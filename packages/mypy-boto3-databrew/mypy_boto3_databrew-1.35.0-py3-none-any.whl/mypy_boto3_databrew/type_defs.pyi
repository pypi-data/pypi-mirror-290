...
__all__ = (
    ...
    "ExcelOptionsExtraOutputTypeDef",
    ...
    "DatasetParameterExtraOutputTypeDef",
    "DatasetParameterOutputTypeDef",
    "DatasetParameterTypeDef",
    "FormatOptionsExtraOutputTypeDef",
...
ExcelOptionsExtraOutputTypeDef = TypedDict(
    "ExcelOptionsExtraOutputTypeDef",
    {
...
DatasetParameterExtraOutputTypeDef = TypedDict(
    "DatasetParameterExtraOutputTypeDef",
    {
        "Name": str,
        ...
        "Filter": NotRequired[FilterExpressionExtraOutputTypeDef],
    },
)
...
FormatOptionsExtraOutputTypeDef = TypedDict(
    "FormatOptionsExtraOutputTypeDef",
    {
        "Json": NotRequired[JsonOptionsTypeDef],
        "Excel": NotRequired[ExcelOptionsExtraOutputTypeDef],
...
PathOptionsExtraOutputTypeDef = TypedDict(
    "PathOptionsExtraOutputTypeDef",
    {
        "LastModifiedDateCondition": NotRequired[FilterExpressionExtraOutputTypeDef],
        "FilesLimit": NotRequired[FilesLimitTypeDef],
        "Parameters": NotRequired[Dict[str, DatasetParameterExtraOutputTypeDef]],
    },
)
...
FormatOptionsUnionTypeDef = Union[FormatOptionsTypeDef, FormatOptionsExtraOutputTypeDef]
...
RecipeStepUnionTypeDef = Union[RecipeStepTypeDef, RecipeStepExtraOutputTypeDef]
...
PathOptionsUnionTypeDef = Union[PathOptionsTypeDef, PathOptionsExtraOutputTypeDef]
