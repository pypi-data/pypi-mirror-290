...
[boto3.OpenSearchService 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/opensearch.html#OpenSearchService)
...
Full list of `OpenSearchService` Literals can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_opensearch/literals/).
...
Full list of `OpenSearchService` TypeDefs can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_opensearch/type_defs/).
