  ...
  'syms': { 'bellek.hf.datasets.utils': { 'bellek.hf.datasets.utils.chunk_random_dataset': ( 'hf.datasets.utils.html#chunk_random_dataset',
            ...
            'bellek.qa.ablation': { 'bellek.qa.ablation.QuestionAnsweringResultCOT': ( 'qa.ablation.html#questionansweringresultcot',
                                    ...
                                    'bellek.qa.ablation.answer_question_standard': ( 'qa.ablation.html#answer_question_standard',
                                                                                     'bellek/qa/ablation.py')},
            'bellek.qa.gen': { 'bellek.qa.gen.answer_question_cot': ('qa.gen.html#answer_question_cot', 'bellek/qa/gen.py'),
                               'bellek.qa.gen.answer_question_cot_fs': ('qa.gen.html#answer_question_cot_fs', 'bellek/qa/gen.py'),
                               'bellek.qa.gen.answer_question_cte': ('qa.gen.html#answer_question_cte', 'bellek/qa/gen.py'),
                               'bellek.qa.gen.answer_question_standard': ('qa.gen.html#answer_question_standard', 'bellek/qa/gen.py')},
