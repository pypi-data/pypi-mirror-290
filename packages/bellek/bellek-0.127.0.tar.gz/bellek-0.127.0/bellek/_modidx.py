...
d = { 'settings': { 'branch': 'master',
                ...
                'lib_path': 'bellek'},
  'syms': { 'bellek.hf.datasets.utils': { 'bellek.hf.datasets.utils.chunk_random_dataset': ( 'hf.datasets.utils.html#chunk_random_dataset',
            ...
            'bellek.hf.transformers.llama2': { 'bellek.hf.transformers.llama2._extract_messages_from_conv': ( 'hf.transformers.llama2.html#_extract_messages_from_conv',
                                               ...
                                               'bellek.hf.transformers.llama2.prepare_llama2_for_inference': ( 'hf.transformers.llama2.html#prepare_llama2_for_inference',
                                                                                                               'bellek/hf/transformers/llama2.py'),
                                               'bellek.hf.transformers.llama2.prepare_llama2_for_training': ( 'hf.transformers.llama2.html#prepare_llama2_for_training',
                                                                                                              'bellek/hf/transformers/llama2.py'),
                                               'bellek.hf.transformers.llama2.text2chat': ( 'hf.transformers.llama2.html#text2chat',
                                                                                            'bellek/hf/transformers/llama2.py')},
            ...
            'bellek.hf.transformers.utils': { 'bellek.hf.transformers.utils.load_tokenizer_model': ( 'hf.transformers.utils.html#load_tokenizer_model',
                                              ...
                                              'bellek.hf.transformers.utils.prepare_model_kwargs': ( 'hf.transformers.utils.html#prepare_model_kwargs',
                                                                                                     'bellek/hf/transformers/utils.py')},
            'bellek.jerx.dataset': { 'bellek.jerx.dataset._batch_transform_webnlg': ( 'jerx.dataset.html#_batch_transform_webnlg',
                                                                                      'bellek/jerx/dataset.py'),
                                     'bellek.jerx.dataset._transform_entity': ( 'jerx.dataset.html#_transform_entity',
                                                                                'bellek/jerx/dataset.py'),
                                     'bellek.jerx.dataset._transform_relation': ( 'jerx.dataset.html#_transform_relation',
                                                                                  'bellek/jerx/dataset.py'),
                                     'bellek.jerx.dataset._transform_triplet': ( 'jerx.dataset.html#_transform_triplet',
                                                                                 'bellek/jerx/dataset.py'),
                                     'bellek.jerx.dataset.batch_transform_webnlg': ( 'jerx.dataset.html#batch_transform_webnlg',
                                                                                     'bellek/jerx/dataset.py')},
            ...
            'bellek.jerx.prompt': { 'bellek.jerx.prompt.JERXChatFormatter': ('jerx.prompt.html#jerxchatformatter', 'bellek/jerx/prompt.py'),
                                    ...
                                    'bellek.jerx.prompt.JERXSimpleChatFormatter.make_system_message': ( 'jerx.prompt.html#jerxsimplechatformatter.make_system_message',
                                                                                                        'bellek/jerx/prompt.py')},
            'bellek.jerx.reward.gpt': { 'bellek.jerx.reward.gpt.QuestionAnsweringResult': ( 'jerx.reward.gpt.html#questionansweringresult',
                                                                                            'bellek/jerx/reward/gpt.py'),
                                        'bellek.jerx.reward.gpt.RewardAssessment': ( 'jerx.reward.gpt.html#rewardassessment',
                                                                                     'bellek/jerx/reward/gpt.py'),
                                        'bellek.jerx.reward.gpt.make_question_answer_func': ( 'jerx.reward.gpt.html#make_question_answer_func',
                                                                                              'bellek/jerx/reward/gpt.py'),
                                        'bellek.jerx.reward.gpt.make_reward_func': ( 'jerx.reward.gpt.html#make_reward_func',
                                                                                     'bellek/jerx/reward/gpt.py')},
            ...
            'bellek.lang.qdecomp': { 'bellek.lang.qdecomp.make_chat_prompt_template': ( 'lang.qdecomp.html#make_chat_prompt_template',
                                     ...
                                     'bellek.lang.qdecomp.parse_sub_questions': ( 'lang.qdecomp.html#parse_sub_questions',
                                                                                  'bellek/lang/qdecomp.py')},
            'bellek.langchain.cache': { 'bellek.langchain.cache._resolve_cache_path': ( 'langchain.cache.html#_resolve_cache_path',
                                                                                        'bellek/langchain/cache.py'),
                                        'bellek.langchain.cache.set_llm_cache': ( 'langchain.cache.html#set_llm_cache',
                                                                                  'bellek/langchain/cache.py'),
                                        'bellek.langchain.cache.unset_llm_cache': ( 'langchain.cache.html#unset_llm_cache',
                                                                                    'bellek/langchain/cache.py')},
            'bellek.langchain.obs': { 'bellek.langchain.obs._serialize_io': ('langchain.obs.html#_serialize_io', 'bellek/langchain/obs.py'),
                                      'bellek.langchain.obs.patch_wandb_tracer_serialize_io': ( 'langchain.obs.html#patch_wandb_tracer_serialize_io',
                                                                                                'bellek/langchain/obs.py')},
            ...
            'bellek.musique.eval': { 'bellek.musique.eval._exact_match': ('musique.eval.html#_exact_match', 'bellek/musique/eval.py'),
                                     ...
                                     'bellek.musique.eval.compare_answers': ( 'musique.eval.html#compare_answers',
                                                                              'bellek/musique/eval.py')},
            'bellek.musique.mhqa.one': { 'bellek.musique.mhqa.one.BaselineMultiHop': ( 'musique.singlehop.html#baselinemultihop',
                                                                                       'bellek/musique/mhqa/one.py'),
                                         'bellek.musique.mhqa.one.BaselineMultiHop.__call__': ( 'musique.singlehop.html#baselinemultihop.__call__',
                                                                                                'bellek/musique/mhqa/one.py'),
                                         'bellek.musique.mhqa.one.BaselineMultiHop.__init__': ( 'musique.singlehop.html#baselinemultihop.__init__',
                                                                                                'bellek/musique/mhqa/one.py'),
                                         'bellek.musique.mhqa.one.BaselineMultiHop._call': ( 'musique.singlehop.html#baselinemultihop._call',
                                                                                             'bellek/musique/mhqa/one.py'),
                                         'bellek.musique.mhqa.one.benchmark': ( 'musique.singlehop.html#benchmark',
                                                                                'bellek/musique/mhqa/one.py'),
                                         'bellek.musique.mhqa.one.make_docs': ( 'musique.singlehop.html#make_docs',
                                                                                'bellek/musique/mhqa/one.py')},
            ...
            'bellek.musique.singlehop': { 'bellek.musique.singlehop.BaselineSingleHop': ( 'musique.singlehop.html#baselinesinglehop',
                                          ...
                                          'bellek.musique.singlehop.make_docs': ( 'musique.singlehop.html#make_docs',
                                                                                  'bellek/musique/singlehop.py')},
            'bellek.qa.ablation': { 'bellek.qa.ablation.answer_question_cot': ('qa.gen.html#answer_question_cot', 'bellek/qa/ablation.py'),
                                    'bellek.qa.ablation.answer_question_cot_fs': ( 'qa.gen.html#answer_question_cot_fs',
                                                                                   'bellek/qa/ablation.py'),
                                    'bellek.qa.ablation.answer_question_cte': ('qa.gen.html#answer_question_cte', 'bellek/qa/ablation.py'),
                                    'bellek.qa.ablation.answer_question_standard': ( 'qa.gen.html#answer_question_standard',
                                                                                     'bellek/qa/ablation.py')},
