...
.. warning::
   ...
   This project is still under development. While basic features are available, there are still improvements to make.
   See :doc:`docs/limitations` for limitations compared to rustdoc and :doc:`docs/compatibility` for writing markdown
   syntax compatible with both rustdoc and Sphinx.
...
See :doc:`docs/limitations` for some cases where the tool will not work the same as rustdoc and :doc:`docs/compatibility`
for any tweaks required to make the tool work with existing docstrings.
