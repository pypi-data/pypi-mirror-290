...
def run_command_and_get_output():
    ...
    result = subprocess.run(
        ["python", "-m", "rockai.command.openapi_schema"],
...
def build_docker_image(
    ...
    docker_list.append(add_run("sed -i 's/http:\/\/archive.ubuntu.com\/ubuntu\//http:\/\/mirrors.tuna.tsinghua.edu.cn\/ubuntu\//g' /etc/apt/sources.list"))
    ...
    docker_list.append(add_run("apt-get upgrade"))
    docker_list.append(add_run("apt upgrade"))
...
""".format(
    ...
    docker_list.append(add_cmd("rockai start"))
