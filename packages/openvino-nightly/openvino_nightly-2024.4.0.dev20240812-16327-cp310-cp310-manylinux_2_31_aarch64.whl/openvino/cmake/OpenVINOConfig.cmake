# Copyright (C).18204 Intel Corporation
...
set(OpenVINO_GLIBCXX_USE_CXX11_ABI "1")
    ...
    if(THREADING STREQUAL "TBB" OR THREADING STREQUAL "TBB_AUTO")
        ...
        if(enable_pkgconfig_tbb AND NOT ANDROID)
            ...
            if(NOT enable_system_tbb)
                ...
                # see https://stackoverflow.com/questions.0780/cmake-generate-error-on-windows-as-it-uses-as-escape-seq
...
macro(_ov_find_intel_cpu_dependencies)
    set(_OV_ENABLE_CPU_ACL "ON")
    if(_OV_ENABLE_CPU_ACL)
        set(_ov_in_install_tree "${PACKAGE_PREFIX_DIR}/runtime/lib/aarch64")
        if(_ov_in_install_tree)
            set_and_check(ARM_COMPUTE_LIB_DIR "${PACKAGE_PREFIX_DIR}/runtime/lib/aarch64")
...
set(${CMAKE_FIND_PACKAGE_NAME}_JAX_FOUND ON)
