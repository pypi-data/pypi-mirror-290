...
set_target_properties(TBB::tbb PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libtbb_debug.so.12.13"
  IMPORTED_SONAME_DEBUG "libtbb_debug.so.12"
  )

list(APPEND _IMPORT_CHECK_TARGETS TBB::tbb )
list(APPEND _IMPORT_CHECK_FILES_FOR_TBB::tbb "${_IMPORT_PREFIX}/lib/libtbb_debug.so.12.13" )
...
set_target_properties(TBB::tbbmalloc PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libtbbmalloc_debug.so.2.13"
  IMPORTED_SONAME_DEBUG "libtbbmalloc_debug.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS TBB::tbbmalloc )
list(APPEND _IMPORT_CHECK_FILES_FOR_TBB::tbbmalloc "${_IMPORT_PREFIX}/lib/libtbbmalloc_debug.so.2.13" )
...
set_target_properties(TBB::tbbmalloc_proxy PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libtbbmalloc_proxy_debug.so.2.13"
  IMPORTED_SONAME_DEBUG "libtbbmalloc_proxy_debug.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS TBB::tbbmalloc_proxy )
list(APPEND _IMPORT_CHECK_FILES_FOR_TBB::tbbmalloc_proxy "${_IMPORT_PREFIX}/lib/libtbbmalloc_proxy_debug.so.2.13" )
...
set_target_properties(TBB::tbbbind_2_5 PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libtbbbind_2_5_debug.so.3.13"
  IMPORTED_SONAME_DEBUG "libtbbbind_2_5_debug.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS TBB::tbbbind_2_5 )
list(APPEND _IMPORT_CHECK_FILES_FOR_TBB::tbbbind_2_5 "${_IMPORT_PREFIX}/lib/libtbbbind_2_5_debug.so.3.13" )
