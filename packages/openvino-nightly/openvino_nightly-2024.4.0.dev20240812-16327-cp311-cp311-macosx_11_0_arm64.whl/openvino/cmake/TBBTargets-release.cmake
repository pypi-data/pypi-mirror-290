...
set_target_properties(TBB::tbb PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libtbb.12.13.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libtbb.12.dylib"
  )

list(APPEND _cmake_import_check_targets TBB::tbb )
list(APPEND _cmake_import_check_files_for_TBB::tbb "${_IMPORT_PREFIX}/openvino/libs/libtbb.12.13.dylib" )
...
set_target_properties(TBB::tbbmalloc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libtbbmalloc.2.13.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libtbbmalloc.2.dylib"
  )

list(APPEND _cmake_import_check_targets TBB::tbbmalloc )
list(APPEND _cmake_import_check_files_for_TBB::tbbmalloc "${_IMPORT_PREFIX}/openvino/libs/libtbbmalloc.2.13.dylib" )
...
set_target_properties(TBB::tbbmalloc_proxy PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libtbbmalloc_proxy.2.13.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libtbbmalloc_proxy.2.dylib"
  )

list(APPEND _cmake_import_check_targets TBB::tbbmalloc_proxy )
list(APPEND _cmake_import_check_files_for_TBB::tbbmalloc_proxy "${_IMPORT_PREFIX}/openvino/libs/libtbbmalloc_proxy.2.13.dylib" )
...
set_target_properties(TBB::tbbbind_2_5 PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libtbbbind_2_5.3.13.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libtbbbind_2_5.3.dylib"
  )

list(APPEND _cmake_import_check_targets TBB::tbbbind_2_5 )
list(APPEND _cmake_import_check_files_for_TBB::tbbbind_2_5 "${_IMPORT_PREFIX}/openvino/libs/libtbbbind_2_5.3.13.dylib" )
