...
[boto3.SagemakerEdgeManager 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/sagemaker-edge.html#SagemakerEdgeManager)
...
- Install `boto3-stubs[sagemaker-edge]` in your environment:
...
Install `boto3-stubs-lite[sagemaker-edge]` in your environment:
...
- Install `boto3-stubs[sagemaker-edge]` with services you use in your
  environment:
...
`mypy_boto3_sagemaker_edge.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `SagemakerEdgeManager` Literals can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_sagemaker_edge/literals/).
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_sagemaker_edge/type_defs/).
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_sagemaker_edge/)
