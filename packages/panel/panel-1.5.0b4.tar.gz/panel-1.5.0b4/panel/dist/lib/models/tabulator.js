...
export class TableEditEvent extends ModelEvent {
    ...
    row;
    pre;
    static __name__ = "TableEditEvent";
...
export class CellClickEvent extends ModelEvent {
    column;
    row;
    static __name__ = "CellClickEvent";
...
export class SelectionEvent extends ModelEvent {
    ...
    selected;
    flush;
    static __name__ = "SelectionEvent";
...
export class DataTabulatorView extends HTMLBoxView {
    ...
    columns = new Map();
    container = null;
    _tabulator_cell_updating = false;
    ...
    _lastHorizontalScrollbarLeftPosition = 0;
    ...
    renderChildren() {
        new Promise(async (resolve) => {
            ...
            for (const index of this.model.expanded) {
                ...
                if (view != null) {
                    const render = new_children.includes(view);
    ...
    _render_row(row, resize = true, render = true) {
        const index = row._row?.data._index;
...
export class DataTabulator extends HTMLBox {
    ...
    static {
        ...
        this.define(({ Any, List, Bool, Nullable, Float, Ref, Str }) => ({
            aggregators: [Any, {}],
            buttons: [Any, {}],
