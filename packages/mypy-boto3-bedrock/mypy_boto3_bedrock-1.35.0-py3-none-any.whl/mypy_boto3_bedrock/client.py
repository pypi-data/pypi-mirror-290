...
class BedrockClient(BaseClient):
    ...
    def create_guardrail(
        ...
        *,
        ...
        contextualGroundingPolicyConfig: GuardrailContextualGroundingPolicyConfigTypeDef = ...,
        kmsKeyId: str = ...,
    ...
    def create_model_copy_job(
        ...
        *,
        ...
        targetModelName: str,
        modelKmsKeyId: str = ...,
        targetModelTags: Sequence[TagTypeDef] = ...,
        clientRequestToken: str = ...,
    ) -> CreateModelCopyJobResponseTypeDef:
        """
    ...
    def create_model_customization_job(
        ...
        *,
        ...
        validationDataConfig: ValidationDataConfigUnionTypeDef = ...,
    ...
    def get_model_copy_job(self, *, jobArn: str) -> GetModelCopyJobResponseTypeDef:
        """
