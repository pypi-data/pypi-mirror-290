...
class AsyncPulsejetLocal(AsyncPulsejetBase):
    def __init__(self, options: Options, timeout: Optional[int] = None, **kwargs: Any):
    ...
    async def search_single(self, collection_name: str, vector: [float], limit: int,
