...
class OptionTrade(TradeMixin):
    ...
    option_type: str  # type of the option (call/put)
    ...
    def calculate_bull_bear(self):
        ...
        iv_factor = (sigmoid(self.implied_volatility * 10) * 2) - 1
        delta_factor = self.delta * 2 - 1
...
class StockTrade(TradeMixin):
    ...
    def calculate_bull_bear(self):
        super().calculate_bull_bear()
        volume_factor = sigmoid(self.volume / 100000) * 2 - 1  # Transforms to [-1, 1]
