...
Usage::
    ...
    ```python
    from mypy_boto3_iotfleetwise.type_defs import ActuatorExtraOutputTypeDef

    data: ActuatorExtraOutputTypeDef = ...
    ```
"""
...
ActuatorExtraOutputTypeDef = TypedDict(
    "ActuatorExtraOutputTypeDef",
    {
...
AttributeExtraOutputTypeDef = TypedDict(
    "AttributeExtraOutputTypeDef",
    {
        "fullyQualifiedName": str,
        "dataType": NodeDataTypeType,
...
SensorExtraOutputTypeDef = TypedDict(
    "SensorExtraOutputTypeDef",
    {
        "fullyQualifiedName": str,
        "dataType": NodeDataTypeType,
...
NodeExtraOutputTypeDef = TypedDict(
    "NodeExtraOutputTypeDef",
    {
        "branch": NotRequired[BranchTypeDef],
        "sensor": NotRequired[SensorExtraOutputTypeDef],
        "actuator": NotRequired[ActuatorExtraOutputTypeDef],
        "attribute": NotRequired[AttributeExtraOutputTypeDef],
...
NodeTypeDef = TypedDict(
    ...
    {
        "branch": NotRequired[BranchTypeDef],
        "sensor": NotRequired[SensorTypeDef],
        "actuator": NotRequired[ActuatorTypeDef],
...
SignalDecoderTypeDef = TypedDict(
    "SignalDecoderTypeDef",
    {
        ...
        "messageSignal": NotRequired[MessageSignalTypeDef],
    },
)
...
CreateDecoderManifestRequestRequestTypeDef = TypedDict(
    "CreateDecoderManifestRequestRequestTypeDef",
    {
        ...
        "modelManifestArn": str,
        "description": NotRequired[str],
        "signalDecoders": NotRequired[Sequence[SignalDecoderTypeDef]],
