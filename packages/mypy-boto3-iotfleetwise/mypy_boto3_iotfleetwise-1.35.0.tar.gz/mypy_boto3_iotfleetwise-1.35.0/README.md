...
[boto3.IoTFleetWise 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/iotfleetwise.html#IoTFleetWise)
...
def get_value() -> ActuatorExtraOutputTypeDef:
    return {...}
```
