...
export const make_unsigned_transaction = async ({
	...
	const unsigned_tx_reversed_hexadecimal_string = string_from_Uint8Array (unsigned_tx_reversed_as_bytes)
	...
	console.log ({ unsigned_tx_reversed  })


	return {
		unsigned_tx: transaction_petition,
		unsigned_tx_as_hexadecimal_string: transaction_petition_hexadecimal_string
	}
}
