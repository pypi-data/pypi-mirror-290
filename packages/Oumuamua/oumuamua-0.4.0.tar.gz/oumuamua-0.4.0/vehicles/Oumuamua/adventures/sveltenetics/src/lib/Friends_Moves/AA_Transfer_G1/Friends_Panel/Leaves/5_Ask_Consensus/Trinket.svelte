...
<div>
	...
	>
		...
		<p
			style="
				font-size: 1.1em;
			"
		>With the <b>Transaction Petition</b> and the <b>Signature of the Sender</b>,<br/> an ask can be sent to the consensus to attach the transaction to the blockchain.</p>
	</div>
	...
	>
		...
		>Ask the consensus to add the transaction to the block chain.</button>
	</div>
