...
const move_faucet = async () => {
	...
	const svgElement = codeWriter.writeToDom (barcode_element, "asdf", 300, 300)
	...
	// https://github.com/aptos-labs/aptos-ts-sdk/blob/main/tests/e2e/transaction/transactionBuilder.test.ts#L141
	...
	// const serializedTx = Transaction.toBCS(transaction);
