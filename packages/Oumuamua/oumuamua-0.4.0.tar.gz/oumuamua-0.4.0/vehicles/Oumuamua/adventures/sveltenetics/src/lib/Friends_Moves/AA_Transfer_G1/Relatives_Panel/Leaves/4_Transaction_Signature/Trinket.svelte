...
>
	...
	>
		<Tab bind:group={current_show} name="tab2" value={0}>
			<span object_button>Object</span>
		</Tab>
		<Tab bind:group={current_show} name="tab1" value={1}>
			<span barcode_button>Barcode</span>
		</Tab>
		<Tab bind:group={current_show} name="tab2" value={2}>
