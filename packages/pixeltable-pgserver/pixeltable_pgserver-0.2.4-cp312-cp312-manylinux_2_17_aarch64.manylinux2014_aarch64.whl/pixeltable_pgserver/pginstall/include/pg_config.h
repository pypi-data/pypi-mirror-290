...
#define CONFIGURE_ARGS " '--prefix=/project/pgbuild/../src/pixeltable_pgserver/pginstall/' '--without-icu' 'PKG_CONFIG_PATH=/usr/local/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 16.2 on aarch64-unknown-linux-gnu, compiled by gcc (GCC) 10.2.1 20210130 (Red Hat 10.2.1-11), 64-bit"
