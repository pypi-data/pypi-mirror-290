...
#define CONFIGURE_ARGS " '--prefix=/d/a/pixeltable-pgserver/pixeltable-pgserver/pgbuild/../src/pgserver/pginstall/' '--without-readline' '--without-icu' 'PKG_CONFIG_PATH=C:\hostedtoolcache\windows\Python\3.10.11\x64/lib/pkgconfig'"
