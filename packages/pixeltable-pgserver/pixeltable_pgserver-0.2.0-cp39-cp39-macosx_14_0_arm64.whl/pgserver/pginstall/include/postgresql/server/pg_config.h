...
#define CONFIGURE_ARGS " '--prefix=/Users/asiegel/Dropbox/workspace/pixeltable/pgserver/pgbuild/../src/pgserver/pginstall/' '--without-readline' '--without-icu'"
...
#define PG_VERSION_STR "PostgreSQL 16.2 on aarch64-apple-darwin23.4.0, compiled by Apple clang version 15.0.0 (clang-1500.3.9.4), 64-bit"
