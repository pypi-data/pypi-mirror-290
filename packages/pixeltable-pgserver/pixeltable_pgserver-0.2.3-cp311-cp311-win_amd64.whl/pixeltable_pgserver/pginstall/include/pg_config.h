...
#define CONFIGURE_ARGS " '--prefix=/d/a/pixeltable-pgserver/pixeltable-pgserver/pgbuild/../src/pixeltable_pgserver/pginstall/' '--without-icu' 'PKG_CONFIG_PATH=C:\hostedtoolcache\windows\Python\3.10.11\x64/lib/pkgconfig'"
