...
#define CONFIGURE_ARGS " '--prefix=/d/a/pixeltable-pgserver/pixeltable-pgserver/pgbuild/../src/pixeltable_pgserver/pginstall/' '--without-readline' '--without-icu' 'PKG_CONFIG_PATH=C:\hostedtoolcache\windows\Python\3.10.11\x64/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 16.2 on x86_64-pc-mingw64, compiled by gcc.exe (x86_64-posix-seh-rev2, Built by MinGW-W64 project) 12.2.0, 64-bit"
