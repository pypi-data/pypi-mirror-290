...
class TimestreamQueryClient(BaseClient):
    ...
    def close(self) -> None:
        ...
        [Show boto3-stubs documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_timestream_query/client/#close)
        """
    ...
    def delete_scheduled_query(self, *, ScheduledQueryArn: str) -> EmptyResponseMetadataTypeDef:
        """
