...
class Application:
	...
	# 실제 로그 출력.
	#--------------------------------------------------------------------------------
	def __Log(self, message : str, logType : LogType) -> None:
	...
	def LogDebug(message : str) -> None:
		Application._Application__Log(message, LogType.DEBUG)
	...
	def LogInfo(message : str) -> None:
		Application._Application__Log(message, LogType.INFO)
	...
	def LogWarning(message : str) -> None:
		Application._Application__Log(message, LogType.WARNING)
	...
	def LogError(message : str) -> None:
		Application._Application__Log(message, LogType.ERROR)
	...
	def LogCritical(message : str) -> None:
		Application._Application__Log(message, LogType.CRITICAL)
