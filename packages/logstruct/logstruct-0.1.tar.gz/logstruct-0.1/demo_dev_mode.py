...
log.warning("An warning message with stack info", stack_info=True)
log.error("An error message with data (traditional)", extra={"struct": "log", "unrepresentable": logging})
log.critical("A critical message with data (kwargs)", struct="log", unrepresentable=logging)
