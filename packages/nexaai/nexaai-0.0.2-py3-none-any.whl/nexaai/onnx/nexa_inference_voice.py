...
from nexaai.constants import EXIT_REMINDER, NEXA_RUN_MODEL_MAP_ONNX
from nexaai.general import pull_model
from nexaai.utils import nexa_prompt
    ...
    def _dialogue_mode(self):
        ...
        while True:
            try:
                ...
                logging.error(f"Error during voice transcription: {e}", exc_info=True)

    def transcribe_audio(self, audio_path):
        """
        Used for SDK. Transcribe audio file to text.
