...
class UnpackedItems(BaseModel):
    """
    Unpacked items list.
    """ # noqa: E501
    product_keys: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=70001)]] = Field(default=None, description="Unpacked product keys list.")
    package_keys: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=11)]] = Field(default=None, description="Unused package keys list.")
    __properties: ClassVar[List[str]] = ["product_keys", "package_keys"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UnpackedItems from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UnpackedItems from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "product_keys": obj.get("product_keys"),
            "package_keys": obj.get("package_keys")
        })
        return _obj
