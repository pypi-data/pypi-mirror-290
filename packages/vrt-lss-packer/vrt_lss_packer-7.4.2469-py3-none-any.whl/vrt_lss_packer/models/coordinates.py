...
class Coordinates(BaseModel):
    ...
    """ # noqa: E501
    x: Annotated[int, Field(le=100000, strict=True, ge=0)] = Field(description="Local coordinate along the X axis, in millimeters.")
    y: Annotated[int, Field(le=100000, strict=True, ge=0)] = Field(description="Local coordinate along the Y axis, in millimeters.")
    z: Annotated[int, Field(le=100000, strict=True, ge=0)] = Field(description="Local coordinate along the Z axis, in millimeters.")
