...
class ValidateResult(BaseModel):
    ...
    """ # noqa: E501
    tracedata: Tracedata
    warnings: Annotated[List[EntityWarning], Field(min_length=0, max_length=70001)] = Field(description="List of warnings. Depending on the flag `calculation_settings.treat_warnings_as_errors` - triggered checks are interpreted as errors or result in the removal of incorrect data from the calculation. ")
