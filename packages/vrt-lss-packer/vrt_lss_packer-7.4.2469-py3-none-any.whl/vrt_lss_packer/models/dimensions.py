...
class Dimensions(BaseModel):
    ...
    """ # noqa: E501
    length: Annotated[int, Field(le=100000, strict=True, ge=0)] = Field(description="Length in millimeters.")
    width: Annotated[int, Field(le=100000, strict=True, ge=0)] = Field(description="Width in millimeters.")
    height: Annotated[int, Field(le=100000, strict=True, ge=0)] = Field(description="Height in millimeters.")
    mass: Annotated[int, Field(le=1000000, strict=True, ge=0)] = Field(description="Weight in grams.")
    __properties: ClassVar[List[str]] = ["length", "width", "height", "mass"]
