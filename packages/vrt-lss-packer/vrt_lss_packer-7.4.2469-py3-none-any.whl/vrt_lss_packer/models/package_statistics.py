...
class PackageStatistics(BaseModel):
    ...
    """ # noqa: E501
    package_key: Annotated[str, Field(min_length=1, strict=True, max_length=1024)] = Field(description="Package key, unique identifier.")
    package_type: PackageType
    count: Annotated[int, Field(le=700001, strict=True, ge=0)] = Field(description="The total number of packages.")
    max_container_mass: Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]] = Field(description="The maximum weight of goods that this package can hold (in total for all packages of the specified key and type), in kilograms.")
    max_container_volume: Union[Annotated[float, Field(le=1000000, strict=True, ge=0)], Annotated[int, Field(le=1000000, strict=True, ge=0)]] = Field(description="The maximum volume of goods that this package can hold (total for all packages of the specified key and type), in cubic meters.")
    utilization_by_mass: Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]] = Field(description="Utilization by mass (in fractions) - the ratio of the loaded mass to the maximum possible (excluding weight of packages).")
    utilization_by_volume: Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]] = Field(description="Utilization by volume (in fractions) - the ratio of the loaded volume to the maximum possible (excluding volume of packages).")
    __properties: ClassVar[List[str]] = ["package_key", "package_type", "count", "max_container_mass", "max_container_volume", "utilization_by_mass", "utilization_by_volume"]
