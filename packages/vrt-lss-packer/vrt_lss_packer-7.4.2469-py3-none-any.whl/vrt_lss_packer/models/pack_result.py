...
class PackResult(BaseModel):
    ...
    """ # noqa: E501
    tracedata: Tracedata
    blueprint: Annotated[List[PackageLayout], Field(min_length=0, max_length=70001)] = Field(description="A product layout plan as a list of packaging locations. The first level contains a list of pallet stacks. ")
    ...
    unpacked_items: Optional[UnpackedItems] = None
    ...
    __properties: ClassVar[List[str]] = ["tracedata", "blueprint", "statistics", "warnings", "unpacked_items", "calculation_progress", "calculation_info"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PackResult from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of unpacked_items
        if self.unpacked_items:
            _dict['unpacked_items'] = self.unpacked_items.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PackResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "blueprint": [PackageLayout.from_dict(_item) for _item in obj["blueprint"]] if obj.get("blueprint") is not None else None,
            "statistics": PackStatistics.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None,
            "warnings": [EntityWarning.from_dict(_item) for _item in obj["warnings"]] if obj.get("warnings") is not None else None,
            "unpacked_items": UnpackedItems.from_dict(obj["unpacked_items"]) if obj.get("unpacked_items") is not None else None,
