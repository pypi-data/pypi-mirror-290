...
class PackageLayout(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["package_key", "coordinates", "dimensions", "product_group_layouts", "package_layouts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "product_group_layouts": [ProductGroupLayout.from_dict(_item) for _item in obj["product_group_layouts"]] if obj.get("product_group_layouts") is not None else None,
            "package_layouts": [PackageLayout.from_dict(_item) for _item in obj["package_layouts"]] if obj.get("package_layouts") is not None else None
        })
        return _obj

# TODO: Rewrite to not use raise_errors
PackageLayout.model_rebuild(raise_errors=False)
