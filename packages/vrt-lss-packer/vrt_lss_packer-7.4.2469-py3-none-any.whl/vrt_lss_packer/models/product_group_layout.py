...
class ProductGroupLayout(BaseModel):
    ...
    """ # noqa: E501
    product_key: Annotated[str, Field(min_length=1, strict=True, max_length=1024)] = Field(description="Package key.")
    coordinates: Coordinates
    dimensions: Dimensions
    product_layouts: Annotated[List[ProductLayout], Field(min_length=0, max_length=70001)] = Field(description="List of product layouts.")
    __properties: ClassVar[List[str]] = ["product_key", "coordinates", "dimensions", "product_layouts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "product_layouts": [ProductLayout.from_dict(_item) for _item in obj["product_layouts"]] if obj.get("product_layouts") is not None else None
        })
        return _obj
