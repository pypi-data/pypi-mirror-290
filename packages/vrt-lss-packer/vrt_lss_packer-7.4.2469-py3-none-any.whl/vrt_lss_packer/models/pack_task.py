...
class PackTask(BaseModel):
    ...
    Initial task.
    """ # noqa: E501
    products: Annotated[List[Product], Field(min_length=1, max_length=70001)] = Field(description="List of products.")
    packages: Annotated[List[Package], Field(min_length=1, max_length=11)] = Field(description="List of packages. It is obligatory to have at least one package of each type (SLOT, PALLET, MIXBOX). ")
    ...
    __properties: ClassVar[List[str]] = ["products", "packages", "pack_settings", "dataset_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pack_settings": PackSettings.from_dict(obj["pack_settings"]) if obj.get("pack_settings") is not None else None,
