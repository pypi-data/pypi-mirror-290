...
class WorkMailClient(BaseClient):
    ...
    def close(self) -> None:
        ...
        [Show boto3-stubs documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_workmail/client/#close)
        """
    ...
    def describe_entity(self, *, OrganizationId: str, Email: str) -> DescribeEntityResponseTypeDef:
        """
