...
# -----------------------------------------
# Make snippets for Markdown
# -----------------------------------------
# yaml_file = '/Users/taravser/Documents/My_papers/PhenoScript_main/PhenoScript/phenospy_package/phenospy/package-data/phs-config.yaml'
# make_mdSnips(yaml_file)
def make_mdSnips(yaml_file):
    # -----------------------------------------
    # Read configuration yaml
    # -----------------------------------------
    ...
    for onto_path in onto_store:
        ...
        for item in onto_obj:
            ...
            if (pref is not None) and (trimmed_iri is not None):
                ...
                if defin is None:
                    defin=''
                snip = snippetInfo_md('C', item.label.first(), item.iri, pref, trimmed_iri, defin)
                snips.append(snip)
                #print(snip)
            else:
                print(f"\t\t\t{Fore.RED}Warning! See phs-config.yaml. Namespace is not defined for{Style.RESET_ALL}{Fore.BLUE}", item, item.iri)
        ...
        for item in onto_obj:
            ...
            if (pref is not None) and (trimmed_iri is not None):
                ...
                if defin is None:
                    defin=''
                snip = snippetInfo_md('OP', item.label.first(), item.iri, pref, trimmed_iri, defin)
                snips.append(snip)
                #print(snip)
            else:
                print(f"\t\t\t{Fore.RED}Warning! See phs-config.yaml. Namespace is not defined for{Style.RESET_ALL}{Fore.BLUE}", item, item.iri)
        ...
        for item in onto_obj:
            ...
            if (pref is not None) and (trimmed_iri is not None):
                ...
                if defin is None:
                    defin=''
                snip = snippetInfo_md('DP', item.label.first(), item.iri, pref, trimmed_iri, defin)
                snips.append(snip)
                #print(snip)
            else:
                print(f"\t\t\t{Fore.RED}Warning! See phs-config.yaml. Namespace is not defined for{Style.RESET_ALL}{Fore.BLUE}", item, item.iri)
        ...
        for item in onto_obj:
            ...
            if (pref is not None) and (trimmed_iri is not None):
                ...
                if defin is None:
                    defin=''
                snip = snippetInfo_md('AP', item.label.first(), item.iri, pref, trimmed_iri, defin)
                snips.append(snip)
                #print(snip)
            else:
                print(f"\t\t\t{Fore.RED}Warning! See phs-config.yaml. Namespace is not defined for{Style.RESET_ALL}{Fore.BLUE}", item, item.iri)
