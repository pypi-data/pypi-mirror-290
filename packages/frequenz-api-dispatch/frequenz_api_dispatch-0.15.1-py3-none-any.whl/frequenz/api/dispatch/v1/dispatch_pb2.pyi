...
class StreamMicrogridDispatchesResponse(google.protobuf.message.Message):
    ...
    class _EventEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[StreamMicrogridDispatchesResponse._Event.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        EVENT_UNSPECIFIED: StreamMicrogridDispatchesResponse._Event.ValueType  # 0
        """Default, unspecified event"""
        EVENT_CREATED: StreamMicrogridDispatchesResponse._Event.ValueType  # 1
        """A new dispatch has been created"""
        EVENT_UPDATED: StreamMicrogridDispatchesResponse._Event.ValueType  # 2
        """An existing dispatch has been updated"""
        EVENT_DELETED: StreamMicrogridDispatchesResponse._Event.ValueType  # 3
        """An existing dispatch has been deleted"""

    class Event(_Event, metaclass=_EventEnumTypeWrapper): ...
    EVENT_UNSPECIFIED: StreamMicrogridDispatchesResponse.Event.ValueType  # 0
    """Default, unspecified event"""
    EVENT_CREATED: StreamMicrogridDispatchesResponse.Event.ValueType  # 1
    """A new dispatch has been created"""
    EVENT_UPDATED: StreamMicrogridDispatchesResponse.Event.ValueType  # 2
    """An existing dispatch has been updated"""
    EVENT_DELETED: StreamMicrogridDispatchesResponse.Event.ValueType  # 3
    """An existing dispatch has been deleted"""

    DISPATCH_FIELD_NUMBER: builtins.int
    EVENT_FIELD_NUMBER: builtins.int
    event: global___StreamMicrogridDispatchesResponse.Event.ValueType
...
class DispatchData(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_duration", b"_duration", "duration", b"duration", "payload", b"payload", "recurrence", b"recurrence", "selector", b"selector", "start_time", b"start_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_duration", b"_duration", "duration", b"duration", "is_active", b"is_active", "is_dry_run", b"is_dry_run", "payload", b"payload", "recurrence", b"recurrence", "selector", b"selector", "start_time", b"start_time", "type", b"type"]) -> None: ...
...
class DispatchMetadata(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["create_time", b"create_time", "end_time", b"end_time", "modification_time", b"modification_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["create_time", b"create_time", "dispatch_id", b"dispatch_id", "end_time", b"end_time", "modification_time", b"modification_time"]) -> None: ...
...
class DispatchFilter(google.protobuf.message.Message):
    ...
    @property
    def start_time_interval(self) -> global___TimeIntervalFilter:
        """Optional filter by start time.
        If no interval is provided, all dispatches will be returned.
        """

    @property
    def end_time_interval(self) -> global___TimeIntervalFilter:
        """Optional filter by end time
        Filter dispatches based on their explicit end time.
        """

    @property
    def update_time_interval(self) -> global___TimeIntervalFilter:
    ...
    def __init__(
        ...
        *,
        ...
        start_time_interval: global___TimeIntervalFilter | None = ...,
        end_time_interval: global___TimeIntervalFilter | None = ...,
        update_time_interval: global___TimeIntervalFilter | None = ...,
    ) -> None: ...
    ...
    def ClearField(self, field_name: typing.Literal["_is_active", b"_is_active", "_is_dry_run", b"_is_dry_run", "end_time_interval", b"end_time_interval", "filter", b"filter", "is_active", b"is_active", "is_dry_run", b"is_dry_run", "is_recurring", b"is_recurring", "recurrence", b"recurrence", "selectors", b"selectors", "start_time_interval", b"start_time_interval", "update_time_interval", b"update_time_interval"]) -> None: ...
    @typing.overload
...
class ComponentSelector(google.protobuf.message.Message):
    ...
    @property
    def component_ids(self) -> global___ComponentSelector.IdSet:
        """Set of component IDs"""

    @property
    def component_categories(self) -> global___ComponentSelector.CategorySet:
        """Component categories"""

    def __init__(
        self,
        *,
        component_ids: global___ComponentSelector.IdSet | None = ...,
        component_categories: global___ComponentSelector.CategorySet | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["component_categories", b"component_categories", "component_ids", b"component_ids", "selector", b"selector"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["component_categories", b"component_categories", "component_ids", b"component_ids", "selector", b"selector"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["selector", b"selector"]) -> typing.Literal["component_ids", "component_categories"] | None: ...
...
class CreateMicrogridDispatchRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["dispatch_data", b"dispatch_data"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["dispatch_data", b"dispatch_data", "microgrid_id", b"microgrid_id"]) -> None: ...
...
class UpdateMicrogridDispatchRequest(google.protobuf.message.Message):
    ...
    class DispatchUpdate(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["_duration", b"_duration", "_is_active", b"_is_active", "duration", b"duration", "is_active", b"is_active", "payload", b"payload", "recurrence", b"recurrence", "selector", b"selector", "start_time", b"start_time"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["_duration", b"_duration", "_is_active", b"_is_active", "duration", b"duration", "is_active", b"is_active", "payload", b"payload", "recurrence", b"recurrence", "selector", b"selector", "start_time", b"start_time"]) -> None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing.Literal["_duration", b"_duration"]) -> typing.Literal["duration"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing.Literal["_is_active", b"_is_active"]) -> typing.Literal["is_active"] | None: ...
