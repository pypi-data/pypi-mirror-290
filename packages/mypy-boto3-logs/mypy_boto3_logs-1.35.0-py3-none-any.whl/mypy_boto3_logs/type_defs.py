...
__all__ = (
    ...
    "MetricTransformationExtraOutputTypeDef",
...
MetricTransformationExtraOutputTypeDef = TypedDict(
    "MetricTransformationExtraOutputTypeDef",
    {
        "metricName": str,
        "metricNamespace": str,
...
MetricTransformationUnionTypeDef = Union[
    MetricTransformationTypeDef, MetricTransformationExtraOutputTypeDef
]
