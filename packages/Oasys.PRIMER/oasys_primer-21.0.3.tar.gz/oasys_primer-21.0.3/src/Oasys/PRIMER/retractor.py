...
class Retractor(Oasys.gRPC.OasysItem, metaclass=RetractorType):
    _props = {'colour', 'dsid', 'include', 'label', 'lfed', 'llcid', 'nsbi', 'pull', 'sbid', 'sbrid', 'sbrnid', 'sid1', 'sid2', 'sid3', 'sid4', 'tdel', 'transparency', 'ulcid'}
...
# Constructor
    def __init__(self, model, sbrid, sbrnid, sbid, llcid, sid1, sid2=Oasys.gRPC.defaultArg, sid3=Oasys.gRPC.defaultArg, sid4=Oasys.gRPC.defaultArg, tdel=Oasys.gRPC.defaultArg, pull=Oasys.gRPC.defaultArg, ulcid=Oasys.gRPC.defaultArg, lfed=Oasys.gRPC.defaultArg):
        handle = Oasys.PRIMER._connection.constructor(self.__class__.__name__, model, sbrid, sbrnid, sbid, llcid, sid1, sid2, sid3, sid4, tdel, pull, ulcid, lfed)
