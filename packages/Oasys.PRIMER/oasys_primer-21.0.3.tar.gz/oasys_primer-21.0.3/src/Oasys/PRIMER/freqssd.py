...
# Instance methods
    ...
    def SetErpData(self, index, data):
        ...
        data : List of data
            An list containing the ERP data (values: pid[integer], ptyp[integer]). The array length should be 2
    ...
    def SetLoadData(self, index, data):
        ...
        data : List of data
            ...
            lc1[integer], lc2[integer], sf[real], vid[integer]). The array length should be 8.
