...
class Contact(Oasys.gRPC.OasysItem, metaclass=ContactType):
    _props = {'a', 'algo', 'alpha', 'b', 'bc_flg', 'beta', 'bsort', 'bt', 'bucket', 'c', 'check_mode', 'chksegs', 'cid', 'cid_rcf', 'cideta', 'cidmu', 'close', 'cn', 'cn_1', 'colour', 'contact_penchk_dup_shells', 'cparm8', 'cparm8smp', 'ct2cn', 'ct2cn_1', 'd', 'd_comp', 'dbdth', 'dbinr', 'dbpid', 'dc', 'depth', 'dfscl', 'dnlscl', 'dprfac', 'dt', 'dtpchk', 'dtstif', 'eloff', 'ending', 'epm', 'epscale', 'eraten', 'erates', 'erosop', 'fcm', 'fd', 'flangl', 'fnlscl', 'formula', 'frad', 'frcfrq', 'fricsf', 'fs', 'fsf', 'fstol', 'ftorq', 'ftosa', 'grpable', 'h0', 'hclose', 'heading', 'i2d3d', 'iadj', 'icor', 'id', 'igap', 'ignore', 'ignroff', 'include', 'inititer', 'ipback', 'isym', 'isym_1', 'k', 'kpf', 'label', 'lcbucket', 'lceps', 'lceps2', 'lcfdt', 'lcfst', 'lch', 'lcid', 'lcid1', 'lcid2', 'lcidab', 'lcidnf', 'lcidrf', 'lmax', 'lmin', 'maxpar', 'mes', 'mortar', 'mpp', 'mtcj', 'nen', 'nfls', 'nhv', 'nmhis', 'nmtwh', 'ns2track', 'nstwh', 'ntprm', 'numint', 'offset', 'offset_1', 'offset_flag', 'option', 'option_1', 'param', 'parmax', 'penchk', 'penmax', 'pensf', 'pstiff', 'q2tri', 'region', 'saboxid', 'sapr', 'sast', 'sbboxid', 'sbopt', 'sbpr', 'sbst', 'sfls', 'sfnbr', 'sfsa', 'sfsat', 'sfsb', 'sfsbt', 'sharec', 'shledg', 'shlthk', 'sldstf', 'sldthk', 'snlog', 'sofscl', 'soft', 'srmodel', 'srnde', 'ssftyp', 'surfa', 'surfatyp', 'surfb', 'surfbtyp', 'swtpr', 'tblcid', 'tcso', 'temp', 'tetfac', 'tfail', 'thermal', 'thkoff', 'thkopt', 'tiedid', 'time', 'tscale', 'tsvx', 'tsvy', 'tsvz', 'type', 'up1', 'up10', 'up11', 'up12', 'up13', 'up14', 'up15', 'up16', 'up2', 'up3', 'up4', 'up5', 'up6', 'up7', 'up8', 'up9', 'us', 'vc', 'vdc', 'vsf'}
...
# Instance methods
    ...
    def Interactions(self, type=Oasys.gRPC.defaultArg):
        ...
        """
        return Oasys.PRIMER._connection.instanceMethod(self.__class__.__name__, self._handle, "Interactions", type)
