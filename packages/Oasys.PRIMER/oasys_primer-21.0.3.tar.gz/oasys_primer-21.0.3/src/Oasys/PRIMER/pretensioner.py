...
class Pretensioner(Oasys.gRPC.OasysItem, metaclass=PretensionerType):
    _props = {'colour', 'include', 'label', 'lmtfrc', 'ptlcid', 'sbprid', 'sbprty', 'sbrid', 'sbsid1', 'sbsid2', 'sbsid3', 'sbsid4', 'time', 'transparency'}
...
# Constructor
    def __init__(self, model, sbprid, sbprty, sbrid, ptlcid, sbsid1, sbsid2=Oasys.gRPC.defaultArg, sbsid3=Oasys.gRPC.defaultArg, sbsid4=Oasys.gRPC.defaultArg, time=Oasys.gRPC.defaultArg, lmtfrc=Oasys.gRPC.defaultArg):
        handle = Oasys.PRIMER._connection.constructor(self.__class__.__name__, model, sbprid, sbprty, sbrid, ptlcid, sbsid1, sbsid2, sbsid3, sbsid4, time, lmtfrc)
