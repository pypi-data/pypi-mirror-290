...
class DampingFrequencyRange(Oasys.gRPC.OasysItem, metaclass=DampingFrequencyRangeType):
    _props = {'cdamp', 'fhigh', 'flow', 'iflg', 'include', 'option', 'pidref', 'psid'}
...
# Constructor
    def __init__(self, model, option=Oasys.gRPC.defaultArg, cdamp=Oasys.gRPC.defaultArg, flow=Oasys.gRPC.defaultArg, fhigh=Oasys.gRPC.defaultArg, psid=Oasys.gRPC.defaultArg, pidref=Oasys.gRPC.defaultArg, iflg=Oasys.gRPC.defaultArg):
        handle = Oasys.PRIMER._connection.constructor(self.__class__.__name__, model, option, cdamp, flow, fhigh, psid, pidref, iflg)
