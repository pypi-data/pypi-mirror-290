...
class SensorControl(Oasys.gRPC.OasysItem, metaclass=SensorControlType):
    _props = {'cntlid', 'estyp', 'include', 'initstt', 'label', 'nrep', 'swit1', 'swit2', 'swit3', 'swit4', 'swit5', 'swit6', 'swit7', 'timeoff', 'timeoff/idiscl', 'type', 'typeid'}
...
# Constructor
    def __init__(self, model, sensor_control_id, type, type_id=Oasys.gRPC.defaultArg, estyp=Oasys.gRPC.defaultArg):
        ...
        type : string
            ...
            "BELTSLIP", "CONTACT", "CONTACT2D", "DEF2RIG", "DISC-ELE", "DISC-ELES",
