...
# Instance methods
    def AddLine(self, line_content, line_number=Oasys.gRPC.defaultArg):
        ...
        line_number : Integer
            ...
            If list of lines has been passed in the first argument, the first line of the array will be inserted in the line number specified in second argument, the second line of the array will be inserted in the following line number, etc.
