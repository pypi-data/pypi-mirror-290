...
class Bucket(Construct):
    ...
    def _create_bucket(
        ...
        bucket_name: str,
        app_name: str,
        # access_control: Union[aws_cdk.aws_s3.BucketAccessControl, None] = None,
        public_read_access: bool = False,
        website_index_document: str = None,
        website_error_document: str = None,
        removal_policy: aws_cdk.RemovalPolicy = None,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._bucket = self._create_bucket(
            ...
            # access_control=(_s3.BucketAccessControl.PRIVATE if not public_read_access else None), # legacy
