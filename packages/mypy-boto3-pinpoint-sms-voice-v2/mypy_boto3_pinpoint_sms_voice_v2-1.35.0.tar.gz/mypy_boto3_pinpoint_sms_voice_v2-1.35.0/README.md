...
[boto3.PinpointSMSVoiceV2 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/pinpoint-sms-voice-v2.html#PinpointSMSVoiceV2)
...
describe_registration_section_definitions_paginator: (
    DescribeRegistrationSectionDefinitionsPaginator
) = client.get_paginator("describe_registration_section_definitions")
