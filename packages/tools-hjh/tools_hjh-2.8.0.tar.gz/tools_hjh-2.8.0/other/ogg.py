...
tables = '''
PSBCAP.LOAN_CLOSE_ACCT_DETAIL_RECORD
PSBCAP.BATCH_RT_PBC2SCORE_INFO
PSBCAP.BATCH_RT_PBC2SCORE_RUN
PSBCAP.MYDC_HOUSE_FUND_INFO
PSBCAP.MYDC_PERSONAL_INCOME
PSBCAP.MYDC_INCOME_DETAIL
PSBCAP.JC_FACTOR_ADJ_TRADE_RECORD
PSBCAP.LOAN_FACTOR_ADJUSTMENT_INFO
AI_ROBOT.AI_ROBOT_CHANNEL_CONFIG
FFKFQZ.FACADE_ID_CARD_RPA_RECORD
PSBCAP.EX_ZJFXJ_PBC_INFO2
PSBCAP.EX_ZJFXJ_PBC_INFO1
ACCT_FACADE.DXMFR_REPAY_PLAN_BAK
ACCT_FACADE.DXMFR_REPAY_ITEM_BAK
ACCT_FACADE.DXMFR_REPAY_BAK
ACCT_FACADE.DXMFR_REDUCE_BAK
ACCT_FACADE.DXMFR_PAYOUT_DETAIL_BAK
ACCT_FACADE.DXMFR_OPEN_BAK
ACCT_FACADE.DXMFR_LOAN_RATE_BAK
ACCT_FACADE.DXMFR_LOAN_BAK
ACCT_FACADE.DXMFR_CLEARING_BAK
ACCT_FACADE.DXMFR_LOAN_REPAY_SCHED_DAILY
ACCT_FACADE.DXMFR_LOAN_PRIN_INT_BAL_DAILY
ACCT_FACADE.DXMFR_ACCOUNT_INFO_DAILY
ACCT_FACADE.DXMFR_LOAN_BASE_INFO_DAILY
'''
