...
class OracleTools:
    ...
    @staticmethod
    def copy_data(src_db, dst_db, src_onwer, src_table, dst_onwer, dst_table, dst_pk_cols='', commit_rownum=3000):
        '''
        ...
        if src_onwer == '' or src_onwer is None:
            select_sql = 'select t.*' + dst_pk_cols_2 + ' from ' + src_table + ' t'
        else:
            select_sql = 'select t.*' + dst_pk_cols_2 + ' from ' + src_onwer + '.' + src_table + ' t'
