...
def group_by_windowed(
    *buckets: str,
    ...
    See more at https://docs.chalk.ai/docs/aggregations#grouping-windowed-features
    ...
    materialization
        ...
        See more at https://docs.chalk.ai/docs/aggregations#windowed-aggregation-for-performance
    owner
...
def windowed(
    *buckets: str,
    ...
    materialization
        ...
        See more at https://docs.chalk.ai/docs/aggregations#materialized-window-aggregations
    owner
        You may also specify which person or group is responsible for a feature.
        The owner tag will be available in Chalk's web portal.
        Alerts that do not otherwise have an owner will be assigned
