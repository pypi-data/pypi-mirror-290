...
def DynamoDBSource(
    *,
    ...
    >>> import os
    >>> source = DynamoDBSource(
    ...     aws_client_id_override=os.getenv("DYNAMODB_CLIENT_ID_OVERRIDE"),
    ...     aws_client_secret_override=os.getenv("DYNAMODB_CLIENT_SECRET_OVERRIDE"),
    ...     aws_region_override=os.getenv("DYNAMODB_REGION_OVERRIDE"),
    ... )
    """
    ...
