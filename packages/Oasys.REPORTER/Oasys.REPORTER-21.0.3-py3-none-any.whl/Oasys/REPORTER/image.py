...
# Constructor
    def __init__(self, width, height, backgroundcolour=Oasys.gRPC.defaultArg):
        ...
        backgroundcolour : string
            ...
            colour from the X colour database (For Linux users, see /etc/X11/rgb.txt) e.g. "Blue", or #RRGGBB (each of R, G and B is a single hex digit)
            e.g. "#0000FF" for blue
...
# Instance methods
    ...
    def PixelCount(self, colour, tol=Oasys.gRPC.defaultArg):
        ...
        ----------
        colour : string
            A valid colour from the X colour database (For Linux users, see /etc/X11/rgb.txt) e.g. "Blue", or #RRGGBB (each of R, G and B is a single hex digit)
            e.g. "#0000FF" for blue
        tol : integer
