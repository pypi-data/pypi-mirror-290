...
# Constructor
    def __init__(self, template, name, description=Oasys.gRPC.defaultArg, value=Oasys.gRPC.defaultArg, type=Oasys.gRPC.defaultArg, readonly=Oasys.gRPC.defaultArg, temporary=Oasys.gRPC.defaultArg):
        ...
        type : string
            Optional. Type of variable. Predefined types are "Directory", "File(absolute)", "File(basename)", "File(extension)",
            "File(tail)", "General", "Number" and "String". Alternatively give your own type. e.g. "NODE ID". If omitted default is "General"
        readonly : boolean
