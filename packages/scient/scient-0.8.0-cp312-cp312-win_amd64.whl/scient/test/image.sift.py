...
t=time.time()
kp1, des1 = sift_task.detect(img1)
print('--',time.time()-t)
t=time.time()
kp2, des2 = sift_task.detect(img2)
print('--',time.time()-t)
...
vector1=vector1[:128*128]
vector2=vector2[:128*128]
if len(vector1)<128*128:
    vector1=numpy.concatenate(vector1,numpy.zeros(128*128 - vector1.size))
if len(vector2)<128*128:
    vector2=numpy.concatenate(vector2,numpy.zeros(128*128 - vector2.size))
