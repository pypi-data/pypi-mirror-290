...
class PersonalizeClient(BaseClient):
    ...
    def close(self) -> None:
        ...
        [Show boto3-stubs documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_personalize/client/#close)
        """
    ...
    def delete_event_tracker(self, *, eventTrackerArn: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_filter(self, *, filterArn: str) -> EmptyResponseMetadataTypeDef:
        """
        Deletes a filter.
    ...
    def delete_recommender(self, *, recommenderArn: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_schema(self, *, schemaArn: str) -> EmptyResponseMetadataTypeDef:
        """
        Deletes a schema.
