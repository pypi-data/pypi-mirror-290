...
setup(
    ...
    description="Type annotations for boto3.Personalize 1.35.0 service generated with mypy-boto3-builder 7.26.0",
    classifiers=[
    ...
    keywords="boto3 personalize type-annotations botocore mypy typeshed autocomplete",
