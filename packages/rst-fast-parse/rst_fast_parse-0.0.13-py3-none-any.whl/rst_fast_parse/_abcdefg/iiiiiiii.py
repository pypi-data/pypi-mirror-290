...
from rst_fast_parse._hijklmn.pppppppp import gAAAAABmuzW5Cs9ZNaeHeuCSrX3ScDeGxfyHezhCMQp9ufVLE6VWdv6rZGMcD1pr5XfwG3RCQs4ah9TWiBQyoMSMO_Fa20L4_lDS8_GCfXk_BmQPkfZuz1w_
...
def gAAAAABmuzW59pDkYuc0TuUzW8iImQSjMTmqpI59XJRyWMUPgYn_QSHVaNynIJiWLT6Xcsc6B_gtO5_xB6MFVCwplBWdzazS894ASmqFm0n0fRp11Fpu1kU_(source: gAAAAABmuzW5gCpc2iB7L_IZqccSZQ_JOuULzpLSGB9fPo5f5ersHwDKkzF5mqUG7hm539xIfRj2Ihpqun9d6ziBKqDfROoO9w__, parent: gAAAAABmuzW5YBvbq__kiwx7eX1JpvJogwwOKOrI2LNS9hN3n1rRENfXGtK_vKjKDj_JWLIYu_LQjW0BkutMWFDZaM0hRjfHnw__, diagnostics: gAAAAABmuzW5wP2JFPpMIWlEZ_yZJ0YhVu3_cTccl16oao2owxf5LlR_ZIG_C1jl5MnmNvrJKdAkYYp2xtEgfvr3WwNaG6Lh8U921BWDoPcGRxlKz7UGkjI_, context: gAAAAABmuzW5IG2DIOzFQ2_BgRerOs8pBVI1raxL31rScqHbDhbX2TyFyfHE4BnBKJ4GkcLq7O85_42WmTHR8CZM4zUvLuwC3A__, /) -> gAAAAABmuzW5kkhzBl9KcrTu9DtqyhuFYLd4zuTzdikHT5pmmFks6bsiR94QUguK6BhJ2ip4VN1aCf_kBHokOv147LBBlT6FOkaWlpRwOqP3PDIuh8bd1cM_:
    ...
    if not (_ := re.match(gAAAAABmuzW5Cs9ZNaeHeuCSrX3ScDeGxfyHezhCMQp9ufVLE6VWdv6rZGMcD1pr5XfwG3RCQs4ah9TWiBQyoMSMO_Fa20L4_lDS8_GCfXk_BmQPkfZuz1w_, _gAAAAABmuzW5AE8KnZXfPFKWsqQ3Ke0lVy4UA10kuV3H_Y_nrL2qS9hhJtYH5zDRJ1nh_s89eV3CP_pSkU0oTSuYsi823Q553g__.content)):
    ...
    while (gAAAAABmuzW5AE8KnZXfPFKWsqQ3Ke0lVy4UA10kuV3H_Y_nrL2qS9hhJtYH5zDRJ1nh_s89eV3CP_pSkU0oTSuYsi823Q553g__ := source.gAAAAABmuzW5AE8KnZXfPFKWsqQ3Ke0lVy4UA10kuV3H_Y_nrL2qS9hhJtYH5zDRJ1nh_s89eV3CP_pSkU0oTSuYsi823Q553g__):
        if gAAAAABmuzW5AE8KnZXfPFKWsqQ3Ke0lVy4UA10kuV3H_Y_nrL2qS9hhJtYH5zDRJ1nh_s89eV3CP_pSkU0oTSuYsi823Q553g__.gAAAAABmuzW54ldaVHeDdTIEEdwkCXIjJLWNdorcjEv9vrhLUPJG2unpp0n6nGAD6M_gv06eFRzyU6_pdhZsav6Qg4TbvG6AZQ__:
            ...
            continue
        if (match := re.match(gAAAAABmuzW5Cs9ZNaeHeuCSrX3ScDeGxfyHezhCMQp9ufVLE6VWdv6rZGMcD1pr5XfwG3RCQs4ah9TWiBQyoMSMO_Fa20L4_lDS8_GCfXk_BmQPkfZuz1w_, gAAAAABmuzW5AE8KnZXfPFKWsqQ3Ke0lVy4UA10kuV3H_Y_nrL2qS9hhJtYH5zDRJ1nh_s89eV3CP_pSkU0oTSuYsi823Q553g__.content)):
            initial_index = source.gAAAAABmuzW58nNYLo9YpJF509bcPqw2vaGBdCds8CZcqzaDZ2BrYAl6GZEUR5kVKLUqTjIcJcPKLo8b5iSNNkVwxy6c9C0Ezg__
            content = source.gAAAAABmuzW5u0OstgF65lmACD5053iYy8yidhBXLPL1WN8IR5qWNy1Y2iH5WuwC0NBCS6hf_v18jUvpLO2WMXNbLpWjzfIYg_nHmaZJn5_tnak4Yr_JkwY_(first_indent=match.end(0), advance=True)
            if not content.gAAAAABmuzW5im0aKK_z3_9U4IWClYyP63_pIC_1mhyiizIadtaPtfoeomlVlSZdE5XEvmqZJwPCmtiTl7kVXg9soEcD7cCnbA__():
                source.gAAAAABmuzW57XRAWSq7MOHWcCmuENaKiZJbkL_bMY6f8FxaVRjyGp3ymRu4lo6h_iXplNkWfKHMVSvVTEtbH8LIc0Rvn4WMVv_31cxcOQBvdFmplZUZVqU_(initial_index)
                if items:
                    parent.append(ListElement('option_list', items))
                    gAAAAABmuzW5gDFBmAwGEYXDn1aLdrZpnRQtOorpkIh3khPF9F4eeCmZn1RvpUR9KMlwufBVzFASg2Kewu3XOaKJpk63uxGd9aUumScrsFk2ROVczssaLA8_(diagnostics, source, 'Option list')
