...
from rst_fast_parse._opqrstu.vvvvvvvv import gAAAAABmuzW5dXTy2i0GXSsxvau8coj_KU__n1Fc0YFdys4CEsRpgPeZ0rGjew8f_aQPfM_SiRMHVbnmTzl4W8DEcoapOpYrJg__
...
class DiagnosticCode(enum.Enum):
    ...
    def get_fields(cls) -> list[tuple[str, str, str]]:
        ...
        return gAAAAABmuzW5dXTy2i0GXSsxvau8coj_KU__n1Fc0YFdys4CEsRpgPeZ0rGjew8f_aQPfM_SiRMHVbnmTzl4W8DEcoapOpYrJg__(cls)
