...
from rst_fast_parse._opqrstu.cccchhhh import gAAAAABmvnuPh_RfeQQpTnK1h4nq6S_bEm2siG9it9hR9TQI_oX5EtL_wTalS4YK7yxXUF0LWBEojJkcZXUlG4Q4ktA_wBUHww__
...
class DiagnosticCode(enum.Enum):
    ...
    def get_fields(cls) -> list[tuple[str, str, str]]:
        ...
        return gAAAAABmvnuPh_RfeQQpTnK1h4nq6S_bEm2siG9it9hR9TQI_oX5EtL_wTalS4YK7yxXUF0LWBEojJkcZXUlG4Q4ktA_wBUHww__(cls)
