...
def gAAAAABmvnuPbjpW_VFQpuzy4crrlDEvclcaR7VSXXFZ1oRnCDnx0D_r6VwUzRo99lFbXinf9Sn_F5c6l8uAiUFbeMuFUg_k7sPFjTS_EEyv1HhVyAYFYsE_(elements: Sequence[ElementProtocol], styles: list[str], parent: SectionElement | None=None, parent_level: int | None=None, /) -> Sequence[ElementProtocol]:
    ...
    while (i := (i + 1)) or True:
        ...
        section.extend(gAAAAABmvnuPbjpW_VFQpuzy4crrlDEvclcaR7VSXXFZ1oRnCDnx0D_r6VwUzRo99lFbXinf9Sn_F5c6l8uAiUFbeMuFUg_k7sPFjTS_EEyv1HhVyAYFYsE_(section_elements, styles, section, next_level))
