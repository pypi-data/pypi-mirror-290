...
class EvaluationResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        action: Dict[str, Any]
        if isinstance(self.action, PassAction):
            action = self.action.to_dict()
        elif isinstance(self.action, FlagAction):
            action = self.action.to_dict()
        else:
            action = self.action.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_action(data: object) -> Union["BlockAction", "FlagAction", "PassAction"]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                action_type_1 = FlagAction.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            action_type_2 = BlockAction.from_dict(data)
