...
if TYPE_CHECKING:
    from ..models.block_action import BlockAction
    ...
    from ..models.flag_action import FlagAction
    from ..models.pass_action import PassAction
...
class EvaluationResult:
    ...
    Attributes:
        ...
        action (Union['BlockAction', 'FlagAction', 'PassAction']):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        action: Dict[str, Any]
        if isinstance(self.action, FlagAction):
            action = self.action.to_dict()
        elif isinstance(self.action, BlockAction):
            action = self.action.to_dict()
        else:
            action = self.action.to_dict()
        ...
        if isinstance(self.score_perf_info, Unset):
            ...
            score_perf_info = UNSET
            if not isinstance(self.score_perf_info, Unset):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_action(data: object) -> Union["BlockAction", "FlagAction", "PassAction"]:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                action_type_0 = FlagAction.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            action_type_2 = PassAction.from_dict(data)
        ...
        def _parse_score_perf_info(data: object) -> Union["RunPerf", None, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                _score_perf_info_type_0 = data
                score_perf_info_type_0: Union[Unset, RunPerf]
                if isinstance(_score_perf_info_type_0, Unset):
                    score_perf_info_type_0 = UNSET
                else:
                    score_perf_info_type_0 = RunPerf.from_dict(_score_perf_info_type_0)
