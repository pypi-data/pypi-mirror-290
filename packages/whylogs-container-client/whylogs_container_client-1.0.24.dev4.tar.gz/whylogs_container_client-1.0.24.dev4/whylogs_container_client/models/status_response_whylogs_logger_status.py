...
T = TypeVar("T", bound="StatusResponseWhylogsLoggerStatus")


@_attrs_define
class StatusResponseWhylogsLoggerStatus:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        status_response_whylogs_logger_status = cls()
        ...
        status_response_whylogs_logger_status.additional_properties = additional_properties
        return status_response_whylogs_logger_status
