...
T = TypeVar("T", bound="DebugLLMValidateRequestAdditionalData")


@_attrs_define
class DebugLLMValidateRequestAdditionalData:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        debug_llm_validate_request_additional_data = cls()
        ...
        debug_llm_validate_request_additional_data.additional_properties = additional_properties
        return debug_llm_validate_request_additional_data
