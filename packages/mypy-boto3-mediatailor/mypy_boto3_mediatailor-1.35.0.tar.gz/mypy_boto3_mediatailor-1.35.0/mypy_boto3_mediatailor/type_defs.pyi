...
__all__ = (
    ...
    "TimestampTypeDef",
    "PrefetchRetrievalExtraOutputTypeDef",
    ...
    "PrefetchConsumptionExtraOutputTypeDef",
...
PrefetchRetrievalExtraOutputTypeDef = TypedDict(
    "PrefetchRetrievalExtraOutputTypeDef",
    {
        "EndTime": datetime,
        "DynamicVariables": NotRequired[Dict[str, str]],
...
PrefetchConsumptionExtraOutputTypeDef = TypedDict(
    "PrefetchConsumptionExtraOutputTypeDef",
    {
        "EndTime": datetime,
...
PrefetchConsumptionUnionTypeDef = Union[
    PrefetchConsumptionTypeDef, PrefetchConsumptionExtraOutputTypeDef
]
...
PrefetchRetrievalUnionTypeDef = Union[PrefetchRetrievalTypeDef, PrefetchRetrievalExtraOutputTypeDef]
