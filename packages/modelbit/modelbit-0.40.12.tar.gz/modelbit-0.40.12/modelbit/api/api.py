...
from modelbit.utils import sizeOfFmt, dumpJson
...
def makeRetry() -> 'Retry':
  from requests.adapters import Retry
  try:
    return Retry(total=5, backoff_factor=0.1, status_forcelist=[500, 502, 503, 504], allowed_methods=None)
...
class MbApi:
  ...
  DEFAULT_CLUSTER = "app.modelbit.com"
