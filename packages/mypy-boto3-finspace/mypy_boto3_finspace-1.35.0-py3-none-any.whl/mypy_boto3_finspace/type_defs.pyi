...
__all__ = (
    ...
    "TransitGatewayConfigurationExtraOutputTypeDef",
...
KxDatabaseConfigurationTypeDef = TypedDict(
    "KxDatabaseConfigurationTypeDef",
    {
        ...
        "changesetId": NotRequired[str],
        "dataviewName": NotRequired[str],
        "dataviewConfiguration": NotRequired[KxDataviewConfigurationTypeDef],
    },
)
...
TransitGatewayConfigurationExtraOutputTypeDef = TypedDict(
    "TransitGatewayConfigurationExtraOutputTypeDef",
    {
...
TransitGatewayConfigurationUnionTypeDef = Union[
    TransitGatewayConfigurationTypeDef, TransitGatewayConfigurationExtraOutputTypeDef
]
