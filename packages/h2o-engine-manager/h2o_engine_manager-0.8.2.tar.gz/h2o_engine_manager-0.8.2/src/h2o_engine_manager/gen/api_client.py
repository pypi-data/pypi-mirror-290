...
from h2o_engine_manager.gen import rest
from h2o_engine_manager.gen.configuration import Configuration
from h2o_engine_manager.gen.exceptions import ApiTypeError, ApiValueError, ApiException
from h2o_engine_manager.gen.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/0.8.2/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AdjustedDAIProfileServiceApi()
        api_instance.adjusted_dai_profile_service_get_adjusted_dai_profile  # this is an instance of the class Endpoint
        api_instance.adjusted_dai_profile_service_get_adjusted_dai_profile()  # this invokes api_instance.adjusted_dai_profile_service_get_adjusted_dai_profile.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.adjusted_dai_profile_service_get_adjusted_dai_profile.callable or self.callable in this class
