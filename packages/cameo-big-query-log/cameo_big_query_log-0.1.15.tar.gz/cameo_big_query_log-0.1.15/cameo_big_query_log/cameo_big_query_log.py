...
class BigQueryLogger:
        ...
        for key in data.keys():
            if key not in existing_fields:
                ...
                if isinstance(data[key], int):
                    ...
                    field_type = "BOOLEAN"
                new_fields.append(bigquery.SchemaField(key, field_type, description=f"{key} description"))
    ...
    def caculate_character_count(self, user_data: dict):
        ...
        action_details = ast.literal_eval(f"'{action_details}'")
        ...
        total_count = len(action_details)-2
