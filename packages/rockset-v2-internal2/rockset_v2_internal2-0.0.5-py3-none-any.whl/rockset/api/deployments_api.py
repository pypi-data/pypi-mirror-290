...
class Deployments(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_allowed_deployments_endpoint = _Endpoint(
            settings={
                'response_type': (ListAllowedDeploymentsResponse,),
                'auth': [
                    'apikey'
                ],
                'endpoint_path': '/v1/deployments/allowed',
                'operation_id': 'list_allowed_deployments',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
...
```
    ...
    def list_allowed_deployments(
        self,
        **kwargs
    ) -> typing.Union[ListAllowedDeploymentsResponse, asyncio.Future]:
        """List deployments allowed by the azure groups the logged in user belong to  # noqa: E501
...
```python
rs = RocksetClient(api_key=APIKEY)
future = rs.Deployments.list_allowed_deployments(
    async_req=True,
)
result = await future
```
        ...
        Returns:
            ListAllowedDeploymentsResponse
                If the method is called asynchronously, returns an asyncio.Future which resolves to the response.
        """
        kwargs['async_req'] = kwargs.get(
            'async_req', False
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_allowed_deployments_endpoint.call_with_http_info(**kwargs)
...
future = rs.Deployments.provision_deployment(
    azure_security_group="046b6c7f-0b8a-43b9-b35d-6489e6daee91",
...
```
        ...
        Keyword Args:
            azure_security_group (str): The azure security group this deployment should be owned by. [optional]
