...
def threadpool(f):
    ...
    def wrap(*args, **kwargs):
        if kwargs["async_req"] == True:
            return asyncio.wrap_future((kwargs["executor"]).submit(f, *args, **kwargs))
        else:
...
class ApiClient(object):
    ...
    :param cookie: a cookie to include in the header when making calls
        to the API.
    :param max_workers: The max number of worker threads that ThreadPoolExecutor
        can use to make async requests.
    """

    def __init__(self, configuration=None, header_name=None, header_value=None,
                 cookie=None, max_workers=1):
    ...
    def call_api(
        ...
        return self.__call_api(resource_path, method,
                            ...
                            _check_type, async_req=async_req, executor=self.executor)
