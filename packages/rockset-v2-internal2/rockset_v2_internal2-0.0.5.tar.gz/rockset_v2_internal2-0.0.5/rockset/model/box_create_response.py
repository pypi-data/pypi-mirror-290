...
class BoxCreateResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, box, *args, **kwargs):  # noqa: E501
        """BoxCreateResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, *, box, **kwargs):  # noqa: E501
        """BoxCreateResponse - a model defined in OpenAPI
