...
class Configuration(object):
    ...
    def __init__(self, host: str=None,
                 ...
                 ssl_ca_cert=None, retries=None,
                 ):
        """Constructor
        """
        self._base_path = "https://api.usw2a1.rockset.com" if host is None else host
        """Default Base url
        """
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://api.{region}.rockset.com",
                'description': "No description provided",
                'variables': {
                    'region': {
                        'description': "No description provided",
                        'default_value': "usw2a1",
                        'enum_values': [
                            "usw2a1",
                            "use1a1",
                            "euc1a1",
