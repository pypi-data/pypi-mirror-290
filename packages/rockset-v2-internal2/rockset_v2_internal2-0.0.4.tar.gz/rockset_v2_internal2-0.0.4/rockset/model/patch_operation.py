...
class PatchOperation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, op, path, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            value ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Value used in the patch operation. Required for `ADD`, `REPLACE`, and `TEST` operations.. [optional]  # noqa: E501
        """
