...
class ReplanApi:
    ...
    @validate_call
    def cancel_replan_calculation(
        self,
        process_code: Annotated[StrictStr, Field(description="Unique process identifier.")],
        ...
        _param = self._cancel_replan_calculation_serialize(
    ...
    @validate_call
    def cancel_replan_calculation_with_http_info(
        self,
        process_code: Annotated[StrictStr, Field(description="Unique process identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cancel_replan_calculation_without_preload_content(
        self,
        process_code: Annotated[StrictStr, Field(description="Unique process identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _cancel_replan_calculation_serialize(
        self,
        process_code,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/universal/replan/calculation-async/{process_code}',
    ...
    def delete_replan_result(
        ...
        _param = self._delete_replan_result_serialize(
            process_code=process_code,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_replan_result_with_http_info(
        self,
        process_code: Annotated[StrictStr, Field(description="Unique process identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_replan_result_without_preload_content(
        self,
        process_code: Annotated[StrictStr, Field(description="Unique process identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_replan_result_serialize(
        self,
        process_code,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/universal/replan/result/{process_code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def read_replan_result(
        ...
        _param = self._read_replan_result_serialize(
            process_code=process_code,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_replan_result_with_http_info(
        self,
        process_code: Annotated[StrictStr, Field(description="Unique process identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def read_replan_result_without_preload_content(
        self,
        process_code: Annotated[StrictStr, Field(description="Unique process identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _read_replan_result_serialize(
        self,
        process_code,
        _request_auth,
        _content_type,
    ...
    def read_replan_state(
        ...
        _param = self._read_replan_state_serialize(
            process_code=process_code,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_replan_state_with_http_info(
        self,
        process_code: Annotated[StrictStr, Field(description="Unique process identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def read_replan_state_without_preload_content(
        self,
        process_code: Annotated[StrictStr, Field(description="Unique process identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _read_replan_state_serialize(
        self,
        process_code,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/universal/replan/state/{process_code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def run_replan_calculation(
        self,
        replan_task: Annotated[ReplanTask, Field(description="New replanning request.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Sync method for trips replanning.  Use only for testing and manual plannings.  For production use [async method](#operation/run_replan_calculation_async). 
        ...
        _param = self._run_replan_calculation_serialize(
    ...
    @validate_call
    def run_replan_calculation_with_http_info(
        self,
        replan_task: Annotated[ReplanTask, Field(description="New replanning request.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def run_replan_calculation_without_preload_content(
        self,
        replan_task: Annotated[ReplanTask, Field(description="New replanning request.")],
        _request_timeout: Union[
            None,
    ...
    def _run_replan_calculation_serialize(
        self,
        replan_task,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/universal/replan/calculation',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def run_replan_calculation_async(
        self,
        replan_task: Annotated[ReplanTask, Field(description="Launching the asynchronous replanning.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._run_replan_calculation_async_serialize(
            replan_task=replan_task,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def run_replan_calculation_async_with_http_info(
        self,
        replan_task: Annotated[ReplanTask, Field(description="Launching the asynchronous replanning.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def run_replan_calculation_async_without_preload_content(
        self,
        replan_task: Annotated[ReplanTask, Field(description="Launching the asynchronous replanning.")],
        _request_timeout: Union[
            None,
    ...
    def _run_replan_calculation_async_serialize(
        self,
        replan_task,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/universal/replan/calculation-async',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def run_replan_refine(
        self,
        replan_task: Annotated[ReplanTask, Field(description="Data for refine.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._run_replan_refine_serialize(
            replan_task=replan_task,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def run_replan_refine_with_http_info(
        self,
        replan_task: Annotated[ReplanTask, Field(description="Data for refine.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def run_replan_refine_without_preload_content(
        self,
        replan_task: Annotated[ReplanTask, Field(description="Data for refine.")],
        _request_timeout: Union[
            None,
    ...
    def _run_replan_refine_serialize(
        self,
        replan_task,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/universal/replan/refine',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def run_replan_validation(
        self,
        replan_task: Annotated[ReplanTask, Field(description="Data for validation.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._run_replan_validation_serialize(
            replan_task=replan_task,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def run_replan_validation_with_http_info(
        self,
        replan_task: Annotated[ReplanTask, Field(description="Data for validation.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def run_replan_validation_without_preload_content(
        self,
        replan_task: Annotated[ReplanTask, Field(description="Data for validation.")],
        _request_timeout: Union[
            None,
    ...
    def _run_replan_validation_serialize(
        self,
        replan_task,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/universal/replan/validation',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
