...
class PlanApi:
    ...
    def _cancel_plan_calculation_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/universal/plan/calculation-async/{process_code}',
    ...
    def _delete_plan_result_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/universal/plan/result/{process_code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _read_plan_state_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/universal/plan/state/{process_code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def run_plan_calculation(
        self,
        plan_task: Annotated[PlanTask, Field(description="New planning request.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _run_plan_calculation_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/universal/plan/calculation',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def run_plan_calculation_async(
        self,
        plan_task: Annotated[PlanTask, Field(description="Launching the asynchronous planning.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _run_plan_calculation_async_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/universal/plan/calculation-async',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def run_plan_refine(
        self,
        plan_task: Annotated[PlanTask, Field(description="Data for refine.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param plan_task: Data for refine. (required)
        :type plan_task: PlanTask
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._run_plan_refine_serialize(
            plan_task=plan_task,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def run_plan_refine_with_http_info(
        self,
        plan_task: Annotated[PlanTask, Field(description="Data for refine.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def run_plan_refine_without_preload_content(
        self,
        plan_task: Annotated[PlanTask, Field(description="Data for refine.")],
        _request_timeout: Union[
            None,
    ...
    def _run_plan_refine_serialize(
        self,
        plan_task,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/universal/plan/refine',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def run_plan_validation(
        self,
        plan_task: Annotated[PlanTask, Field(description="Data for validation.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _run_plan_validation_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/universal/plan/validation',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
