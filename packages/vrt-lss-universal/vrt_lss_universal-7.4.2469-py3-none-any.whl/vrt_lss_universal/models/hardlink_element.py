...
class HardlinkElement(BaseModel):
    ...
    entity_key: Annotated[str, Field(min_length=1, strict=True, max_length=1024)] = Field(description="Key of the target entity (an order or a shift).")
    __properties: ClassVar[List[str]] = ["type", "entity_key"]
