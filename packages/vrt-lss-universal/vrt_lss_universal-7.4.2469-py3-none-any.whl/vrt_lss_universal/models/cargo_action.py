...
class CargoAction(BaseModel):
    """
    Action with a cargo.
    """ # noqa: E501
    box_key: Annotated[str, Field(min_length=1, strict=True, max_length=1024)] = Field(description="Box key.")
    cargo_key: Annotated[str, Field(min_length=1, strict=True, max_length=1024)] = Field(description="Cargo key.")
    cargo_action_type: CargoActionType
    __properties: ClassVar[List[str]] = ["box_key", "cargo_key", "cargo_action_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CargoAction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CargoAction from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "cargo_action_type": obj.get("cargo_action_type")
        })
        return _obj
