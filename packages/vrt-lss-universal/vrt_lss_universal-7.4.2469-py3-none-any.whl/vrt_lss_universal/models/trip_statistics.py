...
class TripStatistics(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["trip_key", "general_statistics", "load_statistics", "stop_statistics"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of general_statistics
        if self.general_statistics:
            _dict['general_statistics'] = self.general_statistics.to_dict()
        # override the default output from pydantic by calling `to_dict()` of load_statistics
        if self.load_statistics:
            _dict['load_statistics'] = self.load_statistics.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "general_statistics": GeneralStatistics.from_dict(obj["general_statistics"]) if obj.get("general_statistics") is not None else None,
            "load_statistics": LoadStatistics.from_dict(obj["load_statistics"]) if obj.get("load_statistics") is not None else None,
