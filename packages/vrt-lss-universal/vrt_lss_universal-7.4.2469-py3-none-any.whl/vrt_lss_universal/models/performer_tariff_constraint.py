...
class PerformerTariffConstraint(BaseModel):
    ...
    """ # noqa: E501
    stage_length: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=16)]] = Field(default='P30D', description="Length of the paid period according to [ISO 8601 duration](https://en.wikipedia.org/wiki/ISO_8601#Durations).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "stage_length": obj.get("stage_length") if obj.get("stage_length") is not None else 'P30D',
