...
class PossibleEvent(BaseModel):
    ...
    reward: Optional[Union[Annotated[float, Field(le=1000000000, strict=True, ge=0)], Annotated[int, Field(le=1000000000, strict=True, ge=0)]]] = Field(default=1000.1, description="Reward for completing this event.")
