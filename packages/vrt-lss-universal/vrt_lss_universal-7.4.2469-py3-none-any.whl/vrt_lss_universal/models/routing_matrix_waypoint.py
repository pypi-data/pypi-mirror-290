...
class RoutingMatrixWaypoint(BaseModel):
    """
    Routing matrix waypoint. 
    """ # noqa: E501
    geopoint: Geopoint
    name: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1024)]] = Field(default=None, description="Name of the point. Can be used as an identifier to match the task and the calculation result. ")
    __properties: ClassVar[List[str]] = ["geopoint", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RoutingMatrixWaypoint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RoutingMatrixWaypoint from a dict"""
        if obj is None:
            return None
