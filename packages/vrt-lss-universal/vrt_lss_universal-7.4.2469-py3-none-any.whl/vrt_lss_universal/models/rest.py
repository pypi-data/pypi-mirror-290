...
class Rest(BaseModel):
    ...
    """ # noqa: E501
    relocating_duration_sum: Annotated[str, Field(min_length=3, strict=True, max_length=16)] = Field(description="Time duration according to [ISO 8601 duration](https://en.wikipedia.org/wiki/ISO_8601#Durations).")
    operating_duration_sum: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=16)]] = Field(default=None, description="Time duration according to [ISO 8601 duration](https://en.wikipedia.org/wiki/ISO_8601#Durations).")
    ...
    __properties: ClassVar[List[str]] = ["relocating_duration_sum", "operating_duration_sum", "duration"]

    @field_validator('relocating_duration_sum')
    def relocating_duration_sum_validate_regular_expression(cls, value):
    ...
    @field_validator('operating_duration_sum')
    def operating_duration_sum_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Rest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if operating_duration_sum (nullable) is None
        # and model_fields_set contains the field
        if self.operating_duration_sum is None and "operating_duration_sum" in self.model_fields_set:
            _dict['operating_duration_sum'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Rest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "relocating_duration_sum": obj.get("relocating_duration_sum") if obj.get("relocating_duration_sum") is not None else 'PT0S',
            "operating_duration_sum": obj.get("operating_duration_sum"),
