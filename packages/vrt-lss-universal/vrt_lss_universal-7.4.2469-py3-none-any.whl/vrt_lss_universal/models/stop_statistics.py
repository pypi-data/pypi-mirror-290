...
class StopStatistics(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["location_key", "stop_demands", "stop_time_window", "measurements", "upload", "download", "max_load", "arrival_load", "departure_load"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.stop_demands:
            for _item in self.stop_demands:
                if _item:
