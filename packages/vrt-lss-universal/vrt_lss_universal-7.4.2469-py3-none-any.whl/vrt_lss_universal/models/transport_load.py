...
class TransportLoad(BaseModel):
    ...
    """ # noqa: E501
    count: Annotated[int, Field(le=15001, strict=True, ge=0)] = Field(description="Number of orders.")
    capacity: CapacityStatisticsSum
    __properties: ClassVar[List[str]] = ["count", "capacity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "capacity": CapacityStatisticsSum.from_dict(obj["capacity"]) if obj.get("capacity") is not None else None
        })
        return _obj
