...
class TransportCapacityMultiplier(BaseModel):
    """
    Capacity change rate for the specified transport type.
    """ # noqa: E501
    transport_type: TransportType
    capacity: CapacityMultiplier
    __properties: ClassVar[List[str]] = ["transport_type", "capacity"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransportCapacityMultiplier from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransportCapacityMultiplier from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "capacity": CapacityMultiplier.from_dict(obj["capacity"]) if obj.get("capacity") is not None else None
        })
        return _obj
