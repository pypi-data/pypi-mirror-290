...
class TripState(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["time", "order_key", "demand_key", "event_key", "location_key", "flags", "cargo_actions", "attributes"]
