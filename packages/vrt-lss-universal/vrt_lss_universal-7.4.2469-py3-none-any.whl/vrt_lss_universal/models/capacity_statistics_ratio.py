...
class CapacityStatisticsRatio(BaseModel):
    """
    Statistics on capacity characteristics (ratio).  It may be more than one.
    """ # noqa: E501
    mass: Union[Annotated[float, Field(le=1000, strict=True, ge=0)], Annotated[int, Field(le=1000, strict=True, ge=0)]] = Field(description="Loading by mass, in fractions of a unit.")
    volume: Union[Annotated[float, Field(le=1000, strict=True, ge=0)], Annotated[int, Field(le=1000, strict=True, ge=0)]] = Field(description="Loading by volume, in fractions of a unit.")
    capacity_a: Union[Annotated[float, Field(le=1000, strict=True, ge=0)], Annotated[int, Field(le=1000, strict=True, ge=0)]] = Field(description="Loading by additional parameter (A), in fractions of a unit.")
    capacity_b: Union[Annotated[float, Field(le=1000, strict=True, ge=0)], Annotated[int, Field(le=1000, strict=True, ge=0)]] = Field(description="Loading by additional parameter (B), in fractions of a unit.")
    capacity_c: Union[Annotated[float, Field(le=1000, strict=True, ge=0)], Annotated[int, Field(le=1000, strict=True, ge=0)]] = Field(description="Loading by additional parameter (C), in fractions of a unit.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CapacityStatisticsRatio from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CapacityStatisticsRatio from a dict"""
        if obj is None:
            return None
