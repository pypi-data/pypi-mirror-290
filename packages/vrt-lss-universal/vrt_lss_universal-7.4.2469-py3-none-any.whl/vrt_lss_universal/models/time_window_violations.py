...
class TimeWindowViolations(BaseModel):
    ...
    """ # noqa: E501
    before: TimeWindowViolationDetail
    after: TimeWindowViolationDetail
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "before": TimeWindowViolationDetail.from_dict(obj["before"]) if obj.get("before") is not None else None,
            "after": TimeWindowViolationDetail.from_dict(obj["after"]) if obj.get("after") is not None else None
        })
        return _obj
