...
class PerformerShift(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["key", "availability_time", "working_time", "start_location_key", "finish_location_key", "max_locations", "max_stops", "tariff", "work_and_rest_rules", "attributes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if work_and_rest_rules (nullable) is None
        # and model_fields_set contains the field
        if self.work_and_rest_rules is None and "work_and_rest_rules" in self.model_fields_set:
            _dict['work_and_rest_rules'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tariff": PerformerTariff.from_dict(obj["tariff"]) if obj.get("tariff") is not None else None,
            "work_and_rest_rules": WorkAndRestRules.from_dict(obj["work_and_rest_rules"]) if obj.get("work_and_rest_rules") is not None else None,
