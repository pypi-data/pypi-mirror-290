...
class RestRules(BaseModel):
    ...
    """ # noqa: E501
    consecutive: Optional[Rest]
    __properties: ClassVar[List[str]] = ["consecutive"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RestRules from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RestRules from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "consecutive": Rest.from_dict(obj["consecutive"]) if obj.get("consecutive") is not None else None
        })
        return _obj
