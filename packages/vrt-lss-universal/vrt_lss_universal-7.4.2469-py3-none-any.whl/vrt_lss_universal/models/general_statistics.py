...
class GeneralStatistics(BaseModel):
    ...
    locations_count: Annotated[int, Field(le=15001000, strict=True, ge=0)] = Field(description="The total number of unique locations within one trip.")
    ...
    round_trips_count: Annotated[int, Field(le=15001, strict=True, ge=0)] = Field(description="Number of round-trips within a trip.")
    __properties: ClassVar[List[str]] = ["cost", "reward", "profit", "measurements", "trips_count", "performers_count", "orders_count", "plan_orders_count", "waitlist_orders_count", "stops_count", "locations_count", "cargo_capacity_sum", "cargo_capacity_ratio", "max_transport_load", "average_speed", "round_trips_count"]
