...
class CapacityLimit(BaseModel):
    ...
    Capacity limits.
    """ # noqa: E501
    mass: Union[Annotated[float, Field(le=1000000000, strict=True, ge=0)], Annotated[int, Field(le=1000000000, strict=True, ge=0)]] = Field(description="Weight in kilograms.")
    volume: Union[Annotated[float, Field(le=1000000000, strict=True, ge=0)], Annotated[int, Field(le=1000000000, strict=True, ge=0)]] = Field(description="Volume in cubic meters.")
    capacity_a: Union[Annotated[float, Field(le=1000000000, strict=True, ge=0)], Annotated[int, Field(le=1000000000, strict=True, ge=0)]] = Field(description="Additional parameter (A) for measuring cargoes and boxes in alternative units.")
    capacity_b: Union[Annotated[float, Field(le=1000000000, strict=True, ge=0)], Annotated[int, Field(le=1000000000, strict=True, ge=0)]] = Field(description="Additional parameter (B) for measuring cargoes and boxes in alternative units.")
    capacity_c: Union[Annotated[float, Field(le=1000000000, strict=True, ge=0)], Annotated[int, Field(le=1000000000, strict=True, ge=0)]] = Field(description="Additional parameter (C) for measuring cargoes and boxes in alternative units.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CapacityLimit from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CapacityLimit from a dict"""
        if obj is None:
            return None
