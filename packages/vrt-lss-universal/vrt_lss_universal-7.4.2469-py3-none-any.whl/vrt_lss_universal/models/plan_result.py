...
class PlanResult(BaseModel):
    ...
    """ # noqa: E501
    tracedata: Tracedata
    trips: Annotated[List[Trip], Field(min_length=0, max_length=15001)] = Field(description="Trip list. A trip is a set of works planned to be performed by a specific performer on a specific transport, expressed through a [change in the states](#section/Description/Trip-model) of the performer. ")
    ...
    __properties: ClassVar[List[str]] = ["tracedata", "trips", "statistics", "warnings", "unplanned_items", "removed_items", "calculation_progress", "calculation_info"]
