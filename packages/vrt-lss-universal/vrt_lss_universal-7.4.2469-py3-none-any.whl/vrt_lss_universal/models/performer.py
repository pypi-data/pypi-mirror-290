...
class Performer(BaseModel):
    ...
    own_transport_type: Optional[TransportType] = TransportType.CAR
    ...
    __properties: ClassVar[List[str]] = ["key", "shifts", "own_transport_type", "compatibilities", "limits", "attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": obj.get("key"),
            "shifts": [PerformerShift.from_dict(_item) for _item in obj["shifts"]] if obj.get("shifts") is not None else None,
            "own_transport_type": obj.get("own_transport_type"),
            "compatibilities": PerformerCompatibilities.from_dict(obj["compatibilities"]) if obj.get("compatibilities") is not None else None,
            "limits": PerformerLimits.from_dict(obj["limits"]) if obj.get("limits") is not None else None,
