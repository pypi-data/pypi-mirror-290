...
class RefineResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tracedata", "plan_task", "warnings", "removed_items"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RefineResult from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of plan_task
        if self.plan_task:
            _dict['plan_task'] = self.plan_task.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RefineResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "plan_task": PlanTask.from_dict(obj["plan_task"]) if obj.get("plan_task") is not None else None,
