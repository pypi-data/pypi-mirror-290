...
class CapacityStatisticsSum(BaseModel):
    """
    Statistics on capacity characteristics.
    """ # noqa: E501
    mass: Union[Annotated[float, Field(le=1000000000, strict=True, ge=0)], Annotated[int, Field(le=1000000000, strict=True, ge=0)]] = Field(description="Total weight in kilograms.")
    volume: Union[Annotated[float, Field(le=1000000000, strict=True, ge=0)], Annotated[int, Field(le=1000000000, strict=True, ge=0)]] = Field(description="Total volume in cubic meters.")
    capacity_a: Union[Annotated[float, Field(le=1000000000, strict=True, ge=0)], Annotated[int, Field(le=1000000000, strict=True, ge=0)]] = Field(description="Amount for additional parameter (A) for measuring loads in alternative units of measurement.")
    capacity_b: Union[Annotated[float, Field(le=1000000000, strict=True, ge=0)], Annotated[int, Field(le=1000000000, strict=True, ge=0)]] = Field(description="Amount for additional parameter (B) for measuring loads in alternative units of measurement.")
    capacity_c: Union[Annotated[float, Field(le=1000000000, strict=True, ge=0)], Annotated[int, Field(le=1000000000, strict=True, ge=0)]] = Field(description="Amount for additional parameter (C) for measuring loads in alternative units of measurement.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CapacityStatisticsSum from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CapacityStatisticsSum from a dict"""
        if obj is None:
            return None
