...
class ReplanSettings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["replan_strategy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "replan_strategy": ReplanStrategy.from_dict(obj["replan_strategy"]) if obj.get("replan_strategy") is not None else None
        })
        return _obj
