...
class Chamber(BaseModel):
    ...
    productivity_forecast: Annotated[List[ProductivityForecastElement], Field(min_length=0, max_length=3653)] = Field(description="Productivity forecast.")
    ...
    __properties: ClassVar[List[str]] = ["crop_key", "capacity_forecast", "productivity_forecast", "cost_forecast"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "productivity_forecast": [ProductivityForecastElement.from_dict(_item) for _item in obj["productivity_forecast"]] if obj.get("productivity_forecast") is not None else None,
