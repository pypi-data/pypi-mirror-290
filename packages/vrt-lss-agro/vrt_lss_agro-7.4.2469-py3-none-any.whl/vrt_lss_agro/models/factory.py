...
class Factory(BaseModel):
    ...
    bunkers: Annotated[List[Bunker], Field(min_length=1, max_length=501)] = Field(description="List of bunkers.")
    consumers: Annotated[List[Consumer], Field(min_length=1, max_length=501)] = Field(description="List of consumption.")
    ...
    __properties: ClassVar[List[str]] = ["key", "gate", "dryers", "bunkers", "consumers", "attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bunkers": [Bunker.from_dict(_item) for _item in obj["bunkers"]] if obj.get("bunkers") is not None else None,
