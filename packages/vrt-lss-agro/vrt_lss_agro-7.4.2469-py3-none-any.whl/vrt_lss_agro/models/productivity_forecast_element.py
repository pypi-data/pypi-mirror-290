...
class ProductivityForecastElement(BaseModel):
    """
    Value for time window.
    """ # noqa: E501
    date_window: DateWindow
    productivity: Union[Annotated[float, Field(le=10000000, strict=True, ge=0)], Annotated[int, Field(le=10000000, strict=True, ge=0)]] = Field(description="Productivity value.")
    __properties: ClassVar[List[str]] = ["date_window", "productivity"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProductivityForecastElement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProductivityForecastElement from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "productivity": obj.get("productivity")
        })
        return _obj
