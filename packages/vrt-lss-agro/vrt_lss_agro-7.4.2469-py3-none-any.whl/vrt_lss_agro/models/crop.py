...
class Crop(BaseModel):
    ...
    base_humidity: Annotated[int, Field(le=999, strict=True, ge=1)] = Field(description="Humidity crop, in ppm (‰).")
    compatible_storage_types: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=256)]], Field(min_length=0, max_length=10)]] = Field(default=None, description="List of compatible short-term storage types. ")
    compatible_silo_types: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=256)]], Field(min_length=0, max_length=10)]] = Field(default=None, description="List of compatible long-term storage types. ")
    ...
    __properties: ClassVar[List[str]] = ["key", "base_humidity", "compatible_storage_types", "compatible_silo_types", "attributes"]
