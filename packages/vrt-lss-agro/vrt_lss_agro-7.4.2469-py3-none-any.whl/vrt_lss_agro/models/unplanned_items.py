...
class UnplannedItems(BaseModel):
    ...
    """ # noqa: E501
    crop_keys: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=501)]] = Field(default=None, description="Unplanned crop keys.")
    field_keys: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=20001)]] = Field(default=None, description="Unplanned field keys.")
    elevator_keys: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=501)]] = Field(default=None, description="Unplanned elevator keys.")
    factory_keys: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=501)]] = Field(default=None, description="Unplanned factory keys.")
    market_keys: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=501)]] = Field(default=None, description="Unplanned market keys.")
    __properties: ClassVar[List[str]] = ["crop_keys", "field_keys", "elevator_keys", "factory_keys", "market_keys"]
