...
class Pricelist(BaseModel):
    ...
    """ # noqa: E501
    crop_key: Annotated[str, Field(min_length=1, strict=True, max_length=1024)] = Field(description="Target key.")
    price_forecast: Annotated[List[PriceForecastElement], Field(min_length=0, max_length=3653)] = Field(description="Prices tied to the dates at which the market uys\\sells the specified crop.")
    capacity_forecast: Optional[Annotated[List[CapacityForecastElement], Field(min_length=0, max_length=3653)]] = Field(default=None, description="Capacity forecast.")
    __properties: ClassVar[List[str]] = ["crop_key", "price_forecast", "capacity_forecast"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "price_forecast": [PriceForecastElement.from_dict(_item) for _item in obj["price_forecast"]] if obj.get("price_forecast") is not None else None,
