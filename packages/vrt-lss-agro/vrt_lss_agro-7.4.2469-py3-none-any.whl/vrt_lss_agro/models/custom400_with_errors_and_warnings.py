...
class Custom400WithErrorsAndWarnings(BaseModel):
    ...
    logical_errors: Optional[Annotated[List[EntityError], Field(min_length=0, max_length=100001)]] = Field(default=None, description="A list of errors in the source data that make it impossible to start the calculation. ")
