...
class Market(BaseModel):
    ...
    contracts: Annotated[List[Contract], Field(min_length=0, max_length=50)] = Field(description="List of contracts. ")
    ...
    __properties: ClassVar[List[str]] = ["key", "contracts", "attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": obj.get("key"),
            "contracts": [Contract.from_dict(_item) for _item in obj["contracts"]] if obj.get("contracts") is not None else None,
