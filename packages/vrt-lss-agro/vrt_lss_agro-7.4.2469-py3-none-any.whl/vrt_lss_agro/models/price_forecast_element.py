...
class PriceForecastElement(BaseModel):
    """
    Grain price forecast for the specified date.
    """ # noqa: E501
    date_window: DateWindow
    price: Annotated[int, Field(le=10000000, strict=True, ge=0)] = Field(description="Value.")
    __properties: ClassVar[List[str]] = ["date_window", "price"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PriceForecastElement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PriceForecastElement from a dict"""
        if obj is None:
            return None
