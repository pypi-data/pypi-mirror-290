...
class Contract(BaseModel):
    ...
    type: ContractType
    target_keys: Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=1, max_length=100)] = Field(description="List of production object keys. ")
    pricelist: Annotated[List[Pricelist], Field(min_length=0, max_length=50)] = Field(description="List of prices for the purchase and sale of agricultural crops. ")
    ...
    __properties: ClassVar[List[str]] = ["key", "type", "target_keys", "pricelist", "attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pricelist": [Pricelist.from_dict(_item) for _item in obj["pricelist"]] if obj.get("pricelist") is not None else None,
