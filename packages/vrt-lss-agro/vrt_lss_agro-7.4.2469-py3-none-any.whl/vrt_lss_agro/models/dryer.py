...
class Dryer(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["key", "chamber_variants", "attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": obj.get("key"),
            "chamber_variants": [Chamber.from_dict(_item) for _item in obj["chamber_variants"]] if obj.get("chamber_variants") is not None else None,
