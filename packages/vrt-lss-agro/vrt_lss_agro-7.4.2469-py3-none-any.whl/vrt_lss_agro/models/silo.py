...
class Silo(BaseModel):
    ...
    type: Annotated[str, Field(min_length=1, strict=True, max_length=256)] = Field(description="The type of long-term storage location.")
    ...
    deployment_cost: Optional[Annotated[int, Field(le=1000000, strict=True, ge=0)]] = Field(default=0, description="The total cost of deployment, in conventional monetary units. ")
    collapse_cost: Optional[Annotated[int, Field(le=1000000, strict=True, ge=0)]] = Field(default=0, description="The total cost of collapse, in conventional monetary units. ")
    ...
    __properties: ClassVar[List[str]] = ["key", "type", "capacity_forecast", "cost_forecast", "deployment_cost", "collapse_cost", "attributes"]
