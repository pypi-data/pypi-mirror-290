...
class Leftover(BaseModel):
    ...
    target_detail_key: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]] = Field(default=None, description="Target storage key.")
    amount: Annotated[int, Field(le=10000000, strict=True, ge=0)] = Field(description="Weight, in tn.")
    __properties: ClassVar[List[str]] = ["crop_key", "humidity", "target_key", "target_detail_key", "amount"]
