...
class SchemaError(BaseModel):
    ...
    """ # noqa: E501
    entity: Optional[Annotated[str, Field(strict=True, max_length=1024)]] = Field(description="Target entity identifier.")
    message: StrictStr = Field(description="Error message.")
    __properties: ClassVar[List[str]] = ["entity", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SchemaError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SchemaError from a dict"""
        if obj is None:
            return None
