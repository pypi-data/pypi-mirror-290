...
class CostForecastElement(BaseModel):
    """
    Cost for time window.
    """ # noqa: E501
    date_window: DateWindow
    cost: Annotated[int, Field(le=1000000, strict=True, ge=0)] = Field(description="The total cost, in conventional monetary units.")
    __properties: ClassVar[List[str]] = ["date_window", "cost"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CostForecastElement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CostForecastElement from a dict"""
        if obj is None:
            return None
