...
class CapacityForecastElement(BaseModel):
    ...
    capacity: Annotated[int, Field(le=10000000, strict=True, ge=0)] = Field(description="The maximum number of tons of grain that can be processed each day within the specified time window.")
    __properties: ClassVar[List[str]] = ["date_window", "capacity"]
