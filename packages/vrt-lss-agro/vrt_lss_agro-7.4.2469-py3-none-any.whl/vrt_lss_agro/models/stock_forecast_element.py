...
class StockForecastElement(BaseModel):
    """
    Humidity forecast, ppm (‰).
    """ # noqa: E501
    date_window: DateWindow
    min_stock_days: Annotated[int, Field(le=365, strict=True, ge=0)] = Field(description="Minimum time reserve - how many days in advance it is necessary to maintain the availability of crops in bins to ensure continuity of the consumption process. Current day consumption is not included in this parameter. ")
    __properties: ClassVar[List[str]] = ["date_window", "min_stock_days"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StockForecastElement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StockForecastElement from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "min_stock_days": obj.get("min_stock_days")
        })
        return _obj
