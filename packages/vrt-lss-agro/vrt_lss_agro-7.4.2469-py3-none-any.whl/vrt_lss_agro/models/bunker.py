...
class Bunker(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["key", "capacity_forecast", "cost_forecast", "attributes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Bunker from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Bunker from a dict"""
        if obj is None:
            return None
