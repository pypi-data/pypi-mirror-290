...
class MovementMatrixElement(BaseModel):
    ...
    """ # noqa: E501
    source_key: Annotated[str, Field(min_length=1, strict=True, max_length=1024)] = Field(description="Target key.")
    destination_key: Annotated[str, Field(min_length=1, strict=True, max_length=1024)] = Field(description="Target key.")
    distance: Annotated[int, Field(le=40000, strict=True, ge=0)] = Field(description="Total length, in km.")
    cost_per_transport: Optional[Annotated[int, Field(le=100000000, strict=True, ge=0)]] = Field(default=0, description="The total cost of usage 1 transport between source and destination, in conventional monetary units. ")
    __properties: ClassVar[List[str]] = ["source_key", "destination_key", "distance", "cost_per_transport"]
