...
class OperationMeasurements(BaseModel):
    ...
    cost: Union[Annotated[float, Field(le=1000000000000, strict=True, ge=-1000000000000)], Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]] = Field(description="The total cost of the operation, in conventional monetary units.")
    __properties: ClassVar[List[str]] = ["distance", "cost"]
