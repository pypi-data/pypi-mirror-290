...
class PlanSettings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["project_settings", "calculation_settings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "project_settings": ProjectSettings.from_dict(obj["project_settings"]) if obj.get("project_settings") is not None else None,
