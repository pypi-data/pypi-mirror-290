...
from vrt_lss_agro.api_response import ApiResponse, T as ApiResponseT
import vrt_lss_agro.models
from vrt_lss_agro import rest
from vrt_lss_agro.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI/7.4.2469/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(vrt_lss_agro.models, klass)
