...
from vrt_lss_agro.api_client import ApiClient, RequestSerialized
from vrt_lss_agro.api_response import ApiResponse
from vrt_lss_agro.rest import RESTResponseType
...
class PlanApi:
    ...
    def cancel_plan_calculation(
        ...
        _param = self._cancel_plan_calculation_serialize(
    ...
    @validate_call
    def cancel_plan_calculation_with_http_info(
        self,
        process_code: Annotated[StrictStr, Field(description="Unique process identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cancel_plan_calculation_without_preload_content(
        self,
        process_code: Annotated[StrictStr, Field(description="Unique process identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _cancel_plan_calculation_serialize(
        self,
        process_code,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/agro/plan/calculation-async/{process_code}',
    ...
    def delete_plan_result(
        ...
        _param = self._delete_plan_result_serialize(
            process_code=process_code,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_plan_result_with_http_info(
        self,
        process_code: Annotated[StrictStr, Field(description="Unique process identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_plan_result_without_preload_content(
        self,
        process_code: Annotated[StrictStr, Field(description="Unique process identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_plan_result_serialize(
        self,
        process_code,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/agro/plan/result/{process_code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def read_plan_result(
        ...
        _param = self._read_plan_result_serialize(
            process_code=process_code,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_plan_result_with_http_info(
        self,
        process_code: Annotated[StrictStr, Field(description="Unique process identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def read_plan_result_without_preload_content(
        self,
        process_code: Annotated[StrictStr, Field(description="Unique process identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _read_plan_result_serialize(
        self,
        process_code,
        _request_auth,
        _content_type,
    ...
    def read_plan_state(
        ...
        _param = self._read_plan_state_serialize(
            process_code=process_code,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_plan_state_with_http_info(
        self,
        process_code: Annotated[StrictStr, Field(description="Unique process identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def read_plan_state_without_preload_content(
        self,
        process_code: Annotated[StrictStr, Field(description="Unique process identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _read_plan_state_serialize(
        self,
        process_code,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/agro/plan/state/{process_code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def run_plan_calculation(
        self,
        plan_task: Annotated[PlanTask, Field(description="Data for calculation.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._run_plan_calculation_serialize(
            plan_task=plan_task,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def run_plan_calculation_with_http_info(
        self,
        plan_task: Annotated[PlanTask, Field(description="Data for calculation.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def run_plan_calculation_without_preload_content(
        self,
        plan_task: Annotated[PlanTask, Field(description="Data for calculation.")],
        _request_timeout: Union[
            None,
    ...
    def _run_plan_calculation_serialize(
        self,
        plan_task,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/agro/plan/calculation',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def run_plan_calculation_async(
        ...
        _param = self._run_plan_calculation_async_serialize(
            plan_task=plan_task,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def run_plan_calculation_async_with_http_info(
        self,
        plan_task: Annotated[PlanTask, Field(description="Data for calculation.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def run_plan_calculation_async_without_preload_content(
        self,
        plan_task: Annotated[PlanTask, Field(description="Data for calculation.")],
        _request_timeout: Union[
            None,
    ...
    def _run_plan_calculation_async_serialize(
        self,
        plan_task,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/agro/plan/calculation-async',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def run_plan_clip(
        self,
        clip_key: Annotated[str, Field(min_length=1, strict=True, max_length=1024, description="Target essence key.")],
        plan_task: Annotated[PlanTask, Field(description="Data for clipping.")],
        clip_strategy: Annotated[Optional[StrictStr], Field(description="Data clipping strategy.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._run_plan_clip_serialize(
            clip_key=clip_key,
            plan_task=plan_task,
    ...
    @validate_call
    def run_plan_clip_with_http_info(
        self,
        clip_key: Annotated[str, Field(min_length=1, strict=True, max_length=1024, description="Target essence key.")],
        plan_task: Annotated[PlanTask, Field(description="Data for clipping.")],
        clip_strategy: Annotated[Optional[StrictStr], Field(description="Data clipping strategy.")] = None,
    ...
    @validate_call
    def run_plan_clip_without_preload_content(
        self,
        clip_key: Annotated[str, Field(min_length=1, strict=True, max_length=1024, description="Target essence key.")],
        plan_task: Annotated[PlanTask, Field(description="Data for clipping.")],
        clip_strategy: Annotated[Optional[StrictStr], Field(description="Data clipping strategy.")] = None,
    ...
    def _run_plan_clip_serialize(
        ...
        if clip_key is not None:
            _path_params['clip_key'] = clip_key
        # process the query parameters
        if clip_strategy is not None:
            
            _query_params.append(('clip_strategy', clip_strategy))
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/agro/plan/clip/{clip_key}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def run_plan_validation(
        ...
        _param = self._run_plan_validation_serialize(
            plan_task=plan_task,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def run_plan_validation_with_http_info(
        self,
        plan_task: Annotated[PlanTask, Field(description="Data for calculation.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def run_plan_validation_without_preload_content(
        self,
        plan_task: Annotated[PlanTask, Field(description="Data for calculation.")],
        _request_timeout: Union[
            None,
    ...
    def _run_plan_validation_serialize(
        self,
        plan_task,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/agro/plan/validation',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
