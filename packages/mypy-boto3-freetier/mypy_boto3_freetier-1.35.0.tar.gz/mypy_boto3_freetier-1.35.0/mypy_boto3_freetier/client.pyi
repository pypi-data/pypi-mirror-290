...
class FreeTierClient(BaseClient):
    ...
    def close(self) -> None:
        ...
        [Show boto3-stubs documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_freetier/client/#close)
        """
    ...
    def get_free_tier_usage(
        self, *, filter: "ExpressionTypeDef" = ..., maxResults: int = ..., nextToken: str = ...
