...
class Connection:
    ...
    def __init__(self, url: str,
                 ...
                 header: Union[None, dict[str, str]] = None,
                 send_pong=False):
        """
    ...
    def _run_forever(self) -> None:
        while self.auto_reconnect:
            try:
                ...
                header: Union[list, dict, Callable[[], Any]] = []
                if self.auth is not None and hasattr(self.auth, 'headers'):
                    auth_headers = getattr(self.auth, 'headers')
