...
class SimMIM(PreTrainBaseNet):
    ...
    def __init__(
        ...
        assert (
            isinstance(self.encoder, Swin_Transformer_v2) is True
        ), "Only Swin Transformer v2 is supported as an encoder for this network"
        self.encoder: Swin_Transformer_v2
