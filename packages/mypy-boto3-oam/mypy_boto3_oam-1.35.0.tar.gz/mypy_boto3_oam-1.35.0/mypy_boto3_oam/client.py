...
class CloudWatchObservabilityAccessManagerClient(BaseClient):
    ...
    def close(self) -> None:
        ...
        [Show boto3-stubs documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_oam/client/#close)
        """
    ...
    def create_sink(self, *, Name: str, Tags: Mapping[str, str] = ...) -> CreateSinkOutputTypeDef:
        """
    ...
    def list_links(self, *, MaxResults: int = ..., NextToken: str = ...) -> ListLinksOutputTypeDef:
        """
    ...
    def list_sinks(self, *, MaxResults: int = ..., NextToken: str = ...) -> ListSinksOutputTypeDef:
        """
