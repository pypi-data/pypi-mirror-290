...
class Cluster(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int = 0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.9.0 fwBuild=30/07/2024-12:43:40 fwHash=0x80063CC5 fwDirty=0 kmodVersion=0.9.0 kmodBuild=07/08/2024-12:32:09 kmodHash=0xE5CDF960 kmodDirty=0 swVersion=0.9.0 swBuild=07/08/2024-12:32:09 swHash=0xE5CDF960 swDirty=0 cfgManVersion=0.3.0 cfgManBuild=07/08/2024-12:32:09 cfgManHash=0xE5CDF960 cfgManDirty=0"
            if build != build_ref:
    ...
    def _get_lo_hw_present(self, slot: int) -> bool:
        ...
        # SCPI call
        var0 = self._read(f"SLOT{slot}:LO:PRESent?")
