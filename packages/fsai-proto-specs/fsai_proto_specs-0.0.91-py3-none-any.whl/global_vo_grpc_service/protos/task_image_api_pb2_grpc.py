...
class TaskImageApiStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetAllTaskImagesFromTaskId = channel.unary_unary(
                '/TaskImageApi/GetAllTaskImagesFromTaskId',
                request_serializer=global__vo__grpc__service_dot_protos_dot_task__image__api__pb2.GetAllTaskImagesFromTaskIdRequest.SerializeToString,
                response_deserializer=global__vo__grpc__service_dot_protos_dot_task__image__api__pb2.GetAllTaskImagesFromTaskIdResponse.FromString,
                )
...
class TaskImageApiServicer(object):
    ...
    def GetAllTaskImagesFromTaskId(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_TaskImageApiServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetAllTaskImagesFromTaskId': grpc.unary_unary_rpc_method_handler(
                    servicer.GetAllTaskImagesFromTaskId,
                    request_deserializer=global__vo__grpc__service_dot_protos_dot_task__image__api__pb2.GetAllTaskImagesFromTaskIdRequest.FromString,
                    response_serializer=global__vo__grpc__service_dot_protos_dot_task__image__api__pb2.GetAllTaskImagesFromTaskIdResponse.SerializeToString,
            ),
...
class TaskImageApi(object):
    ...
    @staticmethod
    def GetAllTaskImagesFromTaskId(request,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/TaskImageApi/GetAllTaskImagesFromTaskId',
            global__vo__grpc__service_dot_protos_dot_task__image__api__pb2.GetAllTaskImagesFromTaskIdRequest.SerializeToString,
            global__vo__grpc__service_dot_protos_dot_task__image__api__pb2.GetAllTaskImagesFromTaskIdResponse.FromString,
