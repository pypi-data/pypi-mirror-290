...
class DatalakeClient:
    ...
    def get_item_details(self, unique_name: str, filter: dict):
        ...
        payload = {"uniqueFileName": unique_name, "requiredMetaObj": filter}
    ...
    """
    def find_elements_from_docs(self, unique_name_list: List[str], user_question: str):
        payload = {
    ...
    """
    def extract_doc_content(self, doc_elements: dict, extraction_keys: List[dict], user_question: str):
        payload = {
            "userQuestion": user_question,
    ...
    def insert_mongo_data(
        self, source_name, collection, data, request_id
    ):
        payload = {
            "sourceName": source_name,
    ...
    def delete_mongo_data(
        self, source_name, collection, filter_obj, request_id
    ):
        payload = {
            "sourceName": source_name,
            "collectionName": collection,
