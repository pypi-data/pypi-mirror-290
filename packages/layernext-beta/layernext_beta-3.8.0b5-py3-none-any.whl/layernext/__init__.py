...
class LayerNextClient:
    ...
    def get_documents_with_structure(self, doc_unique_name_list: list, user_question: str):
        ...
        document_element_dict = self.find_elements(unique_name_list=doc_unique_name_list, user_question=user_question)
    ...
    def find_elements(self, unique_name_list: List[str], user_question: str ):
        """
