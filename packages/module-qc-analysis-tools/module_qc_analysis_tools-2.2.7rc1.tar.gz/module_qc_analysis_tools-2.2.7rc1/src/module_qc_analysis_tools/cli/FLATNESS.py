...
from module_qc_analysis_tools.analysis.flatness import analyze
...
def main(
    ...
    """
    This analysis script performs QC criteria checks on the flatness measurement.
    """
    ...
    log.info("")
    log.info(" ===============================================")
    log.info(" \tPerforming Flatness analysis")
    log.info(" ===============================================")
    log.info("")
