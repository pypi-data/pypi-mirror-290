"""
Setup script for mypy-boto3-ec2-instance-connect.
"""
...
setup(
    ...
    description="Type annotations for boto3.EC2InstanceConnect 1.35.0 service generated with mypy-boto3-builder 7.26.0",
    classifiers=[
