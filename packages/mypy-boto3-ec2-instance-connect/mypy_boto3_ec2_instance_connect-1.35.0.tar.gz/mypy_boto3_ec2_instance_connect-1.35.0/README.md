...
[boto3.EC2InstanceConnect 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2-instance-connect.html#EC2InstanceConnect)
...
- Install `boto3-stubs[ec2-instance-connect]` in your environment:
...
Install `boto3-stubs-lite[ec2-instance-connect]` in your environment:
...
- Install `boto3-stubs[ec2-instance-connect]` with services you use in your
  environment:
...
`mypy_boto3_ec2_instance_connect.literals` module contains literals extracted
from shapes that can be used in user code for type checking.

Full list of `EC2InstanceConnect` Literals can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_ec2_instance_connect/literals/).
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_ec2_instance_connect/type_defs/).
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_ec2_instance_connect/)
