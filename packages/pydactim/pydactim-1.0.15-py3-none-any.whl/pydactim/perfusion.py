...
class SignalDSC():
    ...
    def solve_CBV(self, clip=True):
        ...
        self.save_image(self.CBV, "pf_CBV")

    def solve_CBF(self):
        self.CBF = np.max(self.TRF, axis=-1)
        self.CBF = self.hematocrit * self.CBF
        self.save_image(self.CBF * 60, "pf_CBF")

    def solve_MTT(self):
        self.MTT = self.CBV / (self.CBF + 1e-9)
        self.save_image(self.MTT, "pf_MTT")
    ...
    def solve_TTP(self):
        ...
        self.save_image(self.TTP, "pf_TTP")
    ...
    def solve_Tmax(self, threshold=6.):
        ...
        self.save_image(self.Tmax, "pf_Tmax")
    ...
    def save_image(self, volume, suffix):
        nib.save(
            ...
            self.dsc_path.replace(".nii", f"_{suffix}.nii")
        )
