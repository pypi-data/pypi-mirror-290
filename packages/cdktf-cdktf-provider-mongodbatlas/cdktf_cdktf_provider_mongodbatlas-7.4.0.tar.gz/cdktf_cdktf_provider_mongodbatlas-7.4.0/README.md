# CDKTF prebuilt bindings for mongodb/mongodbatlas provider version 1.18.0

This repo builds and publishes the [Terraform mongodbatlas provider](https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform mongodbatlas provider](https://registry.terraform.io/providers/mongodb/mongodbatlas/1.18.0)
