...
__all__ = (
    ...
    "TokenDataTypeDef",
    "ProductInformationFilterExtraOutputTypeDef",
    ...
    "ProductInformationExtraOutputTypeDef",
...
ProductInformationFilterExtraOutputTypeDef = TypedDict(
    "ProductInformationFilterExtraOutputTypeDef",
    {
...
ProductInformationExtraOutputTypeDef = TypedDict(
    "ProductInformationExtraOutputTypeDef",
    {
        "ResourceType": str,
        "ProductInformationFilterList": List[ProductInformationFilterExtraOutputTypeDef],
    },
)
...
ProductInformationUnionTypeDef = Union[
    ProductInformationTypeDef, ProductInformationExtraOutputTypeDef
]
