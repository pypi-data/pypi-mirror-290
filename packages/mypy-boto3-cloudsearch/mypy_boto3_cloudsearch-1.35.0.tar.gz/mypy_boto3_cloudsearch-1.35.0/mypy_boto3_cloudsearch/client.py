...
class CloudSearchClient(BaseClient):
    ...
    def close(self) -> None:
        ...
        [Show boto3-stubs documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_cloudsearch/client/#close)
        """
    ...
    def describe_analysis_schemes(
        self, *, DomainName: str, AnalysisSchemeNames: Sequence[str] = ..., Deployed: bool = ...
    ) -> DescribeAnalysisSchemesResponseTypeDef:
        """
    ...
    def describe_availability_options(
        self, *, DomainName: str, Deployed: bool = ...
    ) -> DescribeAvailabilityOptionsResponseTypeDef:
        """
    ...
    def describe_expressions(
        self, *, DomainName: str, ExpressionNames: Sequence[str] = ..., Deployed: bool = ...
    ) -> DescribeExpressionsResponseTypeDef:
        """
    ...
    def describe_index_fields(
        self, *, DomainName: str, FieldNames: Sequence[str] = ..., Deployed: bool = ...
    ) -> DescribeIndexFieldsResponseTypeDef:
        """
    ...
    def describe_suggesters(
        self, *, DomainName: str, SuggesterNames: Sequence[str] = ..., Deployed: bool = ...
    ) -> DescribeSuggestersResponseTypeDef:
        """
