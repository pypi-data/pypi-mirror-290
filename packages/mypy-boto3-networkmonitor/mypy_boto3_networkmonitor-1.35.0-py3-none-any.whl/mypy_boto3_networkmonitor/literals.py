...
[Open documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_networkmonitor/literals/)
...
__all__ = (
    ...
    "ProbeStateType",
    "ProtocolType",
    "CloudWatchNetworkMonitorServiceName",
    "ServiceName",
    "ResourceServiceName",
    "PaginatorName",
)
...
CloudWatchNetworkMonitorServiceName = Literal["networkmonitor"]
ServiceName = Literal[
    "accessanalyzer",
    "account",
    "acm",
...
PaginatorName = Literal["list_monitors"]
