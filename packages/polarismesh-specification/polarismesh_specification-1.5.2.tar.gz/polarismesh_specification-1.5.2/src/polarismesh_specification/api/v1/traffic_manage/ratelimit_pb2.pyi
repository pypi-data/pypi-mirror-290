...
class Rule(_message.Message):
    __slots__ = ("id", "service", "namespace", "subset", "priority", "resource", "type", "labels", "amounts", "action", "disable", "report", "ctime", "mtime", "revision", "service_token", "adjuster", "regex_combine", "amount_mode", "failover", "cluster", "method", "arguments", "name", "etime", "max_queue_delay", "metadata")
