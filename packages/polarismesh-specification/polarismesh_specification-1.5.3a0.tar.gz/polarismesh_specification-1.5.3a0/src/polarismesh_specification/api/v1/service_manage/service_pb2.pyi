...
class Service(_message.Message):
    __slots__ = ("name", "namespace", "metadata", "ports", "business", "department", "cmdb_mod1", "cmdb_mod2", "cmdb_mod3", "comment", "owners", "token", "ctime", "mtime", "revision", "platform_id", "total_instance_count", "healthy_instance_count", "user_ids", "group_ids", "remove_user_ids", "remove_group_ids", "id", "editable", "export_to")
