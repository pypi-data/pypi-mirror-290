...
class Namespace(_message.Message):
    __slots__ = ("name", "comment", "owners", "token", "ctime", "mtime", "total_service_count", "total_health_instance_count", "total_instance_count", "user_ids", "group_ids", "remove_user_ids", "remove_group_ids", "id", "editable", "service_export_to")
