...
class CircuitBreakerRule(_message.Message):
    __slots__ = ("id", "name", "namespace", "enable", "revision", "ctime", "mtime", "etime", "description", "level", "rule_matcher", "error_conditions", "trigger_condition", "max_ejection_percent", "recoverCondition", "faultDetectConfig", "fallbackConfig", "block_configs", "priority", "metadata")
    class MetadataEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
