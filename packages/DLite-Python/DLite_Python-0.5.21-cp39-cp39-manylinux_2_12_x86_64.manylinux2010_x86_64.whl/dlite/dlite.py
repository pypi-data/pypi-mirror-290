...
def _err_getcode(name: "char const *") -> "int":
    r"""
...
def _err_ignore_set(code: "int", value: "int") -> "void":
    r"""
...
def _err_ignore_get(code: "int") -> "int":
    r"""
...
def _err_mask_get() -> "int64_t":
    r"""_err_mask_get() -> int64_t"""
    return _dlite._err_mask_get()

def _err_mask_set(mask: "int64_t") -> "void":
...
def to_typename(type: "int", size: "int"=-1) -> "char *":
    r"""
...
def to_typenumber(dtypename: "char const *") -> "int":
    r"""
...
class Storage(object):
    ...
    def delete(self, id: "char const *") -> "void":
        r"""
        delete(self, id)
    ...
    def _set_readable(self, readable: "bool") -> "void":
        r"""
    ...
    def _set_writable(self, writable: "bool") -> "void":
        r"""
    ...
    def _set_generic(self, generic: "bool") -> "void":
        r"""
...
class Property(object):
    ...
    def __init__(self, name: "char const *", type: "char const *", ref: "char const *"=None, shape: "obj_t *"=None, unit: "char const *"=None, description: "char const *"=None):
        r"""
...
class Relation(object):
    ...
    def __init__(self, s: "char const *", p: "char const *", o: "char const *", d: "char const *"=None, id: "char const *"=None):
        r"""
...
class Instance(object):
    ...
    def __init__(self, metaid: "char const *"=None, dims: "int *"=None, id: "char const *"=None, url: "char const *"=None, storage: "Storage"=None, driver: "char const *"=None, location: "char const *"=None, options: "char const *"=None, uri: "char const *"=None, jsoninput: "char const *"=None, bsoninput: "unsigned char const *"=None, dimensions: "Dimension"=None, properties: "Property"=None, description: "char const *"=None):
        r"""
    ...
    def _get_meta(self) -> "struct _DLiteInstance const *":
        r"""
    ...
    def _get_parent_uuid(self) -> "char const *":
        r"""
    ...
    def _get_parent_hash(self) -> "char *":
        r"""
    ...
    def to_bytes(self, driver: "char const *", options: "char const *"=None) -> "void":
        r"""
    ...
    def verify_hash(self, hash: "char const *"=None, recursive: "bool"=False) -> "void":
        r"""
        ...
        """
        return _dlite.Instance_verify_hash(self, hash, recursive)

    def _copy(self, newid: "char const *"=None) -> "struct _DLiteInstance *":
        r"""
    ...
    def get_snapshot(self, n: "int"=1) -> "struct _DLiteInstance *":
        r"""
    ...
    def pull_snapshot(self, storage: "Storage", n: "int") -> "struct _DLiteInstance *":
        r"""
    ...
    def push_snapshot(self, storage: "Storage", n: "int") -> "void":
        r"""
    ...
    def set_parent(self, parent: "Instance") -> "void":
        r"""
    ...
    def get_property_as_string(self, name: "char const *", width: "int"=0, prec: "int"=-2, flags: "int"=0) -> "char *":
        r"""
    ...
    def set_property_from_string(self, name: "char const *", s: "char const *", flags: "int"=0) -> "void":
        r"""
    ...
    def _asjson(self, indent: "int"=0, single: "bool"=False, urikey: "bool"=False, with_uuid: "bool"=False, with_meta: "bool"=False, with_arrays: "bool"=False, no_parent: "bool"=False, compact_rel: "bool"=False) -> "char *":
        r"""
        ...
        """
        return _dlite.Instance__asjson(self, indent, single, urikey, with_uuid, with_meta, with_arrays, no_parent, compact_rel)

    def asbson(self) -> "void":
        r"""
        asbson(self)
...
def _from_bytes(driver: "char const *", INPUT_BYTES: "unsigned char *", id: "char const *"=None, options: "char const *"=None) -> "struct _DLiteInstance *":
    r"""
    _from_bytes(driver, INPUT_BYTES, id=None, options=None) -> Instance
    Loads instance from string.
    """
    return _dlite._from_bytes(driver, INPUT_BYTES, id, options)
...
class _CollectionIter(object):
    ...
    def next(self) -> "struct _DLiteInstance const *":
        r"""
        next(self) -> Instance
    ...
    def next_relation(self) -> "struct _Triple const *":
...
def _get_collection(id: "char const *") -> "struct _DLiteCollection *":
    r"""
...
def _collection_value(inst: "Instance", s: "char const *"=None, p: "char const *"=None, o: "char const *"=None, d: "char const *"=None, fallback: "char const *"=None, any: "int"=0) -> "char *":
