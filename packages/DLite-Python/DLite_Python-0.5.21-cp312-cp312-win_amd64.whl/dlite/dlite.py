...
class Instance(object):
    ...
    def verify_hash(self, hash=None, recursive=False):
        r"""
    ...
    def _asjson(self, indent=0, single=False, urikey=False, with_uuid=False, with_meta=False, with_arrays=False, no_parent=False, compact_rel=False):
        r"""
...
def get_instance(id, metaid=None, check_storages=True):
    r"""
...
def has_instance(id, check_storages=True):
    r"""
...
def _from_bytes(driver, INPUT_BYTES, id=None, options=None):
    r"""
