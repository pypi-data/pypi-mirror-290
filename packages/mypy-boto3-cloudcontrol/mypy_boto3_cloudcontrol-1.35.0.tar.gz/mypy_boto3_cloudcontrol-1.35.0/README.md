...
[boto3.CloudControlApi 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloudcontrol.html#CloudControlApi)
...
Install `boto3-stubs-lite[cloudcontrol]` in your environment:
