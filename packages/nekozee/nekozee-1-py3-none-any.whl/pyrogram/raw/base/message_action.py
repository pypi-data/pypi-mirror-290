...
class MessageAction:  # type: ignore
    ...
    Constructors:
        This base type has 44 constructors available.
    ...
    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        ...
                        "More info: https://dawn.github.io/nekozee-docs/telegram/base/message-action")
