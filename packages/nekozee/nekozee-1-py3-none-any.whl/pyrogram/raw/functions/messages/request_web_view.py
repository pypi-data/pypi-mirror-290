...
class RequestWebView(TLObject):  # type: ignore
    ...
    def read(b: BytesIO, *args: Any) -> "RequestWebView":
        ...
        return RequestWebView(peer=peer, bot=bot, platform=platform, from_bot_menu=from_bot_menu, silent=silent, compact=compact, url=url, start_param=start_param, theme_params=theme_params, reply_to=reply_to, send_as=send_as)
