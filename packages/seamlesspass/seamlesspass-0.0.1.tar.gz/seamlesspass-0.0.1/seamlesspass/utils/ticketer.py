...
class TICKETER_options:
    def __init__(self):
        ...
        self.duration = 10 # Default 10 hours
        self.enc_tkt_in_skey = None
        self.extra_pac = None
        self.extra_sid = None
        self.forwardable = None
        self.groups = '513, 512, 520, 518, 519'
        self.hashes = None
...
class TICKETER:
    ...
    def saveTicket(self, ticket, sessionKey):
        ...
        import base64
        print(base64.b64encode(ccache.toKRBCRED()))
