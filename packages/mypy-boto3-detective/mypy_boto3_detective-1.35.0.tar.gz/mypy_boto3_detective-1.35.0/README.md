...
[boto3.Detective 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/detective.html#Detective)
...
- Install `boto3-stubs[detective]` in your environment:
...
Install `boto3-stubs-lite[detective]` in your environment:
...
- Install `boto3-stubs[detective]` with services you use in your environment:
...
Full list of `Detective` Literals can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_detective/literals/).
...
Full list of `Detective` TypeDefs can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_detective/type_defs/).
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_detective/)
