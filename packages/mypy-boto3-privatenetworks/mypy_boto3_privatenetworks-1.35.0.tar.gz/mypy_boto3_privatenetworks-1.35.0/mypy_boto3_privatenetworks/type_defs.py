...
NetworkResourceDefinitionExtraOutputTypeDef = TypedDict(
    "NetworkResourceDefinitionExtraOutputTypeDef",
    {
        "count": int,
        "type": NetworkResourceDefinitionTypeType,
...
SitePlanExtraOutputTypeDef = TypedDict(
    "SitePlanExtraOutputTypeDef",
    {
        "options": NotRequired[List[NameValuePairTypeDef]],
        "resourceDefinitions": NotRequired[List[NetworkResourceDefinitionExtraOutputTypeDef]],
    },
)
...
SitePlanUnionTypeDef = Union[SitePlanTypeDef, SitePlanExtraOutputTypeDef]
