...
def vllm_basic(
    ...
    **llm_kwargs,
    ...
    Args:
        ...
        **llm_kwargs: Additional keyword arguments to pass to `vllm.LLM` 
            model.
    ...
    addition to various initialization parameters for vllm.SamplingParams.
    ...
    Example:
        ...
        ```
        from covalent_blueprints_ai import vllm_basic

        vllm_blueprint = vllm_basic(model_name="unsloth/llama-3-8b-Instruct")
    ...
    bp.example = get_usage_example(vllm_basic)
