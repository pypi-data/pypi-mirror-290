...
ActivatedRuleExtraOutputTypeDef = TypedDict(
    "ActivatedRuleExtraOutputTypeDef",
    {
        "Priority": int,
        "RuleId": str,
...
LoggingConfigurationExtraOutputTypeDef = TypedDict(
    "LoggingConfigurationExtraOutputTypeDef",
    {
        "ResourceArn": str,
...
ListLoggingConfigurationsResponseTypeDef = TypedDict(
    "ListLoggingConfigurationsResponseTypeDef",
    {
        "LoggingConfigurations": List[LoggingConfigurationExtraOutputTypeDef],
        "NextMarker": str,
        "ResponseMetadata": ResponseMetadataTypeDef,
    },
)
