...
__all__ = (
    ...
    "DeploymentLaunchConfigExtraOutputTypeDef",
    ...
    "DataSourceTypeDef",
    "DeploymentApplicationConfigExtraOutputTypeDef",
...
DeploymentLaunchConfigExtraOutputTypeDef = TypedDict(
    "DeploymentLaunchConfigExtraOutputTypeDef",
    {
        "packageName": str,
        "launchFile": str,
...
DeploymentApplicationConfigExtraOutputTypeDef = TypedDict(
    "DeploymentApplicationConfigExtraOutputTypeDef",
    {
        "application": str,
        "applicationVersion": str,
        "launchConfig": DeploymentLaunchConfigExtraOutputTypeDef,
    },
)
...
DeploymentApplicationConfigUnionTypeDef = Union[
    DeploymentApplicationConfigTypeDef, DeploymentApplicationConfigExtraOutputTypeDef
]
