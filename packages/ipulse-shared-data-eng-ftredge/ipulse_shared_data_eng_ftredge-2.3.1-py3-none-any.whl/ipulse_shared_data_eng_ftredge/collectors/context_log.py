...
from ipulse_shared_base_ftredge import Status, LogLevel
...
class ContextLog:
    ...
    def __init__(self, level: LogLevel, base_context: str = None, execution_domain:str=None, collector_id: str = None,
    ...
    def to_dict(self, max_field_len:int =10000, size_limit:float=256 * 1024 * 0.80,max_traceback_lines:int = 30):
        ...
        fields = [
            ...
            ("execution_domain", str(self.execution_domain)),
