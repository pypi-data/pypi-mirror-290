...
class UserRequest(BaseModel):
    ...
    role_name: Optional[StrictStr] = Field(default=None, description="Role name. Must be one of the values: (Admin, Viewer, Maintainer, Robot).", alias="roleName")
    username: StrictStr = Field(description="The user name used for login.")
    __properties: ClassVar[List[str]] = ["active", "displayName", "isHashed", "password", "remote", "roleName", "username"]
