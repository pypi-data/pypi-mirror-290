...
class ResourcesTemplate(BaseModel):
    """
    Provides a named set of values to configure resource parameters for a packaged model.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["description", "name", "resources"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ResourcesTemplate from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ResourcesTemplate from a dict"""
        if obj is None:
            return None
