...
class DeploymentTokenRequest(BaseModel):
    """
    DeploymentTokenRequest describes the request to create a deployment token.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DeploymentTokenRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of DeploymentTokenRequest from a dict"""
        if obj is None:
            return None
