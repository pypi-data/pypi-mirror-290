...
__all__ = (
    ...
    "DeploymentTypeDef",
    "DomainNameConfigurationExtraOutputTypeDef",
    "TimestampTypeDef",
    ...
    "JWTConfigurationExtraOutputTypeDef",
...
DomainNameConfigurationExtraOutputTypeDef = TypedDict(
    "DomainNameConfigurationExtraOutputTypeDef",
    {
        "ApiGatewayDomainName": NotRequired[str],
        "CertificateArn": NotRequired[str],
...
JWTConfigurationExtraOutputTypeDef = TypedDict(
    "JWTConfigurationExtraOutputTypeDef",
    {
        "Audience": NotRequired[List[str]],
        "Issuer": NotRequired[str],
...
JWTConfigurationUnionTypeDef = Union[JWTConfigurationTypeDef, JWTConfigurationExtraOutputTypeDef]
...
DomainNameConfigurationUnionTypeDef = Union[
    DomainNameConfigurationTypeDef, DomainNameConfigurationExtraOutputTypeDef
]
