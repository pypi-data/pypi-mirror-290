    ...
    def change_and_sort(self, path=None):
        ...
        if self.set_up_to_mogo:
            username, password, host, port = get_myconf.select_config_values(target_service='home_lx',
                                                                             database='mongodb')
            d = mongo_update.UploadMongo(username=username, password=password, host=host, port=port,
        ...
        if self.set_up_to_mysql:
            ...
            m = mysql_update.MysqlUpload(username=username, password=password, host=host, port=port)
