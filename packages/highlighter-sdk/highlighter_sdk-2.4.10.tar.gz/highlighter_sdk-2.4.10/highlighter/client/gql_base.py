...
# (<class 'highlighter.client.base_models.EntityAttributeEnumType'>, <class 'NoneType'>)
# (Pdb) f.annotation.__args__[0]
# <class 'highlighter.client.base_models.EntityAttributeEnumType'>
# (Pdb) f.annotation._name
#'Optional'
