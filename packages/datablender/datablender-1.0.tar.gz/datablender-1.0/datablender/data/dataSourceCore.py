...
class DataSourceCore(DataElement):
        ...
        if self.data_configuration.active:
            ...
            if self.config_element:
                ...
                if self.status =='inexistant':
                    self.data_configuration.deleteElement(self.id,'data_source')
    ...
    def findConfiguration(self) -> bool:
        ...
        for source in getattr(self.data_configuration.getElements('data_source'),'data_source'):
            directory_check = os.path.abspath(directory_name) in os.path.abspath(source['directory_name'])
