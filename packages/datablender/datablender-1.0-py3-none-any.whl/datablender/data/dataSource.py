...
class AsyncDataSource:
    ...
    def setDirectoryElement(
        ...
        **kwargs
        ...
        self.directory_element = AsyncDataDirectoryElement(
            self.core,
            **directory_element
        )
    ...
    async def getDataDirectoryElement(
        ...
        **kwargs
        ...
        return {
            **self.core.configuration,
            'directory_element':await self.setDirectoryElement(
                directory_element,
                relative_path
            ).directory_element.get(**kwargs)         
        }
    ...
    async def structureData(
        ...
        for set in sets:
            ...
            await self.core.actionTables(
                ...
                directory_element = set.get('directory_element')['directory_name']
            )
            ...
            **self.configuration, 
            'structure':{
                'tables':[
                    {  
                        **table.configuration,
                        **await table.structureData(self.core.status)
                    } for table in self.core.tables
                ]
            }
        }
