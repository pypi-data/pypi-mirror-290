...
def _element_maker(env:MaestroIDE, kls:Type[IdeManager], macro_name, mode:str=""):

    @wraps(_element_maker)
    def wrapped(
        py_name:   str = "",
        *,
        ...
        **kw
        ...
        return kls(
            env, py_name, ID, SANS, WHITE, REC_LIMIT, MERMAID,
