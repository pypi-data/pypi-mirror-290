<a id="mypy-boto3-application-signals"></a>
...
[boto3.CloudWatchApplicationSignals 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/application-signals.html#CloudWatchApplicationSignals)
