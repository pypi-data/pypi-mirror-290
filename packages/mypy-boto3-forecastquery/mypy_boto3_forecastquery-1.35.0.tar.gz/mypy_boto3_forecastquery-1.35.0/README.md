...
[boto3.ForecastQueryService 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/forecastquery.html#ForecastQueryService)
...
- Install `boto3-stubs[forecastquery]` in your environment:
...
Install `boto3-stubs-lite[forecastquery]` in your environment:
...
- Install `boto3-stubs[forecastquery]` with services you use in your
  environment:
...
`mypy_boto3_forecastquery.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `ForecastQueryService` Literals can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_forecastquery/literals/).
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_forecastquery/type_defs/).
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_forecastquery/)
