...
Refer to the Terraform Registry for docs: [`azurerm_sentinel_data_connector_microsoft_threat_intelligence`](https://registry.terraform.io/providers/hashicorp/azurerm/3.116.0/docs/resources/sentinel_data_connector_microsoft_threat_intelligence).
'''
...
class SentinelDataConnectorMicrosoftThreatIntelligence(
    ...
    def __init__(
        ...
        *,
        ...
        name: builtins.str,
        bing_safety_phishing_url_lookback_date: typing.Optional[builtins.str] = None,
        id: typing.Optional[builtins.str] = None,
        microsoft_emerging_threat_feed_lookback_date: typing.Optional[builtins.str] = None,
        ...
        :param log_analytics_workspace_id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.116.0/docs/resources/sentinel_data_connector_microsoft_threat_intelligence#log_analytics_workspace_id SentinelDataConnectorMicrosoftThreatIntelligence#log_analytics_workspace_id}.
        :param name: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.116.0/docs/resources/sentinel_data_connector_microsoft_threat_intelligence#name SentinelDataConnectorMicrosoftThreatIntelligence#name}.
        :param bing_safety_phishing_url_lookback_date: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.116.0/docs/resources/sentinel_data_connector_microsoft_threat_intelligence#bing_safety_phishing_url_lookback_date SentinelDataConnectorMicrosoftThreatIntelligence#bing_safety_phishing_url_lookback_date}.
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.116.0/docs/resources/sentinel_data_connector_microsoft_threat_intelligence#id SentinelDataConnectorMicrosoftThreatIntelligence#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param microsoft_emerging_threat_feed_lookback_date: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.116.0/docs/resources/sentinel_data_connector_microsoft_threat_intelligence#microsoft_emerging_threat_feed_lookback_date SentinelDataConnectorMicrosoftThreatIntelligence#microsoft_emerging_threat_feed_lookback_date}.
        :param tenant_id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.116.0/docs/resources/sentinel_data_connector_microsoft_threat_intelligence#tenant_id SentinelDataConnectorMicrosoftThreatIntelligence#tenant_id}.
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.116.0/docs/resources/sentinel_data_connector_microsoft_threat_intelligence#timeouts SentinelDataConnectorMicrosoftThreatIntelligence#timeouts}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing SentinelDataConnectorMicrosoftThreatIntelligence that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.116.0/docs/resources/sentinel_data_connector_microsoft_threat_intelligence#import import section} in the documentation of this resource for the id to use
    ...
    def put_timeouts(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.116.0/docs/resources/sentinel_data_connector_microsoft_threat_intelligence#create SentinelDataConnectorMicrosoftThreatIntelligence#create}.
        :param delete: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.116.0/docs/resources/sentinel_data_connector_microsoft_threat_intelligence#delete SentinelDataConnectorMicrosoftThreatIntelligence#delete}.
        :param read: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.116.0/docs/resources/sentinel_data_connector_microsoft_threat_intelligence#read SentinelDataConnectorMicrosoftThreatIntelligence#read}.
        '''
    ...
    @jsii.member(jsii_name="resetBingSafetyPhishingUrlLookbackDate")
    def reset_bing_safety_phishing_url_lookback_date(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetBingSafetyPhishingUrlLookbackDate", []))

    @jsii.member(jsii_name="resetId")
    def reset_id(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetId", []))

    @jsii.member(jsii_name="resetMicrosoftEmergingThreatFeedLookbackDate")
    def reset_microsoft_emerging_threat_feed_lookback_date(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetMicrosoftEmergingThreatFeedLookbackDate", []))
    ...
    @builtins.property
    @jsii.member(jsii_name="bingSafetyPhishingUrlLookbackDateInput")
    def bing_safety_phishing_url_lookback_date_input(
        self,
    ) -> typing.Optional[builtins.str]:
        return typing.cast(typing.Optional[builtins.str], jsii.get(self, "bingSafetyPhishingUrlLookbackDateInput"))
    ...
    @builtins.property
    @jsii.member(jsii_name="bingSafetyPhishingUrlLookbackDate")
    def bing_safety_phishing_url_lookback_date(self) -> builtins.str:
        return typing.cast(builtins.str, jsii.get(self, "bingSafetyPhishingUrlLookbackDate"))

    @bing_safety_phishing_url_lookback_date.setter
    def bing_safety_phishing_url_lookback_date(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__57447211efe7442d3181afff6480f91af16019693b0e8d80d5a73fce0629bb7d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "bingSafetyPhishingUrlLookbackDate", value) # pyright: ignore[reportArgumentType]
...
@jsii.data_type(
    ...
    name_mapping={
        ...
        "name": "name",
        "bing_safety_phishing_url_lookback_date": "bingSafetyPhishingUrlLookbackDate",
        "id": "id",
...
class SentinelDataConnectorMicrosoftThreatIntelligenceConfig(
    ...
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument bing_safety_phishing_url_lookback_date", value=bing_safety_phishing_url_lookback_date, expected_type=type_hints["bing_safety_phishing_url_lookback_date"])
        ...
        if bing_safety_phishing_url_lookback_date is not None:
            self._values["bing_safety_phishing_url_lookback_date"] = bing_safety_phishing_url_lookback_date
        if id is not None:
            self._values["id"] = id
        if microsoft_emerging_threat_feed_lookback_date is not None:
            self._values["microsoft_emerging_threat_feed_lookback_date"] = microsoft_emerging_threat_feed_lookback_date
    ...
    @builtins.property
    def bing_safety_phishing_url_lookback_date(self) -> typing.Optional[builtins.str]:
        ...
        result = self._values.get("bing_safety_phishing_url_lookback_date")
    ...
    @builtins.property
    def microsoft_emerging_threat_feed_lookback_date(
        self,
    ) -> typing.Optional[builtins.str]:
...
def _typecheckingstub__57447211efe7442d3181afff6480f91af16019693b0e8d80d5a73fce0629bb7d(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
