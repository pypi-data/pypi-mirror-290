...
from textual.widgets import Static,Header,Footer,DataTable,Input,Log,Button
...
更新: pip install tmd-top --upgrade
    ...
    def on_mount(self) -> None:
        ...
        listen_table.add_columns(*("PID", "名称", "监听地址","监听端口","IP数","连接数","上传","下载","CPU","内存"))
        ...
        outside_table.add_columns(*("PID", "名称","IP数","连接数","上传","下载","CPU","内存"))
