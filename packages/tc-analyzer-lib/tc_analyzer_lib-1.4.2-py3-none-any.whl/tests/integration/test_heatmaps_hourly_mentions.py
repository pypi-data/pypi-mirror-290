...
class TestMentionedMessages(IsolatedAsyncioTestCase):
    async def test_mentioned_messages(self):
        ...
        for document in results:
            ...
            if document["user"] == "user_0":
                ...
                assert {"account": "user_0", "count": 9} in document[
                    "mentioner_per_acc"
                ]
                assert {"account": "user_1", "count": 9} in document[
                    "mentioner_per_acc"
                ]
