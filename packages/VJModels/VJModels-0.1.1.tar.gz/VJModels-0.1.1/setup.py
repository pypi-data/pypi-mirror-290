...
setup(
  ...
  packages = ['VJModels'],   # Chose the same as "name"
  version = '0.1.1',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'My person machine learning models',   # Give a short description about your library
  ...
  download_url = 'https://github.com/Vanderval31bs/VJModels/archive/refs/tags/v0.1.1-alpha.tar.gz',    # I explain this later on
