...
[boto3.LookoutMetrics 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/lookoutmetrics.html#LookoutMetrics)
...
Full list of `LookoutMetrics` Literals can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_lookoutmetrics/literals/).
...
Full list of `LookoutMetrics` TypeDefs can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_lookoutmetrics/type_defs/).
