...
class TestApplicationVariants:
    ...
    def test_method_create_overload_1(self, client: SGPClient) -> None:
        ...
        assert_matches_type(ApplicationVariant, application_variant, path=["response"])
    ...
    def test_method_list(self, client: SGPClient) -> None:
        ...
        assert_matches_type(SyncPageResponse[ApplicationVariant], application_variant, path=["response"])
...
class TestAsyncApplicationVariants:
    ...
    async def test_method_list(self, async_client: AsyncSGPClient) -> None:
        ...
        assert_matches_type(AsyncPageResponse[ApplicationVariant], application_variant, path=["response"])
