...
class TestChatThreads:
    ...
    def test_method_create(self, client: SGPClient) -> None:
        chat_thread = client.applications.chat_threads.create(
    ...
    def test_raw_response_create(self, client: SGPClient) -> None:
        response = client.applications.chat_threads.with_raw_response.create(
            path_application_variant_id="application_variant_id",
            account_id="account_id",
            body_application_variant_id="application_variant_id",
            title="title",
    ...
    def test_streaming_response_create(self, client: SGPClient) -> None:
        with client.applications.chat_threads.with_streaming_response.create(
            path_application_variant_id="application_variant_id",
            account_id="account_id",
            body_application_variant_id="application_variant_id",
            title="title",
    ...
    def test_path_params_create(self, client: SGPClient) -> None:
        with pytest.raises(
            ...
            client.applications.chat_threads.with_raw_response.create(
...
class TestAsyncChatThreads:
    ...
    async def test_method_create(self, async_client: AsyncSGPClient) -> None:
        chat_thread = await async_client.applications.chat_threads.create(
            path_application_variant_id="application_variant_id",
            account_id="account_id",
            body_application_variant_id="application_variant_id",
            title="title",
    ...
    async def test_raw_response_create(self, async_client: AsyncSGPClient) -> None:
        response = await async_client.applications.chat_threads.with_raw_response.create(
            path_application_variant_id="application_variant_id",
            account_id="account_id",
            body_application_variant_id="application_variant_id",
            title="title",
    ...
    async def test_streaming_response_create(self, async_client: AsyncSGPClient) -> None:
        async with async_client.applications.chat_threads.with_streaming_response.create(
            path_application_variant_id="application_variant_id",
            account_id="account_id",
            body_application_variant_id="application_variant_id",
            title="title",
    ...
    async def test_path_params_create(self, async_client: AsyncSGPClient) -> None:
        with pytest.raises(
            ...
            await async_client.applications.chat_threads.with_raw_response.create(
                path_application_variant_id="",
                account_id="account_id",
                body_application_variant_id="",
                title="title",
