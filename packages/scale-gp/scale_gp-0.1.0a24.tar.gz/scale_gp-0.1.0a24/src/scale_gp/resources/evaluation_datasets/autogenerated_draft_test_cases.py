...
from ...types.evaluation_datasets.autogenerated_draft_test_case_list_response import (
    ...
    def list(
        ...
        *,
        ...
        return self._get_api_list(
            f"/v4/evaluation-datasets/{evaluation_dataset_id}/autogenerated-draft-test-cases",
            page=SyncPageResponse[AutogeneratedDraftTestCaseListResponse],
            options=make_request_options(
            ...
            model=AutogeneratedDraftTestCaseListResponse,
        )
...
class AsyncAutogeneratedDraftTestCasesResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        AutogeneratedDraftTestCaseListResponse, AsyncPageResponse[AutogeneratedDraftTestCaseListResponse]
    ]:
        """
        List Autogenerated Draft Test Cases
        ...
        return self._get_api_list(
            f"/v4/evaluation-datasets/{evaluation_dataset_id}/autogenerated-draft-test-cases",
            page=AsyncPageResponse[AutogeneratedDraftTestCaseListResponse],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
