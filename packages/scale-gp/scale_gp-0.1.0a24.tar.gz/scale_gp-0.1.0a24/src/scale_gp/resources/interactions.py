    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          input: Represents the input of an interaction.

          output: Represents the output of an interaction.
          ...
          operation_status: Enum representing the status of an operation.
