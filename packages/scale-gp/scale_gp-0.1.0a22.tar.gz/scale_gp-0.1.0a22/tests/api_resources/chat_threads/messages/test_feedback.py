...
class TestFeedback:
    ...
    def test_method_update(self, client: SGPClient) -> None:
        feedback = client.chat_threads.messages.feedback.update(
            thread_id="thread_id",
            path_application_interaction_id="application_interaction_id",
            body_application_interaction_id="application_interaction_id",
            chat_thread_id="chat_thread_id",
            description="description",
            sentiment="positive",
        )
        assert_matches_type(ChatThreadFeedback, feedback, path=["response"])

    @parametrize
    def test_raw_response_update(self, client: SGPClient) -> None:
        response = client.chat_threads.messages.feedback.with_raw_response.update(
            thread_id="thread_id",
            path_application_interaction_id="application_interaction_id",
            body_application_interaction_id="application_interaction_id",
            chat_thread_id="chat_thread_id",
    ...
    def test_streaming_response_update(self, client: SGPClient) -> None:
        with client.chat_threads.messages.feedback.with_streaming_response.update(
            thread_id="thread_id",
            path_application_interaction_id="application_interaction_id",
            body_application_interaction_id="application_interaction_id",
            chat_thread_id="chat_thread_id",
    ...
    def test_path_params_update(self, client: SGPClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `thread_id` but received ''"):
            client.chat_threads.messages.feedback.with_raw_response.update(
                thread_id="",
                path_application_interaction_id="application_interaction_id",
                body_application_interaction_id="application_interaction_id",
                chat_thread_id="chat_thread_id",
...
class TestAsyncFeedback:
    ...
    async def test_method_update(self, async_client: AsyncSGPClient) -> None:
        feedback = await async_client.chat_threads.messages.feedback.update(
            thread_id="thread_id",
            path_application_interaction_id="application_interaction_id",
            body_application_interaction_id="application_interaction_id",
            chat_thread_id="chat_thread_id",
    ...
    async def test_raw_response_update(self, async_client: AsyncSGPClient) -> None:
        response = await async_client.chat_threads.messages.feedback.with_raw_response.update(
            thread_id="thread_id",
            path_application_interaction_id="application_interaction_id",
            body_application_interaction_id="application_interaction_id",
            chat_thread_id="chat_thread_id",
    ...
    async def test_streaming_response_update(self, async_client: AsyncSGPClient) -> None:
        async with async_client.chat_threads.messages.feedback.with_streaming_response.update(
            thread_id="thread_id",
            path_application_interaction_id="application_interaction_id",
            body_application_interaction_id="application_interaction_id",
            chat_thread_id="chat_thread_id",
    ...
    async def test_path_params_update(self, async_client: AsyncSGPClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `thread_id` but received ''"):
            await async_client.chat_threads.messages.feedback.with_raw_response.update(
                thread_id="",
                path_application_interaction_id="application_interaction_id",
                body_application_interaction_id="application_interaction_id",
                chat_thread_id="chat_thread_id",
