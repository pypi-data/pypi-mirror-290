...
from .test_cases.test_cases import TestCasesResource, AsyncTestCasesResource
...
class EvaluationDatasetsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> SyncPageResponse[EvaluationDataset]:
        """
        ### Description
        ...
        return self._get_api_list(
            "/v4/evaluation-datasets",
            page=SyncPageResponse[EvaluationDataset],
            options=make_request_options(
...
class AsyncEvaluationDatasetsResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[EvaluationDataset, AsyncPageResponse[EvaluationDataset]]:
        """
        ### Description
        ...
        return self._get_api_list(
            "/v4/evaluation-datasets",
            page=AsyncPageResponse[EvaluationDataset],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
