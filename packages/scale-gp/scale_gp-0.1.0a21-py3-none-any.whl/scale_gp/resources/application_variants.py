...
from typing import Any, Dict, Union, Iterable, cast, overload
...
from ..types.application_variant import ApplicationVariant
...
class ApplicationVariantsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> SyncPageResponse[ApplicationVariant]:
        """
        ### Description
        ...
        return self._get_api_list(
            "/v4/application-variants",
            page=SyncPageResponse[ApplicationVariant],
            options=make_request_options(
            ...
            model=cast(Any, ApplicationVariant),  # Union types cannot be passed in as arguments in the type system
        )
...
class AsyncApplicationVariantsResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> AsyncPaginator[ApplicationVariant, AsyncPageResponse[ApplicationVariant]]:
        """
        ### Description
        ...
        return self._get_api_list(
            "/v4/application-variants",
            page=AsyncPageResponse[ApplicationVariant],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
