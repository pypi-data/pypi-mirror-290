...
class AggregatedNominationsNlMtus(BaseModel):
    """
    AggregatedNominationsNlMtus
    """
    ...
    eprogram_values: AggregatedNominationsNlMtusEprogramValues = Field(..., alias="eprogramValues")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AggregatedNominationsNlMtus:
        """Create an instance of AggregatedNominationsNlMtus from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AggregatedNominationsNlMtus:
        """Create an instance of AggregatedNominationsNlMtus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AggregatedNominationsNlMtus.parse_obj(obj)

        _obj = AggregatedNominationsNlMtus.parse_obj({
            "mtu": obj.get("mtu"),
            ...
            "eprogram_values": AggregatedNominationsNlMtusEprogramValues.from_dict(obj.get("eprogramValues")) if obj.get("eprogramValues") is not None else None
        })
        return _obj
