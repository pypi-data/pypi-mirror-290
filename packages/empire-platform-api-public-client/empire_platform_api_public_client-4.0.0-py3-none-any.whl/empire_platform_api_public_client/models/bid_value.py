...
class BidValue(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BidValue:
        """Create an instance of BidValue from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BidValue:
        """Create an instance of BidValue from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BidValue.parse_obj(obj)

        _obj = BidValue.parse_obj({
            "price": obj.get("price"),
