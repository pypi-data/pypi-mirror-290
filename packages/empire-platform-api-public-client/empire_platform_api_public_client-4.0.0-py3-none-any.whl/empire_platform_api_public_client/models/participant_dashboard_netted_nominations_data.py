...
class ParticipantDashboardNettedNominationsData(BaseModel):
    ...
    mtus: conlist(ParticipantDashboardNettedNominationsDataMtus) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ParticipantDashboardNettedNominationsData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ParticipantDashboardNettedNominationsData:
        """Create an instance of ParticipantDashboardNettedNominationsData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ParticipantDashboardNettedNominationsData.parse_obj(obj)

        _obj = ParticipantDashboardNettedNominationsData.parse_obj({
            "mtu_size": obj.get("mtuSize"),
            "mtus": [ParticipantDashboardNettedNominationsDataMtus.from_dict(_item) for _item in obj.get("mtus")] if obj.get("mtus") is not None else None
        })
        return _obj
