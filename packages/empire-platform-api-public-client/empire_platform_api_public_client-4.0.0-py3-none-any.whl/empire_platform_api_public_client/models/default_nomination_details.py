...
class DefaultNominationDetails(BaseModel):
    """
    ...
    __properties = ["id", "timescale", "borderDirection", "deliveryPeriodStart", "deliveryPeriodEnd", "mtus"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DefaultNominationDetails:
        """Create an instance of DefaultNominationDetails from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DefaultNominationDetails:
        """Create an instance of DefaultNominationDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DefaultNominationDetails.parse_obj(obj)

        _obj = DefaultNominationDetails.parse_obj({
            "id": obj.get("id"),
