...
class LongTermReservePriceSteps(BaseModel):
    """
    When Reserve Price enabled, the range of the Offered Capacity must be covered by price resolution steps.  - from: Lower boundary of step in kilowatts, inclusive - to: Upper boundary of step in kilowatts, inclusive   # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LongTermReservePriceSteps:
        """Create an instance of LongTermReservePriceSteps from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LongTermReservePriceSteps:
        """Create an instance of LongTermReservePriceSteps from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LongTermReservePriceSteps.parse_obj(obj)

        _obj = LongTermReservePriceSteps.parse_obj({
