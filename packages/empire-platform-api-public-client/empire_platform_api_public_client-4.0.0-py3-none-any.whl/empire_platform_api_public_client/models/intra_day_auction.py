...
class IntraDayAuction(BaseModel):
    """
    IntraDayAuction
    """
    ...
    __properties = ["id", "name", "displayId", "productType", "borderDirection", "status", "processing", "deliveryPeriod", "allocationMtuSize", "allocationResolution", "biddingConfiguration", "processSteps", "offeredCapacitySetup", "offeredCapacityManuallyUpdated", "mtus"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IntraDayAuction:
        """Create an instance of IntraDayAuction from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IntraDayAuction:
        """Create an instance of IntraDayAuction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IntraDayAuction.parse_obj(obj)

        _obj = IntraDayAuction.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
