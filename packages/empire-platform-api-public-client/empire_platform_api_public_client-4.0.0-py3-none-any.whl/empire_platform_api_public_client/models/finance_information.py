...
class FinanceInformation(BaseModel):
    ...
    letter_of_credits: conlist(FinanceInformationLetterOfCredits) = Field(..., alias="letterOfCredits")
    bank_deposits: conlist(FinanceInformationBankDeposits) = Field(..., alias="bankDeposits")
