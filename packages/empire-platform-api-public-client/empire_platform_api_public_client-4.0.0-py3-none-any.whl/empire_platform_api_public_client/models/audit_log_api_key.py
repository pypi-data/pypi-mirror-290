...
class AuditLogApiKey(BaseModel):
    """
    AuditLogApiKey
    """
    ...
    __properties = ["id", "name", "createdAt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditLogApiKey:
        """Create an instance of AuditLogApiKey from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuditLogApiKey:
        """Create an instance of AuditLogApiKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditLogApiKey.parse_obj(obj)

        _obj = AuditLogApiKey.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
