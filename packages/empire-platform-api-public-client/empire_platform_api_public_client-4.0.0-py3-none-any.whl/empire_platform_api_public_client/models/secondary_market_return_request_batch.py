...
class SecondaryMarketReturnRequestBatch(BaseModel):
    ...
    """
    entries: conlist(SecondaryMarketReturnRequest) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SecondaryMarketReturnRequestBatch:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SecondaryMarketReturnRequestBatch:
        """Create an instance of SecondaryMarketReturnRequestBatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SecondaryMarketReturnRequestBatch.parse_obj(obj)

        _obj = SecondaryMarketReturnRequestBatch.parse_obj({
            "entries": [SecondaryMarketReturnRequest.from_dict(_item) for _item in obj.get("entries")] if obj.get("entries") is not None else None,
