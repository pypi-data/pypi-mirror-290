...
class UpdateDefaultNominationRequest(BaseModel):
    """
    UpdateDefaultNominationRequest
    """
    ...
    __properties = ["deliveryPeriodStart", "deliveryPeriodEnd", "mtus"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateDefaultNominationRequest:
        """Create an instance of UpdateDefaultNominationRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateDefaultNominationRequest:
        """Create an instance of UpdateDefaultNominationRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateDefaultNominationRequest.parse_obj(obj)

        _obj = UpdateDefaultNominationRequest.parse_obj({
