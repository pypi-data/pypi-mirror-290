...
class PublicDayAheadAuction(BaseModel):
    """
    ...
    __properties = ["id", "name", "displayId", "productType", "borderDirection", "status", "processing", "deliveryPeriod", "allocationMtuSize", "allocationResolution", "processSteps", "mtus"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublicDayAheadAuction:
        """Create an instance of PublicDayAheadAuction from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublicDayAheadAuction:
        """Create an instance of PublicDayAheadAuction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PublicDayAheadAuction.parse_obj(obj)

        _obj = PublicDayAheadAuction.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
