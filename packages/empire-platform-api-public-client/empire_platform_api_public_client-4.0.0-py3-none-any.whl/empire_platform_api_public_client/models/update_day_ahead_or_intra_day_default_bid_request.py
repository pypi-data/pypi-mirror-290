...
class UpdateDayAheadOrIntraDayDefaultBidRequest(BaseModel):
    """
    UpdateDayAheadOrIntraDayDefaultBidRequest
    """
    ...
    bids: conlist(UpdateDayAheadOrIntraDayDefaultBidRequestBids) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateDayAheadOrIntraDayDefaultBidRequest:
        """Create an instance of UpdateDayAheadOrIntraDayDefaultBidRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateDayAheadOrIntraDayDefaultBidRequest:
        """Create an instance of UpdateDayAheadOrIntraDayDefaultBidRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateDayAheadOrIntraDayDefaultBidRequest.parse_obj(obj)

        _obj = UpdateDayAheadOrIntraDayDefaultBidRequest.parse_obj({
            ...
            "bids": [UpdateDayAheadOrIntraDayDefaultBidRequestBids.from_dict(_item) for _item in obj.get("bids")] if obj.get("bids") is not None else None
        })
        return _obj
