...
class BiddingConfigurationValues(BaseModel):
    """
    BiddingConfigurationValues
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BiddingConfigurationValues:
        """Create an instance of BiddingConfigurationValues from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BiddingConfigurationValues:
        """Create an instance of BiddingConfigurationValues from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BiddingConfigurationValues.parse_obj(obj)

        _obj = BiddingConfigurationValues.parse_obj({
