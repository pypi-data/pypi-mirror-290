...
class PublicAllocatedAuctionApi:
    ...
    @validate_arguments
    def get_public_aggregated_allocated_auctions(self, border_direction : Annotated[Optional[BorderDirection], Field(description="Border Direction (optional)")] = None, timescales : Annotated[Optional[conlist(AuctionTimescale)], Field(description="List of Auction Timescales (optional)")] = None, product_types : Annotated[Optional[conlist(AuctionProductType)], Field(description="List of Auction Product Types (optional)")] = None, delivery_period_start : Optional[datetime] = None, delivery_period_end : Optional[datetime] = None, **kwargs) -> List[AggregatedAllocatedAuction]:  # noqa: E501
        ...
        >>> thread = api.get_public_aggregated_allocated_auctions(border_direction, timescales, product_types, delivery_period_start, delivery_period_end, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_public_aggregated_allocated_auctions_with_http_info(border_direction, timescales, product_types, delivery_period_start, delivery_period_end, **kwargs)  # noqa: E501

    @validate_arguments
    def get_public_aggregated_allocated_auctions_with_http_info(self, border_direction : Annotated[Optional[BorderDirection], Field(description="Border Direction (optional)")] = None, timescales : Annotated[Optional[conlist(AuctionTimescale)], Field(description="List of Auction Timescales (optional)")] = None, product_types : Annotated[Optional[conlist(AuctionProductType)], Field(description="List of Auction Product Types (optional)")] = None, delivery_period_start : Optional[datetime] = None, delivery_period_end : Optional[datetime] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_public_aggregated_allocated_auctions  # noqa: E501
        ...
        >>> thread = api.get_public_aggregated_allocated_auctions_with_http_info(border_direction, timescales, product_types, delivery_period_start, delivery_period_end, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_public_allocated_auctions(self, limit : Annotated[conint(strict=True, le=100, ge=1), Field(..., description="Number of records to return on a page")], offset : Annotated[conint(strict=True, ge=0), Field(..., description="Offset in the list of records to return")], sort_by : AllocatedAuctionSortBy, border_direction : Annotated[Optional[BorderDirection], Field(description="Border Direction (optional)")] = None, timescales : Annotated[Optional[conlist(AuctionTimescale)], Field(description="List of Auction Timescales (optional)")] = None, product_types : Annotated[Optional[conlist(AuctionProductType)], Field(description="List of Auction Product Types (optional)")] = None, delivery_period_start : Optional[datetime] = None, delivery_period_end : Optional[datetime] = None, query : Optional[StrictStr] = None, **kwargs) -> PublicAllocatedAuctionBatch:  # noqa: E501
        ...
        >>> thread = api.get_public_allocated_auctions(limit, offset, sort_by, border_direction, timescales, product_types, delivery_period_start, delivery_period_end, query, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_public_allocated_auctions_with_http_info(limit, offset, sort_by, border_direction, timescales, product_types, delivery_period_start, delivery_period_end, query, **kwargs)  # noqa: E501
    ...
    def get_public_allocated_auctions_with_http_info(self, limit : Annotated[conint(strict=True, le=100, ge=1), Field(..., description="Number of records to return on a page")], offset : Annotated[conint(strict=True, ge=0), Field(..., description="Offset in the list of records to return")], sort_by : AllocatedAuctionSortBy, border_direction : Annotated[Optional[BorderDirection], Field(description="Border Direction (optional)")] = None, timescales : Annotated[Optional[conlist(AuctionTimescale)], Field(description="List of Auction Timescales (optional)")] = None, product_types : Annotated[Optional[conlist(AuctionProductType)], Field(description="List of Auction Product Types (optional)")] = None, delivery_period_start : Optional[datetime] = None, delivery_period_end : Optional[datetime] = None, query : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.get_public_allocated_auctions_with_http_info(limit, offset, sort_by, border_direction, timescales, product_types, delivery_period_start, delivery_period_end, query, async_req=True)
        >>> result = thread.get()
