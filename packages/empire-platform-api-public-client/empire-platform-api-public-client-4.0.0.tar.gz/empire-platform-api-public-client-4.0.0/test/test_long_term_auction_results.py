...
from empire_platform_api_public_client.models.long_term_auction_results import LongTermAuctionResults  # noqa: E501
        ...
        if include_optional:
            return LongTermAuctionResults(
                congestion_rent = empire_platform_api_public_client.models.auction_result_congestion_rent.AuctionResultCongestionRent(
                    ...
                    total_revenue = 1.337, ),
                bids = [
                    empire_platform_api_public_client.models.long_term_auction_results_bids.LongTermAuctionResults_bids(
                ...
                allocated_capacity = [
                    empire_platform_api_public_client.models.long_term_auction_results_allocated_capacity.LongTermAuctionResults_allocatedCapacity(
