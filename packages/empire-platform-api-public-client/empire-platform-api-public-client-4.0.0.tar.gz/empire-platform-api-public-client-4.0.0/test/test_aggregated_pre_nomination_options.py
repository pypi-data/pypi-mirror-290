...
from empire_platform_api_public_client.models.aggregated_pre_nomination_options import AggregatedPreNominationOptions  # noqa: E501
...
class TestAggregatedPreNominationOptions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AggregatedPreNominationOptions:
        ...
        """
        model = AggregatedPreNominationOptions()  # noqa: E501
        if include_optional:
            return AggregatedPreNominationOptions(
                long_term = [
                    empire_platform_api_public_client.models.aggregated_pre_nomination_options_timescale.AggregatedPreNominationOptionsTimescale(
                        direction = 'GB_NL', 
