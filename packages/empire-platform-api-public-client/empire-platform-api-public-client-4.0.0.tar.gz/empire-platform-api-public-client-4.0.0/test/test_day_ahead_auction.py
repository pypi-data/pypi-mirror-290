...
from empire_platform_api_public_client.models.day_ahead_auction import DayAheadAuction  # noqa: E501

class TestDayAheadAuction(unittest.TestCase):
    """DayAheadAuction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DayAheadAuction:
        """Test DayAheadAuction
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DayAheadAuction`
        """
        model = DayAheadAuction()  # noqa: E501
        if include_optional:
            return DayAheadAuction(
                ...
                bidding_configuration = empire_platform_api_public_client.models.auction_bidding_configuration.AuctionBiddingConfiguration(
                    mode = 'OPEN', 
                    pre_bidding_allowed = True, 
                    max_bids_per_participants = 0, 
                    min_bid_price = 1.337, ),
                ...
                offered_capacity_setup = 'PERCENT_100_ATC',
                offered_capacity_manually_updated = True,
                mtus = [
