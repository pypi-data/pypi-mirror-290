...
from empire_platform_api_public_client.models.create_secondary_market_long_term_noticeboard_response import CreateSecondaryMarketLongTermNoticeboardResponse  # noqa: E501

class TestCreateSecondaryMarketLongTermNoticeboardResponse(unittest.TestCase):
    """CreateSecondaryMarketLongTermNoticeboardResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSecondaryMarketLongTermNoticeboardResponse:
        """Test CreateSecondaryMarketLongTermNoticeboardResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSecondaryMarketLongTermNoticeboardResponse`
        """
        model = CreateSecondaryMarketLongTermNoticeboardResponse()  # noqa: E501
        if include_optional:
            return CreateSecondaryMarketLongTermNoticeboardResponse(
    ...
    def testCreateSecondaryMarketLongTermNoticeboardResponse(self):
        """Test CreateSecondaryMarketLongTermNoticeboardResponse"""
