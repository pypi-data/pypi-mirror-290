...
from empire_platform_api_public_client.models.public_aggregated_nominations_overview_response_mtus_netted_nominations import PublicAggregatedNominationsOverviewResponseMtusNettedNominations  # noqa: E501
...
class TestPublicAggregatedNominationsOverviewResponseMtusNettedNominations(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PublicAggregatedNominationsOverviewResponseMtusNettedNominations:
        ...
        """
        model = PublicAggregatedNominationsOverviewResponseMtusNettedNominations()  # noqa: E501
        if include_optional:
