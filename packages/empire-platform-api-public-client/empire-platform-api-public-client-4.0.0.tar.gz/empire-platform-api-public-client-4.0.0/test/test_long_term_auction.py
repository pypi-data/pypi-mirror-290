...
from empire_platform_api_public_client.models.long_term_auction import LongTermAuction  # noqa: E501

class TestLongTermAuction(unittest.TestCase):
    """LongTermAuction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LongTermAuction:
        """Test LongTermAuction
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LongTermAuction`
        """
        model = LongTermAuction()  # noqa: E501
        if include_optional:
            return LongTermAuction(
