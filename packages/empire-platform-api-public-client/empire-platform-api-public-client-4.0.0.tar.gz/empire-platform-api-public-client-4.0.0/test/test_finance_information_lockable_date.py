...
from empire_platform_api_public_client.models.finance_information_lockable_date import FinanceInformationLockableDate  # noqa: E501
    ...
    def make_instance(self, include_optional) -> FinanceInformationLockableDate:
        ...
        if include_optional:
            return FinanceInformationLockableDate(
                var_date = 'Tue Jan 04 00:00:00 UTC 2022',
                locked = True
            )
        else:
            return FinanceInformationLockableDate(
