...
class TestSubmitLongTermBidsRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SubmitLongTermBidsRequest:
        ...
        """
        model = SubmitLongTermBidsRequest()  # noqa: E501
        if include_optional:
            return SubmitLongTermBidsRequest(
                bids = [
                    empire_platform_api_public_client.models.submit_long_term_bids_request_bids.SubmitLongTermBidsRequest_bids(
