...
from empire_platform_api_public_client.models.secondary_market_day_ahead_or_intra_day_noticeboard_entry import SecondaryMarketDayAheadOrIntraDayNoticeboardEntry  # noqa: E501

class TestSecondaryMarketDayAheadOrIntraDayNoticeboardEntry(unittest.TestCase):
    """SecondaryMarketDayAheadOrIntraDayNoticeboardEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SecondaryMarketDayAheadOrIntraDayNoticeboardEntry:
        """Test SecondaryMarketDayAheadOrIntraDayNoticeboardEntry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SecondaryMarketDayAheadOrIntraDayNoticeboardEntry`
        """
        model = SecondaryMarketDayAheadOrIntraDayNoticeboardEntry()  # noqa: E501
        if include_optional:
            return SecondaryMarketDayAheadOrIntraDayNoticeboardEntry(
                notice_details = empire_platform_api_public_client.models.secondary_market_day_ahead_or_intra_day_noticeboard_entry_details.SecondaryMarketDayAheadOrIntraDayNoticeboardEntryDetails(
                    type = 'BUY', 
                    timescale = 'LONG_TERM', 
                    ...
                    is_own = True, ),
                responses = [
                    empire_platform_api_public_client.models.secondary_market_day_ahead_or_intra_day_noticeboard_entry_response.SecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponse(
                        mtus = [
                            empire_platform_api_public_client.models.secondary_market_day_ahead_or_intra_day_noticeboard_entry_response_mtus.SecondaryMarketDayAheadOrIntraDayNoticeboardEntryResponse_mtus(
                                mtu = '2022-01-04T10:00Z', 
                        ...
                        comment = '', 
                        responded_at = '2022-01-04T00:00Z', )
                    ],
                matching_entries = [
                    empire_platform_api_public_client.models.secondary_market_day_ahead_or_intra_day_noticeboard_entry_matching.SecondaryMarketDayAheadOrIntraDayNoticeboardEntryMatching(
                        id = '8d3787bb-b9ce-4d75-9a75-074ddd5d1e09', 
                        type = 'BUY', 
                        delivery_day_from = 'Tue Jan 04 00:00:00 UTC 2022', 
                        delivery_day_to = 'Tue Jan 04 00:00:00 UTC 2022', 
                        timescale = 'LONG_TERM', 
                        direction = 'GB_NL', 
    ...
    def testSecondaryMarketDayAheadOrIntraDayNoticeboardEntry(self):
        """Test SecondaryMarketDayAheadOrIntraDayNoticeboardEntry"""
