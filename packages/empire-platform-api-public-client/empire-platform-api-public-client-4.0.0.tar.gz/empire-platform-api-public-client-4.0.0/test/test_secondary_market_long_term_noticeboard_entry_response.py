...
from empire_platform_api_public_client.models.secondary_market_long_term_noticeboard_entry_response import SecondaryMarketLongTermNoticeboardEntryResponse  # noqa: E501

class TestSecondaryMarketLongTermNoticeboardEntryResponse(unittest.TestCase):
    """SecondaryMarketLongTermNoticeboardEntryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SecondaryMarketLongTermNoticeboardEntryResponse:
        """Test SecondaryMarketLongTermNoticeboardEntryResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SecondaryMarketLongTermNoticeboardEntryResponse`
        """
        model = SecondaryMarketLongTermNoticeboardEntryResponse()  # noqa: E501
        if include_optional:
            return SecondaryMarketLongTermNoticeboardEntryResponse(
                reponse_capacity = 56,
    ...
    def testSecondaryMarketLongTermNoticeboardEntryResponse(self):
        """Test SecondaryMarketLongTermNoticeboardEntryResponse"""
