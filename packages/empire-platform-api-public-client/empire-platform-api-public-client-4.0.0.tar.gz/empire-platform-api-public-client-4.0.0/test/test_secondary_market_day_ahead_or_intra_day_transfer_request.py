...
from empire_platform_api_public_client.models.secondary_market_day_ahead_or_intra_day_transfer_request import SecondaryMarketDayAheadOrIntraDayTransferRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> SecondaryMarketDayAheadOrIntraDayTransferRequest:
        ...
        if include_optional:
            return SecondaryMarketDayAheadOrIntraDayTransferRequest(
                ...
                mtus = [
                    empire_platform_api_public_client.models.secondary_market_day_ahead_or_intra_day_transfer_request_mtus.SecondaryMarketDayAheadOrIntraDayTransferRequest_mtus(
