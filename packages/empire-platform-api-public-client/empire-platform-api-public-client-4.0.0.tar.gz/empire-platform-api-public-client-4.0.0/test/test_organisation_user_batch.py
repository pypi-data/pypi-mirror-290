...
from empire_platform_api_public_client.models.organisation_user_batch import OrganisationUserBatch  # noqa: E501
...
class TestOrganisationUserBatch(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrganisationUserBatch:
        ...
        """
        model = OrganisationUserBatch()  # noqa: E501
        if include_optional:
            return OrganisationUserBatch(
                entries = [
                    empire_platform_api_public_client.models.organisation_user.OrganisationUser(
                        ...
                        role = 'ICO_ADMIN_BDL', 
                        invited_at = '2022-01-04T00:00Z', 
                        last_login_at = '2022-01-04T00:00Z', 
                        last_password_change_at = '2022-01-04T00:00Z', 
                        status = 'ACTIVE', )
                    ],
                total_count = 0
            )
