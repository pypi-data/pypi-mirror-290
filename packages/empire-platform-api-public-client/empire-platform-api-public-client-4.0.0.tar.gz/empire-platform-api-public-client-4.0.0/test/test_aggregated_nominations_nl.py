...
from empire_platform_api_public_client.models.aggregated_nominations_nl import AggregatedNominationsNl  # noqa: E501

class TestAggregatedNominationsNl(unittest.TestCase):
    """AggregatedNominationsNl unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AggregatedNominationsNl:
        """Test AggregatedNominationsNl
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregatedNominationsNl`
        """
        model = AggregatedNominationsNl()  # noqa: E501
        if include_optional:
            return AggregatedNominationsNl(
    ...
    def testAggregatedNominationsNl(self):
        """Test AggregatedNominationsNl"""
