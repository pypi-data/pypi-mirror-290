...
class TestPublicDayAheadOrIntraDayAuctionMtuResults(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PublicDayAheadOrIntraDayAuctionMtuResults:
        ...
        """
        model = PublicDayAheadOrIntraDayAuctionMtuResults()  # noqa: E501
        if include_optional:
            return PublicDayAheadOrIntraDayAuctionMtuResults(
                bids = [
                    empire_platform_api_public_client.models.public_day_ahead_or_intra_day_auction_mtu_results_bids.PublicDayAheadOrIntraDayAuctionMtuResults_bids(
