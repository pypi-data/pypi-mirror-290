...
from empire_platform_api_public_client.models.intra_day_auction import IntraDayAuction  # noqa: E501

class TestIntraDayAuction(unittest.TestCase):
    """IntraDayAuction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntraDayAuction:
        """Test IntraDayAuction
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntraDayAuction`
        """
        model = IntraDayAuction()  # noqa: E501
        if include_optional:
