...
from empire_platform_api_public_client.models.allocated_auction import AllocatedAuction  # noqa: E501

class TestAllocatedAuction(unittest.TestCase):
    """AllocatedAuction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AllocatedAuction:
        """Test AllocatedAuction
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AllocatedAuction`
        """
        model = AllocatedAuction()  # noqa: E501
        if include_optional:
