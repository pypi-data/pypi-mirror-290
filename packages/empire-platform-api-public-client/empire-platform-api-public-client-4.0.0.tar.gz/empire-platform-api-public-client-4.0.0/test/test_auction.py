...
from empire_platform_api_public_client.models.auction import Auction  # noqa: E501

class TestAuction(unittest.TestCase):
    """Auction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Auction:
        """Test Auction
