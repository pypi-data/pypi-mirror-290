...
from empire_platform_api_public_client.models.timescale_nominations import TimescaleNominations  # noqa: E501
    ...
    def make_instance(self, include_optional) -> TimescaleNominations:
        ...
        if include_optional:
            return TimescaleNominations(
                ...
                mtus = [
                    empire_platform_api_public_client.models.timescale_nominations_mtus.TimescaleNominations_mtus(
