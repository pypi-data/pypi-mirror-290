...
from empire_platform_api_public_client.models.participant_dashboard_transmission_rights_and_nominations_graph_data import ParticipantDashboardTransmissionRightsAndNominationsGraphData  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ParticipantDashboardTransmissionRightsAndNominationsGraphData:
        ...
        if include_optional:
            return ParticipantDashboardTransmissionRightsAndNominationsGraphData(
                mtus = [
                    empire_platform_api_public_client.models.participant_dashboard_transmission_rights_and_nominations_graph_data_mtus.ParticipantDashboardTransmissionRightsAndNominationsGraphData_mtus(
                        mtu = '2022-01-04T10:00Z', 
                        values = [
                            empire_platform_api_public_client.models.participant_dashboard_transmission_rights_and_nominations_graph_data_mtus_values.ParticipantDashboardTransmissionRightsAndNominationsGraphData_mtus_values(
                                direction = 'GB_NL', 
                                allocated_trs = 56, 
