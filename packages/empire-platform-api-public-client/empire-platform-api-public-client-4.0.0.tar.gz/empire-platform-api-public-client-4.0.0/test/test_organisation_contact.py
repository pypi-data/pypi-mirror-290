...
from empire_platform_api_public_client.models.organisation_contact import OrganisationContact  # noqa: E501
...
class TestOrganisationContact(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OrganisationContact:
        """Test OrganisationContact
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganisationContact`
        """
        model = OrganisationContact()  # noqa: E501
        if include_optional:
