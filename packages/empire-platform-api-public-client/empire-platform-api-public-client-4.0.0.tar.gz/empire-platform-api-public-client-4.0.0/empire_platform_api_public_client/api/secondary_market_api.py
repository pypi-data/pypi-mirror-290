...
class SecondaryMarketApi:
    ...
    def get_secondary_market_return_requests(self, limit : Annotated[conint(strict=True, le=100, ge=1), Field(..., description="Number of records to return on a page")], offset : Annotated[conint(strict=True, ge=0), Field(..., description="Offset in the list of records to return")], x_participant_id : Annotated[StrictStr, Field(..., description="Internal ID of a Participant-type Organisation")], border_directions : Annotated[conlist(BorderDirection), Field(..., description="List Border Directions")], delivery_period_from : Annotated[date, Field(..., description="Filter for start of auction delivery period")], delivery_period_to : Annotated[date, Field(..., description="Filter for end of auction delivery period")], search_query : Annotated[Optional[StrictStr], Field(description="Searching in the Target Auction Auction ID and Auction name")] = None, **kwargs) -> SecondaryMarketReturnRequestBatch:  # noqa: E501
        ...
        >>> thread = api.get_secondary_market_return_requests(limit, offset, x_participant_id, border_directions, delivery_period_from, delivery_period_to, search_query, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_secondary_market_return_requests_with_http_info(limit, offset, x_participant_id, border_directions, delivery_period_from, delivery_period_to, search_query, **kwargs)  # noqa: E501

    @validate_arguments
    def get_secondary_market_return_requests_with_http_info(self, limit : Annotated[conint(strict=True, le=100, ge=1), Field(..., description="Number of records to return on a page")], offset : Annotated[conint(strict=True, ge=0), Field(..., description="Offset in the list of records to return")], x_participant_id : Annotated[StrictStr, Field(..., description="Internal ID of a Participant-type Organisation")], border_directions : Annotated[conlist(BorderDirection), Field(..., description="List Border Directions")], delivery_period_from : Annotated[date, Field(..., description="Filter for start of auction delivery period")], delivery_period_to : Annotated[date, Field(..., description="Filter for end of auction delivery period")], search_query : Annotated[Optional[StrictStr], Field(description="Searching in the Target Auction Auction ID and Auction name")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """get_secondary_market_return_requests  # noqa: E501
        ...
        >>> thread = api.get_secondary_market_return_requests_with_http_info(limit, offset, x_participant_id, border_directions, delivery_period_from, delivery_period_to, search_query, async_req=True)
        >>> result = thread.get()
