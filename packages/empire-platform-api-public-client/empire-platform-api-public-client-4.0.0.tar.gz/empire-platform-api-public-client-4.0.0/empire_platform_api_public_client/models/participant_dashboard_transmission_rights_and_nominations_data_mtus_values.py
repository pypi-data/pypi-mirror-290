...
class ParticipantDashboardTransmissionRightsAndNominationsDataMtusValues(BaseModel):
    ...
    nomination_restriction: Optional[ParticipantDashboardTransmissionRightsAndNominationsDataMtusValuesNominationRestriction] = Field(None, alias="nominationRestriction")
