...
class ProfileUser(BaseModel):
    ...
    __properties = ["id", "name", "email", "role", "organisation"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProfileUser:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProfileUser:
        """Create an instance of ProfileUser from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProfileUser.parse_obj(obj)

        _obj = ProfileUser.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "email": obj.get("email"),
            "role": obj.get("role"),
