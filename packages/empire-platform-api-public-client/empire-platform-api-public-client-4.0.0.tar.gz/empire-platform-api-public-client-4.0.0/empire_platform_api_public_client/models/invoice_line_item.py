...
class InvoiceLineItem(BaseModel):
    ...
    delivery_month: date = Field(..., alias="deliveryMonth", description="One single calendar day, interpreted in **System Time**  - ISO 8601 compliant string in `yyyy-mm-01` format ")
