...
class SubmitDayAheadOrIntraDayBidsRequestBidGroupsBids(BaseModel):
    """
    SubmitDayAheadOrIntraDayBidsRequestBidGroupsBids
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubmitDayAheadOrIntraDayBidsRequestBidGroupsBids:
        """Create an instance of SubmitDayAheadOrIntraDayBidsRequestBidGroupsBids from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubmitDayAheadOrIntraDayBidsRequestBidGroupsBids:
        """Create an instance of SubmitDayAheadOrIntraDayBidsRequestBidGroupsBids from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubmitDayAheadOrIntraDayBidsRequestBidGroupsBids.parse_obj(obj)

        _obj = SubmitDayAheadOrIntraDayBidsRequestBidGroupsBids.parse_obj({
            "mtu": obj.get("mtu"),
