...
class CreateLongTermDefaultBidRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateLongTermDefaultBidRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateLongTermDefaultBidRequest:
        """Create an instance of CreateLongTermDefaultBidRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateLongTermDefaultBidRequest.parse_obj(obj)

        _obj = CreateLongTermDefaultBidRequest.parse_obj({
