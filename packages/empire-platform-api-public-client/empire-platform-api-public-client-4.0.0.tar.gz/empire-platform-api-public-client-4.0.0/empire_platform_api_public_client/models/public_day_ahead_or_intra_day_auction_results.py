...
class PublicDayAheadOrIntraDayAuctionResults(BaseModel):
    ...
    __properties = ["mtus", "successfulParticipants"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublicDayAheadOrIntraDayAuctionResults:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublicDayAheadOrIntraDayAuctionResults:
        """Create an instance of PublicDayAheadOrIntraDayAuctionResults from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PublicDayAheadOrIntraDayAuctionResults.parse_obj(obj)

        _obj = PublicDayAheadOrIntraDayAuctionResults.parse_obj({
