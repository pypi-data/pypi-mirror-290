...
class CreateSecondaryMarketDayAheadOrIntraDayTransferRequest(BaseModel):
    ...
    mtus: conlist(CreateSecondaryMarketDayAheadOrIntraDayTransferRequestMtus) = Field(...)
    ...
    def from_dict(cls, obj: dict) -> CreateSecondaryMarketDayAheadOrIntraDayTransferRequest:
        ...
        _obj = CreateSecondaryMarketDayAheadOrIntraDayTransferRequest.parse_obj({
            ...
            "mtus": [CreateSecondaryMarketDayAheadOrIntraDayTransferRequestMtus.from_dict(_item) for _item in obj.get("mtus")] if obj.get("mtus") is not None else None
        })
        return _obj
