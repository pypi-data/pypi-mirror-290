...
class SubmitNominationsMtu(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubmitNominationsMtu:
        """Create an instance of SubmitNominationsMtu from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubmitNominationsMtu:
        """Create an instance of SubmitNominationsMtu from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubmitNominationsMtu.parse_obj(obj)

        _obj = SubmitNominationsMtu.parse_obj({
            "mtu": obj.get("mtu"),
            "value": obj.get("value")
        })
        return _obj
