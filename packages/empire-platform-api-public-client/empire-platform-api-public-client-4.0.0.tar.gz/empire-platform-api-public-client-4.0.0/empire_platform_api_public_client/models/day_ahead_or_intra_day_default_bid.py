...
class DayAheadOrIntraDayDefaultBid(BaseModel):
    """
    ...
    bids: conlist(DayAheadOrIntraDayDefaultBidBids) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DayAheadOrIntraDayDefaultBid:
        """Create an instance of DayAheadOrIntraDayDefaultBid from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DayAheadOrIntraDayDefaultBid:
        """Create an instance of DayAheadOrIntraDayDefaultBid from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DayAheadOrIntraDayDefaultBid.parse_obj(obj)

        _obj = DayAheadOrIntraDayDefaultBid.parse_obj({
            "id": obj.get("id"),
            ...
            "bids": [DayAheadOrIntraDayDefaultBidBids.from_dict(_item) for _item in obj.get("bids")] if obj.get("bids") is not None else None
        })
        return _obj
