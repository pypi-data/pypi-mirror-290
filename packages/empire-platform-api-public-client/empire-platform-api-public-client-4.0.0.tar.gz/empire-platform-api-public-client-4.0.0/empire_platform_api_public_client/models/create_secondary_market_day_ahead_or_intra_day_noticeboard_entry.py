...
class CreateSecondaryMarketDayAheadOrIntraDayNoticeboardEntry(BaseModel):
    """
    CreateSecondaryMarketDayAheadOrIntraDayNoticeboardEntry
    """
    ...
    __properties = ["type", "timescale", "deliveryDay", "direction", "mtus"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSecondaryMarketDayAheadOrIntraDayNoticeboardEntry:
        """Create an instance of CreateSecondaryMarketDayAheadOrIntraDayNoticeboardEntry from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSecondaryMarketDayAheadOrIntraDayNoticeboardEntry:
        """Create an instance of CreateSecondaryMarketDayAheadOrIntraDayNoticeboardEntry from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSecondaryMarketDayAheadOrIntraDayNoticeboardEntry.parse_obj(obj)

        _obj = CreateSecondaryMarketDayAheadOrIntraDayNoticeboardEntry.parse_obj({
            "type": obj.get("type"),
