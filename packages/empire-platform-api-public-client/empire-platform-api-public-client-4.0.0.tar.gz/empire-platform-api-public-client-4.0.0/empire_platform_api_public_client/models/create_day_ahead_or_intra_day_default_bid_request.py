...
class CreateDayAheadOrIntraDayDefaultBidRequest(BaseModel):
    """
    CreateDayAheadOrIntraDayDefaultBidRequest
    """
    ...
    bids: conlist(CreateDayAheadOrIntraDayDefaultBidRequestBids) = Field(...)
    __properties = ["auctionProductType", "borderDirection", "deliveryPeriodStart", "deliveryPeriodEnd", "validityPeriodStart", "validityPeriodEnd", "mtuSize", "bids"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDayAheadOrIntraDayDefaultBidRequest:
        """Create an instance of CreateDayAheadOrIntraDayDefaultBidRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDayAheadOrIntraDayDefaultBidRequest:
        """Create an instance of CreateDayAheadOrIntraDayDefaultBidRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDayAheadOrIntraDayDefaultBidRequest.parse_obj(obj)

        _obj = CreateDayAheadOrIntraDayDefaultBidRequest.parse_obj({
            ...
            "bids": [CreateDayAheadOrIntraDayDefaultBidRequestBids.from_dict(_item) for _item in obj.get("bids")] if obj.get("bids") is not None else None
        })
        return _obj
