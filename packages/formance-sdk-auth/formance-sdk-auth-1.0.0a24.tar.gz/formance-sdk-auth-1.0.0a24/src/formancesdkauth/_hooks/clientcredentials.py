...
class ClientCredentialsHook(SDKInitHook, BeforeRequestHook, AfterErrorHook):
    ...
    def get_credentials(self, source: Optional[Union[Any, Callable[[], Any]]]) -> Optional[Credentials]:
        ...
        if security is None or security.formance_o_auth is None:
            return None
        
        return Credentials(
            client_id=security.formance_o_auth.client_id,
            client_secret=security.formance_o_auth.client_secret,
            token_url=security.formance_o_auth.token_url
        )
