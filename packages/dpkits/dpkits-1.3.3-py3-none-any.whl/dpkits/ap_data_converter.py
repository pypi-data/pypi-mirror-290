...
#
#         print(cl.Fore.GREEN, loc_str, txt, cl.Fore.RESET)
...
class APDataConverter:
    ...
    def read_file_xlsx(self, file: str, is_qme: bool, is_zip: bool = False) -> (pd.DataFrame, pd.DataFrame):
        ...
        print(f'Read file {Fore.BLUE}"{file}"{Fore.RESET}')
    ...
    def convert_upload_files_to_df_converted(self):
        ...
        try:
            ...
            print(f'Convert data file {Fore.BLUE}"{self.str_file_name}"{Fore.RESET} to dataframe')
