...
from .event_local import EventsLocal
...
def createHandler(request_parameters: dict) -> dict:
    ...
    event_id = EventsLocal(is_test_data=is_test_data).insert_event_data(request_parameters)
...
def getAllHandler(request_parameters: dict) -> list:
    ...
    is_test_data = request_parameters.get("isTestData", False)
    events_list = EventsLocal(is_test_data=is_test_data).select_all_events(lang_code_str, limit=limit)
    return events_list
...
def getEventByProfileIdHandler(request_parameters: dict) -> list:
    ...
    is_test_data = request_parameters.get("isTestData", False)
    events_list = EventsLocal(is_test_data=is_test_data).select_events_by_profile_id(profile_id, limit=limit)
    return events_list
...
def updateHandler(request_parameters: dict) -> dict:
    ...
    EventsLocal(is_test_data=is_test_data).update_by_event_id(event_id, request_parameters)
...
def getEventByEventTitleHandler(request_parameters: dict) -> list:  # TODO: test
    ...
    limit = request_parameters.get("limit")
    is_test_data = request_parameters.get("isTestData", False)
    events_list = EventsLocal(is_test_data=is_test_data).select_events_by_title(title, limit=limit)
    return events_list
