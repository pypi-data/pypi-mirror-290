   ...
   match configmodule.platform:
      case "Linux":
         match configmodule.windowmanagertype:
            ...
            case "wayland":
               return Linux_Wayland.mouseButtonNameToTkname(name)
      case "Windows":
...
def tkeventToMouseButtonName(event):
   match configmodule.platform:
      case "Linux":
         match configmodule.windowmanagertype:
            case "x11":
               return Linux_X11.tkeventToMouseButtonName(event)
            case "wayland":
               return Linux_Wayland.tkeventToMouseButtonName(event)
      case "Windows":
...
def tkeventToJavascriptKeycode(event):
   match configmodule.platform:
      case "Linux":
         match configmodule.windowmanagertype:
            case "x11":
               return Linux_X11.tkeventToJavascriptKeycode(event)
            case "wayland":
               return Linux_Wayland.tkeventToJavascriptKeycode(event)
      case "Windows":
