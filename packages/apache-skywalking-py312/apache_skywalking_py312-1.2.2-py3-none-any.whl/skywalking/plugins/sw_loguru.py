...
def install():
    ...
    def _sw_sink(message):
        ...
        core_tags = [
            ...
            KeyStringValuePair(key='module', value=record['module']),
            KeyStringValuePair(key='line', value=str(record['line'])),
            KeyStringValuePair(key='file', value=str(record['file'].path)),
            KeyStringValuePair(key='function', value=record['function']),
        ]
        tags = LogTags()
