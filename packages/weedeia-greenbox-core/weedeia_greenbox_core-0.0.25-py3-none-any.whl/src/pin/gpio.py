...
class GpioService :
  def setup(self):
    ...
    self.thr1 = adafruit_dht.DHT11(THR1)
    self.thr2 = adafruit_dht.DHT11(THR2)
    self.thr3 = adafruit_dht.DHT11(THR3)
    self.ventilationPwn = GPIO.PWM(VENTILATION, 20000)
  def cleanUp(self):
    GPIO.cleanup()
  def read_temperature_humidity(self):
    thr1Humidity = self.thr1.humidity
    thr1Temperature = self.thr1.temperature
    # thr2Humidity = self.thr2.humidity
    # thr2Temperature = self.thr2.temperature
    # thr3Humidity = self.thr3.humidity
    # thr3Temperature = self.thr3.temperature
