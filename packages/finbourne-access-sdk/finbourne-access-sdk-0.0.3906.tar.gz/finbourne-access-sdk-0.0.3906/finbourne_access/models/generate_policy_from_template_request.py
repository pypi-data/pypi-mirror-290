...
class GeneratePolicyFromTemplateRequest(object):
    ...
    def __init__(self, template_selection=None, selectors=None, local_vars_configuration=None):  # noqa: E501
        ...
        :param selectors:  List of additional selectors to be included in the policy
    ...
    def template_selection(self, template_selection):
        ...
        if (self.local_vars_configuration.client_side_validation and
                template_selection is not None and len(template_selection) > 100):
            raise ValueError("Invalid value for `template_selection`, number of items must be less than or equal to `100`")  # noqa: E501

        self._template_selection = template_selection

    @property
    def selectors(self):
        """Gets the selectors of this GeneratePolicyFromTemplateRequest.  # noqa: E501

        List of additional selectors to be included in the policy  # noqa: E501

        :return: The selectors of this GeneratePolicyFromTemplateRequest.  # noqa: E501
    ...
    def selectors(self, selectors):
        """Sets the selectors of this GeneratePolicyFromTemplateRequest.

        List of additional selectors to be included in the policy  # noqa: E501

        :param selectors: The selectors of this GeneratePolicyFromTemplateRequest.  # noqa: E501
        :type selectors: list[finbourne_access.SelectorDefinition]
        """
        if (self.local_vars_configuration.client_side_validation and
                selectors is not None and len(selectors) > 100):
            raise ValueError("Invalid value for `selectors`, number of items must be less than or equal to `100`")  # noqa: E501
