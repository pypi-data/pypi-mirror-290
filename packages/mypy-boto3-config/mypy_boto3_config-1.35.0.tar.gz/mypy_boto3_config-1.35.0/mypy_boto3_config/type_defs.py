...
Usage::
    ...
    ```python
    from mypy_boto3_config.type_defs import AccountAggregationSourceExtraOutputTypeDef

    data: AccountAggregationSourceExtraOutputTypeDef = ...
    ```
"""
...
AccountAggregationSourceExtraOutputTypeDef = TypedDict(
    "AccountAggregationSourceExtraOutputTypeDef",
    {
        "AccountIds": List[str],
...
ScopeExtraOutputTypeDef = TypedDict(
    "ScopeExtraOutputTypeDef",
    {
...
OrganizationAggregationSourceExtraOutputTypeDef = TypedDict(
    "OrganizationAggregationSourceExtraOutputTypeDef",
    {
        "RoleArn": str,
        "AwsRegions": NotRequired[List[str]],
...
OrganizationCustomRuleMetadataExtraOutputTypeDef = TypedDict(
    "OrganizationCustomRuleMetadataExtraOutputTypeDef",
    {
        "LambdaFunctionArn": str,
        "OrganizationConfigRuleTriggerTypes": List[OrganizationConfigRuleTriggerTypeType],
...
OrganizationManagedRuleMetadataExtraOutputTypeDef = TypedDict(
    "OrganizationManagedRuleMetadataExtraOutputTypeDef",
    {
        "RuleIdentifier": str,
        "Description": NotRequired[str],
...
AccountAggregationSourceUnionTypeDef = Union[
    AccountAggregationSourceTypeDef, AccountAggregationSourceExtraOutputTypeDef
]
...
OrganizationAggregationSourceUnionTypeDef = Union[
    OrganizationAggregationSourceTypeDef, OrganizationAggregationSourceExtraOutputTypeDef
]
...
OrganizationCustomRuleMetadataUnionTypeDef = Union[
    OrganizationCustomRuleMetadataTypeDef, OrganizationCustomRuleMetadataExtraOutputTypeDef
]
OrganizationManagedRuleMetadataUnionTypeDef = Union[
    OrganizationManagedRuleMetadataTypeDef, OrganizationManagedRuleMetadataExtraOutputTypeDef
]
...
SourceExtraOutputTypeDef = TypedDict(
    "SourceExtraOutputTypeDef",
    {
        "Owner": OwnerType,
...
RemediationConfigurationTypeDef = TypedDict(
    "RemediationConfigurationTypeDef",
    {
        ...
        "TargetId": str,
        "TargetVersion": NotRequired[str],
        "Parameters": NotRequired[Mapping[str, RemediationParameterValueTypeDef]],
        "ResourceType": NotRequired[str],
        "Automatic": NotRequired[bool],
        "ExecutionControls": NotRequired[ExecutionControlsTypeDef],
        "MaximumAutomaticAttempts": NotRequired[int],
...
ConfigRuleExtraOutputTypeDef = TypedDict(
    "ConfigRuleExtraOutputTypeDef",
    {
        ...
        "ConfigRuleId": NotRequired[str],
        "Description": NotRequired[str],
        "Scope": NotRequired[ScopeExtraOutputTypeDef],
        "InputParameters": NotRequired[str],
        "MaximumExecutionFrequency": NotRequired[MaximumExecutionFrequencyType],
