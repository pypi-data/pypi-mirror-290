...
def deploy_service(service_id: str, image_id: str, sku_id: Optional[str], price_id: Optional[str]) -> Dict[str, Any]:
    params = dict(image_id=image_id, sku_id=sku_id, price_id=price_id)
...
def create_shell(team_id: str, name: Optional[str], sku_id: str, price_id: str) -> str:
