...
def register_commands(app: typer.Typer):
    ...
    def deploy(
        ...
        update_sku: bool = typer.Option(
            False,
            "--update-sku",
            help="Update SKU and price for the service",
        ),
    ):
        """
        ...
        try:
            if update_sku:
                sku_id, price_id = select_service_sku_price(CliConfig.team_id)
            ...
            if upload_res.status_code == 200:
                ...
                deploy_service(service_id, image_info["image_id"], sku_id, price_id)
                print(
