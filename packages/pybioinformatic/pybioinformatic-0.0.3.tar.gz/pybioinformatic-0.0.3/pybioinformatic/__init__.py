...
from pybioinformatic.RNA_seq import parse_sample_info, MergeSamples, SpecificStrandRNASeqAnalyser
...
from pybioinformatic.biomatplotlib import generate_unique_colors
