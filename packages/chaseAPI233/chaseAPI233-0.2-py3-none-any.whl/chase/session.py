...
class ChaseSession:
    ...
    def login(self, username, password, last_four):
        ...
        try:
            ...
            try:
                push_selector = self.page.wait_for_selector("#list-item--navigational", timeout=3000)
                push_selector.click()
                sleep(2)
                ...
                # Check if we've reached the summary welcome page
                try:
                    self.page.wait_for_url(landing_page(), timeout=10000)
