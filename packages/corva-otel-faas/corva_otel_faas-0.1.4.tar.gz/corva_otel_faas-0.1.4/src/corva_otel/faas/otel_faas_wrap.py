...
from corva_otel.semconv import attributes
...
def extract_corva_attributes(event: Any):
    corva_attrs = {
        attributes.CORVA_ASSET_ID: _extract_attribute(event, "asset_id"),
        attributes.CORVA_ASSET_TYPE: _extract_attribute(event, "asset_type"),
        attributes.CORVA_ASSET_NAME: _extract_attribute(event, "asset_name"),
        attributes.CORVA_COMPANY_NAME: _extract_attribute(event, "company"),
        attributes.CORVA_COMPANY_ID: _extract_attribute(event, "company_id"),
        attributes.CORVA_APP_CONNECTION_ID: (
            _extract_attribute(event, "app_connection_id")
            or _extract_attribute(event, "app_connection")
        ),
        attributes.CORVA_APP_STREAM_ID: (
            _extract_attribute(event, "app_stream_id")
            or _extract_attribute(event, "app_stream")
        ),
        attributes.CORVA_SEGMENT: _extract_attribute(event, "source_type"),
