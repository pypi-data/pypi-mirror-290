...
[boto3.IoTWireless 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/iotwireless.html#IoTWireless)
...
Full list of `IoTWireless` Literals can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_iotwireless/literals/).
...
Full list of `IoTWireless` TypeDefs can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_iotwireless/type_defs/).
