...
figsize = namedtuple("figsize", ["width", "height"])

elsevier_cw = figsize(9 * cm2inch, 9 * cm2inch)
elsevier_hpw = figsize(14 * cm2inch, 9 * cm2inch)
elsevier_pw = figsize(19 * cm2inch, 9 * cm2inch)
