...
class AppAWSECRImageConfig(BaseModel):
    ...
    component_config_id: Optional[StrictStr] = Field(default=None, description="connection to parent model")
    component_config_type: Optional[StrictStr] = None
    created_at: Optional[StrictStr] = None
    created_by: Optional[AppAccount] = None
    created_by_id: Optional[StrictStr] = None
    iam_role_arn: Optional[StrictStr] = Field(default=None, description="actual configuration")
    id: Optional[StrictStr] = None
    updated_at: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["aws_region", "component_config_id", "component_config_type", "created_at", "created_by", "created_by_id", "iam_role_arn", "id", "updated_at"]
