...
class AppInstallEvent(BaseModel):
    ...
    payload: Optional[Dict[str, StrictStr]] = None
    updated_at: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["created_at", "created_by", "created_by_id", "id", "install_id", "operation", "operation_name", "operation_status", "org_id", "payload", "updated_at"]
