...
class AppHelmComponentConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["chart_name", "component_config_connection_id", "connected_github_vcs_config", "created_at", "created_by", "created_by_id", "id", "public_git_vcs_config", "updated_at", "values", "values_files"]
