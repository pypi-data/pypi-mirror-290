...
class ServiceCreateInstallRequest(BaseModel):
    ...
    """ # noqa: E501
    aws_account: Optional[ServiceCreateInstallRequestAwsAccount] = None
    azure_account: Optional[ServiceCreateInstallRequestAzureAccount] = None
    inputs: Optional[Dict[str, StrictStr]] = None
    name: StrictStr
    __properties: ClassVar[List[str]] = ["aws_account", "azure_account", "inputs", "name"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "azure_account": ServiceCreateInstallRequestAzureAccount.from_dict(obj.get("azure_account")) if obj.get("azure_account") is not None else None,
