...
class AppPublicGitVCSConfig(BaseModel):
    ...
    component_config_id: Optional[StrictStr] = None
    ...
    repo: Optional[StrictStr] = Field(default=None, description="actual configuration")
    updated_at: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["branch", "component_config_id", "component_config_type", "created_at", "created_by", "created_by_id", "directory", "id", "repo", "updated_at"]
