...
class ServiceCreateComponentReleaseRequest(BaseModel):
    ...
    """ # noqa: E501
    auto_build: Optional[StrictBool] = None
    build_id: Optional[StrictStr] = None
    strategy: Optional[ServiceCreateComponentReleaseRequestStrategy] = None
    __properties: ClassVar[List[str]] = ["auto_build", "build_id", "strategy"]
