...
class AppExternalImageComponentConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["aws_ecr_image_config", "component_config_connection_id", "created_at", "created_by", "created_by_id", "id", "image_url", "tag", "updated_at"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "aws_ecr_image_config": AppAWSECRImageConfig.from_dict(obj.get("aws_ecr_image_config")) if obj.get("aws_ecr_image_config") is not None else None,
