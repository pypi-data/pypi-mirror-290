...
class ServiceCLIConfig(BaseModel):
    ...
    ServiceCLIConfig
    """ # noqa: E501
    auth_audience: Optional[StrictStr] = None
    auth_client_id: Optional[StrictStr] = None
    auth_domain: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["auth_audience", "auth_client_id", "auth_domain"]
