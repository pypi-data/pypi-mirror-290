...
from ai_tools_zxw.LLM_ifly.api.General.chat.__SparkApi import SparkAPI
from ai_tools_zxw.LLM_ifly.api.config import appid, api_key, api_secret
...
class ChatAPI:
    ...
    def chat(self, my_input: str) -> str:
        ...
        self.__spark_api.main(appid, api_key, api_secret, self.__Spark_url, self.__domain, my_input_organized)
