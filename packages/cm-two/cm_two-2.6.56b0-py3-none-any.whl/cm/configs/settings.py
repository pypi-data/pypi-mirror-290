...
class Settings:
    ...
    def __init__(self, root, dirpath, mirrored=False, external_cam_frame=None,
        ...
        self.kpp_abort_photocell_waiting = (
            ...
            'operator.kpp_page.abort_photocell_waiting_pressed()',
            PhotoImage(
        ...
        self.kpp_abort_photocell_waiting_win_btns = [
            ...
            ('kpp_abort_photocell_waiting.png', 1115.5, 625.5,
             'operator.kpp_page.abort_photocell_waiting()',
             PhotoImage(
                 file=self.imgsysdir + 'kpp_abort_photocell_waiting.png'), 25,
             25,
             'toolbarBtn.TButton',
            ...
            ('kpp_abort_photocell_continue_btn.png', 957.5, 701,
             'operator.kpp_page.continue_photocell_waiting()',
             PhotoImage(
                 file=self.imgsysdir + 'kpp_abort_photocell_continue_btn.png'),
             25,
             25,
             'toolbarBtn.TButton',
             PhotoImage(
                 file=self.imgsysdir + 'kpp_abort_photocell_continue_btnZ.png')),
        ...
        self.kpp_external_btn = [(
            ...
            'operator.kpp_page.external_button_pressed()',
        ...
        self.kpp_internal_btn = [(
            ...
            'operator.kpp_page.internal_button_pressed()',
        ...
        self.kpp_ok_btn = (
            ...
            'operator.kpp_page.get_arrivals()',
        ...
        self.kpp_abort_btn = (
            ...
            'operator.kpp_page.abort_filters()',
        ...
        self.kpp_lift_up_win = ('kpp_lift_up_win.png', 960, 540,
                                PhotoImage(
                                    file=self.imgsysdir + 'kpp_lift_up_win.png'))
        self.kpp_lift_up_accept_btn = (
            'kpp_lift_accept_btn.png', 1120.5, 893.5,
        ...
        self.kpp_lift_up_decline_btn = (
            'kpp_manual_pass_decline.png', 799.5, 893.5,
            'self.destroyBlockImg()',
            PhotoImage(file=self.imgsysdir + 'kpp_manual_pass_decline.png'),
            20, 220,
            "onORUPbtn.TButton",
