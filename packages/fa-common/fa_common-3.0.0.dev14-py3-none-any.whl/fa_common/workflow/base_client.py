...
from .models import ArgoWorkflowRun, JobTemplate
...
class WorkflowBaseClient(ABC):
    ...
    @abstractmethod
    async def run_job(self, job_base: JobTemplate) -> ArgoWorkflowRun:  # FIXME: This should return a GenericWorkflowRun
        """
    ...
    ) -> ArgoWorkflowRun:  # FIXME: This should return a GenericWorkflowRun
        """
