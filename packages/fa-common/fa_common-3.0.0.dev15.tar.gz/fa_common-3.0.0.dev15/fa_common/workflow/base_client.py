...
class WorkflowBaseClient(ABC):
    ...
    @abstractmethod
    async def run_job(self, job_base: JobTemplate) -> WorkflowRun:  # FIXME: This should return a GenericWorkflowRun
        """
    ...
    ) -> WorkflowRun:  # FIXME: This should return a GenericWorkflowRun
        """
