...
from .models import JobTemplate, LocalWorkflowRun
...
class LocalWorkflowClient(WorkflowBaseClient):
    ...
    async def run_job(self, job_base: JobTemplate) -> LocalWorkflowRun:
        ...
        return LocalWorkflowRun(id=flow_run.id, state=flow_run.type.value, message=flow_run.message, template=job_base)
