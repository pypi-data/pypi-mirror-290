...
class Ticker(_message.Message):
    __slots__ = ("timestamp", "platform", "instrument", "open", "high", "low", "last", "volume", "best_bid_price", "best_bid_amount", "best_ask_price", "best_ask_amount", "info", "limit_up", "limit_down")
...
class Kline(_message.Message):
    __slots__ = ("timestamp", "platform", "instrument", "resolution", "open", "high", "low", "close", "volume", "info")
    TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
    PLATFORM_FIELD_NUMBER: _ClassVar[int]
    INSTRUMENT_FIELD_NUMBER: _ClassVar[int]
    ...
    volume: str
    info: str
    def __init__(self, timestamp: _Optional[int] = ..., platform: _Optional[str] = ..., instrument: _Optional[str] = ..., resolution: _Optional[str] = ..., open: _Optional[str] = ..., high: _Optional[str] = ..., low: _Optional[str] = ..., close: _Optional[str] = ..., volume: _Optional[str] = ..., info: _Optional[str] = ...) -> None: ...
...
class Order(_message.Message):
    __slots__ = ("platform", "instrument", "order_id", "state", "price", "amount", "filled_amount", "avg_price", "type", "side", "client_order_id", "created_time", "updated_time", "info", "investor", "strategy", "source", "tag", "error")
    ...
    tag: str
    error: str
    def __init__(self, platform: _Optional[str] = ..., instrument: _Optional[str] = ..., order_id: _Optional[str] = ..., state: _Optional[_Union[Order.State, str]] = ..., price: _Optional[str] = ..., amount: _Optional[str] = ..., filled_amount: _Optional[str] = ..., avg_price: _Optional[str] = ..., type: _Optional[str] = ..., side: _Optional[str] = ..., client_order_id: _Optional[str] = ..., created_time: _Optional[int] = ..., updated_time: _Optional[int] = ..., info: _Optional[str] = ..., investor: _Optional[str] = ..., strategy: _Optional[str] = ..., source: _Optional[str] = ..., tag: _Optional[str] = ..., error: _Optional[str] = ...) -> None: ...
...
class Position(_message.Message):
    __slots__ = ("platform", "instrument", "kind", "size", "average_price", "leverage", "side", "margin", "profit_loss", "investor", "strategy", "info")
    ...
    strategy: str
    info: str
    def __init__(self, platform: _Optional[str] = ..., instrument: _Optional[str] = ..., kind: _Optional[str] = ..., size: _Optional[str] = ..., average_price: _Optional[str] = ..., leverage: _Optional[str] = ..., side: _Optional[_Union[Position.Side, str]] = ..., margin: _Optional[str] = ..., profit_loss: _Optional[str] = ..., investor: _Optional[str] = ..., strategy: _Optional[str] = ..., info: _Optional[str] = ...) -> None: ...
...
class Instrument(_message.Message):
    __slots__ = ("platform", "kind", "id", "name", "price_tick", "volume_tick", "long_margin_ratio", "short_margin_ratio", "max_leverage", "volume_multiple", "max_order_size", "min_order_size", "is_trading", "exchange_id", "info")
    PLATFORM_FIELD_NUMBER: _ClassVar[int]
    KIND_FIELD_NUMBER: _ClassVar[int]
    ID_FIELD_NUMBER: _ClassVar[int]
...
class GetInstrumentsRequest(_message.Message):
    ...
    instruments: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, platform: _Optional[str] = ..., kinds: _Optional[_Iterable[str]] = ..., instruments: _Optional[_Iterable[str]] = ...) -> None: ...
