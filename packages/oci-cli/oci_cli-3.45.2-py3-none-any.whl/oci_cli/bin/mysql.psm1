...
function GetOciCommandsToLongParams_mysql() {
    $ociCommandsToLongParams = @{
        ...
        'mysql backup copy' = 'compartment-id description display-name from-json help if-match max-wait-seconds source-backup-id source-region wait-for-state wait-interval-seconds'
        ...
        'mysql db-system clone' = 'admin-password admin-username availability-domain backup-policy compartment-id configuration-id crash-recovery data-storage-size-in-gbs database-management defined-tags deletion-policy description display-name fault-domain freeform-tags from-json help hostname-label ip-address is-highly-available maintenance max-wait-seconds mysql-version port port-x secure-connections shape-name source-backup-id subnet-id wait-for-state wait-interval-seconds'
        'mysql db-system create' = 'admin-password admin-username availability-domain backup-policy compartment-id configuration-id crash-recovery data-storage-size-in-gbs database-management defined-tags deletion-policy description display-name fault-domain freeform-tags from-json help hostname-label ip-address is-highly-available maintenance max-wait-seconds mysql-version port port-x secure-connections shape-name source subnet-id wait-for-state wait-interval-seconds'
        ...
        'mysql db-system import' = 'admin-password admin-username availability-domain backup-policy compartment-id configuration-id crash-recovery data-storage-size-in-gbs database-management defined-tags deletion-policy description display-name fault-domain freeform-tags from-json help hostname-label ip-address is-highly-available maintenance max-wait-seconds mysql-version port port-x secure-connections shape-name source-url subnet-id wait-for-state wait-interval-seconds'
        ...
        'mysql db-system update' = 'admin-password admin-username availability-domain backup-policy configuration-id crash-recovery data-storage-size-in-gbs database-management db-system-id defined-tags deletion-policy description display-name fault-domain force freeform-tags from-json help hostname-label if-match ip-address is-highly-available maintenance max-wait-seconds mysql-version port port-x secure-connections shape-name subnet-id wait-for-state wait-interval-seconds'
