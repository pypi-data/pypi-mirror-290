...
class BotAliasAvailableWaiter(Waiter):
    ...
    def wait(self, *, botAliasId: str, botId: str, WaiterConfig: WaiterConfigTypeDef = ...) -> None:
        """
...
class BotAvailableWaiter(Waiter):
    ...
    def wait(self, *, botId: str, WaiterConfig: WaiterConfigTypeDef = ...) -> None:
        """
...
class BotExportCompletedWaiter(Waiter):
    ...
    def wait(self, *, exportId: str, WaiterConfig: WaiterConfigTypeDef = ...) -> None:
        """
...
class BotImportCompletedWaiter(Waiter):
    ...
    def wait(self, *, importId: str, WaiterConfig: WaiterConfigTypeDef = ...) -> None:
        """
...
class BotVersionAvailableWaiter(Waiter):
    ...
    def wait(self, *, botId: str, botVersion: str, WaiterConfig: WaiterConfigTypeDef = ...) -> None:
        """
