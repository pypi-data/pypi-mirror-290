"""
This module provides a set of functions to convert between different
...
class UnitConvertor:
    ...
    This class provides static methods for converting between bytes and megabytes,
    days and seconds, and seconds and minutes.
    """
