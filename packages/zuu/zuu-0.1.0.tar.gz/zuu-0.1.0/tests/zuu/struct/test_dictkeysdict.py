import pytest
from zuu.struct.dictkeysdict import DictKeysDict, FrozenDict

class TestDictKeysDict:
    def test_init_and_getitem(self):
        d = DictKeysDict({FrozenDict({"a": 1}): "value1", FrozenDict({"b": 2}): "value2"})
