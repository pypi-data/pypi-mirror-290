# -*- coding: utf-8 -*-
"""Installer for the imio.scan_logger package."""
...
setup(
    ...
    project_urls={
        ...
        # 'Documentation': 'https://imio.scan_logger.readthedocs.io/en/latest/',
    },
    ...
    target = plone
    [console_scripts]
    update_locale = imio.scan_logger.locales.update:update_locale
    """,
)
