...
GFATPY_DIR = Path(__file__).parent.parent.parent
...
def convert_scc(
    ...
    for ini_hour, end_hour in intervals:
        ...
        scc_config_dir = GFATPY_DIR / "gfatpy" / "lidar" / "scc" / "scc_configFiles"
...
def send_to_scc(
    ...
    config_path = GFATPY_DIR / "env_files" / scc_config_name
