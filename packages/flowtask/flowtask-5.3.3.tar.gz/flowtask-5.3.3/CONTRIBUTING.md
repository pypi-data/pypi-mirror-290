...
FlowTask is designed to use last syntax of asyncio-tools, for that reason, you'll need to have at least Python 3.9 available for testing.
...
FlowTask start using *[black][]* for formating code.
