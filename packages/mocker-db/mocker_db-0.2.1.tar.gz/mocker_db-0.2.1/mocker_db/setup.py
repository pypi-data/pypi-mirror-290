...
setup(
    name="mocker_db",
    packages=["mocker_db"],
    install_requires=['### mocker_db.py', 'pyyaml', 'numpy==1.26.0', 'httpx', 'gitpython==3.1.41', 'dill==0.3.7', 'gridlooper==0.0.1', 'attrs>=22.2.0', 'appdirs==1.4.3', 'fastapi==0.109.1', 'uvicorn==0.29.0', 'hnswlib==0.8.0', 'click==8.1.3', 'sentence-transformers==2.2.2'],
    ...
    author="Kyrylo Mordan", author_email="parachute.repo@gmail.com", description="A mock handler for simulating a vector database.", version="0.2.1"
)
