...
[boto3.FraudDetector 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/frauddetector.html#FraudDetector)
...
Full list of `FraudDetector` Literals can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_frauddetector/literals/).
...
Full list of `FraudDetector` TypeDefs can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_frauddetector/type_defs/).
