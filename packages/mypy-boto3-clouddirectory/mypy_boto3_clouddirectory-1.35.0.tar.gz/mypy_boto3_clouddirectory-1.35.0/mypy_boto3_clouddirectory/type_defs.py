...
__all__ = (
    ...
    "AttributeKeyTypeDef",
    "TypedAttributeValueExtraOutputTypeDef",
    ...
    "AttributeKeyAndValueExtraOutputTypeDef",
    "AttributeNameAndValueExtraOutputTypeDef",
    ...
    "FacetAttributeDefinitionExtraOutputTypeDef",
    "TypedLinkAttributeDefinitionExtraOutputTypeDef",
    ...
    "TypedLinkSpecifierExtraOutputTypeDef",
    ...
    "FacetAttributeExtraOutputTypeDef",
...
TypedAttributeValueExtraOutputTypeDef = TypedDict(
    "TypedAttributeValueExtraOutputTypeDef",
    {
...
AttributeKeyAndValueExtraOutputTypeDef = TypedDict(
    "AttributeKeyAndValueExtraOutputTypeDef",
    {
        "Key": AttributeKeyTypeDef,
        "Value": TypedAttributeValueExtraOutputTypeDef,
    },
)
AttributeNameAndValueExtraOutputTypeDef = TypedDict(
    "AttributeNameAndValueExtraOutputTypeDef",
    {
        "AttributeName": str,
        "Value": TypedAttributeValueExtraOutputTypeDef,
...
FacetAttributeDefinitionExtraOutputTypeDef = TypedDict(
    "FacetAttributeDefinitionExtraOutputTypeDef",
    {
        "Type": FacetAttributeTypeType,
        "DefaultValue": NotRequired[TypedAttributeValueExtraOutputTypeDef],
        "IsImmutable": NotRequired[bool],
        "Rules": NotRequired[Dict[str, RuleExtraOutputTypeDef]],
    },
)
TypedLinkAttributeDefinitionExtraOutputTypeDef = TypedDict(
    "TypedLinkAttributeDefinitionExtraOutputTypeDef",
    {
        "Name": str,
        "Type": FacetAttributeTypeType,
...
TypedLinkSpecifierExtraOutputTypeDef = TypedDict(
    "TypedLinkSpecifierExtraOutputTypeDef",
    {
        ...
        "IdentityAttributeValues": List[AttributeNameAndValueExtraOutputTypeDef],
    },
)
...
FacetAttributeExtraOutputTypeDef = TypedDict(
    "FacetAttributeExtraOutputTypeDef",
    {
        "Name": str,
        "AttributeDefinition": NotRequired[FacetAttributeDefinitionExtraOutputTypeDef],
...
ListTypedLinkFacetAttributesResponseTypeDef = TypedDict(
    "ListTypedLinkFacetAttributesResponseTypeDef",
    {
        "Attributes": List[TypedLinkAttributeDefinitionExtraOutputTypeDef],
        "ResponseMetadata": ResponseMetadataTypeDef,
        "NextToken": NotRequired[str],
    },
)
...
ListIncomingTypedLinksResponseTypeDef = TypedDict(
    "ListIncomingTypedLinksResponseTypeDef",
    {
        "LinkSpecifiers": List[TypedLinkSpecifierExtraOutputTypeDef],
        "ResponseMetadata": ResponseMetadataTypeDef,
        "NextToken": NotRequired[str],
    },
)
ListOutgoingTypedLinksResponseTypeDef = TypedDict(
    "ListOutgoingTypedLinksResponseTypeDef",
    {
        "TypedLinkSpecifiers": List[TypedLinkSpecifierExtraOutputTypeDef],
        "ResponseMetadata": ResponseMetadataTypeDef,
        "NextToken": NotRequired[str],
    },
)
...
AttributeKeyAndValueUnionTypeDef = Union[
    AttributeKeyAndValueTypeDef, AttributeKeyAndValueExtraOutputTypeDef
]
...
AttributeNameAndValueUnionTypeDef = Union[
    AttributeNameAndValueTypeDef, AttributeNameAndValueExtraOutputTypeDef
]
...
TypedLinkSpecifierUnionTypeDef = Union[
    TypedLinkSpecifierTypeDef, TypedLinkSpecifierExtraOutputTypeDef
]
FacetAttributeUnionTypeDef = Union[FacetAttributeTypeDef, FacetAttributeExtraOutputTypeDef]
