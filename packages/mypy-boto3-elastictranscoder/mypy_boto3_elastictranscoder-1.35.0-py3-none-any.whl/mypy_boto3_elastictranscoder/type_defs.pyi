...
PermissionExtraOutputTypeDef = TypedDict(
    "PermissionExtraOutputTypeDef",
    {
...
PipelineOutputConfigExtraOutputTypeDef = TypedDict(
    "PipelineOutputConfigExtraOutputTypeDef",
    {
        "Bucket": NotRequired[str],
        "StorageClass": NotRequired[str],
        "Permissions": NotRequired[List[PermissionExtraOutputTypeDef]],
    },
)
...
VideoParametersExtraOutputTypeDef = TypedDict(
    "VideoParametersExtraOutputTypeDef",
    {
        "Codec": NotRequired[str],
...
InputCaptionsExtraOutputTypeDef = TypedDict(
    "InputCaptionsExtraOutputTypeDef",
    {
        "MergePolicy": NotRequired[str],
        "CaptionSources": NotRequired[List[CaptionSourceTypeDef]],
...
PipelineOutputConfigUnionTypeDef = Union[
    PipelineOutputConfigTypeDef, PipelineOutputConfigExtraOutputTypeDef
]
...
VideoParametersUnionTypeDef = Union[VideoParametersTypeDef, VideoParametersExtraOutputTypeDef]
...
JobInputExtraOutputTypeDef = TypedDict(
    "JobInputExtraOutputTypeDef",
    {
        "Key": NotRequired[str],
        "FrameRate": NotRequired[str],
        ...
        "Encryption": NotRequired[EncryptionTypeDef],
        "TimeSpan": NotRequired[TimeSpanTypeDef],
        "InputCaptions": NotRequired[InputCaptionsExtraOutputTypeDef],
...
JobInputUnionTypeDef = Union[JobInputTypeDef, JobInputExtraOutputTypeDef]
