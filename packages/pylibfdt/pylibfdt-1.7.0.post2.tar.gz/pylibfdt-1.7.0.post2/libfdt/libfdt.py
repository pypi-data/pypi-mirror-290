...
class fdt_node_header(object):
    ...
    name = property(_libfdt.fdt_node_header_name_get)
...
class fdt_property(object):
    ...
    data = property(_libfdt.fdt_property_data_get)
...
def fdt_get_path(fdt, nodeoffset, buf):
    return _libfdt.fdt_get_path(fdt, nodeoffset, buf)
...
def fdt_get_property_by_offset_w(fdt, offset):
    return _libfdt.fdt_get_property_by_offset_w(fdt, offset)
...
def fdt_overlay_target_offset(fdt, fdto, fragment_offset, pathp):
    return _libfdt.fdt_overlay_target_offset(fdt, fdto, fragment_offset, pathp)
