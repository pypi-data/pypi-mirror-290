...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, tls_validation=None, username=None, client_cert=None, client_key=None, rate_limit=None, url=None, password=None, headers=None, download_concurrency=None, proxy_password=None, proxy_username=None, ca_cert=None, total_timeout=None, connect_timeout=None, max_retries=None, proxy_url=None, pulp_labels=None, sock_read_timeout=None, name=None, sock_connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
