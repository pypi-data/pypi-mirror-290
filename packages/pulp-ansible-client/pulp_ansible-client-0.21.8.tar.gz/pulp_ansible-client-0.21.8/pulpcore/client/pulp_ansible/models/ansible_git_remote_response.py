...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_href=None, tls_validation=None, pulp_last_updated=None, pulp_created=None, client_cert=None, rate_limit=None, url=None, headers=None, download_concurrency=None, ca_cert=None, total_timeout=None, connect_timeout=None, max_retries=None, proxy_url=None, pulp_labels=None, sock_read_timeout=None, name=None, hidden_fields=None, sock_connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
