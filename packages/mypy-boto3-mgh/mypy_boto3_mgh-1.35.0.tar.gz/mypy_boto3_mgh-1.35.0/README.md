...
[boto3.MigrationHub 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/mgh.html#MigrationHub)
...
- Install `boto3-stubs[mgh]` in your environment:
...
Install `boto3-stubs-lite[mgh]` in your environment:
...
- Install `boto3-stubs[mgh]` with services you use in your environment:
...
list_progress_update_streams_paginator: ListProgressUpdateStreamsPaginator = client.get_paginator(
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_mgh/literals/).
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_mgh/type_defs/).
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_mgh/)
