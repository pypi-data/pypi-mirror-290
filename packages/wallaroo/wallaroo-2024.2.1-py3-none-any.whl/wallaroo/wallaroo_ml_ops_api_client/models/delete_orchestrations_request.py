...
T = TypeVar("T", bound="DeleteOrchestrationsRequest")


@_attrs_define
class DeleteOrchestrationsRequest:
    """Deletes the specified model versions.

    Attributes:
        orchestrations (List[str]): Model version IDs
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delete_orchestrations_request = cls(
            orchestrations=orchestrations,
            confirm_delete=confirm_delete,
        )

        delete_orchestrations_request.additional_properties = d
        return delete_orchestrations_request
