...
T = TypeVar("T", bound="SeriesSummary")


@_attrs_define
class SeriesSummary:
    """A statistical summary based off the given [`Aggregation`].
    ...
    Attributes:
        ...
        name (str): Name of the [`polars::prelude::Series`] this summary was made for.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        series_summary.additional_properties = d
