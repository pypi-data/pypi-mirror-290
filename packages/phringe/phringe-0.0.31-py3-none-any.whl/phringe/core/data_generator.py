...
class DataGenerator():
    ...
    def run(self) -> np.ndarray:
        ...
        a = self.differential_photon_counts.nelement() * self.differential_photon_counts.element_size()
        # b = intensity_responses.nelement() * intensity_responses.element_size()
        print(a)
        # print(b)
