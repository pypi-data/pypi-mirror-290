...
def change_trade(fx, trade):
    ...
    if str_trade_id and trade.trade_id == str_trade_id:
        print("Changing TradeID: {0:s}".format(trade.trade_id))
    ...
    trade_object =fxh.trade_row_to_trade_object(trade)
    trade_object.message="Trade stop changing to"
    #print(trade)
