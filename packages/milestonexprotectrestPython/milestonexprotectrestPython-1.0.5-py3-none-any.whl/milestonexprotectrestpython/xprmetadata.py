...
@export
class XPRMetadata(XPRDevice):
    """
    Metadata device information.

    More information about MetaData configuration can be found on the
    ...
    def __eq__(self, other):
        try:
            ...
            if (isinstance(self, XPRMetadata )) and (isinstance(other, XPRMetadata )):
                return self.Name == other.Name
            return False
