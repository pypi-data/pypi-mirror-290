...
def main():
    ...
    # cmd = 'service start plus -h 1 -l 1'
    # cmd = 'service start -short plus -h 2 -l 2'
    cmd = 'status'
    # cmd = 'widget enable all'
    # cmd = 'widget mark 224706f5-436c-5602-8257-85855c7127d5'
    # cmd = r'widget add C:\Users\amiao\Desktop\mtest\mtest03'
    # cmd = 'service start'
    # cmd = 'service start -short'
