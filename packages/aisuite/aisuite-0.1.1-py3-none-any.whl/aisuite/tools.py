...
### Starting C2-platform helper functions
## No new functions added

### Starting C3-platform helper functions
import folium
...
def view_map():
	...
	itinerary = {
	    "New York": {"coords": (40.7128, -74.0060), "arrival": "July-01", "departure": "July-08", "flag": "🇺🇸"},
	    "Rio de Janeiro": {"coords": (-22.9068, -43.1729), "arrival": "July-09", "departure": "July-16", "flag": "🇧🇷"},
	    "Cape Town": {"coords": (-33.9249, 18.4241), "arrival": "July-17", "departure": "July-24", "flag": "🇿🇦"},
	    "Istanbul": {"coords": (41.0082, 28.9784), "arrival": "July-25", "departure": "August-01", "flag": "🇹🇷"},
	    "Paris": {"coords": (48.8566, 2.3522), "arrival": "August-02", "departure": "August-09", "flag": "🇫🇷"},
	    "Tokyo": {"coords": (35.6895, 139.6917), "arrival": "August-10", "departure": "August-17", "flag": "🇯🇵"},
	    "Sydney": {"coords": (-33.8688, 151.2093), "arrival": "August-18", "departure": "August-25", "flag": "🇦🇺"}
	}
	...
	world_map = folium.Map(tiles="Cartodb Positron", 
	                       location=map_center, 
	                       zoom_start=2, max_bounds=True, control_scale=True, min_zoom=2, max_zoom=3)
	...
	for city, info in itinerary.items():
	    ...
	    if city == "New York":
	        folium.Marker(
	            ...
	            popup=popup_text,
	            icon=BeautifyIcon(icon='flag', border_color = "green", text_color = "green")
	        ).add_to(world_map)
	    elif city == "Sydney":
	        folium.Marker(
	            location=info["coords"],
	...
	for city, info in itinerary.items():
	    if prev_coords:
	        folium.PolyLine([prev_coords, info["coords"]], color='black').add_to(world_map)
...
def download_map(file_path = "trip_around_world_map.html", description = 'Click here to download the map'):
