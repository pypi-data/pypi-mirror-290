...
[boto3.DataZone 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/datazone.html#DataZone)
...
Install `boto3-stubs-lite[datazone]` in your environment:
