...
SA_fugue_sqlTranslator::~SA_fugue_sqlTranslator() {
    ...
    Py_XDECREF(FugueSchemaMapTypeContext_cls);
...
antlrcpp::Any SA_fugue_sqlTranslator::visitFugueSchemaMapType(fugue_sqlParser::FugueSchemaMapTypeContext *ctx){
    if(!FugueSchemaMapTypeContext_cls) FugueSchemaMapTypeContext_cls = PyObject_GetAttrString(translator->parser_cls, "FugueSchemaMapTypeContext");
    PyObject *py_ctx = translator->convert_ctx(this, ctx, FugueSchemaMapTypeContext_cls);
    return py_ctx;
}
