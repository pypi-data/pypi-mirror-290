...
if (n_structures != 0):
   ...
   for i in range(n_structures):
       ...
       #--------------------------------------------------------------
       ID_Bilayer = formula_bilayer + '/' + unique_id
       #---------------------------------------------
       # ID_Bilayer = str(n_Lattice) + 'L/' + formula_bilayer + '/'
       # ID_Bilayer += str(nions_1) + '_' + str(nions_2)
       # if (n_Lattice == 3): ID_Bilayer += '_' + str(nions_3)
       # ID_Bilayer += '/' + str(mismatch_12[i]) + '_' + str(angle1)
       # if (n_Lattice == 3): ID_Bilayer += '/' + str(mismatch_13[i]) + '_' + str(angle3)
       # ID_Bilayer += '/' + unique_id
       #-----------------------------------------------------------------
...
for i in range(len(files)):
    ...
    new_name = diret2 + '/' +  n_ion + '_' + VTemp1[0] + '_' + VTemp1[1] + '_' + str(VTemp1[-1]) + '+' + number
