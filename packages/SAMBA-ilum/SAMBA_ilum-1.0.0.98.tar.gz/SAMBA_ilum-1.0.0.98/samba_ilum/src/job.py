...
job.write(f'           python3 "$j_analysis.py" \n')
job.write(f'           #--------------------- \n')
job.write(f'           for k in "{tasks}"; do \n')
job.write(f'               #------------------------ \n')
job.write(f'               if [ "$j" == "xyz-scan" ] \n')
...
job.write(f'               #------------------------ \n')
job.write(f'               if [ "$j" == "xy-scan" ] \n')
job.write(f'                  if [[ "$k" != "xy-scan" && "$k" != "xyz-scan" ]];  then \n')
job.write(f'                     cp $dir0/$i/$j/POSCAR  $dir0/$i/$k/POSCAR \n')
job.write(f'                     cp $dir0/$i/$j/CONTCAR  $dir0/$i/$k/CONTCAR \n')
job.write(f'                  fi \n')
job.write(f'               fi \n')
job.write(f'               cp $dir0/$i/$j/POSCAR $dir0/$i/output/POSCAR \n')
job.write(f'               #------------------------ \n')
job.write(f'               if [ "$j" == "z-scan" ] \n')
job.write(f'                  if [[ "$k" != "z-scan" && "$k" != "xy-scan" && "$k" != "xyz-scan" ]];  then \n')
job.write(f'                     cp $dir0/$i/$j/POSCAR  $dir0/$i/$k/POSCAR \n')
job.write(f'                     cp $dir0/$i/$j/CONTCAR  $dir0/$i/$k/CONTCAR \n')
job.write(f'                  fi \n')
job.write(f'               fi \n')
job.write(f'               cp $dir0/$i/$j/POSCAR $dir0/$i/output/POSCAR \n')
job.write(f'               #------------------------ \n')
job.write(f'               if [ "$j" == "a-scan" ] \n')
job.write(f'                  if [[ "$k" != "a-scan" && "$k" != "z-scan" && "$k" != "xy-scan" && "$k" != "xyz-scan" ]];  then \n')
job.write(f'                     cp $dir0/$i/$j/POSCAR  $dir0/$i/$k/POSCAR \n')
job.write(f'                     cp $dir0/$i/$j/CONTCAR  $dir0/$i/$k/CONTCAR \n')
job.write(f'                  fi \n')
job.write(f'               fi \n')
...
job.write(f'           python3 contcar_update.py \n')
job.write(f'           for k in "{tasks}"; do \n')
job.write(f'               if [[ "$k" != "z-scan" && "$k" != "xy-scan" && "$k" != "relax" ]]; then \n')
