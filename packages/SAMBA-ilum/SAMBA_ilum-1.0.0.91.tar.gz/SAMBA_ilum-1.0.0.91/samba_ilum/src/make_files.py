...
for i in range(len(files)):
    ...
    if (VTemp1[0] != 'SAMBA'):
       ...
       #-------------------------------------------------------------------
       with open(Lattice1 + files[i], 'r') as file: line = file.readlines()
       line[0] = 'SAMBA ' + temp_ion + ' ' + temp_nion + ' ' + id_material + '\n'
       with open(Lattice1 + files[i], 'w') as file: file.writelines(line)
       #-----------------------------------------------------------------
...
#--------------------------------------------------------
command_terminal('rm -r ' + dir_files + '/Structures/.*')
#--------------------------------------------------------
...
for i in range(len(files)):
    ...
    VTemp_ions = poscar.readline()
    VTemp_nions = poscar.readline()
    poscar.close()
    #-------------
    number += 1
