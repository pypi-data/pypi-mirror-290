...
passo_if = replace_passo_if    # Incremento no valor de deltaZ entre as etapas "i" e "f"
...
#===========================================================
z_scan = np.arange(deltaZ_i, deltaZ_f +passo_if, passo_if)
z_scan = np.append(lista, 15.0)
#------------------------------
