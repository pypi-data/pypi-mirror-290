...
from moapy.wgsd.wgsd_flow import concrete_geometry, tendon_geometry, ConcreteGrade, InnerPolygon, OuterPolygon, Points, TendonProp
...
def calc_concrete_coordinate(inp: LinkConc):
    ...
    return {'outerPolygon': outerPolygon, 'innerPolygon': innerPolygon, 'matl': concrete_grade}
...
def calc_elem_tendon_properties(linkKey: LinkKey):
    ...
    return {'points': points, 'prop': tendon_properties}
