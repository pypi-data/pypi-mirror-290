...
async def custom_404_handler(request: Request, exc: BaseHTTPException) -> JSONResponse:
    response_code = getattr(exc, ResponseEnum.RESPONSE_KEY.RESPONSE_CODE.value, ResponseEnum.EXCEPTION.NOT_FOUND.response_key)
    ...
    response_content = {
        ...
        ResponseEnum.RESPONSE_KEY.MESSAGE.value: message or ResponseEnum.EXCEPTION.NOT_FOUND.value,
