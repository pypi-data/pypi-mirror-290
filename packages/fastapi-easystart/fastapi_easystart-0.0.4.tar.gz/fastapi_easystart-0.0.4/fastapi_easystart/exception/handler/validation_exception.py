...
async def validation_exception_handler(request: Request, exc: RequestValidationError) -> JSONResponse:
    ...
    modified_details = []
    response_code = ResponseEnum.EXCEPTION.VALIDATION_ERROR.response_key  # Default response code
    message = ResponseEnum.EXCEPTION.VALIDATION_ERROR.value  # Default message
    ...
    response_content = {
        ResponseEnum.RESPONSE_KEY.RESPONSE_CODE.value: ResponseEnum.EXCEPTION.VALIDATION_ERROR.value if response_code == "missing" else response_code,
