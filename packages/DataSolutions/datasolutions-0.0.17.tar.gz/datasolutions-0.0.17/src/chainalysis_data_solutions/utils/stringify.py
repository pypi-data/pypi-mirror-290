...
from chainalysis_data_solutions.util_functions.check_list_type import get_list_type
from chainalysis_data_solutions.util_functions.exceptions import BadRequest
...
class Stringify:
    ...
    def columns(self, columns: list) -> str:
        ...
        if type != str:
            raise BadRequest("Columns must be a list")
        return ", ".join(columns)
