...
#     assert case_serialized == SmpmDlDeviceEnergy8BSetRelayData.serialize(SmpmDlDeviceEnergy8BSetRelayData(state=False, relay_id=SmpmDlDeviceEnergy8bSetRelayId.ALL))  # noqa: E501
...
#     assert case_serialized == SmpmDlDeviceEnergy8BSetRelayData.serialize(SmpmDlDeviceEnergy8BSetRelayData(relay_id=SmpmDlDeviceEnergy8bSetRelayId.RELAY_ID_7, state=False))  # noqa: E501
