...
#
# RESULT int:        42341826945
# RESULT bin:  MSB   00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00000000 00001001 11011011 11000101 00000001 10000001   LSB
# RESULT hex:  LE    81 01 c5 db 09 00 00 00 00 00 00 00 00 00 00 00
#
...
# day                              u5                                               5          15                                                                                                       01111
# request_data_pack_ids.0.pack_id  SmpmDlDeviceEnergy16bGetDataDataRequestId       14         315                                                                                         00000100111011
# request_data_pack_ids.1.pack_id  SmpmDlDeviceEnergy16bGetDataDataRequestId       14           0                                                                           00000000000000
# request_data_pack_ids.2.pack_id  SmpmDlDeviceEnergy16bGetDataDataRequestId       14           0                                                             00000000000000
# request_data_pack_ids.3.pack_id  SmpmDlDeviceEnergy16bGetDataDataRequestId       14           0                                               00000000000000
# request_data_pack_ids.4.pack_id  SmpmDlDeviceEnergy16bGetDataDataRequestId       14           0                                 00000000000000
...
class SmpmDlDeviceEnergy16BGetDataData(Packet):
    ...
    @property
    def reserved_bit_count(self) -> int:
        return 17
