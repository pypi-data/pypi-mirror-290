...
class Geometry2DRegion2DIdeaRSOpenModel(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "outline": Geometry2DPolyLine2DIdeaRSOpenModel.from_dict(obj["outline"]) if obj.get("outline") is not None else None,
            "openings": [Geometry2DPolyLine2DIdeaRSOpenModel.from_dict(_item) for _item in obj["openings"]] if obj.get("openings") is not None else None
        })
        return _obj
