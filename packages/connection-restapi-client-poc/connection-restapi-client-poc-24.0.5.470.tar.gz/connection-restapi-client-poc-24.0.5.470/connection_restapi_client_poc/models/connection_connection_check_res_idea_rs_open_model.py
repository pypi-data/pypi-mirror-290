...
class ConnectionConnectionCheckResIdeaRSOpenModel(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "checkResSummary": [ConnectionCheckResSummaryIdeaRSOpenModel.from_dict(_item) for _item in obj["checkResSummary"]] if obj.get("checkResSummary") is not None else None,
            "checkResPlate": [ConnectionCheckResPlateIdeaRSOpenModel.from_dict(_item) for _item in obj["checkResPlate"]] if obj.get("checkResPlate") is not None else None,
            "checkResWeld": [ConnectionCheckResWeldIdeaRSOpenModel.from_dict(_item) for _item in obj["checkResWeld"]] if obj.get("checkResWeld") is not None else None,
            "checkResBolt": [ConnectionCheckResBoltIdeaRSOpenModel.from_dict(_item) for _item in obj["checkResBolt"]] if obj.get("checkResBolt") is not None else None,
            "checkResAnchor": [ConnectionCheckResAnchorIdeaRSOpenModel.from_dict(_item) for _item in obj["checkResAnchor"]] if obj.get("checkResAnchor") is not None else None,
            "checkResConcreteBlock": [ConnectionCheckResConcreteBlockIdeaRSOpenModel.from_dict(_item) for _item in obj["checkResConcreteBlock"]] if obj.get("checkResConcreteBlock") is not None else None,
            "bucklingResults": [ConnectionBucklingResIdeaRSOpenModel.from_dict(_item) for _item in obj["bucklingResults"]] if obj.get("bucklingResults") is not None else None,
            "name": obj.get("name"),
            "connectionID": obj.get("connectionID"),
            "id": obj.get("id"),
            "messages": MessageOpenMessagesIdeaRSOpenModel.from_dict(obj["messages"]) if obj.get("messages") is not None else None
        })
        return _obj
