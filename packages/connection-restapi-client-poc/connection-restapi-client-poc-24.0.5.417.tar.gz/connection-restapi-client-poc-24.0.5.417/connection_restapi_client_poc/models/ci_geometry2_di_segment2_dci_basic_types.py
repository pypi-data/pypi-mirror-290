...
class CIGeometry2DISegment2DCIBasicTypes(BaseModel):
    """
    CIGeometry2DISegment2DCIBasicTypes
    """ # noqa: E501
    end_point: Optional[CIGeometry2DIdaComPoint2DCIBasicTypes] = Field(default=None, alias="endPoint")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "endPoint": CIGeometry2DIdaComPoint2DCIBasicTypes.from_dict(obj["endPoint"]) if obj.get("endPoint") is not None else None
        })
        return _obj
