...
class CostEstimationItemBoltIdeaStatiCaConnectionChecks(BaseModel):
    """
    CostEstimationItemBoltIdeaStatiCaConnectionChecks
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["uniqueId", "unitCost", "cost", "totalWeight", "name", "grade"]
