...
class BucklingCheckDataIdeaStatiCaConnectionChecks(BaseModel):
    """
    BucklingCheckDataIdeaStatiCaConnectionChecks
    """ # noqa: E501
    shape: Optional[StrictInt] = None
    shape_inx: Optional[StrictInt] = Field(default=None, alias="shapeInx")
    bucklig_load_coefficient: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="buckligLoadCoefficient")
    ...
    __properties: ClassVar[List[str]] = ["shape", "shapeInx", "buckligLoadCoefficient", "id", "name", "checkStatus", "limitCheckStatus", "loadCaseId", "loadCase", "maxUnityCheck", "form"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "shape": obj.get("shape"),
            "shapeInx": obj.get("shapeInx"),
            "buckligLoadCoefficient": obj.get("buckligLoadCoefficient"),
            "id": obj.get("id"),
            "name": obj.get("name"),
