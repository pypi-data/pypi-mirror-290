...
class ResultResultOnMembersIdeaRSOpenModel(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "loading": ResultLoadingIdeaRSOpenModel.from_dict(obj["loading"]) if obj.get("loading") is not None else None,
            "members": [ResultResultOnMemberIdeaRSOpenModel.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None
        })
        return _obj
