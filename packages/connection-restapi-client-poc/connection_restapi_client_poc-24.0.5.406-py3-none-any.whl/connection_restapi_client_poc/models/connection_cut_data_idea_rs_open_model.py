...
class ConnectionCutDataIdeaRSOpenModel(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "planePoint": Geometry3DPoint3DIdeaRSOpenModel.from_dict(obj["planePoint"]) if obj.get("planePoint") is not None else None,
            "normalVector": Geometry3DVector3DIdeaRSOpenModel.from_dict(obj["normalVector"]) if obj.get("normalVector") is not None else None,
