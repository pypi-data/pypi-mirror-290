...
class OpenModelIdeaRSOpenModel(BaseModel):
    """
    OpenModelIdeaRSOpenModel
    """ # noqa: E501
    version: Optional[StrictInt] = None
    origin_settings: Optional[Dict[str, Any]] = Field(default=None, alias="originSettings")
    point3_d: Optional[List[Geometry3DPoint3DIdeaRSOpenModel]] = Field(default=None, alias="point3D")
    line_segment3_d: Optional[List[Geometry3DLineSegment3DIdeaRSOpenModel]] = Field(default=None, alias="lineSegment3D")
    arc_segment3_d: Optional[List[Geometry3DArcSegment3DIdeaRSOpenModel]] = Field(default=None, alias="arcSegment3D")
    poly_line3_d: Optional[List[Geometry3DPolyLine3DIdeaRSOpenModel]] = Field(default=None, alias="polyLine3D")
    region3_d: Optional[List[Geometry3DRegion3DIdeaRSOpenModel]] = Field(default=None, alias="region3D")
    mat_concrete: Optional[List[MaterialMatConcreteIdeaRSOpenModel]] = Field(default=None, alias="matConcrete")
    mat_reinforcement: Optional[List[MaterialMatReinforcementIdeaRSOpenModel]] = Field(default=None, alias="matReinforcement")
    mat_steel: Optional[List[MaterialMatSteelIdeaRSOpenModel]] = Field(default=None, alias="matSteel")
    mat_prestress_steel: Optional[List[MaterialMatPrestressSteelIdeaRSOpenModel]] = Field(default=None, alias="matPrestressSteel")
    mat_welding: Optional[List[MaterialMatWeldingIdeaRSOpenModel]] = Field(default=None, alias="matWelding")
    cross_section: Optional[List[CrossSectionCrossSectionIdeaRSOpenModel]] = Field(default=None, alias="crossSection")
    reinforced_cross_section: Optional[List[CrossSectionReinforcedCrossSectionIdeaRSOpenModel]] = Field(default=None, alias="reinforcedCrossSection")
    hinge_element1_d: Optional[List[ModelHingeElement1DIdeaRSOpenModel]] = Field(default=None, alias="hingeElement1D")
    opening: Optional[List[DetailOpeningIdeaRSOpenModel]] = None
    dapped_end: Optional[List[DetailDappedEndIdeaRSOpenModel]] = Field(default=None, alias="dappedEnd")
    patch_device: Optional[List[DetailPatchDeviceIdeaRSOpenModel]] = Field(default=None, alias="patchDevice")
    element1_d: Optional[List[ModelElement1DIdeaRSOpenModel]] = Field(default=None, alias="element1D")
    beam: Optional[List[DetailBeamIdeaRSOpenModel]] = None
    member1_d: Optional[List[ModelMember1DIdeaRSOpenModel]] = Field(default=None, alias="member1D")
    element2_d: Optional[List[ModelElement2DIdeaRSOpenModel]] = Field(default=None, alias="element2D")
    wall: Optional[List[DetailWallIdeaRSOpenModel]] = None
    member2_d: Optional[List[ModelMember2DIdeaRSOpenModel]] = Field(default=None, alias="member2D")
    rigid_link: Optional[List[ModelRigidLinkIdeaRSOpenModel]] = Field(default=None, alias="rigidLink")
    point_on_line3_d: Optional[List[Geometry3DPointOnLine3DIdeaRSOpenModel]] = Field(default=None, alias="pointOnLine3D")
    point_support_node: Optional[List[ModelPointSupportNodeIdeaRSOpenModel]] = Field(default=None, alias="pointSupportNode")
    line_support_segment: Optional[List[ModelLineSupportSegmentIdeaRSOpenModel]] = Field(default=None, alias="lineSupportSegment")
    loads_in_point: Optional[List[LoadingLoadInPointIdeaRSOpenModel]] = Field(default=None, alias="loadsInPoint")
    loads_on_line: Optional[List[LoadingLoadOnLineIdeaRSOpenModel]] = Field(default=None, alias="loadsOnLine")
    strain_loads_on_line: Optional[List[LoadingStrainLoadOnLineIdeaRSOpenModel]] = Field(default=None, alias="strainLoadsOnLine")
    point_loads_on_line: Optional[List[LoadingPointLoadOnLineIdeaRSOpenModel]] = Field(default=None, alias="pointLoadsOnLine")
    loads_on_surface: Optional[List[LoadingLoadOnSurfaceIdeaRSOpenModel]] = Field(default=None, alias="loadsOnSurface")
    settlements: Optional[List[LoadingSettlementIdeaRSOpenModel]] = None
    temperature_loads_on_line: Optional[List[LoadingTemperatureLoadOnLineIdeaRSOpenModel]] = Field(default=None, alias="temperatureLoadsOnLine")
    load_group: Optional[List[LoadingLoadGroupIdeaRSOpenModel]] = Field(default=None, alias="loadGroup")
    load_case: Optional[List[LoadingLoadCaseIdeaRSOpenModel]] = Field(default=None, alias="loadCase")
    combi_input: Optional[List[LoadingCombiInputIdeaRSOpenModel]] = Field(default=None, alias="combiInput")
    attribute: Optional[List[Dict[str, Any]]] = None
    connection_point: Optional[List[ConnectionConnectionPointIdeaRSOpenModel]] = Field(default=None, alias="connectionPoint")
    connections: Optional[List[ConnectionConnectionDataIdeaRSOpenModel]] = None
    reinforcement: Optional[List[DetailReinforcementIdeaRSOpenModel]] = None
    isd_model: Optional[List[DetailISDModelIdeaRSOpenModel]] = Field(default=None, alias="isdModel")
    initial_imperfection_of_point: Optional[List[ModelInitialImperfectionOfPointIdeaRSOpenModel]] = Field(default=None, alias="initialImperfectionOfPoint")
    tendon: Optional[List[ModelTendonIdeaRSOpenModel]] = None
    result_class: Optional[List[LoadingResultClassIdeaRSOpenModel]] = Field(default=None, alias="resultClass")
    design_member: Optional[List[ModelDesignMemberIdeaRSOpenModel]] = Field(default=None, alias="designMember")
    sub_structure: Optional[List[ModelSubStructureIdeaRSOpenModel]] = Field(default=None, alias="subStructure")
    connection_setup: Optional[ConnectionSetupIdeaRSOpenModel] = Field(default=None, alias="connectionSetup")
    project_data: Optional[Dict[str, Any]] = Field(default=None, alias="projectData")
    check_member: Optional[List[ModelCheckMemberIdeaRSOpenModel]] = Field(default=None, alias="checkMember")
    concrete_check_section: Optional[List[ConcreteCheckSectionIdeaRSOpenModel]] = Field(default=None, alias="concreteCheckSection")
    concrete_setup: Optional[ConcreteConcreteSetupIdeaRSOpenModel] = Field(default=None, alias="concreteSetup")
    project_data_concrete: Optional[Dict[str, Any]] = Field(default=None, alias="projectDataConcrete")
    rebar_shape: Optional[List[ModelRebarShapeIdeaRSOpenModel]] = Field(default=None, alias="rebarShape")
    rebar_general: Optional[List[ModelRebarGeneralIdeaRSOpenModel]] = Field(default=None, alias="rebarGeneral")
    rebar_single: Optional[List[ModelRebarSingleIdeaRSOpenModel]] = Field(default=None, alias="rebarSingle")
    rebar_stirrups: Optional[List[ModelRebarStirrupsIdeaRSOpenModel]] = Field(default=None, alias="rebarStirrups")
    taper: Optional[List[ModelTaperIdeaRSOpenModel]] = None
    span: Optional[List[ModelSpanIdeaRSOpenModel]] = None
    solid_blocks3_d: Optional[List[DetailSolidBlock3DIdeaRSOpenModel]] = Field(default=None, alias="solidBlocks3D")
    surface_supports3_d: Optional[List[DetailSurfaceSupport3DIdeaRSOpenModel]] = Field(default=None, alias="surfaceSupports3D")
    base_plates3_d: Optional[List[DetailBasePlate3DIdeaRSOpenModel]] = Field(default=None, alias="basePlates3D")
    anchors3_d: Optional[List[DetailAnchor3DIdeaRSOpenModel]] = Field(default=None, alias="anchors3D")
    detail_load_case: Optional[List[DetailLoadingDetailLoadCaseIdeaRSOpenModel]] = Field(default=None, alias="detailLoadCase")
    detail_combination: Optional[List[DetailLoadingDetailCombinationIdeaRSOpenModel]] = Field(default=None, alias="detailCombination")
    __properties: ClassVar[List[str]] = ["version", "originSettings", "point3D", "lineSegment3D", "arcSegment3D", "polyLine3D", "region3D", "matConcrete", "matReinforcement", "matSteel", "matPrestressSteel", "matWelding", "crossSection", "reinforcedCrossSection", "hingeElement1D", "opening", "dappedEnd", "patchDevice", "element1D", "beam", "member1D", "element2D", "wall", "member2D", "rigidLink", "pointOnLine3D", "pointSupportNode", "lineSupportSegment", "loadsInPoint", "loadsOnLine", "strainLoadsOnLine", "pointLoadsOnLine", "loadsOnSurface", "settlements", "temperatureLoadsOnLine", "loadGroup", "loadCase", "combiInput", "attribute", "connectionPoint", "connections", "reinforcement", "isdModel", "initialImperfectionOfPoint", "tendon", "resultClass", "designMember", "subStructure", "connectionSetup", "projectData", "checkMember", "concreteCheckSection", "concreteSetup", "projectDataConcrete", "rebarShape", "rebarGeneral", "rebarSingle", "rebarStirrups", "taper", "span", "solidBlocks3D", "surfaceSupports3D", "basePlates3D", "anchors3D", "detailLoadCase", "detailCombination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "point3D": [Geometry3DPoint3DIdeaRSOpenModel.from_dict(_item) for _item in obj["point3D"]] if obj.get("point3D") is not None else None,
            "lineSegment3D": [Geometry3DLineSegment3DIdeaRSOpenModel.from_dict(_item) for _item in obj["lineSegment3D"]] if obj.get("lineSegment3D") is not None else None,
            "arcSegment3D": [Geometry3DArcSegment3DIdeaRSOpenModel.from_dict(_item) for _item in obj["arcSegment3D"]] if obj.get("arcSegment3D") is not None else None,
            "polyLine3D": [Geometry3DPolyLine3DIdeaRSOpenModel.from_dict(_item) for _item in obj["polyLine3D"]] if obj.get("polyLine3D") is not None else None,
            "region3D": [Geometry3DRegion3DIdeaRSOpenModel.from_dict(_item) for _item in obj["region3D"]] if obj.get("region3D") is not None else None,
            "matConcrete": [MaterialMatConcreteIdeaRSOpenModel.from_dict(_item) for _item in obj["matConcrete"]] if obj.get("matConcrete") is not None else None,
            "matReinforcement": [MaterialMatReinforcementIdeaRSOpenModel.from_dict(_item) for _item in obj["matReinforcement"]] if obj.get("matReinforcement") is not None else None,
            "matSteel": [MaterialMatSteelIdeaRSOpenModel.from_dict(_item) for _item in obj["matSteel"]] if obj.get("matSteel") is not None else None,
            "matPrestressSteel": [MaterialMatPrestressSteelIdeaRSOpenModel.from_dict(_item) for _item in obj["matPrestressSteel"]] if obj.get("matPrestressSteel") is not None else None,
            "matWelding": [MaterialMatWeldingIdeaRSOpenModel.from_dict(_item) for _item in obj["matWelding"]] if obj.get("matWelding") is not None else None,
            "crossSection": [CrossSectionCrossSectionIdeaRSOpenModel.from_dict(_item) for _item in obj["crossSection"]] if obj.get("crossSection") is not None else None,
            "reinforcedCrossSection": [CrossSectionReinforcedCrossSectionIdeaRSOpenModel.from_dict(_item) for _item in obj["reinforcedCrossSection"]] if obj.get("reinforcedCrossSection") is not None else None,
            "hingeElement1D": [ModelHingeElement1DIdeaRSOpenModel.from_dict(_item) for _item in obj["hingeElement1D"]] if obj.get("hingeElement1D") is not None else None,
            "opening": [DetailOpeningIdeaRSOpenModel.from_dict(_item) for _item in obj["opening"]] if obj.get("opening") is not None else None,
            "dappedEnd": [DetailDappedEndIdeaRSOpenModel.from_dict(_item) for _item in obj["dappedEnd"]] if obj.get("dappedEnd") is not None else None,
            "patchDevice": [DetailPatchDeviceIdeaRSOpenModel.from_dict(_item) for _item in obj["patchDevice"]] if obj.get("patchDevice") is not None else None,
            "element1D": [ModelElement1DIdeaRSOpenModel.from_dict(_item) for _item in obj["element1D"]] if obj.get("element1D") is not None else None,
            "beam": [DetailBeamIdeaRSOpenModel.from_dict(_item) for _item in obj["beam"]] if obj.get("beam") is not None else None,
            "member1D": [ModelMember1DIdeaRSOpenModel.from_dict(_item) for _item in obj["member1D"]] if obj.get("member1D") is not None else None,
            "element2D": [ModelElement2DIdeaRSOpenModel.from_dict(_item) for _item in obj["element2D"]] if obj.get("element2D") is not None else None,
            "wall": [DetailWallIdeaRSOpenModel.from_dict(_item) for _item in obj["wall"]] if obj.get("wall") is not None else None,
            "member2D": [ModelMember2DIdeaRSOpenModel.from_dict(_item) for _item in obj["member2D"]] if obj.get("member2D") is not None else None,
            "rigidLink": [ModelRigidLinkIdeaRSOpenModel.from_dict(_item) for _item in obj["rigidLink"]] if obj.get("rigidLink") is not None else None,
            "pointOnLine3D": [Geometry3DPointOnLine3DIdeaRSOpenModel.from_dict(_item) for _item in obj["pointOnLine3D"]] if obj.get("pointOnLine3D") is not None else None,
            "pointSupportNode": [ModelPointSupportNodeIdeaRSOpenModel.from_dict(_item) for _item in obj["pointSupportNode"]] if obj.get("pointSupportNode") is not None else None,
            "lineSupportSegment": [ModelLineSupportSegmentIdeaRSOpenModel.from_dict(_item) for _item in obj["lineSupportSegment"]] if obj.get("lineSupportSegment") is not None else None,
            "loadsInPoint": [LoadingLoadInPointIdeaRSOpenModel.from_dict(_item) for _item in obj["loadsInPoint"]] if obj.get("loadsInPoint") is not None else None,
            "loadsOnLine": [LoadingLoadOnLineIdeaRSOpenModel.from_dict(_item) for _item in obj["loadsOnLine"]] if obj.get("loadsOnLine") is not None else None,
            "strainLoadsOnLine": [LoadingStrainLoadOnLineIdeaRSOpenModel.from_dict(_item) for _item in obj["strainLoadsOnLine"]] if obj.get("strainLoadsOnLine") is not None else None,
            "pointLoadsOnLine": [LoadingPointLoadOnLineIdeaRSOpenModel.from_dict(_item) for _item in obj["pointLoadsOnLine"]] if obj.get("pointLoadsOnLine") is not None else None,
            "loadsOnSurface": [LoadingLoadOnSurfaceIdeaRSOpenModel.from_dict(_item) for _item in obj["loadsOnSurface"]] if obj.get("loadsOnSurface") is not None else None,
            "settlements": [LoadingSettlementIdeaRSOpenModel.from_dict(_item) for _item in obj["settlements"]] if obj.get("settlements") is not None else None,
            "temperatureLoadsOnLine": [LoadingTemperatureLoadOnLineIdeaRSOpenModel.from_dict(_item) for _item in obj["temperatureLoadsOnLine"]] if obj.get("temperatureLoadsOnLine") is not None else None,
            "loadGroup": [LoadingLoadGroupIdeaRSOpenModel.from_dict(_item) for _item in obj["loadGroup"]] if obj.get("loadGroup") is not None else None,
            "loadCase": [LoadingLoadCaseIdeaRSOpenModel.from_dict(_item) for _item in obj["loadCase"]] if obj.get("loadCase") is not None else None,
            "combiInput": [LoadingCombiInputIdeaRSOpenModel.from_dict(_item) for _item in obj["combiInput"]] if obj.get("combiInput") is not None else None,
            "attribute": obj.get("attribute"),
            "connectionPoint": [ConnectionConnectionPointIdeaRSOpenModel.from_dict(_item) for _item in obj["connectionPoint"]] if obj.get("connectionPoint") is not None else None,
            "connections": [ConnectionConnectionDataIdeaRSOpenModel.from_dict(_item) for _item in obj["connections"]] if obj.get("connections") is not None else None,
            "reinforcement": [DetailReinforcementIdeaRSOpenModel.from_dict(_item) for _item in obj["reinforcement"]] if obj.get("reinforcement") is not None else None,
            "isdModel": [DetailISDModelIdeaRSOpenModel.from_dict(_item) for _item in obj["isdModel"]] if obj.get("isdModel") is not None else None,
            "initialImperfectionOfPoint": [ModelInitialImperfectionOfPointIdeaRSOpenModel.from_dict(_item) for _item in obj["initialImperfectionOfPoint"]] if obj.get("initialImperfectionOfPoint") is not None else None,
            "tendon": [ModelTendonIdeaRSOpenModel.from_dict(_item) for _item in obj["tendon"]] if obj.get("tendon") is not None else None,
            "resultClass": [LoadingResultClassIdeaRSOpenModel.from_dict(_item) for _item in obj["resultClass"]] if obj.get("resultClass") is not None else None,
            "designMember": [ModelDesignMemberIdeaRSOpenModel.from_dict(_item) for _item in obj["designMember"]] if obj.get("designMember") is not None else None,
            "subStructure": [ModelSubStructureIdeaRSOpenModel.from_dict(_item) for _item in obj["subStructure"]] if obj.get("subStructure") is not None else None,
            "connectionSetup": ConnectionSetupIdeaRSOpenModel.from_dict(obj["connectionSetup"]) if obj.get("connectionSetup") is not None else None,
            "projectData": obj.get("projectData"),
            "checkMember": [ModelCheckMemberIdeaRSOpenModel.from_dict(_item) for _item in obj["checkMember"]] if obj.get("checkMember") is not None else None,
            "concreteCheckSection": [ConcreteCheckSectionIdeaRSOpenModel.from_dict(_item) for _item in obj["concreteCheckSection"]] if obj.get("concreteCheckSection") is not None else None,
            ...
            "rebarShape": [ModelRebarShapeIdeaRSOpenModel.from_dict(_item) for _item in obj["rebarShape"]] if obj.get("rebarShape") is not None else None,
            "rebarGeneral": [ModelRebarGeneralIdeaRSOpenModel.from_dict(_item) for _item in obj["rebarGeneral"]] if obj.get("rebarGeneral") is not None else None,
            "rebarSingle": [ModelRebarSingleIdeaRSOpenModel.from_dict(_item) for _item in obj["rebarSingle"]] if obj.get("rebarSingle") is not None else None,
            "rebarStirrups": [ModelRebarStirrupsIdeaRSOpenModel.from_dict(_item) for _item in obj["rebarStirrups"]] if obj.get("rebarStirrups") is not None else None,
            "taper": [ModelTaperIdeaRSOpenModel.from_dict(_item) for _item in obj["taper"]] if obj.get("taper") is not None else None,
            "span": [ModelSpanIdeaRSOpenModel.from_dict(_item) for _item in obj["span"]] if obj.get("span") is not None else None,
            "solidBlocks3D": [DetailSolidBlock3DIdeaRSOpenModel.from_dict(_item) for _item in obj["solidBlocks3D"]] if obj.get("solidBlocks3D") is not None else None,
            "surfaceSupports3D": [DetailSurfaceSupport3DIdeaRSOpenModel.from_dict(_item) for _item in obj["surfaceSupports3D"]] if obj.get("surfaceSupports3D") is not None else None,
            "basePlates3D": [DetailBasePlate3DIdeaRSOpenModel.from_dict(_item) for _item in obj["basePlates3D"]] if obj.get("basePlates3D") is not None else None,
            "anchors3D": [DetailAnchor3DIdeaRSOpenModel.from_dict(_item) for _item in obj["anchors3D"]] if obj.get("anchors3D") is not None else None,
            "detailLoadCase": [DetailLoadingDetailLoadCaseIdeaRSOpenModel.from_dict(_item) for _item in obj["detailLoadCase"]] if obj.get("detailLoadCase") is not None else None,
            "detailCombination": [DetailLoadingDetailCombinationIdeaRSOpenModel.from_dict(_item) for _item in obj["detailCombination"]] if obj.get("detailCombination") is not None else None
        })
        return _obj
