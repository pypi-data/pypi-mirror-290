...
class DataThinPlateValidityCIBasicTypes(BaseModel):
    """
    DataThinPlateValidityCIBasicTypes
    """ # noqa: E501
    related_plate_name: Optional[StrictStr] = Field(default=None, alias="relatedPlateName")
    validity_criteria: Optional[List[DataThinPlateValidityCriterionCIBasicTypes]] = Field(default=None, alias="validityCriteria")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "validityCriteria": [DataThinPlateValidityCriterionCIBasicTypes.from_dict(_item) for _item in obj["validityCriteria"]] if obj.get("validityCriteria") is not None else None
        })
        return _obj
