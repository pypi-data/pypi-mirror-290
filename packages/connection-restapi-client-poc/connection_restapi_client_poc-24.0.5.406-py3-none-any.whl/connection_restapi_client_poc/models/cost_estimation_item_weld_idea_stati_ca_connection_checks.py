...
class CostEstimationItemWeldIdeaStatiCaConnectionChecks(BaseModel):
    """
    CostEstimationItemWeldIdeaStatiCaConnectionChecks
    """ # noqa: E501
    unique_id: Optional[StrictInt] = Field(default=None, alias="uniqueId")
    ...
    throat_thickness: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="throatThickness")
    plate_thickness: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="plateThickness")
    leg_size: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="legSize")
    weld_type: Optional[DataWeldTypeCodeCIBasicTypes] = Field(default=None, alias="weldType")
    __properties: ClassVar[List[str]] = ["uniqueId", "unitCost", "cost", "totalWeight", "name", "throatThickness", "plateThickness", "legSize", "weldType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "throatThickness": obj.get("throatThickness"),
            "plateThickness": obj.get("plateThickness"),
