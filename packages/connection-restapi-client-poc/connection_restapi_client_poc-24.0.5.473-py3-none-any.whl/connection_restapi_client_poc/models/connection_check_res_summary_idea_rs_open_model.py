...
class ConnectionCheckResSummaryIdeaRSOpenModel(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if unity_check_message (nullable) is None
        # and model_fields_set contains the field
        if self.unity_check_message is None and "unity_check_message" in self.model_fields_set:
            _dict['unityCheckMessage'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "unityCheckMessage": obj.get("unityCheckMessage"),
