...
class ConnectionBeamDataIdeaRSOpenModel(BaseModel):
    """
    ...
    cuts: Optional[List[ConnectionCutDataIdeaRSOpenModel]] = None
    ...
    added_member: Optional[ReferenceElementIdeaRSOpenModel] = Field(default=None, alias="addedMember")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cuts": [ConnectionCutDataIdeaRSOpenModel.from_dict(_item) for _item in obj["cuts"]] if obj.get("cuts") is not None else None,
            "isAdded": obj.get("isAdded"),
            "addedMemberLength": obj.get("addedMemberLength"),
            "isNegativeObject": obj.get("isNegativeObject"),
            "addedMember": ReferenceElementIdeaRSOpenModel.from_dict(obj["addedMember"]) if obj.get("addedMember") is not None else None,
