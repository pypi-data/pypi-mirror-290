...
class ConnectionAnchorGridIdeaRSOpenModel(BaseModel):
    """
    ConnectionAnchorGridIdeaRSOpenModel
    """ # noqa: E501
    concrete_block: Optional[ConnectionConcreteBlockIdeaRSOpenModel] = Field(default=None, alias="concreteBlock")
    anchor_type: Optional[ParametersAnchorTypeIdeaRSOpenModel] = Field(default=None, alias="anchorType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "concreteBlock": ConnectionConcreteBlockIdeaRSOpenModel.from_dict(obj["concreteBlock"]) if obj.get("concreteBlock") is not None else None,
            ...
            "positions": [Geometry3DPoint3DIdeaRSOpenModel.from_dict(_item) for _item in obj["positions"]] if obj.get("positions") is not None else None,
