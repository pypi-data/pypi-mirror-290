...
class Geometry2DPolyLine2DIdeaRSOpenModel(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "startPoint": Geometry2DPoint2DIdeaRSOpenModel.from_dict(obj["startPoint"]) if obj.get("startPoint") is not None else None,
            "segments": [Geometry2DSegment2DIdeaRSOpenModel.from_dict(_item) for _item in obj["segments"]] if obj.get("segments") is not None else None
        })
        return _obj
