...
class CostEstimationItemSteelIdeaStatiCaConnectionChecks(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["uniqueId", "unitCost", "cost", "totalWeight", "name", "grade", "plateThickness"]
