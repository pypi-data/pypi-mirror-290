...
class IdeaStatiCaApiConnectionModelProjCrossSectionIdeaStatiCaApi(BaseModel):
    """
    ...
    is_from_database: Optional[StrictBool] = Field(default=None, alias="isFromDatabase")
    database_name: Optional[StrictStr] = Field(default=None, alias="databaseName")
    material: Optional[StrictStr] = None
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["crossSectionType", "isFromDatabase", "databaseName", "material", "id", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isFromDatabase": obj.get("isFromDatabase"),
