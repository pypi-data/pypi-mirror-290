...
class CIGeometry2DIRegion2DCIBasicTypes(BaseModel):
    """
    CIGeometry2DIRegion2DCIBasicTypes
    """ # noqa: E501
    outline: Optional[CIGeometry2DIPolyLine2DCIBasicTypes] = None
    openings: Optional[List[CIGeometry2DIPolyLine2DCIBasicTypes]] = None
    arc_discr_angle: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="arcDiscrAngle")
    __properties: ClassVar[List[str]] = ["outline", "openings", "arcDiscrAngle"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "outline": CIGeometry2DIPolyLine2DCIBasicTypes.from_dict(obj["outline"]) if obj.get("outline") is not None else None,
            "openings": [CIGeometry2DIPolyLine2DCIBasicTypes.from_dict(_item) for _item in obj["openings"]] if obj.get("openings") is not None else None,
            "arcDiscrAngle": obj.get("arcDiscrAngle")
        })
        return _obj
