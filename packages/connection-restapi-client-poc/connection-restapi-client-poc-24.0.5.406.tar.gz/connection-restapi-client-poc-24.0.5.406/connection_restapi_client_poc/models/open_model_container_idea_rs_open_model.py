...
class OpenModelContainerIdeaRSOpenModel(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "openModel": OpenModelIdeaRSOpenModel.from_dict(obj["openModel"]) if obj.get("openModel") is not None else None,
            "openModelResult": ResultOpenModelResultIdeaRSOpenModel.from_dict(obj["openModelResult"]) if obj.get("openModelResult") is not None else None
        })
        return _obj
