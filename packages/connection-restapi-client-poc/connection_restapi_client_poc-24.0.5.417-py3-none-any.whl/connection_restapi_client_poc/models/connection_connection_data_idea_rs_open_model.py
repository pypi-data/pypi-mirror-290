...
class ConnectionConnectionDataIdeaRSOpenModel(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "beams": [ConnectionBeamDataIdeaRSOpenModel.from_dict(_item) for _item in obj["beams"]] if obj.get("beams") is not None else None,
            "plates": [ConnectionPlateDataIdeaRSOpenModel.from_dict(_item) for _item in obj["plates"]] if obj.get("plates") is not None else None,
            "foldedPlates": [ConnectionFoldedPlateDataIdeaRSOpenModel.from_dict(_item) for _item in obj["foldedPlates"]] if obj.get("foldedPlates") is not None else None,
            "boltGrids": [ConnectionBoltGridIdeaRSOpenModel.from_dict(_item) for _item in obj["boltGrids"]] if obj.get("boltGrids") is not None else None,
            "anchorGrids": [ConnectionAnchorGridIdeaRSOpenModel.from_dict(_item) for _item in obj["anchorGrids"]] if obj.get("anchorGrids") is not None else None,
            "welds": [ConnectionWeldDataIdeaRSOpenModel.from_dict(_item) for _item in obj["welds"]] if obj.get("welds") is not None else None,
            "concreteBlocks": [ConnectionConcreteBlockDataIdeaRSOpenModel.from_dict(_item) for _item in obj["concreteBlocks"]] if obj.get("concreteBlocks") is not None else None,
            "cutBeamByBeams": [ConnectionCutBeamByBeamDataIdeaRSOpenModel.from_dict(_item) for _item in obj["cutBeamByBeams"]] if obj.get("cutBeamByBeams") is not None else None
        })
        return _obj
