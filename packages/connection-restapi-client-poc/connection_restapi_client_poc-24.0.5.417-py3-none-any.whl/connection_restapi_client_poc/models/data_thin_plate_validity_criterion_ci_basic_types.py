...
class DataThinPlateValidityCriterionCIBasicTypes(BaseModel):
    """
    DataThinPlateValidityCriterionCIBasicTypes
    """ # noqa: E501
    value_name: Optional[StrictStr] = Field(default=None, alias="valueName")
    value: Optional[Union[StrictFloat, StrictInt]] = None
    limit: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["valueName", "value", "limit"]
