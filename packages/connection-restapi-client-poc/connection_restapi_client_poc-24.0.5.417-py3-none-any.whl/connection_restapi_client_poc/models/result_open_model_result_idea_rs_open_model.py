...
class ResultOpenModelResultIdeaRSOpenModel(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resultOnMembers": [ResultResultOnMembersIdeaRSOpenModel.from_dict(_item) for _item in obj["resultOnMembers"]] if obj.get("resultOnMembers") is not None else None
        })
        return _obj
