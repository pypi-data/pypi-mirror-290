...
from .wsi import WSI, wsi_factory
...
def segment_tissue_deep(
    ...
    from .datasets import WSIPatcherDataset
    from .singletons import segmenter_singleton
    ...
    if weights_dir is None:
        weights_dir = get_path_relative(__file__, f'../models/')
    ...
    model = segmenter_singleton.get_model(weights_dir, model_name, auto_download=auto_download)
...
def get_path_relative(file, path) -> str:
    ...
    rel_path = Path(os.path.join(curr_dir, path))
