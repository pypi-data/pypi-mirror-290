...
from officelyTest.team_builder.nodes.enums import NodeType
from officelyTest.team_builder.nodes.filter.interfaces import ICondition, IFilterObject
from officelyTest.team_builder.nodes.interface import Iinputs
from officelyTest.team_builder.nodes.node import Node
...
class FilterNode(Node):
    ...
    def send_verbose(self, parent:str, child:str, g:Optional[ThreadedGenerator]=None):
        if g:
