...
secrets_dict=sparta_5541c9b661()
...
hostnames=[_D,sparta_2354afc773()]
...
from spartaqube_app.db_path import sparta_6f7516b5ff
LOCAL_DB_PATH=sparta_6f7516b5ff()
print('LOCAL_DB_PATH >>> '+str(LOCAL_DB_PATH))
