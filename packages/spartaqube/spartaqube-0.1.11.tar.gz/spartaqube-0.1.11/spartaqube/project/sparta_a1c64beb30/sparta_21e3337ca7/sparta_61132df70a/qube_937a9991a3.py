...
plot_example"""}]
def sparta_399d932742():return sparta_eb880e2232(type=_N)
def sparta_670817a97a():return sparta_eb880e2232(type='gauge2')
def sparta_2b00b0a610():
	type='gauge3'
	if conf_settings.IS_DEV:B=_F
	else:B=_G
