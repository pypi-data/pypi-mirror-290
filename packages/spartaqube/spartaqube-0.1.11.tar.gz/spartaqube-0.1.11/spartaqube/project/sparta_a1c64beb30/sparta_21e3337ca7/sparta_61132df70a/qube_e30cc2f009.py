...
def sparta_eb880e2232(type='line'):
...
plot_example"""}]
def sparta_ef1d20fb02():return sparta_eb880e2232(type='line')
def sparta_4ec2ddc3a0():return sparta_eb880e2232(type='bar')
def sparta_e9b2222873():return sparta_eb880e2232(type='scatter')
def sparta_952bc687d5():
	if conf_settings.IS_DEV:A=_F
	else:A=_G
...
plot_example"""}]
def sparta_04d5977851(type='pie'):
	if conf_settings.IS_DEV:A=_F
	else:A=_G
...
plot_example"""}]
def sparta_2fd0676010():return sparta_04d5977851(type='donut')
def sparta_8399b4afc4():return sparta_04d5977851(type='polar')
def sparta_6f7000ada5():
	type='bubble'
	if conf_settings.IS_DEV:A=_F
	else:A=_G
	B={_I:_L,_J:_M,_K:_N};C=_O;D=_P;return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f"""{A}
