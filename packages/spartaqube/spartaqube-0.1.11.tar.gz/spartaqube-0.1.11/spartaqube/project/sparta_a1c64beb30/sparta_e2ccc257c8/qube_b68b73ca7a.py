...
def sparta_913d7214d4(json_data,userObj):
	A=json_data
	try:D=A[_A];E=A[_C];B=os.path.dirname(D);F,G=sparta_17fce97c40(B,E);C={_B:1,'files':G,_D:F,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_599131f840(json_data,userObj):
	A=json_data
	try:B=A[_A];D=A[_C];E,F=sparta_17fce97c40(B,D);C={_B:1,'files':F,_D:E,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_17fce97c40(currentPath,typeexplorer=None):
...
def sparta_bf6693e157(currentPath):
