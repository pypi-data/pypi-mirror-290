...
import pytz
UTC=pytz.utc
def sparta_33f36433bc():0
def sparta_a00105a0ab():
...
def sparta_76f8059b8c():
	...
	return A
def sparta_a7e5adfc60():
	F='res'
	try:
		C=sparta_76f8059b8c();A=sparta_a00105a0ab();D=AppVersioning.objects.all();E=datetime.now().astimezone(UTC)
