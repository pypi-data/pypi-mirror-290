...
def sparta_9d7197d0ea(type='line'):
...
plot_example"""}]
def sparta_9fcfb6c8d6():return sparta_9d7197d0ea(type='line')
def sparta_e0008d935d():return sparta_9d7197d0ea(type='bar')
def sparta_97a64d6f76():return sparta_9d7197d0ea(type='scatter')
def sparta_237b0a2c10():
	if conf_settings.IS_DEV:A=_F
	else:A=_G
...
plot_example"""}]
def sparta_b337c05594(type='pie'):
	if conf_settings.IS_DEV:A=_F
	else:A=_G
...
plot_example"""}]
def sparta_e9b511a84a():return sparta_b337c05594(type='donut')
def sparta_4b04c54d22():return sparta_b337c05594(type='polar')
def sparta_055af549cf():
	type='bubble'
	if conf_settings.IS_DEV:A=_F
	else:A=_G
	B={_I:_L,_J:_M,_K:_N};C=_O;D=_P;return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f"""{A}
