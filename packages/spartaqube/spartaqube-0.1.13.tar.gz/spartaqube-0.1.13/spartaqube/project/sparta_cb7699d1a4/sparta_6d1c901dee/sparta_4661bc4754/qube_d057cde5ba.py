...
def sparta_05c074fb40(type='candlestick'):
...
plot_example"""}]
def sparta_9d7197d0ea(type='line2'):
	if conf_settings.IS_DEV:A=_E
	else:A=_F
...
plot_example"""}]
def sparta_b2d0c1a551():return sparta_9d7197d0ea('line2')
def sparta_2fa5e1713b():return sparta_9d7197d0ea('bar2')
def sparta_4e9527ba02():return sparta_9d7197d0ea('area2')
def sparta_2e419d069d():return sparta_9d7197d0ea('lollipop2')
def sparta_0dddd974c2():
