...
def sparta_9315ef9e4e(user_obj):
	B=user_obj
	...
	return A
def sparta_e90cef3780(json_data,user_obj):
...
def sparta_3dd1e3a1b7(json_data,user_obj):
...
def sparta_f2ff8ec500(json_data,user_obj):
	...
	return{_C:1}
def sparta_aab258f31a(json_data,user_obj):
