...
plot_example"""}]
def sparta_50624cb569():return sparta_9d7197d0ea(type=_N)
def sparta_6d99964c61():return sparta_9d7197d0ea(type='gauge2')
def sparta_1c0c8d26bd():
	type='gauge3'
	if conf_settings.IS_DEV:B=_F
	else:B=_G
