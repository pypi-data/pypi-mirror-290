...
def sparta_7c417af3e6(json_data,userObj):
	A=json_data
	try:D=A[_A];E=A[_C];B=os.path.dirname(D);F,G=sparta_9a831df077(B,E);C={_B:1,'files':G,_D:F,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_8e443c59fd(json_data,userObj):
	A=json_data
	try:B=A[_A];D=A[_C];E,F=sparta_9a831df077(B,D);C={_B:1,'files':F,_D:E,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_9a831df077(currentPath,typeexplorer=None):
...
def sparta_e7706de71a(currentPath):
