...
from project.sparta_cb7699d1a4.sparta_9afaf2aacf.qube_8f2e727781 import IPythonKernel as IPythonKernel
from project.sparta_cb7699d1a4.sparta_9afaf2aacf.qube_26ecaa4192 import sparta_ebce0d45e6
...
from project.sparta_7ea42ed2bd.sparta_4b6986daa6 import qube_8d44c27597 as qube_8d44c27597
	...
	def receive(A,text_data):
		...
		if len(M)>0:
			...
			if B=='init-socket'or B=='reconnect-kernel':E={G:1,F:B};A.start_kernel();D=json.dumps(E);A.send(text_data=D);return
				...
				O=[];P=[]
				for I in C[S]:
					X=A.kernel_obj.get_workspace_variable(kernel_variable=I);J=sparta_51c1448d0f(X,variable_name=I);print('workspace_variable_df');print(J);print(type(J))
					try:O.append(sparta_59d061ad78(J));P.append(I)
					except:pass
