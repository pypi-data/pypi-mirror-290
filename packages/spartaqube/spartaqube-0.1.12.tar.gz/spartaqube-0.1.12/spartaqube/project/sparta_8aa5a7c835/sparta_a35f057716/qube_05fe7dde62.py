...
from project.sparta_560fb5fd39.sparta_235050b221.qube_1d84e6f543 import IPythonKernel as IPythonKernel
from project.sparta_560fb5fd39.sparta_235050b221.qube_c2a44a1aee import sparta_ade1e6bf18
	...
	def receive(A,text_data):
		...
		if len(M)>0:
			...
			if B=='init-socket'or B=='reconnect-kernel':E={G:1,F:B};A.start_kernel();D=json.dumps(E);A.send(text_data=D);return
				...
				O=[];P=[]
				for I in C[S]:
					X=A.kernel_obj.get_workspace_variable(kernel_variable=I);J=sparta_dc18dcc477(X,variable_name=I);print('workspace_variable_df');print(J);print(type(J))
					try:O.append(sparta_b07bd8c600(J));P.append(I)
					except:pass
