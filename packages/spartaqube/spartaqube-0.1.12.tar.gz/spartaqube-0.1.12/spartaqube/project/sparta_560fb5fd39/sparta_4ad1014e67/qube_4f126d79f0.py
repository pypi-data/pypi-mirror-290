...
def sparta_b1ad485226(user_obj):
	B=user_obj
	...
	return A
def sparta_f7de2df551(json_data,user_obj):
...
def sparta_1c662c9009(json_data,user_obj):
...
def sparta_6747345717(json_data,user_obj):
	...
	return{_C:1}
def sparta_68eba1e107(json_data,user_obj):
