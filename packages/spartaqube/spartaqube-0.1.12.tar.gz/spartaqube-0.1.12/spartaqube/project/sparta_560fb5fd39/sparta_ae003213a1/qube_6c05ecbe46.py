...
import pytz
UTC=pytz.utc
def sparta_1e46051183():0
def sparta_29e7eccd5c():
...
def sparta_805880f1a1():
	...
	return A
def sparta_81b13e1e38():
	F='res'
	try:
		C=sparta_805880f1a1();A=sparta_29e7eccd5c();D=AppVersioning.objects.all();E=datetime.now().astimezone(UTC)
