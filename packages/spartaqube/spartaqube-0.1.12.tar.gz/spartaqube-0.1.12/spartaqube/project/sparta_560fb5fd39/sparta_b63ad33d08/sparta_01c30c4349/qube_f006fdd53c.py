...
plot_example"""}]
def sparta_0376dc6f16():return sparta_d6e30278d3(type=_N)
def sparta_7458a28929():return sparta_d6e30278d3(type='gauge2')
def sparta_b27f73a39b():
	type='gauge3'
	if conf_settings.IS_DEV:B=_F
	else:B=_G
