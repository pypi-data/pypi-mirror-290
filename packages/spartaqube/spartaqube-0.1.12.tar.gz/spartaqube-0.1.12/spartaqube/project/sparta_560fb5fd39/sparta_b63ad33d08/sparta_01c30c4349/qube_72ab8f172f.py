...
def sparta_e366254c51(type='candlestick'):
...
plot_example"""}]
def sparta_d6e30278d3(type='line2'):
	if conf_settings.IS_DEV:A=_E
	else:A=_F
...
plot_example"""}]
def sparta_11ed69d5c9():return sparta_d6e30278d3('line2')
def sparta_17ec8c7744():return sparta_d6e30278d3('bar2')
def sparta_e038b4aa54():return sparta_d6e30278d3('area2')
def sparta_7e3168f2e9():return sparta_d6e30278d3('lollipop2')
def sparta_6d9dedeb34():
