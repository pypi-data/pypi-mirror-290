...
def sparta_0c795920ac(json_data,userObj):
	A=json_data
	try:D=A[_A];E=A[_C];B=os.path.dirname(D);F,G=sparta_9d5b263a86(B,E);C={_B:1,'files':G,_D:F,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_f006a70f9a(json_data,userObj):
	A=json_data
	try:B=A[_A];D=A[_C];E,F=sparta_9d5b263a86(B,D);C={_B:1,'files':F,_D:E,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_9d5b263a86(currentPath,typeexplorer=None):
...
def sparta_e008cf3585(currentPath):
