...
class WalletsWalletCounterpartWalletType(str, Enum):
    WALLET = 'WALLET'


@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class WalletsWalletCounterpartWallet:
    type: WalletsWalletCounterpartWalletType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
