...
class WalletsCreditWalletInputAmount:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class WalletsCreditWalletInput:
    amount: WalletsCreditWalletInputAmount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('amount') }})
