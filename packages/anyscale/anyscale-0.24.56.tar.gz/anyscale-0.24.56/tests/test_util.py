...
# Keep in sync with backend.server.common.utils.constants.NAME_VALIDATION_REGEX_PATTERN
_NAME_VALIDATION_REGEX_PATTERN = "^[A-Za-z0-9._-]+$"
...
def test_gen_valid_name():
    ...
    assert re.match(_NAME_VALIDATION_REGEX_PATTERN, name_without_prefiex) is not None
    assert re.match(_NAME_VALIDATION_REGEX_PATTERN, name_with_prefiex) is not None
