...
from py_smallgames.spaceship.gameobj.enemy import Enemy1, Enemy2, Enemy3
from py_smallgames.spaceship.gameobj.particle import Explosion
from py_smallgames.spaceship.gameobj.ship import Ship
from py_smallgames.spaceship.gameobj.star import Star
...
shot_s = pygame.mixer.Sound("assets/sounds/shot.wav")
highscore_s = pygame.mixer.Sound("assets/sounds/highscore.wav")

wait = 0
time = 0

gameover = pygame.image.load("assets/images/gameover.gif")
...
song = pygame.mixer.Sound("assets/sounds/technotris.wav")
song.play(-1)
...
while 1:
    ...
    if time % (1000000 / (score + 1) + 1) == 0:
        if random.randint(0, 1) == 0:
            enemy_L.append(Enemy2(list((size[0] + 100, random.randint(50, size[1] - 50))), enemyshot_L))
