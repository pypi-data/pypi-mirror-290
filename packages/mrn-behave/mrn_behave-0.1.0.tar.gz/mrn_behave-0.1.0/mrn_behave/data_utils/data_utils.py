...
def load_master_dataset(subject: str) -> dict:
    with importlib.resources.path('mrn_behave', 'data') as data_path:
        path = os.path.join(data_path, 'subjects', subject, 'master_dataset.pkl')
...
def load_split(subject: str, fold: int) -> dict:
    with importlib.resources.path('mrn_behave', 'data') as data_path:
        path = os.path.join(data_path, 'subjects', subject, 'splits', f'split_{fold}.yaml')
