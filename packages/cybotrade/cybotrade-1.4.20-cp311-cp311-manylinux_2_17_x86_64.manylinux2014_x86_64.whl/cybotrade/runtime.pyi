...
class StrategyTrader:
    ...
    async def open(self, exchange: Exchange, symbol: Symbol, side: OrderSide, quantity: float, limit: float | None, take_profit: float | None, stop_loss: float | None, is_hedge_mode: bool | None, is_post_only: bool | None) -> OrderResponse:
        """
    ...
    async def cancel(self, exchange: Exchange, symbol: Symbol, id: str) -> OrderResponse:
        ...
        """
    async def close(self, exchange: Exchange, symbol: Symbol, side: OrderSide, quantity: float, is_hedge_mode: bool | None):
        """
