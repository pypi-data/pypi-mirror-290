...
class SegmentConcepts(ConceptsEnum):
    ...
    def base_columns(cls) -> list[str]:
        return [SegmentConcepts.Concept, SegmentConcepts.Object, SegmentConcepts.Index, SegmentConcepts.Start,
                SegmentConcepts.End]
...
class SegmentDataConcepts(ConceptsEnum):
    ...
    @classmethod
    def base_columns(cls) -> list[str]:
        return [SegmentDataConcepts.Type, SegmentDataConcepts.Object, SegmentDataConcepts.Concept,
                SegmentDataConcepts.Index]
