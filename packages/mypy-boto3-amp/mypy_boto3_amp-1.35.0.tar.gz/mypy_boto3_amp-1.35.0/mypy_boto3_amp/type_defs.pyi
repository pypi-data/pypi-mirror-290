...
__all__ = (
    ...
    "EksConfigurationExtraOutputTypeDef",
...
EksConfigurationExtraOutputTypeDef = TypedDict(
    "EksConfigurationExtraOutputTypeDef",
    {
        "clusterArn": str,
        "subnetIds": List[str],
...
SourceExtraOutputTypeDef = TypedDict(
    "SourceExtraOutputTypeDef",
    {
        "eksConfiguration": NotRequired[EksConfigurationExtraOutputTypeDef],
    },
)
...
SourceUnionTypeDef = Union[SourceTypeDef, SourceExtraOutputTypeDef]
