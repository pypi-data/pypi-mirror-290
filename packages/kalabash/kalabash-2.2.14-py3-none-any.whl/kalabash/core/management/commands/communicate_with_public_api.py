...
from kalabash.lib import api_client
from ... import models
from ... import utils
...
class Command(BaseCommand):
    ...
    help = "Communicate with Kalabash public API."  # NOQA:A003
    ...
    def send_notification(self, local_config, extensions):
        ...
        subject = _("[kalabash] Update(s) available")
    ...
    def handle(self, *args, **options):
        ...
        if not local_config.parameters.get_value("enable_api_communication"):
            return
        self.client = api_client.KbashAPIClient()
