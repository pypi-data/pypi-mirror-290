...
SETTINGS_SAMPLE = {
    ...
    "core-sender_address": "noreply@alphamonak.com",
...
class LoginTestCase(KbashTestCase):
...
class DashboardTestCase(KbashTestCase):
    """Dashboard tests."""
    ...
    def test_custom_news(self):
        ...
        url = reverse("core:dashboard")
        response = self.client.get(url)
        self.assertContains(response, "https://alphamonak.com")
    ...
    def test_features_visibility(self):
        ...
        url = reverse("core:dashboard")
        response = self.client.get(url)
        self.assertContains(response, "Upcoming Features")
        ...
        response = self.client.get(url)
        self.assertNotContains(response, "Upcoming Features")
    ...
    def test_enable_dashboard_external_queries(self):
        ...
        url = reverse("core:dashboard")
        response = self.client.get(url)
        self.assertContains(response, 'href="https://alphamonak.com/en/weblog/')
    ...
    def test_disable_dashboard_external_queries(self):
        ...
        url = reverse("core:dashboard")
        response = self.client.get(url)
        self.assertNotContains(response, "https://alphamonak.com/en/weblog/")
...
class SettingsTestCase(KbashTestCase):
    """Settings tests."""
...
class PreferencesTestCase(KbashTestCase):
