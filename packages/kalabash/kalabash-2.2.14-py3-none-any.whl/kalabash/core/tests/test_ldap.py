...
from kalabash.lib import exceptions
...
class LDAPAuthenticationTestCase(LDAPTestCaseMixin, KbashTestCase):
    ...
    def check_created_user(self, username, group="StandardUsers", with_mb=True):
...
class ProfileTestCase(LDAPTestCaseMixin, KbashTestCase):
