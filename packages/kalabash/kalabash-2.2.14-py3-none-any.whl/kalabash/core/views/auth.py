...
from kalabash.core import constants, fido2_auth, forms, models
from kalabash.core.api.v2 import serializers
from kalabash.core.password_hashers import get_password_hasher
from kalabash.lib import cryptutils
...
logger = logging.getLogger("kalabash.auth")


class LoginViewMixin:
    @cached_property
    def logger(self):
        return logging.getLogger("kalabash.auth")
...
class PasswordResetView(auth_views.PasswordResetView):
    ...
    def form_valid(self, form):
        ...
        text = _(
            "Please use the following code to recover your Kalabash password: {}".format(
                code
            )
        )
