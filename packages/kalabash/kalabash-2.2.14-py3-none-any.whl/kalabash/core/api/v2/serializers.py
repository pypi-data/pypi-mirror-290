...
from kalabash.lib import fields as lib_fields, cryptutils
...
class CoreGlobalParametersSerializer(serializers.Serializer):
    ...
    ldap_dovecot_conf_file = serializers.CharField(
        default="/etc/dovecot/dovecot-kalabash.conf", required=False
    )
...
class KalabashComponentSerializer(serializers.Serializer):
