module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        env: {
            accra: {
                TZ: 'Africa/Accra' // sets env for phantomJS https://github.com/ariya/phantomjs/issues/10379#issuecomment-36058589
            }
        },
        connect: {
            server: {
    ...
    grunt.registerTask('default', ['jshint', 'jscs', 'less', 'env:accra', 'connect', 'jasmine']);
    grunt.registerTask('build:travis', [
        ...
        'uglify', 'less',
        // tests
        'env:accra', 'connect', 'jasmine'
    ]);

    // Task to be run when building
    grunt.registerTask('build', ['jshint', 'jscs', 'uglify', 'less']);

    grunt.registerTask('test', ['jshint', 'jscs', 'uglify', 'less', 'env:accra', 'connect', 'jasmine']);
