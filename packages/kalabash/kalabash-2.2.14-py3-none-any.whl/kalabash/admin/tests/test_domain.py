...
from kalabash.core.tests.test_views import SETTINGS_SAMPLE
from kalabash.lib.tests import KbashTestCase
from kalabash.maillog import factories as ml_factories
...
class DomainTestCase(KbashTestCase):
...
class DKIMTestCase(KbashTestCase):
    """Test case for DKIM."""
    ...
    def test_dkim_key_creation(self):
        ...
        call_command("kbash", "manage_dkim_keys")
        ...
        call_command("kbash", "manage_dkim_keys", f"--domain={domain.name}")
        domain.refresh_from_db()
