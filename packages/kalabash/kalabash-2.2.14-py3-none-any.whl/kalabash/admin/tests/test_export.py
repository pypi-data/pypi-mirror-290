...
class ExportTestCase(KbashTestCase):
    ...
    def test_export_domains(self):
        ...
        call_command("kbash", "export", "domains")
    ...
    def test_export_simpleusers(self):
        ...
        response = self.__export_identities(
            idtfilter="account", grpfilter="StandardUsers"
        )
        expected_response = "account;user@test.com;{PLAIN}toto;;;True;StandardUsers;user@test.com;10\r\naccount;user@test2.com;{PLAIN}toto;;;True;StandardUsers;user@test2.com;10\r\naccount;toto@test.com;{PLAIN}toto;Léon;;True;StandardUsers;toto@test.com;10"  # NOQA:E501
        self.assertCountEqual(
