...
from kalabash.core import factories as core_factories
...
""",
    ...
    def test_identities_import(self):
        ...
        f = ContentFile(
            """
account; user1@test.com; toto; User; One; True; StandardUsers; user1@test.com; 0
...
""",
        ...
        self.assertEqual(u1.role, "StandardUsers")
    ...
    def test_import_for_nonlocal_domain(self):
        ...
        f = ContentFile(
            b"""
account; user1@nonlocal.com; toto; User; One; True; StandardUsers; user1@nonlocal.com; 0
""",
            name="identities.csv",
        )  # NOQA:E501
        self.client.post(
    ...
    def test_import_invalid_quota(self):
        f = ContentFile(
            b"""
account; user1@test.com; toto; User; One; True; StandardUsers; user1@test.com; ; test.com
""",
            name="identities.csv",
        )  # NOQA:E501
...
""",
    ...
    def test_import_quota_too_big(self):
        ...
        f = ContentFile(
            b"""
account; user1@test.com; toto; User; One; True; StandardUsers; user1@test.com; 40
""",
            name="identities.csv",
        )
        resp = self.client.post(
    ...
    def test_import_missing_quota(self):
        f = ContentFile(
            b"""
account; user1@test.com; toto; User; One; True; StandardUsers; user1@test.com
""",
            name="identities.csv",
        )
        self.client.post(
...
""".encode(
    ...
    def test_import_command_missing_file(self):
        with mock.patch("os.path.isfile") as mock_isfile:
            ...
            with self.assertRaises(CommandError) as cm:
                call_command("kbash", "import", "test.csv")
    ...
    def test_import_command(self):
        ...
        call_command("kbash", "import", test_file)
    ...
    def test_import_command_duplicates_continue(self):
        ...
        call_command("kbash", "import", "--continue-if-exists", test_file)
