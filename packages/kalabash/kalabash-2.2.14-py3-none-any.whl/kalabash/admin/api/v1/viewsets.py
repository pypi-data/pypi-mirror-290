...
from kalabash.core import sms_backends
from kalabash.lib import renderers as lib_renderers
from kalabash.lib import viewsets as lib_viewsets
from kalabash.lib.throttle import GetThrottleViewsetMixin, PasswordResetRequestThrottle
...
class AccountViewSet(
    ...
    def reset_password(self, request):
        ...
        content = _("Here is your new Kalabash password: {}").format(password)
