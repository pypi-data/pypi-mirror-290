...
from kalabash.lib.exceptions import Conflict, KalabashException, PermDeniedException
...
def get_dns_records(name, typ, resolver=None):
    ...
    logger = logging.getLogger("kalabash.admin")
