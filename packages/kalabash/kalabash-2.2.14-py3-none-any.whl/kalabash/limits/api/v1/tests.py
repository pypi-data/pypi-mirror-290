...
from kalabash.lib import permissions, tests as lib_tests
from ... import utils


class APIAdminLimitsTestCase(lib_tests.KbashAPITestCase):
...
class APIDomainLimitsTestCase(lib_tests.KbashAPITestCase):
    """Check that limits are used also by the API."""
...
class ResourcesAPITestCase(lib_tests.KbashAPITestCase):
    """Check resources API."""
