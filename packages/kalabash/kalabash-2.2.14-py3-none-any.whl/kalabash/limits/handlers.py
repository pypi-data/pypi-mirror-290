...
from kalabash.admin import models as admin_models, signals as admin_signals
from kalabash.core import models as core_models, signals as core_signals
from kalabash.lib import permissions, signals as lib_signals
...
def get_static_content(sender, caller, st_type, user, **kwargs):
    ...
    condition = (
        ...
        or user.role in ["SuperAdmins", "StandardUsers"]
    )
    if condition:
        return ""
    if st_type == "css":
