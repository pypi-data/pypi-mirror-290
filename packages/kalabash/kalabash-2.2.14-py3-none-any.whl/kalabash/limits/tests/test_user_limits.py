...
from kalabash.admin.factories import populate_database
from kalabash.admin.models import Alias, Domain
...
class PermissionsTestCase(lib_tests.KbashTestCase):
...
class ResourceTestCase(lib_tests.KbashTestCase):
    ...
    def _create_account(self, username, role="StandardUsers", status=200, **kwargs):
        values = {
            "username": username,
            "first_name": "Tester",
            "last_name": "Toto",
...
class ResellerTestCase(ResourceTestCase):
    ...
    def test_quota_propagation(self):
        ...
        # See https://github.com/amonak/kalabash/issues/1223
        self._create_domain("domain1.tld")
