...
DEFAULT_USER_LIMITS = collections.OrderedDict(
    (
        ...
        (
            "domain_aliases",
            {
                "content_type": "admin.domainalias",
        ...
        (
            "mailbox_aliases",
            {
                "content_type": "admin.alias",
                "label": _("Mailbox aliases"),
                "help": _("Maximum number of mailbox aliases this user " "can create"),
            },
        ),
        (
            "domain_admins",
            {
                "content_type": "core.user",
                "label": _("Domain admins"),
                "help": _(
                    "Maximum number of domain administrators this user " "can create"
                ),
                "required_role": "Resellers",
