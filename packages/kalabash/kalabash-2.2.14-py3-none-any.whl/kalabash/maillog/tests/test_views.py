...
class RunCommandsMixin(object):
    ...
    def tearDown(self):
        ...
        pid_file = f"{settings.PID_FILE_STORAGE_PATH}/kalabash_logparser.pid"
...
class ViewsTestCase(RunCommandsMixin, KbashTestCase):
    """Views test cases."""
...
@override_settings(RRDTOOL_TEST_MODE=True)
class ManagementCommandsTestCase(RunCommandsMixin, KbashTestCase):
    ...
    def test_locking(self):
        with open(f"{settings.PID_FILE_STORAGE_PATH}/kalabash_logparser.pid", "w") as fp:
