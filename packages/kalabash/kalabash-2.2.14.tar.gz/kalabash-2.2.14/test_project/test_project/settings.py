...
try:
    ...
    KALABASH_APPS += ("kalabash.ldapsync",)
...
STATICFILES_DIRS = (os.path.join(BASE_DIR, "..", "kalabash", "bower_components"),)
...
LOGGING = {
    ...
    "loggers": {
        ...
        "kalabash.admin": {"handlers": ["kalabash"], "level": "INFO", "propagate": False},
        "django.server": {
