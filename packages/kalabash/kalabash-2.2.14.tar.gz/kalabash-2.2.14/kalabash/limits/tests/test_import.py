...
class LimitImportTestCase(KbashTestCase):
...
""".format(
    ...
    def _test_mailboxes_import(self, limit):
        ...
        self.assertFalse(limit.is_exceeded())
        f = ContentFile(
            "account; user1@{domain}; toto; User; One; True; StandardUsers; "
            "user1@{domain}; 5\r\n"
            "account; truc@{domain}; toto; René; Truc; True; StandardUsers; "
        ...
        f = ContentFile(
            """
account; user3@{domain}; toto; User; One; True; StandardUsers; user3@{domain}; 5
""".format(
                domain=self.domain
            ),
            name="domains.csv",
