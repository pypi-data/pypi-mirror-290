...
class SimpleKbashTestCase(ParametersMixin, TestCase):
    """Simple class to add parameters editing."""


class KbashTestCase(ParametersMixin, TestCase):
    """All test cases must inherit from this one."""

    @classmethod
    def setUpTestData(cls):  # noqa
        """Create a default user."""
        super(KbashTestCase, cls).setUpTestData()
...
class KbashAPITestCase(ParametersMixin, APITestCase):
    """All test cases must inherit from this one."""

    @classmethod
    def setUpTestData(cls):  # noqa
        """Create a default user."""
        super(KbashAPITestCase, cls).setUpTestData()
    ...
    def setUp(self):
        """Setup."""
        super(KbashAPITestCase, self).setUp()
