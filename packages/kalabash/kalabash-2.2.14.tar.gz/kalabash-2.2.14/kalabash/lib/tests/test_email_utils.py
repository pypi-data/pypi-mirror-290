...
class EmailTests(SimpleTestCase):
    """Tests for kalabash.lib.email_utils.Email
    ...
    def test_invalid_links_value(self):
        """kalabash-amavis set links = "0"; in python "0" == True, fixed in PR 79
        https://github.com/amonak/kalabash-amavis/pull/79"""
    ...
    def test_links_value_for_webmail(self):
        """kalabash-webmail sets links = 0 or 1
        TODO: this should be fixed in kalabash-webmail to use True/False"""
...
class EmailAddressParserTests(SimpleTestCase):
    ...
    def test_split_local_part_mailing_list_address(self):
        ...
        local_part = "owner-kalabash"
        expected_output = ("owner-kalabash", None)
        output = split_local_part(local_part, "-")
        self.assertEqual(output, expected_output)
