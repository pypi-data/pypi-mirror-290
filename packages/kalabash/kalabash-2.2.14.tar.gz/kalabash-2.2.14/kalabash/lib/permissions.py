...
from kalabash.core import constants as core_constants, signals as core_signals
from kalabash.core.models import ObjectAccess, User
...
def get_account_roles(user, account=None):
    ...
    """
    result = [core_constants.STANDARDUSERS_ROLE]
