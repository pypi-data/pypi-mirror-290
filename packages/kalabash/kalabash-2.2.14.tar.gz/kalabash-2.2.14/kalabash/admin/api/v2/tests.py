...
from kalabash.admin import factories, models, constants
from kalabash.core import models as core_models
from kalabash.lib.tests import KbashAPITestCase


class DomainViewSetTestCase(KbashAPITestCase):
    @classmethod
...
class IdentityViewSetTestCase(KbashAPITestCase):
    @classmethod
    def setUpTestData(cls):  # NOQA:N802
        """Create test data."""
        super().setUpTestData()
...
class AliasViewSetTestCase(KbashAPITestCase):
    @classmethod
    def setUpTestData(cls):  # NOQA:N802
        """Create test data."""
        super().setUpTestData()
...
class UserAccountViewSetTestCase(KbashAPITestCase):
    @classmethod
    def setUpTestData(cls):  # NOQA:N802
        """Create test data."""
        super().setUpTestData()
...
class AlarmViewSetTestCase(KbashAPITestCase):
    @classmethod
    def setUpTestData(cls):  # NOQA:N802
        """Create test data."""
        super().setUpTestData()
