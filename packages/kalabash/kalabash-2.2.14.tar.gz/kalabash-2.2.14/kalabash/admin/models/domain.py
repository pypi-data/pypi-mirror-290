...
from kalabash.lib.exceptions import BadRequest, Conflict
...
class Domain(mixins.MessageLimitMixin, AdminObject):
    ...
    dkim_key_selector = models.CharField(max_length=30, default="kalabash")
    ...
    def delete(self, fromuser, keepdir=False):
        ...
        from kalabash.lib.permissions import ungrant_access_to_objects
        from .mailbox import Quota
