...
from kalabash.lib.exceptions import BadRequest, PermDeniedException
from kalabash.lib.listing import get_listing_page, get_sort_order
from kalabash.lib.web_utils import render_to_json_response
from .. import signals
...
def list_quotas(request):
    from kalabash.lib.db_utils import db_type
...
def accounts_list(request):
    accs = User.objects.filter(is_superuser=False).exclude(groups__name="StandardUsers")
