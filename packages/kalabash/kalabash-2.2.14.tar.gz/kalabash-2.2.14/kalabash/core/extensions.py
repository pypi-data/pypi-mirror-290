...
class KbashExtension(object):
    """
    Base extension class.

    Each Kalabash extension must inherit from this class to be
    considered as valid.
    """
...
class ExtensionsPool(object):
    ...
    def load_extension(self, name):
        ...
        __import__(name, locals(), globals(), [smart_str("kbash_extension")])
    ...
    def load_all(self):
        ...
        Kalabash. Only enabled and special extensions are loaded but
        ...
        """
        for ext in settings.KALABASH_APPS:
