"""A shortcut to deploy a fresh kalabash instance."""
...
from kalabash.core.commands import Command
from kalabash.core.utils import generate_rsa_private_key
...
class DeployCommand(Command):
    ...
    help = (  # NOQA:A003
        ...
        " and apply Kalabash specific settings."
    )

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self._parser.add_argument(
            "name", type=str, help="The name of your Kalabash instance"
        )
        self._parser.add_argument(
            "--collectstatic",
            action="store_true",
        ...
        self._parser.add_argument(
            ...
            type=str,
            default=None,
            help="The domain under which you want to deploy kalabash",
        )
        self._parser.add_argument(
    ...
    def _get_extension_list(self):
        ...
        """
        url = "http://api.alphamonak.com/"
        official_exts = KbashAPIClient(url).list_extensions()
        return [extension["name"] for extension in official_exts]

    def _generate_secret_key(self, secret_key_length):
        """Generate a secret key since the one generated by django
    ...
    def handle(self, parsed_args):
        ...
        if parsed_args.domain:
            ...
            allowed_host = input("What will be the hostname used to access Kalabash? ")
            if not allowed_host:
