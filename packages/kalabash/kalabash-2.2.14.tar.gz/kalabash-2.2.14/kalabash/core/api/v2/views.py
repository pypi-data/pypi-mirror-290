...
from kalabash.core.utils import check_for_updates
from kalabash.lib.permissions import IsSuperUser
from kalabash.lib.throttle import (
    UserLesserDdosUser,
...
class ComponentsInformationAPIView(APIView):
    ...
    @extend_schema(responses=serializers.KalabashComponentSerializer(many=True))
    def get(self, request, *args, **kwargs):
        status, extensions = check_for_updates()
        serializer = serializers.KalabashComponentSerializer(extensions, many=True)
