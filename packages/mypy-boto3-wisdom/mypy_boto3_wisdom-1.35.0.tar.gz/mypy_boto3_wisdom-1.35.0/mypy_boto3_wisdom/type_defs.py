...
Usage::
    ...
    ```python
    from mypy_boto3_wisdom.type_defs import AppIntegrationsConfigurationExtraOutputTypeDef

    data: AppIntegrationsConfigurationExtraOutputTypeDef = ...
    ```
"""
...
AppIntegrationsConfigurationExtraOutputTypeDef = TypedDict(
    "AppIntegrationsConfigurationExtraOutputTypeDef",
    {
...
GroupingConfigurationExtraOutputTypeDef = TypedDict(
    "GroupingConfigurationExtraOutputTypeDef",
    {
        "criteria": NotRequired[str],
...
SourceConfigurationExtraOutputTypeDef = TypedDict(
    "SourceConfigurationExtraOutputTypeDef",
    {
        "appIntegrations": NotRequired[AppIntegrationsConfigurationExtraOutputTypeDef],
    },
)
...
GroupingConfigurationUnionTypeDef = Union[
    GroupingConfigurationTypeDef, GroupingConfigurationExtraOutputTypeDef
]
...
SourceConfigurationUnionTypeDef = Union[
    SourceConfigurationTypeDef, SourceConfigurationExtraOutputTypeDef
]
