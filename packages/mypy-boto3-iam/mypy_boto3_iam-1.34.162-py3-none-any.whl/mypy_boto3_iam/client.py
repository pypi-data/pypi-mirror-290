...
class IAMClient(BaseClient):
    ...
    def add_user_to_group(self, *, GroupName: str, UserName: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def attach_role_policy(self, *, RoleName: str, PolicyArn: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def attach_user_policy(self, *, UserName: str, PolicyArn: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_account_alias(self, *, AccountAlias: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_group(self, *, GroupName: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_instance_profile(self, *, InstanceProfileName: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_login_profile(self, *, UserName: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_policy(self, *, PolicyArn: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_role(self, *, RoleName: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_role_permissions_boundary(self, *, RoleName: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_role_policy(self, *, RoleName: str, PolicyName: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_saml_provider(self, *, SAMLProviderArn: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_user(self, *, UserName: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_user_permissions_boundary(self, *, UserName: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_user_policy(self, *, UserName: str, PolicyName: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_virtual_mfa_device(self, *, SerialNumber: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def detach_role_policy(self, *, RoleName: str, PolicyArn: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def detach_user_policy(self, *, UserName: str, PolicyArn: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def untag_role(self, *, RoleName: str, TagKeys: Sequence[str]) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def untag_user(self, *, UserName: str, TagKeys: Sequence[str]) -> EmptyResponseMetadataTypeDef:
        """
