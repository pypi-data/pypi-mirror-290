...
class JobsApi(object):
    ...
    @validate_arguments
    def optimize_job(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs) -> StartJobResponse:  # noqa: E501
        """Optimize model
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._optimize_job_with_http_info(project_id, **kwargs)  # noqa: E501

    @validate_arguments
    def _optimize_job_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs):  # noqa: E501
        """Optimize model 
