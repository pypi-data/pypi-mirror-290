...
class _OrderEventEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_OrderEvent.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ORDER_EVENT_UNSPECIFIED: _OrderEvent.ValueType  # 0
    ORDER_EVENT_CREATED: _OrderEvent.ValueType  # 1
    ORDER_EVENT_SHARED: _OrderEvent.ValueType  # 2

class OrderEvent(_OrderEvent, metaclass=_OrderEventEnumTypeWrapper):
    """An enum for all the fabrication methods implemented
    corresponding to their field name on `PartFabrication`
    """

ORDER_EVENT_UNSPECIFIED: OrderEvent.ValueType  # 0
ORDER_EVENT_CREATED: OrderEvent.ValueType  # 1
ORDER_EVENT_SHARED: OrderEvent.ValueType  # 2
...
class Order(google.protobuf.message.Message):
    ...
    @property
    def state(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___OrderEventLog]:
    ...
    def parts(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[kerfed.protos.common.v1.fab_pb2.PartFabrication]:
        """TODO : remove this in favor of `Order.lines[n].fab`"""
    @property
    ...
    def __init__(
        ...
        *,
        ...
        user_id: builtins.str = ...,
        shop_id: builtins.str = ...,
        state: collections.abc.Iterable[global___OrderEventLog] | None = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["billing", b"billing", "lines", b"lines", "models", b"models", "order_id", b"order_id", "parcels", b"parcels", "parts", b"parts", "shipping", b"shipping", "shop_id", b"shop_id", "state", b"state", "total", b"total", "user_id", b"user_id"]) -> None: ...

global___Order = Order

@typing_extensions.final
class OrderEventLog(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    TIME_FIELD_NUMBER: builtins.int
    EVENT_FIELD_NUMBER: builtins.int
    @property
    def time(self) -> kerfed.protos.common.v1.timestamp_pb2.Timestamp:
        """when did this event occur?"""
    event: global___OrderEvent.ValueType
    """What type of event was this?"""
    def __init__(
        self,
        *,
        time: kerfed.protos.common.v1.timestamp_pb2.Timestamp | None = ...,
        event: global___OrderEvent.ValueType = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["time", b"time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["event", b"event", "time", b"time"]) -> None: ...

global___OrderEventLog = OrderEventLog
...
class OrderLine(google.protobuf.message.Message):
    ...
    def config(self) -> kerfed.protos.common.v1.config_pb2.PartConfiguration:
        """The analysis of the part containing all methods.
        TODO : remove `Order.parts` in favor of `Order.line[n].part`
        PartFabrication part = 6;
