...
def extract_text_from_pdf_file(filename_full_path:str,image_recognition:bool=False,ocr_engine_path:str=None,output_temp_dir:str=None):
    """
    Extracts text from a PDF file.

    :param filename_full_path: Full path to the PDF file from which to extract text.
    :type filename_full_path: str
    :param image_recognition: Indicates whether to perform text recognition on images within the PDF.
    ...
    # Example usage
    ```python
    text = extract_text_from_pdf_file('/tmp/example.pdf', image_recognition=True, ocr_engine_path='/usr/local/bin/tesseract', output_temp_dir='/tmp/tesseract_output')
    ```
