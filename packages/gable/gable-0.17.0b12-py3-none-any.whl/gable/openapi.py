...
class GableSchemaBytes(BaseModel):
    ...
    doc: Optional[str] = None
    logical: Optional[Logical2] = None
...
class CheckDataAssetsResponse1(BaseModel):
    __root__: Union[
...
class CheckDataAssetsResponse(BaseModel):
    __root__: Union[
        List[CheckDataAssetsResponse1], CheckDataAssetCommentMarkdownResponse
    ]
