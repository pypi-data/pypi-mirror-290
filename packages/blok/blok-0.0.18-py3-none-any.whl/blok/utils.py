...
def get_cleartext_deps(blok):
    ...
    for dep in dependencies:
        if hasattr(dep, "get_blok_service_meta"):
            cleartext_deps.append(dep.get_blok_service_meta().identifier)
        elif hasattr(dep, "get_blok_meta"):
            cleartext_deps.append(dep.get_blok_meta().name)
        else:
            assert isinstance(
                dep, str
