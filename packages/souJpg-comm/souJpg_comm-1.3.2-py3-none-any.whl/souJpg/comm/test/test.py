...
class DistributeFsTest(unittest.TestCase):
    def setUp(self) -> None:
        self.fs = MinioFs()
        self.cosFs=TecentCosFs()

    def test_upload(self):
        localFile = r"C:\Users\jasstion\OneDrive\图片\sexy\屏幕截图 2022-07-04 095052.jpg"
        self.fs.upload(
    ...
    def test_download_cos(self):
        ...
        self.cosFs.download(
            localFilePath=localFile, remoteFilePath="models/loras_test/Remv2FB.safetensors"
        )
...
class RedisOpsTest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        port='6380'
        password='souJpgrFg~'
        self.redisOps = RedisOps({'redis_host':host, "redis_port":port, "redis_password":password})
    ...
    def test_cache(self):
        @cached(ex=4,redisKey={'etst':"sdfsdfsdf",'test2':"sdfsdfsdf"},haskKey=True,compress=True)
        def testFunc(a, b):
