...
[boto3.AutoScalingPlans 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/autoscaling-plans.html#AutoScalingPlans)
...
- Install `boto3-stubs[autoscaling-plans]` in your environment:
...
Install `boto3-stubs-lite[autoscaling-plans]` in your environment:
...
- Install `boto3-stubs[autoscaling-plans]` with services you use in your
  environment:
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_autoscaling_plans/literals/).
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_autoscaling_plans/type_defs/).

```python
from mypy_boto3_autoscaling_plans.type_defs import TagFilterExtraOutputTypeDef


def get_value() -> TagFilterExtraOutputTypeDef:
    return {...}
```
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_autoscaling_plans/)
