...
from pr_assistant.secret_providers import get_secret_provider
from pr_assistant.servers.github_action_runner import get_setting_or_env, is_true
from pr_assistant.tools.pr_code_suggestions import PRCodeSuggestions
from pr_assistant.tools.pr_description import PRDescription
from pr_assistant.tools.pr_reviewer import PRReviewer
                    ...
                    with get_logger().contextualize(**log_context):
                        ...
                        if get_identity_provider().verify_eligibility("bitbucket",
                            ...
                            if get_settings().get("bitbucket_app.pr_commands"):
                                await _perform_commands_bitbucket("pr_commands", PRAssistant(), pr_url, log_context)
