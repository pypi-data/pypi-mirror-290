...
async def gitlab_webhook(background_tasks: BackgroundTasks, request: Request):
    ...
    async def inner(data: dict):
        ...
        if 'khulnasoft' in sender_name or 'bot_' in sender_name or 'bot-' in sender_name or '_bot' in sender_name or '-bot' in sender_name:
        ...
        if data.get('object_kind') == 'merge_request' and data['object_attributes'].get('action') in ['open', 'reopen']:
            ...
            await _perform_commands_gitlab("pr_commands", PRAssistant(), url, log_context)
            ...
            try:
                ...
                await _perform_commands_gitlab("push_commands", PRAssistant(), url, log_context)
            except Exception as e:
