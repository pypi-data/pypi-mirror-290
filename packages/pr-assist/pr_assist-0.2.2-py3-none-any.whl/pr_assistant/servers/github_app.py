...
from pr_assistant.git_providers.git_provider import IncrementalPR
...
from pr_assistant.servers.utils import DefaultDictWithTimeout, verify_signature
...
def handle_closed_pr(body, event, action, log_context):
    ...
    log_context["api_url"] = api_url
    get_logger().info("PR-Assistant statistics for closed PR", analytics=True, pr_statistics=pr_statistics, **log_context)
