...
from gai.cli.scripts.gai_docker_start import docker_start
from gai.cli.scripts.gai_docker_stop import docker_stop
from gai.cli.scripts.gai_init import init
from gai.cli.scripts.gai_pull import pull
from gai.cli.scripts.gai_news import news
from gai.cli.scripts.gai_search import search
from gai.cli.scripts.gai_chat import chat
...
def main():
    ...
    if args.command == "init":
        ...
        if args.extra_args:
            ...
            console.print("[red]Content not provided[/]")
