...
from .dimension_regressor_complexity import Regressor 
...
class feature_space_construction:
    ...
    def feature_expansion(self):
        ...
        if self.no_of_operators == None:
            ...
            if self.disp: print(f'***************************** Size of the feature space formed in the initial expansion {self.df_feature_values.shape[1]} ******************************** \n')
            ...
            rmse1,equation1,r21,r,c,n,intercepts,coeffs = Regressor(self.df_feature_values,self.Target_column,self.feature_names,self.dimensionality,complexity,metrics=self.metrics).regressor_fit()
            ...
            while True:
                ...
                rmse,equation,r2,r,c,n,intercepts,coeffs = Regressor(self.df_feature_values,self.Target_column,self.feature_names,self.dimensionality,complexity,metrics=self.metrics).regressor_fit()
