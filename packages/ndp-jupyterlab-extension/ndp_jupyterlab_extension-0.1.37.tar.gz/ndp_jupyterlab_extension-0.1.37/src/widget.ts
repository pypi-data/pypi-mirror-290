...
import {
  ...
  createDropdownGitLinks,
  updateGitLinksDropdown
} from './dropdowns';
import {
...
export class NDPWidget extends Widget {
  ...
  public dropdownGitLinks: HTMLSelectElement;
  ...
  constructor(
    ...
    this.dropdownGitLinks = createDropdownGitLinks();
  ...
  _onCloneGitRepoButtonClick(event: Event): void {
