...
class NDPWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_0__.Widget {
    constructor(defaultBrowser, commands) {
        ...
        buttonGetWorkspacesData.textContent = 'Refresh My Workspaces';
        ...
        // Adding an empty div for spacing
        const spacer1 = document.createElement('div');
        spacer1.textContent = 'Utilities';
        spacer1.className = 'headers';
        // spacer1.style.paddingTop = '10px'
        // spacer1.style.height = '30px'; // Adjust the height as needed
        const spacer2 = document.createElement('div');
        spacer2.style.height = '30px'; // Adjust the height as needed
...
//# sourceMappingURL=lib_index_js.843c4908c92068490956.js.map