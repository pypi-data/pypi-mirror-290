...
/* harmony export */   createGitCloneButton: () => (/* binding */ createGitCloneButton),
...
function createGitCloneButton(widget) {
    return createButton('Clone Repository', 'ndp-button', widget._onCloneGitRepoButtonClick.bind(widget));
}
...
/* harmony export */   createDropdownGitLinks: () => (/* binding */ createDropdownGitLinks),
...
/* harmony export */   updateGitLinksDropdown: () => (/* binding */ updateGitLinksDropdown),
...
function createDropdownGitLinks() {
...
function updateGitLinksDropdown(widget) {
    // Get the selected option value
    const selectedWorkspaceName = widget.dropdownWorkspaces.value;
    // Find the selected workspace
    const selectedWorkspace = widget.workspaces.find(workspace => workspace.workspace_name === selectedWorkspaceName);
...
class NDPWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_0__.Widget {
    constructor(defaultBrowser, commands) {
        ...
        this.dropdownGitLinks = (0,_dropdowns__WEBPACK_IMPORTED_MODULE_3__.createDropdownGitLinks)();
        ...
        const headerGitLinks = document.createElement('div');
        headerGitLinks.textContent = 'GIT';
        headerGitLinks.className = 'headers';
        ...
        container.appendChild(headerGitLinks);
        container.appendChild(this.dropdownGitLinks);
        container.appendChild((0,_buttons__WEBPACK_IMPORTED_MODULE_4__.createGitCloneButton)(this));
        ...
        this.dropdownWorkspaces.addEventListener('change', () => {
            ...
            (0,_dropdowns__WEBPACK_IMPORTED_MODULE_3__.updateGitLinksDropdown)(this);
        });
    ...
    _onCloneGitRepoButtonClick(event) {
        // Get value from git links dropdown
        const selectedGitLink = this.dropdownGitLinks.value;
        this.commands.execute('git:clone', {
            path: this.fileBrowser.model.path,
            url: selectedGitLink
        });
    }
...
//# sourceMappingURL=lib_index_js.547602cd94cb78a3520e.js.map