...
function populateCheckboxes(widget, datasetResources) {
    ...
    datasetResources.forEach(resource => {
        ...
        checkbox.id = resource.resource_name;
        checkbox.value = resource.resource_name;
        const label = document.createElement('label');
        label.htmlFor = resource.resource_name;
        label.textContent = resource.resource_name;
...
//# sourceMappingURL=lib_index_js.3d3f982544f173fc3e3d.js.map