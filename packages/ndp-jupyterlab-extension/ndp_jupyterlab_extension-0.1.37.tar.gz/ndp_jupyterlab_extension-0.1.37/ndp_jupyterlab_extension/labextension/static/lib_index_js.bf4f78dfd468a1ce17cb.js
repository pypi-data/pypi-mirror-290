...
Object(function webpackMissingModule() { var e = new Error("Cannot find module '../style/ndp-landing-image.png'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
Object(function webpackMissingModule() { var e = new Error("Cannot find module '../style/ndp_logo.png'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
class NDPWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_0__.Widget {
    constructor(defaultBrowser, commands) {
        ...
        ndpMapImg.src = Object(function webpackMissingModule() { var e = new Error("Cannot find module '../style/ndp-landing-image.png'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
        ...
        ndpLettersImg.src = Object(function webpackMissingModule() { var e = new Error("Cannot find module '../style/ndp_logo.png'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
    ...
    async _onButtonUnzipClick(event) {
        ...
        console.log('Making request to JupyterLab API');
        try {
            const data = await (0,_handler__WEBPACK_IMPORTED_MODULE_2__.requestAPI)('unzip', {
                method: 'POST',
    ...
    async _onButtonGetWorkspacesDataClick(event) {
        ...
        try {
            this.workspaces = await (0,_handler__WEBPACK_IMPORTED_MODULE_2__.requestAPI)('get_workspaces_data', {
                method: 'GET'
            });
...
//# sourceMappingURL=lib_index_js.bf4f78dfd468a1ce17cb.js.map