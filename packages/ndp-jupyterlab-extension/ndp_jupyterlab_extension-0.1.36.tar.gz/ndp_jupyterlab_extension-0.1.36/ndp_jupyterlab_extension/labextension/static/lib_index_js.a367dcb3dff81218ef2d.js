...
/* harmony import */ var _datasets_dropdown__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./datasets_dropdown */ "./lib/datasets_dropdown.js");
...
class NDPWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_0__.Widget {
    constructor(defaultBrowser, commands) {
        ...
        this.dropdownDatasets = (0,_datasets_dropdown__WEBPACK_IMPORTED_MODULE_3__.createDropdownDatasets)();
        ...
        this.dropdownWorkspaces.addEventListener('change', () => {
            (0,_datasets_dropdown__WEBPACK_IMPORTED_MODULE_3__.updateDatasetsDropdown)(this);
        });
    }
    createCheckboxes() {
    ...
    async _onButtonDownloadClick(event) {
        ...
        try {
            const data = await (0,_handler__WEBPACK_IMPORTED_MODULE_4__.requestAPI)('download_datasets', {
                method: 'POST',
    ...
    async _onButtonUnzipClick(event) {
        ...
        try {
            const data = await (0,_handler__WEBPACK_IMPORTED_MODULE_4__.requestAPI)('unzip', {
                method: 'POST',
    ...
    async _onButtonInstallClick(event) {
        ...
        try {
            const data = await (0,_handler__WEBPACK_IMPORTED_MODULE_4__.requestAPI)('install_requirements', {
                method: 'POST',
                body: JSON.stringify({ path: currentPath })
            });
            console.log(data);
    ...
    async _getWorkspacesData() {
        ...
        try {
            this.workspaces = await (0,_handler__WEBPACK_IMPORTED_MODULE_4__.requestAPI)('get_workspaces_data', {
                method: 'GET'
            });
...
//# sourceMappingURL=lib_index_js.a367dcb3dff81218ef2d.js.map