...
function createDownloadButton(widget) {
    return createButton('Download Selected Dataset', 'ndp-button', widget._onButtonDownloadClick.bind(widget));
}
...
function populateCheckboxes(widget, datasetResources) {
    ...
    widget.checkboxContainer.innerHTML = '';
    // Assuming datasetResources is an object with keys as resource names
    Object.keys(datasetResources).forEach(resourceName => {
        const checkboxWrapper = document.createElement('div');
        checkboxWrapper.className = 'checkbox-wrapper';
        const checkbox = document.createElement('input');
        checkbox.type = 'checkbox';
        checkbox.id = resourceName;
...
class NDPWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_0__.Widget {
    constructor(defaultBrowser, commands) {
        ...
        headerCheckboxes.textContent = 'Selectable Items';
        ...
        this.dropdownDatasets.addEventListener('change', () => {
            ...
            if (selectedDataset) {
                ...
                (0,_dropdowns__WEBPACK_IMPORTED_MODULE_3__.populateCheckboxes)(this, selectedDataset.dataset_resources);
            }
        });
    }
...
//# sourceMappingURL=lib_index_js.a891dba86190d82de22a.js.map