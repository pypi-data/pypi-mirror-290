...
class NDPWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_0__.Widget {
    constructor(defaultBrowser, commands) {
        ...
        const headerNamespace = document.createElement('div');
        headerNamespace.textContent = 'Namespace';
        headerNamespace.className = 'headers';
        ...
        container.appendChild(headerNamespace);
...
//# sourceMappingURL=lib_index_js.6dfb2ec877b0d7fa0990.js.map