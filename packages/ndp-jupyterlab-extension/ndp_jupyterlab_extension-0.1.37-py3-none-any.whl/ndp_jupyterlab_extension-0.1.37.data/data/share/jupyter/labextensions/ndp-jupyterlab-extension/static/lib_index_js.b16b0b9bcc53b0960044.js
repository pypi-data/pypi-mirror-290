...
function createGitCloneButton(widget) {
    return createButton('Clone Repository', 'ndp-button', async () => {
        ...
        const body = new _lumino_widgets__WEBPACK_IMPORTED_MODULE_1__.Widget();
...
class NDPWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_0__.Widget {
    ...
    _onGoToGitExtensionButtonClick(event) {
        this.commands.execute('git:clone', { path: this.fileBrowser.model.path, url: 'http://git.git', repoUrl: 'http://git2.git2' });
    }
...
//# sourceMappingURL=lib_index_js.b16b0b9bcc53b0960044.js.map