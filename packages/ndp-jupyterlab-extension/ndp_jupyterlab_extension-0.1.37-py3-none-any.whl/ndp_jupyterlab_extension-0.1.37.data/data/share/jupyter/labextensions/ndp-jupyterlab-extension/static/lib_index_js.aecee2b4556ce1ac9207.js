...
class NDPWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_0__.Widget {
    constructor(defaultBrowser, commands) {
        ...
        buttonDownload.textContent = 'Download from Workspace';
        ...
        buttonUnZip.textContent = 'Extract all .zip files in Current Folder';
        ...
        buttonInstall.textContent = 'Get Workspaces Data';
        buttonInstall.className = 'ndp-button';
        buttonInstall.addEventListener('click', this._onButtonGetWorkspacesDataClick.bind(this));
    ...
    async _onButtonGetWorkspacesDataClick(event) {
        ...
        try {
            const data = await (0,_handler__WEBPACK_IMPORTED_MODULE_3__.requestAPI)('get_workspaces_data', {
                method: 'GET'
            });
            console.log(data);
        }
...
//# sourceMappingURL=lib_index_js.aecee2b4556ce1ac9207.js.map