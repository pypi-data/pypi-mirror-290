...
/* harmony import */ var _datasets_dropdown__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./datasets_dropdown */ "./lib/datasets_dropdown.js");
/* harmony import */ var _workspaces_dropdown__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./workspaces_dropdown */ "./lib/workspaces_dropdown.js");
...
class NDPWidget extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_0__.Widget {
    constructor(defaultBrowser, commands) {
        ...
        this.dropdownWorkspaces = (0,_workspaces_dropdown__WEBPACK_IMPORTED_MODULE_3__.createDropdownWorkspaces)();
        this.dropdownDatasets = (0,_datasets_dropdown__WEBPACK_IMPORTED_MODULE_4__.createDropdownDatasets)();
        ...
        const headerCheckboxes = document.createElement('div'); // Add this line
        headerCheckboxes.textContent = 'Selectable Items'; // Add this line
        headerCheckboxes.className = 'headers'; // Add this line
        ...
        // container.appendChild(buttonUnZip); ToDo: remove
        ...
        this.checkboxContainer = document.createElement('div'); // Add this line
        this.checkboxContainer.className = 'checkbox-container'; // Add this line
        this.createCheckboxes(); // Add this line
        container.appendChild(headerCheckboxes); // Add this line
        container.appendChild(this.checkboxContainer); // Add this line
        ...
        this.dropdownWorkspaces.addEventListener('change', () => {
            (0,_datasets_dropdown__WEBPACK_IMPORTED_MODULE_4__.updateDatasetsDropdown)(this);
        });
    }
    createCheckboxes() {
        // Example data for checkboxes
        ...
        items.forEach(item => {
            ...
            this.checkboxContainer.appendChild(checkboxWrapper);
        });
    }
    /**
    ...
    async _onButtonDownloadClick(event) {
        ...
        try {
            const data = await (0,_handler__WEBPACK_IMPORTED_MODULE_5__.requestAPI)('download_datasets', {
                method: 'POST',
    ...
    async _onButtonUnzipClick(event) {
        ...
        // Get the current path from the file manager
        const currentPath = this.fileBrowser.model.path;
        console.log('Making request to JupyterLab API: UnZip');
        try {
            const data = await (0,_handler__WEBPACK_IMPORTED_MODULE_5__.requestAPI)('unzip', {
                method: 'POST',
    ...
    async _onButtonInstallClick(event) {
        ...
        try {
            const data = await (0,_handler__WEBPACK_IMPORTED_MODULE_5__.requestAPI)('install_requirements', {
                method: 'POST',
                body: JSON.stringify({ path: currentPath })
            });
            console.log(data);
    ...
    async _getWorkspacesData() {
        ...
        try {
            this.workspaces = await (0,_handler__WEBPACK_IMPORTED_MODULE_5__.requestAPI)('get_workspaces_data', {
                method: 'GET'
            });
            console.log(this.workspaces);
            (0,_workspaces_dropdown__WEBPACK_IMPORTED_MODULE_3__.updateWorkspacesDropdown)(this);
        }
        catch (error) {
...
/* harmony export */ });
/* harmony import */ var _datasets_dropdown__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./datasets_dropdown */ "./lib/datasets_dropdown.js");
...
function updateWorkspacesDropdown(widget) {
    ...
    sortedWorkspaces.forEach((workspace) => {
        ...
        // Populate the second dropdown if the selected workspace is found
        (0,_datasets_dropdown__WEBPACK_IMPORTED_MODULE_0__.updateDatasetsDropdown)(widget);
    });
}
...
//# sourceMappingURL=lib_index_js.24855dc68cd972785e2c.js.map