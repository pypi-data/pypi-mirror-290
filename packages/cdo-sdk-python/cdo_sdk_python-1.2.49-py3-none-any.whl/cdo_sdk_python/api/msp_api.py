...
class MSPApi:
    ...
    @validate_call
    def add_active_directory_groups_to_tenant_in_msp_portal(
        self,
        tenant_uid: Annotated[StrictStr, Field(description="Unique identifier of the tenant to which the user groups will be added.")],
        active_directory_group_create_or_update_input: List[ActiveDirectoryGroupCreateOrUpdateInput],
        ...
        :param tenant_uid: Unique identifier of the tenant to which the user groups will be added. (required)
        :type tenant_uid: str
        :param active_directory_group_create_or_update_input: (required)
        :type active_directory_group_create_or_update_input: List[ActiveDirectoryGroupCreateOrUpdateInput]
        ...
        _param = self._add_active_directory_groups_to_tenant_in_msp_portal_serialize(
    ...
    @validate_call
    def add_active_directory_groups_to_tenant_in_msp_portal_with_http_info(
        self,
        tenant_uid: Annotated[StrictStr, Field(description="Unique identifier of the tenant to which the user groups will be added.")],
        active_directory_group_create_or_update_input: List[ActiveDirectoryGroupCreateOrUpdateInput],
        _request_timeout: Union[
    ...
    @validate_call
    def add_active_directory_groups_to_tenant_in_msp_portal_without_preload_content(
        self,
        tenant_uid: Annotated[StrictStr, Field(description="Unique identifier of the tenant to which the user groups will be added.")],
        active_directory_group_create_or_update_input: List[ActiveDirectoryGroupCreateOrUpdateInput],
        _request_timeout: Union[
    ...
    def _add_active_directory_groups_to_tenant_in_msp_portal_serialize(
        self,
        tenant_uid,
    ...
    def provision_cd_fmc_for_tenant_in_msp_portal(
        self,
        tenant_uid: Annotated[StrictStr, Field(description="Unique identifier of the tenant that Cloud-Delivered FMC provisioning will be enabled for.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        This is an asynchronous operation to Cloud-Delivered FMC for a tenant associated with the MSP Portal.

        :param tenant_uid: Unique identifier of the tenant that Cloud-Delivered FMC provisioning will be enabled for. (required)
        :type tenant_uid: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
