...
[boto3.ElasticLoadBalancingv2 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/elbv2.html#ElasticLoadBalancingv2)
...
def get_value() -> AuthenticateCognitoActionConfigExtraOutputTypeDef:
    return {...}
```
