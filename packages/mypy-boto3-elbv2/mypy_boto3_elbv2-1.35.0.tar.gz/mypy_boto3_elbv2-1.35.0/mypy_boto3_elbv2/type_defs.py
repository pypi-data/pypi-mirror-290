...
Usage::
    ...
    ```python
    from mypy_boto3_elbv2.type_defs import AuthenticateCognitoActionConfigExtraOutputTypeDef

    data: AuthenticateCognitoActionConfigExtraOutputTypeDef = ...
    ```
"""
...
AuthenticateCognitoActionConfigExtraOutputTypeDef = TypedDict(
    "AuthenticateCognitoActionConfigExtraOutputTypeDef",
    {
        "UserPoolArn": str,
...
AuthenticateOidcActionConfigExtraOutputTypeDef = TypedDict(
    "AuthenticateOidcActionConfigExtraOutputTypeDef",
    {
        "Issuer": str,
...
HostHeaderConditionConfigExtraOutputTypeDef = TypedDict(
    "HostHeaderConditionConfigExtraOutputTypeDef",
    {
...
HttpHeaderConditionConfigExtraOutputTypeDef = TypedDict(
    "HttpHeaderConditionConfigExtraOutputTypeDef",
    {
...
HttpRequestMethodConditionConfigExtraOutputTypeDef = TypedDict(
    "HttpRequestMethodConditionConfigExtraOutputTypeDef",
    {
        "Values": NotRequired[List[str]],
    },
...
PathPatternConditionConfigExtraOutputTypeDef = TypedDict(
    "PathPatternConditionConfigExtraOutputTypeDef",
    {
        "Values": NotRequired[List[str]],
    },
...
SourceIpConditionConfigExtraOutputTypeDef = TypedDict(
    "SourceIpConditionConfigExtraOutputTypeDef",
    {
        "Values": NotRequired[List[str]],
    },
...
ForwardActionConfigExtraOutputTypeDef = TypedDict(
    "ForwardActionConfigExtraOutputTypeDef",
    {
...
QueryStringConditionConfigExtraOutputTypeDef = TypedDict(
    "QueryStringConditionConfigExtraOutputTypeDef",
    {
...
ActionExtraOutputTypeDef = TypedDict(
    "ActionExtraOutputTypeDef",
    {
        ...
        "TargetGroupArn": NotRequired[str],
        "AuthenticateOidcConfig": NotRequired[AuthenticateOidcActionConfigExtraOutputTypeDef],
        "AuthenticateCognitoConfig": NotRequired[AuthenticateCognitoActionConfigExtraOutputTypeDef],
        ...
        "ForwardConfig": NotRequired[ForwardActionConfigExtraOutputTypeDef],
    },
)
...
RuleConditionExtraOutputTypeDef = TypedDict(
    "RuleConditionExtraOutputTypeDef",
    {
        "Field": NotRequired[str],
        "Values": NotRequired[List[str]],
        "HostHeaderConfig": NotRequired[HostHeaderConditionConfigExtraOutputTypeDef],
        "PathPatternConfig": NotRequired[PathPatternConditionConfigExtraOutputTypeDef],
        "HttpHeaderConfig": NotRequired[HttpHeaderConditionConfigExtraOutputTypeDef],
        "QueryStringConfig": NotRequired[QueryStringConditionConfigExtraOutputTypeDef],
        "HttpRequestMethodConfig": NotRequired[HttpRequestMethodConditionConfigExtraOutputTypeDef],
        "SourceIpConfig": NotRequired[SourceIpConditionConfigExtraOutputTypeDef],
    },
)
