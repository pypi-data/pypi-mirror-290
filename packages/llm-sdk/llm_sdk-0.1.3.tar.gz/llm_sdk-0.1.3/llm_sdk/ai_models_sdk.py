...
class ModelsAPI:
    ...
    def get_providers(self, model_type_name: Optional[str] = None,
    ...
    def get_model_creators(self, model_type_name: Optional[str] = None,
    ...
    def get_model_types(self):
        ...
        response.raise_for_status()
        return parse_obj_as(ModelTypeModel, response.json())
...
ai_models = ModelsAPI('https://web-production-6c25.up.railway.app')
