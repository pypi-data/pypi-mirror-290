...
from metamist import rest
from metamist.configuration import Configuration
from metamist.exceptions import ApiTypeError, ApiValueError, ApiException
from metamist.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create_analysis  # this is an instance of the class Endpoint
        api_instance.create_analysis()  # this invokes api_instance.create_analysis.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_analysis.callable or self.callable in this class
