...
class SeqrApi(object):
    ...
    def get_families(
        ...
        **kwargs
        ...
        Keyword Args:
            participant_ids ([int]): [optional] if omitted the server will use the default value of []
            sample_ids ([str]): [optional] if omitted the server will use the default value of []
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def get_pedigree(
        ...
        **kwargs
        ...
        >>> thread = api.get_pedigree(project, internal_family_ids, async_req=True)
        >>> result = thread.get()

        Args:
            project (str):
            internal_family_ids ([int]):
    ...
    def get_samples_reads_map(
        ...
        **kwargs
        ...
        Keyword Args:
            export_type (bool, date, datetime, dict, float, int, list, str, none_type): [optional]
            sequencing_types ([str]): [optional] if omitted the server will use the default value of []
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
