...
class BillingColumn(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """BillingColumn - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): List of billing columns., must be one of ["id", "topic", "service", "sku", "usage_start_time", "usage_end_time", "project", "labels", "system_labels", "location", "export_time", "cost", "currency", "currency_conversion_rate", "usage", "credits", "invoice", "cost_type", "adjustment_info", "gcp_project", "day", "cost_category", "ar_guid", "invoice_month", "dataset", "batch_id", "sequencing_type", "stage", "sequencing_group", "compute_category", "cromwell_sub_workflow_name", "cromwell_workflow_id", "goog_pipelines_worker", "wdl_task_name", "namespace", ]  # noqa: E501
