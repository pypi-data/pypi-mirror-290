...
class ProjectSummary(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, project, total_samples, total_participants, total_sequencing_groups, total_assays, cram_seqr_stats, batch_sequencing_group_stats, seqr_links, seqr_sync_types, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, project, total_samples, total_participants, total_sequencing_groups, total_assays, cram_seqr_stats, batch_sequencing_group_stats, seqr_links, seqr_sync_types, *args, **kwargs):  # noqa: E501
        """ProjectSummary - a model defined in OpenAPI
