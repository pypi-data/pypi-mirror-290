...
def lazy_import():
    ...
    globals()['ProjectParticipantGridField'] = ProjectParticipantGridField


class ProjectParticipantGridResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'fields': ({str: ([ProjectParticipantGridField],)},),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, participants, total_results, fields, *args, **kwargs):  # noqa: E501
        """ProjectParticipantGridResponse - a model defined in OpenAPI

        Args:
            participants ([NestedParticipant]):
            total_results (int):
            fields ({str: ([ProjectParticipantGridField],)}):
    ...
    @convert_js_args_to_python_args
    def __init__(self, participants, total_results, fields, *args, **kwargs):  # noqa: E501
        """ProjectParticipantGridResponse - a model defined in OpenAPI
