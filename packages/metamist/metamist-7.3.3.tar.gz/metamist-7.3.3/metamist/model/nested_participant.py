...
class NestedParticipant(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, external_ids, meta, samples, families, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, external_ids, meta, samples, families, *args, **kwargs):  # noqa: E501
        """NestedParticipant - a model defined in OpenAPI
