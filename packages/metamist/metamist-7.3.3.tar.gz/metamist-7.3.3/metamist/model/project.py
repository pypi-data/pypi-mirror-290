...
def lazy_import():
    ...
    globals()['ProjectMemberRole'] = ProjectMemberRole
...
class Project(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'roles': ([ProjectMemberRole],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, dataset, roles, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, dataset, roles, *args, **kwargs):  # noqa: E501
        """Project - a model defined in OpenAPI
