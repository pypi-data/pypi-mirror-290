...
class NestedSample(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'sample_root_id': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'sample_parent_id': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'sample_root_id': 'sample_root_id',  # noqa: E501
        'sample_parent_id': 'sample_parent_id',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, external_ids, meta, type, created_date, sample_root_id, sample_parent_id, non_sequencing_assays, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            sample_root_id (bool, date, datetime, dict, float, int, list, str, none_type):
            sample_parent_id (bool, date, datetime, dict, float, int, list, str, none_type):
        ...
        self.sample_root_id = sample_root_id
        self.sample_parent_id = sample_parent_id
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, external_ids, meta, type, created_date, sample_root_id, sample_parent_id, non_sequencing_assays, *args, **kwargs):  # noqa: E501
        """NestedSample - a model defined in OpenAPI
