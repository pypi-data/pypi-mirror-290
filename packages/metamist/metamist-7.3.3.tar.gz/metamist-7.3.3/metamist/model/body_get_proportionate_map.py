...
def lazy_import():
    ...
    globals()['ProportionalDateTemporalMethod'] = ProportionalDateTemporalMethod


class BodyGetProportionateMap(ModelNormal):
    ...
    attribute_map = {
        ...
        'temporal_methods': 'temporal_methods',  # noqa: E501
        'sequencing_types': 'sequencing_types',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, projects, temporal_methods, *args, **kwargs):  # noqa: E501
        """BodyGetProportionateMap - a model defined in OpenAPI

        Args:
            projects ([str]):
            temporal_methods ([ProportionalDateTemporalMethod]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, projects, temporal_methods, *args, **kwargs):  # noqa: E501
        """BodyGetProportionateMap - a model defined in OpenAPI
