...
class Analysis(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'cohort_ids': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'author': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'timestamp_completed': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'cohort_ids': 'cohort_ids',  # noqa: E501
    ...
    def _from_openapi_data(cls, type, status, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            sequencing_group_ids (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            cohort_ids (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            author (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
            timestamp_completed (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
