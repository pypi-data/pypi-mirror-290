...
class AnalysisCostRecordCromwellSubworkflow(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'cromwell_sub_workflow_name': (str,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cromwell_sub_workflow_name, cost, usage_start_time, usage_end_time, skus, *args, **kwargs):  # noqa: E501
        """AnalysisCostRecordCromwellSubworkflow - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, cromwell_sub_workflow_name, cost, usage_start_time, usage_end_time, skus, *args, **kwargs):  # noqa: E501
        """AnalysisCostRecordCromwellSubworkflow - a model defined in OpenAPI
