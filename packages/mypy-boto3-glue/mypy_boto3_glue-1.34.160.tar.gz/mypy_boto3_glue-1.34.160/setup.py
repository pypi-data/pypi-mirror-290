...
setup(
    ...
    description="Type annotations for boto3.Glue 1.34.160 service generated with mypy-boto3-builder 7.25.3",
    classifiers=[
    ...
    keywords="boto3 glue type-annotations botocore mypy typeshed autocomplete",
