...
- value (string | number | boolean; optional):
    ...
    _type = 'Radios'
    @_explicitize_args
    def __init__(self, options=Component.UNDEFINED, value=Component.UNDEFINED, id=Component.UNDEFINED, title=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'options', 'title', 'value']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'options', 'title', 'value']
