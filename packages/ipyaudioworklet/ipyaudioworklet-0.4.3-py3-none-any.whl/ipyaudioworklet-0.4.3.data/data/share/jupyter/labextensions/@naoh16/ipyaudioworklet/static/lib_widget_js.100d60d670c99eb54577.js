...
let buffers = [];
exports.audiodata = []; //new Float32Array(_audiodata);
exports.blob_url = '';
function run(audio_processor_js_url = '', annealing_time_ms = 500) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log('(1)');
        yield prepareCustomAudioProcessor(audio_processor_js_url, 'audio-reorder-processor');
...
let audioProcessorJsUrl = 'https://cdn.jsdelivr.net/npm/@naoh16/ipyaudioworklet@' +
    version_1.MODULE_VERSION +
...
try {
    if (window.document.body.classList.contains('notebook_app')) {
        ...
        const e = window.document.querySelector('#jupyter-config-data');
        const jconfig = JSON.parse(e.textContent);
        audioProcessorJsUrl =
            jconfig['fullAppUrl'] +
