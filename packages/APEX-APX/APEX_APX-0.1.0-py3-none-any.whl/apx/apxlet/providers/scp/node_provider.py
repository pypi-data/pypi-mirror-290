...
from apx.clouds.utils.scp_utils import SCPCreationFailError
from apx.apxlet.providers.scp.config import ZoneConfig
from apx.utils import common_utils

TAG_PATH_PREFIX = '~/.apx/generated/scp/metadata'
...
class SCPNodeProvider(NodeProvider):
    ...
    def __init__(self, provider_config: Dict[str, Any],
        ...
        if os.path.exists(ray_yaml_path) and not os.path.exists(
            ...
            # Ensure correct cluster so apx launch on head node works correctly
