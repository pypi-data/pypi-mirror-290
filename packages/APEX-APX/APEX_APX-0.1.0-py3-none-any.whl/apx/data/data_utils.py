"""Miscellaneous Utils for Apx Data
"""
...
def get_ibm_cos_bucket_region(bucket_name: str) -> str:
    ...
    # https://github.com/apxdeploy-org/apxdeploy/pull/1966#issuecomment-1646992938
...
def get_gsutil_command() -> Tuple[str, str]:
    ...
    Returns:
        ...
        ```
    """
    gsutil_alias = 'apxdeploy_gsutil'
    disable_multiprocessing_flag = '-o "GSUtil:parallel_process_count=1"'

    # Define apxdeploy_gsutil as a shell function instead of an alias.
