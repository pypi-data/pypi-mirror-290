...
from apx.adaptors.ibm import CREDENTIAL_FILE
...
class IBM(clouds.Cloud):
    ...
    def query_status(cls, name: str, tag_filters: Dict[str, str],
        ...
        if not vpcs_filtered_by_tags_and_region:
            # a vpc could have been removed unkownlingly to apxdeploy, such as
            # via `apx autostop --down`, or simply manually (e.g. via console).
