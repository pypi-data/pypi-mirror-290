...
# Namespace for APX resources shared across multiple tenants on the
...
_APXDEPLOY_SYSTEM_NAMESPACE = 'apxdeploy-system'
...
class Kubernetes(clouds.Cloud):
    ...
    APX_SSH_KEY_SECRET_NAME = 'apx-ssh-keys'
    APX_SSH_JUMP_NAME = 'apx-ssh-jump-pod'
    ...
    # These services are named as {cluster_name_on_cloud}--apxdeploy-svc--{port},
    ...
    IMAGE_CPU = 'apxdeploy:cpu-ubuntu-2004'
    IMAGE_GPU = 'apxdeploy:gpu-ubuntu-2004'
    ...
    def make_deploy_resources_variables(
        ...
        timeout = apxdeploy_config.get_nested(
        ...
        deploy_vars = {
            ...
            'k8s_ssh_key_secret_name': self.APX_SSH_KEY_SECRET_NAME,
            'k8s_acc_label_key': k8s_acc_label_key,
            'k8s_acc_label_value': k8s_acc_label_value,
            'k8s_ssh_jump_name': self.APX_SSH_JUMP_NAME,
            'k8s_ssh_jump_image': ssh_jump_image,
            'k8s_service_account_name': k8s_service_account_name,
            'k8s_automount_sa_token': k8s_automount_sa_token,
            'k8s_fuse_device_required': fuse_device_required,
            # Namespace to run the FUSE device manager in
            'k8s_apxdeploy_system_namespace': _APXDEPLOY_SYSTEM_NAMESPACE,
