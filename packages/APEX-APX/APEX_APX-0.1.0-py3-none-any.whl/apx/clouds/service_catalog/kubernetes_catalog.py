...
mapping APX image tags to corresponding container image tags.
"""
import re
import typing
...
from apx.clouds import Kubernetes
from apx.clouds.service_catalog import CloudFilter
...
def list_accelerators_realtime(
    ...
    # by apx show-gpus when cloud is not specified.
