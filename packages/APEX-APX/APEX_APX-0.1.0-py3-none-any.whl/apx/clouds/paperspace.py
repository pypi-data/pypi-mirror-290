...
from apx.provision.paperspace import utils
...
class Paperspace(clouds.Cloud):
    ...
    # Using the latest APX provisioner API to provision and check status.
    ...
    def check_credentials(cls) -> Tuple[bool, Optional[str]]:
        ...
        try:
            ...
            return False, (
                ...
                'https://apxdeploy.readthedocs.io/en/latest/getting-started/installation.html#paperspace\n    '
