...
from apx.provision.vsphere.vsphere_utils import get_vsphere_credentials
from apx.provision.vsphere.vsphere_utils import initialize_vsphere_data
    ...
    def check_credentials(cls) -> Tuple[bool, Optional[str]]:
        ...
        try:
            ...
            return False, (
                ...
                f'\n{cls._INDENT_PREFIX}  $ pip install apxdeploy[vSphere]'
                f'\n{cls._INDENT_PREFIX}Credentials may also need to be set. '
                'For more details. See https://apxdeploy.readthedocs.io/en/latest/getting-started/installation.html#vmware-vsphere'  # pylint: disable=line-too-long
