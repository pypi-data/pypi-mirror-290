...
from apx.clouds.utils import scp_utils
...
class SCP(clouds.Cloud):
    ...
    def _get_default_ami(cls, region_name: str, instance_type: str) -> str:
        ...
        image_id = service_catalog.get_image_id_from_tag('apxdeploy:ubuntu-2004',
                                                         region_name,
                                                         clouds='scp')
        if acc is not None:
            assert len(acc) == 1, acc
            image_id = service_catalog.get_image_id_from_tag(
                'apxdeploy:gpu-ubuntu-1804', region_name, clouds='scp')
