        ...
        try:
            ...
            if not valid:
                return False, (
                    ...
                    f'        $ runpod config\n'
                    '    For more information, see https://apxdeploy.readthedocs.io/en/latest/getting-started/installation.html#runpod'  # pylint: disable=line-too-long
                )
            ...
            return False, ('Failed to import runpod. '
                           'To install, run: pip install apxdeploy[runpod]')
