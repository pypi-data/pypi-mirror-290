...
_DB_PATH = os.path.expanduser('~/.apx/state.db')
...
def add_or_update_cluster(cluster_name: str,
    ...
    """
    # FIXME: launched_at will be changed when `apx launch -c` is called.
...
def get_cached_enabled_clouds() -> List[clouds.Cloud]:
    ...
    for c in ret:
        try:
            ...
            # APX, e.g., 'local' was a cloud in the past and may be stored
