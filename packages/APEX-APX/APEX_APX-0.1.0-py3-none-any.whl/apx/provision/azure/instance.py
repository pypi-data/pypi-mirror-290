...
UNIQUE_ID_LEN = 4
_TAG_APXDEPLOY_VM_ID = 'apxdeploy-vm-id'
...
def _create_instances(
    ...
    tags = {
        ...
        constants.TAG_APXDEPLOY_CLUSTER_NAME: cluster_name_on_cloud,
        **constants.WORKER_NODE_TAGS,
        _TAG_APXDEPLOY_VM_ID: vm_id,
        **tags,
    }
        ...
        try:
            ...
            nsg.security_rules.append(
                azure.create_security_rule(
                    name=f'apx-ports-{cluster_name_on_cloud}-{priority}',
                    priority=priority,
                    protocol='Tcp',
                    access='Allow',
                    direction='Inbound',
