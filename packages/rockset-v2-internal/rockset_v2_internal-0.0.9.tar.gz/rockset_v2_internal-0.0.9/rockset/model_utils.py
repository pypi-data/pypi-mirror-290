...
def validate_and_convert_types(input_value, required_types_mixed, path_to_item,
    ...
    Args:
        ...
        is_from_server: (boolean) True if deserializing a response from the server.
            None will be allowed as an option for all fields.
    ...
    if is_from_server and none_type not in valid_classes:
        valid_classes = list(valid_classes)
        valid_classes.append(none_type)
