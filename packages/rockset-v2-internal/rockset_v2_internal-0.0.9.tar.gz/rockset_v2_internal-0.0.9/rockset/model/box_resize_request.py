...
class BoxResizeRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, new_size, *args, **kwargs):  # noqa: E501
        """BoxResizeRequest - a model defined in OpenAPI

        Args:
            new_size (str): desired new size
