...
class QueryParameter(ModelNormal):
    ...
    def _from_openapi_data(cls, name, value, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            value (str): Literal value of the field. If the type field is not provided, the value of this field must be JSON (strings should include escaped quotes within the string itself)
        ...
        Keyword Args:
            ...
            type (str): Deprecated. Data type of the field.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, *, name, value, **kwargs):  # noqa: E501
        """QueryParameter - a model defined in OpenAPI
