...
[Open documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_voice_id/client/)
...
class VoiceIDClient(BaseClient):
    ...
    def close(self) -> None:
        ...
        [Show boto3-stubs documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_voice_id/client/#close)
        """
    ...
    def delete_domain(self, *, DomainId: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_fraudster(self, *, DomainId: str, FraudsterId: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_speaker(self, *, DomainId: str, SpeakerId: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_watchlist(self, *, DomainId: str, WatchlistId: str) -> EmptyResponseMetadataTypeDef:
        """
