...
class Interfaces(BaseModel):
    ...
    @computed_field
    @property
    def average_rates_data_inbound(self) -> Table:
        return Table(client=self.client, endpoint="tables/interfaces/transfer-rates/inbound", sn=self.sn)

    @computed_field
    @property
    def average_rates_data_outbound(self) -> Table:
        return Table(client=self.client, endpoint="tables/interfaces/transfer-rates/outbound", sn=self.sn)

    @computed_field
    @property
    def average_rates_data_bidirectional(self) -> Table:
        return Table(client=self.client, endpoint="tables/interfaces/transfer-rates/bidirectional", sn=self.sn)

    @computed_field
    @property
    def average_rates_data_inbound_per_device(self) -> Table:
        return Table(client=self.client, endpoint="tables/interfaces/transfer-rates/inbound-device", sn=self.sn)

    @computed_field
    @property
    def average_rates_data_outbound_per_device(self) -> Table:
        return Table(client=self.client, endpoint="tables/interfaces/transfer-rates/outbound-device", sn=self.sn)

    @computed_field
    @property
    def average_rates_data_bidirectional_per_device(self) -> Table:
        return Table(client=self.client, endpoint="tables/interfaces/transfer-rates/bidirectional-device", sn=self.sn)

    @computed_field
    @property
    def average_rates_errors_inbound(self) -> Table:
        return Table(client=self.client, endpoint="tables/interfaces/errors/inbound", sn=self.sn)

    @computed_field
    @property
    def average_rates_errors_outbound(self) -> Table:
        return Table(client=self.client, endpoint="tables/interfaces/errors/outbound", sn=self.sn)

    @computed_field
    @property
    def average_rates_errors_bidirectional(self) -> Table:
        return Table(client=self.client, endpoint="tables/interfaces/errors/bidirectional", sn=self.sn)

    @computed_field
    @property
    def average_rates_errors_inbound_per_device(self) -> Table:
        return Table(client=self.client, endpoint="tables/interfaces/errors/inbound-device", sn=self.sn)

    @computed_field
    @property
    def average_rates_errors_outbound_per_device(self) -> Table:
        return Table(client=self.client, endpoint="tables/interfaces/errors/outbound-device", sn=self.sn)

    @computed_field
    @property
    def average_rates_errors_bidirectional_per_device(self) -> Table:
        return Table(client=self.client, endpoint="tables/interfaces/errors/bidirectional-device", sn=self.sn)

    @computed_field
    @property
    def average_rates_drops_inbound(self) -> Table:
        return Table(client=self.client, endpoint="tables/interfaces/drops/inbound", sn=self.sn)

    @computed_field
    @property
    def average_rates_drops_outbound(self) -> Table:
        return Table(client=self.client, endpoint="tables/interfaces/drops/outbound", sn=self.sn)

    @computed_field
    @property
    def average_rates_drops_bidirectional(self) -> Table:
        return Table(client=self.client, endpoint="tables/interfaces/drops/bidirectional", sn=self.sn)

    @computed_field
    @property
    def average_rates_drops_inbound_per_device(self) -> Table:
        return Table(client=self.client, endpoint="tables/interfaces/drops/inbound-device", sn=self.sn)

    @computed_field
    @property
    def average_rates_drops_outbound_per_device(self) -> Table:
        return Table(client=self.client, endpoint="tables/interfaces/drops/outbound-device", sn=self.sn)

    @computed_field
    @property
    def average_rates_drops_bidirectional_per_device(self) -> Table:
        return Table(client=self.client, endpoint="tables/interfaces/drops/bidirectional-device", sn=self.sn)
