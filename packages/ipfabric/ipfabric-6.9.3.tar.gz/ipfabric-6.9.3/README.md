...
**IP Fabric 6.9 will be the last release before 7.0.**  Major Releases will have breaking changes that will need to be
...
In `ipfabric>=v7.0.x` (Next Release after 6.9) the following will be changed/deprecated:
