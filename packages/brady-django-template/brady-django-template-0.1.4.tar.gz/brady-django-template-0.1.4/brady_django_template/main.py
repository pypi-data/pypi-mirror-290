...
import pkg_resources  # Import pkg_resources for package data access

def create_django_project():
    # Ensure there is a project name argument
    if len(sys.argv) != 2:
    ...
    # Get the path to the template directory within the package
    template_dir = pkg_resources.resource_filename(__name__, 'project-template')
