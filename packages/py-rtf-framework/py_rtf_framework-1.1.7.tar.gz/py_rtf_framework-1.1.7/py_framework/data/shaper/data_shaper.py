...
def run_data_shaper(work_flow_schema_path: str, input_tables: pd.DataFrame | None = None) -> DataFrame:
    ...
    work_flow = Workflow(schema=workflow_schema, input_tables=input_tables)
