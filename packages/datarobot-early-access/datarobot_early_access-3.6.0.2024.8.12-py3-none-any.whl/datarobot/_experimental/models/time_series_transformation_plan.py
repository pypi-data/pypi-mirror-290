...
from datarobot._experimental.models.recipe_operations import WranglingOperation
...
class InputParameters(APIObject):
    ...
    _converter = t.Dict(
        {
            ...
            t.Key("do_not_derive_columns", optional=True): t.Or(
                t.List(t.String(allow_blank=False)), t.Null
            ),
            t.Key("known_in_advance_columns", optional=True): t.Or(
                t.List(t.String(allow_blank=False)), t.Null
            ),
            t.Key("exclude_low_info_columns", optional=True): t.Or(t.Bool, t.Null),
            t.Key("shap_impact_threshold", optional=True): t.Or(t.Float(gt=0, lte=1), t.Null),
        }
    ).allow_extra("*")
    ...
    def __init__(
        ...
        shap_impact_threshold: Optional[float] = None,
    ):
        ...
        self.shap_impact_threshold = shap_impact_threshold
