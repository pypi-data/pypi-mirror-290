...
class GenKit:
    class PhoneGen:
        ...
        def generate(self, length=10):
            ...
            Parameters:
            length (int): The length of the phone number to generate. Defaults to 10.
    ...
    def phonenumber(country="IN", n=1, type="string", save=False):
        ...
        Parameters:
        country (str): The country code to use for generating phone numbers. Defaults to 'IN'.
        n (int): The number of phone numbers to generate. Defaults to 1.
        type (str): The format of the output. Can be 'string' (default), 'list', or 'dict'.
        save (bool): Whether to save the generated phone numbers to a file. Defaults to False.
