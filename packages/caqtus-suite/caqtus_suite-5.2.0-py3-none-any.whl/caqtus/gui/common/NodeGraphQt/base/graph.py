...
from .commands import NodeAddedCmd, NodesRemovedCmd, NodeMovedCmd, PortConnectedCmd
...
from ..errors import NodeCreationError, NodeDeletionError
from ..nodes.backdrop_node import BackdropNode
from ..nodes.base_node import BaseNode
from ..nodes.group_node import GroupNode
from ..nodes.port_node import PortInputNode, PortOutputNode
from ..widgets.node_graph import NodeGraphWidget, SubGraphWidget
...
class NodeGraph(QtCore.QObject):
    ...
    def widget(self):
        ...
        if self._widget is None:
            ...
            tab_flags = [QtWidgets.QTabBar.RightSide, QtWidgets.QTabBar.LeftSide]
