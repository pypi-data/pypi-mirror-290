...
- [Feb, 2024] Speed up your LLM deployments with [**SGLang**](https://github.com/sgl-project/sglang) for 5x throughput on APXServe: [**example**](./llm/sglang/)
...
- [Sep, 2023] [**Mistral 7B**](https://mistral.ai/news/announcing-mistral-7b/), a high-quality open LLM, was released! Deploy via APX on any cloud: [**Mistral docs**](https://docs.mistral.ai/self-deployment/apxdeploy)
- [July, 2023] Self-Hosted **Llama-2 Chatbot** on Any Cloud: [**example**](./llm/llama-2/)
- [June, 2023] Serving LLM 24x Faster On the Cloud [**with vLLM**](https://vllm.ai/) and APX: [**example**](./llm/vllm/), [**blog post**](https://blog.apxdeploy.co/serving-llm-24x-faster-on-the-cloud-with-vllm-and-apxdeploy/)
- [April, 2023] [APX YAMLs](./llm/vicuna/) for finetuning & serving the [Vicuna LLM](https://lmsys.org/blog/2023-03-30-vicuna/) with a single command!
...
<!-- Keep this section in sync with index.rst in APX Docs -->
Runnable examples:
- LLMs on APX
