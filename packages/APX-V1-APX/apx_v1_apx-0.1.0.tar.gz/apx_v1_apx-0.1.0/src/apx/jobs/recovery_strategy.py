...
class StrategyExecutor:
    ...
    def _try_cancel_all_jobs(self):
        ...
        try:
            usage_lib.messages.usage.set_internal()
            # Note that `apx.cancel()` may not go through for a variety of
            # reasons:
            ...
            #
            # In the case where the worker node is preempted, the `apx.cancel()`
            ...
            apx.cancel(cluster_name=self.cluster_name,
                       all=True,
    ...
    def _launch(self,
        ...
        """
        # TODO(zhwu): handle the failure during `preparing apx runtime`.
        retry_cnt = 0
        ...
        while True:
            ...
            try:
                ...
                # Please refer to the docstring of `apx.launch` for more
                ...
                # At this point, a apx.launch() has succeeded. Cluster may be
...
class FailoverStrategyExecutor(StrategyExecutor, name='FAILOVER',
    ...
    def __init__(self, cluster_name: str, backend: 'backends.Backend',
        ...
        # preempted.)
        self._launched_resources: Optional['apx.resources.Resources'] = None
