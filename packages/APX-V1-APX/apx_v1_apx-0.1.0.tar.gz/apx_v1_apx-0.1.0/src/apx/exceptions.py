...
if typing.TYPE_CHECKING:
    ...
    from apx.backends import backend

# Return code for keyboard interruption and SIGTSTP
KEYBOARD_INTERRUPT_CODE = 130
SIGTSTP_CODE = 146
RSYNC_FILE_NOT_FOUND_CODE = 23
# Arbitrarily chosen value. Used in APX's storage mounting scripts
MOUNT_PATH_NON_EMPTY_CODE = 42
# Arbitrarily chosen value. Used to provision Kubernetes instance in Apxdeploy
...
class ResourcesUnavailableError(Exception):
    ...
    This is mainly used for the APIs in apx.execution; please refer to
    the docstring of apx.launch for more details about how the
...
class ProvisionPrechecksError(Exception):
    ...
    lower-level apx.launch()). Please refer to the docstring of
