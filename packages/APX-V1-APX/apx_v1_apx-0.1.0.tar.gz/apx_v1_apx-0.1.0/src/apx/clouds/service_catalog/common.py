...
from apx.clouds import cloud as cloud_lib
from apx.clouds import cloud_registry
from apx.clouds.service_catalog import constants
...
class LazyDataFrame:
    ...
    We don't need to load the catalog for every APX call, and this class
                ...
                if not candidate_strs:
                    if cloud_name in ('azure', 'gcp'):
                        faq_msg = (
                            ...
                            'its catalog info.\nhttps://apxdeploy.readthedocs.io'
                            '/en/latest/reference/faq.html#advanced-how-to-'
                            'make-apxdeploy-use-all-global-regions')
