...
# used instead for APX-launched instances. This is the same behavior as
# gcloud:
...
# See: https://github.com/apxdeploy-org/apxdeploy/pull/1539
# NOTE: do not expanduser() on this path. It's used as a destination path on the
# remote cluster.
...
# NOTE: do not expanduser() on this path. It's used as a destination path on the
# remote cluster.
_GCLOUD_INSTALLATION_LOG = '~/.apx/logs/gcloud_installation.log'
...
USER_PORTS_FIREWALL_RULE_NAME = 'apx-ports-{}'
...
class GCPIdentityType(enum.Enum):
    ...
    #   apxdeploy-v1@xxxx.iam.gserviceaccount.com
...
class GCP(clouds.Cloud):
    ...
    # characters. Through testing, this is the maximum length for the Apx
    ...
    _CREDENTIAL_HINT = (
        ...
        'https://apxdeploy.readthedocs.io/en/latest/getting-started/installation.html#google-cloud-platform-gcp'  # pylint: disable=line-too-long
    )
    ...
    def _unsupported_features_for_resources(
        ...
        # because `apxdeploy_config` may change for an existing cluster.
    ...
    def make_deploy_resources_variables(
        ...
        image_id = 'apxdeploy:cpu-debian-11'
        ...
        if accelerators is not None:
            ...
            if 'tpu' in acc:
                ...
                if acc == 'K80':
                    ...
                    image_id = 'apxdeploy:k80-debian-10'
                else:
                    # CUDA driver version 535.86.10, CUDA Library 12.2
                    image_id = 'apxdeploy:gpu-debian-11'
        ...
        managed_instance_group_config = apxdeploy_config.get_nested(
            ('gcp', 'managed_instance_group'),
            None,
        ...
        resources_vars[
            'force_enable_external_ips'] = apxdeploy_config.get_nested(
    ...
    def check_credentials(cls) -> Tuple[bool, Optional[str]]:
            ...
            if is_api_disabled(endpoint, project_id):
                ...
                if proc.returncode == 0:
                    ...
                    return False, (
                        ...
                        '`apx check` in a few minutes, or manually enable it.')
                else:
        ...
        if enabled_api:
            print('\nHint: Enabled GCP API(s) may take a few minutes to take '
                  'effect. If any APX commands/calls failed, retry after '
                  'some time.')
        ...
        if len(diffs) > 0:
            ...
            return False, (
                ...
                f'{diffs}\n    '
                'For more details, visit: https://apxdeploy.readthedocs.io/en/latest/cloud-setup/cloud-permissions/gcp.html')  # pylint: disable=line-too-long
        return True, None
    ...
    def get_credential_file_mounts(self) -> Dict[str, str]:
        ...
        # `check_credentials()` when the user calls `apx check`.
        credentials = {
    ...
    def check_quota_available(cls, resources: 'resources.Resources') -> bool:
        ...
        # pylint: disable=import-outside-toplevel
        from apx.clouds.service_catalog import gcp_catalog
