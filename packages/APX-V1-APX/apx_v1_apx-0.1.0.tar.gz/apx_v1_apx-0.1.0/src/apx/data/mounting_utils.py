"""Helper functions for object store mounting in Apx Storage"""
import random
import shlex
import textwrap
...
_BLOBFUSE_CACHE_ROOT_DIR = '~/.apx/blobfuse2_cache'
_BLOBFUSE_CACHE_DIR = ('~/.apx/blobfuse2_cache/'
...
def get_mounting_command(
    ...
    #  fails with apx's ssh pipeline. Instead, we don't use EOF and use )
    ...
    script_path = f'~/.apx/mount_{random.randint(0, 1000000)}.sh'
