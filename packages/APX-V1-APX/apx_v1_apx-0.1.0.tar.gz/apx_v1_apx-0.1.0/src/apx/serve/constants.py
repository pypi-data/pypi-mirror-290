"""Constants used for APXServe."""

CONTROLLER_TEMPLATE = 'apx-serve-controller.yaml.j2'

APXSERVE_METADATA_DIR = '~/.apx/serve'
...
PORT_SELECTION_FILE_LOCK_PATH = f'{APXSERVE_METADATA_DIR}/port_selection.lock'

# Signal file path for controller to handle signals.
SIGNAL_FILE_PATH = '/tmp/apx_serve_controller_signal_{}'
...
REPLICA_ID_ENV_VAR = 'APXDEPLOY_SERVE_REPLICA_ID'
...
# the user can be notified to update their APX serve version on the remote
# cluster.
SERVE_VERSION = 1
