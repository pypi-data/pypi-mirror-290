"""Service specification for APXServe."""
import json
import os
import textwrap
...
class ApxServiceSpec:
    """APXServe service specification."""
        ...
        if auto_restart is not None:
            with ux_utils.print_exception_no_traceback():
                raise ValueError(
                    ...
                    'Currently, APXServe will cleanup failed replicas'
    ...
    @staticmethod
    def from_yaml_config(config: Dict[str, Any]) -> 'ApxServiceSpec':
        ...
        return ApxServiceSpec(**service_config)

    @staticmethod
    def from_yaml(yaml_path: str) -> 'ApxServiceSpec':
        ...
        return ApxServiceSpec.from_yaml_config(config['service'])
