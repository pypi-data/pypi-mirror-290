...
LOG_URL = 'http://usage.apxdeploy.co:9090/loki/api/v1/push'  # pylint: disable=line-too-long

USAGE_MESSAGE_SCHEMA_VERSION = 1

PRIVACY_POLICY_PATH = '~/.apx/privacy_policy'

USAGE_POLICY_MESSAGE = (
    'APX collects usage data to improve its services. '
    '`setup` and `run` commands are not collected to '
    'ensure privacy.\n'
    'Usage logging can be disabled by setting the '
    'environment variable APXDEPLOY_DISABLE_USAGE_COLLECTION=1.')
