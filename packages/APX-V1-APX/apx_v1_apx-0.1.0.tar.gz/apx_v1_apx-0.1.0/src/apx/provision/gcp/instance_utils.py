...
from apx.clouds import gcp as gcp_cloud
...
from apx.provision.gcp import mig_utils
        ...
        config.update({
            'labels': dict(
                labels, **{
                    ...
                    provision_constants.TAG_APXDEPLOY_CLUSTER_NAME: cluster_name
                }),
        })
...
class GCPTPUVMInstance(GCPInstance):
    ...
    def filter(
        ...
        try:
            ...
            # APX: Catch HttpError when accessing unauthorized region.
