"""Cudo Compute library wrapper for APX."""
import time
from typing import Dict

from apx import apx_logging
from apx.adaptors import cudo
import apx.provision.cudo.cudo_utils as utils
    ...
    try:
        ...
        api.update_vm_metadata(
            ...
            cudo.cudo.UpdateVMMetadataBody(
                metadata=tags,
                merge=True))  # TODO (apxdeploy team) merge or overwrite?
    except cudo.cudo.rest.ApiException as e:
        raise e
...
def vm_available(to_start_count, gpu_count, gpu_model, data_center_id, mem,
                 cpus):
    try:
        gpu_model = utils.apxdeploy_gpu_to_cudo_gpu(gpu_model)
        api = cudo.cudo.cudo_api.virtual_machines()
