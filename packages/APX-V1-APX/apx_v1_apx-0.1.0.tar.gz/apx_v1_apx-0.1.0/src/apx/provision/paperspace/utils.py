"""Paperspace API client wrapper for APX."""
...
import apx.provision.paperspace.constants as constants
...
class PaperspaceCloudClient:
    ...
    def get_apx_key_script(self) -> str:
        return self.list_startup_scripts(ADD_KEY_SCRIPT)[0]['id']

    def set_apx_key_script(self, public_key: str) -> None:
        script = (
        ...
        try:
            script_id = self.get_apx_key_script()
    ...
    def launch(self, name: str, instance_type: str, network_id: str,
        ...
        response = _try_request_with_backoff(
            ...
            data=json.dumps({
                ...
                'startupScriptId': self.get_apx_key_script(),
