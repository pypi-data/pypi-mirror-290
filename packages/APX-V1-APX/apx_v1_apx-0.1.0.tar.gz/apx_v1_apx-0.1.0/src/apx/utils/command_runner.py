...
def _ssh_control_path(ssh_control_filename: Optional[str]) -> Optional[str]:
    ...
    path = f'/tmp/apxdeploy_ssh_{user_hash}/{ssh_control_filename}'
    ...
    def run(
        ...
        Args:
            ...
            skip_lines: The number of lines to skip at the beginning of the
                ...
                APX but we still want to get rid of some warning messages,
    ...
    def __init__(
        ...
        Args:
            ...
            docker_user: The docker user to use for ssh. If specified, the
                ...
                server running at port apx.apxlet.constants.DEFAULT_DOCKER_PORT
