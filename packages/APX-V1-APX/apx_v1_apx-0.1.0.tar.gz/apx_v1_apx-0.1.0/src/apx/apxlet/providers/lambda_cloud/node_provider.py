...
_TAG_PATH_PREFIX = '~/.apx/generated/lambda_cloud/metadata'
    ...
    def __init__(self, provider_config: Dict[str, Any],
        ...
        if self.on_head:
            ...
            if os.path.exists(ssh_key_name_path):
                ...
                # At this point, `~/.ssh/apx-key.pub` contains the public
                ...
                # not possible for ~/.ssh/apx-key.pub to already be regenerated
                # by the user.
            ...
            # On local
            self.ssh_key_name = _get_ssh_key_name(
                f'apx-key-{common_utils.get_user_hash()}')
