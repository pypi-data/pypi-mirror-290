...
label_selector = f'apxdeploy-ssh-jump={current_name}'
...
# Accumulated time of where no APX cluster exists. Compared
...
def main():
    sys.stdout.write('APX SSH Jump Pod Lifecycle Manager\n')
