...
# Canonicalized names of all accelerators (except TPUs) supported by APX.
...
# 3. (For APX dev) What to do if I want to add a new accelerator?
#
...
def canonicalize_accelerator_name(accelerator: str,
    ...
    # catalogs (that have new accelerators) without upgrading APX.
