...
To show debug messages, export APXDEPLOY_DEBUG=1 
...
class OCINodeProvider(NodeProvider):
        ...
        if count > 0:
            ...
            vm_tags = {
                **tags,
                ...
                "apx_spot_flag": str(node_config["Preemptible"]).lower(),
            }
    ...
    def terminate_node(self, node_id):
        ...
        logger.debug(f"apx_spot_flag: {node['tags']['apx_spot_flag']}")
        preemptibleFlag = (True if node and
                           (str(node["tags"]["apx_spot_flag"]) == "true") else
                           False)
        ...
        logger.info(
            f"{state_word} {node_id} w/ apx_spot_flag: {preemptibleFlag}.")
