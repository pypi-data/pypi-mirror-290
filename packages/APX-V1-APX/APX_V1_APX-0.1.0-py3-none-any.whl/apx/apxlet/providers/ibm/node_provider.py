...
from apx.apxlet.providers.ibm.utils import RAY_RECYCLABLE, get_logger
...
class IBMVPCNodeProvider(NodeProvider):
    ...
    def _delete_node(self, node_id, node_data=None):
        ...
        if (
            ...
            # if the request is executed by the remote head like in `apx autostop --down`
            # , in contrast to `apx down`, use cloud functions to delete the VPC
