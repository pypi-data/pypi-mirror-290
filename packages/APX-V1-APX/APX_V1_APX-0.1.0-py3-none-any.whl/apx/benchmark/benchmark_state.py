"""Apx benchmark database, backed by sqlite."""
import enum
import os
import pathlib
import pickle
...
if typing.TYPE_CHECKING:
    from apx.backends import backend as backend_lib

_BENCHMARK_BUCKET_NAME_KEY = 'bucket_name'
_BENCHMARK_BUCKET_TYPE_KEY = 'bucket_type'

_BENCHMARK_DB_PATH = os.path.expanduser('~/.apx/benchmark.db')
...
class _BenchmarkSQLiteConn(threading.local):
    ...
    2. Benchmark Config table stores Apx Benchmark configurations
