...
class Azure(clouds.Cloud):
    ...
    _REPR = 'Azure'
    # Azure has a 90 char limit for resource group; however, APX adds the
    ...
    def get_image_size(cls, image_id: str, region: Optional[str]) -> float:
        if region is None:
            ...
            region = 'eastus'
        is_apxdeploy_image_tag = False
        if image_id.startswith('apxdeploy:'):
            is_apxdeploy_image_tag = True
    ...
    def _get_default_image_tag(self, gen_version, instance_type) -> str:
        ...
        if acc is not None:
            ...
            if acc_name == 'K80':
                return 'apxdeploy:k80-ubuntu-2004'
        ...
        if gen_version == 'V1':
            return 'apxdeploy:v1-ubuntu-2004'
        ...
        return 'apxdeploy:gpu-ubuntu-2204'
    ...
    def make_deploy_resources_variables(
        ...
        if (resources.image_id is None or
            ...
            from apx.clouds.service_catalog import azure_catalog
        ...
        cloud_init_setup_commands = textwrap.dedent("""\
            ...
            runcmd:
              ...
              - echo '\\nif [ ! -f "/tmp/__restarted" ]; then\\n  sudo systemctl restart ssh\\n  sleep 2\\n  touch /tmp/__restarted\\nfi' >> /home/apxdeploy:ssh_user/.bashrc
              - usermod -aG docker apxdeploy:ssh_user
            write_files:
    ...
    def check_credentials(cls) -> Tuple[bool, Optional[str]]:
        ...
        try:
            ...
            return False, (
                ...
                f'\n{cls._INDENT_PREFIX}  $ pip install apxdeploy[azure]'
            ...
            try:
                ...
                with ux_utils.print_exception_no_traceback():
                    raise exceptions.CloudUserIdentityError(
                        ...
                        'Please install APX with: '
                        f'{colorama.Style.BRIGHT}pip install apxdeploy[azure]'
