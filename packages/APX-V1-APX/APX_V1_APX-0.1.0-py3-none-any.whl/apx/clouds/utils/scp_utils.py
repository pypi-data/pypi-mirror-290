...
class Metadata:
    ...
    def __init__(self, path_prefix: str, cluster_name: str) -> None:
        ...
        # now since APX uses a per-cluster lock for ray-related
...
class SCPClient:
    ...
    def create_security_group(self, zone_id, vpc, sg_name):
        ...
        request_body = {
            ...
            'vpcId': vpc,
            'securityGroupDescription': 'apxdeploy sg'
        }
    ...
    def add_security_group_in_rule(self, sg_id):
        ...
        request_body = {
            ...
            'ruleDescription': 'apxdeploy ssh rule'
        }
        return self._post(url, request_body)
    ...
    def add_security_group_out_rule(self, sg_id):
        ...
        request_body = {
            ...
            'ruleDescription': 'apxdeploy out rule'
        }
        return self._post(url, request_body)
