...
from apx.clouds.service_catalog.config import fallback_to_default_catalog
from apx.clouds.service_catalog.constants import ALL_CLOUDS
from apx.clouds.service_catalog.constants import CATALOG_DIR
from apx.clouds.service_catalog.constants import CATALOG_SCHEMA_VERSION
from apx.clouds.service_catalog.constants import HOSTED_CATALOG_DIR_URL
from apx.utils import resources_utils

if typing.TYPE_CHECKING:
    from apx.clouds import cloud
    from apx.clouds.service_catalog import common
    ...
    for cloud in clouds:
        try:
            cloud_module = importlib.import_module(
                f'apx.clouds.service_catalog.{cloud.lower()}_catalog')
        except ModuleNotFoundError:
            raise ValueError(
                'Cannot find module "apx.clouds.service_catalog'
...
def list_accelerators(
    ...
    """List the names of all accelerators offered by Apx.

    This will include all accelerators offered by Apx, including those
...
def list_accelerator_counts(
    ...
    """List all accelerators offered by Apx and available counts.
...
def list_accelerator_realtime(
    ...
    """List all accelerators offered by Apx with their realtime availability.
...
def check_accelerator_attachable_to_host(instance_type: str,
    ...
    so apx exec will not execute this function.
    """
