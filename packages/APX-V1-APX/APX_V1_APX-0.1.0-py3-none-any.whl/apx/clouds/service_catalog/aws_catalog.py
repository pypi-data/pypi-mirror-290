...
from apx.clouds.service_catalog import config
from apx.clouds.service_catalog.data_fetchers import fetch_aws
...
# apxdeploy-catalog/.github/workflows/update-aws-catalog.yml
