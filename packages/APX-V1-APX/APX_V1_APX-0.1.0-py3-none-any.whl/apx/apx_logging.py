...
# If the APXDEPLOY_MINIMIZE_LOGGING environment variable is set to True,
...
_root_logger = logging.getLogger('apx')
...
# All code inside the library should use apx_logging.print()
# rather than print().
...
@contextlib.contextmanager
def silent():
    """Make all apx_logging.print() and logger.{info, warning...} silent.
