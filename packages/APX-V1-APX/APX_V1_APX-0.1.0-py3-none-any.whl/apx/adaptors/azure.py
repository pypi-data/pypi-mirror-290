...
from apx import exceptions as apx_exceptions
...
azure = common.LazyImport(
    ...
    import_error_message=('Failed to import dependencies for Azure.'
                          'Try pip install "apxdeploy[azure]"'))
Client = Any
apx_logger = apx_logging.init_logger(__name__)
...
def get_client(name: str,
    ...
    Raises:
        ...
        TimeoutError: If unable to get the container client within the
            specified time.
    """
    # Apx only supports Azure CLI credential for now.
        ...
        if name == 'compute':
            ...
            if storage_account_availability.name_available:
                with ux_utils.print_exception_no_traceback():
                    raise apx_exceptions.NonExistentStorageAccountError(
            ...
            while (time.time() - start_time <
                ...
                try:
                    ...
                    if 'ERROR: AADSTS50020' in str(e):
                        with ux_utils.print_exception_no_traceback():
                            raise apx_exceptions.StorageBucketGetError(
...
def assign_storage_account_iam_role(
    ...
    try:
        ...
        apx_logger.info('Assigned Storage Blob Data Owner role to your '
        ...
        if 'RoleAssignmentExists' in str(e):
            ...
            with ux_utils.print_exception_no_traceback():
                raise apx_exceptions.StorageBucketCreateError(
