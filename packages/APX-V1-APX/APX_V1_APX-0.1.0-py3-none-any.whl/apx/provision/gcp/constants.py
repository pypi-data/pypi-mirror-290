...
APXDEPLOY = 'apxdeploy'
APXDEPLOY_SERVICE_ACCOUNT_ID = APXDEPLOY + '-' + VERSION
APXDEPLOY_SERVICE_ACCOUNT_EMAIL_TEMPLATE = (
    '{account_id}@{project_id}.iam.gserviceaccount.com')
APXDEPLOY_SERVICE_ACCOUNT_CONFIG = {
    'displayName': f'APX Service Account ({VERSION})',
}
...
APXDEPLOY_VPC_NAME = 'apxdeploy-vpc'
...
# Required firewall rules for APX to work.
FIREWALL_RULES_REQUIRED = [
    ...
    # Allow ssh connection from anywhere.
    {
        ...
        # TODO(apxdeploy): some users reported that this should be relaxed (e.g.,
...
# A list of permissions required to run APX on GCP.
# Keep this in sync with https://apxdeploy.readthedocs.io/en/latest/cloud-setup/cloud-permissions/gcp.html # pylint: disable=line-too-long
VM_MINIMAL_PERMISSIONS = [
    ...
    # Check: apx.provision.gcp.config::_is_permission_satisfied
...
MIG_NAME_PREFIX = 'apx-mig-'
INSTANCE_TEMPLATE_NAME_PREFIX = 'apx-it-'
