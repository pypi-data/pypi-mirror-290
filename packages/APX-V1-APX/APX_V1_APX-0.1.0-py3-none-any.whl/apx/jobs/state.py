...
_DB_PATH = pathlib.Path('~/.apx/spot_jobs.db')
...
# e.g., via apx jobs queue. These may not correspond to actual
...
class ManagedJobStatus(enum.Enum):
    ...
    # script.
    FAILED_SETUP = 'FAILED_SETUP'
    # FAILED_PRECHECKS: the underlying `apx.launch` fails due to precheck
...
def set_submitted(job_id: int, task_id: int, run_timestamp: str,
    ...
    """
    # Use the timestamp in the `run_timestamp` ('apx-2022-10...'), to make
