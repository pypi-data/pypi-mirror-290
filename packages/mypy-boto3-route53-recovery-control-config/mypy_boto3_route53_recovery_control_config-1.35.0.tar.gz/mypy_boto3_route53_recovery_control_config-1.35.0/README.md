...
[boto3.Route53RecoveryControlConfig 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/route53-recovery-control-config.html#Route53RecoveryControlConfig)
...
- Install `boto3-stubs[route53-recovery-control-config]` in your environment:
...
Install `boto3-stubs-lite[route53-recovery-control-config]` in your
environment:
...
- Install `boto3-stubs[route53-recovery-control-config]` with services you use
  in your environment:
...
`mypy_boto3_route53_recovery_control_config.paginator` module contains type
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_route53_recovery_control_config/literals/).
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_route53_recovery_control_config/type_defs/).
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_route53_recovery_control_config/)
