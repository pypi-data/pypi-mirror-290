...
class Postgres(object):
    ...
    def create_table(self, engine = None, schema = None, tableName = None, fieldNames = None):
        ...
        try:
            ...
            print(f"Table {tableName} either did not exist or could not be dropped!")
        ...
        try:
            ...
            print(err)
            print(f"Table {tableName} could not be created!")
            sys.exit()
    ...
    def insert(self, tableName = None, table = None, values = None):
        ...
        if not tableName:
            print(f"{tableName} is not provided! Skipping...")
