...
class Parser(object):
    ...
    def insert_rows(self, database = None, tableName = None, filePath = filePath, commitSize = 1000):
        ...
        logger.info(f"Inserting rows into tabble {tableName}...")
        ...
        with open(filePath, "r", newline="", encoding="utf-8") as csvfile:
            ...
            for _row in _reader:               
                ...
                if _counter == 1:
                    ...
                    logger.info(f"commit {_commitCount}: {commitSize} rows have been commited")
            ...
            if not _counter == 1:
                ...
                logger.info(f"commit {_commitCount}: {commitSize - _counter} rows have been commited")
