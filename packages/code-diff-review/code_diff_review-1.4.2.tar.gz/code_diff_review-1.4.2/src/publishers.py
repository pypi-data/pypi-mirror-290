...
class GitIssuePublisher(Publisher):
    ...
    def generate_report(self, data):
        report = [
            ...
            "| **Commit Hash** | **Author** | **Provided Message** | **Generated Message** | **Adherence Score** |",
            "|-----------------|------------|----------------------|-----------------------|---------------------|",
            f"| {self.sha} | {self.user} | '{data['message']['provided']}' | '{data['message']['generated']}' | {data['message']['adherence']['score']} {data['message']['adherence']['emoji']} |",
