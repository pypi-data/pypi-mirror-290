...
[boto3.DAX 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/dax.html#DAX)
...
- Install `boto3-stubs[dax]` in your environment:
...
Install `boto3-stubs-lite[dax]` in your environment:
...
- Install `boto3-stubs[dax]` with services you use in your environment:
...
describe_default_parameters_paginator: DescribeDefaultParametersPaginator = client.get_paginator(
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_dax/literals/).
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_dax/type_defs/).
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_dax/)
