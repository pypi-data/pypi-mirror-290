...
def create_feature_set_frames_v2(current_index, directory_name, feature_images_urls, device): 
    ...
    current_index = add_images_in_frameset_v2(blended_roi_img_url_dict, background, directory_name, current_index,12, 0.1, device) 

    current_index = add_images_in_frameset_v2(blended_roi_img_url_dict, background, directory_name, current_index,12, 0.5, device) 
