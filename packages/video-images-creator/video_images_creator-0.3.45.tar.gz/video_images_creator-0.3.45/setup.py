...
setup(
    ...
    package_dir={"": "src"},
    package_data={"video_images_creator": ["*.ttf", "video-music.wav", "instantvideoaudio.wav", "audionew.wav", "thanks.wav", "background_music.wav", "intro_outro_v6.mp4", '*.jpg', '*.jpeg', '*.png']},
