...
class PermissionApiServicer(object):
    ...
    def get(self, request, context):
        """
        Checks Permissions for the specified users (or autenticated user) to the specified resources.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
    ...
    def list(self, request, context):
        """
        Lists Permissions for the specified users (or autneticated user) to the specified resources.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
