...
from PyQt5.QtCore import (
    Qt, QObject, pyqtSignal, pyqtSlot, QAbstractProxyModel, QAbstractItemModel, QModelIndex
)
...
class AbstractPlotWindow(QWidget):
    ...
    def __init__(self, plot_model: PlotModel, plot_widget: AbstractPlotWidget):
        ...
        self.autorange_button.clicked.connect(self.plot_widget.plotItem.getViewBox().autoRange)
