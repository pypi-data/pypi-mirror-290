...
This module contains miscellaneous utils methods:
    * get_nearest - get index and value of closest value in array to target
        value
    * get_neighbors_idx - get positions (indices) of neighbors of a target
        position in an array
    * get_rectangle - give list of indices of array positions included in
        the rectangle defined by two opposing corners selected by user
