...
class MainWindow (QMainWindow ):
    ...
    def update_single_plot (self ,file_path ):
        ...
        canvas =self .plot_layout .itemAt (index ).widget ()
        ...
        if plot_data .settings ['calculate_avg']and plot_data .settings ['avg_window_size']>0 :
            rolling_avg =calculate_rolling_stats (plot_data .data ,plot_data .sampling_rate ,plot_data .settings ['avg_window_size'])
    ...
    def plot_data (self ,ax ,plot_data ):
        ...
        ax .plot (plot_data .time [::nth_element ],plot_data .data [::nth_element ],linewidth =0.5 )
