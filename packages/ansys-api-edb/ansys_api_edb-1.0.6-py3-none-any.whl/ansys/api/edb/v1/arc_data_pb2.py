...
_ROTATIONDIRECTION = DESCRIPTOR.enum_types_by_name['RotationDirection']
RotationDirection = enum_type_wrapper.EnumTypeWrapper(_ROTATIONDIRECTION)
ROTATION_DIRECTION_CCW = 0
ROTATION_DIRECTION_CW = 1
ROTATION_DIRECTION_COLINEAR = 2


_ARCMESSAGE = DESCRIPTOR.message_types_by_name['ArcMessage']
_ARCMESSAGE_RADIUSMESSAGE = _ARCMESSAGE.nested_types_by_name['RadiusMessage']
_ARCMESSAGE_CENTERMESSAGE = _ARCMESSAGE.nested_types_by_name['CenterMessage']
_ARCDATATWOARCSMESSAGE = DESCRIPTOR.message_types_by_name['ArcDataTwoArcsMessage']
_ARCSMESSAGE = DESCRIPTOR.message_types_by_name['ArcsMessage']
ArcMessage = _reflection.GeneratedProtocolMessageType('ArcMessage', (_message.Message,), {

  'RadiusMessage' : _reflection.GeneratedProtocolMessageType('RadiusMessage', (_message.Message,), {
    'DESCRIPTOR' : _ARCMESSAGE_RADIUSMESSAGE,
    '__module__' : 'ansys.api.edb.v1.arc_data_pb2'
    # @@protoc_insertion_point(class_scope:ansys.api.edb.v1.ArcMessage.RadiusMessage)
    })
  ,

  'CenterMessage' : _reflection.GeneratedProtocolMessageType('CenterMessage', (_message.Message,), {
    'DESCRIPTOR' : _ARCMESSAGE_CENTERMESSAGE,
    '__module__' : 'ansys.api.edb.v1.arc_data_pb2'
    # @@protoc_insertion_point(class_scope:ansys.api.edb.v1.ArcMessage.CenterMessage)
    })
  ,
  'DESCRIPTOR' : _ARCMESSAGE,
  '__module__' : 'ansys.api.edb.v1.arc_data_pb2'
  # @@protoc_insertion_point(class_scope:ansys.api.edb.v1.ArcMessage)
  })
_sym_db.RegisterMessage(ArcMessage)
_sym_db.RegisterMessage(ArcMessage.RadiusMessage)
_sym_db.RegisterMessage(ArcMessage.CenterMessage)

ArcDataTwoArcsMessage = _reflection.GeneratedProtocolMessageType('ArcDataTwoArcsMessage', (_message.Message,), {
  'DESCRIPTOR' : _ARCDATATWOARCSMESSAGE,
  '__module__' : 'ansys.api.edb.v1.arc_data_pb2'
  # @@protoc_insertion_point(class_scope:ansys.api.edb.v1.ArcDataTwoArcsMessage)
  })
_sym_db.RegisterMessage(ArcDataTwoArcsMessage)

ArcsMessage = _reflection.GeneratedProtocolMessageType('ArcsMessage', (_message.Message,), {
  'DESCRIPTOR' : _ARCSMESSAGE,
  '__module__' : 'ansys.api.edb.v1.arc_data_pb2'
  # @@protoc_insertion_point(class_scope:ansys.api.edb.v1.ArcsMessage)
  })
_sym_db.RegisterMessage(ArcsMessage)

_ARCDATASERVICE = DESCRIPTOR.services_by_name['ArcDataService']
