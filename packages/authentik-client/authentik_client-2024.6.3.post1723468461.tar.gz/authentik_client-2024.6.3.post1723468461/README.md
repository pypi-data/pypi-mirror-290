...
- Package version: 2024.6.3-1723468461
...
```sh
pip install git+https://github.com/goauthentik/authentik.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/goauthentik/authentik.git`)
...
*OutpostsApi* | [**outposts_radius_check_access_retrieve**](docs/OutpostsApi.md#outposts_radius_check_access_retrieve) | **GET** /outposts/radius/{id}/check_access/ | 
