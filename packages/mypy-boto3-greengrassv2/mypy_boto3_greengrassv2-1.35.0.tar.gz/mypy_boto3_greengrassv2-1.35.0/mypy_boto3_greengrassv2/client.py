...
class GreengrassV2Client(BaseClient):
    ...
    def delete_component(self, *, arn: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_core_device(self, *, coreDeviceThingName: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_deployment(self, *, deploymentId: str) -> EmptyResponseMetadataTypeDef:
        """
