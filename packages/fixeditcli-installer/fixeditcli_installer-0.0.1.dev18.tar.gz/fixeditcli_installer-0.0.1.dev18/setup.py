...
class install_wrapper(_install):
    ...
    def _install_fixeditcli(self):
        try:
            from src.modules.installer import install_fixeditcli, update_config, decode_token, read_version, get_fixedit_token
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'fixeditcli-install=src.modules.installer:main'
        ]
    },
