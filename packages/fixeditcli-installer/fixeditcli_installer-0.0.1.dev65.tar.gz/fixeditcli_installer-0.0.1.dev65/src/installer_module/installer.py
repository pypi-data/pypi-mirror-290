...
def read_version():
    """Read the FixedIT CLI version from the version text file or
    ...
    try:
        try:
            version = files('src.installer_module').joinpath('data/version.txt').read_text()
        except ModuleNotFoundError:
            version = files('installer_module').joinpath('data/version.txt').read_text()
