...
python_image = KernelImageConfig(
    ...
    image="gcr.io/vorvan/h2oai/notebookkernel-py:latest-snapshot",
...
python_minimal_image = KernelImageConfig(
    ...
    kernel_image_type=KernelImageType.TYPE_PYTHON,
    image="gcr.io/vorvan/h2oai/notebookkernel-py311minimal:latest-snapshot",
    display_name="Python",
    disabled=False,
)
...
r_image = KernelImageConfig(
    ...
    image="gcr.io/vorvan/h2oai/notebookkernel-r:latest-snapshot",
    display_name="R",
    disabled=False,
)
...
python_spark_image = KernelImageConfig(
    ...
    image="gcr.io/vorvan/h2oai/notebookkernel-pyspark:latest-snapshot",
...
r_spark_image = KernelImageConfig(
    ...
    image="gcr.io/vorvan/h2oai/notebookkernel-sparkr:latest-snapshot",
