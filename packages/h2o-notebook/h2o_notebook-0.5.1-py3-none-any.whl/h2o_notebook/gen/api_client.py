...
from h2o_notebook.gen import rest
from h2o_notebook.gen.configuration import Configuration
from h2o_notebook.gen.exceptions import ApiTypeError, ApiValueError, ApiException
from h2o_notebook.gen.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = KernelImageServiceApi()
        api_instance.kernel_image_service_create_kernel_image  # this is an instance of the class Endpoint
        api_instance.kernel_image_service_create_kernel_image()  # this invokes api_instance.kernel_image_service_create_kernel_image.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.kernel_image_service_create_kernel_image.callable or self.callable in this class
