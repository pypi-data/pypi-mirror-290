...
void bind_Pythia8_PartonLevel(std::function< pybind11::module &(std::string const &namespace_) > &M);
...
PYBIND11_MODULE(pythia8mc, root_module) {
	...
	bind_Pythia8_SpaceShower(M);
	bind_Pythia8_PartonLevel(M);
