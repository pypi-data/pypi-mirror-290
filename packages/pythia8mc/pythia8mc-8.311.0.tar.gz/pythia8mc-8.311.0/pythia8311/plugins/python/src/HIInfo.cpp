...
// Pythia8::HIUserHooks file:Pythia8/HIInfo.h line:248
...
// Pythia8::Angantyr file:Pythia8/HeavyIons.h line:154
...
void bind_Pythia8_HIInfo(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // Pythia8::Angantyr file:Pythia8/HeavyIons.h line:154
		...
		cl.def("banner", (void (Pythia8::Angantyr::*)(int, int) const) &Pythia8::Angantyr::banner, "C++: Pythia8::Angantyr::banner(int, int) const --> void", pybind11::arg("idProj"), pybind11::arg("idTarg"));
