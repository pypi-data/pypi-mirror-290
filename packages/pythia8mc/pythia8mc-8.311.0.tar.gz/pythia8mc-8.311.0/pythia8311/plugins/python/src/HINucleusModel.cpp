...
// Pythia8::HardCoreModel file:Pythia8/HINucleusModel.h line:293
...
// Pythia8::WoodsSaxonModel file:Pythia8/HINucleusModel.h line:330
...
// Pythia8::GLISSANDOModel file:Pythia8/HINucleusModel.h line:384
...
// Pythia8::HOShellModel file:Pythia8/HINucleusModel.h line:403
...
// Pythia8::HulthenModel file:Pythia8/HINucleusModel.h line:450
...
// Pythia8::GaussianModel file:Pythia8/HINucleusModel.h line:484
...
// Pythia8::ClusterModel file:Pythia8/HINucleusModel.h line:515
...
// Pythia8::SubCollisionModel file:Pythia8/HISubCollisionModel.h line:121
...
void bind_Pythia8_HINucleusModel(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // Pythia8::SubCollisionSet file:Pythia8/HISubCollisionModel.h line:84
		...
		cl.def("T", (double (Pythia8::SubCollisionSet::*)() const) &Pythia8::SubCollisionSet::T, "C++: Pythia8::SubCollisionSet::T() const --> double");
	...
	{ // Pythia8::SubCollisionModel file:Pythia8/HISubCollisionModel.h line:121
		...
		{ // Pythia8::SubCollisionModel::SigEst file:Pythia8/HISubCollisionModel.h line:126
		...
		cl.def_readwrite("subCollParms", &Pythia8::SubCollisionModel::subCollParms);
		...
		cl.def("evolve", (bool (Pythia8::SubCollisionModel::*)(int, double)) &Pythia8::SubCollisionModel::evolve, "C++: Pythia8::SubCollisionModel::evolve(int, double) --> bool", pybind11::arg("nGenerations"), pybind11::arg("eCM"));
