...
def find_papers(keyword="", doi="", title="", author="", number_of_papers=100):
    cr = Crossref()
    if keyword!="":
        papers = cr.works(query=keyword, limit=number_of_papers)
    elif doi!="":
        papers = cr.works(ids=doi, limit=number_of_papers)
    elif title!="":
        papers = cr.works(query=title, limit=number_of_papers)
    elif author!="":
        papers = cr.works(query=author, limit=number_of_papers)
    else:
