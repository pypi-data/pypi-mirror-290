...
NODE_MAIN_IMAGE_FILENAME = 'aos-vm-main-genericx86-64.wic.vmdk'
NODE_SECONDARY1_IMAGE_FILENAME = 'aos-vm-secondary-1-genericx86-64.wic.vmdk'
NODE_SECONDARY2_IMAGE_FILENAME = 'aos-vm-secondary-2-genericx86-64.wic.vmdk'
NODE_SECONDARY3_IMAGE_FILENAME = 'aos-vm-secondary-3-genericx86-64.wic.vmdk'


DYNAMIC_NODES = {  # noqa: WPS407
    1: NODE_SECONDARY1_IMAGE_FILENAME,
    2: NODE_SECONDARY2_IMAGE_FILENAME,
    3: NODE_SECONDARY3_IMAGE_FILENAME,
}

DISK_IMAGE_DOWNLOAD_URL = 'https://d2aa62nq4kg5j3.cloudfront.net/5.0.0.beta2.tar.gz'
REQUEST_TIMEOUT = 30
