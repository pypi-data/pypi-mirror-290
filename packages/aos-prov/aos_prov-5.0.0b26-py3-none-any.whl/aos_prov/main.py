...
def _parse_args():  # noqa: WPS213
    ...
    parser.add_argument(
        ...
        required=False,
        type=int,
        help='Count of nodes for the Unit.',
        default=2,
    )
    ...
    add_unit_node_command = sub_parser.add_parser(
        ...
        help='Add dynamical node to already presented VirtualBox-based unit',
    )
    ...
    add_unit_node_command.add_argument(
        ...
        '--headless',
        action='store_true',
        help='Start Node of VM in headless mode.',
    )
...
def main():
    ...
    try:  # noqa: WPS225
        ...
        if args.which == _COMMAND_NEW_VM:
            ...
            create_new_unit(args.name, user_creds, disk, nodes_count=args.nodes)
