...
from aos_prov.utils.common import (
    ...
    NODE_SECONDARY1_IMAGE_FILENAME,
    NODE_SECONDARY2_IMAGE_FILENAME,
    NODE_SECONDARY3_IMAGE_FILENAME,
    REQUEST_TIMEOUT,
)
...
def download_and_save_multinode(
    ...
    Args:
         ...
         rename_images (bool): Rename old versions of images to new one
    ...
    old_node_files = [
        save_path / 'aos-vm-node0-genericx86-64.wic.vmdk',
        save_path / 'aos-vm-node1-genericx86-64.wic.vmdk',
        save_path / 'aos-vm-node2-genericx86-64.wic.vmdk',
        save_path / 'aos-vm-node3-genericx86-64.wic.vmdk',
    ]

    node_files = [
        save_path / NODE_MAIN_IMAGE_FILENAME,
        save_path / NODE_SECONDARY1_IMAGE_FILENAME,
        save_path / NODE_SECONDARY2_IMAGE_FILENAME,
        save_path / NODE_SECONDARY3_IMAGE_FILENAME,
    ]
    ...
    # TODO: remove after updating names of images into archive
    # rename node like to main/secondary style
    if rename_images:
        index = 0
        for node_file in node_files:
            os.rename(old_node_files[index], node_file)
            index += 1
