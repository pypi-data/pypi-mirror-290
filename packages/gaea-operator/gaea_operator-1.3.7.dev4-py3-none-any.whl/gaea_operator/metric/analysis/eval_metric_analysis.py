...
class EvalMetricAnalysis(object):
    ...
    def _format_to_text_detection_result(self, metric_result: Dict):
        accuracy_metric = HarmonicMeanMetric(result=metric_result[PrecisionRecallHmean.global_name()][2])
        ...
        metric = TextDetectionMetric(metrics=[precision_metric, recall_metric, accuracy_metric])
