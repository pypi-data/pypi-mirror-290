...
__all__ = (
    ...
    "PostLaunchActionsExtraOutputTypeDef",
...
SsmDocumentExtraOutputTypeDef = TypedDict(
    "SsmDocumentExtraOutputTypeDef",
    {
        "actionName": str,
        "ssmDocumentName": str,
...
PostLaunchActionsExtraOutputTypeDef = TypedDict(
    "PostLaunchActionsExtraOutputTypeDef",
    {
        "cloudWatchLogGroupName": NotRequired[str],
        ...
        "ssmDocuments": NotRequired[List[SsmDocumentExtraOutputTypeDef]],
    },
)
...
PostLaunchActionsUnionTypeDef = Union[PostLaunchActionsTypeDef, PostLaunchActionsExtraOutputTypeDef]
