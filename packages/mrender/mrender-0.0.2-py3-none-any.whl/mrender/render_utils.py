...
def get_relative_path(obj: Union[type, Callable, object]) -> str:
    ...
    try:
        ...
        file_path = os.path.relpath(inspect.getfile(module))
        return file_path
    except ValueError:
        return "Unknown location"
...
def generate_docs(obj: Union[type, Callable, object]) -> str:
    """
