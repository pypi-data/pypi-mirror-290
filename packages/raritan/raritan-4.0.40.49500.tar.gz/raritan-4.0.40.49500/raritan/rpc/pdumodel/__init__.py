...
# interface
class Pdu(Interface):
    idlType = "pdumodel.Pdu:6.2.2"

    ERR_INVALID_PARAM = 1

    # enumeration
    class PduOrientation(Enumeration):
        idlType = "pdumodel.Pdu_6_2_2.PduOrientation:1.0.0"
    ...
    # structure
    class MetaData(Structure):
        idlType = "pdumodel.Pdu_6_2_2.MetaData:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.Pdu_6_2_2.Sensors:1.0.0"
    ...
    class Statistic(Structure):
        idlType = "pdumodel.Pdu_6_2_2.Statistic:1.0.0"
    ...
    # enumeration
    class StartupState(Enumeration):
        idlType = "pdumodel.Pdu_6_2_2.StartupState:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.Pdu_6_2_2.Settings:1.0.0"
    ...
    class OutletSequenceState(Structure):
        idlType = "pdumodel.Pdu_6_2_2.OutletSequenceState:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Pdu_6_2_2.SettingsChangedEvent:1.0.0"
    ...
    class LoadSheddingModeChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Pdu_6_2_2.LoadSheddingModeChangedEvent:1.0.0"
    ...
    class OutletSequenceStateChangedEvent(raritan.rpc.idl.Event):
        idlType = "pdumodel.Pdu_6_2_2.OutletSequenceStateChangedEvent:1.0.0"
