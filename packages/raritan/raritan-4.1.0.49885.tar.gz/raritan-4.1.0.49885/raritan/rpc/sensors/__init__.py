...
class Sensor(Interface):
    ...
    class OnOffState(Enumeration):
        idlType = "sensors.Sensor_4_0_6.OnOffState:1.0.0"
        values = ["OFF", "ON"]
    ...
    class OpenClosedState(Enumeration):
        idlType = "sensors.Sensor_4_0_6.OpenClosedState:1.0.0"
        values = ["OPEN", "CLOSED"]
    ...
    class NormalAlarmedState(Enumeration):
        idlType = "sensors.Sensor_4_0_6.NormalAlarmedState:1.0.0"
    ...
    class OkFaultState(Enumeration):
        idlType = "sensors.Sensor_4_0_6.OkFaultState:1.0.0"
        values = ["OK", "FAULT"]
    ...
    class TypeSpec(Structure):
        idlType = "sensors.Sensor_4_0_6.TypeSpec:1.0.0"
    ...
    class TypeSpecChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.Sensor_4_0_6.TypeSpecChangedEvent:1.0.0"
...
class NumericSensor(Sensor):
    idlType = "sensors.NumericSensor:4.0.7"
    ...
    class Range(Structure):
        idlType = "sensors.NumericSensor_4_0_7.Range:1.0.0"
    ...
    class ThresholdCapabilities(Structure):
        idlType = "sensors.NumericSensor_4_0_7.ThresholdCapabilities:1.0.0"
    ...
    class MetaData(Structure):
        idlType = "sensors.NumericSensor_4_0_7.MetaData:1.0.0"
    ...
    class Thresholds(Structure):
        idlType = "sensors.NumericSensor_4_0_7.Thresholds:1.0.0"
    ...
    class Reading(Structure):
        idlType = "sensors.NumericSensor_4_0_7.Reading:1.0.0"
        ...
        class Status(Structure):
            idlType = "sensors.NumericSensor_4_0_7.Reading.Status:1.0.0"
    ...
    class MinMax(Structure):
        idlType = "sensors.NumericSensor_4_0_7.MinMax:1.0.0"
    ...
    class ReadingChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.NumericSensor_4_0_7.ReadingChangedEvent:1.0.0"
    ...
    class StateChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.NumericSensor_4_0_7.StateChangedEvent:1.0.0"
    ...
    class MetaDataChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.NumericSensor_4_0_7.MetaDataChangedEvent:1.0.0"
    ...
    class DefaultThresholdsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.NumericSensor_4_0_7.DefaultThresholdsChangedEvent:1.0.0"
    ...
    class ThresholdsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.NumericSensor_4_0_7.ThresholdsChangedEvent:1.0.0"
    ...
    class MinMaxChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.NumericSensor_4_0_7.MinMaxChangedEvent:1.0.0"
    ...
    class MinMaxResetEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.NumericSensor_4_0_7.MinMaxResetEvent:1.0.0"
...
class AccumulatingNumericSensor(NumericSensor):
    idlType = "sensors.AccumulatingNumericSensor:2.0.7"

    # value object
    class ResetEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.AccumulatingNumericSensor_2_0_7.ResetEvent:1.0.0"
...
class AlertedSensorManager(Interface):
    idlType = "sensors.AlertedSensorManager:1.0.4"

    # enumeration
    class AlertState(Enumeration):
        idlType = "sensors.AlertedSensorManager_1_0_4.AlertState:1.0.0"
    ...
    class SensorCounts(Structure):
        idlType = "sensors.AlertedSensorManager_1_0_4.SensorCounts:1.0.0"
    ...
    class SensorData(Structure):
        idlType = "sensors.AlertedSensorManager_1_0_4.SensorData:1.0.0"
    ...
    class MonitoredSensorsChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.AlertedSensorManager_1_0_4.MonitoredSensorsChangedEvent:1.0.0"
    ...
    class AlertedSensorsChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.AlertedSensorManager_1_0_4.AlertedSensorsChangedEvent:1.0.0"
...
class StateSensor(Sensor):
    idlType = "sensors.StateSensor:4.0.6"

    # structure
    class State(Structure):
        idlType = "sensors.StateSensor_4_0_6.State:1.0.0"
    ...
    # value object
    class StateChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.StateSensor_4_0_6.StateChangedEvent:1.0.0"
...
class Logger(Interface):
    idlType = "sensors.Logger:3.1.2"

    # structure
    class Info(Structure):
        idlType = "sensors.Logger_3_1_2.Info:1.0.0"
    ...
    class Settings(Structure):
        idlType = "sensors.Logger_3_1_2.Settings:1.0.0"
    ...
    class SensorSet(Structure):
        idlType = "sensors.Logger_3_1_2.SensorSet:1.0.0"
    ...
    class InfoChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.Logger_3_1_2.InfoChangedEvent:1.0.0"
    ...
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.Logger_3_1_2.SettingsChangedEvent:1.0.0"
    ...
    class LoggedSensorsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.Logger_3_1_2.LoggedSensorsChangedEvent:1.0.0"
    ...
    class Record(Structure):
        idlType = "sensors.Logger_3_1_2.Record:1.0.0"
    ...
    class TimedRecord(Structure):
        idlType = "sensors.Logger_3_1_2.TimedRecord:1.0.0"
    ...
    class LogRow(Structure):
        idlType = "sensors.Logger_3_1_2.LogRow:1.0.0"
...
class Switch(StateSensor):
    ...
    class SwitchEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.Switch_2_0_8.SwitchEvent:1.0.0"
