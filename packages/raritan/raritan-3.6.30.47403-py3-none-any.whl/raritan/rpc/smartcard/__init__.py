...
class CardReader(Interface):
    idlType = "smartcard.CardReader:1.0.3"
    ...
    class MetaData(Structure):
        idlType = "smartcard.CardReader_1_0_3.MetaData:1.0.0"
    ...
    class CardInformation(Structure):
        idlType = "smartcard.CardReader_1_0_3.CardInformation:1.0.0"
        elements = ["type", "uid"]
    ...
    class CardEvent(raritan.rpc.idl.Event):
        idlType = "smartcard.CardReader_1_0_3.CardEvent:1.0.0"
    ...
    class CardInsertedEvent(CardEvent):
        idlType = "smartcard.CardReader_1_0_3.CardInsertedEvent:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                # for smartcard.CardReader_1_0_3.CardEvent
                cardInfo = raritan.rpc.smartcard.CardReader.CardInformation.decode(json['cardInfo'], agent),
                # for idl.Event
                source = Interface.decode(json['source'], agent),
            )
    ...
    class CardRemovedEvent(CardEvent):
        idlType = "smartcard.CardReader_1_0_3.CardRemovedEvent:1.0.0"
...
class CardReaderManager(Interface):
    idlType = "smartcard.CardReaderManager:1.0.3"

    # structure
    class CardReaderSettings(Structure):
        idlType = "smartcard.CardReaderManager_1_0_3.CardReaderSettings:1.0.0"
    ...
    class CardReaderEvent(raritan.rpc.idl.Event):
        idlType = "smartcard.CardReaderManager_1_0_3.CardReaderEvent:1.0.0"
    ...
    class CardReaderAttachedEvent(CardReaderEvent):
        idlType = "smartcard.CardReaderManager_1_0_3.CardReaderAttachedEvent:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                # for smartcard.CardReaderManager_1_0_3.CardReaderEvent
                cardReader = Interface.decode(json['cardReader'], agent),
                # for idl.Event
                source = Interface.decode(json['source'], agent),
            )
    ...
    class CardReaderDetachedEvent(CardReaderEvent):
        idlType = "smartcard.CardReaderManager_1_0_3.CardReaderDetachedEvent:1.0.0"
    ...
    class CardReaderSettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "smartcard.CardReaderManager_1_0_3.CardReaderSettingsChangedEvent:1.0.0"
