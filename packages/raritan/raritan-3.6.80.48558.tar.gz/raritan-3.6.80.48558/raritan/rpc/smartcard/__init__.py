...
class CardReaderManager(Interface):
    idlType = "smartcard.CardReaderManager:1.0.4"

    # structure
    class CardReaderSettings(Structure):
        idlType = "smartcard.CardReaderManager_1_0_4.CardReaderSettings:1.0.0"
    ...
    class CardReaderEvent(raritan.rpc.idl.Event):
        idlType = "smartcard.CardReaderManager_1_0_4.CardReaderEvent:1.0.0"
    ...
    class CardReaderAttachedEvent(CardReaderEvent):
        idlType = "smartcard.CardReaderManager_1_0_4.CardReaderAttachedEvent:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                # for smartcard.CardReaderManager_1_0_4.CardReaderEvent
                cardReader = Interface.decode(json['cardReader'], agent),
                # for idl.Event
                source = Interface.decode(json['source'], agent),
            )
    ...
    class CardReaderDetachedEvent(CardReaderEvent):
        idlType = "smartcard.CardReaderManager_1_0_4.CardReaderDetachedEvent:1.0.0"
    ...
    class CardReaderSettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "smartcard.CardReaderManager_1_0_4.CardReaderSettingsChangedEvent:1.0.0"
