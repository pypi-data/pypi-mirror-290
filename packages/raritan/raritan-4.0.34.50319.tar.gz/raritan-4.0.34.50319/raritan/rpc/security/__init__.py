...
class BlockSettings(Structure):
    ...
    def __init__(self, maxFailedLogins, blockTimeout, failedLoginTimeout):
    ...
    def decode(cls, json, agent):
        obj = cls(
            maxFailedLogins = json['maxFailedLogins'],
            blockTimeout = json['blockTimeout'],
            failedLoginTimeout = json['failedLoginTimeout'],
        )
        return obj
...
class Security(Interface):
    idlType = "security.Security:5.0.0"
    ...
    class _getBlockSettings(Interface.Method):
        ...
        @staticmethod
        def decode(rsp, agent):
            _ret_ = raritan.rpc.security.BlockSettings.decode(rsp['_ret_'], agent)
    ...
    class _getTpmInfo(Interface.Method):
        ...
        @staticmethod
        def decode(rsp, agent):
            _ret_ = raritan.rpc.security.TpmInfo.decode(rsp['_ret_'], agent)
