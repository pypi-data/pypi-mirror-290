...
# interface
class Emd(Interface):
    idlType = "emdmodel.Emd:2.3.9"

    ERR_INVALID_PARAMS = 1

    # structure
    class MetaData(Structure):
        idlType = "emdmodel.Emd_2_3_9.MetaData:1.0.0"
    ...
    class Settings(Structure):
        idlType = "emdmodel.Emd_2_3_9.Settings:1.0.0"
        elements = ["name"]
    ...
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "emdmodel.Emd_2_3_9.SettingsChangedEvent:1.0.0"
