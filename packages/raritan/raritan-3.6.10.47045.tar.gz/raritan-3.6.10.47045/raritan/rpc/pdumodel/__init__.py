...
class PowerMeter(Interface):
    idlType = "pdumodel.PowerMeter:1.1.6"
    ...
    # enumeration
    class Type(Enumeration):
        idlType = "pdumodel.PowerMeter_1_1_6.Type:1.0.0"
    ...
    class Config(Structure):
        idlType = "pdumodel.PowerMeter_1_1_6.Config:1.0.0"
    ...
    class Sensors(Structure):
        idlType = "pdumodel.PowerMeter_1_1_6.Sensors:1.0.0"
    ...
    class Settings(Structure):
        idlType = "pdumodel.PowerMeter_1_1_6.Settings:1.0.0"
    ...
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.PowerMeter_1_1_6.SettingsChangedEvent:1.0.0"
    ...
    class EnergyPulseSettings(Structure):
        idlType = "pdumodel.PowerMeter_1_1_6.EnergyPulseSettings:1.0.0"
    ...
    class EnergyPulseSettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.PowerMeter_1_1_6.EnergyPulseSettingsChangedEvent:1.0.0"
...
class Circuit(Interface):
    idlType = "pdumodel.Circuit:1.0.4"
    ...
    # enumeration
    class Type(Enumeration):
        idlType = "pdumodel.Circuit_1_0_4.Type:1.0.0"
    ...
    # structure
    class Config(Structure):
        idlType = "pdumodel.Circuit_1_0_4.Config:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.Circuit_1_0_4.Sensors:1.0.0"
    ...
    class PoleSettings(Structure):
        idlType = "pdumodel.Circuit_1_0_4.PoleSettings:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.Circuit_1_0_4.Settings:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Circuit_1_0_4.SettingsChangedEvent:1.0.0"
...
class Panel(PowerMeter):
    idlType = "pdumodel.Panel:1.1.6"

    # enumeration
    class LabelingScheme(Enumeration):
        idlType = "pdumodel.Panel_1_1_6.LabelingScheme:1.0.0"
    ...
    class PanelSettings(Structure):
        idlType = "pdumodel.Panel_1_1_6.PanelSettings:1.0.0"
    ...
    class PanelSettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Panel_1_1_6.PanelSettingsChangedEvent:1.0.0"
    ...
    class CircuitCreatedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Panel_1_1_6.CircuitCreatedEvent:1.0.0"
    ...
    class CircuitDeletedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Panel_1_1_6.CircuitDeletedEvent:1.0.0"
...
# interface
class Inlet(EDevice):
    idlType = "pdumodel.Inlet:2.0.5"

    # structure
    class MetaData(Structure):
        idlType = "pdumodel.Inlet_2_0_5.MetaData:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.Inlet_2_0_5.Sensors:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.Inlet_2_0_5.Settings:1.0.0"
        elements = ["name"]
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Inlet_2_0_5.SettingsChangedEvent:1.0.0"
    ...
    class EnableStateChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Inlet_2_0_5.EnableStateChangedEvent:1.0.0"
...
class OverCurrentProtector(EDevice):
    idlType = "pdumodel.OverCurrentProtector:3.0.5"

    # enumeration
    class Type(Enumeration):
        idlType = "pdumodel.OverCurrentProtector_3_0_5.Type:1.0.0"
    ...
    # structure
    class MetaData(Structure):
        idlType = "pdumodel.OverCurrentProtector_3_0_5.MetaData:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.OverCurrentProtector_3_0_5.Sensors:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.OverCurrentProtector_3_0_5.Settings:1.0.0"
        elements = ["name"]
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OverCurrentProtector_3_0_5.SettingsChangedEvent:1.0.0"
...
class Outlet(EDevice):
    ...
    # structure
    class MetaData(Structure):
        idlType = "pdumodel.Outlet_2_1_6.MetaData:1.0.0"
    ...
    class PowerState(Enumeration):
        idlType = "pdumodel.Outlet_2_1_6.PowerState:1.0.0"
        values = ["PS_OFF", "PS_ON"]
    ...
    class LedState(Structure):
        idlType = "pdumodel.Outlet_2_1_6.LedState:1.0.0"
    ...
    class State(Structure):
        idlType = "pdumodel.Outlet_2_1_6.State:1.0.0"
    ...
    class StartupState(Enumeration):
        idlType = "pdumodel.Outlet_2_1_6.StartupState:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.Outlet_2_1_6.Settings:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.Outlet_2_1_6.Sensors:1.0.0"
    ...
    class PowerControlEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Outlet_2_1_6.PowerControlEvent:1.0.0"
    ...
    class StateChangedEvent(raritan.rpc.idl.Event):
        idlType = "pdumodel.Outlet_2_1_6.StateChangedEvent:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Outlet_2_1_6.SettingsChangedEvent:1.0.0"
...
# interface
class Pdu(Interface):
    idlType = "pdumodel.Pdu:5.0.0"

    ERR_INVALID_PARAM = 1

    # structure
    class MetaData(Structure):
        idlType = "pdumodel.Pdu_5_0_0.MetaData:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.Pdu_5_0_0.Sensors:1.0.0"
    ...
    class Statistic(Structure):
        idlType = "pdumodel.Pdu_5_0_0.Statistic:1.0.0"
    ...
    # enumeration
    class StartupState(Enumeration):
        idlType = "pdumodel.Pdu_5_0_0.StartupState:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.Pdu_5_0_0.Settings:1.0.0"
    ...
    class OutletSequenceState(Structure):
        idlType = "pdumodel.Pdu_5_0_0.OutletSequenceState:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Pdu_5_0_0.SettingsChangedEvent:1.0.0"
    ...
    class LoadSheddingModeChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Pdu_5_0_0.LoadSheddingModeChangedEvent:1.0.0"
    ...
    class OutletSequenceStateChangedEvent(raritan.rpc.idl.Event):
        idlType = "pdumodel.Pdu_5_0_0.OutletSequenceStateChangedEvent:1.0.0"
...
class PowerMeterController(Interface):
    idlType = "pdumodel.PowerMeterController:1.1.6"
    ...
    class ScanResult(Structure):
        idlType = "pdumodel.PowerMeterController_1_1_6.ScanResult:1.0.0"
    ...
    class PowerMeterCreatedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.PowerMeterController_1_1_6.PowerMeterCreatedEvent:1.0.0"
    ...
    class PowerMeterDeletedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.PowerMeterController_1_1_6.PowerMeterDeletedEvent:1.0.0"
    ...
    class PanelCreatedEvent(PowerMeterCreatedEvent):
        idlType = "pdumodel.PowerMeterController_1_1_6.PanelCreatedEvent:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                ...
                # for pdumodel.PowerMeterController_1_1_6.PowerMeterCreatedEvent
                powerMeter = Interface.decode(json['powerMeter'], agent),
                config = raritan.rpc.pdumodel.PowerMeter.Config.decode(json['config'], agent),
                settings = raritan.rpc.pdumodel.PowerMeter.Settings.decode(json['settings'], agent),
                # for event.UserEvent
    ...
    class PanelDeletedEvent(PowerMeterDeletedEvent):
        idlType = "pdumodel.PowerMeterController_1_1_6.PanelDeletedEvent:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                panelSettings = raritan.rpc.pdumodel.Panel.PanelSettings.decode(json['panelSettings'], agent),
                # for pdumodel.PowerMeterController_1_1_6.PowerMeterDeletedEvent
                config = raritan.rpc.pdumodel.PowerMeter.Config.decode(json['config'], agent),
                settings = raritan.rpc.pdumodel.PowerMeter.Settings.decode(json['settings'], agent),
                # for event.UserEvent
                actUserName = json['actUserName'],
...
class OverCurrentProtectorTripSensor(raritan.rpc.sensors.StateSensor):
    idlType = "pdumodel.OverCurrentProtectorTripSensor:1.0.6"

    # value object
    class TripStateChangedEvent(raritan.rpc.sensors.StateSensor.StateChangedEvent):
        idlType = "pdumodel.OverCurrentProtectorTripSensor_1_0_6.TripStateChangedEvent:1.0.0"
...
class OutletGroup(Interface):
    idlType = "pdumodel.OutletGroup:1.0.2"

    ERR_INVALID_ARGUMENT = 1

    # structure
    class Sensors(Structure):
        idlType = "pdumodel.OutletGroup_1_0_2.Sensors:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.OutletGroup_1_0_2.Settings:1.0.0"
    ...
    # structure
    class MetaData(Structure):
        idlType = "pdumodel.OutletGroup_1_0_2.MetaData:1.0.0"
    ...
    class SensorsChangedEvent(raritan.rpc.idl.Event):
        idlType = "pdumodel.OutletGroup_1_0_2.SensorsChangedEvent:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OutletGroup_1_0_2.SettingsChangedEvent:1.0.0"
    ...
    # value object
    class PowerControlEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OutletGroup_1_0_2.PowerControlEvent:1.0.0"
...
class OutletGroupManager(Interface):
    idlType = "pdumodel.OutletGroupManager:1.0.2"
    ...
    class GroupCreatedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OutletGroupManager_1_0_2.GroupCreatedEvent:1.0.0"
    ...
    class GroupDeletedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OutletGroupManager_1_0_2.GroupDeletedEvent:1.0.0"
