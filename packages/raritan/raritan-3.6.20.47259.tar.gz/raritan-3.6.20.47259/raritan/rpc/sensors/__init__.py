...
class Sensor(Interface):
    ...
    class OnOffState(Enumeration):
        idlType = "sensors.Sensor_4_0_4.OnOffState:1.0.0"
        values = ["OFF", "ON"]
    ...
    class OpenClosedState(Enumeration):
        idlType = "sensors.Sensor_4_0_4.OpenClosedState:1.0.0"
        values = ["OPEN", "CLOSED"]
    ...
    class NormalAlarmedState(Enumeration):
        idlType = "sensors.Sensor_4_0_4.NormalAlarmedState:1.0.0"
    ...
    class OkFaultState(Enumeration):
        idlType = "sensors.Sensor_4_0_4.OkFaultState:1.0.0"
        values = ["OK", "FAULT"]
    ...
    class TypeSpec(Structure):
        idlType = "sensors.Sensor_4_0_4.TypeSpec:1.0.0"
    ...
    class TypeSpecChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.Sensor_4_0_4.TypeSpecChangedEvent:1.0.0"
...
class NumericSensor(Sensor):
    idlType = "sensors.NumericSensor:4.0.4"
    ...
    class Range(Structure):
        idlType = "sensors.NumericSensor_4_0_4.Range:1.0.0"
    ...
    class ThresholdCapabilities(Structure):
        idlType = "sensors.NumericSensor_4_0_4.ThresholdCapabilities:1.0.0"
    ...
    class MetaData(Structure):
        idlType = "sensors.NumericSensor_4_0_4.MetaData:1.0.0"
    ...
    class Thresholds(Structure):
        idlType = "sensors.NumericSensor_4_0_4.Thresholds:1.0.0"
    ...
    class Reading(Structure):
        idlType = "sensors.NumericSensor_4_0_4.Reading:1.0.0"
        ...
        class Status(Structure):
            idlType = "sensors.NumericSensor_4_0_4.Reading.Status:1.0.0"
    ...
    class ReadingChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.NumericSensor_4_0_4.ReadingChangedEvent:1.0.0"
    ...
    class StateChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.NumericSensor_4_0_4.StateChangedEvent:1.0.0"
    ...
    class MetaDataChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.NumericSensor_4_0_4.MetaDataChangedEvent:1.0.0"
    ...
    class ThresholdsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.NumericSensor_4_0_4.ThresholdsChangedEvent:1.0.0"
...
class StateSensor(Sensor):
    idlType = "sensors.StateSensor:4.0.4"

    # structure
    class State(Structure):
        idlType = "sensors.StateSensor_4_0_4.State:1.0.0"
    ...
    # value object
    class StateChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.StateSensor_4_0_4.StateChangedEvent:1.0.0"
...
class Logger(Interface):
    idlType = "sensors.Logger:2.2.7"

    # structure
    class Settings(Structure):
        idlType = "sensors.Logger_2_2_7.Settings:1.0.0"
    ...
    class SensorSet(Structure):
        idlType = "sensors.Logger_2_2_7.SensorSet:1.0.0"
    ...
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.Logger_2_2_7.SettingsChangedEvent:1.0.0"
    ...
    class LoggedSensorsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.Logger_2_2_7.LoggedSensorsChangedEvent:1.0.0"
    ...
    class Record(Structure):
        idlType = "sensors.Logger_2_2_7.Record:1.0.0"
    ...
    class TimedRecord(Structure):
        idlType = "sensors.Logger_2_2_7.TimedRecord:1.0.0"
    ...
    class LogRow(Structure):
        idlType = "sensors.Logger_2_2_7.LogRow:1.0.0"
...
class AccumulatingNumericSensor(NumericSensor):
    idlType = "sensors.AccumulatingNumericSensor:2.0.4"

    # value object
    class ResetEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.AccumulatingNumericSensor_2_0_4.ResetEvent:1.0.0"
...
class Switch(StateSensor):
    ...
    class SwitchEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.Switch_2_0_6.SwitchEvent:1.0.0"
...
class AlertedSensorManager(Interface):
    idlType = "sensors.AlertedSensorManager:1.0.2"

    # enumeration
    class AlertState(Enumeration):
        idlType = "sensors.AlertedSensorManager_1_0_2.AlertState:1.0.0"
    ...
    class SensorCounts(Structure):
        idlType = "sensors.AlertedSensorManager_1_0_2.SensorCounts:1.0.0"
    ...
    class SensorData(Structure):
        idlType = "sensors.AlertedSensorManager_1_0_2.SensorData:1.0.0"
    ...
    class MonitoredSensorsChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.AlertedSensorManager_1_0_2.MonitoredSensorsChangedEvent:1.0.0"
    ...
    class AlertedSensorsChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.AlertedSensorManager_1_0_2.AlertedSensorsChangedEvent:1.0.0"
