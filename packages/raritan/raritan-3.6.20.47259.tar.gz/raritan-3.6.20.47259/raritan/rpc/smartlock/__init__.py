...
class DoorAccessControl(Interface):
    idlType = "smartlock.DoorAccessControl:1.0.0"
    ...
    class AbsoluteTimeCondition(Structure):
        idlType = "smartlock.DoorAccessControl.AbsoluteTimeCondition:1.0.0"
    ...
    class PeriodicTimeCondition(Structure):
        idlType = "smartlock.DoorAccessControl.PeriodicTimeCondition:1.0.0"
    ...
    class CardReaderInfo(Structure):
        idlType = "smartlock.DoorAccessControl.CardReaderInfo:1.0.0"
    ...
    class KeypadInfo(Structure):
        idlType = "smartlock.DoorAccessControl.KeypadInfo:1.0.0"
        elements = ["linkId", "position"]
    ...
    class CardCondition(Structure):
        idlType = "smartlock.DoorAccessControl.CardCondition:1.0.0"
    ...
    class KeypadCondition(Structure):
        idlType = "smartlock.DoorAccessControl.KeypadCondition:1.0.0"
    ...
    class DoorAccessRule(Structure):
        idlType = "smartlock.DoorAccessControl.DoorAccessRule:1.0.0"
    ...
    class DoorAccessDenialReason(Enumeration):
        idlType = "smartlock.DoorAccessControl.DoorAccessDenialReason:1.0.0"
    ...
    class DoorAccessGrantedEvent(raritan.rpc.idl.Event):
        idlType = "smartlock.DoorAccessControl.DoorAccessGrantedEvent:1.0.0"
    ...
    class DoorAccessDeniedEvent(raritan.rpc.idl.Event):
        idlType = "smartlock.DoorAccessControl.DoorAccessDeniedEvent:1.0.0"
    ...
    class DoorAccessRuleAddedEvent(raritan.rpc.event.UserEvent):
        idlType = "smartlock.DoorAccessControl.DoorAccessRuleAddedEvent:1.0.0"
    ...
    class DoorAccessRuleChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "smartlock.DoorAccessControl.DoorAccessRuleChangedEvent:1.0.0"
    ...
    class DoorAccessRuleDeletedEvent(raritan.rpc.event.UserEvent):
        idlType = "smartlock.DoorAccessControl.DoorAccessRuleDeletedEvent:1.0.0"
