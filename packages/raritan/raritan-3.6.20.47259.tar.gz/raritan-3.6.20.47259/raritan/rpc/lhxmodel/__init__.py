...
class Sensor(raritan.rpc.sensors.Sensor):
    idlType = "lhxmodel.Sensor:4.0.4"

    # structure
    class MetaData(Structure):
        idlType = "lhxmodel.Sensor_4_0_4.MetaData:1.0.0"
    ...
    class NumThresholds(Structure):
        idlType = "lhxmodel.Sensor_4_0_4.NumThresholds:1.0.0"
    ...
    class Reading(Structure):
        idlType = "lhxmodel.Sensor_4_0_4.Reading:1.0.0"
    ...
    class ThresholdsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "lhxmodel.Sensor_4_0_4.ThresholdsChangedEvent:1.0.0"
    ...
    class StateChangedEvent(raritan.rpc.idl.Event):
        idlType = "lhxmodel.Sensor_4_0_4.StateChangedEvent:1.0.0"
    ...
    class ReadingChangedEvent(raritan.rpc.idl.Event):
        idlType = "lhxmodel.Sensor_4_0_4.ReadingChangedEvent:1.0.0"
...
class Lhx(Interface):
    ...
    class ParamCfg(Structure):
        idlType = "lhxmodel.Lhx_3_2_5.ParamCfg:1.0.0"
    ...
    # structure
    class MetaData(Structure):
        idlType = "lhxmodel.Lhx_3_2_5.MetaData:1.0.0"
    ...
    class Settings(Structure):
        idlType = "lhxmodel.Lhx_3_2_5.Settings:1.0.0"
    ...
    class AlertStatus(Structure):
        idlType = "lhxmodel.Lhx_3_2_5.AlertStatus:1.0.0"
    ...
    class OpState(Structure):
        idlType = "lhxmodel.Lhx_3_2_5.OpState:1.0.0"
    ...
    class Capabilities(Structure):
        idlType = "lhxmodel.Lhx_3_2_5.Capabilities:1.0.0"
    ...
    class OpStateChangedEvent(raritan.rpc.idl.Event):
        idlType = "lhxmodel.Lhx_3_2_5.OpStateChangedEvent:1.0.0"
    ...
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "lhxmodel.Lhx_3_2_5.SettingsChangedEvent:1.0.0"
...
# interface
class LhxDevel(Lhx):
    idlType = "lhxmodel.LhxDevel:1.1.3"

    # structure
    class ParameterData(Structure):
        idlType = "lhxmodel.LhxDevel_1_1_3.ParameterData:1.0.0"
