...
class PortForwardingSettings(Structure):
    ...
    def __init__(self, enabled, role, primaryUnitDownstreamIfName):
    ...
    def decode(cls, json, agent):
        obj = cls(
            ...
            primaryUnitDownstreamIfName = json['primaryUnitDownstreamIfName'],
        )
        return obj
...
class PortForwardingInfo(Structure):
    ...
    def __init__(self, enabled, nodeIndexValid, nodeIndex, expansionUnitConnected, primaryUnitDownstreamIfName, primaryUnitIPv4AddrInfos, primaryUnitIPv6AddrInfos, linkLocalIPv6Address):
        typecheck.is_bool(enabled, AssertionError)
    ...
    def decode(cls, json, agent):
        obj = cls(
            ...
            expansionUnitConnected = json['expansionUnitConnected'],
            primaryUnitDownstreamIfName = json['primaryUnitDownstreamIfName'],
            primaryUnitIPv4AddrInfos = [raritan.rpc.net.PortForwardingPrimaryUnitAddrInfo.decode(x0, agent) for x0 in json['primaryUnitIPv4AddrInfos']],
            primaryUnitIPv6AddrInfos = [raritan.rpc.net.PortForwardingPrimaryUnitAddrInfo.decode(x0, agent) for x0 in json['primaryUnitIPv6AddrInfos']],
...
class InterfaceIpSettings(Structure):
    ...
    def __init__(self, enabled, configMethod, staticAddrCidr, staticDefaultGatewayAddr, dhcpPreferredHostname):
        typecheck.is_bool(enabled, AssertionError)
    ...
    def decode(cls, json, agent):
        obj = cls(
            ...
            staticDefaultGatewayAddr = json['staticDefaultGatewayAddr'],
...
class InterfaceInfo(Structure):
    ...
    def __init__(self, name, label, type, enabled, controllingIfName, state, macAddr, mtu, ipv4, ipv6):
    ...
    def decode(cls, json, agent):
        obj = cls(
            ...
            enabled = json['enabled'],
            controllingIfName = json['controllingIfName'],
...
class EthSettings(Structure):
    ...
    def __init__(self, linkMode, mtu, authType, eap, lldpEnabled):
...
class WlanSettings(Structure):
    ...
    def __init__(self, enableHT, ssid, bssid, mtu, secProtocol, authType, psk, clearPsk, eap):
...
class PortForwardingExpansionUnitPresenceStateChangedEvent(raritan.rpc.idl.Event):
    ...
    def __init__(self, expansionUnitPresent, source):
    ...
    def decode(cls, json, agent):
        obj = cls(
            expansionUnitPresent = json['expansionUnitPresent'],
            # for idl.Event
            source = Interface.decode(json['source'], agent),
        )
        return obj
