...
class Address(Structure):
    idlType = "peripheral.Address:7.0.0"
...
class Device(ValueObject):
    idlType = "peripheral.Device:6.0.0"
...
class DeviceSlot(Interface):
    idlType = "peripheral.DeviceSlot:4.0.1"
    ...
    class Location(Structure):
        idlType = "peripheral.DeviceSlot_4_0_1.Location:1.0.0"
        elements = ["x", "y", "z"]
    ...
    class Settings(Structure):
        idlType = "peripheral.DeviceSlot_4_0_1.Settings:1.0.0"
    ...
    class DeviceChangedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceSlot_4_0_1.DeviceChangedEvent:1.0.0"
    ...
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "peripheral.DeviceSlot_4_0_1.SettingsChangedEvent:1.0.0"
...
class SensorHub(Interface):
    idlType = "peripheral.SensorHub:2.0.1"

    # enumeration
    class UpstreamType(Enumeration):
        idlType = "peripheral.SensorHub_2_0_1.UpstreamType:1.0.0"
    ...
    class HubPortInfo(Structure):
        idlType = "peripheral.SensorHub_2_0_1.HubPortInfo:1.0.0"
    ...
    class DeviceInfo(Structure):
        idlType = "peripheral.SensorHub_2_0_1.DeviceInfo:1.0.0"
...
class DeviceManager(Interface):
    idlType = "peripheral.DeviceManager:5.0.1"

    ERR_INVALID_PARAMS = 1

    # enumeration
    class ZCoordMode(Enumeration):
        idlType = "peripheral.DeviceManager_5_0_1.ZCoordMode:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "peripheral.DeviceManager_5_0_1.Settings:1.0.0"
    ...
    class MetaData(Structure):
        idlType = "peripheral.DeviceManager_5_0_1.MetaData:1.0.0"
    ...
    class DeviceTypeInfo(Structure):
        idlType = "peripheral.DeviceManager_5_0_1.DeviceTypeInfo:1.0.0"
    ...
    class FirmwareUpdateState(Structure):
        idlType = "peripheral.DeviceManager_5_0_1.FirmwareUpdateState:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "peripheral.DeviceManager_5_0_1.SettingsChangedEvent:1.0.0"
    ...
    class DeviceEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_5_0_1.DeviceEvent:1.0.0"
    ...
    class DeviceAddedEvent(DeviceEvent):
        idlType = "peripheral.DeviceManager_5_0_1.DeviceAddedEvent:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                # for peripheral.DeviceManager_5_0_1.DeviceEvent
                devices = [ValueObject.decode(x0, agent) for x0 in json['devices']],
                allDevices = [ValueObject.decode(x0, agent) for x0 in json['allDevices']],
                # for idl.Event
                source = Interface.decode(json['source'], agent),
    ...
    class DeviceRemovedEvent(DeviceEvent):
        idlType = "peripheral.DeviceManager_5_0_1.DeviceRemovedEvent:1.0.0"
    ...
    class UnknownDeviceAttachedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_5_0_1.UnknownDeviceAttachedEvent:1.0.0"
    ...
    class DeviceFirmwareUpdateState(Enumeration):
        idlType = "peripheral.DeviceManager_5_0_1.DeviceFirmwareUpdateState:1.0.0"
    ...
    class DeviceFirmwareUpdateStateChangedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_5_0_1.DeviceFirmwareUpdateStateChangedEvent:1.0.0"
    ...
    class FirmwareUpdateStateChangedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_5_0_1.FirmwareUpdateStateChangedEvent:1.0.0"
    ...
    class PackageEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_5_0_1.PackageEvent:1.0.0"
    ...
    class PackageAddedEvent(PackageEvent):
        idlType = "peripheral.DeviceManager_5_0_1.PackageAddedEvent:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                # for peripheral.DeviceManager_5_0_1.PackageEvent
                packageInfos = [raritan.rpc.peripheral.PackageInfo.decode(x0, agent) for x0 in json['packageInfos']],
                allPackages = [raritan.rpc.peripheral.PackageInfo.decode(x0, agent) for x0 in json['allPackages']],
                # for idl.Event
                source = Interface.decode(json['source'], agent),
    ...
    class PackageRemovedEvent(PackageEvent):
        idlType = "peripheral.DeviceManager_5_0_1.PackageRemovedEvent:1.0.0"
    ...
    class Statistics(Structure):
        idlType = "peripheral.DeviceManager_5_0_1.Statistics:1.0.0"
