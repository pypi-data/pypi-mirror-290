...
class CascadeManager(Interface):
    idlType = "cascading.CascadeManager:1.0.1"
    ...
    class Role(Enumeration):
        idlType = "cascading.CascadeManager_1_0_1.Role:1.0.0"
    ...
    class LinkUnitStatus(Enumeration):
        idlType = "cascading.CascadeManager_1_0_1.LinkUnitStatus:1.0.0"
    ...
    class LinkUnit(Structure):
        idlType = "cascading.CascadeManager_1_0_1.LinkUnit:1.0.0"
    ...
    class Status(Structure):
        idlType = "cascading.CascadeManager_1_0_1.Status:1.0.0"
    ...
    class RoleChangedEvent(raritan.rpc.idl.Event):
        idlType = "cascading.CascadeManager_1_0_1.RoleChangedEvent:1.0.0"
    ...
    class LinkUnitAddedEvent(raritan.rpc.event.UserEvent):
        idlType = "cascading.CascadeManager_1_0_1.LinkUnitAddedEvent:1.0.0"
    ...
    class LinkUnitReleasedEvent(raritan.rpc.event.UserEvent):
        idlType = "cascading.CascadeManager_1_0_1.LinkUnitReleasedEvent:1.0.0"
    ...
    class LinkUnitStatusChangedEvent(raritan.rpc.idl.Event):
        idlType = "cascading.CascadeManager_1_0_1.LinkUnitStatusChangedEvent:1.0.0"
