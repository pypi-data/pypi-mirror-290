...
# interface
class Pdu(Interface):
    idlType = "pdumodel.Pdu:5.1.3"

    ERR_INVALID_PARAM = 1

    # structure
    class MetaData(Structure):
        idlType = "pdumodel.Pdu_5_1_3.MetaData:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.Pdu_5_1_3.Sensors:1.0.0"
    ...
    class Statistic(Structure):
        idlType = "pdumodel.Pdu_5_1_3.Statistic:1.0.0"
    ...
    # enumeration
    class StartupState(Enumeration):
        idlType = "pdumodel.Pdu_5_1_3.StartupState:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.Pdu_5_1_3.Settings:1.0.0"
    ...
    class OutletSequenceState(Structure):
        idlType = "pdumodel.Pdu_5_1_3.OutletSequenceState:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Pdu_5_1_3.SettingsChangedEvent:1.0.0"
    ...
    class LoadSheddingModeChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Pdu_5_1_3.LoadSheddingModeChangedEvent:1.0.0"
    ...
    class OutletSequenceStateChangedEvent(raritan.rpc.idl.Event):
        idlType = "pdumodel.Pdu_5_1_3.OutletSequenceStateChangedEvent:1.0.0"
