...
class DoorAccessControl(Interface):
    idlType = "smartlock.DoorAccessControl:1.1.1"
    ...
    class AbsoluteTimeCondition(Structure):
        idlType = "smartlock.DoorAccessControl_1_1_1.AbsoluteTimeCondition:1.0.0"
    ...
    class PeriodicTimeCondition(Structure):
        idlType = "smartlock.DoorAccessControl_1_1_1.PeriodicTimeCondition:1.0.0"
    ...
    class CardReaderInfo(Structure):
        idlType = "smartlock.DoorAccessControl_1_1_1.CardReaderInfo:1.0.0"
    ...
    class KeypadInfo(Structure):
        idlType = "smartlock.DoorAccessControl_1_1_1.KeypadInfo:1.0.0"
        elements = ["linkId", "position"]
    ...
    class CardCondition(Structure):
        idlType = "smartlock.DoorAccessControl_1_1_1.CardCondition:1.0.0"
    ...
    class KeypadCondition(Structure):
        idlType = "smartlock.DoorAccessControl_1_1_1.KeypadCondition:1.0.0"
    ...
    class DoorAccessRule(Structure):
        idlType = "smartlock.DoorAccessControl_1_1_1.DoorAccessRule:1.0.0"
    ...
    class DoorAccessDenialReason(Enumeration):
        idlType = "smartlock.DoorAccessControl_1_1_1.DoorAccessDenialReason:1.0.0"
    ...
    class DoorAccessGrantedEvent(raritan.rpc.idl.Event):
        idlType = "smartlock.DoorAccessControl_1_1_1.DoorAccessGrantedEvent:1.0.0"
    ...
    class DoorAccessDeniedEvent(raritan.rpc.idl.Event):
        idlType = "smartlock.DoorAccessControl_1_1_1.DoorAccessDeniedEvent:1.0.0"
    ...
    class DoorAccessRuleAddedEvent(raritan.rpc.event.UserEvent):
        idlType = "smartlock.DoorAccessControl_1_1_1.DoorAccessRuleAddedEvent:1.0.0"
    ...
    class DoorAccessRuleChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "smartlock.DoorAccessControl_1_1_1.DoorAccessRuleChangedEvent:1.0.0"
    ...
    class DoorAccessRuleDeletedEvent(raritan.rpc.event.UserEvent):
        idlType = "smartlock.DoorAccessControl_1_1_1.DoorAccessRuleDeletedEvent:1.0.0"
