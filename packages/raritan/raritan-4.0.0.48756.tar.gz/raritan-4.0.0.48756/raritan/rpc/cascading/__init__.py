...
class CascadeManager(Interface):
    idlType = "cascading.CascadeManager:2.0.0"
    ...
    class PrimaryUnitSettings(Structure):
        idlType = "cascading.CascadeManager_2_0_0.PrimaryUnitSettings:1.0.0"
    ...
    class Role(Enumeration):
        idlType = "cascading.CascadeManager_2_0_0.Role:1.0.0"
    ...
    class LinkUnitStatus(Enumeration):
        idlType = "cascading.CascadeManager_2_0_0.LinkUnitStatus:1.0.0"
        values = ["UNKNOWN", "OK", "UNREACHABLE", "ACCESS_DENIED", "FIRMWARE_UPDATE", "FIRMWARE_MISMATCH"]
    ...
    class LinkUnit(Structure):
        idlType = "cascading.CascadeManager_2_0_0.LinkUnit:1.0.0"
        elements = ["host", "status", "fwVersion"]

        def __init__(self, host, status, fwVersion):
    ...
    class Status(Structure):
        idlType = "cascading.CascadeManager_2_0_0.Status:1.0.0"
    ...
    class LinkPortStatus(Structure):
        idlType = "cascading.CascadeManager_2_0_0.LinkPortStatus:1.0.0"
    ...
    class RoleChangedEvent(raritan.rpc.idl.Event):
        idlType = "cascading.CascadeManager_2_0_0.RoleChangedEvent:1.0.0"
    ...
    class LinkUnitAddedEvent(raritan.rpc.event.UserEvent):
        idlType = "cascading.CascadeManager_2_0_0.LinkUnitAddedEvent:1.0.0"
    ...
    class LinkUnitReleasedEvent(raritan.rpc.event.UserEvent):
        idlType = "cascading.CascadeManager_2_0_0.LinkUnitReleasedEvent:1.0.0"
    ...
    class LinkUnitStatusChangedEvent(raritan.rpc.idl.Event):
        idlType = "cascading.CascadeManager_2_0_0.LinkUnitStatusChangedEvent:1.0.0"
    ...
    class LinkPortStatusChangedEvent(raritan.rpc.idl.Event):
        idlType = "cascading.CascadeManager_2_0_0.LinkPortStatusChangedEvent:1.0.0"
