...
class BatteryPoweredDevicePackage(Package):
    idlType = "peripheral.BatteryPoweredDevicePackage:1.0.0"
    ...
    class VoltageChangedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.BatteryPoweredDevicePackage.VoltageChangedEvent:1.0.0"

        def __init__(self, oldVoltage, newVoltage, source):
        ...
        def decode(cls, json, agent):
            obj = cls(
                oldVoltage = json['oldVoltage'],
                newVoltage = json['newVoltage'],
                # for idl.Event
                source = Interface.decode(json['source'], agent),
            )
            return obj
