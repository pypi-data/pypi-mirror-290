...
class NumericSensor(Sensor):
    idlType = "sensors.NumericSensor:4.0.5"
    ...
    class Range(Structure):
        idlType = "sensors.NumericSensor_4_0_5.Range:1.0.0"
    ...
    class ThresholdCapabilities(Structure):
        idlType = "sensors.NumericSensor_4_0_5.ThresholdCapabilities:1.0.0"
    ...
    class MetaData(Structure):
        idlType = "sensors.NumericSensor_4_0_5.MetaData:1.0.0"
    ...
    class Thresholds(Structure):
        idlType = "sensors.NumericSensor_4_0_5.Thresholds:1.0.0"
    ...
    class Reading(Structure):
        idlType = "sensors.NumericSensor_4_0_5.Reading:1.0.0"
        ...
        class Status(Structure):
            idlType = "sensors.NumericSensor_4_0_5.Reading.Status:1.0.0"
    ...
    class MinMax(Structure):
        idlType = "sensors.NumericSensor_4_0_5.MinMax:1.0.0"
    ...
    class ReadingChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.NumericSensor_4_0_5.ReadingChangedEvent:1.0.0"
    ...
    class StateChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.NumericSensor_4_0_5.StateChangedEvent:1.0.0"
    ...
    class MetaDataChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.NumericSensor_4_0_5.MetaDataChangedEvent:1.0.0"
    ...
    class ThresholdsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.NumericSensor_4_0_5.ThresholdsChangedEvent:1.0.0"
    ...
    class MinMaxChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.NumericSensor_4_0_5.MinMaxChangedEvent:1.0.0"
    ...
    class MinMaxResetEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.NumericSensor_4_0_5.MinMaxResetEvent:1.0.0"
...
class AccumulatingNumericSensor(NumericSensor):
    idlType = "sensors.AccumulatingNumericSensor:2.0.5"

    # value object
    class ResetEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.AccumulatingNumericSensor_2_0_5.ResetEvent:1.0.0"
...
class Logger(Interface):
    idlType = "sensors.Logger:3.0.0"

    # structure
    class Info(Structure):
        idlType = "sensors.Logger_3_0_0.Info:1.0.0"
    ...
    class Settings(Structure):
        idlType = "sensors.Logger_3_0_0.Settings:1.0.0"
    ...
    class SensorSet(Structure):
        idlType = "sensors.Logger_3_0_0.SensorSet:1.0.0"
    ...
    class InfoChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.Logger_3_0_0.InfoChangedEvent:1.0.0"
    ...
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.Logger_3_0_0.SettingsChangedEvent:1.0.0"
    ...
    class LoggedSensorsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.Logger_3_0_0.LoggedSensorsChangedEvent:1.0.0"
    ...
    class Record(Structure):
        idlType = "sensors.Logger_3_0_0.Record:1.0.0"
    ...
    class TimedRecord(Structure):
        idlType = "sensors.Logger_3_0_0.TimedRecord:1.0.0"
    ...
    class LogRow(Structure):
        idlType = "sensors.Logger_3_0_0.LogRow:1.0.0"
