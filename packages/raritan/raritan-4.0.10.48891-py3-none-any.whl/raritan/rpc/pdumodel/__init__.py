...
class MeteredLinePair(Structure):
    idlType = "pdumodel.MeteredLinePair:1.0.0"
...
class DoublePole(Structure):
    idlType = "pdumodel.DoublePole:7.0.0"
...
class Circuit(Interface):
    idlType = "pdumodel.Circuit:2.0.0"
    ...
    class Type(Enumeration):
        idlType = "pdumodel.Circuit_2_0_0.Type:1.0.0"
    ...
    class Config(Structure):
        idlType = "pdumodel.Circuit_2_0_0.Config:1.0.0"
    ...
    class Sensors(Structure):
        idlType = "pdumodel.Circuit_2_0_0.Sensors:1.0.0"
    ...
    class PoleSettings(Structure):
        idlType = "pdumodel.Circuit_2_0_0.PoleSettings:1.0.0"
    ...
    class Settings(Structure):
        idlType = "pdumodel.Circuit_2_0_0.Settings:1.0.0"
    ...
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Circuit_2_0_0.SettingsChangedEvent:1.0.0"
...
# interface
class Inlet(EDevice):
    idlType = "pdumodel.Inlet:3.0.0"

    # structure
    class MetaData(Structure):
        idlType = "pdumodel.Inlet_3_0_0.MetaData:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.Inlet_3_0_0.Sensors:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.Inlet_3_0_0.Settings:1.0.0"
        elements = ["name"]
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Inlet_3_0_0.SettingsChangedEvent:1.0.0"
    ...
    class EnableStateChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Inlet_3_0_0.EnableStateChangedEvent:1.0.0"
...
class OverCurrentProtector(EDevice):
    idlType = "pdumodel.OverCurrentProtector:4.0.0"

    # enumeration
    class Type(Enumeration):
        idlType = "pdumodel.OverCurrentProtector_4_0_0.Type:1.0.0"
    ...
    # structure
    class MetaData(Structure):
        idlType = "pdumodel.OverCurrentProtector_4_0_0.MetaData:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.OverCurrentProtector_4_0_0.Sensors:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.OverCurrentProtector_4_0_0.Settings:1.0.0"
        elements = ["name"]
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OverCurrentProtector_4_0_0.SettingsChangedEvent:1.0.0"
...
class Outlet(EDevice):
    ...
    # structure
    class MetaData(Structure):
        idlType = "pdumodel.Outlet_3_0_0.MetaData:1.0.0"
    ...
    class PowerState(Enumeration):
        idlType = "pdumodel.Outlet_3_0_0.PowerState:1.0.0"
        values = ["PS_OFF", "PS_ON"]
    ...
    class LedState(Structure):
        idlType = "pdumodel.Outlet_3_0_0.LedState:1.0.0"
    ...
    class State(Structure):
        idlType = "pdumodel.Outlet_3_0_0.State:1.0.0"
    ...
    class StartupState(Enumeration):
        idlType = "pdumodel.Outlet_3_0_0.StartupState:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.Outlet_3_0_0.Settings:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.Outlet_3_0_0.Sensors:1.0.0"
    ...
    class PowerControlEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Outlet_3_0_0.PowerControlEvent:1.0.0"
    ...
    class StateChangedEvent(raritan.rpc.idl.Event):
        idlType = "pdumodel.Outlet_3_0_0.StateChangedEvent:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Outlet_3_0_0.SettingsChangedEvent:1.0.0"
...
class OutletGroup(Interface):
    idlType = "pdumodel.OutletGroup:1.1.6"

    ERR_INVALID_ARGUMENT = 1

    # structure
    class Sensors(Structure):
        idlType = "pdumodel.OutletGroup_1_1_6.Sensors:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.OutletGroup_1_1_6.Settings:1.0.0"
    ...
    # structure
    class MetaData(Structure):
        idlType = "pdumodel.OutletGroup_1_1_6.MetaData:1.0.0"
    ...
    class SensorsChangedEvent(raritan.rpc.idl.Event):
        idlType = "pdumodel.OutletGroup_1_1_6.SensorsChangedEvent:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OutletGroup_1_1_6.SettingsChangedEvent:1.0.0"
    ...
    # value object
    class PowerControlEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OutletGroup_1_1_6.PowerControlEvent:1.0.0"
...
class OutletGroupManager(Interface):
    idlType = "pdumodel.OutletGroupManager:1.1.6"
    ...
    class GroupCreatedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OutletGroupManager_1_1_6.GroupCreatedEvent:1.0.0"
    ...
    class GroupDeletedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OutletGroupManager_1_1_6.GroupDeletedEvent:1.0.0"
...
class OverCurrentProtectorTripSensor(raritan.rpc.sensors.StateSensor):
    idlType = "pdumodel.OverCurrentProtectorTripSensor:1.1.10"

    # structure
    class TripEventInformation(Structure):
        idlType = "pdumodel.OverCurrentProtectorTripSensor_1_1_10.TripEventInformation:1.0.0"
    ...
    class TripStateChangedEvent(raritan.rpc.sensors.StateSensor.StateChangedEvent):
        idlType = "pdumodel.OverCurrentProtectorTripSensor_1_1_10.TripStateChangedEvent:1.0.0"
...
class PowerMeter(Interface):
    idlType = "pdumodel.PowerMeter:2.0.0"
    ...
    # enumeration
    class Type(Enumeration):
        idlType = "pdumodel.PowerMeter_2_0_0.Type:1.0.0"
    ...
    # structure
    class Config(Structure):
        idlType = "pdumodel.PowerMeter_2_0_0.Config:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.PowerMeter_2_0_0.Sensors:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.PowerMeter_2_0_0.Settings:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.PowerMeter_2_0_0.SettingsChangedEvent:1.0.0"
    ...
    class EnergyPulseSettings(Structure):
        idlType = "pdumodel.PowerMeter_2_0_0.EnergyPulseSettings:1.0.0"
    ...
    class EnergyPulseSettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.PowerMeter_2_0_0.EnergyPulseSettingsChangedEvent:1.0.0"
...
class Panel(PowerMeter):
    idlType = "pdumodel.Panel:2.0.0"

    # enumeration
    class LabelingScheme(Enumeration):
        idlType = "pdumodel.Panel_2_0_0.LabelingScheme:1.0.0"
    ...
    class PanelSettings(Structure):
        idlType = "pdumodel.Panel_2_0_0.PanelSettings:1.0.0"
    ...
    class PanelSettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Panel_2_0_0.PanelSettingsChangedEvent:1.0.0"
    ...
    class CircuitCreatedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Panel_2_0_0.CircuitCreatedEvent:1.0.0"
    ...
    class CircuitDeletedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Panel_2_0_0.CircuitDeletedEvent:1.0.0"
...
class TransferSwitch(EDevice):
    idlType = "pdumodel.TransferSwitch:5.0.1"
    ...
    # enumeration
    class Type(Enumeration):
        idlType = "pdumodel.TransferSwitch_5_0_1.Type:1.0.0"
        values = ["STS", "ATS", "HTS"]
    ...
    class TransferReason(Enumeration):
        idlType = "pdumodel.TransferSwitch_5_0_1.TransferReason:1.0.0"
    ...
    # structure
    class MetaData(Structure):
        idlType = "pdumodel.TransferSwitch_5_0_1.MetaData:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.TransferSwitch_5_0_1.Sensors:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.TransferSwitch_5_0_1.Settings:1.0.0"
    ...
    class Statistics(Structure):
        idlType = "pdumodel.TransferSwitch_5_0_1.Statistics:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.TransferSwitch_5_0_1.SettingsChangedEvent:1.0.0"
    ...
    class TransferLogEntry(Structure):
        idlType = "pdumodel.TransferSwitch_5_0_1.TransferLogEntry:1.0.0"
...
# interface
class Pdu(Interface):
    idlType = "pdumodel.Pdu:6.1.1"

    ERR_INVALID_PARAM = 1

    # enumeration
    class PduOrientation(Enumeration):
        idlType = "pdumodel.Pdu_6_1_1.PduOrientation:1.0.0"
    ...
    # structure
    class MetaData(Structure):
        idlType = "pdumodel.Pdu_6_1_1.MetaData:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.Pdu_6_1_1.Sensors:1.0.0"
    ...
    class Statistic(Structure):
        idlType = "pdumodel.Pdu_6_1_1.Statistic:1.0.0"
    ...
    # enumeration
    class StartupState(Enumeration):
        idlType = "pdumodel.Pdu_6_1_1.StartupState:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.Pdu_6_1_1.Settings:1.0.0"
    ...
    class OutletSequenceState(Structure):
        idlType = "pdumodel.Pdu_6_1_1.OutletSequenceState:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Pdu_6_1_1.SettingsChangedEvent:1.0.0"
    ...
    class LoadSheddingModeChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Pdu_6_1_1.LoadSheddingModeChangedEvent:1.0.0"
    ...
    class OutletSequenceStateChangedEvent(raritan.rpc.idl.Event):
        idlType = "pdumodel.Pdu_6_1_1.OutletSequenceStateChangedEvent:1.0.0"
...
class PowerMeterController(Interface):
    idlType = "pdumodel.PowerMeterController:1.2.8"
    ...
    class ScanResult(Structure):
        idlType = "pdumodel.PowerMeterController_1_2_8.ScanResult:1.0.0"
    ...
    class PowerMeterCreatedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.PowerMeterController_1_2_8.PowerMeterCreatedEvent:1.0.0"
    ...
    class PowerMeterDeletedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.PowerMeterController_1_2_8.PowerMeterDeletedEvent:1.0.0"
    ...
    class PanelCreatedEvent(PowerMeterCreatedEvent):
        idlType = "pdumodel.PowerMeterController_1_2_8.PanelCreatedEvent:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                ...
                # for pdumodel.PowerMeterController_1_2_8.PowerMeterCreatedEvent
                powerMeter = Interface.decode(json['powerMeter'], agent),
                config = raritan.rpc.pdumodel.PowerMeter.Config.decode(json['config'], agent),
                settings = raritan.rpc.pdumodel.PowerMeter.Settings.decode(json['settings'], agent),
                # for event.UserEvent
    ...
    class PanelDeletedEvent(PowerMeterDeletedEvent):
        idlType = "pdumodel.PowerMeterController_1_2_8.PanelDeletedEvent:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                panelSettings = raritan.rpc.pdumodel.Panel.PanelSettings.decode(json['panelSettings'], agent),
                # for pdumodel.PowerMeterController_1_2_8.PowerMeterDeletedEvent
                config = raritan.rpc.pdumodel.PowerMeter.Config.decode(json['config'], agent),
                settings = raritan.rpc.pdumodel.PowerMeter.Settings.decode(json['settings'], agent),
                # for event.UserEvent
                actUserName = json['actUserName'],
...
class TypeBResidualCurrentNumericSensor(raritan.rpc.sensors.NumericSensor):
    idlType = "pdumodel.TypeBResidualCurrentNumericSensor:1.0.4"
...
class VoltageMonitoringSensor(raritan.rpc.sensors.NumericSensor):
    idlType = "pdumodel.VoltageMonitoringSensor:1.0.0"

    # enumeration
    class EventType(Enumeration):
        idlType = "pdumodel.VoltageMonitoringSensor.EventType:1.0.0"
    ...
    class DipSwellThresholds(Structure):
        idlType = "pdumodel.VoltageMonitoringSensor.DipSwellThresholds:1.0.0"
    ...
    class Event(Structure):
        idlType = "pdumodel.VoltageMonitoringSensor.Event:1.0.0"
    ...
    class EventOccurredEvent(raritan.rpc.idl.Event):
        idlType = "pdumodel.VoltageMonitoringSensor.EventOccurredEvent:1.0.0"
    ...
    class EventListClearedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.VoltageMonitoringSensor.EventListClearedEvent:1.0.0"
    ...
    class DipSwellThresholdsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.VoltageMonitoringSensor.DipSwellThresholdsChangedEvent:1.0.0"
