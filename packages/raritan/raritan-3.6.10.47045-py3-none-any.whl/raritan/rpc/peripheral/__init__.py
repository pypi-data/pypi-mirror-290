...
class PortType(Enumeration):
    idlType = "peripheral.PortType:2.0.0"
    values = ["ONBOARD", "DEV_PORT", "ONEWIRE_HUB_PORT", "ONEWIRE_CHAIN_POS", "REMOTE_HUB_PORT"]
...
class PosElement(Structure):
    idlType = "peripheral.PosElement:2.0.0"
...
class Address(Structure):
    idlType = "peripheral.Address:5.0.0"
...
class Device(ValueObject):
    idlType = "peripheral.Device:4.0.0"
...
class DeviceSlot(Interface):
    idlType = "peripheral.DeviceSlot:3.0.0"
    ...
    class Location(Structure):
        idlType = "peripheral.DeviceSlot_3_0_0.Location:1.0.0"
        elements = ["x", "y", "z"]
    ...
    class Settings(Structure):
        idlType = "peripheral.DeviceSlot_3_0_0.Settings:1.0.0"
    ...
    class DeviceChangedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceSlot_3_0_0.DeviceChangedEvent:1.0.0"
    ...
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "peripheral.DeviceSlot_3_0_0.SettingsChangedEvent:1.0.0"
...
class PackageInfo(Structure):
    idlType = "peripheral.PackageInfo:3.0.0"
    ...
    class State(Enumeration):
        idlType = "peripheral.PackageInfo_3_0_0.State:1.0.0"
    ...
    class HardwareInfo(Structure):
        idlType = "peripheral.PackageInfo_3_0_0.HardwareInfo:1.0.0"
    ...
    class FirmwareInfo(Structure):
        idlType = "peripheral.PackageInfo_3_0_0.FirmwareInfo:1.0.0"
        ...
        class Version(Structure):
            idlType = "peripheral.PackageInfo_3_0_0.FirmwareInfo.Version:1.0.0"
...
class Package(Interface):
    idlType = "peripheral.Package:2.0.0"
...
class DoorHandleControllerPackage(Package):
    idlType = "peripheral.DoorHandleControllerPackage:2.0.0"
...
class SensorHub(Interface):
    idlType = "peripheral.SensorHub:1.0.0"

    # enumeration
    class UpstreamType(Enumeration):
        idlType = "peripheral.SensorHub.UpstreamType:1.0.0"
    ...
    class HubPortInfo(Structure):
        idlType = "peripheral.SensorHub.HubPortInfo:1.0.0"
    ...
    class DeviceInfo(Structure):
        idlType = "peripheral.SensorHub.DeviceInfo:1.0.0"
...
class DeviceManager(Interface):
    idlType = "peripheral.DeviceManager:4.0.0"

    ERR_INVALID_PARAMS = 1

    # enumeration
    class ZCoordMode(Enumeration):
        idlType = "peripheral.DeviceManager_4_0_0.ZCoordMode:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "peripheral.DeviceManager_4_0_0.Settings:1.0.0"
    ...
    class MetaData(Structure):
        idlType = "peripheral.DeviceManager_4_0_0.MetaData:1.0.0"
    ...
    class DeviceTypeInfo(Structure):
        idlType = "peripheral.DeviceManager_4_0_0.DeviceTypeInfo:1.0.0"
    ...
    class FirmwareUpdateState(Structure):
        idlType = "peripheral.DeviceManager_4_0_0.FirmwareUpdateState:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "peripheral.DeviceManager_4_0_0.SettingsChangedEvent:1.0.0"
    ...
    class DeviceEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_4_0_0.DeviceEvent:1.0.0"
    ...
    class DeviceAddedEvent(DeviceEvent):
        idlType = "peripheral.DeviceManager_4_0_0.DeviceAddedEvent:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                # for peripheral.DeviceManager_4_0_0.DeviceEvent
                devices = [ValueObject.decode(x0, agent) for x0 in json['devices']],
                allDevices = [ValueObject.decode(x0, agent) for x0 in json['allDevices']],
                # for idl.Event
                source = Interface.decode(json['source'], agent),
    ...
    class DeviceRemovedEvent(DeviceEvent):
        idlType = "peripheral.DeviceManager_4_0_0.DeviceRemovedEvent:1.0.0"
    ...
    class UnknownDeviceAttachedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_4_0_0.UnknownDeviceAttachedEvent:1.0.0"
    ...
    class DeviceFirmwareUpdateState(Enumeration):
        idlType = "peripheral.DeviceManager_4_0_0.DeviceFirmwareUpdateState:1.0.0"
    ...
    class DeviceFirmwareUpdateStateChangedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_4_0_0.DeviceFirmwareUpdateStateChangedEvent:1.0.0"
    ...
    class FirmwareUpdateStateChangedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_4_0_0.FirmwareUpdateStateChangedEvent:1.0.0"
    ...
    class PackageEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_4_0_0.PackageEvent:1.0.0"
    ...
    class PackageAddedEvent(PackageEvent):
        idlType = "peripheral.DeviceManager_4_0_0.PackageAddedEvent:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                # for peripheral.DeviceManager_4_0_0.PackageEvent
                packageInfos = [raritan.rpc.peripheral.PackageInfo.decode(x0, agent) for x0 in json['packageInfos']],
                allPackages = [raritan.rpc.peripheral.PackageInfo.decode(x0, agent) for x0 in json['allPackages']],
                # for idl.Event
                source = Interface.decode(json['source'], agent),
    ...
    class PackageRemovedEvent(PackageEvent):
        idlType = "peripheral.DeviceManager_4_0_0.PackageRemovedEvent:1.0.0"
    ...
    class Statistics(Structure):
        idlType = "peripheral.DeviceManager_4_0_0.Statistics:1.0.0"
        elements = ["cSumErrCnt"]
