...
class ResidualCurrentStateSensor(raritan.rpc.sensors.StateSensor):
    idlType = "pdumodel.ResidualCurrentStateSensor:2.0.4"
...
class Pole(Structure):
    idlType = "pdumodel.Pole:7.0.0"
    elements = ["label", "line", "nodeId", "voltage", "voltageLN", "current", "peakCurrent", "activePower", "reactivePower", "apparentPower", "powerFactor", "phaseAngle", "displacementPowerFactor", "activeEnergy", "apparentEnergy", "residualCurrent", "residualACCurrent", "residualDCCurrent", "crestFactor", "residualCurrentStatus"]

    def __init__(self, label, line, nodeId, voltage, voltageLN, current, peakCurrent, activePower, reactivePower, apparentPower, powerFactor, phaseAngle, displacementPowerFactor, activeEnergy, apparentEnergy, residualCurrent, residualACCurrent, residualDCCurrent, crestFactor, residualCurrentStatus):
...
class DoublePole(Structure):
    idlType = "pdumodel.DoublePole:6.0.0"
...
class Circuit(Interface):
    idlType = "pdumodel.Circuit:1.0.5"
    ...
    class Type(Enumeration):
        idlType = "pdumodel.Circuit_1_0_5.Type:1.0.0"
    ...
    class Config(Structure):
        idlType = "pdumodel.Circuit_1_0_5.Config:1.0.0"
    ...
    class Sensors(Structure):
        idlType = "pdumodel.Circuit_1_0_5.Sensors:1.0.0"
    ...
    class PoleSettings(Structure):
        idlType = "pdumodel.Circuit_1_0_5.PoleSettings:1.0.0"
    ...
    class Settings(Structure):
        idlType = "pdumodel.Circuit_1_0_5.Settings:1.0.0"
    ...
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Circuit_1_0_5.SettingsChangedEvent:1.0.0"
...
# interface
class Inlet(EDevice):
    idlType = "pdumodel.Inlet:2.0.7"

    # structure
    class MetaData(Structure):
        idlType = "pdumodel.Inlet_2_0_7.MetaData:1.0.0"
        elements = ["label", "plugType", "namePlate", "rating", "isDC"]

        def __init__(self, label, plugType, namePlate, rating, isDC):
            typecheck.is_string(label, AssertionError)
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.Inlet_2_0_7.Sensors:1.0.0"
        elements = ["voltage", "current", "peakCurrent", "residualCurrent", "residualACCurrent", "residualDCCurrent", "activePower", "reactivePower", "apparentPower", "powerFactor", "displacementPowerFactor", "activeEnergy", "apparentEnergy", "unbalancedCurrent", "lineFrequency", "phaseAngle", "crestFactor", "powerQuality", "surgeProtectorStatus", "residualCurrentStatus"]
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.Inlet_2_0_7.Settings:1.0.0"
        elements = ["name"]
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Inlet_2_0_7.SettingsChangedEvent:1.0.0"
    ...
    class EnableStateChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Inlet_2_0_7.EnableStateChangedEvent:1.0.0"
...
class OverCurrentProtector(EDevice):
    idlType = "pdumodel.OverCurrentProtector:3.0.8"

    # enumeration
    class Type(Enumeration):
        idlType = "pdumodel.OverCurrentProtector_3_0_8.Type:1.0.0"
    ...
    # structure
    class MetaData(Structure):
        idlType = "pdumodel.OverCurrentProtector_3_0_8.MetaData:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.OverCurrentProtector_3_0_8.Sensors:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.OverCurrentProtector_3_0_8.Settings:1.0.0"
        elements = ["name"]
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OverCurrentProtector_3_0_8.SettingsChangedEvent:1.0.0"
...
class Outlet(EDevice):
    ...
    # structure
    class MetaData(Structure):
        idlType = "pdumodel.Outlet_2_1_9.MetaData:1.0.0"
    ...
    class PowerState(Enumeration):
        idlType = "pdumodel.Outlet_2_1_9.PowerState:1.0.0"
        values = ["PS_OFF", "PS_ON"]
    ...
    class LedState(Structure):
        idlType = "pdumodel.Outlet_2_1_9.LedState:1.0.0"
    ...
    class State(Structure):
        idlType = "pdumodel.Outlet_2_1_9.State:1.0.0"
    ...
    class StartupState(Enumeration):
        idlType = "pdumodel.Outlet_2_1_9.StartupState:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.Outlet_2_1_9.Settings:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.Outlet_2_1_9.Sensors:1.0.0"
    ...
    class PowerControlEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Outlet_2_1_9.PowerControlEvent:1.0.0"
    ...
    class StateChangedEvent(raritan.rpc.idl.Event):
        idlType = "pdumodel.Outlet_2_1_9.StateChangedEvent:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Outlet_2_1_9.SettingsChangedEvent:1.0.0"
...
class OutletGroup(Interface):
    idlType = "pdumodel.OutletGroup:1.0.5"

    ERR_INVALID_ARGUMENT = 1

    # structure
    class Sensors(Structure):
        idlType = "pdumodel.OutletGroup_1_0_5.Sensors:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.OutletGroup_1_0_5.Settings:1.0.0"
    ...
    # structure
    class MetaData(Structure):
        idlType = "pdumodel.OutletGroup_1_0_5.MetaData:1.0.0"
    ...
    class SensorsChangedEvent(raritan.rpc.idl.Event):
        idlType = "pdumodel.OutletGroup_1_0_5.SensorsChangedEvent:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OutletGroup_1_0_5.SettingsChangedEvent:1.0.0"
    ...
    # value object
    class PowerControlEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OutletGroup_1_0_5.PowerControlEvent:1.0.0"
...
class OutletGroupManager(Interface):
    idlType = "pdumodel.OutletGroupManager:1.0.5"
    ...
    class GroupCreatedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OutletGroupManager_1_0_5.GroupCreatedEvent:1.0.0"
    ...
    class GroupDeletedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.OutletGroupManager_1_0_5.GroupDeletedEvent:1.0.0"
...
class OverCurrentProtectorTripSensor(raritan.rpc.sensors.StateSensor):
    idlType = "pdumodel.OverCurrentProtectorTripSensor:1.0.9"

    # value object
    class TripStateChangedEvent(raritan.rpc.sensors.StateSensor.StateChangedEvent):
        idlType = "pdumodel.OverCurrentProtectorTripSensor_1_0_9.TripStateChangedEvent:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                ...
                # for sensors.StateSensor_4_0_4.StateChangedEvent
...
class PowerMeter(Interface):
    idlType = "pdumodel.PowerMeter:1.1.7"
    ...
    # enumeration
    class Type(Enumeration):
        idlType = "pdumodel.PowerMeter_1_1_7.Type:1.0.0"
    ...
    # structure
    class Config(Structure):
        idlType = "pdumodel.PowerMeter_1_1_7.Config:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.PowerMeter_1_1_7.Sensors:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.PowerMeter_1_1_7.Settings:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.PowerMeter_1_1_7.SettingsChangedEvent:1.0.0"
    ...
    class EnergyPulseSettings(Structure):
        idlType = "pdumodel.PowerMeter_1_1_7.EnergyPulseSettings:1.0.0"
    ...
    class EnergyPulseSettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.PowerMeter_1_1_7.EnergyPulseSettingsChangedEvent:1.0.0"
...
class Panel(PowerMeter):
    idlType = "pdumodel.Panel:1.1.7"

    # enumeration
    class LabelingScheme(Enumeration):
        idlType = "pdumodel.Panel_1_1_7.LabelingScheme:1.0.0"
    ...
    class PanelSettings(Structure):
        idlType = "pdumodel.Panel_1_1_7.PanelSettings:1.0.0"
    ...
    class PanelSettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Panel_1_1_7.PanelSettingsChangedEvent:1.0.0"
    ...
    class CircuitCreatedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Panel_1_1_7.CircuitCreatedEvent:1.0.0"
    ...
    class CircuitDeletedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Panel_1_1_7.CircuitDeletedEvent:1.0.0"
...
class TransferSwitch(EDevice):
    idlType = "pdumodel.TransferSwitch:4.0.6"
    ...
    # enumeration
    class Type(Enumeration):
        idlType = "pdumodel.TransferSwitch_4_0_6.Type:1.0.0"
        values = ["STS", "ATS", "HTS"]
    ...
    class TransferReason(Enumeration):
        idlType = "pdumodel.TransferSwitch_4_0_6.TransferReason:1.0.0"
    ...
    # structure
    class MetaData(Structure):
        idlType = "pdumodel.TransferSwitch_4_0_6.MetaData:1.0.0"
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.TransferSwitch_4_0_6.Sensors:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.TransferSwitch_4_0_6.Settings:1.0.0"
    ...
    class Statistics(Structure):
        idlType = "pdumodel.TransferSwitch_4_0_6.Statistics:1.0.0"
    ...
    class WaveformSample(Structure):
        idlType = "pdumodel.TransferSwitch_4_0_6.WaveformSample:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.TransferSwitch_4_0_6.SettingsChangedEvent:1.0.0"
    ...
    class TransferLogEntry(Structure):
        idlType = "pdumodel.TransferSwitch_4_0_6.TransferLogEntry:1.0.0"
...
# interface
class Pdu(Interface):
    idlType = "pdumodel.Pdu:5.1.4"

    ERR_INVALID_PARAM = 1

    # structure
    class MetaData(Structure):
        idlType = "pdumodel.Pdu_5_1_4.MetaData:1.0.0"
        elements = ["nameplate", "ctrlBoardSerial", "hwRevision", "fwRevision", "macAddress", "hasSwitchableOutlets", "hasMeteredOutlets", "hasLatchingOutletRelays", "isInlineMeter", "isEnergyPulseSupported", "hasDCInlets"]

        def __init__(self, nameplate, ctrlBoardSerial, hwRevision, fwRevision, macAddress, hasSwitchableOutlets, hasMeteredOutlets, hasLatchingOutletRelays, isInlineMeter, isEnergyPulseSupported, hasDCInlets):
            typecheck.is_struct(nameplate, raritan.rpc.pdumodel.Nameplate, AssertionError)
    ...
    # structure
    class Sensors(Structure):
        idlType = "pdumodel.Pdu_5_1_4.Sensors:1.0.0"
    ...
    class Statistic(Structure):
        idlType = "pdumodel.Pdu_5_1_4.Statistic:1.0.0"
    ...
    # enumeration
    class StartupState(Enumeration):
        idlType = "pdumodel.Pdu_5_1_4.StartupState:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "pdumodel.Pdu_5_1_4.Settings:1.0.0"
        elements = ["name", "startupState", "cycleDelay", "inRushGuardDelay", "outletPowerStateSequence", "powerOnDelay", "latchingRelays", "energyPulseEnabled", "energyPulsesPerKWh", "demandUpdateInterval", "demandAveragingIntervals"]

        def __init__(self, name, startupState, cycleDelay, inRushGuardDelay, outletPowerStateSequence, powerOnDelay, latchingRelays, energyPulseEnabled, energyPulsesPerKWh, demandUpdateInterval, demandAveragingIntervals):
            typecheck.is_string(name, AssertionError)
    ...
    class OutletSequenceState(Structure):
        idlType = "pdumodel.Pdu_5_1_4.OutletSequenceState:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Pdu_5_1_4.SettingsChangedEvent:1.0.0"
    ...
    class LoadSheddingModeChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.Pdu_5_1_4.LoadSheddingModeChangedEvent:1.0.0"
    ...
    class OutletSequenceStateChangedEvent(raritan.rpc.idl.Event):
        idlType = "pdumodel.Pdu_5_1_4.OutletSequenceStateChangedEvent:1.0.0"
...
class PowerMeterController(Interface):
    idlType = "pdumodel.PowerMeterController:1.1.7"
    ...
    class ScanResult(Structure):
        idlType = "pdumodel.PowerMeterController_1_1_7.ScanResult:1.0.0"
    ...
    class PowerMeterCreatedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.PowerMeterController_1_1_7.PowerMeterCreatedEvent:1.0.0"
    ...
    class PowerMeterDeletedEvent(raritan.rpc.event.UserEvent):
        idlType = "pdumodel.PowerMeterController_1_1_7.PowerMeterDeletedEvent:1.0.0"
    ...
    class PanelCreatedEvent(PowerMeterCreatedEvent):
        idlType = "pdumodel.PowerMeterController_1_1_7.PanelCreatedEvent:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                ...
                # for pdumodel.PowerMeterController_1_1_7.PowerMeterCreatedEvent
                powerMeter = Interface.decode(json['powerMeter'], agent),
                config = raritan.rpc.pdumodel.PowerMeter.Config.decode(json['config'], agent),
                settings = raritan.rpc.pdumodel.PowerMeter.Settings.decode(json['settings'], agent),
                # for event.UserEvent
    ...
    class PanelDeletedEvent(PowerMeterDeletedEvent):
        idlType = "pdumodel.PowerMeterController_1_1_7.PanelDeletedEvent:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                panelSettings = raritan.rpc.pdumodel.Panel.PanelSettings.decode(json['panelSettings'], agent),
                # for pdumodel.PowerMeterController_1_1_7.PowerMeterDeletedEvent
                config = raritan.rpc.pdumodel.PowerMeter.Config.decode(json['config'], agent),
                settings = raritan.rpc.pdumodel.PowerMeter.Settings.decode(json['settings'], agent),
                # for event.UserEvent
                actUserName = json['actUserName'],
...
class PowerQualitySensor(raritan.rpc.sensors.StateSensor):
    idlType = "pdumodel.PowerQualitySensor:2.0.4"
...
class TypeBResidualCurrentNumericSensor(raritan.rpc.sensors.NumericSensor):
    idlType = "pdumodel.TypeBResidualCurrentNumericSensor:1.0.3"
