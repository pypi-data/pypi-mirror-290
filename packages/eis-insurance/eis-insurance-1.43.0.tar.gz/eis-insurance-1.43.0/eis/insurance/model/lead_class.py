...
class LeadClass(ModelNormal):
    ...
    attribute_map = {
        ...
        'lead_number': 'leadNumber',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, code, ern, status, account, policy, created_at, updated_at, validate, lead_number, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            validate (bool): A indicator to validate the lead.
            lead_number (str): Lead number.
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, code, ern, status, account, policy, created_at, updated_at, validate, lead_number, *args, **kwargs):  # noqa: E501
        """LeadClass - a model defined in OpenAPI
