...
class PolicyPartnerRoleClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, code, name, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """PolicyPartnerRoleClass - a model defined in OpenAPI
        ...
        Args:
            ...
            name (str): Name of the policy partner role.
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, code, name, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """PolicyPartnerRoleClass - a model defined in OpenAPI
