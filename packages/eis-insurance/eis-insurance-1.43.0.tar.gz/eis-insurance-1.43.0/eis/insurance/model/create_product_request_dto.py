...
class CreateProductRequestDto(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'insured_object_types': ([str],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, insured_object_types, contract_duration_days, slug, default_language, *args, **kwargs):  # noqa: E501
        """CreateProductRequestDto - a model defined in OpenAPI

        Args:
            name (str): Product name.
            insured_object_types ([str]): Insured object types covered under product.
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, insured_object_types, contract_duration_days, slug, default_language, *args, **kwargs):  # noqa: E501
        """CreateProductRequestDto - a model defined in OpenAPI
