...
class InsuredObjectTypeClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, slug, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """InsuredObjectTypeClass - a model defined in OpenAPI

        Args:
            id (float): Internal unique identifier for the object. You should not have to use this, use code instead.
            name (str): Insured object type name.
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, slug, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """InsuredObjectTypeClass - a model defined in OpenAPI
