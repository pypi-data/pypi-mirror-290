...
class PatchDraftPolicyRequestDto(ModelNormal):
    ...
    attribute_map = {
        ...
        'revision_status': 'revisionStatus',  # noqa: E501
        'to': 'to',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, policy_objects, _from, revision_status, *args, **kwargs):  # noqa: E501
        """PatchDraftPolicyRequestDto - a model defined in OpenAPI

        Args:
            policy_objects ([PolicyObjectDto]): Policy objects
            _from (datetime): Date from which the policy should be updated. This will create a new timeline starting from this date.
            revision_status (str): Policy revision status.
    ...
    @convert_js_args_to_python_args
    def __init__(self, policy_objects, _from, revision_status, *args, **kwargs):  # noqa: E501
        """PatchDraftPolicyRequestDto - a model defined in OpenAPI
