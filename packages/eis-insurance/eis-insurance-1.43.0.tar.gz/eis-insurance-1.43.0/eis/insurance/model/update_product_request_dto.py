...
class UpdateProductRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, contract_duration_days, slug, id, *args, **kwargs):  # noqa: E501
        """UpdateProductRequestDto - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, contract_duration_days, slug, id, *args, **kwargs):  # noqa: E501
        """UpdateProductRequestDto - a model defined in OpenAPI
