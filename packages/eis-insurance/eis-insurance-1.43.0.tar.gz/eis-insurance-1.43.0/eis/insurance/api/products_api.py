...
class ProductsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_product_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/insuranceservice/v1/products',
        ...
        self.delete_product_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/insuranceservice/v1/products/{id}',
        ...
        self.get_product_by_code_endpoint = _Endpoint(
            settings={
                'response_type': (GetProductResponseClass,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/insuranceservice/v1/products/code/{code}',
                'operation_id': 'get_product_by_code',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_product_by_identifier_endpoint = _Endpoint(
            settings={
                'response_type': (GetProductResponseClass,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/insuranceservice/v1/products/get-by-identifier',
        ...
        self.update_product_endpoint = _Endpoint(
            settings={
                'response_type': (UpdateProductResponseClass,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/insuranceservice/v1/products/{id}',
            ...
            root_map={
                ...
                'location_map': {
                    'id': 'path',
                    'update_product_request_dto': 'body',
                    'authorization': 'header',
                },
                'collection_format_map': {
                }
    ...
    def create_product(
        ...
        **kwargs
        ...
        Create a blank product. The product cannot be used as long    as it is missing product factors, insured objects and premium formulas.  # noqa: E501
    ...
    def delete_product(
        ...
        **kwargs
        ...
        Permanently deletes the product. Supply the unique id that was returned when you created the product and this will delete it.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_products(
        ...
        **kwargs
        ...
        Keyword Args:
            ...
            expand (str): You can expand product versions and insured object types list in this endpoint. By default, versions & insuredObjectTypes will be an empty array.. [optional]
    ...
    def update_product(
        ...
        **kwargs
        ...
        >>> thread = api.update_product(id, update_product_request_dto, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        kwargs['update_product_request_dto'] = \
            update_product_request_dto
