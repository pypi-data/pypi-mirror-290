...
class StatusTransitionRulesApi(object):
    ...
    def create_status_transition_rule(
        ...
        **kwargs
        ...
        This will create a status transition rule. Status transition rules allow or deny a transition from        one status to another based on custom conditions.  # noqa: E501
    ...
    def delete_status_transition_rule(
        ...
        **kwargs
        ...
        Permanently deletes the status transition rule. Supply the unique code that was returned when you created the status transition rule and this will delete it.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_status_transition_rule(
        ...
        **kwargs
        ...
        Retrieves the details of the status transition rule that was previously created. Supply the unique status transition rule code that was returned when you created it and Emil Api will return the corresponding status transition rule information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_status_transition_rules(
        ...
        **kwargs
        ...
        Returns a list of status transition rules you have previously created. The status transition rules are returned in sorted order, with the oldest one appearing first. For more information about pagination, read the Pagination documentation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def patch_status_transition_rule(
        ...
        **kwargs
        ...
        Updates the specified status transition rule by setting the values of the parameters passed.       Any parameters not provided will be left unchanged.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
