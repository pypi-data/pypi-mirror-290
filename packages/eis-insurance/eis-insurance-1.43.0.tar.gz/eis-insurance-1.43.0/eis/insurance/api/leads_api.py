...
class LeadsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_lead_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/insuranceservice/v1/leads',
        ...
        self.create_lead_async_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/insuranceservice/v1/leads-async',
        ...
        self.create_lead_sync_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/insuranceservice/v1/leads-sync',
        ...
        self.delete_lead_endpoint = _Endpoint(
            settings={
                'response_type': (DeleteResponseClass,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/insuranceservice/v1/leads/{code}',
        ...
        self.patch_lead_endpoint = _Endpoint(
            settings={
                'response_type': (PatchLeadResponseClass,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/insuranceservice/v1/leads/{code}',
        ...
        self.update_lead_sync_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/insuranceservice/v1/leads-sync/{code}',
    ...
    def delete_lead(
        ...
        **kwargs
        ...
        Permanently deletes the lead. Supply the unique code that was returned when you created the lead and this will delete it.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_lead(code, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['code'] = \
            code
        return self.delete_lead_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_lead(
        ...
        **kwargs
        ...
        >>> thread = api.patch_lead(code, patch_lead_request_dto, async_req=True)
        >>> result = thread.get()

        Args:
            code (str): Unique identifier for the object.
            patch_lead_request_dto (PatchLeadRequestDto):
        ...
        kwargs['code'] = \
            code
        kwargs['patch_lead_request_dto'] = \
            patch_lead_request_dto
        return self.patch_lead_endpoint.call_with_http_info(**kwargs)
