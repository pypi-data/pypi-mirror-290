...
class LeadVersionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_lead_version_endpoint = _Endpoint(
            settings={
                'response_type': (GetLeadVersionResponseClass,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/insuranceservice/v1/leads/{code}/versions/{version}',
                'operation_id': 'get_lead_version',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_lead_versions_endpoint = _Endpoint(
            settings={
                'response_type': (ListLeadVersionsResponseClass,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/insuranceservice/v1/leads/{code}/versions',
                'operation_id': 'list_lead_versions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_lead_version(
        ...
        **kwargs
        ...
        Retrieves the details of the lead version that was previously created. Supply the unique lead version code that was returned when you created it and Emil Api will return the corresponding lead version information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_lead_version(code, version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['version'] = \
            version
        return self.get_lead_version_endpoint.call_with_http_info(**kwargs)

    def list_lead_versions(
        self,
        code,
        **kwargs
    ):
        ...
        Returns a list of lead versions you have previously created. The lead versions are returned in sorted order, with the oldest one appearing first. For more information about pagination, read the Pagination documentation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_lead_versions(code, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['code'] = \
            code
        return self.list_lead_versions_endpoint.call_with_http_info(**kwargs)
