...
class ProductFactorsApi(object):
    ...
    def get_product_factor(
        ...
        **kwargs
        ...
        Retrieves the details of the product factor that was previously created. Supply the unique product factor id that was returned when you created it and Emil Api will return the corresponding product factor information.  # noqa: E501
    ...
    def get_product_factor_value(
        ...
        **kwargs
        ...
        Get the value corresponding to a specific product factor.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_product_factors_for_version(
        ...
        **kwargs
        ...
        Returns product factors without values (values=none),     or with values if their number less or equal to 200 (values=short),     or with all values (values=all - this may take several seconds).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def store_product_factors(
        ...
        **kwargs
        ...
        Upload a CSV file containing product factors necessary for a product.     The columns must be in the following order: group,label,key,name,value. It is advised to validate     the file first.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def validate_product_factors(
        ...
        **kwargs
        ...
        Validate a CSV file containing all product factors.     The columns must be in the following order: group,label,key,name,value.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
