...
class PolicyClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, code, policy_number, product_version_id, product_id, account_code, status, versions, policy_start_date, created_at, updated_at, ern, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, code, policy_number, product_version_id, product_id, account_code, status, versions, policy_start_date, created_at, updated_at, ern, *args, **kwargs):  # noqa: E501
        """PolicyClass - a model defined in OpenAPI
