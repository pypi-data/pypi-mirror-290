...
class ListPolicyPartnerRolesResponseClass(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([PolicyPartnerRoleClass],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, next_page_token, *args, **kwargs):  # noqa: E501
        """ListPolicyPartnerRolesResponseClass - a model defined in OpenAPI

        Args:
            items ([PolicyPartnerRoleClass]): The list of policy partner roles.
