...
from papertlab import __version__, urls, utils
from papertlab.dump import dump  # noqa: F401

papertlab_user_agent = f"papertlab/{__version__} +{urls.website}"
...
def install_playwright(io):
    ...
    pip_cmd = utils.get_pip_install(["papert-lab[playwright]"])
...
class Scraper:
    ...
    def scrape_with_playwright(self, url):
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                user_agent = user_agent.replace("headless", "")
                user_agent += " " + papertlab_user_agent
    ...
    def scrape_with_httpx(self, url):
        ...
        headers = {"User-Agent": f"Mozilla./5.0 ({papertlab_user_agent})"}
        try:
