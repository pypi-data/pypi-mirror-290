...
class TMAAuthenticator():
    ...
    token_creator: TMAAuthenticationRouter

    def __init__(self, bot_token: str, admin_password: str, storage_provider: StorageProvider):
        self.bot_token = bot_token
        self.admin_password = admin_password
        self.storage_provider = storage_provider
        self.token_creator = TMAAuthenticationRouter(admin_password=self.admin_password, storage_provider=self.storage_provider)

    @property
    def authentication_router(self):
        return self.token_creator
