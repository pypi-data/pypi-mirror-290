...
from typing import Union, Any, AsyncIterator, List, Iterator, Literal, Tuple, Optional
...
class PartialLabelViewInput(BaseModel):
    ...
    c_min: Optional[int] = Field(alias="cMin", default=None)
    c_max: Optional[int] = Field(alias="cMax", default=None)
    fluorophore: Optional[ID] = None
    primary_antibody: Optional[ID] = Field(alias="primaryAntibody", default=None)
    secondary_antibody: Optional[ID] = Field(alias="secondaryAntibody", default=None)
...
class LabelViewFluorophoreKind(BaseModel):
...
class LabelViewPrimaryantibodyKind(BaseModel):
    typename: Optional[Literal["EntityKind"]] = Field(alias="__typename", exclude=True)
    id: ID
    label: str
...
class LabelViewSecondaryantibodyKind(BaseModel):
    typename: Optional[Literal["EntityKind"]] = Field(alias="__typename", exclude=True)
    id: ID
    label: str
...
class SpecimenEntityKind(BaseModel):
    typename: Optional[Literal["EntityKind"]] = Field(alias="__typename", exclude=True)
    id: ID
    label: str
...
class EntityRelationKindLeftkind(BaseModel):
    typename: Optional[Literal["EntityKind"]] = Field(alias="__typename", exclude=True)
    id: ID
...
class EntityRelationKindRightkind(BaseModel):
    typename: Optional[Literal["EntityKind"]] = Field(alias="__typename", exclude=True)
    id: ID
...
class EntityRelationKindKind(BaseModel):
    typename: Optional[Literal["EntityKind"]] = Field(alias="__typename", exclude=True)
    id: ID
...
class CreateEntityKindMutationCreateentitykind(BaseModel):
    typename: Optional[Literal["EntityKind"]] = Field(alias="__typename", exclude=True)
    id: ID
    label: str
...
class CreateEntityKindMutation(BaseModel):
    ...
    class Meta:
        document = "mutation CreateEntityKind($label: String!, $ontology: ID, $purl: String, $description: String) {\n  createEntityKind(\n    input: {label: $label, ontology: $ontology, description: $description, purl: $purl}\n  ) {\n    id\n    label\n  }\n}"
...
class SearchEntityKindQueryOptions(BaseModel):
    typename: Optional[Literal["EntityKind"]] = Field(alias="__typename", exclude=True)
    value: ID
    label: str
