...
class RequestUtil:
    ...
    def post(url, json=None, headers=None):
        return RequestUtil._request('post', url, json=json, headers=headers)

    @staticmethod
    def put(url, json=None, headers=None):
        return RequestUtil._request('put', url, json=json, headers=headers)
    ...
    @staticmethod
    def post_with_file(url, headers=None, files=None):
        return RequestUtil._request('post', url, files=files, headers=headers)
