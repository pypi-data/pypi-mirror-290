...
__all__ = (
    ...
    "HealthCheckConfigExtraOutputTypeDef",
...
HealthCheckConfigExtraOutputTypeDef = TypedDict(
    "HealthCheckConfigExtraOutputTypeDef",
    {
...
HealthCheckConfigUnionTypeDef = Union[HealthCheckConfigTypeDef, HealthCheckConfigExtraOutputTypeDef]
...
ResourceRecordSetExtraOutputTypeDef = TypedDict(
    "ResourceRecordSetExtraOutputTypeDef",
    {
        "Name": str,
        "Type": RRTypeType,
...
ListResourceRecordSetsResponseTypeDef = TypedDict(
    "ListResourceRecordSetsResponseTypeDef",
    {
        "ResourceRecordSets": List[ResourceRecordSetExtraOutputTypeDef],
        "IsTruncated": bool,
        "NextRecordName": str,
