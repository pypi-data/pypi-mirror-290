...
from ..utils.scalers_transformers import PcaChooser, PolyChooser, SplineChooser, ScalerChooser, \
...
class EXGEP:
    ...
    n_weak_models: int, optional (default=0)
        ...
        in addition to 2 other 'lightgbm' models. Setting this parameter to non-zero allows the EXGEP model
    ...
    write_folder: str, optional (default='/result/' in the current working directory)
    ...
    models_to_optimize: list of str, optional (default=['lightgbm', 'xgboost', 'catboost', 'bayesianridge', 'lassolars'])
        ...
        Check documentation of EXGEP children classes for details
    ...
    def model_evaluate(self) -> EXGEP:
        ...
        models_to_assess = self.list_all_models_assess + ['EXGEP']
        ...
        for i, model in enumerate(models_to_assess):
            ...
            for idx_fold, fold in enumerate(indexes_test_cv):
                ...
                pred_results = pd.concat([pred_results, fold_results], ignore_index=True)
