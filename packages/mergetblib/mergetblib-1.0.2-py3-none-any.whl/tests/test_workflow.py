...
from mergetblib.workspace import Experiment
from mergetblib.realize import Realization
from mergetblib.materialize import Materialization
...
try:
    ...
    # Create experiment
    exp = Experiment("mergetblibtest", username)
    exp.create()
    ...
    try:
        ...
        raise Exception("realization did not succeed within %d seconds" % MTZ_TIMEOUT)
