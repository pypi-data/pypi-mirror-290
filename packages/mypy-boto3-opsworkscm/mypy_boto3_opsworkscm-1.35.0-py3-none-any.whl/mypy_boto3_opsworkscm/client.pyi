...
class OpsWorksCMClient(BaseClient):
    ...
    def associate_node(
        self, *, ServerName: str, NodeName: str, EngineAttributes: Sequence[EngineAttributeTypeDef]
    ) -> AssociateNodeResponseTypeDef:
        """
    ...
    def close(self) -> None:
        ...
        [Show boto3-stubs documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_opsworkscm/client/#close)
        """
