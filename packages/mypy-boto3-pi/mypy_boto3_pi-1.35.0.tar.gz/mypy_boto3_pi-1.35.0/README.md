...
[boto3.PI 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/pi.html#PI)
...
- Install `boto3-stubs[pi]` in your environment:
...
Install `boto3-stubs-lite[pi]` in your environment:
...
- Install `boto3-stubs[pi]` with services you use in your environment:
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_pi/literals/).

```python
from mypy_boto3_pi.literals import AcceptLanguageType


def check_value(value: AcceptLanguageType) -> bool: ...
```
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_pi/type_defs/).
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_pi/)
