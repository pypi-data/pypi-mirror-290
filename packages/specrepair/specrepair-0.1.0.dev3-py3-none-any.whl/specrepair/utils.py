...
def repair_spec(
    ...
    fault_segment: Annotated[str, "spec脚本中导致错误的代码片段，附带行号，按行号从小到大顺序"] = "",
...
def repair_spec_impl(
    ...
    sorted_delete_list_with_index = sorted(delete_list_with_index, key=lambda x: x[1][0], reverse=True)
