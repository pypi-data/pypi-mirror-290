...
class RDSClient(BaseClient):
    ...
    def delete_db_shard_group(self, *, DBShardGroupIdentifier: str) -> DBShardGroupResponseTypeDef:
        """
    ...
    def modify_db_shard_group(
        self, *, DBShardGroupIdentifier: str, MaxACU: float = ..., MinACU: float = ...
    ) -> DBShardGroupResponseTypeDef:
        """
    ...
    def reboot_db_shard_group(self, *, DBShardGroupIdentifier: str) -> DBShardGroupResponseTypeDef:
        """
