...
[boto3.RDS 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS)
...
describe_engine_default_cluster_parameters_paginator: (
    DescribeEngineDefaultClusterParametersPaginator
...
describe_reserved_db_instances_offerings_paginator: (
    DescribeReservedDBInstancesOfferingsPaginator
