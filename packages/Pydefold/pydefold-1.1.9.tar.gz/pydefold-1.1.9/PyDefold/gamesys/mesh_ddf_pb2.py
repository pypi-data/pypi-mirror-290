...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _MESHDESC_PRIMITIVETYPE.values_by_name["PRIMITIVE_LINES"]._serialized_options = b'\302\301\030\005Lines'
  _MESHDESC_PRIMITIVETYPE.values_by_name["PRIMITIVE_TRIANGLES"]._options = None
  _MESHDESC_PRIMITIVETYPE.values_by_name["PRIMITIVE_TRIANGLES"]._serialized_options = b'\302\301\030\tTriangles'
  _MESHDESC_PRIMITIVETYPE.values_by_name["PRIMITIVE_TRIANGLE_STRIP"]._options = None
  _MESHDESC_PRIMITIVETYPE.values_by_name["PRIMITIVE_TRIANGLE_STRIP"]._serialized_options = b'\302\301\030\016Triangle Strip'
  _MESHDESC.fields_by_name['material']._options = None
  _MESHDESC.fields_by_name['material']._serialized_options = b'\240\273\030\001'
  _MESHDESC.fields_by_name['vertices']._options = None
  _MESHDESC.fields_by_name['vertices']._serialized_options = b'\240\273\030\001'
  _MESHDESC.fields_by_name['textures']._options = None
  _MESHDESC.fields_by_name['textures']._serialized_options = b'\240\273\030\001'
