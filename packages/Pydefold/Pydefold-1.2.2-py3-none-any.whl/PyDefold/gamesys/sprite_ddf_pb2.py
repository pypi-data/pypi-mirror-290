...
# source: gamesys/sprite_ddf.proto
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SPRITETEXTURE.fields_by_name['texture']._serialized_options = b'\240\273\030\001'
  _SPRITEDESC_BLENDMODE.values_by_name["BLEND_MODE_ALPHA"]._options = None
  _SPRITEDESC_BLENDMODE.values_by_name["BLEND_MODE_ALPHA"]._serialized_options = b'\302\301\030\005Alpha'
  _SPRITEDESC_BLENDMODE.values_by_name["BLEND_MODE_ADD"]._options = None
  _SPRITEDESC_BLENDMODE.values_by_name["BLEND_MODE_ADD"]._serialized_options = b'\302\301\030\003Add'
  _SPRITEDESC_BLENDMODE.values_by_name["BLEND_MODE_ADD_ALPHA"]._options = None
  _SPRITEDESC_BLENDMODE.values_by_name["BLEND_MODE_ADD_ALPHA"]._serialized_options = b'\302\301\030\026Add Alpha (Deprecated)'
  _SPRITEDESC_BLENDMODE.values_by_name["BLEND_MODE_MULT"]._options = None
  _SPRITEDESC_BLENDMODE.values_by_name["BLEND_MODE_MULT"]._serialized_options = b'\302\301\030\010Multiply'
  _SPRITEDESC_BLENDMODE.values_by_name["BLEND_MODE_SCREEN"]._options = None
  _SPRITEDESC_BLENDMODE.values_by_name["BLEND_MODE_SCREEN"]._serialized_options = b'\302\301\030\006Screen'
  _SPRITEDESC_SIZEMODE.values_by_name["SIZE_MODE_MANUAL"]._options = None
  _SPRITEDESC_SIZEMODE.values_by_name["SIZE_MODE_MANUAL"]._serialized_options = b'\302\301\030\006Manual'
  _SPRITEDESC_SIZEMODE.values_by_name["SIZE_MODE_AUTO"]._options = None
  _SPRITEDESC_SIZEMODE.values_by_name["SIZE_MODE_AUTO"]._serialized_options = b'\302\301\030\004Auto'
  _SPRITEDESC.fields_by_name['tile_set']._options = None
  _SPRITEDESC.fields_by_name['tile_set']._serialized_options = b'\240\273\030\001'
  _SPRITEDESC.fields_by_name['material']._options = None
  _SPRITEDESC.fields_by_name['material']._serialized_options = b'\240\273\030\001'
