...
def prepare_func(args):
    ...
    if args.program in ('tau', 'firms'):
        ...
        if args.vasp_born:
            ...
            derivatives = ho.calculate_dmudQ(bec_tensors)
        elif args.gaussian_log:
            derivatives = make_gaussian_extractor(args.gaussian_log, ("freq", "dipole_derivatives"))[1]
            derivatives *= 1/np.sqrt(42.2561) * 3.33564e-30 * 1e10 * np.sqrt(ho.red_masses)
        elif args.gaussian_fchk:
            derivatives = make_gaussian_extractor(args.gaussian_fchk, ("fchk", "dipole_derivatives"))[1]
