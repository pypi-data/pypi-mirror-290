...
class CLIWrapper:
    ...
    def __init__(self):
        ...
        sub_command.add_argument("--number-of-distribs", help='The number of distirbs to be created on the node', dest='number_of_distribs', type=int)
        ...
        if args.command in ['storage-node', 'sn']:
            ...
            if sub_command == "deploy":
                ...
                out = storage_ops.add_node(
                    ...
                    small_bufsize, large_bufsize, num_partitions_per_dev, jm_percent, number_of_devices, number_of_distribs)
                return out
