...
bstack1lll1l1l1ll_opy_ = 30
bstack1lll1ll1111_opy_ = 2
class bstack1lll1l1l11l_opy_:
    def __init__(self, handler, bstack1lll1ll11l1_opy_=bstack1lll1l1ll1l_opy_, bstack1lll1l1llll_opy_=bstack1lll1l1ll11_opy_):
        self.queue = []
    ...
    def bstack1lll1ll11ll_opy_(self):
        self.timer = threading.Timer(self.bstack1lll1l1llll_opy_, self.bstack1lll1ll111l_opy_)
        self.timer.start()
    ...
    def add(self, event):
        with self.lock:
            ...
            if len(self.queue) >= self.bstack1lll1ll11l1_opy_:
                t = threading.Thread(target=self.bstack1lll1ll111l_opy_)
                t.start()
