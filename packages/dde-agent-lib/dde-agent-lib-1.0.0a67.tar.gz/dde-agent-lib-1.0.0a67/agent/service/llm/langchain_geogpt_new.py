...
class LangchainGeoGPTNew(LLM, CustomModel):
    def __init__(self, endpoint: str, *, streaming: bool = True, model: str = "Geogpt", system: Optional[str] = None,
        ...
        kwargs = {"endpoint": endpoint, " streaming": streaming, "model": model, "system": system,
                  ...
                  "template_name": template_name, "temperature": temperature, "source": source}
    ...
    @staticmethod
    def generate_parameters(prompt, system, history, endpoint, stream, max_output_length, template_name, temperature, source):
        model_params = {
        }
        service_params = {
    ...
    @staticmethod
    def ahttp_request_stream(prompt, system, history, endpoint, stream, max_output_length, template_name, temperature, source):
        model_params = {
        }
        service_params = {
            "promptTemplateName": template_name,
