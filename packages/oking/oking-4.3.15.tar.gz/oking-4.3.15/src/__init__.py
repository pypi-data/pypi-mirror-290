...
global is_connected_oracle_client, client_data, start_time, shortname_interface, token_interface, conexao, token_param, \
    token_total, createDatabase, nome_token, job_console
nome_token = ''
...
jobs_qtd = 0
version = pkg_resources.require("oking")[0].version
...
try:
    ...
    if not is_dev:
        ...
        api_okinghub.post_log(Log(f'Oking inicializando {client_data["integracao_nome"]} - Versão {src.version}'
                                  , 'INICIALIZACAO'
                                  , 'OKING_INICIALIZACAO'
        ...
        api_okinghub.post_log(Log(f'Oking inicializando cliente id {client_data["integracao_nome"]} - Versão {src.version}'
                                  , ''
                                  , 'OKING_INICIALIZACAO'
