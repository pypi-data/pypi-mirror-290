from contacts.record.address import Address
from contacts.record.birthday import Birthday
from contacts.record.email import Email
from contacts.record.name import Name
from contacts.record.phone import Phone, PhoneCollection
