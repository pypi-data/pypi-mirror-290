<a id="mypy-boto3-workspaces-thin-client"></a>
...
[boto3.WorkSpacesThinClient 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/workspaces-thin-client.html#WorkSpacesThinClient)
...
Install `boto3-stubs-lite[workspaces-thin-client]` in your environment:
