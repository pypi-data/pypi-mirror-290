...
[boto3.DataSync 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/datasync.html#DataSync)
...
describe_storage_system_resource_metrics_paginator: (
    DescribeStorageSystemResourceMetricsPaginator
...
Full list of `DataSync` Literals can be found in
