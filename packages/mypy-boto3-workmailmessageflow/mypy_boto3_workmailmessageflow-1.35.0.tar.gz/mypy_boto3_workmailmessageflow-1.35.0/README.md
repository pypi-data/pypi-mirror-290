...
[boto3.WorkMailMessageFlow 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/workmailmessageflow.html#WorkMailMessageFlow)
...
- Install `boto3-stubs[workmailmessageflow]` in your environment:
...
Install `boto3-stubs-lite[workmailmessageflow]` in your environment:
...
- Install `boto3-stubs[workmailmessageflow]` with services you use in your
  environment:
...
`mypy_boto3_workmailmessageflow.literals` module contains literals extracted
from shapes that can be used in user code for type checking.

Full list of `WorkMailMessageFlow` Literals can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_workmailmessageflow/literals/).
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_workmailmessageflow/type_defs/).
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_workmailmessageflow/)
