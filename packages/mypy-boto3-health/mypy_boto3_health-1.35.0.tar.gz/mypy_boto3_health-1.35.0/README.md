...
[boto3.Health 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/health.html#Health)
...
Install `boto3-stubs-lite[health]` in your environment:
...
- Install `boto3-stubs[health]` with services you use in your environment:
...
Full list of `Health` Literals can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_health/literals/).
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_health/type_defs/).
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_health/)
