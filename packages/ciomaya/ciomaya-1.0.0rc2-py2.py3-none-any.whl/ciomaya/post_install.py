...
WIN_MY_DOCUMENTS = 5
WIN_TYPE_CURRENT = 0
SUPPORTED_MAYA_VERSIONS = [2025]
WHEELS_FOLDER = os.path.join(PKG_DIR, "wheels")
...
def main():
    ...
    for wheel in os.listdir(WHEELS_FOLDER):
        sys.stdout.write(f"Installing {wheel}\n")
        pip.main(["install", "--target", CIODIR, os.path.join(WHEELS_FOLDER, wheel)])
