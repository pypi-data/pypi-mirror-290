...
class Client:
    ...
    **Handling Exceptions**
    ...
    def plan_import(
        self, table_name: str, search_string: str, from_ref: str = 'main', args: Optional[Dict] | None = None
    ) -> PlanImportState:
        """
        ...
        try:
            return self._import.plan(
                search_string=search_string, table_name=table_name, from_ref=from_ref, args=args
            )
        except grpc._channel._InactiveRpcError as e:
            if hasattr(e, 'details'):
                raise exceptions.RunError(e.details()) from e
    ...
    def apply_import(
        self, plan: Dict, onto_branch: str, args: Optional[Dict] | None = None
    ) -> ApplyPlanState:
        """
