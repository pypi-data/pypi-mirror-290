...
""" The _pyrfc_tr_chl C-extension module """
...
from pyrfc_tr_chl.csapnwrfc cimport *
from pyrfc_tr_chl._exception import *
from pyrfc_tr_chl._utils import enum_names, enum_values
...
def language_iso_to_sap(lang_iso):
    ...
    :raises: :exc:`~pyrfc_tr_chl.RFCError` or a subclass
...
cdef class Connection:
    ...
    Instantiating an :class:`pyrfc_tr_chl.Connection` object will
    ...
    :param config: Configuration of the client connection, valid for all RFC calls of given connection. Allowed keys are:
           ...
           * ``timeout``
             ...
             Examples: https://github.com/SAP/pyrfc_tr_chl/tree/main/examples/timeout
    ...
    @property
    def version(self):
        """Get SAP NW RFC SDK and pyrfc_tr_chl binding versions
        :returns: SAP NW RFC SDK major, minor, patch level and pyrfc_tr_chl binding version
        """
        cdef unsigned major = 0
        cdef unsigned minor = 0
        cdef unsigned patchlevel = 0
    ...
    def cancel(self):
        """ Cancels the ongoing RFC call using `~pyrfc_tr_chl.cancel_connection()` function
    ...
    def get_connection_attributes(self):
        ...
        :raises: :exc:`~pyrfc_tr_chl.RFCError` or a subclass thereof if the RFC call fails.
        """
        cdef RFC_RC rc
        cdef RFC_ERROR_INFO errorInfo
    ...
    def fill_and_submit_unit(self, unit, calls, queue_names=None, attributes=None):
        ...
        :param unit: a unit descriptor as returned by
               :meth:`~pyrfc_tr_chl.Connection.initialize_unit`.
        ...
        :raises: :exc:`~pyrfc_tr_chl.RFCError` or a subclass thereof if an error
...
cdef class Server:
    ...
    An instance of :class:`~pyrfc_tr_chl.Server` allows for installing
...
cdef class Throughput:
    ...
    def getFromConnection(Connection connection):
        ...
        :raises: :exc:`~pyrfc_tr_chl.RFCError` or a subclass in case of error
        """
        cdef RFC_ERROR_INFO errorInfo
