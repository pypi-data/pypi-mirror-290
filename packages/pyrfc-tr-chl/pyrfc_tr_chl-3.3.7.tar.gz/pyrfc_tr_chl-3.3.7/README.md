...
[![PyPI - Wheel](https://img.shields.io/pypi/wheel/pyrfc_tr_chl)](https://pypi.org/project/pyrfc_tr_chl/)
[![PyPI - Version](https://img.shields.io/pypi/v/pyrfc_tr_chl)](https://pypi.org/project/pyrfc_tr_chl/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/pyrfc_tr_chl)](https://pypi.org/project/pyrfc_tr_chl/)
[![Ruff](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/charliermarsh/ruff/main/assets/badge/v2.json)](https://github.com/astral-sh/ruff)
[![PyPI - Downloads](https://img.shields.io/pypi/dm/pyrfc_tr_chl)](https://pypistats.org/packages/pyrfc_tr_chl)
[![REUSE status](https://api.reuse.software/badge/github.com/SAP/pyrfc_tr_chl)](https://api.reuse.software/info/github.com/SAP/pyrfc_tr_chl)
...
This project is currently looking for new maintainers. Please see [this issue](https://github.com/SAP/pyrfc_tr_chl/issues/372) for details.
...
- All [platforms supported by SAP NWRFC SDK](https://launchpad.support.sap.com/#/notes/2573790) are supported by build from source installation ([build instructions](http://sap.github.io/pyrfc_tr_chl/build.html))

- In addition, pre-built wheels are provided for Windows, Darwin and Ubuntu Linux, attached to pyrfc_tr_chl GitHub [release](https://github.com/SAP/pyrfc_tr_chl/releases/latest)
...
- [Ansible Module for use of SAP pyrfc_tr_chl](https://docs.ansible.com/ansible/latest/collections/community/sap_libs/sap_pyrfc_tr_chl_module.html)

- Microsoft IIS, see [#359](https://github.com/SAP/pyrfc_tr_chl/issues/359)
...
pyrfc_tr_chl is using source distribution (sdist) installation on Linux systems and [Cython](https://cython.readthedocs.io/en/latest/index.html) is required on Linux system to build the pyrfc_tr_chl package from source. See [Installing Cython](https://cython.readthedocs.io/en/latest/src/quickstart/install.html#installing-cython)
...
- Remote paths must be set in SAP NWRFC SDK for macOS: [documentation](http://sap.github.io/pyrfc_tr_chl/install.html#macos)

- When the pyrfc_tr_chl is started for the first time, the popups may come-up for each NWRFC SDK library, to confirm the usage. If SAP NW RFC SDK is installed in admin folder, the app shall be first time started with admin privileges, eg. `sudo -E`
...
```shell
pip install --no-binary pyrfc_tr_chl pyrfc_tr_chl
# or
pip install https://files.pythonhosted.org/packages/.../pyrfc_tr_chl-3.1.0.tar.gz
```

Alternative build from source installation:

```shell
git clone https://github.com/SAP/pyrfc_tr_chl.git
cd pyrfc_tr_chl
# if you use tox
...
# or
pyrfc_tr_chl_BUILD_CYTHON=yes python -m build --wheel --sdist --outdir dist
pip install --upgrade --no-index --find-links=dist pyrfc_tr_chl
```

Run ``python`` and type ``from pyrfc_tr_chl import *``. If this finishes silently, without oputput, the installation was successful.

Using virtual environments you can isolate Python/pyrfc_tr_chl projects, working without administrator privileges.

See also the [pyrfc_tr_chl documentation](http://sap.github.io/pyrfc_tr_chl),
...
```python
from pyrfc_tr_chl import Connection
...
Using an open connection, remote function modules (RFM) can be invoked. More info in [pyrfc_tr_chl documentation](http://sap.github.io/pyrfc_tr_chl/client.html#client-scenariol).
...
See also pyrfc_tr_chl documentation for [Client Scenario](http://sap.github.io/pyrfc_tr_chl/client.html)
...
See also pyrfc_tr_chl documentation for [Server Scenario](http://sap.github.io/pyrfc_tr_chl/server.html) and server example [source code](https://github.com/SAP/pyrfc_tr_chl/blob/main/examples/server).
...
If you encounter an issue or have a feature request, you can create a [ticket](https://github.com/SAP/pyrfc_tr_chl/issues).

Check out the [SAP Community](https://community.sap.com/) (search for "pyrfc_tr_chl") and stackoverflow (use the tag [pyrfc_tr_chl](https://stackoverflow.com/questions/tagged/pyrfc_tr_chl)), to discuss code-related problems and questions.

## Contributing

We appreciate contributions from the community to **pyrfc_tr_chl**!
