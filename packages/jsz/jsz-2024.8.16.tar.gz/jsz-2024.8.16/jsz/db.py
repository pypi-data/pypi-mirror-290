...
def oss2_upload_file(bucket, key, filepath, proxies=None):
    """
    上传文件到 oss
...
def oss2_upload_content(bucket, key, content, proxies=None):
    """
    上传 content 到 oss
