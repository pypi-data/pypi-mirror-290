...
class CredentialsDependency(Enum):
    splickyDsp = 'splickyDsp'


class CredentialsDependency5(BaseModel):
...
class CredentialsDependency3(
    RootModel[Union[CredentialsDependency, CredentialsDependency5]]
):
    root: Union[CredentialsDependency, CredentialsDependency5]
...
class ComputationNodeKindV918(ComputationNodeKind10):
    pass


class ComputationNodeKindV919(ComputationNodeKindV215):
    pass


class ComputationNodeKindV920(ComputationNodeKindV620):
    pass


class ComputationNodeKindV921(ComputationNodeKindV621):
    pass
...
class ComputationNodeKindV913(ComputationNodeKind6):
    pass


class ComputationNodeKindV914(ComputationNodeKindV210):
    pass


class ComputationNodeKindV915(ComputationNodeKind7):
    pass
...
class ExportConnectorNode2(BaseModel):
    credentialsDependency: CredentialsDependency3
    dependency: ExportNodeDependency
    kind: ExportConnectorKind2
    specificationId: str
...
class ComputationNodeKindV916(ComputationNodeKind8):
    pass
...
class ComputationNodeKindV922(BaseModel):
    ...
    exportConnector: ExportConnectorNode2
...
class ComputationNodeKindV923(ComputationNodeKindV623):
    pass


class ComputationNodeKindV912(
    RootModel[
        Union[
            ComputationNodeKindV913,
            ComputationNodeKindV914,
            ComputationNodeKindV915,
            ComputationNodeKindV916,
            ComputationNodeKindV9,
            ComputationNodeKindV918,
...
class DataScienceDataRoomConfigurationV9(BaseModel):
    dcrSecretIdBase64: Optional[str] = None
    description: str
    enableAirlock: bool
    enableAllowEmptyFilesInValidation: bool
