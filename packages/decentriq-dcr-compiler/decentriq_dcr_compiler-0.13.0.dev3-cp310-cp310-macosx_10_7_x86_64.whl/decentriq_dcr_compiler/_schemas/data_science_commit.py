...
class CredentialsDependency1(Enum):
    splickyDsp = 'splickyDsp'


class CredentialsDependency2(BaseModel):
...
class CredentialsDependency(
    RootModel[Union[CredentialsDependency1, CredentialsDependency2]]
):
    root: Union[CredentialsDependency1, CredentialsDependency2]
...
class ComputationNodeKindV93(ComputationNodeKind2):
    pass
