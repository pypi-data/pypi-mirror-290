...
with open(os.path.join(file_path, "public_address_lib.json"), encoding="utf-8") as cfg_file:
    ...
    OPENMIND_TOKEN_URL = json.loads(json_file)["openmind_token_url"]
...
HOSTNAME_WHITE_LIST = ["openmind.cn", "osinfra.cn"]
UPLOAD_OBS_HOSTNAME_WHITE_LIST = ["openmind.cn", "osinfra.cn", "myhuaweicloud.com"]
DOWNLOAD_CDN_HOSTNAME_WHITE_LIST = ["openmind.cn", "osinfra.cn"]
...
# error code:
REVISION_NOT_FOUND = 1001
ENTRY_NOT_FOUND = 404
GATE_REPOSITORY = 401
VALIDATION_FIELD = 1004
REPOSITORY_NOT_FOUND = 404
NOT_ON_WHITE_LIST = 418
DUPLICATE_CREATING_MSG = "duplicate_creating"
...
SPACES_IMAGES = ["python3.8-pytorch2.1", "python3.8-mindspore2.3"]
