...
from .goodies import b_if_not_a
from .aws_init import new_aws_resource, boto3config, ClientError, EndpointConnectionError, ResponseParserError
        ...
        if host_type.lower().startswith('elastic'):
            ...
            for u in urls:
                try:
                    ...
                    mq_client = new_aws_resource('sqs', endpoint_url=u,
