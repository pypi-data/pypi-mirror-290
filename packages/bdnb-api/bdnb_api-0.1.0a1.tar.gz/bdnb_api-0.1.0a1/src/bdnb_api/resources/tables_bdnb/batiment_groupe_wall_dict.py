...
from ...types.tables_bdnb import batiment_groupe_wall_dict_list_params
from ...types.tables_bdnb.batiment_groupe_wall_dict_list_response import BatimentGroupeWallDictListResponse
