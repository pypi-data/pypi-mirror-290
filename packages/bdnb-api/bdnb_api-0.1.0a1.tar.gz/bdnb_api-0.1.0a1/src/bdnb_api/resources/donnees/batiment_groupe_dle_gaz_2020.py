...
from ...types.donnees.batiment_groupe_dle_gaz_2020_list_response import BatimentGroupeDleGaz2020ListResponse
...
class BatimentGroupeDleGaz2020Resource(SyncAPIResource):
    ...
    def list(
        ...
        *,
    ...
    ) -> BatimentGroupeDleGaz2020ListResponse:
        """
        ...
        return self._get(
            ...
            cast_to=BatimentGroupeDleGaz2020ListResponse,
        )
