...
class BatimentGroupeDleGazMultimillesimeResource(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> BatimentGroupeDleGazMultimillesimeResourceWithRawResponse:
        return BatimentGroupeDleGazMultimillesimeResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> BatimentGroupeDleGazMultimillesimeResourceWithStreamingResponse:
        return BatimentGroupeDleGazMultimillesimeResourceWithStreamingResponse(self)
...
class AsyncBatimentGroupeDleGazMultimillesimeResource(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncBatimentGroupeDleGazMultimillesimeResourceWithRawResponse:
        return AsyncBatimentGroupeDleGazMultimillesimeResourceWithRawResponse(self)
...
class BatimentGroupeDleGazMultimillesimeResourceWithRawResponse:
    def __init__(self, batiment_groupe_dle_gaz_multimillesime: BatimentGroupeDleGazMultimillesimeResource) -> None:
        self._batiment_groupe_dle_gaz_multimillesime = batiment_groupe_dle_gaz_multimillesime

        self.list = to_raw_response_wrapper(
            batiment_groupe_dle_gaz_multimillesime.list,
        )


class AsyncBatimentGroupeDleGazMultimillesimeResourceWithRawResponse:
    def __init__(self, batiment_groupe_dle_gaz_multimillesime: AsyncBatimentGroupeDleGazMultimillesimeResource) -> None:
        self._batiment_groupe_dle_gaz_multimillesime = batiment_groupe_dle_gaz_multimillesime
...
class BatimentGroupeDleGazMultimillesimeResourceWithStreamingResponse:
    def __init__(self, batiment_groupe_dle_gaz_multimillesime: BatimentGroupeDleGazMultimillesimeResource) -> None:
        self._batiment_groupe_dle_gaz_multimillesime = batiment_groupe_dle_gaz_multimillesime
...
class AsyncBatimentGroupeDleGazMultimillesimeResourceWithStreamingResponse:
    def __init__(self, batiment_groupe_dle_gaz_multimillesime: AsyncBatimentGroupeDleGazMultimillesimeResource) -> None:
        self._batiment_groupe_dle_gaz_multimillesime = batiment_groupe_dle_gaz_multimillesime
