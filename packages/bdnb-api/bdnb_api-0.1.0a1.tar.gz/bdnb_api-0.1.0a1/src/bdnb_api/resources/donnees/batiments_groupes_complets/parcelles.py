...
from ....types.donnees.batiments_groupes_complets import parcelle_list_params
from ....types.donnees.batiments_groupes_complets.parcelle_list_response import ParcelleListResponse

__all__ = ["ParcellesResource", "AsyncParcellesResource"]


class ParcellesResource(SyncAPIResource):
    @cached_property
    def with_raw_response(self) -> ParcellesResourceWithRawResponse:
        return ParcellesResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> ParcellesResourceWithStreamingResponse:
        return ParcellesResourceWithStreamingResponse(self)
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            "/donnees/batiment_groupe_complet/parcelle",
...
class AsyncParcellesResource(AsyncAPIResource):
    @cached_property
    def with_raw_response(self) -> AsyncParcellesResourceWithRawResponse:
        return AsyncParcellesResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncParcellesResourceWithStreamingResponse:
        return AsyncParcellesResourceWithStreamingResponse(self)
...
class ParcellesResourceWithRawResponse:
    def __init__(self, parcelles: ParcellesResource) -> None:
...
class AsyncParcellesResourceWithRawResponse:
    def __init__(self, parcelles: AsyncParcellesResource) -> None:
        self._parcelles = parcelles
...
class ParcellesResourceWithStreamingResponse:
    def __init__(self, parcelles: ParcellesResource) -> None:
        self._parcelles = parcelles
...
class AsyncParcellesResourceWithStreamingResponse:
    def __init__(self, parcelles: AsyncParcellesResource) -> None:
        self._parcelles = parcelles
