...
from bdnb_api.types.donnees.batiments_groupes_complets import AdressListResponse
...
class TestAdresses:
    ...
    def test_method_list(self, client: BdnbAPI) -> None:
        adress = client.donnees.batiments_groupes_complets.adresses.list()
        assert_matches_type(AdressListResponse, adress, path=["response"])
    ...
    def test_raw_response_list(self, client: BdnbAPI) -> None:
        response = client.donnees.batiments_groupes_complets.adresses.with_raw_response.list()

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        adress = response.parse()
        assert_matches_type(AdressListResponse, adress, path=["response"])

    @parametrize
    def test_streaming_response_list(self, client: BdnbAPI) -> None:
        with client.donnees.batiments_groupes_complets.adresses.with_streaming_response.list() as response:
...
class TestAsyncAdresses:
    parametrize = pytest.mark.parametrize("async_client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    async def test_method_list(self, async_client: AsyncBdnbAPI) -> None:
        adress = await async_client.donnees.batiments_groupes_complets.adresses.list()
        assert_matches_type(AdressListResponse, adress, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncBdnbAPI) -> None:
        response = await async_client.donnees.batiments_groupes_complets.adresses.with_raw_response.list()

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        adress = await response.parse()
        assert_matches_type(AdressListResponse, adress, path=["response"])

    @parametrize
    async def test_streaming_response_list(self, async_client: AsyncBdnbAPI) -> None:
        async with async_client.donnees.batiments_groupes_complets.adresses.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
