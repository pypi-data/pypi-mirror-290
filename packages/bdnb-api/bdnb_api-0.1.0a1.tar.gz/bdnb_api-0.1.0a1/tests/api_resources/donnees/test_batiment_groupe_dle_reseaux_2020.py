...
class TestBatimentGroupeDleReseaux2020:
    ...
    def test_raw_response_list(self, client: BdnbAPI) -> None:
        response = client.donnees.batiment_groupe_dle_reseaux_2020.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: BdnbAPI) -> None:
        with client.donnees.batiment_groupe_dle_reseaux_2020.with_streaming_response.list() as response:
...
class TestAsyncBatimentGroupeDleReseaux2020:
    ...
    async def test_raw_response_list(self, async_client: AsyncBdnbAPI) -> None:
        response = await async_client.donnees.batiment_groupe_dle_reseaux_2020.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncBdnbAPI) -> None:
        async with async_client.donnees.batiment_groupe_dle_reseaux_2020.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
