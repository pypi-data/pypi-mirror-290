...
class TestBatimentGroupeDpeRepresentatifLogement:
    ...
    def test_raw_response_list(self, client: BdnbAPI) -> None:
        response = client.donnees.batiment_groupe_dpe_representatif_logement.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: BdnbAPI) -> None:
        with client.donnees.batiment_groupe_dpe_representatif_logement.with_streaming_response.list() as response:
...
class TestAsyncBatimentGroupeDpeRepresentatifLogement:
    ...
    async def test_raw_response_list(self, async_client: AsyncBdnbAPI) -> None:
        response = await async_client.donnees.batiment_groupe_dpe_representatif_logement.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncBdnbAPI) -> None:
        async with async_client.donnees.batiment_groupe_dpe_representatif_logement.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
