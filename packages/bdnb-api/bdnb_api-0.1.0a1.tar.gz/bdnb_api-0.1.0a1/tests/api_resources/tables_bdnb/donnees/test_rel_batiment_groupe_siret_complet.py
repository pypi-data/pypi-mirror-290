...
class TestRelBatimentGroupeSiretComplet:
    parametrize = pytest.mark.parametrize("client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    def test_method_list(self, client: BdnbAPI) -> None:
        rel_batiment_groupe_siret_complet = client.tables_bdnb.donnees.rel_batiment_groupe_siret_complet.list()
        assert_matches_type(
    ...
    def test_raw_response_list(self, client: BdnbAPI) -> None:
        response = client.tables_bdnb.donnees.rel_batiment_groupe_siret_complet.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: BdnbAPI) -> None:
        with client.tables_bdnb.donnees.rel_batiment_groupe_siret_complet.with_streaming_response.list() as response:
...
class TestAsyncRelBatimentGroupeSiretComplet:
    parametrize = pytest.mark.parametrize("async_client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    async def test_method_list(self, async_client: AsyncBdnbAPI) -> None:
        rel_batiment_groupe_siret_complet = (
            await async_client.tables_bdnb.donnees.rel_batiment_groupe_siret_complet.list()
        )
        assert_matches_type(
            RelBatimentGroupeSiretCompletListResponse, rel_batiment_groupe_siret_complet, path=["response"]
        )
    ...
    async def test_raw_response_list(self, async_client: AsyncBdnbAPI) -> None:
        response = await async_client.tables_bdnb.donnees.rel_batiment_groupe_siret_complet.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncBdnbAPI) -> None:
        async with async_client.tables_bdnb.donnees.rel_batiment_groupe_siret_complet.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
