...
class TestBatimentGroupeSimulationsValeurVerte:
    ...
    def test_method_list(self, client: BdnbAPI) -> None:
        batiment_groupe_simulations_valeur_verte = client.tables_bdnb.batiment_groupe_simulations_valeur_verte.list()
        assert_matches_type(
            BatimentGroupeSimulationsValeurVerteListResponse,
    ...
    def test_raw_response_list(self, client: BdnbAPI) -> None:
        response = client.tables_bdnb.batiment_groupe_simulations_valeur_verte.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: BdnbAPI) -> None:
        with client.tables_bdnb.batiment_groupe_simulations_valeur_verte.with_streaming_response.list() as response:
...
class TestAsyncBatimentGroupeSimulationsValeurVerte:
    ...
    async def test_method_list(self, async_client: AsyncBdnbAPI) -> None:
        batiment_groupe_simulations_valeur_verte = (
            await async_client.tables_bdnb.batiment_groupe_simulations_valeur_verte.list()
        )
        assert_matches_type(
            BatimentGroupeSimulationsValeurVerteListResponse,
            batiment_groupe_simulations_valeur_verte,
    ...
    async def test_raw_response_list(self, async_client: AsyncBdnbAPI) -> None:
        response = await async_client.tables_bdnb.batiment_groupe_simulations_valeur_verte.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncBdnbAPI) -> None:
        async with async_client.tables_bdnb.batiment_groupe_simulations_valeur_verte.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
