...
from ....types.tables_bdnb.donnees import batiment_groupe_bpe_list_params
from ....types.tables_bdnb.donnees.batiment_groupe_bpe_list_response import BatimentGroupeBpeListResponse
