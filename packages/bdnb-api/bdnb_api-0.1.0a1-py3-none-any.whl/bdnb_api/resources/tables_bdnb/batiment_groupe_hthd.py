...
from ...types.tables_bdnb import batiment_groupe_hthd_list_params
from ...types.tables_bdnb.batiment_groupe_hthd_list_response import BatimentGroupeHthdListResponse
