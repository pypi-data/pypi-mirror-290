...
from ....types.tables_bdnb.referentiel_administratif import departement_list_params
from ....types.tables_bdnb.referentiel_administratif.departement_list_response import DepartementListResponse
