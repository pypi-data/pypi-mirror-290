...
class DFTransformationDecorator:
    ...
    max_job_duration: timedelta = timedelta(hours=48)
    spark_params: Dict[str, str] = field(default_factory=dict)  # spark specific
    write_options: Dict[str, str] = field(default_factory=dict)  # spark specific
    table_properties: Dict[str, str] = field(default_factory=dict)  # spark specific
        ...
        return SourceVariant(
            ...
            definition=DFTransformation(
                ...
                spark_flags=SparkFlags(
                    spark_params=self.spark_params or {},
                    write_options=self.write_options or {},
                    table_properties=self.table_properties or {},
                ),
            ),
            owner=self.owner,
            provider=self.provider,
