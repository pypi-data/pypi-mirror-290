...
class AlimTalkOptions:
    def __init__(self, pf_id: str, template_id: str, disable_sms: bool = False,
...
class AlimTalkMessage(Message):
    def __init__(self, from_number: str, to_number: str, pf_id: str, template_id: str, variables: Dict[str, str],
                 disable_sms: bool = False, scheduled_date: Optional[str] = None):
