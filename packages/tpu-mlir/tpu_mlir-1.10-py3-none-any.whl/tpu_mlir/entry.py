...
def bmodel_infer():
	file_name = f"{os.getenv('TPUC_ROOT')}/python/tools/bmodel_infer.py"
	run_subprocess_py(file_name)
...
### total 30 entry generated for f"{package_path}/python/tools/
...
def detect_pp_yolov3():
	file_name = f"{os.getenv('TPUC_ROOT')}/python/samples/detect_pp_yolov3.py"
	run_subprocess_py(file_name)
...
### total 2 entry generated for f"{package_path}/python/test/
