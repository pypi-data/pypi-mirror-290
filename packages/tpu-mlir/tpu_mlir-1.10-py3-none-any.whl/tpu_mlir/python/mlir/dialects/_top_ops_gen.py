...
class BatchNormTrainOp(_ods_ir.OpView):
  ...
  def __init__(self, output, mean_out, variance_out, input, mean, variance, gamma, beta, *, epsilon=None, momentum=None, do_relu=None, relu_limit=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class InputOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input, *, shape_tensor=None, do_preprocess=None, pixel_format=None, channel_format=None, resize_dims=None, keep_aspect_ratio=None, keep_ratio_mode=None, pad_value=None, pad_type=None, scale=None, mean=None, customization_format=None, aligned=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class WeightOp(_ods_ir.OpView):
  ...
  def __init__(self, output, *, scale=None, store_mode=None, allow_split=None, do_compress=None, bias0=None, bias1=None, is_signed=None, zero_guard=None, inline_bytes=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
