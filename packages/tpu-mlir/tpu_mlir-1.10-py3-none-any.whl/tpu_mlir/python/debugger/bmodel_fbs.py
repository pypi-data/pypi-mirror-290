...
class CoeffMem(object):
    ...
    @staticmethod
    def CoeffMemAddEncryptMode(builder, encryptMode):
        builder.PrependInt32Slot(4, encryptMode, 0)

    @staticmethod
    def AddEncryptMode(builder, encryptMode):
        return CoeffMem.CoeffMemAddEncryptMode(builder, encryptMode)

    @staticmethod
    def CoeffMemAddDecryptSize(builder, decryptSize):
        builder.PrependUint64Slot(5, decryptSize, 0)

    @staticmethod
    def AddDecryptSize(builder, decryptSize):
        return CoeffMem.CoeffMemAddDecryptSize(builder, decryptSize)
