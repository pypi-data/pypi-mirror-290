...
#   timestamp: 2024-07-31T10:47:23+00:00
...
from mlflow.pydantic_v1 import BaseModel, Field, constr
...
class SystemMessage(BaseModel):
    ...
    role: Literal["system"]
    content: Union[constr(regex=r"^.{1,}$"), BlobStorageReference] = Field(
...
class TextContentPart(BaseModel):
    ...
    type: Literal["text"]
    text: Union[constr(regex=r"^.{1,}$"), BlobStorageReference]
