...
def test(exchangeName="", params={}):
    ...
    if "createLimitOrder" in params and params["createLimitOrder"]:
        ...
        try:
            resp = ttxtExchange.create_limit_order(symbol=tickerToTest, amount=200, side="buy", price=0.040)
    ...
    if "create_market_order" in params and params["create_market_order"]:
        ...
        try:
            resp = ttxtExchange.create_market_order(symbol=tickerToTest, side="buy", amount=10)
...
if __name__ == "__main__":
    ...
    testingParams = {"ticker": False, 
                     ...
                     "myTrades": False,
                     "accountInfo": False}
    test(params=testingParams, exchangeName="whitebit")
