...
[boto3.LicenseManagerUserSubscriptions 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/license-manager-user-subscriptions.html#LicenseManagerUserSubscriptions)
...
- Install `boto3-stubs[license-manager-user-subscriptions]` with services you
...
`mypy_boto3_license_manager_user_subscriptions.literals` module contains
