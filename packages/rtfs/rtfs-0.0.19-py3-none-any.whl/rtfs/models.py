...
emphasize, in which case the emphasized word should be all caps. Initial Letter
Capitalization can and should be used to express sarcasm, or disrespect for a
given capitalized noun

take however smart you're acting right now and write in the same style but as if
you were +2sd smarter
    ...
    async def query(self, prompt: str) -> str:
        ...
        try:
            ...
            response = await self.client.chat.completions.create(
                messages=[
                    # {"role": "system", "content": EIGENROBOT},
