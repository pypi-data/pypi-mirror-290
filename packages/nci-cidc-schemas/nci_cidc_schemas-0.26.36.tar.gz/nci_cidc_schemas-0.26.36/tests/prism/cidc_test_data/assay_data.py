...
def mibi() -> PrismTestData:
            ...
            "mibi": [
                {
                    "batch_id": "test_batch",
                    "metadata_tsv": {
                        "upload_placeholder": "eeeeeeee-047f-4df6-b614-871289a1a2a9Q"
                    },
                    "records": [
                        {
                            "cimac_id": "CXTTPP111.00",
                            "files": {
                                "dataset": "CIMAC cohort",
                                "roi_id": "1",
                                "roi_description": "description 1",
                                ...
                                "mibi_ome_tiff_file_name": "ome_file_1",
                            },
                        },
                        {
                            "cimac_id": "CXTTPP111.00",
                            "files": {
                                ...
                                "mibi_ome_tiff_file_name": "ome_file_2",
                            },
                        },
                        {
                            "cimac_id": "CXTTPP111.00",
                            "files": {
                                "dataset": "CIMAC cohort",
                                "roi_id": "2",
                                "roi_description": "description 3",
                                "he_file": {
                                    "upload_placeholder": "cdeeeee-669c-48c7-aee0-f0d5e5e8a342"
                                },
                                "mibi_ome_tiff_file": {
                                    "upload_placeholder": "feeeeeee-669c-48c7-aee0-f0d5e5e8a342"
                                },
                                "mibi_ome_tiff_file_name": "ome_file_3",
                            },
                        },
                        {
                            "cimac_id": "CXTTPP121.00",
                            "files": {
                                "dataset": "CIMAC cohort",
                                "roi_id": "1",
                                "roi_description": "description 4",
                                "he_file": {
                                    "upload_placeholder": "xdeeeee-669c-48c7-aee0-f0d5e5e8a342"
                                },
                                "mibi_ome_tiff_file": {
                                    "upload_placeholder": "xeeeeeee-669c-48c7-aee0-f0d5e5e8a342"
                                },
                                "mibi_ome_tiff_file_name": "ome_file_4",
                            },
                        },
                    ],
    ...
    upload_entries = [
        LocalFileUploadEntry(
            local_path="he_file_1.jpg",
            gs_key="123/mibi/test_batch/CXTTPP111.00/1/he_file.jpg",
            upload_placeholder="eeeeeeee-047f-4df6-b614-871289a1a2a8",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="ome_file_1.ome.tiff",
            gs_key="123/mibi/test_batch/CXTTPP111.00/1/ome_file_1.ome.tiff",
            upload_placeholder="ffffffff-047f-4df6-b614-871289a1a2a8",
            metadata_availability=False,
            allow_empty=False,
        ),
        ...
        LocalFileUploadEntry(
            local_path="ome_file_2.ome.tiff",
            gs_key="123/mibi/test_batch/CXTTPP111.00/1/ome_file_2.ome.tiff",
            upload_placeholder="feeeeeee-669c-48c7-aee0-f0d5e5e8a341",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="he_file_2.jpg",
            gs_key="123/mibi/test_batch/CXTTPP111.00/2/he_file.jpg",
            upload_placeholder="cdeeeee-669c-48c7-aee0-f0d5e5e8a342",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="ome_file_3.ome.tiff",
            gs_key="123/mibi/test_batch/CXTTPP111.00/2/ome_file_3.ome.tiff",
            upload_placeholder="feeeeeee-669c-48c7-aee0-f0d5e5e8a342",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="he_file_3.svs",
            gs_key="123/mibi/test_batch/CXTTPP121.00/1/he_file.svs",
            upload_placeholder="xdeeeee-669c-48c7-aee0-f0d5e5e8a342",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="ome_file_4.ome.tiff",
            gs_key="123/mibi/test_batch/CXTTPP121.00/1/ome_file_4.ome.tiff",
            upload_placeholder="xeeeeeee-669c-48c7-aee0-f0d5e5e8a342",
            metadata_availability=False,
            allow_empty=False,
        ),
...
def atacseq_fastq() -> PrismTestData:
                    ...
                    "records": [
                        ...
                        },
                        {
                            ...
                            "files": {
                                "r1": [
                                    {
                                        "upload_placeholder": "d24a1b3d-a19a-414a-9fc4-55bcbb7db9ec"
                                    },
                                ],
                                "r2": [
                                    {
    ...
    upload_entries = [
        ...
        LocalFileUploadEntry(
            local_path="/local/path/to/fwd.1.2.1_2.fastq.gz",
            gs_key="test_prism_trial_id/atacseq/CTTTPP121.00/1/r1_L1.fastq.gz",
            upload_placeholder="d24a1b3d-a19a-414a-9fc4-55bcbb7db9ec",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="/local/path/to/rev.1.2.1_2.fastq.gz",
            gs_key="test_prism_trial_id/atacseq/CTTTPP121.00/1/r2_L1.fastq.gz",
            upload_placeholder="7eb4b639-c2a4-48f8-85f8-e9a04f5233c6",
            metadata_availability=False,
            allow_empty=False,
        ),
