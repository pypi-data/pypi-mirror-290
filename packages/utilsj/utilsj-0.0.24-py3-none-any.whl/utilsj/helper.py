...
def setup_logger(logger_name, log_root=None, log_file_save_basename=None, level=logging.INFO, screen=True,
    ...
    if logger_name in logger_initialized:
        lg.info(f'old logger {logger_name}.')
        return lg
    if msecs:
    ...
    lg.info(f'new logger {logger_name}.')

    return lg


def get_logger(logger_name, log_root=None, log_file_save_basename=None, level=logging.INFO, screen=True,
               tofile=False, msecs=False):
    return setup_logger(logger_name, log_root, log_file_save_basename, level, screen, msecs)
