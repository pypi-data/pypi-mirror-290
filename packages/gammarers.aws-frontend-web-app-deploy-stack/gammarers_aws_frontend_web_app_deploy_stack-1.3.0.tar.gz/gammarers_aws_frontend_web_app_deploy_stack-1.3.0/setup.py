    ...
    """
{
    ...
    "package_data": {
        "gammarers.aws_frontend_web_app_deploy_stack._jsii": [
            "aws-frontend-web-app-deploy-stack@1.3.0.jsii.tgz"
        ],
        "gammarers.aws_frontend_web_app_deploy_stack": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "gammarers.aws-secure-cloudfront-origin-bucket>=1.6.11, <1.7.0",
        "gammarers.aws-secure-frontend-web-app-cloudfront-distribution>=1.4.7, <1.5.0",
        "jsii>=1.102.0, <2.0.0",
        "publication>=0.0.3",
        "typeguard~=2.13.3"
    ],
