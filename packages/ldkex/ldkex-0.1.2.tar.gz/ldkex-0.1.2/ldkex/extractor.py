...
class Extractor:
    ...
    def _create_geometry(self, geometry_type, name, coordinates, metadata, color_string):
        try:
            ...
            self._handle_geometry_creation_error(geometry_type=geometry_type, coordinates=coordinates, name=name,
                                                 metadata=metadata, color_string=color_string)

    def _handle_geometry_creation_error(self, geometry_type, coordinates, name, metadata, color_string):
