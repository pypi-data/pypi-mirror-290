...
def generate_dialogue(quest, npc, dialogue_context, template, locations, characters):
    ...
    f"Format the dialogue in a clear manner similar to the provided example:\n"
    ...
    f"2. complete_quest(param: quest_name)\n"
    f"3. attack_player()\n"
    f"4. add_item(param: item_name, number_to_add)\n"
    f"5. remove_item(param: item_name, number_to_remove)\n"
