...
[boto3.MWAA 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/mwaa.html#MWAA)
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_mwaa/literals/).

```python
from mypy_boto3_mwaa.literals import EndpointManagementType


def check_value(value: EndpointManagementType) -> bool: ...
```
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_mwaa/type_defs/).
