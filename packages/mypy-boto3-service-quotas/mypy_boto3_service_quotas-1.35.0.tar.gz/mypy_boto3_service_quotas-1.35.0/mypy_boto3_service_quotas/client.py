...
class ServiceQuotasClient(BaseClient):
    ...
    def close(self) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/service-quotas.html#ServiceQuotas.Client.close)
        [Show boto3-stubs documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_service_quotas/client/#close)
        """
    ...
    def get_service_quota(
        self, *, ServiceCode: str, QuotaCode: str, ContextId: str = ...
    ) -> GetServiceQuotaResponseTypeDef:
        """
    ...
    def request_service_quota_increase(
        self, *, ServiceCode: str, QuotaCode: str, DesiredValue: float, ContextId: str = ...
    ) -> RequestServiceQuotaIncreaseResponseTypeDef:
        """
