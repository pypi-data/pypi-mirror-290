...
[Open documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_managedblockchain_query/literals/)
...
ManagedBlockchainQueryServiceName = Literal["managedblockchain-query"]
ServiceName = Literal[
    "accessanalyzer",
    "account",
    "acm",
