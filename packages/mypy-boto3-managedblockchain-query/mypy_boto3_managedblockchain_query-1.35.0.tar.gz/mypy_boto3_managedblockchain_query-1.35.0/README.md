<a id="mypy-boto3-managedblockchain-query"></a>
...
[boto3.ManagedBlockchainQuery 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/managedblockchain-query.html#ManagedBlockchainQuery)
