"""
Setup script for mypy-boto3-managedblockchain-query.
"""
...
setup(
    ...
    description="Type annotations for boto3.ManagedBlockchainQuery 1.35.0 service generated with mypy-boto3-builder 7.26.0",
    classifiers=[
