...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.heightSpinBox.setGeometry(QRect(120, 60, 62, 26))
        ...
        self.checkBox.setGeometry(QRect(200, 40, 131, 21))
        self.widthSpinBox = QDoubleSpinBox(self.tab)
        self.widthSpinBox.setObjectName(u"widthSpinBox")
        self.widthSpinBox.setGeometry(QRect(120, 20, 62, 26))
        ...
        self.filenameInput.setGeometry(QRect(10, 110, 241, 28))
