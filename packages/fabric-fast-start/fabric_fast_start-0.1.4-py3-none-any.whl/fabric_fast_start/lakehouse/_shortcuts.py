...
def create_shortcut_onelake(
    ...
    destination_workspace: Optional[str] = None,  # noqa: UP007
    shortcut_name: Optional[str] = None,  # noqa: UP007
):
    """
    ...
    try:
        ...
        if response.status_code == 201:
            print(
                ...
                f" the '{destination_workspace} workspace. It is based on the '{table_name}' table in the '{source_lakehouse}' lakehouse within the '{source_workspace}' workspace."  # noqa: E501
            )
        else:
...
def delete_shortcut(
    ...
    print(f"{icons.green_dot} The '{shortcut_name}' shortcut in the '{lakehouse}' within the '{workspace}' workspace has been deleted.")
