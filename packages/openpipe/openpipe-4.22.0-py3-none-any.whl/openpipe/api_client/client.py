...
class OpenPipeApi:
    ...
    def get_model(self, model: str) -> GetModelResponse:
        """
        Get a model by ID. Note, this endpoint is unstable and may change without notice. Do not use without consulting the OpenPipe team.
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"models/{model}"),
            headers=self._client_wrapper.get_headers(),
            timeout=240,
        )
        if 200 <= _response.status_code < 300:
    ...
    def list_models(self) -> typing.List[ListModelsResponseItem]:
        """
        List a project's fine-tuned models. Note, this endpoint is unstable and may change without notice. Do not use without consulting the OpenPipe team.
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(typing.List[ListModelsResponseItem], _response.json())  # type: ignore
        try:
            _response_json = _response.json()
        except JSONDecodeError:
            raise ApiError(status_code=_response.status_code, body=_response.text)
    ...
    def unstable_finetune_create(
        ...
        *,
        ...
        Parameters:
            ...
            - base_model: str. The base model to fine-tune from. Supported models include: OpenPipe/Hermes-2-Theta-Llama-3-8B-32k, meta-llama/Meta-Llama-3-8B-Instruct, meta-llama/Meta-Llama-3-70B-Instruct, OpenPipe/mistral-ft-optimized-1227, mistralai/Mixtral-8x7B-Instruct-v0.1
...
class AsyncOpenPipeApi:
    ...
    async def get_model(self, model: str) -> GetModelResponse:
        """
        Get a model by ID. Note, this endpoint is unstable and may change without notice. Do not use without consulting the OpenPipe team.
    ...
    async def list_models(self) -> typing.List[ListModelsResponseItem]:
        """
        List a project's fine-tuned models. Note, this endpoint is unstable and may change without notice. Do not use without consulting the OpenPipe team.
