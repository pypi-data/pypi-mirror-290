...
class _SimpleQualityMixin:
    ...
    def _create_statement_metric(
        name: str, description: str, statement: str, warnings: str | None = None
    ) -> dict:
        metric = ReportMetric(
...
class _SimplePlotQualityMixin:
    ...
    def quality_build_frame_average(self, task_type: str, num_modstates: int | None = None) -> dict:
        ...
        # With modstates
        if num_modstates:
            # NOTE: this if statement is unnecessary because `_load_2d_plot_values` already chains together modstate data
            series_data = {}
    ...
    def quality_build_frame_rms(self, task_type: str, num_modstates: int | None = None) -> dict:
...
class _PolcalQualityMixin:
    ...
    def quality_build_polcal_local_parameter_values(self, label: str) -> dict:
        ...
        description += self._compute_bin_description(data)
    ...
    @staticmethod
    def _compute_bin_description(data: dict) -> str:
        """
        ...
        """
        base_str = f" Data show {data['total_bins']} total samples spanning "
