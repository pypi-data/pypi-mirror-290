...
#define OPENBLAS_L2_ASSOCIATIVE 32
#define OPENBLAS_HAVE_VFPV4 
#define OPENBLAS_HAVE_VFPV3 
#define OPENBLAS_HAVE_VFP 
#define OPENBLAS_HAVE_NEON 
#define OPENBLAS_ARMV8 
#define OPENBLAS_CORE_VORTEX 
#define OPENBLAS_CHAR_CORENAME "VORTEX"
