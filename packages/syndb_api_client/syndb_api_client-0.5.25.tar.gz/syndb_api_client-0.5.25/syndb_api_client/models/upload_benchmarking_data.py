...
class UploadBenchmarkingData(BaseModel):
    """
    UploadBenchmarkingData
    """  # noqa: E501

    upload_interval: StrictStr
    payload_byte_size: StrictInt
    continent: StrictStr
    country: Annotated[str, Field(strict=True)]
    city: StrictStr
    __properties: ClassVar[List[str]] = ["upload_interval", "payload_byte_size", "continent", "country", "city"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UploadBenchmarkingData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UploadBenchmarkingData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "upload_interval": obj.get("upload_interval"),
