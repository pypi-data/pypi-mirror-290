...
class UploadedSingleDataset(BaseModel):
    """
    ...
    brain_region: BrainRegionCreateReadOutput
    microscopy: StrictStr
    notes: Optional[StrictStr] = None
    owner_id: StrictStr
    syndb_tables: List[SyndbTable]
    number_of_units: StrictInt
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UploadedSingleDataset from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of animal
        if self.animal:
            _dict["animal"] = self.animal.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UploadedSingleDataset from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "brain_region": (
                    BrainRegionCreateReadOutput.from_dict(obj["brain_region"])
