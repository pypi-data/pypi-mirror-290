...
class UserProfile(BaseModel):
    ...
    scientist_tag: Optional[StrictStr]
    has_profile_picture: StrictBool
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if scientist_tag (nullable) is None
        # and model_fields_set contains the field
        if self.scientist_tag is None and "scientist_tag" in self.model_fields_set:
            _dict["scientist_tag"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "scientist_tag": obj.get("scientist_tag"),
                "has_profile_picture": obj.get("has_profile_picture"),
            }
        )
        return _obj
