...
### 測試 collection_status_api
```shell
curl -X POST http://localhost:8000/api/botrun/botrun_ask_folder/init_collection_status \
  -H "Content-Type: application/json" \
  -d '{"id":"test_collection_1","status":"PROCESSING","items":[{"id":"item1","name":"Test Item 1","mimeType":"application/pdf","modifiedTime":"2023-05-20T10:30:00Z","size":"1024","parent":"parent_folder_id","path":"/path/to/item1"}]}'
```
