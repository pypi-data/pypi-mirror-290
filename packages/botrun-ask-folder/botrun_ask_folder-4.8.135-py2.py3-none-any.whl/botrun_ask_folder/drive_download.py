...
from .drive_download_metadata import save_drive_download_metadata, update_drive_download_metadata
...
def drive_download(service_account_file: str,
    ...
    new_items = drive_download_items(service_account_file, items, output_folder, force)
...
def drive_download_items(service_account_file, items, output_folder, force: bool = False) -> list:
