"""
Setup script for mypy-boto3-chime-sdk-identity.
"""
...
setup(
    ...
    description="Type annotations for boto3.ChimeSDKIdentity 1.35.0 service generated with mypy-boto3-builder 7.26.0",
    classifiers=[
