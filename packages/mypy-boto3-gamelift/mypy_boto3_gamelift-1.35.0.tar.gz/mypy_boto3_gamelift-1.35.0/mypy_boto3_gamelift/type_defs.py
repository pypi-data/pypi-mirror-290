...
FilterConfigurationExtraOutputTypeDef = TypedDict(
    "FilterConfigurationExtraOutputTypeDef",
    {
...
PriorityConfigurationExtraOutputTypeDef = TypedDict(
    "PriorityConfigurationExtraOutputTypeDef",
    {
        "PriorityOrder": NotRequired[List[PriorityTypeType]],
        "LocationOrder": NotRequired[List[str]],
...
PlayerTypeDef = TypedDict(
    ...
    {
        "PlayerId": NotRequired[str],
        "PlayerAttributes": NotRequired[Mapping[str, AttributeValueTypeDef]],
        "Team": NotRequired[str],
...
FilterConfigurationUnionTypeDef = Union[
    FilterConfigurationTypeDef, FilterConfigurationExtraOutputTypeDef
]
...
PriorityConfigurationUnionTypeDef = Union[
    PriorityConfigurationTypeDef, PriorityConfigurationExtraOutputTypeDef
]
