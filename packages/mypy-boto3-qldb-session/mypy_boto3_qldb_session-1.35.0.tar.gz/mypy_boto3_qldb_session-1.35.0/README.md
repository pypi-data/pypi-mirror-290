...
[boto3.QLDBSession 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/qldb-session.html#QLDBSession)
...
- Install `boto3-stubs[qldb-session]` in your environment:
...
Install `boto3-stubs-lite[qldb-session]` in your environment:
...
- Install `boto3-stubs[qldb-session]` with services you use in your
  environment:
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_qldb_session/literals/).
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_qldb_session/type_defs/).
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_qldb_session/)
