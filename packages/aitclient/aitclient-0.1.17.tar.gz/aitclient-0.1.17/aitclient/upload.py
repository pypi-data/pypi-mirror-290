...
def aitPOST(access_token_response, directory_path=None, file_type=None, project=None, file_name=None, Proxy=None):
    ...
    logging.info(f'Files successfully uploaded: {files_list.join(", ")}')
