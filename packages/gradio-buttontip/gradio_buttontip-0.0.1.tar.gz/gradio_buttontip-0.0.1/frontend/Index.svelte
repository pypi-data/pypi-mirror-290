...
<div 
	...
	style={`--tooltip-color: ${tooltip_color}; --tooltip-background-color: ${tooltip_background_color}`} on:mouseenter={calculateTooltipPosition}
>
    <Button
		{value}
		{variant}
...
<style>
	...
	.tooltip-text {
		...
		background-color:  var(--tooltip-background-color);/* Use the custom color */
