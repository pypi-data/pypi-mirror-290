    ...
    def upsert_identity_provider(
        ...
        return openapi_client.DomainIdentityProviderInfo.from_json(
            self.authz.get_session().upsert_identity_providers(
                name=provider_name,
                domain_identity_provider=provider_params.to_json(),
            )
        )
