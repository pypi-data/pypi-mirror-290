...
class MitigationStrategy :
    def __init__(self, sampling_method: BaseSampler, target: str = None, protected_attributes: list = None, 
...
class BalanceOutput(TransformerMixin, BaseEstimator, MitigationStrategy):
