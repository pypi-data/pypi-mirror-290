...
class MeshFactory:
	...
	@staticmethod
	def set_geometry_engine(geom_engine: GEOMImpl_Gen) -> None: ...
...
class MeshReferenceType(enum.Enum):
	...
	MESH_COMPONENT: MeshReferenceType
...
class Mesh:
	...
	def load_mesh(self, mesh_directory: str) -> bool: ...
	def load_mesh_from_stl(self, mesh_directory: str) -> bool: ...
	def write_stl(self, export_directory: str) -> str: ...
	def write_msh(self, export_directory: str) -> str: ...
...
class MasterMesh:
    ...
    @staticmethod
    def place_component_mesh(comp_id: int, mesh: Mesh) -> ComponentMesh:
        """
        Places a standalone mesh and inserts it into the master mesh.

        :param comp_id: Unique identifier of the to-be-inserted mesh part.
        :param mesh: Temporary mesh object to be inserted into the master mesh.
        :return: Pointer to newly created component mesh.
        """
        ...
    ...
    @staticmethod
    def get_mesh_reference(comp_id: int) -> MeshReference:
        """
        Gets the mesh reference for a given component ID.

        :param comp_id: Unique query identifier of component mesh.
        :return: Pointer to the mesh reference, or None if not found.
        """
        ...

    @staticmethod
    def delete_mesh_reference(comp_id: int) -> bool:
        """
    ...
    @staticmethod
    def add_node(mesh_component_id: int, xyz: XYZ) -> Node:
        """
        Adds a new node to the master mesh.

        :param mesh_component_id: The mesh component that was active when the node was inserted.
    ...
    def delete_elements(
        ...
        :param mesh_component_id: MeshComponent the element IDs belong to.
    ...
    @staticmethod
    def export_med_file(mesh_component_id: int = -1) -> bool:
        """
        Exports a MED file with the sets defined there.

        :param mesh_component_id: If specified, writes out a MED file for the corresponding component mesh ID.
        :return: True if the file export was successful.
        """
        ...

class MeshReference(Mesh):
...
class Model:
    ...
    @staticmethod
    def set_geometry_engine(pGeometryEngine: GEOMImpl_Gen) -> None: ...
...
class Geometry3DPrimitives:
	def __init__(self, engine: GEOMImpl_Gen): ...
