...
#ifndef MS_KERNELS_INTERNAL_KERNEL_PAGEDATTENTION_IMPL_H_
#define MS_KERNELS_INTERNAL_KERNEL_PAGEDATTENTION_IMPL_H_
...
namespace mindspore {
namespace internal {
class PagedAttentionImpl : public InternelKernelImpl {
 public:
  PagedAttentionImpl(const OpParamPtr &param) : InternelKernelImpl(param){};
  virtual ~PagedAttentionImpl() = default;
 ...
 private:
  ...
  // impl val
  uint64_t B, N, S, D, G, CORE_NUM, table_block_size, q_seqlen;
  bool BFLOAT16, BSH, ALIBI;
