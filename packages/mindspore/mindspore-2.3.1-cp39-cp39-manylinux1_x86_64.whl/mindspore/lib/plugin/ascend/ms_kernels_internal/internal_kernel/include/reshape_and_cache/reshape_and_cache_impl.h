 ...
 */
#ifndef MS_KERNELS_INTERNAL_KERNEL_RESHAPE_AND_CACHE_IMPL_H_
#define MS_KERNELS_INTERNAL_KERNEL_RESHAPE_AND_CACHE_IMPL_H_
...
namespace mindspore {
namespace internal {
class ReshapeAndCacheImpl : public InternelKernelImpl {
 public:
  ReshapeAndCacheImpl(const OpParamPtr &param) : InternelKernelImpl(param) {}
  virtual ~ReshapeAndCacheImpl() {}
