 ...
 */
#ifndef MS_KERNELS_INTERNAL_KERNEL_RESHAPE_AND_CACHE_H_
#define MS_KERNELS_INTERNAL_KERNEL_RESHAPE_AND_CACHE_H_
...
namespace mindspore {
namespace internal {
class AddLayerNormImpl : public InternelKernelImpl {
 public:
  AddLayerNormImpl(const OpParamPtr &param) : InternelKernelImpl(param) {}
  virtual ~AddLayerNormImpl() {}
 ...
 private:
  ...
  void *extra_output_addr = nullptr;
  void *extra_add_addr = nullptr;
