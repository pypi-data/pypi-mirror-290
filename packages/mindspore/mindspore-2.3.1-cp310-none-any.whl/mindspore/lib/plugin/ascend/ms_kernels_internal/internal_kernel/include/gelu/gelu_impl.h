 ...
 */
#ifndef MS_KERNELS_INTERNAL_KERNEL_GELU_IMPL_H_
#define MS_KERNELS_INTERNAL_KERNEL_GELU_IMPL_H_
...
class GeLUImpl : public InternelKernelImpl {
 public:
  GeLUImpl(const OpParamPtr &param) : InternelKernelImpl(param) {}
  virtual ~GeLUImpl() {}
...
#endif  // MS_KERNELS_INTERNAL_KERNEL_GELU_IMPL_H_