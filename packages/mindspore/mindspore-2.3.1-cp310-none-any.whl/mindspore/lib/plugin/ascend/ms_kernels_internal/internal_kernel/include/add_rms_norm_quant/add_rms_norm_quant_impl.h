 ...
 */
#ifndef MS_KERNELS_INTERNAL_KERNEL_ADD_RMS_NORM_QUANT_H_
#define MS_KERNELS_INTERNAL_KERNEL_ADD_RMS_NORM_QUANT_H_
...
namespace mindspore {
namespace internal {
class AddRmsNormQuantImpl : public InternelKernelImpl {
 public:
  AddRmsNormQuantImpl(const OpParamPtr &param) : InternelKernelImpl(param) {}
  virtual ~AddRmsNormQuantImpl() {}
  bool Init(const ValidateInfo &info) override { return true; };
