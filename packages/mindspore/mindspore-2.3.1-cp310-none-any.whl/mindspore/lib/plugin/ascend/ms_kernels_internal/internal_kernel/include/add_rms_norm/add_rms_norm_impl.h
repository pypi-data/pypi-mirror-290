 ...
 */
#ifndef MS_KERNELS_INTERNAL_KERNEL_ADD_RMS_NORM_H_
#define MS_KERNELS_INTERNAL_KERNEL_ADD_RMS_NORM_H_
...
namespace mindspore {
namespace internal {
class AddRmsNormImpl : public InternelKernelImpl {
 public:
  AddRmsNormImpl(const OpParamPtr &param) : InternelKernelImpl(param) {}
  virtual ~AddRmsNormImpl() {}
