...
class OrganizationApplicationsIdpApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_organization_application_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/organization_applications/{client_id}',
                'operation_id': 'delete_organization_application',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
    ...
    def create_organization_application(
        ...
        **kwargs
        ...
        Create an organization OAuth2 application.  Required scope: **organization_applications:execute**  # noqa: E501
    ...
    def delete_organization_application(
        ...
        **kwargs
        ...
        """Delete organization application  # noqa: E501

        Deletes an application.Required scope: **organization_applications:execute**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_organization_application(client_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['client_id'] = \
            client_id
        return self.delete_organization_application_endpoint.call_with_http_info(**kwargs)
