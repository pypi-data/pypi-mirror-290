...
class UsersIdpApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.disable_user_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/users/{user_guid}',
    ...
    def create_user(
        ...
        **kwargs
        ...
        >>> thread = api.create_user(post_user, async_req=True)
        >>> result = thread.get()
    ...
    def disable_user(
        ...
        **kwargs
        ...
        Disables a user. User is not deleted.  Required scope: **users:execute**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.disable_user(user_guid, async_req=True)
        >>> result = thread.get()
    ...
    def get_user(
        ...
        **kwargs
        ...
        Retrieves a user.  Required scope: **users:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_user(user_guid, async_req=True)
        >>> result = thread.get()
    ...
    def list_user(
        ...
        **kwargs
        ...
        Retrieve a list users.  Required scope: **users:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
