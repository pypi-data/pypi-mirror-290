...
class BankApplicationsIdpApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_bank_application_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/bank_applications/{client_id}',
                'operation_id': 'delete_bank_application',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
    ...
    def create_bank_application(
        ...
        **kwargs
        ...
        Creates a bank OAuth2 application.  Required scope: **bank_applications:execute**  # noqa: E501
    ...
    def delete_bank_application(
        self,
        client_id,
        **kwargs
    ):
        """Delete bank application  # noqa: E501

        Deletes an application.Required scope: **bank_applications:execute**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_bank_application(client_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['client_id'] = \
            client_id
        return self.delete_bank_application_endpoint.call_with_http_info(**kwargs)
