...
CmafEncryptionExtraOutputTypeDef = TypedDict(
    "CmafEncryptionExtraOutputTypeDef",
    {
        "SpekeKeyProvider": SpekeKeyProviderExtraOutputTypeDef,
        "ConstantInitializationVector": NotRequired[str],
    },
)
DashEncryptionExtraOutputTypeDef = TypedDict(
    "DashEncryptionExtraOutputTypeDef",
    {
        "SpekeKeyProvider": SpekeKeyProviderExtraOutputTypeDef,
    },
)
HlsEncryptionExtraOutputTypeDef = TypedDict(
    "HlsEncryptionExtraOutputTypeDef",
    {
        "SpekeKeyProvider": SpekeKeyProviderExtraOutputTypeDef,
        "ConstantInitializationVector": NotRequired[str],
...
MssEncryptionExtraOutputTypeDef = TypedDict(
    "MssEncryptionExtraOutputTypeDef",
    {
        "SpekeKeyProvider": SpekeKeyProviderExtraOutputTypeDef,
    },
...
CmafPackageExtraOutputTypeDef = TypedDict(
    "CmafPackageExtraOutputTypeDef",
    {
        "HlsManifests": List[HlsManifestTypeDef],
        "Encryption": NotRequired[CmafEncryptionExtraOutputTypeDef],
        "IncludeEncoderConfigurationInSegments": NotRequired[bool],
        "SegmentDurationSeconds": NotRequired[int],
    },
)
DashPackageExtraOutputTypeDef = TypedDict(
    "DashPackageExtraOutputTypeDef",
    {
        "DashManifests": List[DashManifestTypeDef],
        "Encryption": NotRequired[DashEncryptionExtraOutputTypeDef],
        "IncludeEncoderConfigurationInSegments": NotRequired[bool],
        "IncludeIframeOnlyStream": NotRequired[bool],
...
HlsPackageExtraOutputTypeDef = TypedDict(
    "HlsPackageExtraOutputTypeDef",
    {
        "HlsManifests": List[HlsManifestTypeDef],
        "Encryption": NotRequired[HlsEncryptionExtraOutputTypeDef],
        "IncludeDvbSubtitles": NotRequired[bool],
        "SegmentDurationSeconds": NotRequired[int],
        "UseAudioRenditionGroup": NotRequired[bool],
    },
)
MssPackageExtraOutputTypeDef = TypedDict(
    "MssPackageExtraOutputTypeDef",
    {
        "MssManifests": List[MssManifestTypeDef],
        "Encryption": NotRequired[MssEncryptionExtraOutputTypeDef],
        "SegmentDurationSeconds": NotRequired[int],
    },
)
...
CmafPackageUnionTypeDef = Union[CmafPackageTypeDef, CmafPackageExtraOutputTypeDef]
DashPackageUnionTypeDef = Union[DashPackageTypeDef, DashPackageExtraOutputTypeDef]
HlsPackageUnionTypeDef = Union[HlsPackageTypeDef, HlsPackageExtraOutputTypeDef]
...
MssPackageUnionTypeDef = Union[MssPackageTypeDef, MssPackageExtraOutputTypeDef]
