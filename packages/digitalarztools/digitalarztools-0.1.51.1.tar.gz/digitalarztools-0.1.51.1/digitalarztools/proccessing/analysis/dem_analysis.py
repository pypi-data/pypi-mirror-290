...
class DEMAnalysis:
    ...
    def get_z_factor(self, z_in: str = "m", lat: float = None) -> float:
        """
    ...
    @staticmethod
    def extract_streams(flow_accumulation: np.ndarray, threshold: float = None, std_multiplier: float = 2) -> np.ndarray:
        """
