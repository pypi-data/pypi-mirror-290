...
if TYPE_CHECKING:
    from ..models.list_completed_jobs_response_200_item_raw_flow_modules_item_suspend_resume_form import (
        ListCompletedJobsResponse200ItemRawFlowModulesItemSuspendResumeForm,
    )
    from ..models.list_completed_jobs_response_200_item_raw_flow_modules_item_suspend_user_groups_required_type_0 import (
        ListCompletedJobsResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType0,
    )
    from ..models.list_completed_jobs_response_200_item_raw_flow_modules_item_suspend_user_groups_required_type_1 import (
        ListCompletedJobsResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType1,
    )
...
@_attrs_define
class ListCompletedJobsResponse200ItemRawFlowModulesItemSuspend:
    """
    Attributes:
        required_events (Union[Unset, int]):
        timeout (Union[Unset, int]):
        resume_form (Union[Unset, ListCompletedJobsResponse200ItemRawFlowModulesItemSuspendResumeForm]):
        user_auth_required (Union[Unset, bool]):
        user_groups_required (Union['ListCompletedJobsResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType0',
            'ListCompletedJobsResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "ListCompletedJobsResponse200ItemRawFlowModulesItemSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.user_groups_required, Unset):
            ...
            self.user_groups_required, ListCompletedJobsResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType0
        ):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = ListCompletedJobsResponse200ItemRawFlowModulesItemSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, ListCompletedJobsResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        ListCompletedJobsResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, ListCompletedJobsResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    ListCompletedJobsResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType1.from_dict(
        ...
        list_completed_jobs_response_200_item_raw_flow_modules_item_suspend = cls(
        ...
        list_completed_jobs_response_200_item_raw_flow_modules_item_suspend.additional_properties = d
        return list_completed_jobs_response_200_item_raw_flow_modules_item_suspend
