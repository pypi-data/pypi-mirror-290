...
if TYPE_CHECKING:
    from ..models.extended_jobs_jobs_item_type_0_raw_flow_failure_module_suspend_resume_form import (
        ExtendedJobsJobsItemType0RawFlowFailureModuleSuspendResumeForm,
    )
    from ..models.extended_jobs_jobs_item_type_0_raw_flow_failure_module_suspend_user_groups_required_type_0 import (
        ExtendedJobsJobsItemType0RawFlowFailureModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.extended_jobs_jobs_item_type_0_raw_flow_failure_module_suspend_user_groups_required_type_1 import (
        ExtendedJobsJobsItemType0RawFlowFailureModuleSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="ExtendedJobsJobsItemType0RawFlowFailureModuleSuspend")


@_attrs_define
class ExtendedJobsJobsItemType0RawFlowFailureModuleSuspend:
    """
    Attributes:
        required_events (Union[Unset, int]):
        timeout (Union[Unset, int]):
        resume_form (Union[Unset, ExtendedJobsJobsItemType0RawFlowFailureModuleSuspendResumeForm]):
        user_auth_required (Union[Unset, bool]):
        user_groups_required (Union['ExtendedJobsJobsItemType0RawFlowFailureModuleSuspendUserGroupsRequiredType0',
            'ExtendedJobsJobsItemType0RawFlowFailureModuleSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "ExtendedJobsJobsItemType0RawFlowFailureModuleSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.user_groups_required, Unset):
            ...
            self.user_groups_required, ExtendedJobsJobsItemType0RawFlowFailureModuleSuspendUserGroupsRequiredType0
        ):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = ExtendedJobsJobsItemType0RawFlowFailureModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, ExtendedJobsJobsItemType0RawFlowFailureModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        ExtendedJobsJobsItemType0RawFlowFailureModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, ExtendedJobsJobsItemType0RawFlowFailureModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    ExtendedJobsJobsItemType0RawFlowFailureModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        extended_jobs_jobs_item_type_0_raw_flow_failure_module_suspend = cls(
        ...
        extended_jobs_jobs_item_type_0_raw_flow_failure_module_suspend.additional_properties = d
        return extended_jobs_jobs_item_type_0_raw_flow_failure_module_suspend
