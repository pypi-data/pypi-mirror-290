...
if TYPE_CHECKING:
    from ..models.open_flow_value_modules_item_suspend_resume_form import OpenFlowValueModulesItemSuspendResumeForm
    from ..models.open_flow_value_modules_item_suspend_user_groups_required_type_0 import (
        OpenFlowValueModulesItemSuspendUserGroupsRequiredType0,
    )
    from ..models.open_flow_value_modules_item_suspend_user_groups_required_type_1 import (
        OpenFlowValueModulesItemSuspendUserGroupsRequiredType1,
    )
...
class OpenFlowValueModulesItemSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, OpenFlowValueModulesItemSuspendResumeForm]):
        user_auth_required (Union[Unset, bool]):
        user_groups_required (Union['OpenFlowValueModulesItemSuspendUserGroupsRequiredType0',
            'OpenFlowValueModulesItemSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "OpenFlowValueModulesItemSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.user_groups_required, OpenFlowValueModulesItemSuspendUserGroupsRequiredType0):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = OpenFlowValueModulesItemSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[Unset, OpenFlowValueModulesItemSuspendUserGroupsRequiredType0]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = OpenFlowValueModulesItemSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[Unset, OpenFlowValueModulesItemSuspendUserGroupsRequiredType1]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = OpenFlowValueModulesItemSuspendUserGroupsRequiredType1.from_dict(
