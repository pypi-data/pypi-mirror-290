...
if TYPE_CHECKING:
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_raw_flow_modules_item_suspend_resume_form import (
        ListExtendedJobsResponse200JobsItemType1RawFlowModulesItemSuspendResumeForm,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_raw_flow_modules_item_suspend_user_groups_required_type_0 import (
        ListExtendedJobsResponse200JobsItemType1RawFlowModulesItemSuspendUserGroupsRequiredType0,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_raw_flow_modules_item_suspend_user_groups_required_type_1 import (
        ListExtendedJobsResponse200JobsItemType1RawFlowModulesItemSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="ListExtendedJobsResponse200JobsItemType1RawFlowModulesItemSuspend")


@_attrs_define
class ListExtendedJobsResponse200JobsItemType1RawFlowModulesItemSuspend:
    """
    Attributes:
        required_events (Union[Unset, int]):
        timeout (Union[Unset, int]):
        resume_form (Union[Unset, ListExtendedJobsResponse200JobsItemType1RawFlowModulesItemSuspendResumeForm]):
        user_auth_required (Union[Unset, bool]):
        user_groups_required
            (Union['ListExtendedJobsResponse200JobsItemType1RawFlowModulesItemSuspendUserGroupsRequiredType0',
            'ListExtendedJobsResponse200JobsItemType1RawFlowModulesItemSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "ListExtendedJobsResponse200JobsItemType1RawFlowModulesItemSuspendResumeForm"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = ListExtendedJobsResponse200JobsItemType1RawFlowModulesItemSuspendResumeForm.from_dict(
                _resume_form
            )
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, ListExtendedJobsResponse200JobsItemType1RawFlowModulesItemSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = ListExtendedJobsResponse200JobsItemType1RawFlowModulesItemSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, ListExtendedJobsResponse200JobsItemType1RawFlowModulesItemSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    ListExtendedJobsResponse200JobsItemType1RawFlowModulesItemSuspendUserGroupsRequiredType1.from_dict(
        ...
        list_extended_jobs_response_200_jobs_item_type_1_raw_flow_modules_item_suspend = cls(
        ...
        list_extended_jobs_response_200_jobs_item_type_1_raw_flow_modules_item_suspend.additional_properties = d
        return list_extended_jobs_response_200_jobs_item_type_1_raw_flow_modules_item_suspend
