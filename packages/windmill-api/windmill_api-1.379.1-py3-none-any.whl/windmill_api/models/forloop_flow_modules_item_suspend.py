...
if TYPE_CHECKING:
    from ..models.forloop_flow_modules_item_suspend_resume_form import ForloopFlowModulesItemSuspendResumeForm
...
@_attrs_define
class ForloopFlowModulesItemSuspend:
    """
    Attributes:
        required_events (Union[Unset, int]):
        timeout (Union[Unset, int]):
        resume_form (Union[Unset, ForloopFlowModulesItemSuspendResumeForm]):
        user_auth_required (Union[Unset, bool]):
        user_groups_required (Union['ForloopFlowModulesItemSuspendUserGroupsRequiredType0',
            'ForloopFlowModulesItemSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "ForloopFlowModulesItemSuspendResumeForm"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = ForloopFlowModulesItemSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[Unset, ForloopFlowModulesItemSuspendUserGroupsRequiredType0]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = ForloopFlowModulesItemSuspendUserGroupsRequiredType0.from_dict(
        ...
        forloop_flow_modules_item_suspend = cls(
        ...
        forloop_flow_modules_item_suspend.additional_properties = d
        return forloop_flow_modules_item_suspend
