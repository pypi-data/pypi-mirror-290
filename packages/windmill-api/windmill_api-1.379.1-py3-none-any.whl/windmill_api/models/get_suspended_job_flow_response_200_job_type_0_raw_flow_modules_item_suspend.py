...
if TYPE_CHECKING:
    from ..models.get_suspended_job_flow_response_200_job_type_0_raw_flow_modules_item_suspend_resume_form import (
        GetSuspendedJobFlowResponse200JobType0RawFlowModulesItemSuspendResumeForm,
    )
...
@_attrs_define
class GetSuspendedJobFlowResponse200JobType0RawFlowModulesItemSuspend:
    """
    Attributes:
        required_events (Union[Unset, int]):
        timeout (Union[Unset, int]):
        resume_form (Union[Unset, GetSuspendedJobFlowResponse200JobType0RawFlowModulesItemSuspendResumeForm]):
        ...
        user_groups_required
            ...
            'GetSuspendedJobFlowResponse200JobType0RawFlowModulesItemSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "GetSuspendedJobFlowResponse200JobType0RawFlowModulesItemSuspendResumeForm"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = GetSuspendedJobFlowResponse200JobType0RawFlowModulesItemSuspendResumeForm.from_dict(
                _resume_form
            )
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, GetSuspendedJobFlowResponse200JobType0RawFlowModulesItemSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = GetSuspendedJobFlowResponse200JobType0RawFlowModulesItemSuspendUserGroupsRequiredType0.from_dict(
        ...
        get_suspended_job_flow_response_200_job_type_0_raw_flow_modules_item_suspend = cls(
        ...
        get_suspended_job_flow_response_200_job_type_0_raw_flow_modules_item_suspend.additional_properties = d
        return get_suspended_job_flow_response_200_job_type_0_raw_flow_modules_item_suspend
