...
if TYPE_CHECKING:
    from ..models.get_suspended_job_flow_response_200_job_type_1_raw_flow_failure_module_suspend_resume_form import (
        GetSuspendedJobFlowResponse200JobType1RawFlowFailureModuleSuspendResumeForm,
    )
    from ..models.get_suspended_job_flow_response_200_job_type_1_raw_flow_failure_module_suspend_user_groups_required_type_0 import (
        GetSuspendedJobFlowResponse200JobType1RawFlowFailureModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.get_suspended_job_flow_response_200_job_type_1_raw_flow_failure_module_suspend_user_groups_required_type_1 import (
        GetSuspendedJobFlowResponse200JobType1RawFlowFailureModuleSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="GetSuspendedJobFlowResponse200JobType1RawFlowFailureModuleSuspend")


@_attrs_define
class GetSuspendedJobFlowResponse200JobType1RawFlowFailureModuleSuspend:
    """
    Attributes:
        required_events (Union[Unset, int]):
        timeout (Union[Unset, int]):
        resume_form (Union[Unset, GetSuspendedJobFlowResponse200JobType1RawFlowFailureModuleSuspendResumeForm]):
        user_auth_required (Union[Unset, bool]):
        user_groups_required
            (Union['GetSuspendedJobFlowResponse200JobType1RawFlowFailureModuleSuspendUserGroupsRequiredType0',
            'GetSuspendedJobFlowResponse200JobType1RawFlowFailureModuleSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "GetSuspendedJobFlowResponse200JobType1RawFlowFailureModuleSuspendResumeForm"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = GetSuspendedJobFlowResponse200JobType1RawFlowFailureModuleSuspendResumeForm.from_dict(
                _resume_form
            )
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, GetSuspendedJobFlowResponse200JobType1RawFlowFailureModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = GetSuspendedJobFlowResponse200JobType1RawFlowFailureModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, GetSuspendedJobFlowResponse200JobType1RawFlowFailureModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    GetSuspendedJobFlowResponse200JobType1RawFlowFailureModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        get_suspended_job_flow_response_200_job_type_1_raw_flow_failure_module_suspend = cls(
        ...
        get_suspended_job_flow_response_200_job_type_1_raw_flow_failure_module_suspend.additional_properties = d
        return get_suspended_job_flow_response_200_job_type_1_raw_flow_failure_module_suspend
