...
if TYPE_CHECKING:
    from ..models.list_queue_response_200_item_raw_flow_failure_module_suspend_resume_form import (
        ListQueueResponse200ItemRawFlowFailureModuleSuspendResumeForm,
    )
    from ..models.list_queue_response_200_item_raw_flow_failure_module_suspend_user_groups_required_type_0 import (
        ListQueueResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.list_queue_response_200_item_raw_flow_failure_module_suspend_user_groups_required_type_1 import (
...
@_attrs_define
class ListQueueResponse200ItemRawFlowFailureModuleSuspend:
    """
    Attributes:
        required_events (Union[Unset, int]):
        timeout (Union[Unset, int]):
        resume_form (Union[Unset, ListQueueResponse200ItemRawFlowFailureModuleSuspendResumeForm]):
        user_auth_required (Union[Unset, bool]):
        user_groups_required (Union['ListQueueResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType0',
            'ListQueueResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "ListQueueResponse200ItemRawFlowFailureModuleSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.user_groups_required, Unset):
            ...
            self.user_groups_required, ListQueueResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType0
        ):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = ListQueueResponse200ItemRawFlowFailureModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, ListQueueResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        ListQueueResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, ListQueueResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    ListQueueResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        list_queue_response_200_item_raw_flow_failure_module_suspend = cls(
        ...
        list_queue_response_200_item_raw_flow_failure_module_suspend.additional_properties = d
