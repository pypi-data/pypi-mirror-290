...
if TYPE_CHECKING:
    from ..models.get_flow_by_path_with_draft_response_200_draft_value_modules_item_suspend_resume_form import (
        GetFlowByPathWithDraftResponse200DraftValueModulesItemSuspendResumeForm,
    )
    from ..models.get_flow_by_path_with_draft_response_200_draft_value_modules_item_suspend_user_groups_required_type_0 import (
        GetFlowByPathWithDraftResponse200DraftValueModulesItemSuspendUserGroupsRequiredType0,
    )
    from ..models.get_flow_by_path_with_draft_response_200_draft_value_modules_item_suspend_user_groups_required_type_1 import (
        GetFlowByPathWithDraftResponse200DraftValueModulesItemSuspendUserGroupsRequiredType1,
    )
...
class GetFlowByPathWithDraftResponse200DraftValueModulesItemSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, GetFlowByPathWithDraftResponse200DraftValueModulesItemSuspendResumeForm]):
        user_auth_required (Union[Unset, bool]):
        user_groups_required
            (Union['GetFlowByPathWithDraftResponse200DraftValueModulesItemSuspendUserGroupsRequiredType0',
            'GetFlowByPathWithDraftResponse200DraftValueModulesItemSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "GetFlowByPathWithDraftResponse200DraftValueModulesItemSuspendResumeForm"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = GetFlowByPathWithDraftResponse200DraftValueModulesItemSuspendResumeForm.from_dict(
                _resume_form
            )
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, GetFlowByPathWithDraftResponse200DraftValueModulesItemSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        GetFlowByPathWithDraftResponse200DraftValueModulesItemSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, GetFlowByPathWithDraftResponse200DraftValueModulesItemSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    GetFlowByPathWithDraftResponse200DraftValueModulesItemSuspendUserGroupsRequiredType1.from_dict(
