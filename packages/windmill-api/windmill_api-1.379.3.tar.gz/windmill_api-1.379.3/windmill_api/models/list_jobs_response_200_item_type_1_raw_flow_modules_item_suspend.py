...
if TYPE_CHECKING:
    from ..models.list_jobs_response_200_item_type_1_raw_flow_modules_item_suspend_resume_form import (
        ListJobsResponse200ItemType1RawFlowModulesItemSuspendResumeForm,
    )
    from ..models.list_jobs_response_200_item_type_1_raw_flow_modules_item_suspend_user_groups_required_type_0 import (
        ListJobsResponse200ItemType1RawFlowModulesItemSuspendUserGroupsRequiredType0,
    )
    from ..models.list_jobs_response_200_item_type_1_raw_flow_modules_item_suspend_user_groups_required_type_1 import (
        ListJobsResponse200ItemType1RawFlowModulesItemSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="ListJobsResponse200ItemType1RawFlowModulesItemSuspend")


@_attrs_define
class ListJobsResponse200ItemType1RawFlowModulesItemSuspend:
    """
    Attributes:
        required_events (Union[Unset, int]):
        timeout (Union[Unset, int]):
        resume_form (Union[Unset, ListJobsResponse200ItemType1RawFlowModulesItemSuspendResumeForm]):
        user_auth_required (Union[Unset, bool]):
        user_groups_required (Union['ListJobsResponse200ItemType1RawFlowModulesItemSuspendUserGroupsRequiredType0',
            'ListJobsResponse200ItemType1RawFlowModulesItemSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "ListJobsResponse200ItemType1RawFlowModulesItemSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.user_groups_required, Unset):
            ...
            self.user_groups_required, ListJobsResponse200ItemType1RawFlowModulesItemSuspendUserGroupsRequiredType0
        ):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = ListJobsResponse200ItemType1RawFlowModulesItemSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, ListJobsResponse200ItemType1RawFlowModulesItemSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        ListJobsResponse200ItemType1RawFlowModulesItemSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, ListJobsResponse200ItemType1RawFlowModulesItemSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    ListJobsResponse200ItemType1RawFlowModulesItemSuspendUserGroupsRequiredType1.from_dict(
        ...
        list_jobs_response_200_item_type_1_raw_flow_modules_item_suspend = cls(
        ...
        list_jobs_response_200_item_type_1_raw_flow_modules_item_suspend.additional_properties = d
        return list_jobs_response_200_item_type_1_raw_flow_modules_item_suspend
