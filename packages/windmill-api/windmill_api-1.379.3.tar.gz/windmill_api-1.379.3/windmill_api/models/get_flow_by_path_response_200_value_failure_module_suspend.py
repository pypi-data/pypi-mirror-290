...
if TYPE_CHECKING:
    from ..models.get_flow_by_path_response_200_value_failure_module_suspend_resume_form import (
        GetFlowByPathResponse200ValueFailureModuleSuspendResumeForm,
    )
    from ..models.get_flow_by_path_response_200_value_failure_module_suspend_user_groups_required_type_0 import (
        GetFlowByPathResponse200ValueFailureModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.get_flow_by_path_response_200_value_failure_module_suspend_user_groups_required_type_1 import (
        GetFlowByPathResponse200ValueFailureModuleSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="GetFlowByPathResponse200ValueFailureModuleSuspend")


@_attrs_define
class GetFlowByPathResponse200ValueFailureModuleSuspend:
    """
    Attributes:
        required_events (Union[Unset, int]):
        timeout (Union[Unset, int]):
        resume_form (Union[Unset, GetFlowByPathResponse200ValueFailureModuleSuspendResumeForm]):
        user_auth_required (Union[Unset, bool]):
        user_groups_required (Union['GetFlowByPathResponse200ValueFailureModuleSuspendUserGroupsRequiredType0',
            'GetFlowByPathResponse200ValueFailureModuleSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "GetFlowByPathResponse200ValueFailureModuleSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.user_groups_required, Unset):
            ...
            self.user_groups_required, GetFlowByPathResponse200ValueFailureModuleSuspendUserGroupsRequiredType0
        ):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = GetFlowByPathResponse200ValueFailureModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, GetFlowByPathResponse200ValueFailureModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        GetFlowByPathResponse200ValueFailureModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, GetFlowByPathResponse200ValueFailureModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    GetFlowByPathResponse200ValueFailureModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        get_flow_by_path_response_200_value_failure_module_suspend = cls(
        ...
        get_flow_by_path_response_200_value_failure_module_suspend.additional_properties = d
