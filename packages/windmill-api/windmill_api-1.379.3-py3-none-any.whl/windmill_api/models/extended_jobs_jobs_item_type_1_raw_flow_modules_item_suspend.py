...
if TYPE_CHECKING:
    from ..models.extended_jobs_jobs_item_type_1_raw_flow_modules_item_suspend_resume_form import (
        ExtendedJobsJobsItemType1RawFlowModulesItemSuspendResumeForm,
    )
    from ..models.extended_jobs_jobs_item_type_1_raw_flow_modules_item_suspend_user_groups_required_type_0 import (
        ExtendedJobsJobsItemType1RawFlowModulesItemSuspendUserGroupsRequiredType0,
    )
    from ..models.extended_jobs_jobs_item_type_1_raw_flow_modules_item_suspend_user_groups_required_type_1 import (
        ExtendedJobsJobsItemType1RawFlowModulesItemSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="ExtendedJobsJobsItemType1RawFlowModulesItemSuspend")


@_attrs_define
class ExtendedJobsJobsItemType1RawFlowModulesItemSuspend:
    """
    Attributes:
        required_events (Union[Unset, int]):
        timeout (Union[Unset, int]):
        resume_form (Union[Unset, ExtendedJobsJobsItemType1RawFlowModulesItemSuspendResumeForm]):
        user_auth_required (Union[Unset, bool]):
        user_groups_required (Union['ExtendedJobsJobsItemType1RawFlowModulesItemSuspendUserGroupsRequiredType0',
            'ExtendedJobsJobsItemType1RawFlowModulesItemSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "ExtendedJobsJobsItemType1RawFlowModulesItemSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.user_groups_required, Unset):
            ...
            self.user_groups_required, ExtendedJobsJobsItemType1RawFlowModulesItemSuspendUserGroupsRequiredType0
        ):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = ExtendedJobsJobsItemType1RawFlowModulesItemSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, ExtendedJobsJobsItemType1RawFlowModulesItemSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        ExtendedJobsJobsItemType1RawFlowModulesItemSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, ExtendedJobsJobsItemType1RawFlowModulesItemSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    ExtendedJobsJobsItemType1RawFlowModulesItemSuspendUserGroupsRequiredType1.from_dict(
        ...
        extended_jobs_jobs_item_type_1_raw_flow_modules_item_suspend = cls(
        ...
        extended_jobs_jobs_item_type_1_raw_flow_modules_item_suspend.additional_properties = d
        return extended_jobs_jobs_item_type_1_raw_flow_modules_item_suspend
