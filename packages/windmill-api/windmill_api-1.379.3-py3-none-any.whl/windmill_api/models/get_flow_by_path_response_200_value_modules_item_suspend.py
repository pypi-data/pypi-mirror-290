...
if TYPE_CHECKING:
    from ..models.get_flow_by_path_response_200_value_modules_item_suspend_resume_form import (
        GetFlowByPathResponse200ValueModulesItemSuspendResumeForm,
    )
    from ..models.get_flow_by_path_response_200_value_modules_item_suspend_user_groups_required_type_0 import (
        GetFlowByPathResponse200ValueModulesItemSuspendUserGroupsRequiredType0,
    )
    from ..models.get_flow_by_path_response_200_value_modules_item_suspend_user_groups_required_type_1 import (
        GetFlowByPathResponse200ValueModulesItemSuspendUserGroupsRequiredType1,
    )
...
@_attrs_define
class GetFlowByPathResponse200ValueModulesItemSuspend:
    """
    Attributes:
        ...
        user_groups_required (Union['GetFlowByPathResponse200ValueModulesItemSuspendUserGroupsRequiredType0',
            'GetFlowByPathResponse200ValueModulesItemSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "GetFlowByPathResponse200ValueModulesItemSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.user_groups_required, Unset):
            ...
            self.user_groups_required, GetFlowByPathResponse200ValueModulesItemSuspendUserGroupsRequiredType0
        ):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = GetFlowByPathResponse200ValueModulesItemSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, GetFlowByPathResponse200ValueModulesItemSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        GetFlowByPathResponse200ValueModulesItemSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, GetFlowByPathResponse200ValueModulesItemSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    GetFlowByPathResponse200ValueModulesItemSuspendUserGroupsRequiredType1.from_dict(
        ...
        get_flow_by_path_response_200_value_modules_item_suspend = cls(
        ...
        get_flow_by_path_response_200_value_modules_item_suspend.additional_properties = d
        return get_flow_by_path_response_200_value_modules_item_suspend
