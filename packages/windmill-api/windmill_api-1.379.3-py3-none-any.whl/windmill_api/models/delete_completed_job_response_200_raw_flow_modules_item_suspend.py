...
if TYPE_CHECKING:
    from ..models.delete_completed_job_response_200_raw_flow_modules_item_suspend_resume_form import (
        DeleteCompletedJobResponse200RawFlowModulesItemSuspendResumeForm,
    )
    from ..models.delete_completed_job_response_200_raw_flow_modules_item_suspend_user_groups_required_type_0 import (
        DeleteCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType0,
    )
    from ..models.delete_completed_job_response_200_raw_flow_modules_item_suspend_user_groups_required_type_1 import (
        DeleteCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="DeleteCompletedJobResponse200RawFlowModulesItemSuspend")


@_attrs_define
class DeleteCompletedJobResponse200RawFlowModulesItemSuspend:
    """
    Attributes:
        ...
        user_groups_required (Union['DeleteCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType0',
            'DeleteCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "DeleteCompletedJobResponse200RawFlowModulesItemSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.user_groups_required, Unset):
            ...
            self.user_groups_required, DeleteCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType0
        ):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = DeleteCompletedJobResponse200RawFlowModulesItemSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, DeleteCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        DeleteCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, DeleteCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    DeleteCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType1.from_dict(
        ...
        delete_completed_job_response_200_raw_flow_modules_item_suspend = cls(
        ...
        delete_completed_job_response_200_raw_flow_modules_item_suspend.additional_properties = d
