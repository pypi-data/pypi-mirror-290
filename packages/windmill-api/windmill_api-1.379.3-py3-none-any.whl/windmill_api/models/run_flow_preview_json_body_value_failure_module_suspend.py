...
if TYPE_CHECKING:
    from ..models.run_flow_preview_json_body_value_failure_module_suspend_resume_form import (
        RunFlowPreviewJsonBodyValueFailureModuleSuspendResumeForm,
    )
    from ..models.run_flow_preview_json_body_value_failure_module_suspend_user_groups_required_type_0 import (
        RunFlowPreviewJsonBodyValueFailureModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.run_flow_preview_json_body_value_failure_module_suspend_user_groups_required_type_1 import (
        RunFlowPreviewJsonBodyValueFailureModuleSuspendUserGroupsRequiredType1,
    )
...
class RunFlowPreviewJsonBodyValueFailureModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, RunFlowPreviewJsonBodyValueFailureModuleSuspendResumeForm]):
        ...
        user_groups_required (Union['RunFlowPreviewJsonBodyValueFailureModuleSuspendUserGroupsRequiredType0',
            'RunFlowPreviewJsonBodyValueFailureModuleSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "RunFlowPreviewJsonBodyValueFailureModuleSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.user_groups_required, Unset):
            ...
            self.user_groups_required, RunFlowPreviewJsonBodyValueFailureModuleSuspendUserGroupsRequiredType0
        ):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = RunFlowPreviewJsonBodyValueFailureModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, RunFlowPreviewJsonBodyValueFailureModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        RunFlowPreviewJsonBodyValueFailureModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, RunFlowPreviewJsonBodyValueFailureModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    RunFlowPreviewJsonBodyValueFailureModuleSuspendUserGroupsRequiredType1.from_dict(
