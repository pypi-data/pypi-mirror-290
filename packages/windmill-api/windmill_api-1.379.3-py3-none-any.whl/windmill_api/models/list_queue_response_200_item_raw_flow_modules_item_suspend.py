...
if TYPE_CHECKING:
    from ..models.list_queue_response_200_item_raw_flow_modules_item_suspend_resume_form import (
        ListQueueResponse200ItemRawFlowModulesItemSuspendResumeForm,
    )
    from ..models.list_queue_response_200_item_raw_flow_modules_item_suspend_user_groups_required_type_0 import (
        ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType0,
    )
    from ..models.list_queue_response_200_item_raw_flow_modules_item_suspend_user_groups_required_type_1 import (
...
class ListQueueResponse200ItemRawFlowModulesItemSuspend:
    ...
    Attributes:
        ...
        user_groups_required (Union['ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType0',
            'ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "ListQueueResponse200ItemRawFlowModulesItemSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.user_groups_required, Unset):
            ...
            self.user_groups_required, ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType0
        ):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = ListQueueResponse200ItemRawFlowModulesItemSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType1.from_dict(
