...
if TYPE_CHECKING:
    from ..models.open_flow_value_failure_module_suspend_resume_form import OpenFlowValueFailureModuleSuspendResumeForm
    from ..models.open_flow_value_failure_module_suspend_user_groups_required_type_0 import (
        OpenFlowValueFailureModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.open_flow_value_failure_module_suspend_user_groups_required_type_1 import (
        OpenFlowValueFailureModuleSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="OpenFlowValueFailureModuleSuspend")


@_attrs_define
class OpenFlowValueFailureModuleSuspend:
    """
    Attributes:
        required_events (Union[Unset, int]):
        timeout (Union[Unset, int]):
        resume_form (Union[Unset, OpenFlowValueFailureModuleSuspendResumeForm]):
        user_auth_required (Union[Unset, bool]):
        user_groups_required (Union['OpenFlowValueFailureModuleSuspendUserGroupsRequiredType0',
            'OpenFlowValueFailureModuleSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "OpenFlowValueFailureModuleSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.user_groups_required, OpenFlowValueFailureModuleSuspendUserGroupsRequiredType0):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.open_flow_value_failure_module_suspend_resume_form import (
            OpenFlowValueFailureModuleSuspendResumeForm,
        )
        from ..models.open_flow_value_failure_module_suspend_user_groups_required_type_0 import (
            OpenFlowValueFailureModuleSuspendUserGroupsRequiredType0,
        )
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = OpenFlowValueFailureModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[Unset, OpenFlowValueFailureModuleSuspendUserGroupsRequiredType0]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = OpenFlowValueFailureModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[Unset, OpenFlowValueFailureModuleSuspendUserGroupsRequiredType1]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = OpenFlowValueFailureModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        open_flow_value_failure_module_suspend = cls(
        ...
        open_flow_value_failure_module_suspend.additional_properties = d
