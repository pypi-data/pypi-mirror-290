...
if TYPE_CHECKING:
    from ..models.get_hub_flow_by_id_response_200_flow_value_failure_module_suspend_resume_form import (
        GetHubFlowByIdResponse200FlowValueFailureModuleSuspendResumeForm,
    )
    from ..models.get_hub_flow_by_id_response_200_flow_value_failure_module_suspend_user_groups_required_type_0 import (
        GetHubFlowByIdResponse200FlowValueFailureModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.get_hub_flow_by_id_response_200_flow_value_failure_module_suspend_user_groups_required_type_1 import (
        GetHubFlowByIdResponse200FlowValueFailureModuleSuspendUserGroupsRequiredType1,
    )
...
@_attrs_define
class GetHubFlowByIdResponse200FlowValueFailureModuleSuspend:
    """
    Attributes:
        required_events (Union[Unset, int]):
        timeout (Union[Unset, int]):
        resume_form (Union[Unset, GetHubFlowByIdResponse200FlowValueFailureModuleSuspendResumeForm]):
        ...
        user_groups_required (Union['GetHubFlowByIdResponse200FlowValueFailureModuleSuspendUserGroupsRequiredType0',
            'GetHubFlowByIdResponse200FlowValueFailureModuleSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "GetHubFlowByIdResponse200FlowValueFailureModuleSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.user_groups_required, Unset):
            ...
            self.user_groups_required, GetHubFlowByIdResponse200FlowValueFailureModuleSuspendUserGroupsRequiredType0
        ):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = GetHubFlowByIdResponse200FlowValueFailureModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, GetHubFlowByIdResponse200FlowValueFailureModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        GetHubFlowByIdResponse200FlowValueFailureModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, GetHubFlowByIdResponse200FlowValueFailureModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    GetHubFlowByIdResponse200FlowValueFailureModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        get_hub_flow_by_id_response_200_flow_value_failure_module_suspend = cls(
        ...
        get_hub_flow_by_id_response_200_flow_value_failure_module_suspend.additional_properties = d
