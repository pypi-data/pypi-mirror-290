...
if TYPE_CHECKING:
    from ..models.completed_job_raw_flow_failure_module_suspend_resume_form import (
        CompletedJobRawFlowFailureModuleSuspendResumeForm,
    )
...
@_attrs_define
class CompletedJobRawFlowFailureModuleSuspend:
    """
    Attributes:
        ...
        user_groups_required (Union['CompletedJobRawFlowFailureModuleSuspendUserGroupsRequiredType0',
            'CompletedJobRawFlowFailureModuleSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "CompletedJobRawFlowFailureModuleSuspendResumeForm"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = CompletedJobRawFlowFailureModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, CompletedJobRawFlowFailureModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        CompletedJobRawFlowFailureModuleSuspendUserGroupsRequiredType0.from_dict(
        ...
        completed_job_raw_flow_failure_module_suspend = cls(
        ...
        completed_job_raw_flow_failure_module_suspend.additional_properties = d
        return completed_job_raw_flow_failure_module_suspend
