...
class FlowModuleSuspend:
    ...
    Attributes:
        ...
        user_groups_required (Union['FlowModuleSuspendUserGroupsRequiredType0',
            'FlowModuleSuspendUserGroupsRequiredType1', Unset]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = FlowModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[Unset, FlowModuleSuspendUserGroupsRequiredType0]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = FlowModuleSuspendUserGroupsRequiredType0.from_dict(
        ...
        flow_module_suspend.additional_properties = d
        return flow_module_suspend
