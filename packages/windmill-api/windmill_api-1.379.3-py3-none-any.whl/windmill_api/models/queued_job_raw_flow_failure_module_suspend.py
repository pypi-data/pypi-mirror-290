...
if TYPE_CHECKING:
    from ..models.queued_job_raw_flow_failure_module_suspend_resume_form import (
        QueuedJobRawFlowFailureModuleSuspendResumeForm,
    )
    from ..models.queued_job_raw_flow_failure_module_suspend_user_groups_required_type_0 import (
        QueuedJobRawFlowFailureModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.queued_job_raw_flow_failure_module_suspend_user_groups_required_type_1 import (
        QueuedJobRawFlowFailureModuleSuspendUserGroupsRequiredType1,
    )
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                if isinstance(_user_groups_required_type_0, Unset):
                    ...
                    user_groups_required_type_0 = QueuedJobRawFlowFailureModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            if isinstance(_user_groups_required_type_1, Unset):
                ...
                user_groups_required_type_1 = QueuedJobRawFlowFailureModuleSuspendUserGroupsRequiredType1.from_dict(
