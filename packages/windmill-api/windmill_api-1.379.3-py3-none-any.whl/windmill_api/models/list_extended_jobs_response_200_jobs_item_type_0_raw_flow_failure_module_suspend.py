...
if TYPE_CHECKING:
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_raw_flow_failure_module_suspend_resume_form import (
        ListExtendedJobsResponse200JobsItemType0RawFlowFailureModuleSuspendResumeForm,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_raw_flow_failure_module_suspend_user_groups_required_type_0 import (
        ListExtendedJobsResponse200JobsItemType0RawFlowFailureModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_raw_flow_failure_module_suspend_user_groups_required_type_1 import (
        ListExtendedJobsResponse200JobsItemType0RawFlowFailureModuleSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="ListExtendedJobsResponse200JobsItemType0RawFlowFailureModuleSuspend")


@_attrs_define
class ListExtendedJobsResponse200JobsItemType0RawFlowFailureModuleSuspend:
    """
    Attributes:
        required_events (Union[Unset, int]):
        timeout (Union[Unset, int]):
        resume_form (Union[Unset, ListExtendedJobsResponse200JobsItemType0RawFlowFailureModuleSuspendResumeForm]):
        user_auth_required (Union[Unset, bool]):
        user_groups_required
            (Union['ListExtendedJobsResponse200JobsItemType0RawFlowFailureModuleSuspendUserGroupsRequiredType0',
            'ListExtendedJobsResponse200JobsItemType0RawFlowFailureModuleSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "ListExtendedJobsResponse200JobsItemType0RawFlowFailureModuleSuspendResumeForm"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = ListExtendedJobsResponse200JobsItemType0RawFlowFailureModuleSuspendResumeForm.from_dict(
                _resume_form
            )
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, ListExtendedJobsResponse200JobsItemType0RawFlowFailureModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = ListExtendedJobsResponse200JobsItemType0RawFlowFailureModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, ListExtendedJobsResponse200JobsItemType0RawFlowFailureModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = ListExtendedJobsResponse200JobsItemType0RawFlowFailureModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        list_extended_jobs_response_200_jobs_item_type_0_raw_flow_failure_module_suspend = cls(
        ...
        list_extended_jobs_response_200_jobs_item_type_0_raw_flow_failure_module_suspend.additional_properties = d
        return list_extended_jobs_response_200_jobs_item_type_0_raw_flow_failure_module_suspend
