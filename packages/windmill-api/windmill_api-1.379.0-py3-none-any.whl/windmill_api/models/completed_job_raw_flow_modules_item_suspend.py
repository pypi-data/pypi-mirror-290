...
if TYPE_CHECKING:
    from ..models.completed_job_raw_flow_modules_item_suspend_resume_form import (
        CompletedJobRawFlowModulesItemSuspendResumeForm,
    )
    from ..models.completed_job_raw_flow_modules_item_suspend_user_groups_required_type_0 import (
        CompletedJobRawFlowModulesItemSuspendUserGroupsRequiredType0,
    )
    from ..models.completed_job_raw_flow_modules_item_suspend_user_groups_required_type_1 import (
        CompletedJobRawFlowModulesItemSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="CompletedJobRawFlowModulesItemSuspend")


@_attrs_define
class CompletedJobRawFlowModulesItemSuspend:
    """
    Attributes:
        ...
        user_groups_required (Union['CompletedJobRawFlowModulesItemSuspendUserGroupsRequiredType0',
            'CompletedJobRawFlowModulesItemSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "CompletedJobRawFlowModulesItemSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.user_groups_required, CompletedJobRawFlowModulesItemSuspendUserGroupsRequiredType0):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = CompletedJobRawFlowModulesItemSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[Unset, CompletedJobRawFlowModulesItemSuspendUserGroupsRequiredType0]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        CompletedJobRawFlowModulesItemSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[Unset, CompletedJobRawFlowModulesItemSuspendUserGroupsRequiredType1]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = CompletedJobRawFlowModulesItemSuspendUserGroupsRequiredType1.from_dict(
        ...
        completed_job_raw_flow_modules_item_suspend = cls(
        ...
        completed_job_raw_flow_modules_item_suspend.additional_properties = d
