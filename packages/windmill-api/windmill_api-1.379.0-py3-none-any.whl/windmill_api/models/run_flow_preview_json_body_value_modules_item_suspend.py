...
if TYPE_CHECKING:
    from ..models.run_flow_preview_json_body_value_modules_item_suspend_resume_form import (
        RunFlowPreviewJsonBodyValueModulesItemSuspendResumeForm,
    )
    from ..models.run_flow_preview_json_body_value_modules_item_suspend_user_groups_required_type_0 import (
        RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType0,
    )
    from ..models.run_flow_preview_json_body_value_modules_item_suspend_user_groups_required_type_1 import (
        RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType1,
    )
...
class RunFlowPreviewJsonBodyValueModulesItemSuspend:
    ...
    Attributes:
        ...
        user_groups_required (Union['RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType0',
            'RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "RunFlowPreviewJsonBodyValueModulesItemSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.user_groups_required, Unset):
            ...
            self.user_groups_required, RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType0
        ):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = RunFlowPreviewJsonBodyValueModulesItemSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType1.from_dict(
