...
if TYPE_CHECKING:
    from ..models.flow_preview_value_modules_item_suspend_resume_form import (
        FlowPreviewValueModulesItemSuspendResumeForm,
    )
    from ..models.flow_preview_value_modules_item_suspend_user_groups_required_type_0 import (
        FlowPreviewValueModulesItemSuspendUserGroupsRequiredType0,
    )
    from ..models.flow_preview_value_modules_item_suspend_user_groups_required_type_1 import (
        FlowPreviewValueModulesItemSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="FlowPreviewValueModulesItemSuspend")


@_attrs_define
class FlowPreviewValueModulesItemSuspend:
    """
    Attributes:
        ...
        user_groups_required (Union['FlowPreviewValueModulesItemSuspendUserGroupsRequiredType0',
            'FlowPreviewValueModulesItemSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "FlowPreviewValueModulesItemSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.user_groups_required, FlowPreviewValueModulesItemSuspendUserGroupsRequiredType0):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = FlowPreviewValueModulesItemSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[Unset, FlowPreviewValueModulesItemSuspendUserGroupsRequiredType0]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = FlowPreviewValueModulesItemSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[Unset, FlowPreviewValueModulesItemSuspendUserGroupsRequiredType1]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = FlowPreviewValueModulesItemSuspendUserGroupsRequiredType1.from_dict(
        ...
        flow_preview_value_modules_item_suspend = cls(
        ...
        flow_preview_value_modules_item_suspend.additional_properties = d
        return flow_preview_value_modules_item_suspend
