...
if TYPE_CHECKING:
    ...
    from ..models.get_flow_by_path_with_draft_response_200_draft_value_failure_module_suspend_user_groups_required_type_0 import (
        GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.get_flow_by_path_with_draft_response_200_draft_value_failure_module_suspend_user_groups_required_type_1 import (
...
class GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspend:
    ...
    Attributes:
        ...
        user_groups_required
            (Union['GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendUserGroupsRequiredType0',
            'GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendUserGroupsRequiredType1', Unset]):
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendUserGroupsRequiredType1.from_dict(
