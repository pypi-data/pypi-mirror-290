...
if TYPE_CHECKING:
    from ..models.get_completed_job_response_200_raw_flow_failure_module_suspend_resume_form import (
        GetCompletedJobResponse200RawFlowFailureModuleSuspendResumeForm,
    )
    from ..models.get_completed_job_response_200_raw_flow_failure_module_suspend_user_groups_required_type_0 import (
        GetCompletedJobResponse200RawFlowFailureModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.get_completed_job_response_200_raw_flow_failure_module_suspend_user_groups_required_type_1 import (
        GetCompletedJobResponse200RawFlowFailureModuleSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="GetCompletedJobResponse200RawFlowFailureModuleSuspend")


@_attrs_define
class GetCompletedJobResponse200RawFlowFailureModuleSuspend:
    """
    Attributes:
        ...
        user_groups_required (Union['GetCompletedJobResponse200RawFlowFailureModuleSuspendUserGroupsRequiredType0',
            'GetCompletedJobResponse200RawFlowFailureModuleSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "GetCompletedJobResponse200RawFlowFailureModuleSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.user_groups_required, Unset):
            ...
            self.user_groups_required, GetCompletedJobResponse200RawFlowFailureModuleSuspendUserGroupsRequiredType0
        ):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = GetCompletedJobResponse200RawFlowFailureModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, GetCompletedJobResponse200RawFlowFailureModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        GetCompletedJobResponse200RawFlowFailureModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, GetCompletedJobResponse200RawFlowFailureModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    GetCompletedJobResponse200RawFlowFailureModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        get_completed_job_response_200_raw_flow_failure_module_suspend = cls(
        ...
        get_completed_job_response_200_raw_flow_failure_module_suspend.additional_properties = d
        return get_completed_job_response_200_raw_flow_failure_module_suspend
