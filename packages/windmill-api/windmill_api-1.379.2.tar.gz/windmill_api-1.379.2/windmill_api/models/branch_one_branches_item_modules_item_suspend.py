...
if TYPE_CHECKING:
    from ..models.branch_one_branches_item_modules_item_suspend_resume_form import (
        BranchOneBranchesItemModulesItemSuspendResumeForm,
    )
    from ..models.branch_one_branches_item_modules_item_suspend_user_groups_required_type_0 import (
        BranchOneBranchesItemModulesItemSuspendUserGroupsRequiredType0,
    )
    from ..models.branch_one_branches_item_modules_item_suspend_user_groups_required_type_1 import (
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, BranchOneBranchesItemModulesItemSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        BranchOneBranchesItemModulesItemSuspendUserGroupsRequiredType0.from_dict(
            ...
            if isinstance(_user_groups_required_type_1, Unset):
                ...
                user_groups_required_type_1 = BranchOneBranchesItemModulesItemSuspendUserGroupsRequiredType1.from_dict(
