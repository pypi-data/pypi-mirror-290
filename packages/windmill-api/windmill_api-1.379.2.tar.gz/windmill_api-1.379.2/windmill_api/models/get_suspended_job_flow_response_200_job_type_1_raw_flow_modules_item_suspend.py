...
if TYPE_CHECKING:
    from ..models.get_suspended_job_flow_response_200_job_type_1_raw_flow_modules_item_suspend_resume_form import (
        GetSuspendedJobFlowResponse200JobType1RawFlowModulesItemSuspendResumeForm,
    )
    from ..models.get_suspended_job_flow_response_200_job_type_1_raw_flow_modules_item_suspend_user_groups_required_type_0 import (
        GetSuspendedJobFlowResponse200JobType1RawFlowModulesItemSuspendUserGroupsRequiredType0,
    )
    from ..models.get_suspended_job_flow_response_200_job_type_1_raw_flow_modules_item_suspend_user_groups_required_type_1 import (
        GetSuspendedJobFlowResponse200JobType1RawFlowModulesItemSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="GetSuspendedJobFlowResponse200JobType1RawFlowModulesItemSuspend")


@_attrs_define
class GetSuspendedJobFlowResponse200JobType1RawFlowModulesItemSuspend:
    """
    Attributes:
        required_events (Union[Unset, int]):
        timeout (Union[Unset, int]):
        resume_form (Union[Unset, GetSuspendedJobFlowResponse200JobType1RawFlowModulesItemSuspendResumeForm]):
        user_auth_required (Union[Unset, bool]):
        user_groups_required
            (Union['GetSuspendedJobFlowResponse200JobType1RawFlowModulesItemSuspendUserGroupsRequiredType0',
            'GetSuspendedJobFlowResponse200JobType1RawFlowModulesItemSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "GetSuspendedJobFlowResponse200JobType1RawFlowModulesItemSuspendResumeForm"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = GetSuspendedJobFlowResponse200JobType1RawFlowModulesItemSuspendResumeForm.from_dict(
                _resume_form
            )
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, GetSuspendedJobFlowResponse200JobType1RawFlowModulesItemSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = GetSuspendedJobFlowResponse200JobType1RawFlowModulesItemSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, GetSuspendedJobFlowResponse200JobType1RawFlowModulesItemSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    GetSuspendedJobFlowResponse200JobType1RawFlowModulesItemSuspendUserGroupsRequiredType1.from_dict(
        ...
        get_suspended_job_flow_response_200_job_type_1_raw_flow_modules_item_suspend = cls(
        ...
        get_suspended_job_flow_response_200_job_type_1_raw_flow_modules_item_suspend.additional_properties = d
        return get_suspended_job_flow_response_200_job_type_1_raw_flow_modules_item_suspend
