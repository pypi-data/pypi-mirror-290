...
if TYPE_CHECKING:
    from ..models.flow_preview_value_failure_module_suspend_resume_form import (
        FlowPreviewValueFailureModuleSuspendResumeForm,
    )
    from ..models.flow_preview_value_failure_module_suspend_user_groups_required_type_0 import (
        FlowPreviewValueFailureModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.flow_preview_value_failure_module_suspend_user_groups_required_type_1 import (
        FlowPreviewValueFailureModuleSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="FlowPreviewValueFailureModuleSuspend")


@_attrs_define
class FlowPreviewValueFailureModuleSuspend:
    """
    Attributes:
        ...
        user_groups_required (Union['FlowPreviewValueFailureModuleSuspendUserGroupsRequiredType0',
            'FlowPreviewValueFailureModuleSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "FlowPreviewValueFailureModuleSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.user_groups_required, FlowPreviewValueFailureModuleSuspendUserGroupsRequiredType0):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = FlowPreviewValueFailureModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[Unset, FlowPreviewValueFailureModuleSuspendUserGroupsRequiredType0]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = FlowPreviewValueFailureModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[Unset, FlowPreviewValueFailureModuleSuspendUserGroupsRequiredType1]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = FlowPreviewValueFailureModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        flow_preview_value_failure_module_suspend = cls(
        ...
        flow_preview_value_failure_module_suspend.additional_properties = d
        return flow_preview_value_failure_module_suspend
