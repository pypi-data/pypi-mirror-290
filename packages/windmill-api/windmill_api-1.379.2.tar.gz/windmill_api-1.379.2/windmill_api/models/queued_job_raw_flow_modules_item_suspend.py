...
if TYPE_CHECKING:
    from ..models.queued_job_raw_flow_modules_item_suspend_resume_form import (
        QueuedJobRawFlowModulesItemSuspendResumeForm,
    )
    from ..models.queued_job_raw_flow_modules_item_suspend_user_groups_required_type_0 import (
        QueuedJobRawFlowModulesItemSuspendUserGroupsRequiredType0,
    )
    from ..models.queued_job_raw_flow_modules_item_suspend_user_groups_required_type_1 import (
        QueuedJobRawFlowModulesItemSuspendUserGroupsRequiredType1,
    )
...
class QueuedJobRawFlowModulesItemSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, QueuedJobRawFlowModulesItemSuspendResumeForm]):
        user_auth_required (Union[Unset, bool]):
        user_groups_required (Union['QueuedJobRawFlowModulesItemSuspendUserGroupsRequiredType0',
            'QueuedJobRawFlowModulesItemSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "QueuedJobRawFlowModulesItemSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.user_groups_required, QueuedJobRawFlowModulesItemSuspendUserGroupsRequiredType0):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = QueuedJobRawFlowModulesItemSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[Unset, QueuedJobRawFlowModulesItemSuspendUserGroupsRequiredType0]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = QueuedJobRawFlowModulesItemSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[Unset, QueuedJobRawFlowModulesItemSuspendUserGroupsRequiredType1]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = QueuedJobRawFlowModulesItemSuspendUserGroupsRequiredType1.from_dict(
