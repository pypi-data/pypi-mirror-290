...
if TYPE_CHECKING:
    from ..models.get_hub_flow_by_id_response_200_flow_value_modules_item_suspend_resume_form import (
        GetHubFlowByIdResponse200FlowValueModulesItemSuspendResumeForm,
    )
...
@_attrs_define
class GetHubFlowByIdResponse200FlowValueModulesItemSuspend:
    """
    Attributes:
        ...
        user_groups_required (Union['GetHubFlowByIdResponse200FlowValueModulesItemSuspendUserGroupsRequiredType0',
            'GetHubFlowByIdResponse200FlowValueModulesItemSuspendUserGroupsRequiredType1', Unset]):
    ...
    resume_form: Union[Unset, "GetHubFlowByIdResponse200FlowValueModulesItemSuspendResumeForm"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = GetHubFlowByIdResponse200FlowValueModulesItemSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, GetHubFlowByIdResponse200FlowValueModulesItemSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        GetHubFlowByIdResponse200FlowValueModulesItemSuspendUserGroupsRequiredType0.from_dict(
        ...
        get_hub_flow_by_id_response_200_flow_value_modules_item_suspend = cls(
        ...
        get_hub_flow_by_id_response_200_flow_value_modules_item_suspend.additional_properties = d
