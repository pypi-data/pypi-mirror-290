...
# -*- coding: utf-8 -*-
#
# ipyfilite documentation build configuration file
#
...
from os.path import join as pjoin  # noqa: E402
...
_version_py = os.path.join(repo, "ipyfilite", "_version.py")
version_ns = {}
...
htmlhelp_basename = "ipyfilitedoc"
...
man_pages = [(master_doc, "ipyfilite", "ipyfilite Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        "ipyfilite",
        (
            "File upload widget specifically for Pyodide kernels running in"
            " JupyterLite. Uploaded files are not loaded into memory but"
            " mounted as read-only files in a new WORKERFS."
        ),
        "Miscellaneous",
    ),
]
