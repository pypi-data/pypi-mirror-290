...
[Open documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_connectcampaigns/literals/)
...
ConnectCampaignServiceServiceName = Literal["connectcampaigns"]
ServiceName = Literal[
    "accessanalyzer",
    "account",
    "acm",
...
RegionName = Literal[
    "ap-southeast-2", "ca-central-1", "eu-central-1", "eu-west-2", "us-east-1", "us-west-2"
]
