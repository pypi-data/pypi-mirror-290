...
[boto3.MigrationHubConfig 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/migrationhub-config.html#MigrationHubConfig)
...
- Install `boto3-stubs[migrationhub-config]` in your environment:
...
Install `boto3-stubs-lite[migrationhub-config]` in your environment:
...
- Install `boto3-stubs[migrationhub-config]` with services you use in your
  environment:
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_migrationhub_config/literals/).
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_migrationhub_config/type_defs/).
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_migrationhub_config/)
