...
[boto3.ResilienceHub 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/resiliencehub.html#ResilienceHub)
...
list_resource_grouping_recommendations_paginator: ListResourceGroupingRecommendationsPaginator = (
    client.get_paginator("list_resource_grouping_recommendations")
)
```
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_resiliencehub/literals/).
...
Full list of `ResilienceHub` TypeDefs can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_resiliencehub/type_defs/).
