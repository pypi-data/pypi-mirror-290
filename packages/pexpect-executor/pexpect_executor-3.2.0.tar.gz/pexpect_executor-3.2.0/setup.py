...
PROJECT_DESCRIPTION = 'Automate interactive CLI tools actions'
PROJECT_EMAIL = 'radian.dc@gmail.com'
PROJECT_KEYWORDS = 'pexpect pexpect-executor'
PROJECT_LICENSE = 'Apache License 2.0'
PROJECT_MODULE = 'pexpect_executor'
PROJECT_NAME = 'pexpect-executor'
PROJECT_NAMESPACE = 'RadianDevCore/tools'
PROJECT_PACKAGE = 'pexpect-executor'
PROJECT_SCRIPTS = [
    'pexpect-executor = pexpect_executor.cli.main:main',
]
