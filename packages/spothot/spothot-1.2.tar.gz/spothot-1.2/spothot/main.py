...
# Wi-Fi settings
ssid={ssid}
hw_mode=g               # 2.4 GHz mode (b/g/n)
channel=10              # Common channel with minimal interference
...
ignore_broadcast_ssid=0 # Broadcast the SSID (make the network visible)
wmm_enabled=1           # Enable Wi-Fi Multimedia (WMM) for better performance
