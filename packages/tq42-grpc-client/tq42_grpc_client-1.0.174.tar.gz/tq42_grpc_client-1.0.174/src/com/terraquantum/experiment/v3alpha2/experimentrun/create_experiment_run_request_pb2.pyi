...
class CreateExperimentRunRequest(_message.Message):
    ...
    def __init__(self, experiment_id: _Optional[str] = ..., hardware: _Optional[_Union[_experiment_run_pb2.HardwareProto, str]] = ..., parent_id: _Optional[str] = ..., algorithm: _Optional[str] = ..., version: _Optional[str] = ..., metadata: _Optional[_Union[_any_pb2.Any, _Mapping]] = ...) -> None: ...
