...
class ExperimentRunResultProto(_message.Message):
    ...
    result_json: str
    outcome: _any_pb2.Any
    def __init__(self, result_json: _Optional[str] = ..., outcome: _Optional[_Union[_any_pb2.Any, _Mapping]] = ...) -> None: ...
