...
class ExperimentRunResultProto(_message.Message):
    __slots__ = ("result_json", "circuit_run_outcome", "cva_opt_outcome", "tetra_opt_outcome", "tetra_qu_enc_outcome", "toy_outcome", "ts_hqlstm_eval_outcome", "ts_hqlstm_train_outcome", "ts_hqmlp_eval_outcome", "ts_hqmlp_train_outcome", "ts_lstm_eval_outcome", "ts_lstm_train_outcome", "ts_mlp_eval_outcome", "ts_mlp_train_outcome", "generic_ml_train_outcome", "generic_ml_infer_outcome")
