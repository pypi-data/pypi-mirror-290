...
__all__ = (
    ...
    "S3LocationExtraExtraOutputTypeDef",
...
S3LocationExtraExtraOutputTypeDef = TypedDict(
    "S3LocationExtraExtraOutputTypeDef",
    {
...
OutputLocationExtraExtraOutputTypeDef = TypedDict(
    "OutputLocationExtraExtraOutputTypeDef",
    {
        "S3": NotRequired[S3LocationExtraExtraOutputTypeDef],
    },
)
