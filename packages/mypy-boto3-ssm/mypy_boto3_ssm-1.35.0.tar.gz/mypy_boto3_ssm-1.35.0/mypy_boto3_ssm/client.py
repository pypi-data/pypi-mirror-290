...
[Open documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_ssm/client/)
...
class SSMClient(BaseClient):
    ...
    def close(self) -> None:
        ...
        [Show boto3-stubs documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_ssm/client/#close)
        """
    ...
    def delete_ops_item(self, *, OpsItemId: str) -> Dict[str, Any]:
        """
        Delete an OpsItem.
    ...
    def get_ops_item(self, *, OpsItemId: str, OpsItemArn: str = ...) -> GetOpsItemResponseTypeDef:
        """
