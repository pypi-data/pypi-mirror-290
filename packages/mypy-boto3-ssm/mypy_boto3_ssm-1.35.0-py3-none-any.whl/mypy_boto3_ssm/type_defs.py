...
ComplianceExecutionSummaryExtraOutputTypeDef = TypedDict(
    "ComplianceExecutionSummaryExtraOutputTypeDef",
    {
...
MaintenanceWindowTaskParameterValueExpressionExtraOutputTypeDef = TypedDict(
    "MaintenanceWindowTaskParameterValueExpressionExtraOutputTypeDef",
    {
        "Values": NotRequired[List[str]],
    },
...
NotificationConfigExtraOutputTypeDef = TypedDict(
    "NotificationConfigExtraOutputTypeDef",
    {
        "NotificationArn": NotRequired[str],
        "NotificationEvents": NotRequired[List[NotificationEventType]],
...
AlarmConfigurationExtraOutputTypeDef = TypedDict(
    "AlarmConfigurationExtraOutputTypeDef",
    {
...
NotificationConfigUnionTypeDef = Union[
    NotificationConfigTypeDef, NotificationConfigExtraOutputTypeDef
]
...
TargetLocationExtraOutputTypeDef = TypedDict(
    "TargetLocationExtraOutputTypeDef",
    {
        ...
        "TargetLocationAlarmConfiguration": NotRequired[AlarmConfigurationExtraOutputTypeDef],
    },
)
...
AlarmConfigurationUnionTypeDef = Union[
    AlarmConfigurationTypeDef, AlarmConfigurationExtraOutputTypeDef
]
TargetLocationTypeDef = TypedDict(
    "TargetLocationTypeDef",
    {
        ...
        "TargetLocationMaxErrors": NotRequired[str],
        "ExecutionRoleName": NotRequired[str],
        "TargetLocationAlarmConfiguration": NotRequired[AlarmConfigurationTypeDef],
    },
)
...
ComplianceExecutionSummaryUnionTypeDef = Union[
    ComplianceExecutionSummaryTypeDef, ComplianceExecutionSummaryExtraOutputTypeDef
]
...
RunbookExtraOutputTypeDef = TypedDict(
    "RunbookExtraOutputTypeDef",
    {
        "DocumentName": str,
        "DocumentVersion": NotRequired[str],
        ...
        "Targets": NotRequired[List[TargetExtraOutputTypeDef]],
        "TargetMaps": NotRequired[List[Dict[str, List[str]]]],
        "MaxConcurrency": NotRequired[str],
        "MaxErrors": NotRequired[str],
        "TargetLocations": NotRequired[List[TargetLocationExtraOutputTypeDef]],
    },
)
