...
"""
    ...
    pip3 cache purge
    pip3 install -i https://pypi.tuna.tsinghua.edu.cn/simple Fr1997v011==1.9.6
"""
...
class SpiderJike:
    ...
    # 抖音笔记
    def douyin_note_resp(self, response):
        base_ret_data = {'aweme_type': 1, 'is_alive': 1}
        ...
        """
            'create_time': data_json['create_date'],
            'update_time_info': int(time.time()),
            'is_open': 1,
            'd_id': id_id,
        """

        # 遍历 <script> 标签，查找包含数据的标签
        for script in scripts:
            script_content = script.text
            if 'nickname' in str(script_content):
                import js2py  # pip install js2py
                script_content = str(script_content)
                index = script_content.find('{')
                script_content = script_content[index:]
                index = script_content.rfind('}')
                script_content = script_content[:index + 1]
                js_code = f'JSON.parse(\'{script_content}\')'
                data_data_each = js2py.eval_js(js_code)

                detail = data_data_each['aweme']['detail']

                base_ret_data['desc'] = detail["desc"]
                base_ret_data['aweme_type'] = detail['awemeType']
                ...
                base_ret_data['forward_num'] = detail["stats"]["forwardCount"]
...
class DouyinJike:
    ...
    # 【api】 视频详情 2024-05-28
    def api_douyin_video(self, video_id, use_proxies=1, res_tp='video_info', proxies_dcc=0):
        headers = {
            "user-agent": config_dict['base_ua'],
        }
...
class XhsJike:
    ...
    def xhs_web_note_into(self, text, note_id):
        ...
        if aweme_type is None:
            return ret_json(500, 'aweme_type 错误')
    ...
    def xhs_video_main(self, req_url, proxies=None, user_cookie=0):
        pattern = r'xsec_token=([^&]+)'
        matches = re.findall(pattern, req_url)
        if matches:
            xsec_token = matches[0]
        else:
            xsec_token = random.choice(self.get_xsec_tokens())
        print(xsec_token)
        ...
        if user_cookie == 1:
            ...
            # headers['cookie'] = "abRequestId=1ab11e10399096997b4625560b217201; customerClientId=975404585159340; x-user-id-creator.xiaohongshu.com=5f5095750000000001000e62; access-token-creator.xiaohongshu.com=customer.ares.AT-f2f9c6dbf3824c8191599a19ceb73870-dc3ee23df5b94bd7b8c8d2bbb421e273; x-user-id-pgy.xiaohongshu.com=65b9dad3c700000000000001; a1=18f9f543208njxr0g3jixejgwmrzo13z4p0t4s7fi50000383112; webId=3436e9c56411e6bb78a3e2dfd41b5f31; gid=yYiji24qJ848yYiji24qJUMW8YIVCF8kqV3C8i3dVkE6F928ulyqu4888qYqyyJ88dy4ySi4; x-user-id-ad.xiaohongshu.com=65b9dad3c700000000000001; customer-sso-sid=68c517386611676314366429ac1a6ec039d4d12c; web_session=040069b49ada826407478f7086344bf30027b4; webBuild=4.28.5; xsecappid=xhs-pc-web; websectiga=f3d8eaee8a8c63016320d94a1bd00562d516a5417bc43a032a80cbf70f07d5c0; sec_poison_id=48c6a422-4674-45dd-8c1e-f5f7de727d2c; acw_tc=09e22abb5904cc5c2450ebed792e55c068dbb801563a341d44eb177751926721; unread={%22ub%22:%2266b6d5f2000000001e01c4d0%22%2C%22ue%22:%2266924bd5000000000a0277a5%22%2C%22uc%22:29}"
            # headers['cookie'] = 'a1=18e2c078173wq6eepo1e9eop5its3pfas3ccmvp3j50000126018; webId=b32d483d04ce0fcd7a4af8597ef09e47; gid=yYdJS8W20DMjyYdJS8WYyqhUWqEAKddUlydjSqVdlU239S28MqUi06888yJK8yY88jW8d442; customerClientId=007317342161288; x-user-id-creator.xiaohongshu.com=5f5095750000000001000e62; access-token-creator.xiaohongshu.com=customer.ares.AT-ae50c9e0cd574a22b3ca0f0f02b88f6b-f0dad970d34443948302ed5e611178ed; customer-sso-sid=6641c5df4800000000000009c69ae31ba132aae4; x-user-id-ad.xiaohongshu.com=65b39c94c600000000000001; abRequestId=b32d483d04ce0fcd7a4af8597ef09e47; web_session=040069b51379d66e08dfdffa85344b42f73fb9; xsecappid=xhs-pc-web; webBuild=4.28.5; websectiga=f3d8eaee8a8c63016320d94a1bd00562d516a5417bc43a032a80cbf70f07d5c0; sec_poison_id=c4bb500a-78ef-4b00-aa63-711c17410d5c; acw_tc=6d8d920f5c8f2f1f0da7dcf91f9c08f6d78f3a0287be3cb2748540c0630fdec2'
        else:
            # xhs_url = f'https://www.xiaohongshu.com/explore/{note_id}?xsec_token={xsec_token}&xsec_source=pc_feed'
            xhs_url = f'https://www.xiaohongshu.com/explore/{note_id}?xsec_token={xsec_token}&note_flow_source=baidu&note_flow_source=baidu'
            # xhs_url = f'https://www.xiaohongshu.com/explore/{note_id}?xsec_token={xsec_token}&xsec_source=pc_feed'
            # xhs_url = f'https://www.xiaohongshu.com/explore/{note_id}?xsec_token={xsec_token}&xsec_source=pc_search'
...
class ModeFunc:
    ...
    def ttwid_cookie_tt(self, num=200, get_cache=0):
        ...
        if get_cache == 1:
            ...
            sql = f'SELECT douyin_cookie_ttwid FROM `cd_cookie_douyin` where douyin_cookie_ttwid is not null order by rand() limit {num}'
            all_cookie = mode_pro.mysql_db(method='s', table='cd_cookie_douyin', sql=sql)
            for i in all_cookie:
            ...
            if code == 0 and msg == '':
                ...
                if data_main:
                    ...
                    if search_type == 'hot_search_words':
                        for r in rows:
                            ret_data.append({
                                JFD.__keyword__: r['dimensions']['query'],
