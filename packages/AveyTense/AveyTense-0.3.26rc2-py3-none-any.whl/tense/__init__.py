...
import tense.tcs as tcs, tense.primary as t, time, warnings, uuid, typing as tp
...
_T1 = _var("_T1")
_T2 = _var("_T2")
_T_ls = _var("_T_ls", bound = tcs.Union[
    str,
    tcs.MutableSequence[tcs.Any]
])
"""Note: alias `ls` - list/string"""
_T_richComparable = _var("_T_richComparable", bound = tcs.RichComparable)

_Color = _uni[int, str, None]
_Bits = _lit[3, 4, 8, 24]
...
_TicTacToeBoard = tcs.TicTacToeBoard
...
class _ProbabilityLength(tcs.IntegerFlag):
    "\\@since 0.3.26c2. Internal class for class `tense.Tense`"
    PROBABILITY_COMPUTE = -1
    PROBABILITY_DEFAULT = 10000
    if _local_architecture() == "64bit":
        PROBABILITY_MAX = 9223372036854775807
    else:
        PROBABILITY_MAX = 2147483647
    PROBABILITY_MIN = 1

class _BisectMode(tcs.IntegerFlag):
    "\\@since 0.3.26c2. Internal class for method `Tense.bisect()`"
    BISECT_LEFT = 0
    BISECT_RIGHT = 1

class _InsortMode(tcs.IntegerFlag):
    "\\@since 0.3.26c2. Internal class for method `Tense.insort()`"
    INSORT_LEFT = 0
    INSORT_RIGHT = 1

_ProbabilityLengthType = _uni[int, IntVar, _lit[_ProbabilityLength.PROBABILITY_COMPUTE]]
_BisectModeType = _lit[_BisectMode.BISECT_LEFT, _BisectMode.BISECT_RIGHT]
_InsortModeType = _lit[_InsortMode.INSORT_LEFT, _InsortMode.INSORT_RIGHT]

class Tense(NennɅIAbroads, NennɅIStringz, NennɅIRandomize, Time, Math, tcs.Positive[str], tcs.Negative[str], tcs.Invertible[str]):
    """
    ...
    """
    import uuid as __uu, warnings as __wa, re as __re, tense.tcs as __tcs, time as __ti, tkinter as __tk, inspect as __ins, bisect as __bi, ast as __ast # math as __ma
    ...
    @_cm
    def __isConditionCallback(self, v: object) -> __tcs.TypeIs[_cal[[__tcs.Any], bool]]:
        "\\@since 0.3.26c2"
    ...
    def __invert__(self):
        ...
        return self.__str__()
    @_cm
    def isNone(self, value, /) -> __tcs.TypeIs[None]:
        """
        \\@since 0.3.26b3 \\
        \\@author Aveyzan
        ```ts \\
    ...
    @_cm
    def isBool(self, v: object, /) -> __tcs.TypeIs[bool]:
        """
        \\@since 0.3.26b3 \\
        \\@author Aveyzan
        ```ts \\
    ...
    @_cm
    def isBoolean(self, v: object, /) -> __tcs.TypeIs[bool]:
        """
        \\@since 0.3.26c1 \\
        \\@author Aveyzan
        ```ts \\
        ...
        return v is True or v is False
    @_cm
    def isInt(self, v: object, /) -> __tcs.TypeIs[int]:
        """
        \\@since 0.3.26b3 \\
        \\@author Aveyzan
        ```ts \\
    ...
    @_cm
    def isInteger(self, v: object, /) -> __tcs.TypeIs[int]:
        """
        \\@since 0.3.26c1 \\
        \\@author Aveyzan
        ```ts \\
        ...
        return isinstance(v, int)
    @_cm
    def isFloat(self, v: object, /) -> __tcs.TypeIs[float]:
        """
        \\@since 0.3.26b3 \\
        \\@author Aveyzan
        ```ts \\
    ...
    @_cm
    def isComplex(self, v: object, /) -> __tcs.TypeIs[complex]:
        """
        \\@since 0.3.26b3 \\
        \\@author Aveyzan
        ```ts \\
    ...
    @_cm
    def isStr(self, v: object, /) -> __tcs.TypeIs[str]:
        """
        \\@since 0.3.26b3 \\
        \\@author Aveyzan
        ```ts \\
    ...
    @_cm
    def isString(self, v: object, /) -> __tcs.TypeIs[str]:
        """
        \\@since 0.3.26c1 \\
        \\@author Aveyzan
        ```ts \\
        ...
        return isinstance(v, str)
    @_cm
    def isTuple(self, v: object, /) -> __tcs.TypeIs[tuple[__tcs.Any, ...]]:
        """
        \\@since 0.3.26c1 \\
        \\@author Aveyzan
        ```ts \\
    ...
    @_cm
    def isList(self, v: object, /) -> __tcs.TypeIs[list[__tcs.Any]]:
        """
        \\@since 0.3.26c1 \\
        \\@author Aveyzan
        ```ts \\
    ...
    def shuffle(self, v: _T_ls) -> _T_ls:
        ...
        """
        from collections.abc import MutableSequence #, Sequence, MutableSet, Set, MutableMapping, Mapping
    ...
    def reverse(self, v: _T_ls) -> _T_ls:
        ...
        return _v
    @_cm
    def eval(self, source: __tcs.Union[str, __tcs.Buffer, __ast.Module, __ast.Expression, __ast.Interactive], ast = False):
        "\\@since 0.3.26c2."
        from ast import literal_eval
        if not ast:
            return eval(compile(source))
        else:
            if not self.isString(source) and not isinstance(source, self.__tcs.Buffer):
    ...
    @_cm
    def bisect(self, seq: __tcs.LenGetItemOperable[_T], item: _T_richComparable, low: int = 0, high: _opt[int] = None, key: _opt[_cal[[_T], _T_richComparable]] = None, mode: _BisectModeType = BISECT_RIGHT):
        "\\@since 0.3.26c2. A blend of functions inside `bisect` module: `bisect_left()` and `bisect_right()`."
        if mode == self.BISECT_LEFT:
            return self.__bi.bisect_left(seq, item, low, high, key = key)
        elif mode == self.BISECT_RIGHT:
            return self.__bi.bisect_right(seq, item, low, high, key = key)
        else:
            err, s = (TypeError, "Incompatible value for 'mode' parameter. Expected one of constants: 'BISECT_LEFT' or 'BISECT_RIGHT'")
            raise err(s)
    @_cm
    def insort(self, seq: __tcs.LenGetItemOperable[_T], item: _T_richComparable, low: int = 0, high: _opt[int] = None, key: _opt[_cal[[_T], _T_richComparable]] = None, mode: _InsortModeType = INSORT_RIGHT):
        "\\@since 0.3.26c2. A blend of functions inside `bisect` module: `insort_left()` and `insort_right()`."
        _seq = seq
    ...
    def random(self, x: _uni[int, __tk.IntVar], y: _uni[int, __tk.IntVar], /):
        ...
        \\@lifetime ≥ 0.3.24 \\
        \\@modified 0.3.25, 0.3.26c2 (support for `tkinter.IntVar`) \\
        \\@author Aveyzan
        ```ts \\
        "class method" in class Tense
        ```
    ...
    @_cm
    def uuidPrimary(self, node: _opt[__tcs.TypeOrFinalVarType[int]] = None, clockSeq: _opt[__tcs.TypeOrFinalVarType[int]] = None):
        """
        \\@since 0.3.26a1 \\
        \\@author Aveyzan
        ```ts \\
    ...
    @_cm
    def uuidMd5(self, namespace: __tcs.TypeOrFinalVarType[uuid.UUID], name: __tcs.TypeOrFinalVarType[_uni[str, StringVar]]):
        """
        \\@since 0.3.26a1 \\
        \\@author Aveyzan
        ```ts \\
    ...
    @_cm
    def uuidSha1(self, namespace: __tcs.TypeOrFinalVarType[__uu.UUID], name: __tcs.TypeOrFinalVarType[_uni[str, StringVar]]):
        """
        \\@since 0.3.26a1 \\
        \\@author Aveyzan
        ```ts \\
    ...
    @_cm
    def pick(self, seq: _SequenceLike[_T], /):
        """
        \\@since 0.3.8 (standard since 0.3.24) \\
        \\@lifetime ≥ 0.3.8 \\
        \\@modified 0.3.25, 0.3.26c2 \\
        \\@author Aveyzan
        ```ts \\
        "class method" in class Tense
        ```
        ...
        """
        _seq = +seq if isinstance(seq, self.__tcs.FinalVar) else seq
        _seq = list(_seq) if isinstance(_seq, (set, frozenset)) else _seq
        return _seq[self.random(0, reckon(_seq) - 1)]
    def error(self, handler: type[_ErrorType], message: _uni[str, None] = None):
        ...
        if s is None:
            ...
            raise err(s)
    @_cm
    def first(self, seq: _SequenceLike[_T1], condition: _opt[_cal[[_T1], bool]] = None, /, default: _T2 = None):
        """
        \\@since 0.3.26c2
        ```ts \\
        "class method" in class Tense
        ...
        return default
    @_cm
    def last(self, seq: _SequenceLike[_T1], condition: _opt[_cal[[_T1], bool]] = None, /, default: _T2 = None):
        """
        \\@since 0.3.26c2
        ```ts \\
        "class method" in class Tense
        ...
        return default
    @_cm
    def any(self, seq: _SequenceLike[_T], condition: _opt[_cal[[_T], bool]] = None, /):
        """
        \\@since 0.3.26c2
        ```ts \\
        "class method" in class Tense
        ...
        return a
    @_cm
    def all(self, seq: _SequenceLike[_T1], condition: _opt[_cal[[_T1], bool]] = None, /, default: _T2 = None):
        """
        \\@since 0.3.26c2
        ```ts \\
        "class method" in class Tense
        ...
        a: list[_T1] = []
        for e in _seq:
            if self.__isConditionCallback(condition) and not condition(e): return default
            else:
    ...
    def probability2(self, x: _T = 1, y: _T = 0, frequency: _uni[int, __tk.IntVar] = 1, length: _ProbabilityLengthType = int(1e+4)):
        ...
        return self.pick(a)
    @_cm
    def probability(self, *vf: _ProbabilityType[int], length: _ProbabilityLengthType = PROBABILITY_COMPUTE) -> int:
        """
        \\@since 0.3.8 (standard since 0.3.9) \\
        \\@lifetime ≥ 0.3.8 \\
        \\@modified 0.3.19, 0.3.24, 0.3.25, 0.3.26a3, 0.3.26b3, 0.3.26c1, 0.3.26c2 \\
        \\@author Aveyzan
        ...
        # END 0.3.26a3
            ...
            # lack of integers
            err, s = (self.__tcs.MissingValueError, f"Expected at least 2 items in 'vf' parameter, received {reckon(vf)}")
            raise err(s)
        ...
        return self.pick(a1)
    @_cm
    def until(self, desiredString: _SequenceLike[str], /, message: _opt[str] = None, caseInsensitive: bool = True):
        """
        \\@since 0.3.25 \\
        \\@author Aveyzan
        ```ts \\
        ...
        s = ""
        c = False
        _d = +desiredString if isinstance(desiredString, self.__tcs.FinalVar) else desiredString
    ...
    def owoify(self, string: str, /):
        ...
        aren't included normally (0.3.26a3, 0.3.26b1, 0.3.26c2), still, \\
        most are, several have different translations
        """
...
class _FileRead(tcs.IntegerFlag):
    "\\@since 0.3.26c2"
    CHARS = 0
    LINES = tcs.Auto()

_FileReadType = _lit[_FileRead.CHARS, _FileRead.LINES]
_T_stringOrIterable = _var("_T_stringOrIterable", bound = _uni[str, tp.Iterable[str]])
...
class File:
    ...
    """
    import pickle as __pi, tense.tcs as __tcs, io as __io, typing as __tp
    ...
    def read(self, size = -1, mode: _FileReadType = CHARS):
        "\\@since 0.3.26c2"
        ...
        if self.__fileinstance is not None:
            ...
            err, s = (self.__tcs.NotInitializedError, "Class was not initialized")
            raise err(s)
...
class FinalVar:
    ...
    in module tense
    ```
    A class-like function (since 0.3.26c2 a class) referring \\
    to class `tense.tcs.FinalVar`. This creates a final variable
...
class _ChangeVarState(tcs.IntegerFlag):
    "\\@since 0.3.26c1. Internal class for `ChangeVar.setState()` method"
    I = 1
    D = 2

_ChangeVarStateSelection = _lit[_ChangeVarState.D, _ChangeVarState.I]
...
class _ColorStyling(tcs.IntegerFlag):
    "\\@since 0.3.26c1. Internal class for `%` operator in class `tense.Color`."
    NORMAL = 0
    BOLD = 1
    FAINT = 2
    ITALIC = 3
    ...
    NO_UNDERLINE = 24
    NO_BLINK = 25
    PROPORTIONAL = 26 # corrected mistake! 0.3.26c2
    NO_REVERSE = 27
    UNHIDE = 28
    NO_STRIKE = 29
...
class _ColorAdvancedStyling(tcs.IntegerFlag):
    "\\@since 0.3.26c2. Internal class for `%` operator in class `tense.Color`."
    # 2x
    BOLD_ITALIC = 1000
    BOLD_UNDERLINE = 1001
    BOLD_STRIKE = 1002
...
_ColorStylingType = _lit[
    ...
    # _ColorStyling.PROPORTIONAL, cancelled 0.3.26c2
    _ColorStyling.FRAME,
    _ColorStyling.ENCIRCLE,
    _ColorStyling.OVERLINE,
    # below: since 0.3.26c2
...
class Color(tcs.ModuloOperable, tcs.UnaryOperable):
    ...
    in module tense
    ```
    Deputy of experimental class `tense.extensions.ANSIColor` (≥ 0.3.24; < 0.3.26c1).
    ...
    You are discouraged to do operations on these constants; also, since 0.3.26c2 \\
    ...
    **Warning**: 24-bit colors remains an experimental thing. Rather use 8-bit \\
    ...
    "\\@since 0.3.26c1. Mere text"
    BOLD = _ColorStyling.BOLD
    "\\@since 0.3.26c1. Text becomes bold"
    FAINT = _ColorStyling.FAINT
    "\\@since 0.3.26c1. Also works as 'decreased intensity' or 'dim'"
    ITALIC = _ColorStyling.ITALIC
    "\\@since 0.3.26c1. Text becomes oblique. Not widely supported"
    UNDERLINE = _ColorStyling.UNDERLINE
    "\\@since 0.3.26c1. Text becomes underlined. Marked *experimental* as experimenting with underline colors, but normally it is OK to use"
    SLOW_BLINK = _ColorStyling.SLOW_BLINK
    "\\@since 0.3.26c1. Text will blink for less than 150 times per minute"
    RAPID_BLINK = _ColorStyling.RAPID_BLINK
    "\\@since 0.3.26c1. Text will blink for more than 150 times per minute. Not widely supported"
    REVERSE = _ColorStyling.REVERSE
    "\\@since 0.3.26c2. Swap text and background colors"
    HIDE = _ColorStyling.HIDE
    "\\@since 0.3.26c1. Text becomes transparent"
    STRIKE = _ColorStyling.STRIKE
    "\\@since 0.3.26c1. Text becomes crossed out"
    DOUBLE_UNDERLINE = _ColorStyling.DOUBLE_UNDERLINE
    "\\@since 0.3.26c2. Text becomes doubly underlined"
    # PROPORTIONAL = _ColorStyling.PROPORTIONAL
    "\\@lifetime >= 0.3.26c1; < 0.3.26c2. Proportional spacing. *Experimental*"
    FRAME = _ColorStyling.FRAME
    "\\@since 0.3.26c1. Implemented in mintty as 'emoji variation selector'"
    ENCIRCLE = _ColorStyling.ENCIRCLE
    "\\@since 0.3.26c1. Implemented in mintty as 'emoji variation selector'"
    OVERLINE = _ColorStyling.OVERLINE
    "\\@since 0.3.26c1. Text becomes overlined"
    SUPERSCRIPT = _ColorStyling.SUPERSCRIPT
    "\\@since 0.3.26c2. Text becomes superscripted (implemented in mintty only)"
    SUBSCRIPT = _ColorStyling.SUBSCRIPT
    "\\@since 0.3.26c2. Text becomes subscripted (implemented in mintty only)"
    # 2x
    BOLD_ITALIC = _ColorAdvancedStyling.BOLD_ITALIC
    "\\@since 0.3.26c2. Text becomes bold and oblique"
    BOLD_UNDERLINE = _ColorAdvancedStyling.BOLD_UNDERLINE
    "\\@since 0.3.26c2. Text becomes bold and underlined"
    BOLD_STRIKE = _ColorAdvancedStyling.BOLD_STRIKE
    "\\@since 0.3.26c2. Text becomes bold and crossed out"
    BOLD_OVERLINE = _ColorAdvancedStyling.BOLD_OVERLINE
    "\\@since 0.3.26c2. Text becomes bold and overlined"
    ITALIC_UNDERLINE = _ColorAdvancedStyling.ITALIC_UNDERLINE
    "\\@since 0.3.26c2. Text becomes oblique and underlined"
    ITALIC_STRIKE = _ColorAdvancedStyling.ITALIC_STRIKE
    "\\@since 0.3.26c2. Text becomes oblique and crossed out"
    ITALIC_OVERLINE = _ColorAdvancedStyling.ITALIC_OVERLINE
    "\\@since 0.3.26c2. Text becomes oblique and overlined"
    UNDERLINE_STRIKE = _ColorAdvancedStyling.UNDERLINE_STRIKE
    "\\@since 0.3.26c2. Text becomes underlined and crossed out"
    UOLINE = _ColorAdvancedStyling.UOLINE
    "\\@since 0.3.26c2. Alias to underline-overline. Text gets lines above and below"
    STRIKE_OVERLINE = _ColorAdvancedStyling.STRIKE_OVERLINE
    "\\@since 0.3.26c2. Text becomes crossed out and overlined"
    # 3x
    BOLD_ITALIC_UNDERLINE = _ColorAdvancedStyling.BOLD_ITALIC_UNDERLINE
    "\\@since 0.3.26c2. Text becomes bold, oblique and underlined"
    ...
    def __prepare_return(self):
        ...
        for e in (self.__fg, self.__bg, self.__un):
            if e is not None:
                if self.__bits == 3 and e not in abroad(0x8):
                    err, s = (ValueError, "Interal error. For 3-bit colors, expected integer or string value in range 0-7. One of foreground, background or underline values doesn't match this requirement")
                    raise err(s)
                elif self.__bits == 4 and e not in abroad(0x10):
                    err, s = (ValueError, "Interal error. For 4-bit colors, expected integer or string value in range 0-15. One of foreground, background or underline values doesn't match this requirement")
                    raise err(s)
                elif self.__bits == 8 and e not in abroad(0x100):
                    err, s = (ValueError, "Interal error. For 8-bit colors, expected integer or string value in range 0-255. One of foreground, background or underline values doesn't match this requirement")
                    raise err(s)
                elif self.__bits == 24 and e not in abroad(0x1000000):
                    err, s = (ValueError, "Interal error. For 24-bit colors, expected integer or string value in range 0-16777215. One of foreground, background or underline values doesn't match this requirement")
                    raise err(s)
        if self.__bits == 3:
            # 2 ** 3 = 8 (0x8 in hex)
            ...
            # code reconstructed on 0.3.26c2
            ...
            _hf, _hb, _hu = [None for _ in abroad(3)]
            for s in (_f, _b, _u):
                if reckon(s) == 6:
                    if s == _f:
        ...
        if _s != "\033[":
            ...
            _s = self.__text
        return _s
    def __init__(self, text: str, /, bits: _Bits = 8, foregroundColor: _Color = None, backgroundColor: _Color = None, underlineColor: None = None) -> None: # slash since 0.3.26c2
        """
        \\@since 0.3.26c1. Parameters:
        - `text` - string to be colored. Required parameter
        - `bits` - number of bits, possible values: 3, 4, 8, 24. Defaults to 24 (since 0.3.26c2 - 8)
        ...
        At all it shouldn't be used, as 'underline color' isn't in standard. Due to that since 0.3.26c2 any other \\
        type than `None` throws an error.
        """
        ...
        if not Tense.isInteger(bits) or (Tense.isInteger(bits) and bits not in (3, 4, 8, 24)):
            ...
            raise err(s)
        if underlineColor is not None:
            err, s = (TypeError, "Expected 'None' for 'underlineColor' parameter")
            raise err(s)
    ...
    def setBits(self, bits: _Bits = 8, /):
        ...
        Since 0.3.26c2 default value is 8.
        """
        if not Tense.isInteger(bits) or (Tense.isInteger(bits) and bits not in (3, 4, 8, 24)):
            err, s = (TypeError, "Expected integer value: 3, 4, 8 or 24, for 'bits' parameter")
            raise err(s)
    ...
    def setBackgroundColor(self, color: _Color = None, /):
        ...
        self.__bg = _c
        return self
    def setUnderlineColor(self, color: None = None, /):
        """
        \\@since 0.3.26c1
        
        Set underline color manually. *Experimental* \\
        Since 0.3.26c2 only accepted value is `None`.
        """
        # _c = color if Tense.isInteger(color) or color is None else self.__pre_convert(color)
        _c = None
        if _c is not None:
    ...
    "\\@since 0.3.26c2"
    __all__ = __dir__
    "\\@since 0.3.26c2. Returns list of all non-underscore-preceded members of class `tense.Color`"
    __constants__ = [n for n in locals() if n[:1] != "_" and n.isupper()]
    
    """
    \\@since 0.3.26c2

    Returns list of constants. These can \\
    be used as right operand for `%` operator. \\
    They are sorted as in ANSI escape code table, \\
    in ascending order
    """
...
del deque, t, tcs, time, warnings, uuid, BooleanVar, StringVar, tp, IntVar # Not for export
