...
*griffe-runtime-objects* follows the **sponsorware** release strategy, which means
...
*griffe-runtime-objects Insiders* is a private fork of *griffe-runtime-objects*, hosted as
...
repository.
  ...
  [^1]:
    ...
    existing features that must be supported by *griffe-runtime-objects*.
...
*griffe-runtime-objects* and released for general availability, making them available
...
The biggest bottleneck in Open Source is time.[^3]
  ...
  [^3]:
    ...
    The sponsorware model ensures that if you decide to use *griffe-runtime-objects*,
...
<small>
  ...
  your profile and avatar to show your support for *griffe-runtime-objects*.
...
to use *griffe-runtime-objects* locally without having access to Insiders.
Is this still possible?

Yes. Insiders is compatible with *griffe-runtime-objects*. Almost all new features
...
Yes. Whether you're an individual or a company, you may use *griffe-runtime-objects
Insiders* precisely under the same terms as *griffe-runtime-objects*, which are given
