...
def _get_variables():
    ...
    default_email_subject = 'JJSYSTEM - CONFIRMAR email e CRIAR senha'

    app_name = os.environ.get(
        'JJSYSTEM_APP_NAME', default_app_name)
    noreply_email = os.environ.get(
        'JJSYSTEM_NOREPLY_EMAIL', default_noreply_email)
    base_url = os.environ.get('JJSYSTEM_BASE_URL', default_base_url)
    email_subject = os.environ.get(
        'JJSYSTEM_EMAIL_SUBJECT', default_email_subject)
    email_use_sandbox = os.environ.get(
        'JJSYSTEM_EMAIL_USE_SANDBOX',
