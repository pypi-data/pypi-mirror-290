...
__all__ = (
    ...
    "SamplingRuleExtraOutputTypeDef",
...
SamplingRuleExtraOutputTypeDef = TypedDict(
    "SamplingRuleExtraOutputTypeDef",
    {
        "ResourceARN": str,
        "Priority": int,
...
SamplingRuleUnionTypeDef = Union[SamplingRuleTypeDef, SamplingRuleExtraOutputTypeDef]
