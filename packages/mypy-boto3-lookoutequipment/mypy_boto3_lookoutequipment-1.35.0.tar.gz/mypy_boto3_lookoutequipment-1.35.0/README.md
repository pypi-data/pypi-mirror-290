...
[boto3.LookoutEquipment 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/lookoutequipment.html#LookoutEquipment)
...
Full list of `LookoutEquipment` Literals can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_lookoutequipment/literals/).

```python
from mypy_boto3_lookoutequipment.literals import AutoPromotionResultType


def check_value(value: AutoPromotionResultType) -> bool: ...
```
...
Full list of `LookoutEquipment` TypeDefs can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_lookoutequipment/type_defs/).
