...
class Job(
    ...
    def __init__(
        ...
        *,
        ...
        hcl1: typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]] = None,
        ...
        :param jobspec: Job specification. If you want to point to a file use the file() function. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#jobspec Job#jobspec}
        :param consul_token: The Consul token used to submit this job. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#consul_token Job#consul_token}
        :param deregister_on_destroy: If true, the job will be deregistered on destroy. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#deregister_on_destroy Job#deregister_on_destroy}
        :param deregister_on_id_change: If true, the job will be deregistered when the job ID changes. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#deregister_on_id_change Job#deregister_on_id_change}
        :param detach: If true, the provider will return immediately after creating or updating, instead of monitoring. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#detach Job#detach}
        :param hcl1: If true, the ``jobspec`` will be parsed using the HCL1 format. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#hcl1 Job#hcl1}
        :param hcl2: hcl2 block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#hcl2 Job#hcl2}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#id Job#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param json: If true, the ``jobspec`` will be parsed as json instead of HCL. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#json Job#json}
        :param policy_override: Override any soft-mandatory Sentinel policies that fail. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#policy_override Job#policy_override}
        :param purge_on_destroy: Whether to purge the job when the resource is destroyed. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#purge_on_destroy Job#purge_on_destroy}
        :param read_allocation_ids: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#read_allocation_ids Job#read_allocation_ids}.
        :param rerun_if_dead: If true, forces the job to run again on apply if it is currently dead. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#rerun_if_dead Job#rerun_if_dead}
        :param timeouts: timeouts block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#timeouts Job#timeouts}
        :param vault_token: The Vault token used to submit this job. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#vault_token Job#vault_token}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Job that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#import import section} in the documentation of this resource for the id to use
    ...
    def put_hcl2(
        ...
        *,
        ...
        '''
        :param allow_fs: If true, HCL2 file system functions will be enabled when parsing the ``jobspec``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#allow_fs Job#allow_fs}
        :param enabled: If true, the ``jobspec`` will be parsed as HCL2 instead of HCL. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#enabled Job#enabled}
        :param vars: Additional variables to use when templating the job with HCL2. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#vars Job#vars}
        '''
    ...
    def put_timeouts(
        ...
        *,
        ...
        '''
        :param create: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#create Job#create}.
        :param update: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/job#update Job#update}.
        '''
    ...
    @jsii.member(jsii_name="resetHcl1")
    def reset_hcl1(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetHcl1", []))
    ...
    @builtins.property
    @jsii.member(jsii_name="hcl1Input")
    def hcl1_input(
        self,
    ) -> typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]], jsii.get(self, "hcl1Input"))
    ...
    def consul_token(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8fb8ec063891f66a3277e2ad6b43cc0e717387a90bb815bd7ddc07631a2dac22)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "consulToken", value) # pyright: ignore[reportArgumentType]
    ...
    @builtins.property
    @jsii.member(jsii_name="hcl1")
    def hcl1(self) -> typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable]:
        return typing.cast(typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable], jsii.get(self, "hcl1"))
    ...
    def hcl1(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5eb3ca8faf700937d8d82120cc0889310fdd479c2b9624336fe39d8fea6805f0)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "hcl1", value) # pyright: ignore[reportArgumentType]
    ...
    def vault_token(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3b746a5a0c0e4fb728ade7483a54a2654d6d6058f91cd1254a5aaf73135ee485)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "vaultToken", value) # pyright: ignore[reportArgumentType]
    ...
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument hcl1", value=hcl1, expected_type=type_hints["hcl1"])
...
class JobHcl2OutputReference(
    ...
    def enabled(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__8a8d7796aef5a81e4a73976993a96831fe4cbe2ff7cbed0fdb5b3aa42a49e9e3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
def _typecheckingstub__8fb8ec063891f66a3277e2ad6b43cc0e717387a90bb815bd7ddc07631a2dac22(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__5eb3ca8faf700937d8d82120cc0889310fdd479c2b9624336fe39d8fea6805f0(
    value: typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__3b746a5a0c0e4fb728ade7483a54a2654d6d6058f91cd1254a5aaf73135ee485(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__8a8d7796aef5a81e4a73976993a96831fe4cbe2ff7cbed0fdb5b3aa42a49e9e3(
    value: typing.Union[builtins.bool, _cdktf_9a9027ec.IResolvable],
) -> None:
    """Type checking stubs"""
    pass
