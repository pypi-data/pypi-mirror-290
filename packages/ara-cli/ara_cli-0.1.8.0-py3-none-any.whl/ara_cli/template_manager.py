...
class TemplatePathManager:
    @staticmethod
    def get_template_base_path_prompt_creation():
        """Returns the absolute path to the prompt creation templates directory."""
        current_file_path = Path(__file__).absolute()
        base_dir = current_file_path.parent
        return base_dir / "templates" / "global-prompt-creation"

    @staticmethod
    def get_template_base_path_prompt_modules():
        """Returns the absolute path to the prompt creation templates directory."""
        current_file_path = Path(__file__).absolute()
    ...
    def get_template_content(self, classifier):
        base_path = self.get_template_base_path_artefacts()
