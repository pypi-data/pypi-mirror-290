...
class PersonalizeEventsClient(BaseClient):
    ...
    def close(self) -> None:
        ...
        [Show boto3-stubs documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_personalize_events/client/#close)
        """
    ...
    def put_action_interactions(
        self, *, trackingId: str, actionInteractions: Sequence[ActionInteractionTypeDef]
    ) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def put_actions(
        self, *, datasetArn: str, actions: Sequence[ActionTypeDef]
    ) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def put_items(
        self, *, datasetArn: str, items: Sequence[ItemTypeDef]
    ) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def put_users(
        self, *, datasetArn: str, users: Sequence[UserTypeDef]
    ) -> EmptyResponseMetadataTypeDef:
        """
