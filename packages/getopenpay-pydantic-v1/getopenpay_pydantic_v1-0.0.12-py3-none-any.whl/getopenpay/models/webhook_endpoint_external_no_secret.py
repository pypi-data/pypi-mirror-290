...
class WebhookEndpointExternalNoSecret(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> WebhookEndpointExternalNoSecret:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> WebhookEndpointExternalNoSecret:
    """Create an instance of WebhookEndpointExternalNoSecret from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return WebhookEndpointExternalNoSecret.parse_obj(obj)

    _obj = WebhookEndpointExternalNoSecret.parse_obj(
      {
        'id': obj.get('id'),
