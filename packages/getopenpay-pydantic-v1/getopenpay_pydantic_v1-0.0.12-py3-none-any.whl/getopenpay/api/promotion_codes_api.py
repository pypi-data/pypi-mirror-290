...
class PromotionCodesApi:
  ...
  def create_promo_code(
    self, create_promo_code_request: CreatePromoCodeRequest, **kwargs
  ) -> PromotionCodeExternal:  # noqa: E501
  ...
  def create_promo_code_with_http_info(
    ...
    _all_params = ['create_promo_code_request']
    _all_params.extend(
      [
  ...
  def list_promo_codes(
    self, promo_code_query_params: PromoCodeQueryParams, **kwargs
  ) -> ListResponsePromotionCodeExternal:  # noqa: E501
  ...
  def list_promo_codes_with_http_info(
    ...
    _all_params = ['promo_code_query_params']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
  ...
  def update_promo_code(
    ...
    promo_code_id: Annotated[StrictStr,
                             Field(..., description='Unique identifier of the PromotionCode.')],
    update_promo_code_request: UpdatePromoCodeRequest, **kwargs
  ) -> PromotionCodeExternal:  # noqa: E501
    ...
    if '_preload_content' in kwargs:
      ...
      raise ValueError(message)
    return self.update_promo_code_with_http_info(
      promo_code_id, update_promo_code_request, **kwargs
    )  # noqa: E501
  ...
  def update_promo_code_with_http_info(
    ...
    _all_params = ['promo_code_id', 'update_promo_code_request']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
