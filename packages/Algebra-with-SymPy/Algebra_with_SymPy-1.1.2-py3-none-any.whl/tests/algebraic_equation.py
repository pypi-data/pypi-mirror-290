...
from algebra_with_sympy.sympy.sympy.core.expr import Expr
from algebra_with_sympy.sympy.sympy.core.basic import Basic
from algebra_with_sympy.sympy.sympy.core.evalf import EvalfMixin
from algebra_with_sympy.sympy.sympy.core.sympify import _sympify
from algebra_with_sympy.sympy.sympy import functions
import functools
from algebra_with_sympy.sympy.sympy import *
...
class Equation(Basic, EvalfMixin):
    ...
    >>> from algebra_with_sympy.sympy.sympy import I, pi
    ...
    def as_Boolean(self):
        ...
        """
        from algebra_with_sympy.sympy.sympy.core.relational import Equality
    ...
    def _eval_collect(self, *args, **kwargs):
        from algebra_with_sympy.sympy.sympy.simplify.radsimp import collect
    ...
    def _eval_derivative(self, *args, **kwargs):
        ...
        from algebra_with_sympy.sympy.sympy.core.function import Derivative
        eval_lhs = False
...
def solve(f, *symbols, **flags):
    ...
    manipulations.
    """
    from algebra_with_sympy.sympy.sympy.solvers.solvers import solve
...
def sqrt(arg, evaluate = None):
    ...
    """
    from algebra_with_sympy.sympy.sympy.functions.elementary.miscellaneous import sqrt as symsqrt
    if isinstance(arg, Equation):
        return Equation(symsqrt(arg.lhs, evaluate), symsqrt(arg.rhs, evaluate))
    else:
        return symsqrt(arg,evaluate)

# Pick up the docstring for sqrt from algebra_with_sympy.sympy.sympy
from algebra_with_sympy.sympy.sympy.functions.elementary.miscellaneous import sqrt as symsqrt
...
def root(arg, n, k = 0, evaluate = None):
    ...
    objects that are not basic sympy expressions.
    """
    from algebra_with_sympy.sympy.sympy.functions.elementary.miscellaneous import root as symroot
    if isinstance(arg, Equation):
...
# pick up the docstring for root from algebra_with_sympy.sympy.sympy
from algebra_with_sympy.sympy.sympy.functions.elementary.miscellaneous import root as symroot
