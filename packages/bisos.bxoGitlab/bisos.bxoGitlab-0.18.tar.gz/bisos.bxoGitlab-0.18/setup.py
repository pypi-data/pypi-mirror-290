...
# ./pypiUploadVer exists -- pypiNextVer=0.18 -- installedVersion=0.16
def pkgVersion():
        return '0.18'   # Version Nu To Be Uploaded

####+END:

####+BEGINNOT: b:py3:pypi/requires :extras () :requirements "./requirements.txt"
