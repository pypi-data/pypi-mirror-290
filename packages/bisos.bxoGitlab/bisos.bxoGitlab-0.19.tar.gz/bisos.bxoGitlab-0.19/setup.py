...
# ./pypiUploadVer exists -- pypiNextVer=0.19 -- installedVersion=0.16
def pkgVersion():
        return '0.19'   # Version Nu To Be Uploaded

####+END:

####+BEGIN: b:py3:pypi/requires :extras () :requirements "./requirements.txt"
