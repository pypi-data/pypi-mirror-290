...
def pixelate_video_file(video_input: Union[VideoFileClip, str], output_filename: str):
    """
    ...
    ImageSequenceClip(processed_frames_array, fps = video_input.fps).set_audio(video_input.audio).write_videofile(output_filename)
