...
class ImageGreenscreen:
    ...
    def from_image_to_image(self, image_filename, output_filename):
        self.cgsi.from_image_to_image(image_filename, output_filename)

    def from_image_to_video(self, image_filename, duration, output_filename):
        self.cgsi.from_image_to_video(image_filename, duration, output_filename)

    def from_video_to_image(self, video, output_filename):
        self.cgsi.from_video_to_image()

    def from_video_to_video(self, video, output_filename):
        self.cgsi.from_video_to_video(video, output_filename)