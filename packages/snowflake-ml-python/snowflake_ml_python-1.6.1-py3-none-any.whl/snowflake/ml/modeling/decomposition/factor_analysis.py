...
class FactorAnalysis(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'n_components':(n_components, None, False),
            ...
            'noise_variance_init':(noise_variance_init, None, False),
            'svd_method':(svd_method, "randomized", False),
            'iterated_power':(iterated_power, 3, False),
            'rotation':(rotation, None, False),
            'random_state':(random_state, 0, False),}
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.decomposition.FactorAnalysis
        )
        self._sklearn_object: Any = sklearn.decomposition.FactorAnalysis(
        ...
        self._class_name=FactorAnalysis.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "FactorAnalysis":
        """
    ...
    def transform(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.decomposition.FactorAnalysis.transform]
    ...
    def score_samples(
        ...
        For more details on this function, see [sklearn.decomposition.FactorAnalysis.score_samples]
        (https://scikit-learn.org/stable/modules/generated/sklearn.decomposition.FactorAnalysis.html#sklearn.decomposition.FactorAnalysis.score_samples)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.decomposition.FactorAnalysis.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.decomposition.FactorAnalysis.html#sklearn.decomposition.FactorAnalysis.score)
