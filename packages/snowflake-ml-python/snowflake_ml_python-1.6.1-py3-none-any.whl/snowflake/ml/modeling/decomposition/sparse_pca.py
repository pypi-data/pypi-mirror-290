...
class SparsePCA(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'n_components':(n_components, None, False),
            ...
            'U_init':(U_init, None, False),
            'V_init':(V_init, None, False),
        ...
        self._sklearn_object: Any = sklearn.decomposition.SparsePCA(
        ...
        self._class_name=SparsePCA.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "SparsePCA":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "SparsePCA":
        """Fit the model from data in X
        For more details on this function, see [sklearn.decomposition.SparsePCA.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.decomposition.SparsePCA.html#sklearn.decomposition.SparsePCA.fit)
    ...
    def transform(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.decomposition.SparsePCA.transform]
        (https://scikit-learn.org/stable/modules/generated/sklearn.decomposition.SparsePCA.html#sklearn.decomposition.SparsePCA.transform)
    ...
    def to_sklearn(self) -> Any:
        """Get sklearn.decomposition.SparsePCA object.
        """
