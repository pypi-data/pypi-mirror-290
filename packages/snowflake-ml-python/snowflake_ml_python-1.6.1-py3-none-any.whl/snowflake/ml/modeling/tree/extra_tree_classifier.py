...
class ExtraTreeClassifier(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'criterion':(criterion, "gini", False),
            ...
            'max_features':(max_features, "sqrt", False),
        ...
        self._sklearn_object: Any = sklearn.tree.ExtraTreeClassifier(
        ...
        self._class_name=ExtraTreeClassifier.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "ExtraTreeClassifier":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.tree.ExtraTreeClassifier.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.tree.ExtraTreeClassifier.html#sklearn.tree.ExtraTreeClassifier.predict)
    ...
    def predict_proba(
        ...
        For more details on this function, see [sklearn.tree.ExtraTreeClassifier.predict_proba]
        (https://scikit-learn.org/stable/modules/generated/sklearn.tree.ExtraTreeClassifier.html#sklearn.tree.ExtraTreeClassifier.predict_proba)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.tree.ExtraTreeClassifier.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.tree.ExtraTreeClassifier.html#sklearn.tree.ExtraTreeClassifier.score)
