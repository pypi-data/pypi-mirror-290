...
class PassiveAggressiveClassifier(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'C':(C, 1.0, False),
            ...
            'n_iter_no_change':(n_iter_no_change, 5, False),
            'shuffle':(shuffle, True, False),
            'verbose':(verbose, 0, False),
            'loss':(loss, "hinge", False),
            ...
            'average':(average, False, False),}
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.linear_model.PassiveAggressiveClassifier
        )
        self._sklearn_object: Any = sklearn.linear_model.PassiveAggressiveClassifier(
        ...
        self._class_name=PassiveAggressiveClassifier.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "PassiveAggressiveClassifier":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.linear_model.PassiveAggressiveClassifier.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.PassiveAggressiveClassifier.html#sklearn.linear_model.PassiveAggressiveClassifier.predict)
    ...
    def decision_function(
        ...
        For more details on this function, see [sklearn.linear_model.PassiveAggressiveClassifier.decision_function]
        (https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.PassiveAggressiveClassifier.html#sklearn.linear_model.PassiveAggressiveClassifier.decision_function)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.linear_model.PassiveAggressiveClassifier.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.PassiveAggressiveClassifier.html#sklearn.linear_model.PassiveAggressiveClassifier.score)
