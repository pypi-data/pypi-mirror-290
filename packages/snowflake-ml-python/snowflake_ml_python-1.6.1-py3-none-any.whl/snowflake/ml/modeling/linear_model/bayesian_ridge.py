...
class BayesianRidge(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'max_iter':(max_iter, None, False),
            ...
            'lambda_1':(lambda_1, 1e-06, False),
            'lambda_2':(lambda_2, 1e-06, False),
            'alpha_init':(alpha_init, None, False),
            'lambda_init':(lambda_init, None, False),
        ...
        self._class_name=BayesianRidge.__class__.__name__
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        (https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.BayesianRidge.html#sklearn.linear_model.BayesianRidge.predict)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.linear_model.BayesianRidge.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.BayesianRidge.html#sklearn.linear_model.BayesianRidge.score)
