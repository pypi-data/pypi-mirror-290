...
class LogisticRegression(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'penalty':(penalty, "l2", False),
            ...
            'l1_ratio':(l1_ratio, None, False),}
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.linear_model.LogisticRegression
        )
        self._sklearn_object: Any = sklearn.linear_model.LogisticRegression(
        ...
        self._class_name=LogisticRegression.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "LogisticRegression":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.linear_model.LogisticRegression.predict]
    ...
    def predict_proba(
        ...
        For more details on this function, see [sklearn.linear_model.LogisticRegression.predict_proba]
    ...
    def decision_function(
        ...
        For more details on this function, see [sklearn.linear_model.LogisticRegression.decision_function]
