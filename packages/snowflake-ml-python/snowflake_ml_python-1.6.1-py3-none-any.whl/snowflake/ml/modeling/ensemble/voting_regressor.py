...
class VotingRegressor(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        estimators = transform_snowml_obj_to_sklearn_obj(estimators)
        ...
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.ensemble.VotingRegressor
        )
        self._sklearn_object: Any = sklearn.ensemble.VotingRegressor(
        ...
        self._class_name=VotingRegressor.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "VotingRegressor":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "VotingRegressor":
        """Fit the estimators
        For more details on this function, see [sklearn.ensemble.VotingRegressor.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.VotingRegressor.html#sklearn.ensemble.VotingRegressor.fit)
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.ensemble.VotingRegressor.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.VotingRegressor.html#sklearn.ensemble.VotingRegressor.predict)
    ...
    def transform(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.ensemble.VotingRegressor.transform]
        (https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.VotingRegressor.html#sklearn.ensemble.VotingRegressor.transform)
        ...
        if isinstance(dataset, DataFrame):
            ...
            if True:  # is child of _BaseHeterogeneousEnsemble
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.ensemble.VotingRegressor.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.VotingRegressor.html#sklearn.ensemble.VotingRegressor.score)
    ...
    def to_sklearn(self) -> Any:
        """Get sklearn.ensemble.VotingRegressor object.
        """
