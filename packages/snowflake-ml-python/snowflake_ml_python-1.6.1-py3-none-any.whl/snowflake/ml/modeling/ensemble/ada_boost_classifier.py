...
class AdaBoostClassifier(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.ensemble.AdaBoostClassifier(
        ...
        self._class_name=AdaBoostClassifier.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "AdaBoostClassifier":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "AdaBoostClassifier":
        """Build a boosted classifier/regressor from the training set (X, y)
        For more details on this function, see [sklearn.ensemble.AdaBoostClassifier.fit]
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.ensemble.AdaBoostClassifier.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.AdaBoostClassifier.html#sklearn.ensemble.AdaBoostClassifier.predict)
    ...
    def predict_proba(
        ...
        For more details on this function, see [sklearn.ensemble.AdaBoostClassifier.predict_proba]
        (https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.AdaBoostClassifier.html#sklearn.ensemble.AdaBoostClassifier.predict_proba)
    ...
    def decision_function(
        ...
        For more details on this function, see [sklearn.ensemble.AdaBoostClassifier.decision_function]
        (https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.AdaBoostClassifier.html#sklearn.ensemble.AdaBoostClassifier.decision_function)
