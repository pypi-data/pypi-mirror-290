...
class IsolationForest(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.ensemble.IsolationForest(
        ...
        self._class_name=IsolationForest.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "IsolationForest":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "IsolationForest":
        """Fit estimator
        For more details on this function, see [sklearn.ensemble.IsolationForest.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.IsolationForest.html#sklearn.ensemble.IsolationForest.fit)
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.ensemble.IsolationForest.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.IsolationForest.html#sklearn.ensemble.IsolationForest.predict)
    ...
    def decision_function(
        ...
        For more details on this function, see [sklearn.ensemble.IsolationForest.decision_function]
    ...
    def score_samples(
        ...
        For more details on this function, see [sklearn.ensemble.IsolationForest.score_samples]
