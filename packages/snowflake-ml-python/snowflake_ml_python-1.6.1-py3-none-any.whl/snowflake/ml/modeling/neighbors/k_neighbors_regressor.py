...
class KNeighborsRegressor(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.neighbors.KNeighborsRegressor(
        ...
        self._class_name=KNeighborsRegressor.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "KNeighborsRegressor":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.neighbors.KNeighborsRegressor.predict]
    ...
    def kneighbors(
        ...
        For more details on this function, see [sklearn.neighbors.KNeighborsRegressor.kneighbors]
