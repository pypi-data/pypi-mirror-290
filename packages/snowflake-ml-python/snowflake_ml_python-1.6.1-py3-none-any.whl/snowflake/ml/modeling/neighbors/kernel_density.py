...
class KernelDensity(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'bandwidth':(bandwidth, 1.0, False),
            ...
            'atol':(atol, 0, False),
            'rtol':(rtol, 0, False),
            'breadth_first':(breadth_first, True, False),
            'leaf_size':(leaf_size, 40, False),
            'metric_params':(metric_params, None, False),}
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.neighbors.KernelDensity
        )
        self._sklearn_object: Any = sklearn.neighbors.KernelDensity(
        ...
        self._class_name=KernelDensity.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "KernelDensity":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "KernelDensity":
        """Fit the Kernel Density model on the data
        For more details on this function, see [sklearn.neighbors.KernelDensity.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.neighbors.KernelDensity.html#sklearn.neighbors.KernelDensity.fit)
    ...
    def score_samples(
        ...
        For more details on this function, see [sklearn.neighbors.KernelDensity.score_samples]
        (https://scikit-learn.org/stable/modules/generated/sklearn.neighbors.KernelDensity.html#sklearn.neighbors.KernelDensity.score_samples)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.neighbors.KernelDensity.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.neighbors.KernelDensity.html#sklearn.neighbors.KernelDensity.score)
