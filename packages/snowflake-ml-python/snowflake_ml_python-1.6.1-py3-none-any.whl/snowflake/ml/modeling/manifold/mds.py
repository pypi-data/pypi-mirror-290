...
class MDS(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.manifold.MDS(
        ...
        self._class_name=MDS.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "MDS":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "MDS":
        """Compute the position of the points in the embedding space
        For more details on this function, see [sklearn.manifold.MDS.fit]
