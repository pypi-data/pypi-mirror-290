...
class Isomap(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'n_neighbors':(n_neighbors, 5, False),
            ...
            'path_method':(path_method, "auto", False),
            'neighbors_algorithm':(neighbors_algorithm, "auto", False),
        ...
        self._sklearn_object: Any = sklearn.manifold.Isomap(
        ...
        self._class_name=Isomap.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "Isomap":
        """
    ...
    def transform(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        """Transform X
        For more details on this function, see [sklearn.manifold.Isomap.transform]
        (https://scikit-learn.org/stable/modules/generated/sklearn.manifold.Isomap.html#sklearn.manifold.Isomap.transform)
