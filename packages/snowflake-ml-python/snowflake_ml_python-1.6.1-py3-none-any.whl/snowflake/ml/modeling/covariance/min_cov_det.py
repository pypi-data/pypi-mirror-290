...
class MinCovDet(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._class_name=MinCovDet.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "MinCovDet":
        """
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.covariance.MinCovDet.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.covariance.MinCovDet.html#sklearn.covariance.MinCovDet.score)
