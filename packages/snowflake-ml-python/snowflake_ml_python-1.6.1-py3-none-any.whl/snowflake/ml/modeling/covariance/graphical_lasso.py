...
class GraphicalLasso(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'alpha':(alpha, 0.01, False),
            'mode':(mode, "cd", False),
            'covariance':(covariance, None, False),
            'tol':(tol, 0.0001, False),
            'enet_tol':(enet_tol, 0.0001, False),
        ...
        self._class_name=GraphicalLasso.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "GraphicalLasso":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "GraphicalLasso":
        """Fit the GraphicalLasso model to X
        For more details on this function, see [sklearn.covariance.GraphicalLasso.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.covariance.GraphicalLasso.html#sklearn.covariance.GraphicalLasso.fit)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.covariance.GraphicalLasso.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.covariance.GraphicalLasso.html#sklearn.covariance.GraphicalLasso.score)
