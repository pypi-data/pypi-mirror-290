...
class LGBMRegressor(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        **kwargs,
        ...
        self._sklearn_object: Any = lightgbm.LGBMRegressor(
        ...
        self._class_name=LGBMRegressor.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "LGBMRegressor":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [lightgbm.LGBMRegressor.predict]
        (https://lightgbm.readthedocs.io/en/v3.3.2/pythonapi/lightgbm.LGBMRegressor.html#lightgbm.LGBMRegressor.predict)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [lightgbm.LGBMRegressor.score]
        (https://lightgbm.readthedocs.io/en/v3.3.2/pythonapi/lightgbm.LGBMRegressor.html#lightgbm.LGBMRegressor.score)
