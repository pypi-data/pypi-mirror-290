...
class LGBMClassifier(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        **kwargs,
        ...
        init_args = {'boosting_type':(boosting_type, "gbdt", False),
            ...
            'subsample_for_bin':(subsample_for_bin, 200000, False),
            'objective':(objective, None, False),
            'class_weight':(class_weight, None, False),
            'min_split_gain':(min_split_gain, 0.0, False),
            'min_child_weight':(min_child_weight, 0.001, False),
            'min_child_samples':(min_child_samples, 20, False),
            'subsample':(subsample, 1.0, False),
            'subsample_freq':(subsample_freq, 0, False),
            'colsample_bytree':(colsample_bytree, 1.0, False),
        ...
        self._sklearn_object: Any = lightgbm.LGBMClassifier(
        ...
        self._class_name=LGBMClassifier.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "LGBMClassifier":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [lightgbm.LGBMClassifier.predict]
        (https://lightgbm.readthedocs.io/en/v3.3.2/pythonapi/lightgbm.LGBMClassifier.html#lightgbm.LGBMClassifier.predict)
    ...
    def predict_proba(
        ...
        For more details on this function, see [lightgbm.LGBMClassifier.predict_proba]
        (https://lightgbm.readthedocs.io/en/v3.3.2/pythonapi/lightgbm.LGBMClassifier.html#lightgbm.LGBMClassifier.predict_proba)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [lightgbm.LGBMClassifier.score]
        (https://lightgbm.readthedocs.io/en/v3.3.2/pythonapi/lightgbm.LGBMClassifier.html#lightgbm.LGBMClassifier.score)
