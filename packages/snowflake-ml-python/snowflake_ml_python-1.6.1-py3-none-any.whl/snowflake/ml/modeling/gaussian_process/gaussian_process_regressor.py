...
class GaussianProcessRegressor(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'kernel':(kernel, None, False),
            ...
            'normalize_y':(normalize_y, False, False),
            'copy_X_train':(copy_X_train, True, False),
            'n_targets':(n_targets, None, False),
        ...
        self._sklearn_object: Any = sklearn.gaussian_process.GaussianProcessRegressor(
        ...
        self._class_name=GaussianProcessRegressor.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "GaussianProcessRegressor":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "GaussianProcessRegressor":
        """Fit Gaussian process regression model
        For more details on this function, see [sklearn.gaussian_process.GaussianProcessRegressor.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.gaussian_process.GaussianProcessRegressor.html#sklearn.gaussian_process.GaussianProcessRegressor.fit)
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.gaussian_process.GaussianProcessRegressor.predict]
