...
class FeatureAgglomeration(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'n_clusters':(n_clusters, 2, False),
            ...
            'linkage':(linkage, "ward", False),
            'pooling_func':(pooling_func, numpy.mean, False),
            'distance_threshold':(distance_threshold, None, False),
            'compute_distances':(compute_distances, False, False),}
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.cluster.FeatureAgglomeration
        )
        self._sklearn_object: Any = sklearn.cluster.FeatureAgglomeration(
        ...
        self._class_name=FeatureAgglomeration.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "FeatureAgglomeration":
        """
    ...
    def transform(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.cluster.FeatureAgglomeration.transform]
        (https://scikit-learn.org/stable/modules/generated/sklearn.cluster.FeatureAgglomeration.html#sklearn.cluster.FeatureAgglomeration.transform)
