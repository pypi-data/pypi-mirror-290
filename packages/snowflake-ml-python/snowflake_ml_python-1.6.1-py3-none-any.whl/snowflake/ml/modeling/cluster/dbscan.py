...
class DBSCAN(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.cluster.DBSCAN(
        ...
        self._class_name=DBSCAN.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "DBSCAN":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "DBSCAN":
        """Perform DBSCAN clustering from features, or distance matrix
        For more details on this function, see [sklearn.cluster.DBSCAN.fit]
