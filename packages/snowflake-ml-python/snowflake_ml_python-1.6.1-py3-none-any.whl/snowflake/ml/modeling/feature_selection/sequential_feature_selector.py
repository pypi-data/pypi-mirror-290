...
class SequentialFeatureSelector(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'estimator':(estimator, None, True),
            'n_features_to_select':(n_features_to_select, "auto", False),
            'tol':(tol, None, False),
            'direction':(direction, "forward", False),
        ...
        self._class_name=SequentialFeatureSelector.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "SequentialFeatureSelector":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "SequentialFeatureSelector":
        """Learn the features to select from X
        For more details on this function, see [sklearn.feature_selection.SequentialFeatureSelector.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.feature_selection.SequentialFeatureSelector.html#sklearn.feature_selection.SequentialFeatureSelector.fit)
    ...
    def transform(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        (https://scikit-learn.org/stable/modules/generated/sklearn.feature_selection.SequentialFeatureSelector.html#sklearn.feature_selection.SequentialFeatureSelector.transform)
