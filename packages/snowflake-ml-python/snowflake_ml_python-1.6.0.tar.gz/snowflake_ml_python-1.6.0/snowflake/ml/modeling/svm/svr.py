...
class SVR(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.svm.SVR(
        ...
        self._class_name=SVR.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "SVR":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "SVR":
        """Fit the SVM model according to the given training data
        For more details on this function, see [sklearn.svm.SVR.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.svm.SVR.html#sklearn.svm.SVR.fit)
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.svm.SVR.predict]
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.svm.SVR.score]
