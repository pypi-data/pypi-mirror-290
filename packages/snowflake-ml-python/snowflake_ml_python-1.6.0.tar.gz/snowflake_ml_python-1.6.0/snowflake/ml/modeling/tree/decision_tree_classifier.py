...
class DecisionTreeClassifier(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.tree.DecisionTreeClassifier(
        ...
        self._class_name=DecisionTreeClassifier.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "DecisionTreeClassifier":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.tree.DecisionTreeClassifier.predict]
    ...
    def predict_proba(
        ...
        For more details on this function, see [sklearn.tree.DecisionTreeClassifier.predict_proba]
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.tree.DecisionTreeClassifier.score]
