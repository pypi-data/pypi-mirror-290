...
class MultinomialNB(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.naive_bayes.MultinomialNB(
        ...
        self._class_name=MultinomialNB.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "MultinomialNB":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.naive_bayes.MultinomialNB.predict]
    ...
    def predict_proba(
        ...
        For more details on this function, see [sklearn.naive_bayes.MultinomialNB.predict_proba]
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.naive_bayes.MultinomialNB.score]
