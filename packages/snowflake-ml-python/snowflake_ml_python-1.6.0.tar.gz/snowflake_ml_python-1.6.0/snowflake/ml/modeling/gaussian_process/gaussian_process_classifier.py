...
class GaussianProcessClassifier(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'kernel':(kernel, None, False),
            ...
            'max_iter_predict':(max_iter_predict, 100, False),
            'warm_start':(warm_start, False, False),
            'copy_X_train':(copy_X_train, True, False),
            'random_state':(random_state, None, False),
            'multi_class':(multi_class, "one_vs_rest", False),
        ...
        self._sklearn_object: Any = sklearn.gaussian_process.GaussianProcessClassifier(
        ...
        self._class_name=GaussianProcessClassifier.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "GaussianProcessClassifier":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.gaussian_process.GaussianProcessClassifier.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.gaussian_process.GaussianProcessClassifier.html#sklearn.gaussian_process.GaussianProcessClassifier.predict)
    ...
    def predict_proba(
        ...
        For more details on this function, see [sklearn.gaussian_process.GaussianProcessClassifier.predict_proba]
        (https://scikit-learn.org/stable/modules/generated/sklearn.gaussian_process.GaussianProcessClassifier.html#sklearn.gaussian_process.GaussianProcessClassifier.predict_proba)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.gaussian_process.GaussianProcessClassifier.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.gaussian_process.GaussianProcessClassifier.html#sklearn.gaussian_process.GaussianProcessClassifier.score)
