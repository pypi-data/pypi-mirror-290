...
class ShrunkCovariance(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.covariance.ShrunkCovariance
        )
        self._sklearn_object: Any = sklearn.covariance.ShrunkCovariance(
        ...
        self._class_name=ShrunkCovariance.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "ShrunkCovariance":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "ShrunkCovariance":
        """Fit the shrunk covariance model to X
        For more details on this function, see [sklearn.covariance.ShrunkCovariance.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.covariance.ShrunkCovariance.html#sklearn.covariance.ShrunkCovariance.fit)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.covariance.ShrunkCovariance.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.covariance.ShrunkCovariance.html#sklearn.covariance.ShrunkCovariance.score)
    ...
    def to_sklearn(self) -> Any:
        """Get sklearn.covariance.ShrunkCovariance object.
        """
