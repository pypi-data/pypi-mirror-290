...
class StackingRegressor(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        final_estimator = transform_snowml_obj_to_sklearn_obj(final_estimator)
        init_args = {'estimators':(estimators, None, True),
            'final_estimator':(final_estimator, None, False),
            'cv':(cv, None, False),
            'n_jobs':(n_jobs, None, False),
            'passthrough':(passthrough, False, False),
            'verbose':(verbose, 0, False),}
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.ensemble.StackingRegressor
        )
        self._sklearn_object: Any = sklearn.ensemble.StackingRegressor(
        ...
        self._class_name=StackingRegressor.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "StackingRegressor":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.ensemble.StackingRegressor.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.StackingRegressor.html#sklearn.ensemble.StackingRegressor.predict)
    ...
    def transform(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.ensemble.StackingRegressor.transform]
        (https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.StackingRegressor.html#sklearn.ensemble.StackingRegressor.transform)
