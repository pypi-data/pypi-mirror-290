...
class RadiusNeighborsClassifier(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'radius':(radius, 1.0, False),
            ...
            'outlier_label':(outlier_label, None, False),
            'metric_params':(metric_params, None, False),
            'n_jobs':(n_jobs, None, False),}
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.neighbors.RadiusNeighborsClassifier
        )
        self._sklearn_object: Any = sklearn.neighbors.RadiusNeighborsClassifier(
        ...
        self._class_name=RadiusNeighborsClassifier.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "RadiusNeighborsClassifier":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.neighbors.RadiusNeighborsClassifier.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.neighbors.RadiusNeighborsClassifier.html#sklearn.neighbors.RadiusNeighborsClassifier.predict)
    ...
    def predict_proba(
        ...
        For more details on this function, see [sklearn.neighbors.RadiusNeighborsClassifier.predict_proba]
        (https://scikit-learn.org/stable/modules/generated/sklearn.neighbors.RadiusNeighborsClassifier.html#sklearn.neighbors.RadiusNeighborsClassifier.predict_proba)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.neighbors.RadiusNeighborsClassifier.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.neighbors.RadiusNeighborsClassifier.html#sklearn.neighbors.RadiusNeighborsClassifier.score)
