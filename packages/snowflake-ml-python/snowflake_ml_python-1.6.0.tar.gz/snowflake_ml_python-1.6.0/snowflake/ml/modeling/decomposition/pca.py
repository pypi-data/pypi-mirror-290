...
class PCA(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'n_components':(n_components, None, False),
            ...
            'svd_solver':(svd_solver, "auto", False),
            'tol':(tol, 0.0, False),
            'iterated_power':(iterated_power, "auto", False),
            'n_oversamples':(n_oversamples, 10, False),
            'power_iteration_normalizer':(power_iteration_normalizer, "auto", False),
            'random_state':(random_state, None, False),}
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.decomposition.PCA
        )
        self._sklearn_object: Any = sklearn.decomposition.PCA(
        ...
        self._class_name=PCA.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "PCA":
        """
    ...
    def transform(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.decomposition.PCA.transform]
    ...
    def score_samples(
        ...
        For more details on this function, see [sklearn.decomposition.PCA.score_samples]
        (https://scikit-learn.org/stable/modules/generated/sklearn.decomposition.PCA.html#sklearn.decomposition.PCA.score_samples)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.decomposition.PCA.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.decomposition.PCA.html#sklearn.decomposition.PCA.score)
