...
class AffinityPropagation(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'damping':(damping, 0.5, False),
            ...
            'preference':(preference, None, False),
            'affinity':(affinity, "euclidean", False),
        ...
        self._sklearn_object: Any = sklearn.cluster.AffinityPropagation(
        ...
        self._class_name=AffinityPropagation.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "AffinityPropagation":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.cluster.AffinityPropagation.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.cluster.AffinityPropagation.html#sklearn.cluster.AffinityPropagation.predict)
