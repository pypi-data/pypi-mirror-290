...
class SpectralClustering(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'n_clusters':(n_clusters, 8, False),
            ...
            'gamma':(gamma, 1.0, False),
            'affinity':(affinity, "rbf", False),
            'n_neighbors':(n_neighbors, 10, False),
            'eigen_tol':(eigen_tol, "auto", False),
            'assign_labels':(assign_labels, "kmeans", False),
        ...
        self._sklearn_object: Any = sklearn.cluster.SpectralClustering(
        ...
        self._class_name=SpectralClustering.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "SpectralClustering":
        """
