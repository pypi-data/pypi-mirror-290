...
class MeanShift(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'bandwidth':(bandwidth, None, False),
            ...
            'min_bin_freq':(min_bin_freq, 1, False),
            'cluster_all':(cluster_all, True, False),
        ...
        self._class_name=MeanShift.__class__.__name__
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "MeanShift":
        """Perform clustering
        For more details on this function, see [sklearn.cluster.MeanShift.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.cluster.MeanShift.html#sklearn.cluster.MeanShift.fit)
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        (https://scikit-learn.org/stable/modules/generated/sklearn.cluster.MeanShift.html#sklearn.cluster.MeanShift.predict)
