...
class SelectFwe(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        self,
        *,
        score_func=sklearn.feature_selection._univariate_selection.f_classif,
        alpha=0.05,
        ...
        self._sklearn_object: Any = sklearn.feature_selection.SelectFwe(
        ...
        self._class_name=SelectFwe.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "SelectFwe":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "SelectFwe":
        """Run score function on (X, y) and get the appropriate features
        For more details on this function, see [sklearn.feature_selection.SelectFwe.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.feature_selection.SelectFwe.html#sklearn.feature_selection.SelectFwe.fit)
    ...
    def transform(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.feature_selection.SelectFwe.transform]
        (https://scikit-learn.org/stable/modules/generated/sklearn.feature_selection.SelectFwe.html#sklearn.feature_selection.SelectFwe.transform)
    ...
    def to_sklearn(self) -> Any:
        """Get sklearn.feature_selection.SelectFwe object.
        """
