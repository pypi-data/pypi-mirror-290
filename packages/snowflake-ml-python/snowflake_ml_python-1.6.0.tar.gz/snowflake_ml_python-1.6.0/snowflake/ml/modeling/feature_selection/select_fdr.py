...
class SelectFdr(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._class_name=SelectFdr.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "SelectFdr":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "SelectFdr":
        """Run score function on (X, y) and get the appropriate features
        For more details on this function, see [sklearn.feature_selection.SelectFdr.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.feature_selection.SelectFdr.html#sklearn.feature_selection.SelectFdr.fit)
    ...
    def transform(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        (https://scikit-learn.org/stable/modules/generated/sklearn.feature_selection.SelectFdr.html#sklearn.feature_selection.SelectFdr.transform)
