...
class TransformedTargetRegressor(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'regressor':(regressor, None, False),
            ...
            'inverse_func':(inverse_func, None, False),
            'check_inverse':(check_inverse, True, False),}
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.compose.TransformedTargetRegressor
        )
        self._sklearn_object: Any = sklearn.compose.TransformedTargetRegressor(
        ...
        self._class_name=TransformedTargetRegressor.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "TransformedTargetRegressor":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "TransformedTargetRegressor":
        """Fit the model according to the given training data
        For more details on this function, see [sklearn.compose.TransformedTargetRegressor.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.compose.TransformedTargetRegressor.html#sklearn.compose.TransformedTargetRegressor.fit)
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.compose.TransformedTargetRegressor.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.compose.TransformedTargetRegressor.html#sklearn.compose.TransformedTargetRegressor.predict)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.compose.TransformedTargetRegressor.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.compose.TransformedTargetRegressor.html#sklearn.compose.TransformedTargetRegressor.score)
