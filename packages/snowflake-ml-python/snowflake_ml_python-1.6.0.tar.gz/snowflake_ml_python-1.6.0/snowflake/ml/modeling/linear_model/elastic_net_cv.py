...
class ElasticNetCV(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.linear_model.ElasticNetCV(
        ...
        self._class_name=ElasticNetCV.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "ElasticNetCV":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.linear_model.ElasticNetCV.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.ElasticNetCV.html#sklearn.linear_model.ElasticNetCV.predict)
    ...
    def to_sklearn(self) -> Any:
        """Get sklearn.linear_model.ElasticNetCV object.
        """
