...
class SGDClassifier(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.linear_model.SGDClassifier(
        ...
        self._class_name=SGDClassifier.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "SGDClassifier":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.linear_model.SGDClassifier.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.SGDClassifier.html#sklearn.linear_model.SGDClassifier.predict)
    ...
    def predict_proba(
        ...
        For more details on this function, see [sklearn.linear_model.SGDClassifier.predict_proba]
    ...
    def decision_function(
        ...
        For more details on this function, see [sklearn.linear_model.SGDClassifier.decision_function]
