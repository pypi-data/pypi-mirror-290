...
class SGDOneClassSVM(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'nu':(nu, 0.5, False),
            ...
            'learning_rate':(learning_rate, "optimal", False),
            'eta0':(eta0, 0.0, False),
        ...
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.linear_model.SGDOneClassSVM
        )
        self._sklearn_object: Any = sklearn.linear_model.SGDOneClassSVM(
        ...
        self._class_name=SGDOneClassSVM.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "SGDOneClassSVM":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.linear_model.SGDOneClassSVM.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.SGDOneClassSVM.html#sklearn.linear_model.SGDOneClassSVM.predict)
    ...
    def decision_function(
        ...
        For more details on this function, see [sklearn.linear_model.SGDOneClassSVM.decision_function]
        (https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.SGDOneClassSVM.html#sklearn.linear_model.SGDOneClassSVM.decision_function)
    ...
    def score_samples(
        ...
        For more details on this function, see [sklearn.linear_model.SGDOneClassSVM.score_samples]
        (https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.SGDOneClassSVM.html#sklearn.linear_model.SGDOneClassSVM.score_samples)
