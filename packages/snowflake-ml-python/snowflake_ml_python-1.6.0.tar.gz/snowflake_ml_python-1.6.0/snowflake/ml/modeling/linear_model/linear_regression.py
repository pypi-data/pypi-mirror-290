...
class LinearRegression(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.linear_model.LinearRegression(
        ...
        self._class_name=LinearRegression.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "LinearRegression":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "LinearRegression":
        """Fit linear model
        For more details on this function, see [sklearn.linear_model.LinearRegression.fit]
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.linear_model.LinearRegression.predict]
