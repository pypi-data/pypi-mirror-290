...
class BayesianGaussianMixture(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'n_components':(n_components, 1, False),
            ...
            'tol':(tol, 0.001, False),
            'reg_covar':(reg_covar, 1e-06, False),
            'max_iter':(max_iter, 100, False),
            'n_init':(n_init, 1, False),
            'init_params':(init_params, "kmeans", False),
            'weight_concentration_prior_type':(weight_concentration_prior_type, "dirichlet_process", False),
            'weight_concentration_prior':(weight_concentration_prior, None, False),
            'mean_precision_prior':(mean_precision_prior, None, False),
            'mean_prior':(mean_prior, None, False),
            'degrees_of_freedom_prior':(degrees_of_freedom_prior, None, False),
            'covariance_prior':(covariance_prior, None, False),
            'random_state':(random_state, None, False),
            'warm_start':(warm_start, False, False),
            'verbose':(verbose, 0, False),
            'verbose_interval':(verbose_interval, 10, False),}
        ...
        self._class_name=BayesianGaussianMixture.__class__.__name__
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        (https://scikit-learn.org/stable/modules/generated/sklearn.mixture.BayesianGaussianMixture.html#sklearn.mixture.BayesianGaussianMixture.predict)
    ...
    def predict_proba(
        ...
        For more details on this function, see [sklearn.mixture.BayesianGaussianMixture.predict_proba]
        (https://scikit-learn.org/stable/modules/generated/sklearn.mixture.BayesianGaussianMixture.html#sklearn.mixture.BayesianGaussianMixture.predict_proba)
    ...
    def score_samples(
        ...
        For more details on this function, see [sklearn.mixture.BayesianGaussianMixture.score_samples]
        (https://scikit-learn.org/stable/modules/generated/sklearn.mixture.BayesianGaussianMixture.html#sklearn.mixture.BayesianGaussianMixture.score_samples)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.mixture.BayesianGaussianMixture.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.mixture.BayesianGaussianMixture.html#sklearn.mixture.BayesianGaussianMixture.score)
