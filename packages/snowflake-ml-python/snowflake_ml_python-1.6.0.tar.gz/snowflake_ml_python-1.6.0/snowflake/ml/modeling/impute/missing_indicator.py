...
class MissingIndicator(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'missing_values':(missing_values, np.nan, False),
            ...
            'error_on_new':(error_on_new, True, False),}
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.impute.MissingIndicator
        )
        self._sklearn_object: Any = sklearn.impute.MissingIndicator(
        ...
        self._class_name=MissingIndicator.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "MissingIndicator":
        """
    ...
    def transform(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.impute.MissingIndicator.transform]
        (https://scikit-learn.org/stable/modules/generated/sklearn.impute.MissingIndicator.html#sklearn.impute.MissingIndicator.transform)
