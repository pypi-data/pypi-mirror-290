...
class KernelRidge(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'alpha':(alpha, 1, False),
            ...
            'coef0':(coef0, 1, False),
            'kernel_params':(kernel_params, None, False),}
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.kernel_ridge.KernelRidge
        )
        self._sklearn_object: Any = sklearn.kernel_ridge.KernelRidge(
        ...
        self._class_name=KernelRidge.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "KernelRidge":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "KernelRidge":
        """Fit Kernel Ridge regression model
        For more details on this function, see [sklearn.kernel_ridge.KernelRidge.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.kernel_ridge.KernelRidge.html#sklearn.kernel_ridge.KernelRidge.fit)
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.kernel_ridge.KernelRidge.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.kernel_ridge.KernelRidge.html#sklearn.kernel_ridge.KernelRidge.predict)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.kernel_ridge.KernelRidge.score]
