...
class RandomForestClassifier(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._class_name=RandomForestClassifier.__class__.__name__
    ...
    def predict_proba(
        ...
        For more details on this function, see [sklearn.ensemble.RandomForestClassifier.predict_proba]
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.ensemble.RandomForestClassifier.score]
