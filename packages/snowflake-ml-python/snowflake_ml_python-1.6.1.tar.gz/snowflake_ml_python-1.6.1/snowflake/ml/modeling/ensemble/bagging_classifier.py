...
class BaggingClassifier(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'estimator':(estimator, None, False),
            ...
            'bootstrap_features':(bootstrap_features, False, False),
            'oob_score':(oob_score, False, False),
        ...
        self._sklearn_object: Any = sklearn.ensemble.BaggingClassifier(
        ...
        self._class_name=BaggingClassifier.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "BaggingClassifier":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        """Predict class for X
        For more details on this function, see [sklearn.ensemble.BaggingClassifier.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.BaggingClassifier.html#sklearn.ensemble.BaggingClassifier.predict)
    ...
    def predict_proba(
        ...
        For more details on this function, see [sklearn.ensemble.BaggingClassifier.predict_proba]
        (https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.BaggingClassifier.html#sklearn.ensemble.BaggingClassifier.predict_proba)
    ...
    def decision_function(
        ...
        For more details on this function, see [sklearn.ensemble.BaggingClassifier.decision_function]
        (https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.BaggingClassifier.html#sklearn.ensemble.BaggingClassifier.decision_function)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.ensemble.BaggingClassifier.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.BaggingClassifier.html#sklearn.ensemble.BaggingClassifier.score)
