...
class KernelPCA(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'n_components':(n_components, None, False),
            ...
            'fit_inverse_transform':(fit_inverse_transform, False, False),
            'eigen_solver':(eigen_solver, "auto", False),
            'tol':(tol, 0, False),
            'max_iter':(max_iter, None, False),
            'iterated_power':(iterated_power, "auto", False),
            'remove_zero_eig':(remove_zero_eig, False, False),
        ...
        self._sklearn_object: Any = sklearn.decomposition.KernelPCA(
        ...
        self._class_name=KernelPCA.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "KernelPCA":
        """
    ...
    def transform(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        """Transform X
        For more details on this function, see [sklearn.decomposition.KernelPCA.transform]
        (https://scikit-learn.org/stable/modules/generated/sklearn.decomposition.KernelPCA.html#sklearn.decomposition.KernelPCA.transform)
