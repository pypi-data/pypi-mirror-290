...
class MiniBatchSparsePCA(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.decomposition.MiniBatchSparsePCA
        )
        self._sklearn_object: Any = sklearn.decomposition.MiniBatchSparsePCA(
        ...
        self._class_name=MiniBatchSparsePCA.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "MiniBatchSparsePCA":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "MiniBatchSparsePCA":
        """Fit the model from data in X
        For more details on this function, see [sklearn.decomposition.MiniBatchSparsePCA.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.decomposition.MiniBatchSparsePCA.html#sklearn.decomposition.MiniBatchSparsePCA.fit)
    ...
    def transform(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.decomposition.MiniBatchSparsePCA.transform]
        (https://scikit-learn.org/stable/modules/generated/sklearn.decomposition.MiniBatchSparsePCA.html#sklearn.decomposition.MiniBatchSparsePCA.transform)
