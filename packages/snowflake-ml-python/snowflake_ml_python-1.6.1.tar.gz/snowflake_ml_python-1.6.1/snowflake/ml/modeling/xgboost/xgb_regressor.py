...
class XGBRegressor(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        **kwargs,
        ...
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=xgboost.XGBRegressor
        )
        self._sklearn_object: Any = xgboost.XGBRegressor(
        ...
        self._class_name=XGBRegressor.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "XGBRegressor":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        """Predict with `X`
        For more details on this function, see [xgboost.XGBRegressor.predict]
        (https://xgboost.readthedocs.io/en/stable/python/python_api.html#xgboost.XGBRegressor.predict)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [xgboost.XGBRegressor.score]
