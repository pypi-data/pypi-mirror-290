...
class KNeighborsClassifier(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.neighbors.KNeighborsClassifier(
        ...
        self._class_name=KNeighborsClassifier.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "KNeighborsClassifier":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.neighbors.KNeighborsClassifier.predict]
    ...
    def predict_proba(
        ...
        For more details on this function, see [sklearn.neighbors.KNeighborsClassifier.predict_proba]
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.neighbors.KNeighborsClassifier.score]
    ...
    def kneighbors(
        ...
        For more details on this function, see [sklearn.neighbors.KNeighborsClassifier.kneighbors]
