...
class NearestNeighbors(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.neighbors.NearestNeighbors(
        ...
        self._class_name=NearestNeighbors.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "NearestNeighbors":
        """
    ...
    def kneighbors(
        ...
        For more details on this function, see [sklearn.neighbors.NearestNeighbors.kneighbors]
