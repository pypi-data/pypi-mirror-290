...
class NeighborhoodComponentsAnalysis(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.neighbors.NeighborhoodComponentsAnalysis
        )
        self._sklearn_object: Any = sklearn.neighbors.NeighborhoodComponentsAnalysis(
        ...
        self._class_name=NeighborhoodComponentsAnalysis.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "NeighborhoodComponentsAnalysis":
        """
    ...
    def transform(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.neighbors.NeighborhoodComponentsAnalysis.transform]
        (https://scikit-learn.org/stable/modules/generated/sklearn.neighbors.NeighborhoodComponentsAnalysis.html#sklearn.neighbors.NeighborhoodComponentsAnalysis.transform)
