...
class OAS(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._class_name=OAS.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "OAS":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "OAS":
        """Fit the Oracle Approximating Shrinkage covariance model to X
        For more details on this function, see [sklearn.covariance.OAS.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.covariance.OAS.html#sklearn.covariance.OAS.fit)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.covariance.OAS.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.covariance.OAS.html#sklearn.covariance.OAS.score)
    ...
    def to_sklearn(self) -> Any:
        """Get sklearn.covariance.OAS object.
        """
