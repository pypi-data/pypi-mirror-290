...
class GraphicalLassoCV(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.covariance.GraphicalLassoCV
        )
        self._sklearn_object: Any = sklearn.covariance.GraphicalLassoCV(
        ...
        self._class_name=GraphicalLassoCV.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "GraphicalLassoCV":
        """
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.covariance.GraphicalLassoCV.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.covariance.GraphicalLassoCV.html#sklearn.covariance.GraphicalLassoCV.score)
