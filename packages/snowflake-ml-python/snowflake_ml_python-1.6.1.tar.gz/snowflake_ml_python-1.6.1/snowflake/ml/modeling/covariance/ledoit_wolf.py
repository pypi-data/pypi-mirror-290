...
class LedoitWolf(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.covariance.LedoitWolf(
        ...
        self._class_name=LedoitWolf.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "LedoitWolf":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "LedoitWolf":
        """Fit the Ledoit-Wolf shrunk covariance model to X
        For more details on this function, see [sklearn.covariance.LedoitWolf.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.covariance.LedoitWolf.html#sklearn.covariance.LedoitWolf.fit)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.covariance.LedoitWolf.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.covariance.LedoitWolf.html#sklearn.covariance.LedoitWolf.score)
