...
class QuadraticDiscriminantAnalysis(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.discriminant_analysis.QuadraticDiscriminantAnalysis(
        ...
        self._class_name=QuadraticDiscriminantAnalysis.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "QuadraticDiscriminantAnalysis":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "QuadraticDiscriminantAnalysis":
        """Fit the model according to the given training data and parameters
        For more details on this function, see [sklearn.discriminant_analysis.QuadraticDiscriminantAnalysis.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.discriminant_analysis.QuadraticDiscriminantAnalysis.html#sklearn.discriminant_analysis.QuadraticDiscriminantAnalysis.fit)
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.discriminant_analysis.QuadraticDiscriminantAnalysis.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.discriminant_analysis.QuadraticDiscriminantAnalysis.html#sklearn.discriminant_analysis.QuadraticDiscriminantAnalysis.predict)
    ...
    def predict_proba(
        ...
        For more details on this function, see [sklearn.discriminant_analysis.QuadraticDiscriminantAnalysis.predict_proba]
        (https://scikit-learn.org/stable/modules/generated/sklearn.discriminant_analysis.QuadraticDiscriminantAnalysis.html#sklearn.discriminant_analysis.QuadraticDiscriminantAnalysis.predict_proba)
    ...
    def decision_function(
        ...
        For more details on this function, see [sklearn.discriminant_analysis.QuadraticDiscriminantAnalysis.decision_function]
        (https://scikit-learn.org/stable/modules/generated/sklearn.discriminant_analysis.QuadraticDiscriminantAnalysis.html#sklearn.discriminant_analysis.QuadraticDiscriminantAnalysis.decision_function)
