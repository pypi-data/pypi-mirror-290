...
class LinearDiscriminantAnalysis(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'solver':(solver, "svd", False),
            ...
            'covariance_estimator':(covariance_estimator, None, False),}
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.discriminant_analysis.LinearDiscriminantAnalysis
        )
        self._sklearn_object: Any = sklearn.discriminant_analysis.LinearDiscriminantAnalysis(
        ...
        self._class_name=LinearDiscriminantAnalysis.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "LinearDiscriminantAnalysis":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.discriminant_analysis.LinearDiscriminantAnalysis.predict]
    ...
    def transform(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.discriminant_analysis.LinearDiscriminantAnalysis.transform]
    ...
    def predict_proba(
        ...
        For more details on this function, see [sklearn.discriminant_analysis.LinearDiscriminantAnalysis.predict_proba]
        (https://scikit-learn.org/stable/modules/generated/sklearn.discriminant_analysis.LinearDiscriminantAnalysis.html#sklearn.discriminant_analysis.LinearDiscriminantAnalysis.predict_proba)
    ...
    def decision_function(
        ...
        For more details on this function, see [sklearn.discriminant_analysis.LinearDiscriminantAnalysis.decision_function]
        (https://scikit-learn.org/stable/modules/generated/sklearn.discriminant_analysis.LinearDiscriminantAnalysis.html#sklearn.discriminant_analysis.LinearDiscriminantAnalysis.decision_function)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.discriminant_analysis.LinearDiscriminantAnalysis.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.discriminant_analysis.LinearDiscriminantAnalysis.html#sklearn.discriminant_analysis.LinearDiscriminantAnalysis.score)
