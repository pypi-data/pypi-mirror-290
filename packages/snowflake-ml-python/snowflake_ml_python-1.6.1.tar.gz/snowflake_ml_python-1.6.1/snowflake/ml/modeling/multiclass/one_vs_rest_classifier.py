...
class OneVsRestClassifier(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.multiclass.OneVsRestClassifier(
        ...
        self._class_name=OneVsRestClassifier.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "OneVsRestClassifier":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.multiclass.OneVsRestClassifier.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.multiclass.OneVsRestClassifier.html#sklearn.multiclass.OneVsRestClassifier.predict)
    ...
    def predict_proba(
        ...
        For more details on this function, see [sklearn.multiclass.OneVsRestClassifier.predict_proba]
    ...
    def decision_function(
        ...
        For more details on this function, see [sklearn.multiclass.OneVsRestClassifier.decision_function]
        (https://scikit-learn.org/stable/modules/generated/sklearn.multiclass.OneVsRestClassifier.html#sklearn.multiclass.OneVsRestClassifier.decision_function)
