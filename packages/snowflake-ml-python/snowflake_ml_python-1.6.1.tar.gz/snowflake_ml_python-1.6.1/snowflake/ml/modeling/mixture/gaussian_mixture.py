...
class GaussianMixture(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'n_components':(n_components, 1, False),
            ...
            'weights_init':(weights_init, None, False),
            'means_init':(means_init, None, False),
            'precisions_init':(precisions_init, None, False),
        ...
        self._sklearn_object: Any = sklearn.mixture.GaussianMixture(
        ...
        self._class_name=GaussianMixture.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "GaussianMixture":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.mixture.GaussianMixture.predict]
    ...
    def predict_proba(
        ...
        For more details on this function, see [sklearn.mixture.GaussianMixture.predict_proba]
    ...
    def score_samples(
        ...
        For more details on this function, see [sklearn.mixture.GaussianMixture.score_samples]
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.mixture.GaussianMixture.score]
