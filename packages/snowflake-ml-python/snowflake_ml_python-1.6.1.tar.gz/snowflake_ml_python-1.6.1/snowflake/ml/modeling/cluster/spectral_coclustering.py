...
class SpectralCoclustering(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.cluster.SpectralCoclustering
        )
        self._sklearn_object: Any = sklearn.cluster.SpectralCoclustering(
        ...
        self._class_name=SpectralCoclustering.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "SpectralCoclustering":
        """
