...
class SpectralBiclustering(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._class_name=SpectralBiclustering.__class__.__name__
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "SpectralBiclustering":
        """Create a biclustering for X
        For more details on this function, see [sklearn.cluster.SpectralBiclustering.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.cluster.SpectralBiclustering.html#sklearn.cluster.SpectralBiclustering.fit)
