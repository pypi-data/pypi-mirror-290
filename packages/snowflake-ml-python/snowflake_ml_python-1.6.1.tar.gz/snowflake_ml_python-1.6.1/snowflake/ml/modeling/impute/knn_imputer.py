...
class KNNImputer(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'missing_values':(missing_values, np.nan, False),
            ...
            'metric':(metric, "nan_euclidean", False),
        ...
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.impute.KNNImputer
        )
        self._sklearn_object: Any = sklearn.impute.KNNImputer(
        ...
        self._class_name=KNNImputer.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "KNNImputer":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "KNNImputer":
        """Fit the imputer on X
        For more details on this function, see [sklearn.impute.KNNImputer.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.impute.KNNImputer.html#sklearn.impute.KNNImputer.fit)
    ...
    def transform(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.impute.KNNImputer.transform]
        (https://scikit-learn.org/stable/modules/generated/sklearn.impute.KNNImputer.html#sklearn.impute.KNNImputer.transform)
