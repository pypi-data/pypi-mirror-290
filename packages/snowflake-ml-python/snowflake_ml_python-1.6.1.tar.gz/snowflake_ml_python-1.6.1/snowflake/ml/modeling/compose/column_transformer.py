...
class ColumnTransformer(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        transformers = transform_snowml_obj_to_sklearn_obj(transformers)
        ...
        self._sklearn_object: Any = sklearn.compose.ColumnTransformer(
        ...
        self._class_name=ColumnTransformer.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "ColumnTransformer":
        """
    ...
    def transform(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.compose.ColumnTransformer.transform]
        (https://scikit-learn.org/stable/modules/generated/sklearn.compose.ColumnTransformer.html#sklearn.compose.ColumnTransformer.transform)
