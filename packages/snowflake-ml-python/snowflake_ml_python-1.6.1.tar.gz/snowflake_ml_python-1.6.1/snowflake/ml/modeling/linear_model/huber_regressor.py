...
class HuberRegressor(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.linear_model.HuberRegressor(
        ...
        self._class_name=HuberRegressor.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "HuberRegressor":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "HuberRegressor":
        """Fit the model according to the given training data
        For more details on this function, see [sklearn.linear_model.HuberRegressor.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.HuberRegressor.html#sklearn.linear_model.HuberRegressor.fit)
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.linear_model.HuberRegressor.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.HuberRegressor.html#sklearn.linear_model.HuberRegressor.predict)
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.linear_model.HuberRegressor.score]
        (https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.HuberRegressor.html#sklearn.linear_model.HuberRegressor.score)
    ...
    def to_sklearn(self) -> Any:
        """Get sklearn.linear_model.HuberRegressor object.
        """
