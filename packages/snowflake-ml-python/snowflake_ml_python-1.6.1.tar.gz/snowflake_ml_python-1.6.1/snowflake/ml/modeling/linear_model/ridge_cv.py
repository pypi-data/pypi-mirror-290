...
class RidgeCV(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.linear_model.RidgeCV(
        ...
        self._class_name=RidgeCV.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "RidgeCV":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "RidgeCV":
        """Fit Ridge regression model with cv
        For more details on this function, see [sklearn.linear_model.RidgeCV.fit]
        (https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.RidgeCV.html#sklearn.linear_model.RidgeCV.fit)
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.linear_model.RidgeCV.predict]
