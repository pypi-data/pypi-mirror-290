...
class LassoLarsIC(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'criterion':(criterion, "aic", False),
            ...
            'noise_variance':(noise_variance, None, False),}
        cleaned_up_init_args = validate_sklearn_args(
            args=init_args,
            klass=sklearn.linear_model.LassoLarsIC
        )
        self._sklearn_object: Any = sklearn.linear_model.LassoLarsIC(
        ...
        self._class_name=LassoLarsIC.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "LassoLarsIC":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.linear_model.LassoLarsIC.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.linear_model.LassoLarsIC.html#sklearn.linear_model.LassoLarsIC.predict)
