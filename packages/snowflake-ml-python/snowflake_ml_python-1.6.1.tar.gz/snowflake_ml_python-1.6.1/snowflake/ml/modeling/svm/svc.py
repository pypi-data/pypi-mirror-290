...
class SVC(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        self._sklearn_object: Any = sklearn.svm.SVC(
        ...
        self._class_name=SVC.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "SVC":
        """
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.svm.SVC.predict]
    ...
    def predict_proba(
        ...
        For more details on this function, see [sklearn.svm.SVC.predict_proba]
    ...
    def decision_function(
        ...
        For more details on this function, see [sklearn.svm.SVC.decision_function]
