...
class LinearSVC(BaseTransformer):
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        *,
        ...
        init_args = {'penalty':(penalty, "l2", False),
            ...
            'intercept_scaling':(intercept_scaling, 1, False),
        ...
        self._sklearn_object: Any = sklearn.svm.LinearSVC(
        ...
        self._class_name=LinearSVC.__class__.__name__
    ...
    def set_input_cols(self, input_cols: Optional[Union[str, Iterable[str]]]) -> "LinearSVC":
        """
    ...
    def _fit(self, dataset: Union[DataFrame, pd.DataFrame]) -> "LinearSVC":
        """Fit the model according to the given training data
        For more details on this function, see [sklearn.svm.LinearSVC.fit]
    ...
    def predict(self, dataset: Union[DataFrame, pd.DataFrame]) -> Union[DataFrame, pd.DataFrame]:
        ...
        For more details on this function, see [sklearn.svm.LinearSVC.predict]
        (https://scikit-learn.org/stable/modules/generated/sklearn.svm.LinearSVC.html#sklearn.svm.LinearSVC.predict)
    ...
    def decision_function(
        ...
        For more details on this function, see [sklearn.svm.LinearSVC.decision_function]
    ...
    def score(self, dataset: Union[DataFrame, pd.DataFrame]) -> float:
        ...
        For more details on this function, see [sklearn.svm.LinearSVC.score]
    ...
    def to_sklearn(self) -> Any:
        """Get sklearn.svm.LinearSVC object.
        """
