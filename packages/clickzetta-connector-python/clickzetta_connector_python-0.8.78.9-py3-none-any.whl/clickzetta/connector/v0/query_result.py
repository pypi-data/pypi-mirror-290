...
def _arrow_table_to_rows(table: pa.Table) -> List[Tuple]:
    ...
    def read_object_file(self, file):
        ...
        with pa.ipc.RecordBatchStreamReader(stream) as reader:
            if self._pure_arrow_decoding:
                return _arrow_table_to_rows(reader.read_all())
...
class QueryResult(object):
    def __init__(self, total_msg, pure_arrow_decoding):
        self.data = None
        self.state = None
