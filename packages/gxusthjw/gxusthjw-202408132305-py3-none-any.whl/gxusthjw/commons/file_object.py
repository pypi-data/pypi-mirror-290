...
# Version:          0.0.1
# Created:          2012/01/01
# Description:      Main Function: 定义“文件”相关的函数和类。
#                   Outer Parameters: xxxxxxx
# Class List:       FileInfo -- 表征“文件信息”。
#                   FileObject -- 表征“文件对象”。
# Function List:    get_file_encoding_chardet(file_path) --
#                                       利用chardet库获取文件的编码。
#                   file_info(directory_path, base_name,
#                         ext_name, encoding,**kwargs) --
#                                        构造文件信息对象。
#                   get_file_info(file_path, encoding,
#                                   **kwargs): -- 获取文件信息对象。
#                   get_file_info_of_module(mod_name) --
#                              利用inspect获取指定模块名的文件信息。
#                   get_file_object(file, encoding, **kwargs)
#                                             --  获取文件对象。
# History:
...
#       Jiwei Huang        0.0.1         2024/08/11     finish
# ----------------------------------------------------------------
# 导包 ============================================================
import inspect
import os.path
...
# chardet库需要安装：pip install chardet
import chardet
...
__doc__ = """
Defining functions and classes associated with file.
"""
__all__ = [
...
def file_info(directory_path: str, base_name: str,
    ...
    :return: FileInfo对象。
    """
    return FileInfo(directory_path, base_name,
                    ext_name, encoding,
                    **kwargs)
...
def get_file_object(file: str, encoding: Optional[str] = None, **kwargs):
    """
    获取文件对象。
    ...
    :return: FileObject对象。
    """
    return FileObject(file, encoding=encoding, **kwargs)
    ...
    def __init__(self, file: Union[str, FileInfo],
        ...
        if isinstance(file, str):
            ...
            if self.__file_ext_name.startswith('.'):
                self.__ext_name = self.__file_ext_name[1:]
        else:
