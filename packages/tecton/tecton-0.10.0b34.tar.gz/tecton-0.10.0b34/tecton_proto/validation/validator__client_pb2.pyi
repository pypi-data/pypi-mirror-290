...
class FeatureViewValidationArgs(_message.Message):
    __slots__ = ["args", "materialization_schema", "view_schema"]
    ARGS_FIELD_NUMBER: ClassVar[int]
    ...
    def __init__(self, args: Optional[Union[_feature_view__client_pb2.FeatureViewArgs, Mapping]] = ..., view_schema: Optional[Union[_schema__client_pb2.Schema, Mapping]] = ..., materialization_schema: Optional[Union[_schema__client_pb2.Schema, Mapping]] = ...) -> None: ...
