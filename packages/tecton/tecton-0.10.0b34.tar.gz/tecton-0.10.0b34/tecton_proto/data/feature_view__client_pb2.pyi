...
class AggregateFeature(_message.Message):
    __slots__ = ["batch_sawtooth_tile_size", "function", "function_params", "input_feature_name", "output_feature_name", "time_window", "window"]
    ...
    def __init__(self, input_feature_name: Optional[str] = ..., output_feature_name: Optional[str] = ..., function: Optional[Union[_aggregation_function__client_pb2.AggregationFunction, str]] = ..., function_params: Optional[Union[_aggregation_function__client_pb2.AggregationFunctionParams, Mapping]] = ..., window: Optional[Union[_duration_pb2.Duration, Mapping]] = ..., time_window: Optional[Union[_time_window__client_pb2.TimeWindow, Mapping]] = ..., batch_sawtooth_tile_size: Optional[Union[_duration_pb2.Duration, Mapping]] = ...) -> None: ...
...
class EmbeddingFeature(_message.Message):
    __slots__ = ["input_column_name", "model", "output_column_name"]
    ...
    def __init__(self, input_column_name: Optional[str] = ..., output_column_name: Optional[str] = ..., model: Optional[str] = ...) -> None: ...
...
class FeatureTable(_message.Message):
    __slots__ = ["offline_enabled", "online_enabled", "serving_ttl"]
    ...
    def __init__(self, online_enabled: bool = ..., offline_enabled: bool = ..., serving_ttl: Optional[Union[_duration_pb2.Duration, Mapping]] = ...) -> None: ...
...
class InferenceFeature(_message.Message):
    __slots__ = ["input_columns", "model_artifact", "output_column"]
    ...
    def __init__(self, input_columns: Optional[Iterable[Union[_schema__client_pb2.Column, Mapping]]] = ..., output_column: Optional[Union[_schema__client_pb2.Column, Mapping]] = ..., model_artifact: Optional[Union[_model_artifact_service__client_pb2.ModelArtifactInfo, Mapping]] = ...) -> None: ...
...
class Prompt(_message.Message):
    ...
    def __init__(self, environment: Optional[Union[_realtime_compute__client_pb2.RemoteFunctionComputeConfig, Mapping]] = ...) -> None: ...

class RealtimeFeatureView(_message.Message):
    __slots__ = ["no_op", "supported_environments"]
    ...
    def __init__(self, no_op: bool = ..., supported_environments: Optional[Iterable[Union[_realtime_compute__client_pb2.RemoteFunctionComputeConfig, Mapping]]] = ...) -> None: ...
...
class Temporal(_message.Message):
    __slots__ = ["backfill_config", "data_source_type", "embeddings", "incremental_backfills", "inferences", "is_continuous", "serving_ttl"]
...
class TemporalAggregate(_message.Message):
    ...
    data_source_type: _data_source_type__client_pb2.DataSourceType
    features: _containers.RepeatedCompositeFieldContainer[AggregateFeature]
    is_continuous: bool
...
class TrailingTimeWindowAggregation(_message.Message):
    ...
    is_continuous: bool
    time_key: str
    def __init__(self, time_key: Optional[str] = ..., aggregation_slide_period: Optional[Union[_duration_pb2.Duration, Mapping]] = ..., features: Optional[Iterable[Union[AggregateFeature, Mapping]]] = ..., is_continuous: bool = ...) -> None: ...
