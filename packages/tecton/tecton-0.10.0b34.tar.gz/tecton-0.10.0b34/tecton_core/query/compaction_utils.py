...
@attrs.frozen
class SawtoothAggregateFeature:
    """SawtoothAggregateFeature represents a single aggregate feature and it's metadata.
    ...
    aggregate_feature: feature_view__data_pb2.AggregateFeature
