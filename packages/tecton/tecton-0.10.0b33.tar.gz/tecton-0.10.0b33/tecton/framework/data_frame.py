...
class TectonDataFrame(DataframeWrapper):
    ...
    def start_dataset_job(
        ...
        if isinstance(fco, specs.FeatureServiceSpec) and not environment:
        ...
        return materialization_api.start_dataset_job(
            ...
            output_schema=self._querytree.output_schema,
            compute_mode=self._request_params.compute_mode.to_batch_compute(),
