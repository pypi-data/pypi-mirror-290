...
class Attribute(_message.Message):
    __slots__ = ["column_dtype", "name"]
    COLUMN_DTYPE_FIELD_NUMBER: ClassVar[int]
    NAME_FIELD_NUMBER: ClassVar[int]
    column_dtype: _data_type__client_pb2.DataType
    name: str
    def __init__(self, name: Optional[str] = ..., column_dtype: Optional[Union[_data_type__client_pb2.DataType, Mapping]] = ...) -> None: ...
...
class Embedding(_message.Message):
    __slots__ = ["column", "column_dtype", "model", "name"]
    COLUMN_DTYPE_FIELD_NUMBER: ClassVar[int]
    ...
    model: str
    name: str
    def __init__(self, name: Optional[str] = ..., column: Optional[str] = ..., column_dtype: Optional[Union[_data_type__client_pb2.DataType, Mapping]] = ..., model: Optional[str] = ...) -> None: ...
...
class FeatureAggregation(_message.Message):
    __slots__ = ["batch_sawtooth_tile_size", "column", "column_dtype", "function", "function_params", "lifetime_window", "name", "time_window", "time_window_legacy", "time_window_series"]
...
class Inference(_message.Message):
    __slots__ = ["input_columns", "model", "name"]
    ...
    model: str
    name: str
    def __init__(self, input_columns: Optional[Iterable[Union[_schema__client_pb2.Field, Mapping]]] = ..., name: Optional[str] = ..., model: Optional[str] = ...) -> None: ...
...
class MaterializedFeatureViewArgs(_message.Message):
    __slots__ = ["aggregation_interval", "aggregation_secondary_key", "aggregations", "attributes", "batch_compute", "batch_schedule", "batch_trigger", "compaction_enabled", "data_source_type", "embeddings", "environment", "feature_start_time", "incremental_backfills", "inferences", "lifetime_start_time", "manual_trigger_backfill_end_time", "max_backfill_interval", "monitoring", "offline_store", "offline_store_legacy", "online_store", "output_stream", "run_transformation_validation", "schema", "secondary_key_output_columns", "serving_ttl", "stream_compute", "stream_processing_mode", "stream_tile_size", "stream_tiling_enabled", "tecton_materialization_runtime", "timestamp_field"]
