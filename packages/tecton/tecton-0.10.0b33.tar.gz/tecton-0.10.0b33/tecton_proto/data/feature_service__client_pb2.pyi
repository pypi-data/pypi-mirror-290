...
class FeatureService(_message.Message):
    __slots__ = ["enable_online_caching", "fco_metadata", "feature_service_id", "feature_set_items", "logging", "online_serving_enabled", "options", "realtime_environment", "validation_args"]
