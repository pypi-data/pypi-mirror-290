...
class RealtimeEnvironment(_message.Message):
    __slots__ = ["aws_compute_instance_group", "feature_services", "image_info", "online_provisioned", "remote_function_uri", "tecton_transform_runtime_version"]
    ...
    aws_compute_instance_group: _realtime_compute__client_pb2.AWSComputeInstanceGroup
    ...
    def __init__(self, tecton_transform_runtime_version: Optional[str] = ..., image_info: Optional[Union[_container_image__client_pb2.ContainerImage, Mapping]] = ..., remote_function_uri: Optional[str] = ..., aws_compute_instance_group: Optional[Union[_realtime_compute__client_pb2.AWSComputeInstanceGroup, Mapping]] = ..., feature_services: Optional[Iterable[Union[DependentFeatureService, Mapping]]] = ..., online_provisioned: bool = ...) -> None: ...

class RemoteComputeEnvironment(_message.Message):
    __slots__ = ["created_at", "description", "feature_services", "id", "image_info", "name", "python_version", "realtime_job_environment", "requirements", "resolved_requirements", "rift_batch_job_environment", "s3_wheels_location", "sdk_version", "status", "status_details", "supported_job_environments", "type", "updated_at"]
