...
class RealtimeEnvironment(_message.Message):
    ...
    def __init__(self, tecton_transform_runtime_version: Optional[str] = ..., image_info: Optional[Union[_container_image__client_pb2.ContainerImage, Mapping]] = ..., remote_function_uri: Optional[str] = ..., aws_compute_instance_group: Optional[Union[_compute_instance_group__client_pb2.AWSInstanceGroup, Mapping]] = ..., feature_services: Optional[Iterable[Union[DependentFeatureService, Mapping]]] = ..., online_provisioned: bool = ...) -> None: ...
