...
class CreateModelArtifactRequest(_message.Message):
    __slots__ = ["description", "environments", "file_hashes", "input_schema", "model_file_path", "name", "output_schema", "tags", "type"]
    ...
    type: ModelType
    def __init__(self, name: Optional[str] = ..., type: Optional[Union[ModelType, str]] = ..., description: Optional[str] = ..., file_hashes: Optional[Mapping[str, str]] = ..., input_schema: Optional[Union[_schema__client_pb2.Schema, Mapping]] = ..., output_schema: Optional[Union[_schema__client_pb2.Schema, Mapping]] = ..., tags: Optional[Mapping[str, str]] = ..., model_file_path: Optional[str] = ..., environments: Optional[Iterable[str]] = ...) -> None: ...
...
class GetModelArtifactUploadUrlResponse(_message.Message):
    __slots__ = ["model_artifact_id", "upload_id"]
    MODEL_ARTIFACT_ID_FIELD_NUMBER: ClassVar[int]
    UPLOAD_ID_FIELD_NUMBER: ClassVar[int]
    model_artifact_id: _id__client_pb2.Id
    upload_id: str
    def __init__(self, model_artifact_id: Optional[Union[_id__client_pb2.Id, Mapping]] = ..., upload_id: Optional[str] = ...) -> None: ...
...
class ModelArtifactInfo(_message.Message):
    __slots__ = ["created_at", "description", "environments", "file_hashes", "id", "input_schema", "model_file_path", "name", "output_schema", "status", "storage_path", "tags", "type", "updated_at"]
    class FileHashesEntry(_message.Message):
        __slots__ = ["key", "value"]
        KEY_FIELD_NUMBER: ClassVar[int]
        VALUE_FIELD_NUMBER: ClassVar[int]
...
class UpdateTectonModelRequest(_message.Message):
    __slots__ = ["description", "environments", "id", "input_schema", "name", "output_schema", "tags", "type"]
    class TagsEntry(_message.Message):
        __slots__ = ["key", "value"]
        KEY_FIELD_NUMBER: ClassVar[int]
        VALUE_FIELD_NUMBER: ClassVar[int]
    ...
    tags: _containers.ScalarMap[str, str]
    type: ModelType
    def __init__(self, name: Optional[str] = ..., id: Optional[Union[_id__client_pb2.Id, Mapping]] = ..., description: Optional[str] = ..., input_schema: Optional[Union[_schema__client_pb2.Schema, Mapping]] = ..., output_schema: Optional[Union[_schema__client_pb2.Schema, Mapping]] = ..., tags: Optional[Mapping[str, str]] = ..., environments: Optional[Iterable[str]] = ..., type: Optional[Union[ModelType, str]] = ...) -> None: ...
