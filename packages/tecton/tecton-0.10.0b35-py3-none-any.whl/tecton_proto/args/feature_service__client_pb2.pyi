...
class FeatureServiceArgs(_message.Message):
    __slots__ = ["enable_online_caching", "feature_references", "feature_service_id", "info", "logging", "online_serving_enabled", "options", "prevent_destroy", "realtime_environment", "version"]
