...
class Aggregate(Feature):
    ...
    def __init__(
        ...
        super().__init__(function=function, time_window=time_window, name=name, input_column=input_column)
...
class Attribute(Feature):
    ...
    @batch_feature_view(
        # ...
        features=[Attribute(name="my_column", dtype=String)],
    )
    def my_fv(data_source):
        pass
    ```
    ...
    def _to_proto(self):
        return feature_view_pb2.Attribute(
            name=self.name,
            column_dtype=self.dtype.tecton_type.proto,
        )
...
class Embedding(Feature):
    ...
    def __init__(self, input_column: Field, model: str, name: Optional[str] = None):
        super().__init__(model=model, name=name, input_column=input_column)
...
class Inference(Feature):
    ...
    def __init__(self, model: str, input_columns: List[Field], name: str):
        super().__init__(model=model, input_columns=input_columns, name=name)
