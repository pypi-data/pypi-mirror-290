...
class ModelConfig(StrictModel):
    ...
    def run(self, mock_inputs: Dict[str, List[Any]]) -> pandas.DataFrame:
        ...
        try:
            ...
            msg = "Install tecton[embeddings] to install additional packages needed to use Tecton Custom Models"
        ...
        model_utils.validate(archive_root_path=Path("."), model_file_path=model_file_path, files=all_file_paths)
