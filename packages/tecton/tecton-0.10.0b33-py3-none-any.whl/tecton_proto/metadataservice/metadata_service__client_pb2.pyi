...
class FcoSearchResult(_message.Message):
    __slots__ = ["description", "fco_id", "fco_type", "features", "last_updated", "name", "owner", "tags", "workplace_state_id", "workspace"]
