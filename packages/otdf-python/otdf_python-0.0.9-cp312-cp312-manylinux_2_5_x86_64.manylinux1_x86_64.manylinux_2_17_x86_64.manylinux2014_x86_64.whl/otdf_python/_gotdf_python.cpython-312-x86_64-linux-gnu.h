...
/* package gotdf_python/build/lib.linux-x86_64-cpython-312/otdf_python */
...
//
extern long long int gotdf_python_DecryptionConfig_CTor();
extern char* gotdf_python_DecryptionConfig_ClientId_Get(long long int handle);
extern void gotdf_python_DecryptionConfig_ClientId_Set(long long int handle, char* val);
extern char* gotdf_python_DecryptionConfig_ClientSecret_Get(long long int handle);
extern void gotdf_python_DecryptionConfig_ClientSecret_Set(long long int handle, char* val);
extern char* gotdf_python_DecryptionConfig_PlatformEndpoint_Get(long long int handle);
extern void gotdf_python_DecryptionConfig_PlatformEndpoint_Set(long long int handle, char* val);
extern char* gotdf_python_DecryptionConfig_TokenEndpoint_Get(long long int handle);
extern void gotdf_python_DecryptionConfig_TokenEndpoint_Set(long long int handle, char* val);
extern char* gotdf_python_DecryptionConfig_KasUrl_Get(long long int handle);
extern void gotdf_python_DecryptionConfig_KasUrl_Set(long long int handle, char* val);

// --- wrapping struct: gotdf_python.EncryptionConfig ---
//
extern long long int gotdf_python_EncryptionConfig_CTor();
extern char* gotdf_python_EncryptionConfig_ClientId_Get(long long int handle);
extern void gotdf_python_EncryptionConfig_ClientId_Set(long long int handle, char* val);
extern char* gotdf_python_EncryptionConfig_ClientSecret_Get(long long int handle);
extern void gotdf_python_EncryptionConfig_ClientSecret_Set(long long int handle, char* val);
extern char* gotdf_python_EncryptionConfig_PlatformEndpoint_Get(long long int handle);
extern void gotdf_python_EncryptionConfig_PlatformEndpoint_Set(long long int handle, char* val);
extern char* gotdf_python_EncryptionConfig_TokenEndpoint_Get(long long int handle);
extern void gotdf_python_EncryptionConfig_TokenEndpoint_Set(long long int handle, char* val);
extern char* gotdf_python_EncryptionConfig_KasUrl_Get(long long int handle);
extern void gotdf_python_EncryptionConfig_KasUrl_Set(long long int handle, char* val);
extern long long int gotdf_python_EncryptionConfig_DataAttributes_Get(long long int handle);
extern void gotdf_python_EncryptionConfig_DataAttributes_Set(long long int handle, long long int val);

// --- wrapping struct: gotdf_python.TokenAuth ---
//
extern long long int gotdf_python_TokenAuth_CTor();
extern char* gotdf_python_TokenAuth_AccessToken_Get(long long int handle);
extern void gotdf_python_TokenAuth_AccessToken_Set(long long int handle, char* val);
extern char* gotdf_python_TokenAuth_NpeClientId_Get(long long int handle);
extern void gotdf_python_TokenAuth_NpeClientId_Set(long long int handle, char* val);
extern char* gotdf_python_EncryptString(char* inputText, long long int config);
extern char* gotdf_python_Hello();
extern char* gotdf_python_DecryptFile(char* inputFilePath, char* outputFilePath, long long int config);
extern char* gotdf_python_DecryptFilePE(char* inputFilePath, char* outputFilePath, long long int config, long long int token);
extern char* gotdf_python_DecryptStringPE(char* inputText, long long int config, long long int token);
extern char* gotdf_python_EncryptFile(char* inputFilePath, char* outputFilePath, long long int config);
extern char* gotdf_python_EncryptFilePE(char* inputFilePath, char* outputFilePath, long long int config, long long int token);
