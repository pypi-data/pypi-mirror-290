...
__all__ = (
    ...
    "CloudFormationCostEstimationResourceCollectionFilterExtraOutputTypeDef",
    ...
    "TagCostEstimationResourceCollectionFilterExtraOutputTypeDef",
    ...
    "NotificationFilterConfigExtraOutputTypeDef",
    ...
    "CostEstimationResourceCollectionFilterExtraOutputTypeDef",
    ...
    "NotificationChannelConfigExtraOutputTypeDef",
...
CloudFormationCostEstimationResourceCollectionFilterExtraOutputTypeDef = TypedDict(
    "CloudFormationCostEstimationResourceCollectionFilterExtraOutputTypeDef",
    {
        "StackNames": NotRequired[List[str]],
    },
...
TagCostEstimationResourceCollectionFilterExtraOutputTypeDef = TypedDict(
    "TagCostEstimationResourceCollectionFilterExtraOutputTypeDef",
    {
        "AppBoundaryKey": str,
        "TagValues": List[str],
...
NotificationFilterConfigExtraOutputTypeDef = TypedDict(
    "NotificationFilterConfigExtraOutputTypeDef",
    {
...
CostEstimationResourceCollectionFilterExtraOutputTypeDef = TypedDict(
    "CostEstimationResourceCollectionFilterExtraOutputTypeDef",
    {
        "CloudFormation": NotRequired[
            CloudFormationCostEstimationResourceCollectionFilterExtraOutputTypeDef
        ],
        "Tags": NotRequired[List[TagCostEstimationResourceCollectionFilterExtraOutputTypeDef]],
    },
)
...
NotificationChannelConfigExtraOutputTypeDef = TypedDict(
    "NotificationChannelConfigExtraOutputTypeDef",
    {
        "Sns": SnsChannelConfigTypeDef,
        "Filters": NotRequired[NotificationFilterConfigExtraOutputTypeDef],
    },
)
...
GetCostEstimationResponseTypeDef = TypedDict(
    "GetCostEstimationResponseTypeDef",
    {
        "ResourceCollection": CostEstimationResourceCollectionFilterExtraOutputTypeDef,
...
NotificationChannelConfigUnionTypeDef = Union[
    NotificationChannelConfigTypeDef, NotificationChannelConfigExtraOutputTypeDef
]
