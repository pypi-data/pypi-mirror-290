...
UNSAFE_METHODS = HAS_BODY_METHODS = (CommonMethod.POST, CommonMethod.PUT, CommonMethod.PATCH, CommonMethod.DELETE)
...
REQUEST_ERROR_STATUSES = list(range(400, 419)) + list(range(421, 427)) + [428, 429, 431, 449, 451]
