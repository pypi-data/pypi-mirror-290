...
class Base(DeclarativeBase):
    ...
    def to_model(self, modelclass: Type[BaseModel], exclude_none: bool = False, exclude_zero: bool = False) -> _T:
        ...
        Args:
            ...
            exclude_zero: 忽略0值的字段, 包含'', 0, False等0值
        """
        return modelclass(**(self.to_dict(exclude_none=exclude_none, exclude_zero=exclude_zero)))
