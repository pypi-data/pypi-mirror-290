...
class DeleteSubscriptionRequest(BaseModel):
  ...
  cancel_unpaid_invoices: Optional[StrictBool] = Field(
    default=False, description='Mark unpaid invoices as uncollectible'
  )
  ...
  __properties: ClassVar[List[str]] = ['cancellation_details', 'cancel_unpaid_invoices', 'prorate']
    ...
    _obj = cls.model_validate(
      {
        ...
        'cancel_unpaid_invoices':
          obj.get('cancel_unpaid_invoices')
          if obj.get('cancel_unpaid_invoices') is not None else False,
