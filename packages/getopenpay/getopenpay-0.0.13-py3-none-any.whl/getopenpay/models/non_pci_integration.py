...
class NonPciIntegration(BaseModel):
  ...
  integration_id: StrictStr = Field(description='The integration ID')
  integration_type: NonPciIntegrationEnum
  __properties: ClassVar[List[str]] = ['account_id', 'integration_id', 'integration_type']
