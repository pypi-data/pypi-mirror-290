...
class AccountExternal(BaseModel):
  ...
  event_settings: Union[str,
                        Any] = Field(description='Event settings associated with this account.')
  dunning_settings: Union[str, Any] = Field(
    description='The dunning settings associated with this account.'
  )
  subscription_settings: Union[str, Any] = Field(
    description='The subscription settings associated with this account.'
  )
