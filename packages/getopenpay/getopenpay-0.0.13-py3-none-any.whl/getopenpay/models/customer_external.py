...
class CustomerExternal(BaseModel):
  ...
  balance_atoms: Optional[List[CustomerBalanceExternal]] = None
  subscribed_to_products: Optional[List[ProductExternal]] = None
  ...
  __properties: ClassVar[List[str]] = [
    ...
    'last_successful_payment_intent', 'discount', 'metadata', 'notes'
  ]
