...
setup(
    ...
    description="Type annotations for boto3.IoT1ClickProjects 1.35.0 service generated with mypy-boto3-builder 7.26.0",
    classifiers=[
    ...
    python_requires=">=3.8",
    project_urls={
        "Documentation": "https://youtype.github.io/boto3_stubs_docs/mypy_boto3_iot1click_projects/",
