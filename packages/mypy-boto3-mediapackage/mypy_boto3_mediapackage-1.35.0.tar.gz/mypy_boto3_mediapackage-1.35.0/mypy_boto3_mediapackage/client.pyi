...
class MediaPackageClient(BaseClient):
    ...
    def close(self) -> None:
        ...
        [Show boto3-stubs documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_mediapackage/client/#close)
        """
    ...
    def update_channel(self, *, Id: str, Description: str = ...) -> UpdateChannelResponseTypeDef:
        """
