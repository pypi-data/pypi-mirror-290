...
class FusionApplicationsClient(object):
    ...
    def change_fusion_environment_compartment(self, fusion_environment_id, change_fusion_environment_compartment_details, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"change_fusion_environment_compartment got unknown kwargs: {extra_kwargs!r}")
    ...
    def change_fusion_environment_family_compartment(self, fusion_environment_family_id, change_fusion_environment_family_compartment_details, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"change_fusion_environment_family_compartment got unknown kwargs: {extra_kwargs!r}")
    ...
    def create_data_masking_activity(self, fusion_environment_id, create_data_masking_activity_details, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_data_masking_activity got unknown kwargs: {extra_kwargs!r}")
    ...
    def create_fusion_environment(self, create_fusion_environment_details, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_fusion_environment got unknown kwargs: {extra_kwargs!r}")
    ...
    def create_fusion_environment_admin_user(self, create_fusion_environment_admin_user_details, fusion_environment_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_fusion_environment_admin_user got unknown kwargs: {extra_kwargs!r}")
    ...
    def create_fusion_environment_family(self, create_fusion_environment_family_details, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_fusion_environment_family got unknown kwargs: {extra_kwargs!r}")
    ...
    def create_refresh_activity(self, fusion_environment_id, create_refresh_activity_details, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_refresh_activity got unknown kwargs: {extra_kwargs!r}")
    ...
    def create_service_attachment(self, create_service_attachment_details, fusion_environment_id, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/fusionapps/create_service_attachment.py.html>`__ to see an example of how to use create_service_attachment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fusionEnvironmentId']
        resource_path = "/fusionEnvironments/{fusionEnvironmentId}/serviceAttachments"
        method = "POST"
        operation_name = "create_service_attachment"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/fusion-applications/20211201/ServiceAttachment/CreateServiceAttachment"
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_service_attachment got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=create_service_attachment_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
                required_arguments=required_arguments)
    ...
    def delete_fusion_environment(self, fusion_environment_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"delete_fusion_environment got unknown kwargs: {extra_kwargs!r}")
    ...
    def delete_fusion_environment_admin_user(self, admin_username, fusion_environment_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"delete_fusion_environment_admin_user got unknown kwargs: {extra_kwargs!r}")
    ...
    def delete_fusion_environment_family(self, fusion_environment_family_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"delete_fusion_environment_family got unknown kwargs: {extra_kwargs!r}")
    ...
    def delete_refresh_activity(self, fusion_environment_id, refresh_activity_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/fusionapps/delete_refresh_activity.py.html>`__ to see an example of how to use delete_refresh_activity API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        if extra_kwargs:
            raise ValueError(
                f"delete_refresh_activity got unknown kwargs: {extra_kwargs!r}")
    ...
    def delete_service_attachment(self, fusion_environment_id, service_attachment_id, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/fusionapps/delete_service_attachment.py.html>`__ to see an example of how to use delete_service_attachment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        method = "DELETE"
        operation_name = "delete_service_attachment"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/fusion-applications/20211201/ServiceAttachment/DeleteServiceAttachment"
        ...
        if extra_kwargs:
            raise ValueError(
                f"delete_service_attachment got unknown kwargs: {extra_kwargs!r}")
    ...
    def generate_extract_details(self, fusion_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/fusionapps/generate_extract_details.py.html>`__ to see an example of how to use generate_extract_details API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fusionEnvironmentId']
    ...
    def get_data_masking_activity(self, fusion_environment_id, data_masking_activity_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_data_masking_activity got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_fusion_environment(self, fusion_environment_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_fusion_environment got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_fusion_environment_family(self, fusion_environment_family_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_fusion_environment_family got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_fusion_environment_family_limits_and_usage(self, fusion_environment_family_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_fusion_environment_family_limits_and_usage got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_fusion_environment_family_subscription_detail(self, fusion_environment_family_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_fusion_environment_family_subscription_detail got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_fusion_environment_status(self, fusion_environment_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_fusion_environment_status got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_refresh_activity(self, fusion_environment_id, refresh_activity_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_refresh_activity got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_scheduled_activity(self, fusion_environment_id, scheduled_activity_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_scheduled_activity got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_service_attachment(self, fusion_environment_id, service_attachment_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_service_attachment got unknown kwargs: {extra_kwargs!r}")
    ...
    def initiate_extract(self, fusion_environment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/fusionapps/initiate_extract.py.html>`__ to see an example of how to use initiate_extract API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fusionEnvironmentId']
    ...
    def list_admin_users(self, fusion_environment_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_admin_users got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_data_masking_activities(self, fusion_environment_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_data_masking_activities got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_fusion_environment_families(self, compartment_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_fusion_environment_families got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_fusion_environments(self, compartment_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_fusion_environments got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_refresh_activities(self, fusion_environment_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_refresh_activities got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_scheduled_activities(self, fusion_environment_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_scheduled_activities got unknown kwargs: {extra_kwargs!r}")
        ...
        if 'run_cycle' in kwargs:
            ...
            if kwargs['run_cycle'] not in run_cycle_allowed_values:
                raise ValueError(
                    f"Invalid value for `run_cycle`, must be one of { run_cycle_allowed_values }"
                )
        ...
        if 'scheduled_activity_phase' in kwargs:
            ...
            if kwargs['scheduled_activity_phase'] not in scheduled_activity_phase_allowed_values:
                raise ValueError(
                    f"Invalid value for `scheduled_activity_phase`, must be one of { scheduled_activity_phase_allowed_values }"
                )
    ...
    def list_service_attachments(self, fusion_environment_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_service_attachments got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_time_available_for_refreshes(self, fusion_environment_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_time_available_for_refreshes got unknown kwargs: {extra_kwargs!r}")
    ...
    def reset_fusion_environment_password(self, reset_fusion_environment_password_details, fusion_environment_id, admin_username, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"reset_fusion_environment_password got unknown kwargs: {extra_kwargs!r}")
    ...
    def update_fusion_environment(self, fusion_environment_id, update_fusion_environment_details, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_fusion_environment got unknown kwargs: {extra_kwargs!r}")
    ...
    def update_fusion_environment_family(self, fusion_environment_family_id, update_fusion_environment_family_details, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_fusion_environment_family got unknown kwargs: {extra_kwargs!r}")
    ...
    def update_refresh_activity(self, fusion_environment_id, refresh_activity_id, update_refresh_activity_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/fusionapps/update_refresh_activity.py.html>`__ to see an example of how to use update_refresh_activity API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fusionEnvironmentId', 'refreshActivityId']
        resource_path = "/fusionEnvironments/{fusionEnvironmentId}/refreshActivities/{refreshActivityId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_refresh_activity got unknown kwargs: {extra_kwargs!r}")
    ...
    def verify_service_attachment(self, verify_service_attachment_details, fusion_environment_id, **kwargs):
        """
        Verify whether a service instance can be attached to the fusion pod


        :param oci.fusion_apps.models.VerifyServiceAttachmentDetails verify_service_attachment_details: (required)
            Details for the service attachment.
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/fusionapps/verify_service_attachment.py.html>`__ to see an example of how to use verify_service_attachment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['fusionEnvironmentId']
        resource_path = "/fusionEnvironments/{fusionEnvironmentId}/serviceAttachments/actions/verify"
        method = "POST"
        operation_name = "verify_service_attachment"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/fusion-applications/20211201/ServiceAttachment/VerifyServiceAttachment"
        ...
        if extra_kwargs:
            raise ValueError(
                f"verify_service_attachment got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=verify_service_attachment_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
                required_arguments=required_arguments)
