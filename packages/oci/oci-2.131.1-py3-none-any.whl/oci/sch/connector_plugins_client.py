...
class ConnectorPluginsClient(object):
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("connector_plugins", config, signer, sch_type_mapping, **base_client_init_kwargs)
        self.retry_strategy = kwargs.get('retry_strategy')
        self.circuit_breaker_callback = kwargs.get('circuit_breaker_callback')

    def get_connector_plugin(self, connector_plugin_name, **kwargs):
        """
        Gets the specified connector plugin configuration information.


        :param str connector_plugin_name: (required)
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.sch.models.ConnectorPlugin`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/sch/get_connector_plugin.py.html>`__ to see an example of how to use get_connector_plugin API.
        """
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_connector_plugin got unknown kwargs: {extra_kwargs!r}")

        path_params = {
            "connectorPluginName": connector_plugin_name
        }
    ...
    def list_connector_plugins(self, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.sch.models.ConnectorPluginCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/sch/list_connector_plugins.py.html>`__ to see an example of how to use list_connector_plugins API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                header_params=header_params,
                response_type="ConnectorPluginCollection",
                allow_control_chars=kwargs.get('allow_control_chars'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
                required_arguments=required_arguments)
