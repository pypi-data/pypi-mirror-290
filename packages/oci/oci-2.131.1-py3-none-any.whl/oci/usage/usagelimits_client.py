...
class UsagelimitsClient(object):
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("usagelimits", config, signer, usage_type_mapping, **base_client_init_kwargs)
        self.retry_strategy = kwargs.get('retry_strategy')
        self.circuit_breaker_callback = kwargs.get('circuit_breaker_callback')

    def list_usage_limits(self, compartment_id, subscription_id, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/usage/list_usage_limits.py.html>`__ to see an example of how to use list_usage_limits API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId', 'subscriptionId']
        resource_path = "/usagelimits"
        method = "GET"
        operation_name = "list_usage_limits"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/usage-proxy/20190111/UsageLimitSummary/ListUsageLimits"
        ...
        query_params = {
            ...
            "limitType": kwargs.get("limit_type", missing),
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                response_type="UsageLimitCollection",
