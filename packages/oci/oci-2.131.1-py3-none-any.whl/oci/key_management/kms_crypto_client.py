...
class KmsCryptoClient(object):
    ...
    def decrypt(self, decrypt_data_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/keymanagement/decrypt.py.html>`__ to see an example of how to use decrypt API.
        """
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/key/release/DecryptedData/Decrypt"
    ...
    def encrypt(self, encrypt_data_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/keymanagement/encrypt.py.html>`__ to see an example of how to use encrypt API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/key/release/EncryptedData/Encrypt"
    ...
    def export_key(self, export_key_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/keymanagement/export_key.py.html>`__ to see an example of how to use export_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/key/release/ExportedKeyData/ExportKey"
    ...
    def generate_data_encryption_key(self, generate_key_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/keymanagement/generate_data_encryption_key.py.html>`__ to see an example of how to use generate_data_encryption_key API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/key/release/GeneratedKey/GenerateDataEncryptionKey"
    ...
    def sign(self, sign_data_details, **kwargs):
        ...
        also known as an asymmetric key. To verify the generated signature, you can use the `Verify`__
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/keymanagement/sign.py.html>`__ to see an example of how to use sign API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        method = "POST"
        operation_name = "sign"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/key/release/SignedData/Sign"
    ...
    def verify(self, verify_data_details, **kwargs):
        """
        Verifies a digital signature that was generated by the `Sign`__ operation
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/keymanagement/verify.py.html>`__ to see an example of how to use verify API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/key/release/VerifiedData/Verify"
