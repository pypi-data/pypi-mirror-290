...
class CommitmentClient(object):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("commitment", config, signer, onesubscription_type_mapping, **base_client_init_kwargs)
    ...
    def get_commitment(self, commitment_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.onesubscription.models.Commitment`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/onesubscription/get_commitment.py.html>`__ to see an example of how to use get_commitment API.
        """
    ...
    def list_commitments(self, subscribed_service_id, compartment_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type list of :class:`~oci.onesubscription.models.CommitmentSummary`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/onesubscription/list_commitments.py.html>`__ to see an example of how to use list_commitments API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
