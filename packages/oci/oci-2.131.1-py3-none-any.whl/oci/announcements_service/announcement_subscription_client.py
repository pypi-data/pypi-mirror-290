...
class AnnouncementSubscriptionClient(object):
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("announcement_subscription", config, signer, announcements_service_type_mapping, **base_client_init_kwargs)
        self.retry_strategy = kwargs.get('retry_strategy')
        self.circuit_breaker_callback = kwargs.get('circuit_breaker_callback')

    def change_announcement_subscription_compartment(self, announcement_subscription_id, change_announcement_subscription_compartment_details, **kwargs):
        """
        ...
        :param str announcement_subscription_id: (required)
            The OCID of the announcement subscription.

        :param oci.announcements_service.models.ChangeAnnouncementSubscriptionCompartmentDetails change_announcement_subscription_compartment_details: (required)
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/announcementsservice/change_announcement_subscription_compartment.py.html>`__ to see an example of how to use change_announcement_subscription_compartment API.
        """
        ...
        if extra_kwargs:
            raise ValueError(
                f"change_announcement_subscription_compartment got unknown kwargs: {extra_kwargs!r}")

        path_params = {
            "announcementSubscriptionId": announcement_subscription_id
        }
    ...
    def create_announcement_subscription(self, create_announcement_subscription_details, **kwargs):
        ...
        :param oci.announcements_service.models.CreateAnnouncementSubscriptionDetails create_announcement_subscription_details: (required)
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.announcements_service.models.AnnouncementSubscription`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/announcementsservice/create_announcement_subscription.py.html>`__ to see an example of how to use create_announcement_subscription API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_announcement_subscription got unknown kwargs: {extra_kwargs!r}")
    ...
    def create_filter_group(self, announcement_subscription_id, create_filter_group_details, **kwargs):
        ...
        :param oci.announcements_service.models.CreateFilterGroupDetails create_filter_group_details: (required)
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.announcements_service.models.FilterGroup`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/announcementsservice/create_filter_group.py.html>`__ to see an example of how to use create_filter_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['announcementSubscriptionId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_filter_group got unknown kwargs: {extra_kwargs!r}")
    ...
    def delete_announcement_subscription(self, announcement_subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/announcementsservice/delete_announcement_subscription.py.html>`__ to see an example of how to use delete_announcement_subscription API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['announcementSubscriptionId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"delete_announcement_subscription got unknown kwargs: {extra_kwargs!r}")
    ...
    def delete_filter_group(self, announcement_subscription_id, filter_group_name, **kwargs):
        ...
        :param str filter_group_name: (required)
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/announcementsservice/delete_filter_group.py.html>`__ to see an example of how to use delete_filter_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        if extra_kwargs:
            raise ValueError(
                f"delete_filter_group got unknown kwargs: {extra_kwargs!r}")

        path_params = {
            "announcementSubscriptionId": announcement_subscription_id,
            "filterGroupName": filter_group_name
        }
    ...
    def get_announcement_subscription(self, announcement_subscription_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/announcementsservice/get_announcement_subscription.py.html>`__ to see an example of how to use get_announcement_subscription API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['announcementSubscriptionId']
        resource_path = "/announcementSubscriptions/{announcementSubscriptionId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_announcement_subscription got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_announcement_subscriptions(self, compartment_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.announcements_service.models.AnnouncementSubscriptionCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/announcementsservice/list_announcement_subscriptions.py.html>`__ to see an example of how to use list_announcement_subscriptions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_announcement_subscriptions got unknown kwargs: {extra_kwargs!r}")
    ...
    def update_announcement_subscription(self, announcement_subscription_id, update_announcement_subscription_details, **kwargs):
        ...
        :param oci.announcements_service.models.UpdateAnnouncementSubscriptionDetails update_announcement_subscription_details: (required)
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/announcementsservice/update_announcement_subscription.py.html>`__ to see an example of how to use update_announcement_subscription API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['announcementSubscriptionId']
        resource_path = "/announcementSubscriptions/{announcementSubscriptionId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_announcement_subscription got unknown kwargs: {extra_kwargs!r}")
    ...
    def update_filter_group(self, announcement_subscription_id, filter_group_name, update_filter_group_details, **kwargs):
        ...
        :param oci.announcements_service.models.UpdateFilterGroupDetails update_filter_group_details: (required)
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/announcementsservice/update_filter_group.py.html>`__ to see an example of how to use update_filter_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['announcementSubscriptionId', 'filterGroupName']
        resource_path = "/announcementSubscriptions/{announcementSubscriptionId}/filterGroups/{filterGroupName}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_filter_group got unknown kwargs: {extra_kwargs!r}")
