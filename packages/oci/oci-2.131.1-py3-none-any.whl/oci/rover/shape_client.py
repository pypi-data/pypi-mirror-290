...
class ShapeClient(object):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("shape", config, signer, rover_type_mapping, **base_client_init_kwargs)
    ...
    def list_shapes(self, compartment_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.rover.models.ShapeCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/rover/list_shapes.py.html>`__ to see an example of how to use list_shapes API.
        """
