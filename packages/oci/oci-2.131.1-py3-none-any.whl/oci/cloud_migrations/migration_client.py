...
class MigrationClient(object):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("migration", config, signer, cloud_migrations_type_mapping, **base_client_init_kwargs)
    ...
    def cancel_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/cancel_work_request.py.html>`__ to see an example of how to use cancel_work_request API.
        """
    ...
    def change_migration_compartment(self, migration_id, change_migration_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/change_migration_compartment.py.html>`__ to see an example of how to use change_migration_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_migration_plan_compartment(self, migration_plan_id, change_migration_plan_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/change_migration_plan_compartment.py.html>`__ to see an example of how to use change_migration_plan_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        if extra_kwargs:
            raise ValueError(
                f"change_migration_plan_compartment got unknown kwargs: {extra_kwargs!r}")
    ...
    def change_replication_schedule_compartment(self, replication_schedule_id, change_replication_schedule_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/change_replication_schedule_compartment.py.html>`__ to see an example of how to use change_replication_schedule_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        if extra_kwargs:
            raise ValueError(
                f"change_replication_schedule_compartment got unknown kwargs: {extra_kwargs!r}")

        path_params = {
            "replicationScheduleId": replication_schedule_id
        }
    ...
    def create_migration(self, create_migration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/create_migration.py.html>`__ to see an example of how to use create_migration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_migration_asset(self, create_migration_asset_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/create_migration_asset.py.html>`__ to see an example of how to use create_migration_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_migration_asset got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                method=method,
                header_params=header_params,
                body=create_migration_asset_details,
    ...
    def create_migration_plan(self, create_migration_plan_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/create_migration_plan.py.html>`__ to see an example of how to use create_migration_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_migration_plan got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                method=method,
                header_params=header_params,
                body=create_migration_plan_details,
    ...
    def create_replication_schedule(self, create_replication_schedule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/create_replication_schedule.py.html>`__ to see an example of how to use create_replication_schedule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_replication_schedule got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                method=method,
                header_params=header_params,
                body=create_replication_schedule_details,
    ...
    def create_target_asset(self, create_target_asset_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/create_target_asset.py.html>`__ to see an example of how to use create_target_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_target_asset got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                method=method,
                header_params=header_params,
                body=create_target_asset_details,
    ...
    def delete_migration(self, migration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/delete_migration.py.html>`__ to see an example of how to use delete_migration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationId']
    ...
    def delete_migration_asset(self, migration_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/delete_migration_asset.py.html>`__ to see an example of how to use delete_migration_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        if extra_kwargs:
            raise ValueError(
                f"delete_migration_asset got unknown kwargs: {extra_kwargs!r}")

        path_params = {
            "migrationAssetId": migration_asset_id
        }
    ...
    def delete_migration_plan(self, migration_plan_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/delete_migration_plan.py.html>`__ to see an example of how to use delete_migration_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationPlanId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"delete_migration_plan got unknown kwargs: {extra_kwargs!r}")
    ...
    def delete_replication_schedule(self, replication_schedule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/delete_replication_schedule.py.html>`__ to see an example of how to use delete_replication_schedule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['replicationScheduleId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"delete_replication_schedule got unknown kwargs: {extra_kwargs!r}")
    ...
    def delete_target_asset(self, target_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/delete_target_asset.py.html>`__ to see an example of how to use delete_target_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        if extra_kwargs:
            raise ValueError(
                f"delete_target_asset got unknown kwargs: {extra_kwargs!r}")
    ...
    def execute_migration_plan(self, migration_plan_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/execute_migration_plan.py.html>`__ to see an example of how to use execute_migration_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationPlanId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"execute_migration_plan got unknown kwargs: {extra_kwargs!r}")
    ...
    def export_migration_plan(self, migration_plan_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/export_migration_plan.py.html>`__ to see an example of how to use export_migration_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationPlanId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"export_migration_plan got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_migration(self, migration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/get_migration.py.html>`__ to see an example of how to use get_migration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationId']
        resource_path = "/migrations/{migrationId}"
    ...
    def get_migration_asset(self, migration_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/get_migration_asset.py.html>`__ to see an example of how to use get_migration_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationAssetId']
        resource_path = "/migrationAssets/{migrationAssetId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_migration_asset got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_migration_plan(self, migration_plan_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/get_migration_plan.py.html>`__ to see an example of how to use get_migration_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationPlanId']
        resource_path = "/migrationPlans/{migrationPlanId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_migration_plan got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_replication_progress(self, migration_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/get_replication_progress.py.html>`__ to see an example of how to use get_replication_progress API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationAssetId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_replication_progress got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_replication_schedule(self, replication_schedule_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/get_replication_schedule.py.html>`__ to see an example of how to use get_replication_schedule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['replicationScheduleId']
        resource_path = "/replicationSchedules/{replicationScheduleId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_replication_schedule got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_target_asset(self, target_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/get_target_asset.py.html>`__ to see an example of how to use get_target_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['targetAssetId']
        resource_path = "/targetAssets/{targetAssetId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_target_asset got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
        resource_path = "/workRequests/{workRequestId}"
    ...
    def import_migration_plan(self, migration_plan_id, import_migration_plan_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/import_migration_plan.py.html>`__ to see an example of how to use import_migration_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationPlanId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"import_migration_plan got unknown kwargs: {extra_kwargs!r}")
        ...
        try:
            ...
            import_migration_plan_details = kwargs.get("import_migration_plan_details", missing)

        if import_migration_plan_details is not missing and import_migration_plan_details is not None:
            if (not isinstance(import_migration_plan_details, (six.binary_type, six.string_types)) and
                    not hasattr(import_migration_plan_details, "read")):
                raise TypeError('The body must be a string, bytes, or provide a read() method.')

            if hasattr(import_migration_plan_details, 'fileno') and hasattr(import_migration_plan_details, 'name') and import_migration_plan_details.name != '<stdin>':
                if requests.utils.super_len(import_migration_plan_details) == 0:
            ...
            elif 'Content-Length' not in header_params and not is_content_length_calculable_by_req_util(import_migration_plan_details):
                calculated_obj = back_up_body_calculate_stream_content_length(import_migration_plan_details, kwargs.get("buffer_limit"))
                header_params['Content-Length'] = calculated_obj["content_length"]
                import_migration_plan_details = calculated_obj["byte_content"]
    ...
    def list_available_shapes(self, migration_plan_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/list_available_shapes.py.html>`__ to see an example of how to use list_available_shapes API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationPlanId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_available_shapes got unknown kwargs: {extra_kwargs!r}")
        ...
        query_params = {
            ...
            "dvhHostId": kwargs.get("dvh_host_id", missing),
            "availabilityDomain": kwargs.get("availability_domain", missing),
            "reservedCapacityId": kwargs.get("reserved_capacity_id", missing),
    ...
    def list_migration_assets(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/list_migration_assets.py.html>`__ to see an example of how to use list_migration_assets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/migrationAssets"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_migration_assets got unknown kwargs: {extra_kwargs!r}")

        if 'lifecycle_state' in kwargs:
            lifecycle_state_allowed_values = ["CREATING", "UPDATING", "NEEDS_ATTENTION", "ACTIVE", "DELETING", "DELETED", "FAILED"]
        ...
        query_params = {
            "migrationId": kwargs.get("migration_id", missing),
            "displayName": kwargs.get("display_name", missing),
            "migrationAssetId": kwargs.get("migration_asset_id", missing),
            "limit": kwargs.get("limit", missing),
            "page": kwargs.get("page", missing),
    ...
    def list_migration_plans(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/list_migration_plans.py.html>`__ to see an example of how to use list_migration_plans API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/migrationPlans"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_migration_plans got unknown kwargs: {extra_kwargs!r}")
        ...
        query_params = {
            ...
            "migrationId": kwargs.get("migration_id", missing),
            "displayName": kwargs.get("display_name", missing),
            "migrationPlanId": kwargs.get("migration_plan_id", missing),
            "limit": kwargs.get("limit", missing),
            "page": kwargs.get("page", missing),
            "lifecycleState": kwargs.get("lifecycle_state", missing),
            "sortOrder": kwargs.get("sort_order", missing),
    ...
    def list_migrations(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/list_migrations.py.html>`__ to see an example of how to use list_migrations API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/migrations"
    ...
    def list_replication_schedules(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/list_replication_schedules.py.html>`__ to see an example of how to use list_replication_schedules API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/replicationSchedules"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_replication_schedules got unknown kwargs: {extra_kwargs!r}")
        ...
        query_params = {
            ...
            "lifecycleState": kwargs.get("lifecycle_state", missing),
            "displayName": kwargs.get("display_name", missing),
            "replicationScheduleId": kwargs.get("replication_schedule_id", missing),
            "limit": kwargs.get("limit", missing),
            "page": kwargs.get("page", missing),
            "sortOrder": kwargs.get("sort_order", missing),
            "sortBy": kwargs.get("sort_by", missing)
    ...
    def list_target_assets(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/list_target_assets.py.html>`__ to see an example of how to use list_target_assets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/targetAssets"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_target_assets got unknown kwargs: {extra_kwargs!r}")
        ...
        query_params = {
            "migrationPlanId": kwargs.get("migration_plan_id", missing),
            "displayName": kwargs.get("display_name", missing),
            "targetAssetId": kwargs.get("target_asset_id", missing),
            "limit": kwargs.get("limit", missing),
            "page": kwargs.get("page", missing),
            "lifecycleState": kwargs.get("lifecycle_state", missing),
            "sortOrder": kwargs.get("sort_order", missing),
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_requests(self, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        if 'operation_type' in kwargs:
            operation_type_allowed_values = ["CREATE_MIGRATION", "UPDATE_MIGRATION", "REFRESH_MIGRATION", "DELETE_MIGRATION", "MOVE_MIGRATION", "START_ASSET_REPLICATION", "START_MIGRATION_REPLICATION", "CREATE_REPLICATION_SCHEDULE", "UPDATE_REPLICATION_SCHEDULE", "DELETE_REPLICATION_SCHEDULE", "MOVE_REPLICATION_SCHEDULE", "CREATE_MIGRATION_PLAN", "UPDATE_MIGRATION_PLAN", "DELETE_MIGRATION_PLAN", "MOVE_MIGRATION_PLAN", "REFRESH_MIGRATION_PLAN", "EXECUTE_MIGRATION_PLAN", "REFRESH_MIGRATION_ASSET", "CREATE_MIGRATION_ASSET", "DELETE_MIGRATION_ASSET", "CREATE_TARGET_ASSET", "UPDATE_TARGET_ASSET", "DELETE_TARGET_ASSET"]
    ...
    def refresh_migration(self, migration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/refresh_migration.py.html>`__ to see an example of how to use refresh_migration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"refresh_migration got unknown kwargs: {extra_kwargs!r}")
    ...
    def refresh_migration_asset(self, migration_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/refresh_migration_asset.py.html>`__ to see an example of how to use refresh_migration_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationAssetId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"refresh_migration_asset got unknown kwargs: {extra_kwargs!r}")
    ...
    def refresh_migration_plan(self, migration_plan_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/refresh_migration_plan.py.html>`__ to see an example of how to use refresh_migration_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationPlanId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"refresh_migration_plan got unknown kwargs: {extra_kwargs!r}")
    ...
    def start_asset_replication(self, migration_asset_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/start_asset_replication.py.html>`__ to see an example of how to use start_asset_replication API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationAssetId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"start_asset_replication got unknown kwargs: {extra_kwargs!r}")
    ...
    def start_migration_replication(self, migration_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/start_migration_replication.py.html>`__ to see an example of how to use start_migration_replication API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"start_migration_replication got unknown kwargs: {extra_kwargs!r}")
    ...
    def update_migration(self, migration_id, update_migration_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/update_migration.py.html>`__ to see an example of how to use update_migration API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationId']
        resource_path = "/migrations/{migrationId}"
    ...
    def update_migration_asset(self, migration_asset_id, update_migration_asset_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/update_migration_asset.py.html>`__ to see an example of how to use update_migration_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationAssetId']
        resource_path = "/migrationAssets/{migrationAssetId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_migration_asset got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=update_migration_asset_details,
                response_type="MigrationAsset",
                allow_control_chars=kwargs.get('allow_control_chars'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def update_migration_plan(self, migration_plan_id, update_migration_plan_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/update_migration_plan.py.html>`__ to see an example of how to use update_migration_plan API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['migrationPlanId']
        resource_path = "/migrationPlans/{migrationPlanId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_migration_plan got unknown kwargs: {extra_kwargs!r}")
    ...
    def update_replication_schedule(self, replication_schedule_id, update_replication_schedule_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/update_replication_schedule.py.html>`__ to see an example of how to use update_replication_schedule API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['replicationScheduleId']
        resource_path = "/replicationSchedules/{replicationScheduleId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_replication_schedule got unknown kwargs: {extra_kwargs!r}")
    ...
    def update_target_asset(self, target_asset_id, update_target_asset_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/cloudmigrations/update_target_asset.py.html>`__ to see an example of how to use update_target_asset API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['targetAssetId']
        resource_path = "/targetAssets/{targetAssetId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_target_asset got unknown kwargs: {extra_kwargs!r}")
