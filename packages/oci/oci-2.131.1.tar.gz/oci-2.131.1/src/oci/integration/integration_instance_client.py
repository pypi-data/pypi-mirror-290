...
class IntegrationInstanceClient(object):
    ...
    def change_integration_instance_compartment(self, integration_instance_id, change_integration_instance_compartment_details, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"change_integration_instance_compartment got unknown kwargs: {extra_kwargs!r}")
    ...
    def change_integration_instance_network_endpoint(self, integration_instance_id, change_integration_instance_network_endpoint_details, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"change_integration_instance_network_endpoint got unknown kwargs: {extra_kwargs!r}")
    ...
    def change_private_endpoint_outbound_connection(self, integration_instance_id, change_private_endpoint_outbound_connection_details, **kwargs):
        """
        ...
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['integrationInstanceId']
        resource_path = "/integrationInstances/{integrationInstanceId}/actions/changePrivateEndpointOutboundConnection"
        method = "POST"
        operation_name = "change_private_endpoint_outbound_connection"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/integration/20190131/IntegrationInstance/ChangePrivateEndpointOutboundConnection"
        ...
        if extra_kwargs:
            raise ValueError(
                f"change_private_endpoint_outbound_connection got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=change_private_endpoint_outbound_connection_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
                required_arguments=required_arguments)
    ...
    def create_integration_instance(self, create_integration_instance_details, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_integration_instance got unknown kwargs: {extra_kwargs!r}")
    ...
    def delete_integration_instance(self, integration_instance_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"delete_integration_instance got unknown kwargs: {extra_kwargs!r}")
    ...
    def enable_process_automation(self, integration_instance_id, **kwargs):
        """
        ...
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['integrationInstanceId']
        resource_path = "/integrationInstances/{integrationInstanceId}/actions/enableProcessAutomation"
        method = "POST"
        operation_name = "enable_process_automation"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/integration/20190131/IntegrationInstance/EnableProcessAutomation"
        ...
        if extra_kwargs:
            raise ValueError(
                f"enable_process_automation got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_integration_instance(self, integration_instance_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_integration_instance got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_integration_instances(self, compartment_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_integration_instances got unknown kwargs: {extra_kwargs!r}")
    ...
    def start_integration_instance(self, integration_instance_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"start_integration_instance got unknown kwargs: {extra_kwargs!r}")
    ...
    def stop_integration_instance(self, integration_instance_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"stop_integration_instance got unknown kwargs: {extra_kwargs!r}")
    ...
    def update_integration_instance(self, integration_instance_id, update_integration_instance_details, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_integration_instance got unknown kwargs: {extra_kwargs!r}")
