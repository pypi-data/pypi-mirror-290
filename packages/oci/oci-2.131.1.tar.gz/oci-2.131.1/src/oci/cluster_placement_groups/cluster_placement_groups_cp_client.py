...
from .models import cluster_placement_groups_type_mapping
missing = Sentinel("Missing")


class ClusterPlacementGroupsCPClient(object):
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        """
        if not OCI_SDK_ENABLED_SERVICES_SET.is_service_enabled("cluster_placement_groups"):
        ...
        base_client_init_kwargs = {
            ...
            'base_path': '/20230801',
            'service_endpoint_template': 'https://clusterPlacementGroups.{region}.oci.{secondLevelDomain}',
        ...
        self.base_client = BaseClient("cluster_placement_groups_cp", config, signer, cluster_placement_groups_type_mapping, **base_client_init_kwargs)
        self.retry_strategy = kwargs.get('retry_strategy')
        self.circuit_breaker_callback = kwargs.get('circuit_breaker_callback')

    def activate_cluster_placement_group(self, cluster_placement_group_id, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.cluster_placement_groups.models.ClusterPlacementGroup`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/clusterplacementgroups/activate_cluster_placement_group.py.html>`__ to see an example of how to use activate_cluster_placement_group API.
        """
        ...
        if extra_kwargs:
            raise ValueError(
                f"activate_cluster_placement_group got unknown kwargs: {extra_kwargs!r}")

        path_params = {
            "clusterPlacementGroupId": cluster_placement_group_id
        }
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                response_type="ClusterPlacementGroup",
    ...
    def cancel_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/clusterplacementgroups/cancel_work_request.py.html>`__ to see an example of how to use cancel_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_cluster_placement_group_compartment(self, cluster_placement_group_id, change_cluster_placement_group_compartment_details, **kwargs):
        """
        ...
        :param oci.cluster_placement_groups.models.ChangeClusterPlacementGroupCompartmentDetails change_cluster_placement_group_compartment_details: (required)
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/clusterplacementgroups/change_cluster_placement_group_compartment.py.html>`__ to see an example of how to use change_cluster_placement_group_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterPlacementGroupId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"change_cluster_placement_group_compartment got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=change_cluster_placement_group_compartment_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
                required_arguments=required_arguments)
    ...
    def create_cluster_placement_group(self, create_cluster_placement_group_details, **kwargs):
        """
        Creates a new cluster placement group in the specified compartment.


        :param oci.cluster_placement_groups.models.CreateClusterPlacementGroupDetails create_cluster_placement_group_details: (required)
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/clusterplacementgroups/create_cluster_placement_group.py.html>`__ to see an example of how to use create_cluster_placement_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_cluster_placement_group got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                method=method,
                header_params=header_params,
                body=create_cluster_placement_group_details,
                response_type="ClusterPlacementGroup",
                allow_control_chars=kwargs.get('allow_control_chars'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
    ...
    def deactivate_cluster_placement_group(self, cluster_placement_group_id, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/clusterplacementgroups/deactivate_cluster_placement_group.py.html>`__ to see an example of how to use deactivate_cluster_placement_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterPlacementGroupId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"deactivate_cluster_placement_group got unknown kwargs: {extra_kwargs!r}")
    ...
    def delete_cluster_placement_group(self, cluster_placement_group_id, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/clusterplacementgroups/delete_cluster_placement_group.py.html>`__ to see an example of how to use delete_cluster_placement_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterPlacementGroupId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"delete_cluster_placement_group got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_cluster_placement_group(self, cluster_placement_group_id, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/clusterplacementgroups/get_cluster_placement_group.py.html>`__ to see an example of how to use get_cluster_placement_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterPlacementGroupId']
        resource_path = "/clusterPlacementGroups/{clusterPlacementGroupId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_cluster_placement_group got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.cluster_placement_groups.models.WorkRequest`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/clusterplacementgroups/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
        resource_path = "/workRequests/{workRequestId}"
    ...
    def list_cluster_placement_groups(self, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.cluster_placement_groups.models.ClusterPlacementGroupCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/clusterplacementgroups/list_cluster_placement_groups.py.html>`__ to see an example of how to use list_cluster_placement_groups API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/clusterPlacementGroups"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_cluster_placement_groups got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                header_params=header_params,
                response_type="ClusterPlacementGroupCollection",
                allow_control_chars=kwargs.get('allow_control_chars'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
                required_arguments=required_arguments)
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.cluster_placement_groups.models.WorkRequestErrorCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/clusterplacementgroups/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.cluster_placement_groups.models.WorkRequestLogEntryCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/clusterplacementgroups/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_requests(self, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.cluster_placement_groups.models.WorkRequestSummaryCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/clusterplacementgroups/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def update_cluster_placement_group(self, cluster_placement_group_id, update_cluster_placement_group_details, **kwargs):
        """
        ...
        :param oci.cluster_placement_groups.models.UpdateClusterPlacementGroupDetails update_cluster_placement_group_details: (required)
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/clusterplacementgroups/update_cluster_placement_group.py.html>`__ to see an example of how to use update_cluster_placement_group API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['clusterPlacementGroupId']
        resource_path = "/clusterPlacementGroups/{clusterPlacementGroupId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_cluster_placement_group got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=update_cluster_placement_group_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
                required_arguments=required_arguments)
