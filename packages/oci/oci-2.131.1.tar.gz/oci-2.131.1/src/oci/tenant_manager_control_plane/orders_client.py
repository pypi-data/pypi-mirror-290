...
class OrdersClient(object):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("orders", config, signer, tenant_manager_control_plane_type_mapping, **base_client_init_kwargs)
    ...
    def activate_order(self, activate_order_details, activation_token, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/tenantmanagercontrolplane/activate_order.py.html>`__ to see an example of how to use activate_order API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['activationToken']
        resource_path = "/orders/{activationToken}/actions/activate"
        method = "POST"
        operation_name = "activate_order"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/organizations/20230401/Order/ActivateOrder"
        ...
        if extra_kwargs:
            raise ValueError(
                f"activate_order got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_order(self, activation_token, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/tenantmanagercontrolplane/get_order.py.html>`__ to see an example of how to use get_order API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['activationToken']
        ...
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/organizations/20230401/Order/GetOrder"
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_order got unknown kwargs: {extra_kwargs!r}")
