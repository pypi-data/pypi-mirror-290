...
class OperatorActionsClient(object):
    """
    ...
    def get_operator_action(self, operator_action_id, **kwargs):
        """
        Gets the operator action associated with the specified operator action ID.


        :param str operator_action_id: (required)
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.operator_access_control.models.OperatorAction`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/operatoraccesscontrol/get_operator_action.py.html>`__ to see an example of how to use get_operator_action API.
        """
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_operator_action got unknown kwargs: {extra_kwargs!r}")

        path_params = {
            "operatorActionId": operator_action_id
        }
    ...
    def list_operator_actions(self, compartment_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.operator_access_control.models.OperatorActionCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/operatoraccesscontrol/list_operator_actions.py.html>`__ to see an example of how to use list_operator_actions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_operator_actions got unknown kwargs: {extra_kwargs!r}")
