...
class SubscribedServiceClient(object):
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("subscribed_service", config, signer, onesubscription_type_mapping, **base_client_init_kwargs)
    ...
    def get_subscribed_service(self, subscribed_service_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/onesubscription/get_subscribed_service.py.html>`__ to see an example of how to use get_subscribed_service API.
        """
    ...
    def list_subscribed_services(self, compartment_id, subscription_id, **kwargs):
        """
        ...
        :param int order_line_id: (optional)
        ...
        :return: A :class:`~oci.response.Response` object with data of type list of :class:`~oci.onesubscription.models.SubscribedServiceSummary`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/onesubscription/list_subscribed_services.py.html>`__ to see an example of how to use list_subscribed_services API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId', 'subscriptionId']
        resource_path = "/subscribedServices"
        method = "GET"
        operation_name = "list_subscribed_services"
        api_reference_link = ""
        ...
        query_params = {
            ...
            "orderLineId": kwargs.get("order_line_id", missing),
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                query_params=query_params,
                header_params=header_params,
                response_type="list[SubscribedServiceSummary]",
                allow_control_chars=kwargs.get('allow_control_chars'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
                required_arguments=required_arguments)
