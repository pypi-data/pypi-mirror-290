...
class RatecardClient(object):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("ratecard", config, signer, onesubscription_type_mapping, **base_client_init_kwargs)
    ...
    def list_rate_cards(self, subscription_id, compartment_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type list of :class:`~oci.onesubscription.models.RateCardSummary`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/onesubscription/list_rate_cards.py.html>`__ to see an example of how to use list_rate_cards API.
        """
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_rate_cards got unknown kwargs: {extra_kwargs!r}")
