...
class SubscriptionClient(object):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("subscription", config, signer, onesubscription_type_mapping, **base_client_init_kwargs)
    ...
    def list_subscriptions(self, compartment_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type list of :class:`~oci.onesubscription.models.SubscriptionSummary`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/onesubscription/list_subscriptions.py.html>`__ to see an example of how to use list_subscriptions API.
        """
