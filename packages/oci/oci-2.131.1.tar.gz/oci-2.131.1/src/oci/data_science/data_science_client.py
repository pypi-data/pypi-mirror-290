...
class DataScienceClient(object):
    ...
    def activate_model(self, model_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/activate_model.py.html>`__ to see an example of how to use activate_model API.
        """
        ...
        if extra_kwargs:
            raise ValueError(
                f"activate_model got unknown kwargs: {extra_kwargs!r}")
    ...
    def activate_model_deployment(self, model_deployment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/activate_model_deployment.py.html>`__ to see an example of how to use activate_model_deployment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        if extra_kwargs:
            raise ValueError(
                f"activate_model_deployment got unknown kwargs: {extra_kwargs!r}")
    ...
    def activate_notebook_session(self, notebook_session_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/activate_notebook_session.py.html>`__ to see an example of how to use activate_notebook_session API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        if extra_kwargs:
            raise ValueError(
                f"activate_notebook_session got unknown kwargs: {extra_kwargs!r}")
    ...
    def cancel_job_run(self, job_run_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/cancel_job_run.py.html>`__ to see an example of how to use cancel_job_run API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        if extra_kwargs:
            raise ValueError(
                f"cancel_job_run got unknown kwargs: {extra_kwargs!r}")
    ...
    def cancel_pipeline_run(self, pipeline_run_id, **kwargs):
        ...
        :param bool terminate_gracefully: (optional)
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/cancel_pipeline_run.py.html>`__ to see an example of how to use cancel_pipeline_run API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        if extra_kwargs:
            raise ValueError(
                f"cancel_pipeline_run got unknown kwargs: {extra_kwargs!r}")
        ...
        query_params = {
            "terminateGracefully": kwargs.get("terminate_gracefully", missing)
        }
    ...
    def cancel_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/cancel_work_request.py.html>`__ to see an example of how to use cancel_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_data_science_private_endpoint_compartment(self, data_science_private_endpoint_id, change_data_science_private_endpoint_compartment_details, **kwargs):
        """
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/change_data_science_private_endpoint_compartment.py.html>`__ to see an example of how to use change_data_science_private_endpoint_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['dataSciencePrivateEndpointId']
        resource_path = "/dataSciencePrivateEndpoints/{dataSciencePrivateEndpointId}/actions/changeCompartment"
        method = "POST"
        operation_name = "change_data_science_private_endpoint_compartment"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/data-science/20190101/DataSciencePrivateEndpoint/ChangeDataSciencePrivateEndpointCompartment"
        ...
        if extra_kwargs:
            raise ValueError(
                f"change_data_science_private_endpoint_compartment got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                path_params=path_params,
                header_params=header_params,
                body=change_data_science_private_endpoint_compartment_details,
                allow_control_chars=kwargs.get('allow_control_chars'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
                required_arguments=required_arguments)
    ...
    def change_job_compartment(self, job_id, change_job_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/change_job_compartment.py.html>`__ to see an example of how to use change_job_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_job_run_compartment(self, job_run_id, change_job_run_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/change_job_run_compartment.py.html>`__ to see an example of how to use change_job_run_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['jobRunId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"change_job_run_compartment got unknown kwargs: {extra_kwargs!r}")
    ...
    def change_model_compartment(self, model_id, change_model_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/change_model_compartment.py.html>`__ to see an example of how to use change_model_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelId']
    ...
    def change_model_deployment_compartment(self, model_deployment_id, change_model_deployment_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/change_model_deployment_compartment.py.html>`__ to see an example of how to use change_model_deployment_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelDeploymentId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"change_model_deployment_compartment got unknown kwargs: {extra_kwargs!r}")
    ...
    def change_model_version_set_compartment(self, model_version_set_id, change_model_version_set_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/change_model_version_set_compartment.py.html>`__ to see an example of how to use change_model_version_set_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_notebook_session_compartment(self, notebook_session_id, change_notebook_session_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/change_notebook_session_compartment.py.html>`__ to see an example of how to use change_notebook_session_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['notebookSessionId']
    ...
    def change_pipeline_compartment(self, pipeline_id, change_pipeline_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/change_pipeline_compartment.py.html>`__ to see an example of how to use change_pipeline_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def change_pipeline_run_compartment(self, pipeline_run_id, change_pipeline_run_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/change_pipeline_run_compartment.py.html>`__ to see an example of how to use change_pipeline_run_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['pipelineRunId']
    ...
    def change_project_compartment(self, project_id, change_project_compartment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/change_project_compartment.py.html>`__ to see an example of how to use change_project_compartment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def create_data_science_private_endpoint(self, create_data_science_private_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/create_data_science_private_endpoint.py.html>`__ to see an example of how to use create_data_science_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/dataSciencePrivateEndpoints"
        method = "POST"
        operation_name = "create_data_science_private_endpoint"
        api_reference_link = ""
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_data_science_private_endpoint got unknown kwargs: {extra_kwargs!r}")
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                method=method,
                header_params=header_params,
                body=create_data_science_private_endpoint_details,
    ...
    def create_job(self, create_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/create_job.py.html>`__ to see an example of how to use create_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        resource_path = "/jobs"
    ...
    def create_job_artifact(self, job_id, job_artifact, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/create_job_artifact.py.html>`__ to see an example of how to use create_job_artifact API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['jobId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_job_artifact got unknown kwargs: {extra_kwargs!r}")
    ...
    def create_job_run(self, create_job_run_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/create_job_run.py.html>`__ to see an example of how to use create_job_run API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_job_run got unknown kwargs: {extra_kwargs!r}")
    ...
    def create_model(self, create_model_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/create_model.py.html>`__ to see an example of how to use create_model API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_model_artifact(self, model_id, model_artifact, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/create_model_artifact.py.html>`__ to see an example of how to use create_model_artifact API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_model_artifact got unknown kwargs: {extra_kwargs!r}")
    ...
    def create_model_deployment(self, create_model_deployment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/create_model_deployment.py.html>`__ to see an example of how to use create_model_deployment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_model_provenance(self, model_id, create_model_provenance_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/create_model_provenance.py.html>`__ to see an example of how to use create_model_provenance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelId']
    ...
    def create_model_version_set(self, create_model_version_set_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/create_model_version_set.py.html>`__ to see an example of how to use create_model_version_set API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_notebook_session(self, create_notebook_session_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/create_notebook_session.py.html>`__ to see an example of how to use create_notebook_session API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_pipeline(self, create_pipeline_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/create_pipeline.py.html>`__ to see an example of how to use create_pipeline API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_pipeline_run(self, create_pipeline_run_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/create_pipeline_run.py.html>`__ to see an example of how to use create_pipeline_run API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_project(self, create_project_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/create_project.py.html>`__ to see an example of how to use create_project API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = []
    ...
    def create_step_artifact(self, pipeline_id, step_name, step_artifact, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/create_step_artifact.py.html>`__ to see an example of how to use create_step_artifact API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
    ...
    def deactivate_model(self, model_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/deactivate_model.py.html>`__ to see an example of how to use deactivate_model API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelId']
    ...
    def deactivate_model_deployment(self, model_deployment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/deactivate_model_deployment.py.html>`__ to see an example of how to use deactivate_model_deployment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelDeploymentId']
    ...
    def deactivate_notebook_session(self, notebook_session_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/deactivate_notebook_session.py.html>`__ to see an example of how to use deactivate_notebook_session API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['notebookSessionId']
    ...
    def delete_data_science_private_endpoint(self, data_science_private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/delete_data_science_private_endpoint.py.html>`__ to see an example of how to use delete_data_science_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['dataSciencePrivateEndpointId']
    ...
    def delete_job(self, job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/delete_job.py.html>`__ to see an example of how to use delete_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['jobId']
    ...
    def delete_job_run(self, job_run_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/delete_job_run.py.html>`__ to see an example of how to use delete_job_run API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['jobRunId']
    ...
    def delete_model(self, model_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/delete_model.py.html>`__ to see an example of how to use delete_model API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelId']
    ...
    def delete_model_deployment(self, model_deployment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/delete_model_deployment.py.html>`__ to see an example of how to use delete_model_deployment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelDeploymentId']
    ...
    def delete_model_version_set(self, model_version_set_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/delete_model_version_set.py.html>`__ to see an example of how to use delete_model_version_set API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelVersionSetId']
    ...
    def delete_notebook_session(self, notebook_session_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/delete_notebook_session.py.html>`__ to see an example of how to use delete_notebook_session API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['notebookSessionId']
    ...
    def delete_pipeline(self, pipeline_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/delete_pipeline.py.html>`__ to see an example of how to use delete_pipeline API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['pipelineId']
    ...
    def delete_pipeline_run(self, pipeline_run_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/delete_pipeline_run.py.html>`__ to see an example of how to use delete_pipeline_run API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['pipelineRunId']
    ...
    def delete_project(self, project_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/delete_project.py.html>`__ to see an example of how to use delete_project API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['projectId']
    ...
    def export_model_artifact(self, model_id, export_model_artifact_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/export_model_artifact.py.html>`__ to see an example of how to use export_model_artifact API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelId']
    ...
    def get_data_science_private_endpoint(self, data_science_private_endpoint_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/get_data_science_private_endpoint.py.html>`__ to see an example of how to use get_data_science_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['dataSciencePrivateEndpointId']
        resource_path = "/dataSciencePrivateEndpoints/{dataSciencePrivateEndpointId}"
    ...
    def get_job(self, job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/get_job.py.html>`__ to see an example of how to use get_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['jobId']
        resource_path = "/jobs/{jobId}"
    ...
    def get_job_artifact_content(self, job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/get_job_artifact_content.py.html>`__ to see an example of how to use get_job_artifact_content API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['jobId']
    ...
    def get_job_run(self, job_run_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/get_job_run.py.html>`__ to see an example of how to use get_job_run API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['jobRunId']
        resource_path = "/jobRuns/{jobRunId}"
    ...
    def get_model(self, model_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/get_model.py.html>`__ to see an example of how to use get_model API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelId']
        resource_path = "/models/{modelId}"
    ...
    def get_model_artifact_content(self, model_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/get_model_artifact_content.py.html>`__ to see an example of how to use get_model_artifact_content API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelId']
    ...
    def get_model_deployment(self, model_deployment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/get_model_deployment.py.html>`__ to see an example of how to use get_model_deployment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelDeploymentId']
        resource_path = "/modelDeployments/{modelDeploymentId}"
    ...
    def get_model_provenance(self, model_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/get_model_provenance.py.html>`__ to see an example of how to use get_model_provenance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelId']
        resource_path = "/models/{modelId}/provenance"
    ...
    def get_model_version_set(self, model_version_set_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/get_model_version_set.py.html>`__ to see an example of how to use get_model_version_set API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelVersionSetId']
        resource_path = "/modelVersionSets/{modelVersionSetId}"
    ...
    def get_notebook_session(self, notebook_session_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/get_notebook_session.py.html>`__ to see an example of how to use get_notebook_session API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['notebookSessionId']
        resource_path = "/notebookSessions/{notebookSessionId}"
    ...
    def get_pipeline(self, pipeline_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/get_pipeline.py.html>`__ to see an example of how to use get_pipeline API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['pipelineId']
        resource_path = "/pipelines/{pipelineId}"
    ...
    def get_pipeline_run(self, pipeline_run_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/get_pipeline_run.py.html>`__ to see an example of how to use get_pipeline_run API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['pipelineRunId']
        resource_path = "/pipelineRuns/{pipelineRunId}"
    ...
    def get_project(self, project_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/get_project.py.html>`__ to see an example of how to use get_project API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['projectId']
        resource_path = "/projects/{projectId}"
    ...
    def get_step_artifact_content(self, pipeline_id, step_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/get_step_artifact_content.py.html>`__ to see an example of how to use get_step_artifact_content API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['pipelineId', 'stepName']
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_step_artifact_content got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_work_request(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/get_work_request.py.html>`__ to see an example of how to use get_work_request API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
        resource_path = "/workRequests/{workRequestId}"
    ...
    def head_job_artifact(self, job_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/head_job_artifact.py.html>`__ to see an example of how to use head_job_artifact API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['jobId']
        resource_path = "/jobs/{jobId}/artifact/content"
        ...
        if extra_kwargs:
            raise ValueError(
                f"head_job_artifact got unknown kwargs: {extra_kwargs!r}")
    ...
    def head_model_artifact(self, model_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/head_model_artifact.py.html>`__ to see an example of how to use head_model_artifact API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelId']
        resource_path = "/models/{modelId}/artifact/content"
        ...
        if extra_kwargs:
            raise ValueError(
                f"head_model_artifact got unknown kwargs: {extra_kwargs!r}")
    ...
    def head_step_artifact(self, pipeline_id, step_name, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/head_step_artifact.py.html>`__ to see an example of how to use head_step_artifact API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['pipelineId', 'stepName']
        resource_path = "/pipelines/{pipelineId}/steps/{stepName}/artifact/content"
    ...
    def import_model_artifact(self, model_id, import_model_artifact_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/import_model_artifact.py.html>`__ to see an example of how to use import_model_artifact API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelId']
    ...
    def list_data_science_private_endpoints(self, compartment_id, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type list of :class:`~oci.data_science.models.DataSciencePrivateEndpointSummary`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/list_data_science_private_endpoints.py.html>`__ to see an example of how to use list_data_science_private_endpoints API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/dataSciencePrivateEndpoints"
        method = "GET"
        operation_name = "list_data_science_private_endpoints"
        api_reference_link = "https://docs.oracle.com/iaas/api/#/en/data-science/20190101/DataSciencePrivateEndpoint/ListDataSciencePrivateEndpoints"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_data_science_private_endpoints got unknown kwargs: {extra_kwargs!r}")
        ...
        query_params = {
            ...
            "dataScienceResourceType": kwargs.get("data_science_resource_type", missing)
        }
        query_params = {k: v for (k, v) in six.iteritems(query_params) if v is not missing and v is not None}
        ...
        if retry_strategy:
            ...
            return retry_strategy.make_retrying_call(
                ...
                query_params=query_params,
                header_params=header_params,
                response_type="list[DataSciencePrivateEndpointSummary]",
                allow_control_chars=kwargs.get('allow_control_chars'),
                operation_name=operation_name,
                api_reference_link=api_reference_link,
                required_arguments=required_arguments)
    ...
    def list_fast_launch_job_configs(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/list_fast_launch_job_configs.py.html>`__ to see an example of how to use list_fast_launch_job_configs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_fast_launch_job_configs got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_job_runs(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/list_job_runs.py.html>`__ to see an example of how to use list_job_runs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/jobRuns"
    ...
    def list_job_shapes(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/list_job_shapes.py.html>`__ to see an example of how to use list_job_shapes API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_job_shapes got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_jobs(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/list_jobs.py.html>`__ to see an example of how to use list_jobs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/jobs"
    ...
    def list_model_deployment_shapes(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/list_model_deployment_shapes.py.html>`__ to see an example of how to use list_model_deployment_shapes API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_model_deployment_shapes got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_model_deployments(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/list_model_deployments.py.html>`__ to see an example of how to use list_model_deployments API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/modelDeployments"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_model_deployments got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_model_version_sets(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/list_model_version_sets.py.html>`__ to see an example of how to use list_model_version_sets API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/modelVersionSets"
    ...
    def list_models(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/list_models.py.html>`__ to see an example of how to use list_models API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/models"
    ...
    def list_notebook_session_shapes(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/list_notebook_session_shapes.py.html>`__ to see an example of how to use list_notebook_session_shapes API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_notebook_session_shapes got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_notebook_sessions(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/list_notebook_sessions.py.html>`__ to see an example of how to use list_notebook_sessions API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/notebookSessions"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_notebook_sessions got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_pipeline_runs(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/list_pipeline_runs.py.html>`__ to see an example of how to use list_pipeline_runs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/pipelineRuns"
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_pipeline_runs got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_pipelines(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/list_pipelines.py.html>`__ to see an example of how to use list_pipelines API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/pipelines"
    ...
    def list_projects(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/list_projects.py.html>`__ to see an example of how to use list_projects API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
        resource_path = "/projects"
    ...
    def list_work_request_errors(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/list_work_request_errors.py.html>`__ to see an example of how to use list_work_request_errors API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_request_logs(self, work_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/list_work_request_logs.py.html>`__ to see an example of how to use list_work_request_logs API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['workRequestId']
    ...
    def list_work_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/list_work_requests.py.html>`__ to see an example of how to use list_work_requests API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['compartmentId']
    ...
    def update_data_science_private_endpoint(self, data_science_private_endpoint_id, update_data_science_private_endpoint_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/update_data_science_private_endpoint.py.html>`__ to see an example of how to use update_data_science_private_endpoint API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['dataSciencePrivateEndpointId']
        resource_path = "/dataSciencePrivateEndpoints/{dataSciencePrivateEndpointId}"
    ...
    def update_job(self, job_id, update_job_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/update_job.py.html>`__ to see an example of how to use update_job API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['jobId']
        resource_path = "/jobs/{jobId}"
    ...
    def update_job_run(self, job_run_id, update_job_run_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/update_job_run.py.html>`__ to see an example of how to use update_job_run API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['jobRunId']
        resource_path = "/jobRuns/{jobRunId}"
    ...
    def update_model(self, model_id, update_model_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/update_model.py.html>`__ to see an example of how to use update_model API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelId']
        resource_path = "/models/{modelId}"
    ...
    def update_model_deployment(self, model_deployment_id, update_model_deployment_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/update_model_deployment.py.html>`__ to see an example of how to use update_model_deployment API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelDeploymentId']
        resource_path = "/modelDeployments/{modelDeploymentId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_model_deployment got unknown kwargs: {extra_kwargs!r}")
    ...
    def update_model_provenance(self, model_id, update_model_provenance_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/update_model_provenance.py.html>`__ to see an example of how to use update_model_provenance API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelId']
        resource_path = "/models/{modelId}/provenance"
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_model_provenance got unknown kwargs: {extra_kwargs!r}")
    ...
    def update_model_version_set(self, model_version_set_id, update_model_version_set_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/update_model_version_set.py.html>`__ to see an example of how to use update_model_version_set API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['modelVersionSetId']
        resource_path = "/modelVersionSets/{modelVersionSetId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_model_version_set got unknown kwargs: {extra_kwargs!r}")
    ...
    def update_notebook_session(self, notebook_session_id, update_notebook_session_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/update_notebook_session.py.html>`__ to see an example of how to use update_notebook_session API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['notebookSessionId']
        resource_path = "/notebookSessions/{notebookSessionId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_notebook_session got unknown kwargs: {extra_kwargs!r}")
    ...
    def update_pipeline(self, pipeline_id, update_pipeline_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/update_pipeline.py.html>`__ to see an example of how to use update_pipeline API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['pipelineId']
        resource_path = "/pipelines/{pipelineId}"
    ...
    def update_pipeline_run(self, pipeline_run_id, update_pipeline_run_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/update_pipeline_run.py.html>`__ to see an example of how to use update_pipeline_run API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['pipelineRunId']
        resource_path = "/pipelineRuns/{pipelineRunId}"
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_pipeline_run got unknown kwargs: {extra_kwargs!r}")
    ...
    def update_project(self, project_id, update_project_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/datascience/update_project.py.html>`__ to see an example of how to use update_project API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        required_arguments = ['projectId']
        resource_path = "/projects/{projectId}"
