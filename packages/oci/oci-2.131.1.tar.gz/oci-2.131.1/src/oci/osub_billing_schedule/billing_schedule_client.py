...
class BillingScheduleClient(object):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("billing_schedule", config, signer, osub_billing_schedule_type_mapping, **base_client_init_kwargs)
        self.retry_strategy = kwargs.get('retry_strategy')
        self.circuit_breaker_callback = kwargs.get('circuit_breaker_callback')

    def list_billing_schedules(self, compartment_id, subscription_id, **kwargs):
        """
        ...
        :return: A :class:`~oci.response.Response` object with data of type list of :class:`~oci.osub_billing_schedule.models.BillingScheduleSummary`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/osubbillingschedule/list_billing_schedules.py.html>`__ to see an example of how to use list_billing_schedules API.
        """
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_billing_schedules got unknown kwargs: {extra_kwargs!r}")
        ...
        query_params = {
            ...
            "subscribedServiceId": kwargs.get("subscribed_service_id", missing),
