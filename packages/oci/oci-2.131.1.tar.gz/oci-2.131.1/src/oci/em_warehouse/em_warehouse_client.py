...
class EmWarehouseClient(object):
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("em_warehouse", config, signer, em_warehouse_type_mapping, **base_client_init_kwargs)
    ...
    def change_em_warehouse_compartment(self, em_warehouse_id, change_em_warehouse_compartment_details, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"change_em_warehouse_compartment got unknown kwargs: {extra_kwargs!r}")
    ...
    def create_em_warehouse(self, create_em_warehouse_details, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"create_em_warehouse got unknown kwargs: {extra_kwargs!r}")
    ...
    def delete_em_warehouse(self, em_warehouse_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"delete_em_warehouse got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_em_warehouse(self, em_warehouse_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_em_warehouse got unknown kwargs: {extra_kwargs!r}")
    ...
    def get_em_warehouse_resource_usage(self, em_warehouse_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_em_warehouse_resource_usage got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_em_warehouses(self, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_em_warehouses got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_etl_runs(self, em_warehouse_id, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_etl_runs got unknown kwargs: {extra_kwargs!r}")
    ...
    def update_em_warehouse(self, em_warehouse_id, update_em_warehouse_details, **kwargs):
        ...
        if extra_kwargs:
            raise ValueError(
                f"update_em_warehouse got unknown kwargs: {extra_kwargs!r}")
