...
class SubscriptionClient(object):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("subscription", config, signer, osub_subscription_type_mapping, **base_client_init_kwargs)
    ...
    def list_subscriptions(self, compartment_id, **kwargs):
        ...
        :param str plan_number: (optional)
            The Plan Number

        :param str subscription_id: (optional)
            Line level Subscription Id

        :param str buyer_email: (optional)
            Buyer Email Id

        :param bool is_commit_info_required: (optional)
        ...
        :return: A :class:`~oci.response.Response` object with data of type list of :class:`~oci.osub_subscription.models.SubscriptionSummary`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/osubsubscription/list_subscriptions.py.html>`__ to see an example of how to use list_subscriptions API.
        """
        ...
        query_params = {
            ...
            "planNumber": kwargs.get("plan_number", missing),
            "subscriptionId": kwargs.get("subscription_id", missing),
            "buyerEmail": kwargs.get("buyer_email", missing),
            "isCommitInfoRequired": kwargs.get("is_commit_info_required", missing),
