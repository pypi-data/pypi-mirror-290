...
class OrganizationSubscriptionClient(object):
    """
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("organization_subscription", config, signer, osub_organization_subscription_type_mapping, **base_client_init_kwargs)
        self.retry_strategy = kwargs.get('retry_strategy')
        self.circuit_breaker_callback = kwargs.get('circuit_breaker_callback')

    def list_organization_subscriptions(self, compartment_id, subscription_ids, **kwargs):
        """
        API that returns data for the list of subscription ids returned from Organizations API
        ...
        :param str subscription_ids: (required)
        ...
        :return: A :class:`~oci.response.Response` object with data of type list of :class:`~oci.osub_organization_subscription.models.SubscriptionSummary`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/osuborganizationsubscription/list_organization_subscriptions.py.html>`__ to see an example of how to use list_organization_subscriptions API.
        """
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_organization_subscriptions got unknown kwargs: {extra_kwargs!r}")
        ...
        if 'sort_by' in kwargs:
            sort_by_allowed_values = ["SUBSCRIPTIONID", "TIMESTART"]
