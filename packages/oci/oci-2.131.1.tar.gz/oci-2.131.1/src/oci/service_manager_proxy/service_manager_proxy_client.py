...
class ServiceManagerProxyClient(object):
    ...
    def __init__(self, config, **kwargs):
        ...
        base_client_init_kwargs = {
            ...
            'base_path': '/20210914',
            'service_endpoint_template': 'https://smproxy.{region}.ocs.{secondLevelDomain}',
        ...
        self.base_client = BaseClient("service_manager_proxy", config, signer, service_manager_proxy_type_mapping, **base_client_init_kwargs)
    ...
    def get_service_environment(self, service_environment_id, compartment_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.service_manager_proxy.models.ServiceEnvironment`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/servicemanagerproxy/get_service_environment.py.html>`__ to see an example of how to use get_service_environment API.
        """
        ...
        if extra_kwargs:
            raise ValueError(
                f"get_service_environment got unknown kwargs: {extra_kwargs!r}")
    ...
    def list_service_environments(self, compartment_id, **kwargs):
        ...
        :return: A :class:`~oci.response.Response` object with data of type :class:`~oci.service_manager_proxy.models.ServiceEnvironmentCollection`
        :rtype: :class:`~oci.response.Response`

        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.131.1/servicemanagerproxy/list_service_environments.py.html>`__ to see an example of how to use list_service_environments API.
        """
        # Required path and query arguments. These are in camelCase to replace values in service endpoints.
        ...
        if extra_kwargs:
            raise ValueError(
                f"list_service_environments got unknown kwargs: {extra_kwargs!r}")

        if 'sort_by' in kwargs:
            sort_by_allowed_values = ["ID"]
        ...
        query_params = {
            "serviceEnvironmentId": kwargs.get("service_environment_id", missing),
            "serviceEnvironmentType": kwargs.get("service_environment_type", missing),
            "compartmentId": compartment_id,
