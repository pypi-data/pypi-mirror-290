...
# The server listens for incoming webhooks from Azure DevOps Server and forwards them to the PR Assistant.
...
async def handle_webhook(background_tasks: BackgroundTasks, request: Request):
    ...
    if data["eventType"] == "git.pullrequest.created":
        ...
        await _perform_commands_azure("pr_commands", PRAssistant(), pr_url, log_context)
        return
