...
class BitbucketServerProvider(GitProvider):
    ...
    def get_repo_settings(self):
        try:
            content = self.bitbucket_client.get_content_of_file(self.workspace_slug, self.repo_slug, ".pr_assistant.toml", self.get_pr_branch())
            ...
            get_logger().error(f"Failed to load .pr_assistant.toml file, error: {e}")
            return ""
