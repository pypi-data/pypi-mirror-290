...
class Danila_balka_text_recognize_redone:
    def __init__(self, local,  yolov5_dir, balka_text_recognize_version):
        if local:
            if balka_text_recognize_version == 3:
                self.prod_coefficients = {
                    ...
                    Rama_prod.Rama_Prod.begickaya: Balka_text_recognize_params(Balka_text_cut_recognize_params(5, 64, 160),
                                                                     Balka_text_cut_recognize_params(4, 64, 64),
                                                                     Balka_text_cut_recognize_params(2, 64, 96)),
                    Rama_prod.Rama_Prod.promlit: Balka_text_recognize_params(Balka_text_cut_recognize_params(5, 64, 160),
                                                                   Balka_text_cut_recognize_params(4, 64, 64),
                                                                   Balka_text_cut_recognize_params(2, 64, 64)),
                    Rama_prod.Rama_Prod.ruzhimmash: Balka_text_recognize_params(Balka_text_cut_recognize_params(5, 64, 192),
                                                                      Balka_text_cut_recognize_params(4, 64, 96),
                                                                      Balka_text_cut_recognize_params(2, 64, 64)),
                    Rama_prod.Rama_Prod.tihvin: Balka_text_recognize_params(Balka_text_cut_recognize_params(5, 64, 160),
                                                                  Balka_text_cut_recognize_params(4, 64, 128),
                                                                  Balka_text_cut_recognize_params(2, 64, 64))
                }
                print('reading and loading - BALKA_TEXT_RECOGNIZE_MODEL')
                self.text_recognize_model = Balka_Text_Recognize_yolo(local, LOCAL_RAMA_TEXT_RECOGNIZE_MODEL_ADDRESS, yolov5_dir, self.prod_coefficients)
                ...
                print('reading and loading - BALKA_TEXT_RECOGNIZE_MODEL')
                self.text_recognize_model = Balka_Text_Recognize_yolo(local, LOCAL_RAMA_TEXT_RECOGNIZE_MODEL_ADDRESS_2, yolov5_dir, self.prod_coefficients)
                ...
                self.prod_coefficients = {
                    ...
                    Rama_prod.Rama_Prod.begickaya: Balka_text_recognize_params(Balka_text_cut_recognize_params(5, 160, 160),
                                                                     Balka_text_cut_recognize_params(2, 64, 64),
                                                                     Balka_text_cut_recognize_params(2, 64, 64)),
                    Rama_prod.Rama_Prod.promlit: Balka_text_recognize_params(Balka_text_cut_recognize_params(5, 96, 96),
                                                                   Balka_text_cut_recognize_params(2, 128, 128),
                                                                   Balka_text_cut_recognize_params(2, 32, 32)),
                    Rama_prod.Rama_Prod.ruzhimmash: Balka_text_recognize_params(Balka_text_cut_recognize_params(5, 128, 128),
                                                                      Balka_text_cut_recognize_params(4, 96, 96),
                                                                      Balka_text_cut_recognize_params(2, 64, 64)),
                    Rama_prod.Rama_Prod.tihvin: Balka_text_recognize_params(Balka_text_cut_recognize_params(5, 96, 96),
                                                                  Balka_text_cut_recognize_params(4, 96, 96),
                                                                  Balka_text_cut_recognize_params(2, 64, 64))
                }
                print('reading and loading - BALKA_TEXT_RECOGNIZE_MODEL')
            ...
            if balka_text_recognize_version == 3:
                ...
                print('reading and loading - BALKA_TEXT_RECOGNIZE_MODEL')
                self.text_recognize_model = Balka_Text_Recognize_yolo(local, RAMA_TEXT_RECOGNIZE_MODEL_ADDRESS, yolov5_dir, self.prod_coefficients)
            elif balka_text_recognize_version == 4:
                self.prod_coefficients = {
                    Balka_Prod.altai: Balka_text_recognize_params(Balka_text_cut_recognize_params(5, 64, 160),
                                                                 Balka_text_cut_recognize_params(4, 64, 128),
                ...
                print('reading and loading - BALKA_TEXT_RECOGNIZE_MODEL')
                self.text_recognize_model = Balka_Text_Recognize_yolo(local, RAMA_TEXT_RECOGNIZE_MODEL_ADDRESS_2, yolov5_dir, self.prod_coefficients)
            elif balka_text_recognize_version == 6:
                self.prod_coefficients = {
                    Balka_Prod.altai: Balka_text_recognize_params(Balka_text_cut_recognize_params(5, 128, 128),
                                                                 Balka_text_cut_recognize_params(4, 128, 128),
