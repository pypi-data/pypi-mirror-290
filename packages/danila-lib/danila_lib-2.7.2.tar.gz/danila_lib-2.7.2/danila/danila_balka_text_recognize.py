...
from danila.danila_balka_text_recognize_redone import Danila_balka_text_recognize_redone
...
class Danila_balka_text_recognize:
    def __init__(self, local, yolov5_dir, danila_balka_text_recognize_params):
        ...
        if self.danila_balka_text_recognize_params.balka_text_recognize_version < 3:
