...
class Danila_rama_text_recognize_redone:
    def __init__(self, local, yolov5_dir, rama_text_recognize_version):
        ...
        if local:
            if rama_text_recognize_version == 3:
               ...
               self.prod_coefficients = {
                ...
                self.prod_coefficients = {
                    ...
                    Rama_prod.Rama_Prod.begickaya: Prod_coefficients(Text_coefficients(6, 224, 224),
                                                                     ...
                                                                     Text_coefficients(2, 96, 96)),
                    Rama_prod.Rama_Prod.promlit: Prod_coefficients(Text_coefficients(5, 160, 160),
                                                                   Text_coefficients(2, 96, 96),
                                                                   Text_coefficients(2, 64, 64)),
                    Rama_prod.Rama_Prod.ruzhimmash: Prod_coefficients(Text_coefficients(5, 160, 160),
