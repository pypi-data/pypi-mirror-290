from danila.danila_vagon_text_detect_base import Danila_vagon_text_detect_base
from danila.danila_vagon_text_recognize_base import Danila_vagon_text_recognize_base
