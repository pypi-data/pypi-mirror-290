...
[boto3.CodeGuruSecurity 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/codeguru-security.html#CodeGuruSecurity)
...
- [mypy-boto3-codeguru-security](#mypy-boto3-codeguru-security)
...
- Install `boto3-stubs[codeguru-security]` in your environment:
...
Install `boto3-stubs-lite[codeguru-security]` in your environment:
...
- Install `boto3-stubs[codeguru-security]` with services you use in your
  environment:
...
`boto3.client("codeguru-security")`.
...
`mypy_boto3_codeguru_security.paginator` module contains type annotations for
all paginators.
...
`mypy_boto3_codeguru_security.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `CodeGuruSecurity` Literals can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_codeguru_security/literals/).
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_codeguru_security/type_defs/).
...
`mypy-boto3-codeguru-security` version is the same as related `boto3` version
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_codeguru_security/)
