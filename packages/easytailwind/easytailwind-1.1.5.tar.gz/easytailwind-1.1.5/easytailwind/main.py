def check_et():
    print('Running easytailwind v1.1.5')
...
def install():
    ...
    def create_flask_file(html_filename):
        flask_content = f"""
    ...
    def setup_tailwind():
        ...
        print_header(
            "Hi! I'm EasyTailwind. I'll set up Tailwind CSS for you. Sit back while I handle it!")
    ...
    <body class="bg-gradient-to-r from-gray-900 to-gray-700 flex flex-col items-center justify-center min-h-screen text-gray-100 overflow-hidden">
        ...
        <h1 class="text-4xl font-bold mb-6 text-center hover:text-5xl ani animate-fade-in">
            <span class="text-pink-200">Easy</span><span class="text-gray-100">Tailwind</span><span class="font-light"> v1.1.4</span>
        </h1>
        ...
        <h1 class="text-lg font-light text-center ani animate-fade-in mt-8 hover:text-yellow-600">
            <span>Read the </span><a target="_blank" href="https://pypi.org/project/easytailwind/" class="underline">PyPi documentation</a>
        </h1>
        <script>
        ...
        if insType == '2':
            ...
            create_flask_file(html_filename)
        ...
        print_success(
            "Tailwind CSS setup completed by EasyTailwind. They community awaits your creativity!")
