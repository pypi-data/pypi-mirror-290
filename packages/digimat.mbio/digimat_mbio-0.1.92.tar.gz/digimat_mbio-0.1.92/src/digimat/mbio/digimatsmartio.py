                ...
                for channel in range(self.NBCHANNELAI):
                    ...
                    try:
                        ...
                        if value.config.type[0]=='+':
                            data=self.r2t(value.config.type[1:], data)
                    except:
                        pass
