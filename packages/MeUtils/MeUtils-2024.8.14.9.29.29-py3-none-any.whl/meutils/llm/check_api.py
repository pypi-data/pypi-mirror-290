...
async def check(api_key_or_token, check_url):
    ...
    try:
        async with httpx.AsyncClient(headers=headers, timeout=60) as client:
            ...
            if api_key_or_token.startswith("eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9"):
...
if __name__ == '__main__':
    ...
    api_keys = """
    sk-ukvbnzdplljljdortvlbuwvrwmzyvqzcecsfqksquxcarbmo
sk-xpahzznnweceulaccqbobyzuognuhqjjuluiwdccwtrnmibd
sk-atesayrfcvbuelodrobxzarraajgrugjtgsimhlzsusezkhj
sk-nsujeaeueefgfplafjpehnqyebnnakpncqaajabpdukpoiwq
sk-lwuqklvywlpctjmuywqpvobxthfpxhfudspwwsmflvsgptne
sk-sufppghqjipyneisvqaqsflglwmaduwyyfcxscouonlltoog
sk-exrzmqvwtmkuzzazfdnjqqxrcrhvgofbwztceolsgaoayekf
sk-rdjlmfxratnuqjjievsmeqxfmphgoqpfelbekskqudgligkf
sk-lnqmcysuzieqtjljspxhrcqbrkjqvthfvakjdcegysoptxte
sk-uzzlygwrwwccuooxfasfqvfwecivjhqryvnpvurmarvoswpc
