...
async def upload(file, token: Optional[str] = None, vip: bool = False):  # todo: 统一到 file object
    token = token or await get_next_token_for_polling(FEISHU_URL if not vip else FEISHU_URL_VIP)
...
if __name__ == '__main__':
    ...
    token = '_GRECAPTCHA=09AA5Y-DJkmNf1g2PMwDEbQ7oqX53UdCKblU_GkAGl9VeeLgbrkPkTG1Id9ld2jSQzh9u40aOhYwunoSILjiXdHJg; HMACCOUNT_BFESS=EF4D7893FF070481; Hm_lvt_a3c8711bce1795293b1793d35916c067=1722407243; Hm_lpvt_a3c8711bce1795293b1793d35916c067=1722407243; HMACCOUNT=EF4D7893FF070481; io=j7TFlucvZuUWC5fOAB7Q; JWT=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MjM3MDMyNTEsImlhdCI6MTcyMjQwNzI1MSwiaXNzIjoiaWFtIiwic3ViIjoiMjM2ODY0MjI3NjIzNDI4OCJ9.6mJ-kV7R_iUJlvNMCKLKIA04aLxf_TGrCoIt1JmE9es; Shunt=; Hm_lvt_a3c8711bce1795293b1793d35916c067=1753943242631|1722407243; shortid=l5tdrx5e6; debug=undefined; _grecaptcha=09AA5Y-DLGwzhIf5gAtg_IdcRibZiUkUgFoisN-MtY5EFOzn0V9XWIC_Mh-gD-HdVNP6Gy6eQRwJ8MTVX5OQOKVCND07gmqTpVAagG0A; VIDU_SELECTED_LOCALE=zh; VIDU_TOUR="v1"'
