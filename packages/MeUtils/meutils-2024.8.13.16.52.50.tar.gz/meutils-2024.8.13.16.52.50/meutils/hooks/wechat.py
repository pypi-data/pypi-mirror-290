...
from meutils.decorators import ratelimit
...
# handler_group_msg
# pip install pyrate_limiter meutils -U --user && rm -rf wechat_channel.py && python -m wget https://oss.ffire.cc/files/wechat_channel.py
