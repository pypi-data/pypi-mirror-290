...
class Row(AbstractFactory):
    ...
    def __init__(
        ...
        *items: Union[LayoutItem, Column],
        ...
        self.__custom_height: Optional[Union[float, int]] = height
        self.__height: Optional[Union[int, float]] = None

    @property
    def custom_height(self) -> Optional[Union[float, int]]:
        """Get custom height."""
        return self.__custom_height

    def __set_items(self, *items: Union[LayoutItem, Column]) -> None:
        """Set columns for row."""
        if len(items) > 6:
    ...
    def prepare_heights(
        self, column_height: Optional[Union[float, int]] = None
    ) -> None:
        """Prepare row heights."""
    ...
    def __validate_parent_and_inner_height(
        column: Column, row_height: Optional[Union[float, int]] = None
    ) -> None:
    ...
    def __get_columns_custom_height(self) -> Optional[float]:
    ...
    def __set_height(self, column_height: Optional[Union[float, int]] = None) -> None:
