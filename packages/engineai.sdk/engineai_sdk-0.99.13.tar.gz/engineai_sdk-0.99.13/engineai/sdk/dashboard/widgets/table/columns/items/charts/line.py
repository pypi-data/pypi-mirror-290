...
class LineChartColumn(ChartColumn):
    ...
    def __init__(
        ...
        *,
        ...
        styling: Optional[Union[Palette, LineChartStyling]] = None,
        ...
        Examples:
            ??? example "Create a Table widget with LineChartColumn"
                ```py linenums="1"
                import pandas as pd
        ...
        super().__init__(
            ...
            styling=(
                styling
                if styling
                else LineChartStyling(
                    color_spec=color.Palette.MINT_GREEN,
                )
            ),
            optional=optional,
        )
