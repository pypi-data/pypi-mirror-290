...
class TimeseriesValidateSeriesDataColumnNotFound(BaseDataValidationError):
    ...
    def __init__(
        ...
        """Constructor for TimeseriesValidateSeriesDataColumnNotFound class.
...
class TimeseriesChartsHeightNotUniformError(TimeseriesError):
    ...
    def __init__(
        self, widget_id: str, total_height: Union[int, float], *args: object
    ) -> None:
