...
class PeriodSelector(AbstractFactory):
    ...
    def __init__(
        ...
        *periods: PeriodType,
        ...
        Examples:
            ??? example "Create a minimal timeseries widget with a selector"
                ```python linenums="1"
                import pandas as pd
    ...
    def __set_default_selection(self, option: Optional[int] = None) -> None:
        if self.__visible:
    ...
    def _custom_periods_prepare(self):
        custom_periods = [
