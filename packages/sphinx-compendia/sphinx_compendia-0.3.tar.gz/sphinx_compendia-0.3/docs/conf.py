...
# -- Project information -----------------------------------------------------
#####
from sphinx_compendia import __version__

_today = datetime.today()

project = os.getenv("SPHINX_CONF_PROJECT", "Sphinx-Compendia")
...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitLab",
            "url": "https://gitlab.com/cblegare/sphinx-compendia",
            "icon": "fab fa-gitlab",
        },
    ],
    "show_prev_next": True,
...
nitpick_ignore = [
    ("py:class", "re.Pattern"),
    ("py:class", "Path"),
    ("py:class", "sphinxapi.SphinxDomainObjectDescription"),
    ("py:class", "sphinx_compendia.sphinxapi.SphinxDomainObjectDescription"),
...
extlinks = {
    "dudir": (
        ...
        "Directive Docutils %s",
    ),
    "release": (
        "https://gitlab.com/cblegare/sphinx-compendia/-/releases/%s",
        "Sphinx-Compendia v%s",
    ),
    "mr": (
        "https://gitlab.com/cblegare/sphinx-compendia/-/merge_requests/%s",
        "!%s",
    ),
    "issue": (
        "https://gitlab.com/cblegare/sphinx-compendia/-/issues/%s",
        "#%s",
    ),
    "commiter": ("https://gitlab.com/%s", "@%s"),
}
###
...
def setup(app: Sphinx):
    ...
    make_compendium(
        "rule", ["skill", "spell"], display_name="House Rules", app=app
    )

    from sphinx_compendia import Constituent

    # A tad more advanced usage:
    #   our constituents have long names we don't want to
    #   type each time we write some cross-reference,
    ...
    make_compendium(
        ...
        [
            ...
            Constituent(
                ...
                directive_aliases=["loc", "place"],
            ),
        ],
        display_name="Some Mythical World",
        app=app,
    )
    # app.add_css_file("https://cdn.jsdelivr.net/gh/aaaakshat/cm-web-fonts@latest/fonts.css")
    app.add_css_file(
        "https://fonts.googleapis.com/css2?family=Courier+Prime:ital,wght@0,400;0,700;1,400;1,700&family=Crimson+Pro:ital,wght@0,400;0,700;1,400;1,700&display=swap"
    )
