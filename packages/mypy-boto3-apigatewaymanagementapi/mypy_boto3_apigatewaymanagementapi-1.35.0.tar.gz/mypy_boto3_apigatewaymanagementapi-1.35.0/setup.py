"""
Setup script for mypy-boto3-apigatewaymanagementapi.
"""
...
setup(
    ...
    description="Type annotations for boto3.ApiGatewayManagementApi 1.35.0 service generated with mypy-boto3-builder 7.26.0",
    classifiers=[
