...
def get_paths() -> dict[str, str]:
    """
    Get all standard paths. Returns a dict with the name as keys and the paths as their values.
...
def parent_folder(file: str = __file__) -> str:
    """Gets the parent folder of a specific file. The default value is the current file which is running the script."""
