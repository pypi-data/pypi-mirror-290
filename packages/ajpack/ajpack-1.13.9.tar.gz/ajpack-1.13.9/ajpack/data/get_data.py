...
def capture(
    ...
    :param bbox: Bounding box of the region to capture. If None, captures the entire screen.
    ...
    :param xdisplay: The display to capture. If None, captures the default display.
    """
