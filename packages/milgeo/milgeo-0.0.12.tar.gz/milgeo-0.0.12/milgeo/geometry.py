...
class Geometry:
    ...
    @staticmethod
    def create_geometry(geometry_type, name, coordinates, metadata, color_string):
        try:
            ...
            Geometry.create_geometry(geometry_type=geometry_type, name=name, coordinates=coordinates, metadata=metadata,
