...
class Geometry:
    ...
    @staticmethod
    def create_geometry(geometry_type, name, coordinates, metadata, sidc_string, color_string):
        try:
            geometry = geometry_type(name=name, coordinates=coordinates, metadata=metadata)
            if sidc_string:
                geometry.find_sidc(string=sidc_string)
            if color_string:
            ...
            Geometry.create_geometry(geometry_type=geometry_type, name=name, coordinates=coordinates,
                                     metadata=metadata, color_string=color_string, sidc_string=sidc_string)
