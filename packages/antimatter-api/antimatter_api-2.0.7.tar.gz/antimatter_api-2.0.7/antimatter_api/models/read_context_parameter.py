...
class ReadContextParameter(BaseModel):
    """
    ...
    """ # noqa: E501
    key: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = None
    required: Optional[StrictBool] = None
    description: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = None
    __properties: ClassVar[List[str]] = ["key", "required", "description"]
