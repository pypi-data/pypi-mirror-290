...
class DataTaggingHookInput(BaseModel):
    """
    A request to classify PII in a batch of records
    """ # noqa: E501
    records: List[DataTaggingHookInputRecordsInner] = Field(description="a batch of values to be processed. Every element within a record must belong to the same record. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [DataTaggingHookInputRecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
