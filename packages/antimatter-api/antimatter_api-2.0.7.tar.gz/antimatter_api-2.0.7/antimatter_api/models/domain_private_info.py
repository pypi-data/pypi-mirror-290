...
class DomainPrivateInfo(BaseModel):
    """
    Private information about a domain
    """ # noqa: E501
    default_display_name: Annotated[str, Field(strict=True, max_length=40)] = Field(description="User friendly display name.", alias="defaultDisplayName")
    id: Annotated[str, Field(strict=True)] = Field(description="A globally unique identifier for a domain")
    identity_providers: List[DomainIdentityProviderInfo] = Field(description="A list of identity providers configured in a domain", alias="identityProviders")
    __properties: ClassVar[List[str]] = ["defaultDisplayName", "id", "identityProviders"]
