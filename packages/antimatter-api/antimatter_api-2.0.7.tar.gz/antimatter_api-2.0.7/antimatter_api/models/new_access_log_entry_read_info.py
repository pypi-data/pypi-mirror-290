...
class NewAccessLogEntryReadInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["parameters", "allowedTags", "redactedTags", "tokenizedTags", "returnedRecords", "filteredRecords"]
