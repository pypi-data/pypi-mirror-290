...
class AntimatterDelegatedAWSKeyInfo(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["keyARN", "providerName"]
    ...
    def provider_name_validate_enum(cls, value):
        ...
        if value not in set(['aws_am']):
            raise ValueError("must be one of enum values ('aws_am')")
        return value
