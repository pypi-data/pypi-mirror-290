...
class AccessLogEntryCreateInfo(BaseModel):
    """
    information available if the operation is of type \"create\". 
    """ # noqa: E501
    write_context: Annotated[str, Field(strict=True)] = Field(description="An identifier for a write context that might be imported from a peer domain. If it is, it will bear an imported resource prefix (either a domain identifier or an alias, followed by ::) ", alias="writeContext")
    __properties: ClassVar[List[str]] = ["writeContext"]
