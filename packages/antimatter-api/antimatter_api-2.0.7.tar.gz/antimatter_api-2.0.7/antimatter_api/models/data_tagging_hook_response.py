...
class DataTaggingHookResponse(BaseModel):
    """
    A response from invoking a data tagging hook
    """ # noqa: E501
    version: Annotated[str, Field(strict=True)]
    records: List[DataTaggingHookResponseRecordsInner] = Field(description="the records that have been processed, one per input record ")
    __properties: ClassVar[List[str]] = ["version", "records"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "records": [DataTaggingHookResponseRecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
