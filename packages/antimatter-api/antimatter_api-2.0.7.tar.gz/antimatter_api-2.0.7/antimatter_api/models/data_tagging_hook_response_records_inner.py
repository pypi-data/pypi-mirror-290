...
class DataTaggingHookResponseRecordsInner(BaseModel):
    """
    DataTaggingHookResponseRecordsInner
    """ # noqa: E501
    elements: List[TagSet] = Field(description="the elements that have been processed, matching what was given as input. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "elements": [TagSet.from_dict(_item) for _item in obj["elements"]] if obj.get("elements") is not None else None
        })
        return _obj
