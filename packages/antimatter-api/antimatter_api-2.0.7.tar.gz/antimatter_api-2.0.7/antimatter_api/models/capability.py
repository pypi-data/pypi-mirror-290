...
class Capability(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(strict=True)] = Field(description="An identifier for a capability")
    value: Optional[Annotated[str, Field(strict=True, max_length=256)]] = None
    __properties: ClassVar[List[str]] = ["name", "value"]

    @field_validator('name')
    def name_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^[a-z][a-z0-9-_]{2,16}$", value):
            raise ValueError(r"must validate the regular expression /^[a-z][a-z0-9-_]{2,16}$/")
        return value
