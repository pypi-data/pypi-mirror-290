...
class DomainIdentityEmailPrincipalParams(BaseModel):
    """
    Details for an email principal
    """ # noqa: E501
    type: Optional[StrictStr] = None
    email: StrictStr
    comment: Optional[StrictStr] = Field(default=None, description="An optional comment for the email principal")
    __properties: ClassVar[List[str]] = ["type", "email", "comment"]
