...
class DomainStatus(BaseModel):
    ...
    """ # noqa: E501
    notifications: Optional[List[DomainStatusNotificationsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "notifications": [DomainStatusNotificationsInner.from_dict(_item) for _item in obj["notifications"]] if obj.get("notifications") is not None else None
        })
        return _obj
