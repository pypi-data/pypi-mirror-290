...
class TestVariableDefinition(unittest.TestCase):
    """VariableDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VariableDefinition:
        """Test VariableDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VariableDefinition`
        """
    ...
    def testVariableDefinition(self):
        """Test VariableDefinition"""
