...
class TestDataPolicyClause(unittest.TestCase):
    """DataPolicyClause unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataPolicyClause:
        """Test DataPolicyClause
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataPolicyClause`
        """
        model = DataPolicyClause()
        if include_optional:
            return DataPolicyClause(
                operator = 'AllOf',
                tags = [
