...
class TestDataPolicyRule(unittest.TestCase):
    """DataPolicyRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataPolicyRule:
        """Test DataPolicyRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataPolicyRule`
        """
        model = DataPolicyRule()
        if include_optional:
            return DataPolicyRule(
