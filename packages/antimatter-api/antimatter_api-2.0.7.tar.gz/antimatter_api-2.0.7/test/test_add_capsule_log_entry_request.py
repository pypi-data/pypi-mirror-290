...
class TestAddCapsuleLogEntryRequest(unittest.TestCase):
    """AddCapsuleLogEntryRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddCapsuleLogEntryRequest:
        """Test AddCapsuleLogEntryRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddCapsuleLogEntryRequest`
        """
        model = AddCapsuleLogEntryRequest()
        if include_optional:
            return AddCapsuleLogEntryRequest(
                entry = antimatter_api.models.new_access_log_entry.NewAccessLogEntry(
                    operation = 'read', 
                    location = '', 
    ...
    def testAddCapsuleLogEntryRequest(self):
        """Test AddCapsuleLogEntryRequest"""
