...
class TestDomainPublicInfo(unittest.TestCase):
    """DomainPublicInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DomainPublicInfo:
        """Test DomainPublicInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DomainPublicInfo`
        """
        model = DomainPublicInfo()
        if include_optional:
            return DomainPublicInfo(
