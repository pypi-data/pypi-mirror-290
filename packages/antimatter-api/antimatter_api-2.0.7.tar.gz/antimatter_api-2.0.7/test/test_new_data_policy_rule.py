...
class TestNewDataPolicyRule(unittest.TestCase):
    """NewDataPolicyRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewDataPolicyRule:
        """Test NewDataPolicyRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewDataPolicyRule`
        """
        model = NewDataPolicyRule()
        if include_optional:
            return NewDataPolicyRule(
                comment = '',
                clauses = [
    ...
    def testNewDataPolicyRule(self):
        """Test NewDataPolicyRule"""
