...
class TestUpsertSpanTagsRequest(unittest.TestCase):
    """UpsertSpanTagsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertSpanTagsRequest:
        """Test UpsertSpanTagsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertSpanTagsRequest`
        """
        model = UpsertSpanTagsRequest()
        if include_optional:
            return UpsertSpanTagsRequest(
                summary = antimatter_api.models.tag_summary.TagSummary(
                    unique_tags = [
    ...
    def testUpsertSpanTagsRequest(self):
        """Test UpsertSpanTagsRequest"""
