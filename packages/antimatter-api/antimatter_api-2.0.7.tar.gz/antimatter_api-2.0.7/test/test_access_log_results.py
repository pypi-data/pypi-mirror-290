...
class TestAccessLogResults(unittest.TestCase):
    """AccessLogResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessLogResults:
        """Test AccessLogResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessLogResults`
        """
        model = AccessLogResults()
        if include_optional:
            return AccessLogResults(
                results = [
                    antimatter_api.models.access_log_entry.AccessLogEntry(
