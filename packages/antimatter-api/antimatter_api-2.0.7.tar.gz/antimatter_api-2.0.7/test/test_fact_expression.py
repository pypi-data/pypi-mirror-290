...
class TestFactExpression(unittest.TestCase):
    """FactExpression unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FactExpression:
        """Test FactExpression
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FactExpression`
        """
        model = FactExpression()
        if include_optional:
