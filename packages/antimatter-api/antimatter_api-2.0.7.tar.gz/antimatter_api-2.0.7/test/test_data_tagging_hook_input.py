...
class TestDataTaggingHookInput(unittest.TestCase):
    """DataTaggingHookInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataTaggingHookInput:
        """Test DataTaggingHookInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataTaggingHookInput`
        """
        model = DataTaggingHookInput()
        if include_optional:
            return DataTaggingHookInput(
                records = [
    ...
    def testDataTaggingHookInput(self):
        """Test DataTaggingHookInput"""
