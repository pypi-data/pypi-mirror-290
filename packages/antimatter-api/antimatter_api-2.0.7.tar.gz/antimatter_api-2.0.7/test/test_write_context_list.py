...
class TestWriteContextList(unittest.TestCase):
    """WriteContextList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WriteContextList:
        """Test WriteContextList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WriteContextList`
        """
        model = WriteContextList()
        if include_optional:
            return WriteContextList(
                write_contexts = [
                    antimatter_api.models.write_context_details.WriteContextDetails(
