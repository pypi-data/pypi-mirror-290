...
class NewAccessLogEntry(BaseModel):
    """
    ...
    read_info: NewAccessLogEntryReadInfo = Field(alias="readInfo")
    __properties: ClassVar[List[str]] = ["operation", "location", "readInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "readInfo": NewAccessLogEntryReadInfo.from_dict(obj["readInfo"]) if obj.get("readInfo") is not None else None
        })
        return _obj
