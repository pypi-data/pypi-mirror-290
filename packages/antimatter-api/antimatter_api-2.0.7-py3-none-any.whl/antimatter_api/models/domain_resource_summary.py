...
class DomainResourceSummary(BaseModel):
    ...
    """ # noqa: E501
    var_schema: List[DomainResourceSummarySchemaInner] = Field(alias="schema")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "schema": [DomainResourceSummarySchemaInner.from_dict(_item) for _item in obj["schema"]] if obj.get("schema") is not None else None
        })
        return _obj
