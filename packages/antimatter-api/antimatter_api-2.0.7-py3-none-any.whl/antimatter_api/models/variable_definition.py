...
class VariableDefinition(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["variableName", "source", "tagName", "capabilityName", "factType", "factArguments", "variables"]
    ...
    def source_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['TagValue', 'FactArgument', 'CapabilityValue']):
            raise ValueError("must be one of enum values ('TagValue', 'FactArgument', 'CapabilityValue')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.fact_arguments:
            for _item in self.fact_arguments:
                if _item:
