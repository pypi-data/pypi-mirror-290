...
class TagSummaryUniqueTagsInner(BaseModel):
    """
    TagSummaryUniqueTagsInner
    """ # noqa: E501
    tag: Tag
    occurrences: StrictInt = Field(description="how many times this tag configuration appears")
    __properties: ClassVar[List[str]] = ["tag", "occurrences"]
