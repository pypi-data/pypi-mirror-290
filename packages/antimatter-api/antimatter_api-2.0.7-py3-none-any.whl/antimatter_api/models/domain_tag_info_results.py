...
class DomainTagInfoResults(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tags", "has_more"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tags": [TagMeta.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None,
