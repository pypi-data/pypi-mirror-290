...
class RootEncryptionKeyIDResponse(BaseModel):
    """
    The newly created root encryption key's ID. 
    """ # noqa: E501
    rek_id: StrictStr = Field(description="The root encryption key ID.", alias="rekID")
    __properties: ClassVar[List[str]] = ["rekID"]
