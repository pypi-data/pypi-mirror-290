...
def get_n_save(year_in: int, month_in: int,basepath: str , days_in) -> int:
    ...
    try:
        ...
        myurl = 'https://dows.ibe.cnr.it:8443/dows-1/api/upload/skin_temp'
        print(year_in)
        print(list_of_days)
        ...
        try:
            origin_nc_file = basepath+'/skintemp_'+str(year_in)+'_'+str(month_in)+'.nc'
            nc_file = basepath+'/copyskintemp_'+str(year_in)+'_'+str(month_in)+'.nc'
