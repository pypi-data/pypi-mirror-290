...
class TableTripFilter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "column", "datetime_range", "int_range", "float_range", "bool_list", "string_list", "enum_list", "string_search", "duration_range"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TableTripFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TableTripFilter from a dict"""
        if obj is None:
            return None
