...
class TablePerformerFields(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["essence_key", "essence_type", "enabled", "pristine", "working_time", "availability_time", "trip_key", "trip_name", "location_keys", "trips_count", "attributes"]
