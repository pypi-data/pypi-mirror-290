...
class WebTransportGeopointList(BaseModel):
    """
    Geopoints for map.
    """ # noqa: E501
    geopoints: Annotated[List[WebTransportGeopoint], Field(min_length=0, max_length=60002)] = Field(description="A list of points.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebTransportGeopointList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebTransportGeopointList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "geopoints": [WebTransportGeopoint.from_dict(_item) for _item in obj["geopoints"]] if obj.get("geopoints") is not None else None,
