...
class WebTransport(BaseModel):
    ...
    """ # noqa: E501
    transport: Transport
    fields: Optional[TableTransportFields] = None
    ...
    __properties: ClassVar[List[str]] = ["transport", "fields", "linked_essences"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebTransport from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebTransport from a dict"""
        if obj is None:
            return None
