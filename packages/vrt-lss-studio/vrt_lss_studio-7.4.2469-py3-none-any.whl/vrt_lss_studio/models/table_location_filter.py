...
class TableLocationFilter(BaseModel):
    """
    Universal filter for table.
    """ # noqa: E501
    type: TableFilterType
    column: TableLocationColumnType
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TableLocationFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TableLocationFilter from a dict"""
        if obj is None:
            return None
