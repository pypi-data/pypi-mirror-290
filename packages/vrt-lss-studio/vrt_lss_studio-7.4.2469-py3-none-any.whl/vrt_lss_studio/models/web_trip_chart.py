...
class WebTripChart(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["trip", "chart_demands"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chart_demands": [WebTripChartDemand.from_dict(_item) for _item in obj["chart_demands"]] if obj.get("chart_demands") is not None else None
        })
        return _obj
