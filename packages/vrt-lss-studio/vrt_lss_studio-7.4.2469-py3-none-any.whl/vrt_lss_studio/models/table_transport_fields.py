...
class TableTransportFields(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["essence_key", "essence_type", "enabled", "pristine", "availability_time", "transport_type", "trip_key", "trip_name", "location_keys", "trips_count", "attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "availability_time": BasicTimeWindow.from_dict(obj["availability_time"]) if obj.get("availability_time") is not None else None,
