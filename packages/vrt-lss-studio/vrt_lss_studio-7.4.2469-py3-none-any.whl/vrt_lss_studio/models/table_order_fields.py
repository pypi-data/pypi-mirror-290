...
class TableOrderFields(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["essence_key", "essence_type", "enabled", "pristine", "state", "type", "hard_time_window", "soft_time_window", "general_drop_time_window", "general_pickup_time_window", "general_work_time_window", "reward", "mass", "volume", "capacity_a", "capacity_b", "capacity_c", "order_features", "order_restrictions", "performer_restrictions", "performer_blacklist", "width", "height", "length", "rotation", "box_restrictions", "cargo_features", "cargo_restrictions", "demands_count", "trip_key", "trip_name", "attributes"]
