...
class WebHardlink(BaseModel):
    """
    Web Hardlink.
    """ # noqa: E501
    hardlink: Hardlink
    fields: Optional[TableHardlinkFields] = None
    ...
    __properties: ClassVar[List[str]] = ["hardlink", "fields", "linked_essences"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebHardlink from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of hardlink
        if self.hardlink:
            _dict['hardlink'] = self.hardlink.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebHardlink from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "hardlink": Hardlink.from_dict(obj["hardlink"]) if obj.get("hardlink") is not None else None,
            "fields": TableHardlinkFields.from_dict(obj["fields"]) if obj.get("fields") is not None else None,
