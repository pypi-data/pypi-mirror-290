...
class TableTripFields(BaseModel):
    ...
    cost: Optional[Union[Annotated[float, Field(le=10000000000, strict=True, ge=0)], Annotated[int, Field(le=2147483647, strict=True, ge=0)]]] = Field(default=0, description="Total cost calculated based on the performer's and transport tariffs. ")
    reward: Optional[Union[Annotated[float, Field(le=10000000000, strict=True, ge=-10000000000)], Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]]] = Field(default=0, description="The total reward for orders fulfillment.")
    profit: Optional[Union[Annotated[float, Field(le=10000000000, strict=True, ge=0)], Annotated[int, Field(le=2147483647, strict=True, ge=0)]]] = Field(default=0, description="The total profit is equal to the difference between the total reward (`reward`) and cost (`cost`). ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "time_window": BasicTimeWindow.from_dict(obj["time_window"]) if obj.get("time_window") is not None else None,
