...
class TableHardlinkFields(BaseModel):
    ...
    essence_type: Optional[StrictStr] = Field(default='HARDLINK', description="Essence type.")
    ...
    element_type: Optional[StrictStr] = Field(default='HARDLINK', description="Element type.")
    elements_count: Optional[Annotated[int, Field(le=15001, strict=True, ge=0)]] = Field(default=0, description="Elements count.")
    ...
    __properties: ClassVar[List[str]] = ["essence_key", "essence_type", "enabled", "pristine", "element_type", "elements_count", "trip_key", "trip_name"]
    ...
    def essence_type_validate_enum(cls, value):
        ...
        if value not in set(['HARDLINK', 'ELEMENT']):
    ...
    def element_type_validate_enum(cls, value):
        ...
        if value not in set(['HARDLINK', 'ORDER', 'PERFORMER_SHIFT', 'TRANSPORT_SHIFT']):
