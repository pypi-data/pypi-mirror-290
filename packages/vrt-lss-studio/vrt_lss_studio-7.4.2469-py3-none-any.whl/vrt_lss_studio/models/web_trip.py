...
class WebTrip(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["trip", "trip_statistics", "fields", "linked_essences"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "trip": Trip.from_dict(obj["trip"]) if obj.get("trip") is not None else None,
            "trip_statistics": TripStatistics.from_dict(obj["trip_statistics"]) if obj.get("trip_statistics") is not None else None,
            "fields": TableTripFields.from_dict(obj["fields"]) if obj.get("fields") is not None else None,
