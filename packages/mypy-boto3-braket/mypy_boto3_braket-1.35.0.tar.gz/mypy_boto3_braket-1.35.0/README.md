...
[boto3.Braket 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/braket.html#Braket)
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_braket/literals/).

```python
from mypy_boto3_braket.literals import AssociationTypeType


def check_value(value: AssociationTypeType) -> bool: ...
```
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_braket/type_defs/).
