...
def GetGraphRetrievalWithDS(url: str = "", requestId: str = "", authToken: str = "", retrieveQuery: str = ""):
    if url == "":
        url = BASE_URL_API
...
def BuildSC(url: str = "", requestId: str = "", authToken: str = "", WType: str = "BIN", source: str = "", refCaseType: str = ""):
    if url == "":
        url = BASE_URL_API

    result = requests.post(url + '/internals/buildsc',
                           json={'requestId': requestId, 'authToken': authToken, 'source': source, 'refCaseType': refCaseType})
    return result.status_code, result.reason, result.text

def GetSimilarCase(url: str = "", requestId: str = "", authToken: str = "", WType: str = "BIN", refCaseType: str = "", psCase: str = ""):
    if url == "":
        url = BASE_URL_API

    result = requests.post(url + '/internals/similaritysc',
                           json={'requestId': requestId, 'authToken': authToken, 'WType': WType, 'refCaseType': refCaseType, 'psCase': psCase})
    return result.status_code, result.reason, result.text
