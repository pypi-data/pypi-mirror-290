...
class QuotasApi:
    ...
    def read_quota(
        ...
        _param = self._read_quota_serialize(
    ...
    @validate_call
    def read_quota_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
