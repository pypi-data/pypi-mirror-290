...
class DataApi:
    ...
    def read_data(
        ...
        data_flow_stage: Annotated[Optional[StrictStr], Field(description="Data flow stage.")] = None,
    ...
    def _read_data_serialize(
        ...
        if data_flow_stage is not None:
            ...
            _query_params.append(('data_flow_stage', data_flow_stage))
