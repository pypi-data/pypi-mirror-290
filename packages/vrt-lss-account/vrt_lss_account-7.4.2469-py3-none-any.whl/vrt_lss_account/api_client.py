...
from vrt_lss_account.api_response import ApiResponse, T as ApiResponseT
import vrt_lss_account.models
from vrt_lss_account import rest
from vrt_lss_account.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(vrt_lss_account.models, klass)
