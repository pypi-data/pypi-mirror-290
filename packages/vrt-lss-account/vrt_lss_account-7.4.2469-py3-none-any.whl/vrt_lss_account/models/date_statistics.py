...
class DateStatistics(BaseModel):
    ...
    services: Annotated[List[ServiceStatistics], Field(min_length=0, max_length=8)] = Field(description="Statistics list for each service on the specified date.")
    __properties: ClassVar[List[str]] = ["date", "services"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date": obj.get("date"),
            "services": [ServiceStatistics.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None
        })
        return _obj
