...
class ServiceQuota(BaseModel):
    ...
    """ # noqa: E501
    service: Service
    processes: Annotated[List[ProcessQuota], Field(min_length=1, max_length=100)] = Field(description="List of quotas for a types of processes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "processes": [ProcessQuota.from_dict(_item) for _item in obj["processes"]] if obj.get("processes") is not None else None
        })
        return _obj
