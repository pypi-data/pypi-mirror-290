...
class ServiceStatistics(BaseModel):
    ...
    """ # noqa: E501
    service: Service
    processes: Annotated[List[ProcessStatistics], Field(min_length=1, max_length=100)] = Field(description="Usage statistics list of the specified service processes.")
    __properties: ClassVar[List[str]] = ["service", "processes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "processes": [ProcessStatistics.from_dict(_item) for _item in obj["processes"]] if obj.get("processes") is not None else None
        })
        return _obj
