...
from qtealeaves.abstracttns import _AbstractMatrixTN, _projector_for_rho_i
...
class LPTN(_AbstractMatrixTN):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._initialize_lptn(initialize)
    ...
    def _initialize_lptn(self, initialize):
        """
    ...
    def apply_projective_operator(self, site, selected_output=None, remove=False):
        ...
        if remove:
            ...
            raise Exception("Cannot remove site in projection for LPTN (for now).")
    ...
    def set_singvals_on_link(self, pos_a, pos_b, s_vals):
        ...
        logger.warning("LPTN cannot store singular values yet.")
