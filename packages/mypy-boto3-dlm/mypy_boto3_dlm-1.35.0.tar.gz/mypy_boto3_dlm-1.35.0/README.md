...
[boto3.DLM 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/dlm.html#DLM)
...
- Install `boto3-stubs[dlm]` in your environment:
...
Install `boto3-stubs-lite[dlm]` in your environment:
...
- Install `boto3-stubs[dlm]` with services you use in your environment:
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_dlm/literals/).

```python
from mypy_boto3_dlm.literals import DefaultPoliciesTypeValuesType


def check_value(value: DefaultPoliciesTypeValuesType) -> bool: ...
```
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_dlm/type_defs/).
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_dlm/)
