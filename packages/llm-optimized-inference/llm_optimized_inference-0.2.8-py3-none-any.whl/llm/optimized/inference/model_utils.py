...
def get_best_engine(config_path, inference_config_path):
    """Get best engine."""
    if inference_config_path and os.path.exists(inference_config_path):
        inference_config = {}
...
def build_configs_from_model(mlmodel, model_path, config_path, tokenizer_path, inference_config_path):
