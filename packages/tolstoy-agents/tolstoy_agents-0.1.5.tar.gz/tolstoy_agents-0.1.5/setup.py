...
setup(
    name='tolstoy_agents',
    version='0.1.5',
    packages=find_packages(include=['tolstoy_agents', 'tolstoy_agents.*']),
    py_modules=[os.path.splitext(os.path.basename(path))[0] for path in glob("tolstoy_agents/*.py")],
    include_package_data=True,
    install_requires=[                        # List dependencies here
        # Add your dependencies here, e.g., 'requests', 'numpy', etc.
    ],
    author='Tolstoy',                       # Your name
    author_email='tolstoy@tolstoy.com',    # Your email
