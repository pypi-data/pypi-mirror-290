...
class CalculatePumpDischargePressure(UnitModuleAbstract):
    ...
    def step(self, loop):
        ...
        """Calculate discharge pressure vie the pressure dop from wellhead to ESP"""
        u = dict()
        discharge_pressure = []
