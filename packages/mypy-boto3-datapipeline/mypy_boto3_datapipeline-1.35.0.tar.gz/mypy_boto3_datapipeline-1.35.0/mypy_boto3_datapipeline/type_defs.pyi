...
__all__ = (
    ...
    "PipelineObjectExtraOutputTypeDef",
...
PipelineObjectExtraOutputTypeDef = TypedDict(
    "PipelineObjectExtraOutputTypeDef",
    {
        "id": str,
        "name": str,
...
DescribeObjectsOutputTypeDef = TypedDict(
    "DescribeObjectsOutputTypeDef",
    {
        "pipelineObjects": List[PipelineObjectExtraOutputTypeDef],
        "marker": str,
        "hasMoreResults": bool,
        "ResponseMetadata": ResponseMetadataTypeDef,
    },
...
PipelineObjectUnionTypeDef = Union[PipelineObjectTypeDef, PipelineObjectExtraOutputTypeDef]
