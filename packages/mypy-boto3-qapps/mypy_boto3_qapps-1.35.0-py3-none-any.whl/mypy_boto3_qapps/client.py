...
class QAppsClient(BaseClient):
    ...
    def delete_q_app(self, *, instanceId: str, appId: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def get_q_app(self, *, instanceId: str, appId: str) -> GetQAppOutputTypeDef:
        """
    ...
    def get_q_app_session(self, *, instanceId: str, sessionId: str) -> GetQAppSessionOutputTypeDef:
        """
