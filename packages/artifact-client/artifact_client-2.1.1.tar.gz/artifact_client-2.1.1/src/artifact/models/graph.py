...
class Graph(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "document_ids", "documents", "edge_count", "host", "index_failure_count", "index_interval", "merged_graphml_url", "name", "node_count", "organization_uuid", "status", "summarized_graphml_url", "updated_at", "uuid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "documents": [DocumentMeta.from_dict(_item) for _item in obj["documents"]] if obj.get("documents") is not None else None,
