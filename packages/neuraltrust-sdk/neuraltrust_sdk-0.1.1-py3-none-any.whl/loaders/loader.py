...
from interfaces.neuraltrust import NeuralTrustFilters
...
class Loader(BaseLoader):
    ...
    def load_neuraltrust_runs(
        self,
        filters: Optional[NeuralTrustFilters] = None,
        limit: int = 10,
    ):
        """
        ...
        """
        self._raw_dataset = NeuralTrustApiService.fetch_runs(
        ...
        for raw_dataset in self._raw_dataset:
            ...
            processed_instance = {
                "id": raw_dataset_dict['id'],
                "query": raw_dataset_dict['user_query'],
                "context": context,
                "conversation_history": raw_dataset_dict['conversation_history'],
