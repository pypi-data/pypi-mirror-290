...
class BaseLoader(ABC):
    ...
    def load(self, format: str, **kwargs) -> List[DataPoint]:
        ...
        elif format == LoadFormat.NEURALTRUST.value:
            return self.load_neuraltrust_runs(**kwargs)
        else:
    ...
    @abstractmethod
    def load_neuraltrust_runs(self, data: dict) -> List[DataPoint]:
        """
        Loads and processes data from a dictionary of NeuralTrust inferences.
        """
        pass
