...
class BaseEvaluator(ABC):
    ...
    def run(self, **kwargs) -> BatchRunResult:
        ...
        """
        #NeuralTrustApiService.log_usage(eval_name=self.name, run_type="batch")
    ...
    def _log_eval_results_to_neuraltrust(self, eval_results: List[EvalResult]):
        ...
        try:
            ...
            run = {
                ...
                'evaluationSetId': eval_results[0]['evaluation_set_id'],
            ...
            NeuralTrustApiService.log_eval_run(run)
            NeuralTrustApiService.log_eval_details(details)
            NeuralTrustApiService.update_testsets(testsets)
        except Exception as e:
    ...
    def print_eval_results(self, eval_results):
        table_data = []
        headers = ["Query", "Response", "Expected Response", "Failure", "Score"]
