...
class EvalRunner:
    ...
    def eval_results_link(eval_request_id: str):
        return f"https://app.neuraltrust.ai/develop/request/{eval_request_id}"
    ...
    def _create_eval_request(eval_suite_name: str, data) -> Optional[str]:
        try:
            eval_request_id = NeuralTrustLoggingHelper.create_eval_request(
    ...
    def _log_experiment(experiment, eval_request_id: Optional[str]):
        try:
            if experiment is not None and eval_request_id is not None:
                NeuralTrustLoggingHelper.log_experiment(
    ...
    def _log_evaluation_results(
        ...
        if eval_request_id:
            try:
                NeuralTrustLoggingHelper.log_eval_results(
                    eval_request_id=eval_request_id,
    ...
    def _log_eval_results_with_config(
        ...
        try:
            ...
            llm_judge_model = getattr(eval, "_model", None)
            llm_target_model = getattr(eval, "_custom_model", None)
            NeuralTrustLoggingHelper.log_eval_results_with_config(
    ...
    def run_suite(
        ...
        #NeuralTrustApiService.log_usage(eval_name=eval_suite_name, run_type="suite")
