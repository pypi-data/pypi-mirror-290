...
[boto3.ElasticLoadBalancing 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/elb.html#ElasticLoadBalancing)
...
Install `boto3-stubs-lite[elb]` in your environment:
