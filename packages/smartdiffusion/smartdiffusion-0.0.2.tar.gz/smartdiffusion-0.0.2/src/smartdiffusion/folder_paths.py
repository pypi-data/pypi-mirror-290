...
def set_custom_nodes_directory(path=None):
    global base_path
    global folder_names_and_paths
    folder_names_and_paths["custom_nodes"] = path or (
...
def set_models_directory(path=None):
    ...
    models_dir = path or os.path.join(base_path, "models")
    ...
    folder_names_and_paths["transformer"] = (
        [os.path.join(models_dir, "transformer")],
        supported_pt_extensions,
    )
    ...
    folder_names_and_paths["t5"] = (
        [os.path.join(models_dir, "t5")],
        supported_pt_extensions,
    )
