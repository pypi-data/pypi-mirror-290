...
from smartdiffusion.text_encoders import t5
import os
import torch
...
class HyditBertModel(sd1_clip.SDClipModel):
    def __init__(self, device="cpu", layer="last", layer_idx=None, dtype=None):
        ...
        super().__init__(
            ...
            dtype=dtype,
            special_tokens={"start": 101, "end": 102, "pad": 0},
...
class HyditTokenizer:
    def __init__(self, embedding_directory=None, tokenizer_data={}):
        ...
        self.mt5xl = MT5XLTokenizer(
            tokenizer_data={"spiece_model": mt5_tokenizer_data},
...
class HyditModel(torch.nn.Module):
    ...
    def encode_token_weights(self, token_weight_pairs):
        hydit_out = self.hydit_clip.encode_token_weights(
            token_weight_pairs["hydit_clip"]
        )
        ...
        return (
            ...
            hydit_out[1],
            {
                "attention_mask": hydit_out[2]["attention_mask"],
                "conditioning_mt5xl": mt5_out[0],
                "attention_mask_mt5xl": mt5_out[2]["attention_mask"],
            },
        )
