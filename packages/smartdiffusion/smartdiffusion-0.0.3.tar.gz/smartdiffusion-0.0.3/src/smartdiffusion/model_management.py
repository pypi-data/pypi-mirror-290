...
OOM_EXCEPTION = OutOfMemoryError
...
def load_models_gpu(
    models, memory_required=0, force_patch_weights=False, minimum_memory_required=None
):
    global vram_state
    ...
    if minimum_memory_required is None:
        ...
        minimum_memory_required = (
            max(inference_memory, minimum_memory_required) + 100 * 1024 * 1024
        )
    models = set(models)
