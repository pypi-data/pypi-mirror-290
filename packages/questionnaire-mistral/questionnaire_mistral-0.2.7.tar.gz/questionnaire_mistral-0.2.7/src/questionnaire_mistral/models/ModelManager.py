...
class ModelManager:
    ...
    def __call__(self, document: str, task: str, document_content: str, task_count: int):
        ...
        def question_answering(question, task_count):
            tasks = 5
        ...
        if task == 'text-generation':
            ...
            question_answering(question, task_count)
        elif task == 'multi-task':
            text_generation()
            question_answering('How many pages are in the book?Return only number', task_count)
