...
class TestCreateDerivedDatasetDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateDerivedDatasetDto:
        """Test CreateDerivedDatasetDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDerivedDatasetDto`
        """
        model = CreateDerivedDatasetDto()
        if include_optional:
    ...
    def testCreateDerivedDatasetDto(self):
        """Test CreateDerivedDatasetDto"""
