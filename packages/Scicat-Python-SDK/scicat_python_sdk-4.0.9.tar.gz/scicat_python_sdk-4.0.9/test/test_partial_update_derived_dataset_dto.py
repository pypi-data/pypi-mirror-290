...
class TestPartialUpdateDerivedDatasetDto(unittest.TestCase):
    """PartialUpdateDerivedDatasetDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PartialUpdateDerivedDatasetDto:
        """Test PartialUpdateDerivedDatasetDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PartialUpdateDerivedDatasetDto`
        """
        model = PartialUpdateDerivedDatasetDto()
        if include_optional:
            return PartialUpdateDerivedDatasetDto(
                owner_group = '',
                access_groups = [
                    ''
                    ],
    ...
    def testPartialUpdateDerivedDatasetDto(self):
        """Test PartialUpdateDerivedDatasetDto"""
