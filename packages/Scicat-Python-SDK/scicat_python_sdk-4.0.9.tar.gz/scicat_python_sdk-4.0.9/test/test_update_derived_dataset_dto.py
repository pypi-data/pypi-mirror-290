...
class TestUpdateDerivedDatasetDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateDerivedDatasetDto:
        """Test UpdateDerivedDatasetDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateDerivedDatasetDto`
        """
        model = UpdateDerivedDatasetDto()
        if include_optional:
    ...
    def testUpdateDerivedDatasetDto(self):
        """Test UpdateDerivedDatasetDto"""
