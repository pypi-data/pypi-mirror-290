...
class TestPartialUpdateRawDatasetDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PartialUpdateRawDatasetDto:
        """Test PartialUpdateRawDatasetDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PartialUpdateRawDatasetDto`
        """
        model = PartialUpdateRawDatasetDto()
        if include_optional:
    ...
    def testPartialUpdateRawDatasetDto(self):
        """Test PartialUpdateRawDatasetDto"""
