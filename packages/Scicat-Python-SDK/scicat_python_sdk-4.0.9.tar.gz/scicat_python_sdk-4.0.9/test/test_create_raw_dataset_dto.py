...
class TestCreateRawDatasetDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateRawDatasetDto:
        """Test CreateRawDatasetDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateRawDatasetDto`
        """
        model = CreateRawDatasetDto()
        if include_optional:
    ...
    def testCreateRawDatasetDto(self):
        """Test CreateRawDatasetDto"""
