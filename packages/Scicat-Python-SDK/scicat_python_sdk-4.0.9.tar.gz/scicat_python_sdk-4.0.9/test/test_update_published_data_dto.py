...
class TestUpdatePublishedDataDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdatePublishedDataDto:
        """Test UpdatePublishedDataDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePublishedDataDto`
        """
        model = UpdatePublishedDataDto()
        if include_optional:
