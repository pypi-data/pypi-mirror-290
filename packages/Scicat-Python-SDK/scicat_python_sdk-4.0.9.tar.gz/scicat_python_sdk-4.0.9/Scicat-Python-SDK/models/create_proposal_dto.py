...
class CreateProposalDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ownerGroup", "accessGroups", "instrumentGroup", "pi_email", "pi_firstname", "pi_lastname", "email", "firstname", "lastname", "title", "abstract", "startTime", "endTime", "MeasurementPeriodList", "metadata", "proposalId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateProposalDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateProposalDto from a dict"""
        if obj is None:
            return None
