...
class PartialUpdatePolicyDto(BaseModel):
    ...
    manager: Optional[List[StrictStr]] = None
    ...
    archive_emails_to_be_notified: Optional[List[StrictStr]] = Field(default=None, alias="archiveEmailsToBeNotified")
    retrieve_email_notification: Optional[StrictBool] = Field(default=None, alias="retrieveEmailNotification")
    retrieve_emails_to_be_notified: Optional[List[StrictStr]] = Field(default=None, alias="retrieveEmailsToBeNotified")
