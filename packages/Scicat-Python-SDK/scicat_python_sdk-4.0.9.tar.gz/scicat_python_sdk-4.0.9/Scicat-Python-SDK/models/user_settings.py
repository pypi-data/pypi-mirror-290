...
class UserSettings(BaseModel):
    ...
    UserSettings
    """ # noqa: E501
    columns: List[Dict[str, Any]] = Field(description="Array of the users preferred columns in dataset table")
    ...
    __properties: ClassVar[List[str]] = ["columns", "datasetCount", "jobCount", "userId"]
