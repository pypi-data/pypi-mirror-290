...
class CreateOrigDatablockDto(BaseModel):
    ...
    dataset_id: StrictStr = Field(description="Persistent identifier of the dataset this orig datablock belongs to.", alias="datasetId")
    __properties: ClassVar[List[str]] = ["ownerGroup", "accessGroups", "instrumentGroup", "size", "chkAlg", "dataFileList", "datasetId"]
