...
class CreateMeasurementPeriodDto(BaseModel):
    """
    ...
    comment: Optional[StrictStr] = Field(default=None, description="Additional information relevant for this measurement period, e.g. if different accounts were used for data taking.")
    __properties: ClassVar[List[str]] = ["instrument", "start", "end", "comment"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateMeasurementPeriodDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateMeasurementPeriodDto from a dict"""
        if obj is None:
            return None
