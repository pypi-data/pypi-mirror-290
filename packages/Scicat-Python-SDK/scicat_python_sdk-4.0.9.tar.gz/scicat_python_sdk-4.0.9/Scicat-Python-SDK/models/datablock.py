...
class Datablock(BaseModel):
    ...
    dataset_id: StrictStr = Field(description="PID of the dataset to which the datablock belongs.", alias="datasetId")
    ...
    data_file_list: List[DataFile] = Field(description="Embedded schema definition for each file.", alias="dataFileList")
    __properties: ClassVar[List[str]] = ["createdBy", "updatedBy", "createdAt", "updatedAt", "ownerGroup", "accessGroups", "instrumentGroup", "isPublished", "_id", "datasetId", "archiveId", "size", "packedSize", "chkAlg", "version", "dataFileList"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Datablock from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Datablock from a dict"""
        if obj is None:
            return None
