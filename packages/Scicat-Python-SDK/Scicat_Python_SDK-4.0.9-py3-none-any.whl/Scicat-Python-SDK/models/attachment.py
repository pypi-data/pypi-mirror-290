...
class Attachment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdBy", "updatedBy", "createdAt", "updatedAt", "ownerGroup", "accessGroups", "instrumentGroup", "isPublished", "id", "thumbnail", "caption", "datasetId", "proposalId", "sampleId"]
