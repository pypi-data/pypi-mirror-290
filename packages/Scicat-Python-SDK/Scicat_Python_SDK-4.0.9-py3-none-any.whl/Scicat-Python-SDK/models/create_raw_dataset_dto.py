...
class CreateRawDatasetDto(BaseModel):
    """
    CreateRawDatasetDto
    """ # noqa: E501
    ...
    principal_investigator: StrictStr = Field(description="First name and last name of principal investigator(s). If multiple PIs are present, use a semicolon separated list. This field is required if the dataset is a Raw dataset.", alias="principalInvestigator")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateRawDatasetDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateRawDatasetDto from a dict"""
        if obj is None:
            return None
