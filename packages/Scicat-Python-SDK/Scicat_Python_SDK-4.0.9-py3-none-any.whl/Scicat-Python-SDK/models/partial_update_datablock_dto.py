...
class PartialUpdateDatablockDto(BaseModel):
    ...
    archive_id: Optional[StrictStr] = Field(default=None, description="Unique identifier given by the archive system to the stored datablock. This id is used when data is retrieved back.", alias="archiveId")
    ...
    packed_size: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total size in bytes of all files in the datablock when on archived.", alias="packedSize")
    ...
    data_file_list: Optional[List[DataFile]] = Field(default=None, alias="dataFileList")
    __properties: ClassVar[List[str]] = ["ownerGroup", "accessGroups", "instrumentGroup", "archiveId", "size", "packedSize", "chkAlg", "version", "dataFileList"]
