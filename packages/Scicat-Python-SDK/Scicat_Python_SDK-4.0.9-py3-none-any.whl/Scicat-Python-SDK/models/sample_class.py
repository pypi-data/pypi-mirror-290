...
class SampleClass(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdBy", "updatedBy", "createdAt", "updatedAt", "ownerGroup", "accessGroups", "instrumentGroup", "isPublished", "sampleId", "owner", "description", "sampleCharacteristics"]
