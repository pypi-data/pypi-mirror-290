...
class JobClass(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_id", "emailJobInitiator", "type", "creationTime", "executionTime", "jobParams", "jobStatusMessage", "datasetList", "jobResultObject", "ownerGroup"]
