...
class UpdateAttachmentDto(BaseModel):
    """
    UpdateAttachmentDto
    """ # noqa: E501
    ...
    caption: StrictStr
    __properties: ClassVar[List[str]] = ["ownerGroup", "accessGroups", "instrumentGroup", "thumbnail", "caption"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateAttachmentDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateAttachmentDto from a dict"""
        if obj is None:
            return None
