...
class UpdateOrigDatablockDto(BaseModel):
    """
    UpdateOrigDatablockDto
    """ # noqa: E501
    owner_group: Optional[StrictStr] = Field(default=None, description="Name of the group owning this item. If it is not specified, the datasets owner group is used.", alias="ownerGroup")
    ...
    data_file_list: List[DataFile] = Field(description="List of the files contained in this orig datablock.", alias="dataFileList")
    __properties: ClassVar[List[str]] = ["ownerGroup", "accessGroups", "instrumentGroup", "size", "chkAlg", "dataFileList"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateOrigDatablockDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateOrigDatablockDto from a dict"""
        if obj is None:
            return None
