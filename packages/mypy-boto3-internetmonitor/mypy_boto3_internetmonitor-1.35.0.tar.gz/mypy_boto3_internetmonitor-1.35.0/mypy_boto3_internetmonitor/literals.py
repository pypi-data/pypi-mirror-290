...
[Open documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_internetmonitor/literals/)
...
CloudWatchInternetMonitorServiceName = Literal["internetmonitor"]
ServiceName = Literal[
    "accessanalyzer",
    "account",
    "acm",
...
PaginatorName = Literal["list_health_events", "list_internet_events", "list_monitors"]
RegionName = Literal[
    "af-south-1",
    "ap-east-1",
    "ap-northeast-1",
