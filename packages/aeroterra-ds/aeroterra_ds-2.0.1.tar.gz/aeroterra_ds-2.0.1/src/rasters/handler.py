...
from .common import is_tiff, get_tiffs_from_folder, NUMBER_LIKE
...
@type_checker
def get_image_polygon_aux(image: ArrayLike,
                          transform_tif: Affine,
                          max_value: NUMBER_LIKE,
                          min_value: NUMBER_LIKE,
                          joined: bool,
                          crs_og: int,
                          crs_asked: int):
    """
...
def get_polygons_from_tiff(tiff_file: str,
                           max_value: Optional[NUMBER_LIKE]=None,
                           min_value: NUMBER_LIKE = 0,
                           joined: bool = True,
                           raster_band: int = 1,
...
def create_tiff_from_polygons(polygons: Dict[int, BaseGeometry],
                               ...
                               crs_pol: Optional[int] = None,
                               crs_img: Optional[int] = None,
...
def clip_tiff(tiff_file: str,
              ...
              geometry_crs: Optional[int] = None):
    """
