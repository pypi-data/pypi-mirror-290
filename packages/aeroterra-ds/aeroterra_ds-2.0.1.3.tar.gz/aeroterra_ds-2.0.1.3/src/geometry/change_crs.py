...
@type_checker
def change_crs_tuple_point(point: Tuple[float, float],
                           src_crs: int,
                           dst_crs: int):
    """
...
CHANGE_CRS_OPTIONS = Union[BaseGeometry, Tuple[float, float], List[BaseGeometry], Dict[Any, BaseGeometry], DataFrame]
@type_checker
...
@type_checker
def change_box_crs(bbox: Union[List[float], Tuple[float]],
                   bbox_crs: int,
                   new_crs: int):
    """
