...
def clone_layer(og_gis, og_id, new_gis, new_name=None, copy_data=True, publish_batch=BATCH_AMOUNT, number=None):
    ...
    new_layer = create_layer(layer_content, new_gis, new_name, publish_batch=publish_batch, is_sdf=True)
...
def get_time_enable(gis, layer_id, start, end=None, number=None):
    """
    Given a layer it set the time enable fields
