...
def batch_matmul(result_tensors, inputs, outputs, *, loc=None, ip=None) -> _ods_ir.Value:
...
class Conv1DNcwFcwOp(_ods_ir.OpView):
  ...
  def __init__(self, result_tensors, inputs, outputs, *, strides=None, dilations=None, loc=None, ip=None):
    ...
    if strides is not None: attributes["strides"] = (strides if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_680')) else
          _ods_ir.AttrBuilder.get('anonymous_680')(strides, context=_ods_context))
    if dilations is not None: attributes["dilations"] = (dilations if (
        isinstance(dilations, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_680')) else
          _ods_ir.AttrBuilder.get('anonymous_680')(dilations, context=_ods_context))
    results.extend(result_tensors)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
class Conv2DNchwFchwOp(_ods_ir.OpView):
  ...
  def __init__(self, result_tensors, inputs, outputs, *, strides=None, dilations=None, loc=None, ip=None):
    ...
    if strides is not None: attributes["strides"] = (strides if (
        isinstance(strides, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_690')) else
          _ods_ir.AttrBuilder.get('anonymous_690')(strides, context=_ods_context))
    if dilations is not None: attributes["dilations"] = (dilations if (
        isinstance(dilations, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_690')) else
          _ods_ir.AttrBuilder.get('anonymous_690')(dilations, context=_ods_context))
    results.extend(result_tensors)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
  ...
  def __init__(self, result_tensors, inputs, outputs, *, strides=None, dilations=None, loc=None, ip=None):
    ...
    if strides is not None: attributes["strides"] = (strides if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_718')) else
          _ods_ir.AttrBuilder.get('anonymous_718')(strides, context=_ods_context))
    if dilations is not None: attributes["dilations"] = (dilations if (
        isinstance(dilations, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_718')) else
          _ods_ir.AttrBuilder.get('anonymous_718')(dilations, context=_ods_context))
    results.extend(result_tensors)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
def matmul(result_tensors, inputs, outputs, *, cast=None, loc=None, ip=None) -> _ods_ir.Value:
...
def matmul_unsigned(result_tensors, inputs, outputs, *, loc=None, ip=None) -> _ods_ir.Value:
