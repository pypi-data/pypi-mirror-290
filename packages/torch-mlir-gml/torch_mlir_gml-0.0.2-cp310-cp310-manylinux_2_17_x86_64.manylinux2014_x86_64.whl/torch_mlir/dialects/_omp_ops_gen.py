...
class ParallelOp(_ods_ir.OpView):
  ...
  def __init__(self, allocate_vars, allocators_vars, reduction_vars, private_vars, *, if_expr_var=None, num_threads_var=None, reduction_vars_byref=None, reductions=None, proc_bind_val=None, privatizers=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def parallel(allocate_vars, allocators_vars, reduction_vars, private_vars, *, if_expr_var=None, num_threads_var=None, reduction_vars_byref=None, reductions=None, proc_bind_val=None, privatizers=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ParallelOp(allocate_vars=allocate_vars, allocators_vars=allocators_vars, reduction_vars=reduction_vars, private_vars=private_vars, if_expr_var=if_expr_var, num_threads_var=num_threads_var, reduction_vars_byref=reduction_vars_byref, reductions=reductions, proc_bind_val=proc_bind_val, privatizers=privatizers, loc=loc, ip=ip))
...
class PrivateClauseOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, type_, data_sharing_type, *, loc=None, ip=None):
    ...
    attributes["type"] = (type_ if (
    isinstance(type_, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_667')) else
      _ods_ir.AttrBuilder.get('anonymous_667')(type_, context=_ods_context))
...
class SimdOp(_ods_ir.OpView):
  ...
  def __init__(self, aligned_vars, nontemporal_vars, *, alignment_values=None, if_expr=None, order_val=None, order_mod=None, simdlen=None, safelen=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def simd(aligned_vars, nontemporal_vars, *, alignment_values=None, if_expr=None, order_val=None, order_mod=None, simdlen=None, safelen=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(SimdOp(aligned_vars=aligned_vars, nontemporal_vars=nontemporal_vars, alignment_values=alignment_values, if_expr=if_expr, order_val=order_val, order_mod=order_mod, simdlen=simdlen, safelen=safelen, loc=loc, ip=ip))
