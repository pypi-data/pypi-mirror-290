...
class TransferReadOp(_ods_ir.OpView):
  ...
  @builtins.property
  def in_bounds(self):
    if "in_bounds" not in self.operation.attributes:
      return None
  ...
  def in_bounds(self, value):
    ...
    elif "in_bounds" in self.operation.attributes:
      del self.operation.attributes["in_bounds"]
...
def transfer_read(vector, source, indices, permutation_map, padding, *, mask=None, in_bounds=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(TransferReadOp(vector=vector, source=source, indices=indices, permutation_map=permutation_map, padding=padding, mask=mask, in_bounds=in_bounds, loc=loc, ip=ip))
...
def transfer_write(result, vector, source, indices, permutation_map, *, mask=None, in_bounds=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(TransferWriteOp(result=result, vector=vector, source=source, indices=indices, permutation_map=permutation_map, mask=mask, in_bounds=in_bounds, loc=loc, ip=ip))
