...
def apply_patterns_linalg_erase_unnecessary_inputs(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ApplyEraseUnnecessaryInputsPatternsOp(loc=loc, ip=ip))
...
def apply_patterns_linalg_fold_unit_extent_dims_via_reshapes(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ApplyFoldUnitExtentDimsViaReshapesPatternsOp(loc=loc, ip=ip))
...
def apply_patterns_linalg_fold_unit_extent_dims_via_slices(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ApplyFoldUnitExtentDimsViaSlicesPatternsOp(loc=loc, ip=ip))
...
def apply_patterns_linalg_tiling_canonicalization(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ApplyTilingCanonicalizationPatternsOp(loc=loc, ip=ip))
...
def structured_bufferize_to_allocation(allocated_buffer, new_ops, target, *, memory_space=None, memcpy_op=None, alloc_op=None, bufferize_destination_only=None, emit_dealloc=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(BufferizeToAllocationOp(allocated_buffer=allocated_buffer, new_ops=new_ops, target=target, memory_space=memory_space, memcpy_op=memcpy_op, alloc_op=alloc_op, bufferize_destination_only=bufferize_destination_only, emit_dealloc=emit_dealloc, loc=loc, ip=ip))
...
def structured_continuous_tile_sizes(tile_sizes, chunk_sizes, target, dimension, target_size, *, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(ContinuousTileSizesOp(tile_sizes=tile_sizes, chunk_sizes=chunk_sizes, target=target, dimension=dimension, target_size=target_size, loc=loc, ip=ip))
...
def structured_convert_conv2d_to_img2col(img2col_tensor, transformed, target, *, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(ConvertConv2DToImg2ColOp(img2col_tensor=img2col_tensor, transformed=transformed, target=target, loc=loc, ip=ip))
...
def structured_convert_to_loops(result, target, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ConvertToLoopsOp(result=result, target=target, loc=loc, ip=ip))
...
def structured_decompose_interface(transformed, target, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(DecomposeInterfaceOp(transformed=transformed, target=target, loc=loc, ip=ip))
...
def structured_decompose(transformed, target, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(DecomposeOp(transformed=transformed, target=target, loc=loc, ip=ip))
...
def structured_eliminate_empty_tensors(target, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(EliminateLinalgOpAnchoredEmptyTensorsOp(target=target, loc=loc, ip=ip))
...
def structured_flatten_elementwise(transformed, target, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(FlattenElementwiseLinalgOp(transformed=transformed, target=target, loc=loc, ip=ip))
...
def structured_fuse_into_containing_op(fused_op, new_containing_op, producer_op, containing_op, *, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(FuseIntoContainingOp(fused_op=fused_op, new_containing_op=new_containing_op, producer_op=producer_op, containing_op=containing_op, loc=loc, ip=ip))
...
def structured_fuse(transformed, loops, target, *, tile_sizes=None, tile_interchange=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(FuseOp(transformed=transformed, loops=loops, target=target, tile_sizes=tile_sizes, tile_interchange=tile_interchange, loc=loc, ip=ip))
...
def structured_generalize(transformed, target, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(GeneralizeOp(transformed=transformed, target=target, loc=loc, ip=ip))
...
def structured_hoist_pad_build_packing_loop_nest(packing_loop, target, loop, *, transpose=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(HoistPadBuildPackingLoopNestOp(packing_loop=packing_loop, target=target, loop=loop, transpose=transpose, loc=loc, ip=ip))
...
def structured_hoist_pad(transformed, target, num_loops, *, transpose=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(HoistPadOp(transformed=transformed, target=target, num_loops=num_loops, transpose=transpose, loc=loc, ip=ip))
...
def structured_hoist_redundant_vector_broadcasts(transformed, target, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(HoistRedundantVectorBroadcastsOp(transformed=transformed, target=target, loc=loc, ip=ip))
...
def structured_hoist_redundant_vector_transfers(transformed, target, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(HoistRedundantVectorTransfersOp(transformed=transformed, target=target, loc=loc, ip=ip))
...
def structured_insert_slice_to_copy(transformed, target, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(InsertSliceToCopyOp(transformed=transformed, target=target, loc=loc, ip=ip))
...
def structured_interchange(transformed, target, *, iterator_interchange=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(InterchangeOp(transformed=transformed, target=target, iterator_interchange=iterator_interchange, loc=loc, ip=ip))
...
def structured_lower_pack(pad_op, expand_shape_op, transpose_op, target, *, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(LowerPackOp(pad_op=pad_op, expand_shape_op=expand_shape_op, transpose_op=transpose_op, target=target, loc=loc, ip=ip))
...
def structured_lower_unpack(empty_op, transpose_op, collapse_shape_op, extract_slice_op, target, *, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(LowerUnPackOp(empty_op=empty_op, transpose_op=transpose_op, collapse_shape_op=collapse_shape_op, extract_slice_op=extract_slice_op, target=target, loc=loc, ip=ip))
...
def structured_gpu_map_copy_to_threads(forall_op, tiled_op, target, total_num_threads, desired_bit_alignment, *, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(MapCopyToThreadsOp(forall_op=forall_op, tiled_op=tiled_op, target=target, total_num_threads=total_num_threads, desired_bit_alignment=desired_bit_alignment, loc=loc, ip=ip))
...
def structured_match(results_, target, *, ops=None, interface=None, op_attrs=None, filter_result_type=None, filter_operand_types=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(MatchOp(results_=results_, target=target, ops=ops, interface=interface, op_attrs=op_attrs, filter_result_type=filter_result_type, filter_operand_types=filter_operand_types, loc=loc, ip=ip))
...
def structured_multitile_sizes(low_size, high_size, split_point, target, dimension, target_size, *, divisor=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(MultiTileSizesOp(low_size=low_size, high_size=high_size, split_point=split_point, target=target, dimension=dimension, target_size=target_size, divisor=divisor, loc=loc, ip=ip))
...
def structured_pack_greedily(packed_op, target, matmul_packed_sizes, *, static_matmul_packed_sizes=None, matmul_padded_sizes_next_multiple_of=None, matmul_inner_dims_order=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(PackGreedilyOp(packed_op=packed_op, target=target, matmul_packed_sizes=matmul_packed_sizes, static_matmul_packed_sizes=static_matmul_packed_sizes, matmul_padded_sizes_next_multiple_of=matmul_padded_sizes_next_multiple_of, matmul_inner_dims_order=matmul_inner_dims_order, loc=loc, ip=ip))
...
def structured_pack(packed_op, target, packed_sizes, *, static_packed_sizes=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(PackOp(packed_op=packed_op, target=target, packed_sizes=packed_sizes, static_packed_sizes=static_packed_sizes, loc=loc, ip=ip))
...
def structured_pack_transpose(packed_op, pack_op, un_pack_op, target_pack_or_un_pack_op, target_linalg_op, *, outer_perm=None, inner_perm=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(PackTransposeOp(packed_op=packed_op, pack_op=pack_op, un_pack_op=un_pack_op, target_pack_or_un_pack_op=target_pack_or_un_pack_op, target_linalg_op=target_linalg_op, outer_perm=outer_perm, inner_perm=inner_perm, loc=loc, ip=ip))
...
class PadOp(_ods_ir.OpView):
  ...
  def __init__(self, padded, pad, copy, target, pad_to_multiple_of, *, padding_values=None, padding_dimensions=None, static_pad_to_multiple_of=None, pack_paddings=None, transpose_paddings=None, copy_back_op=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if pack_paddings is not None: attributes["pack_paddings"] = (pack_paddings if (
        isinstance(pack_paddings, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('I64ArrayAttr')) else
    ...
    if transpose_paddings is not None: attributes["transpose_paddings"] = (transpose_paddings if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_470')) else
          _ods_ir.AttrBuilder.get('anonymous_470')(transpose_paddings, context=_ods_context))
  ...
  @builtins.property
  def pack_paddings(self):
    return self.operation.attributes["pack_paddings"]

  @pack_paddings.setter
  def pack_paddings(self, value):
    if value is None:
      raise ValueError("'None' not allowed as value for mandatory attributes")
    self.operation.attributes["pack_paddings"] = value
...
def structured_pad(padded, pad, copy, target, pad_to_multiple_of, *, padding_values=None, padding_dimensions=None, static_pad_to_multiple_of=None, pack_paddings=None, transpose_paddings=None, copy_back_op=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(PadOp(padded=padded, pad=pad, copy=copy, target=target, pad_to_multiple_of=pad_to_multiple_of, padding_values=padding_values, padding_dimensions=padding_dimensions, static_pad_to_multiple_of=static_pad_to_multiple_of, pack_paddings=pack_paddings, transpose_paddings=transpose_paddings, copy_back_op=copy_back_op, loc=loc, ip=ip))
...
def structured_promote(transformed, target, *, operands_to_promote=None, use_full_tile_buffers=None, use_full_tiles_by_default=None, use_alloca=None, memory_space=None, mapping=None, alignment=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(PromoteOp(transformed=transformed, target=target, operands_to_promote=operands_to_promote, use_full_tile_buffers=use_full_tile_buffers, use_full_tiles_by_default=use_full_tiles_by_default, use_alloca=use_alloca, memory_space=memory_space, mapping=mapping, alignment=alignment, loc=loc, ip=ip))
...
def structured_replace(replacement, target, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ReplaceOp(replacement=replacement, target=target, loc=loc, ip=ip))
...
def structured_rewrite_in_destination_passing_style(transformed, target, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(RewriteInDestinationPassingStyleOp(transformed=transformed, target=target, loc=loc, ip=ip))
...
def structured_scalarize(result, target, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ScalarizeOp(result=result, target=target, loc=loc, ip=ip))
...
def structured_specialize(transformed, target, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(SpecializeOp(transformed=transformed, target=target, loc=loc, ip=ip))
...
class SplitOp(_ods_ir.OpView):
  ...
  def __init__(self, first, second, target, dimension, static_chunk_sizes, *, dynamic_chunk_sizes=None, multiway=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(target))
    if dynamic_chunk_sizes is not None: operands.append(_get_op_result_or_value(dynamic_chunk_sizes))
    _ods_context = _ods_get_default_loc_context(loc)
    attributes["dimension"] = (dimension if (
    isinstance(dimension, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('I64Attr')) else
...
def structured_split(first, second, target, dimension, static_chunk_sizes, *, dynamic_chunk_sizes=None, multiway=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(SplitOp(first=first, second=second, target=target, dimension=dimension, static_chunk_sizes=static_chunk_sizes, dynamic_chunk_sizes=dynamic_chunk_sizes, multiway=multiway, loc=loc, ip=ip))
...
def structured_split_reduction(init_or_alloc_op, fill_op, split_linalg_op, combining_linalg_op, target, *, split_factor=None, insert_split_dimension=None, inner_parallel=None, use_scaling_algorithm=None, use_alloc=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(SplitReductionOp(init_or_alloc_op=init_or_alloc_op, fill_op=fill_op, split_linalg_op=split_linalg_op, combining_linalg_op=combining_linalg_op, target=target, split_factor=split_factor, insert_split_dimension=insert_split_dimension, inner_parallel=inner_parallel, use_scaling_algorithm=use_scaling_algorithm, use_alloc=use_alloc, loc=loc, ip=ip))
...
class TileReductionUsingForOp(_ods_ir.OpView):
  ...
  def __init__(self, fill_op, split_linalg_op, combining_linalg_op, for_op, target, *, tile_sizes=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def structured_tile_reduction_using_for(fill_op, split_linalg_op, combining_linalg_op, for_op, target, *, tile_sizes=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(TileReductionUsingForOp(fill_op=fill_op, split_linalg_op=split_linalg_op, combining_linalg_op=combining_linalg_op, for_op=for_op, target=target, tile_sizes=tile_sizes, loc=loc, ip=ip))
...
def structured_tile_using_forall(tiled_op, forall_op, target, num_threads, tile_sizes, *, packed_num_threads=None, packed_tile_sizes=None, static_num_threads=None, static_tile_sizes=None, mapping=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return _get_op_result_or_op_results(TileUsingForallOp(tiled_op=tiled_op, forall_op=forall_op, target=target, num_threads=num_threads, tile_sizes=tile_sizes, packed_num_threads=packed_num_threads, packed_tile_sizes=packed_tile_sizes, static_num_threads=static_num_threads, static_tile_sizes=static_tile_sizes, mapping=mapping, loc=loc, ip=ip))
...
def structured_transpose_conv2d(transformed, target, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(TransposeConv2DOp(transformed=transformed, target=target, loc=loc, ip=ip))
...
def structured_transpose_matmul(transformed, target, *, input_to_transpose=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(TransposeMatmulOp(transformed=transformed, target=target, inputToTranspose=input_to_transpose, loc=loc, ip=ip))
...
def structured_vectorize(target, vector_sizes, *, static_vector_sizes=None, vectorize_nd_extract=None, scalable_sizes=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(VectorizeOp(target=target, vector_sizes=vector_sizes, static_vector_sizes=static_vector_sizes, vectorize_nd_extract=vectorize_nd_extract, scalable_sizes=scalable_sizes, loc=loc, ip=ip))
