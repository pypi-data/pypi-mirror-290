...
class MotionGroupInfosApi:
    ...
    async def get_optimizer_configuration(
        ...
        # EXPERIMENTAL  > **Note:** This endpoint is experimental and might experience functional changes in the future.  Get the complete configuration which can be passed to the planner-optimizer (incl. motion group description, limits etc.) 
