...
class StoreObjectApi:
    ...
    async def store_object(
        ...
        Store any data as an object.  Using a key wich already conains an object will override the previously stored object. To prevent this you can use [getObjectMetadata](getObjectMetadata) to test the existens of objects.  Optional: Specify metadata as a dictionary with names and values. 
