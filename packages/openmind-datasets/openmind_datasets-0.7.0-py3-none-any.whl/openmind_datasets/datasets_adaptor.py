...
def config_adaptation():
    ...
    # Datasets
    config.S3_DATASETS_BUCKET_PREFIX = os.environ.get("OPENMIND_HUB_ENDPOINT", "https://telecom.openmind.cn")
    config.CLOUDFRONT_DATASETS_DISTRIB_PREFIX = os.environ.get("OPENMIND_HUB_ENDPOINT",
                                                               "https://telecom.openmind.cn")
    config.REPO_DATASETS_URL = os.environ.get("OPENMIND_HUB_ENDPOINT", "https://telecom.openmind.cn")
    # Metrics
    config.S3_METRICS_BUCKET_PREFIX = os.environ.get("OPENMIND_HUB_ENDPOINT", "https://telecom.openmind.cn")
    config.CLOUDFRONT_METRICS_DISTRIB_PREFIX = os.environ.get("OPENMIND_HUB_ENDPOINT",
                                                              "https://telecom.openmind.cn")
    config.REPO_METRICS_URL = os.environ.get("OPENMIND_HUB_ENDPOINT",
                                             "https://telecom.openmind.cn") + ("/api/v1/file/evaluate-metric/{"
                                                                               "path}/main/media/{name}")
    # Hub
    ...
    datasets.arrow_reader.HF_GCP_BASE_URL = os.environ.get("OPENMIND_HUB_ENDPOINT",
                                                           "https://telecom.openmind.cn") + "/api/v1/file"
