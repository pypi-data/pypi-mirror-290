...
MODEL_PRICE = {
    ...
    "gpt-4-0125-preview" : [30/1000000, 60/1000000],
...
class GPT:
    ...
    def cal_price(completion, model_name, exchange_rate = 1400):
        if model_name in MODEL_PRICE:
            ...
            return exchange_rate*(completion.usage.prompt_tokens*token_prices[0] + completion.usage.completion_tokens*token_prices[1])
