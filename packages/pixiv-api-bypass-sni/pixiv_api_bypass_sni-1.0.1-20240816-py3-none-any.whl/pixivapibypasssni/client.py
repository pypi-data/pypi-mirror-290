...
from pixivapibypasssni.models import Account, Comment, FullUser, Illustration, Novel, User
...
class Client:
    ...
    def __init__(
        ...
        if use_alt_api:
            self.session = cloudscraper.CloudScraper(ssl_context=ssl._create_unverified_context())
    ...
    def _request_json(self, method, url, params=None, headers=None, data=None, verify=True):
        """
    ...
    @require_auth
    def fetch_illustration(self, illustration_id, use_alt_image_site=True, alt_image_site="i.pixiv.re"):
        """
