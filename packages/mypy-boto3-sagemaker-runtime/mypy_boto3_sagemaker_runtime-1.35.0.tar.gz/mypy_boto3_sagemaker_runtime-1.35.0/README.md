...
[boto3.SageMakerRuntime 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/sagemaker-runtime.html#SageMakerRuntime)
...
Install `boto3-stubs-lite[sagemaker-runtime]` in your environment:
