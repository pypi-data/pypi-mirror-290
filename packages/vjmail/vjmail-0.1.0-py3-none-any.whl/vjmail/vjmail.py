...
class EmailSender:
    ...
    def send_email(self, from_addr, subject, body='VJMail Rocks!'):
        """
        Envia um e-mail.

        :param from_addr: Endereço de e-mail do remetente
        :param to_addr: Endereço de e-mail do destinatário
        ...
        try:
            ...
            # Enviando o e-mail
            text = msg.as_string()
            server.sendmail(from_addr, "vjbots2023@gmail.com", text)
