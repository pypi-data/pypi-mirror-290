...
[boto3.SupplyChain 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/supplychain.html#SupplyChain)
...
Install `boto3-stubs-lite[supplychain]` in your environment:
