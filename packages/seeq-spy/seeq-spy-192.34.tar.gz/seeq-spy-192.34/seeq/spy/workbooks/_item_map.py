...
class ItemMap:
    ...
    def __setstate__(self, state):
        ...
        (self._item_map, self._lookup_df, self._logs, self._dummy_items, self.only_override_maps) = state
    ...
    def add_dummy_item(self, dummy_item: pd.DataFrame):
        self._dummy_items = pd.concat([self._dummy_items, dummy_item])
