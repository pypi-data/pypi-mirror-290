...
from nagra_panorama_api.utils import clean_url_host, first, get_credentials_from_env
...
class XMLApi:
    ...
    def uncommited_changes_patch(self):
        """
        Gives detailed information about pending changes
        (e.g. xpath, owner, action, ...)
        """
    ...
    def get_routing_tables(self) -> List[types.RoutingTable]:
        ...
        # from nagra_panorama_api.xmlapi.utils import pprint
