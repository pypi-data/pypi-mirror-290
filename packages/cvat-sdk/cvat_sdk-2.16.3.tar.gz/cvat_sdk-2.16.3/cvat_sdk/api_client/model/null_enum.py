...
class INullEnum(IModelData):
    ...
    One of: "null"  # noqa: E501
    """

class NullEnum(ModelSimple, INullEnum):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech
    ...
    def __init__(self, *args, **kwargs):
        """NullEnum - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["null", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["null", ]  # noqa: E501
