...
def lazy_import():
    from cvat_sdk.api_client.model.file_info_type_enum import FileInfoTypeEnum
    globals()['FileInfoTypeEnum'] = FileInfoTypeEnum



class IFileInfo(IModelData):
    """
...
class FileInfo(ModelNormal, IFileInfo):
    """
    NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, type, mime_type, *args, **kwargs):  # noqa: E501
...
"""
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, type, mime_type, *args, **kwargs):  # noqa: E501
        """FileInfo - a model defined in OpenAPI
