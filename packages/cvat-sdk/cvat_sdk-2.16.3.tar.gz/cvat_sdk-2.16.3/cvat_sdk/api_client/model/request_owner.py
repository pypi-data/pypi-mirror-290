...
def lazy_import():
    from cvat_sdk.api_client.model.user_identifiers import UserIdentifiers
    globals()['UserIdentifiers'] = UserIdentifiers


class RequestOwner(ModelComposed):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, username, *args, **kwargs) -> RequestOwner:  # noqa: E501
        """RequestOwner - a model defined in OpenAPI
