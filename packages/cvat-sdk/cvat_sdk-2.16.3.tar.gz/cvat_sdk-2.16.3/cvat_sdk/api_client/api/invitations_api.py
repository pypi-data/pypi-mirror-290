...
from cvat_sdk.api_client.model.accept_invitation_read import AcceptInvitationRead
...
class InvitationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.accept_endpoint = _Endpoint(
            settings={
                'response_schema': (AcceptInvitationRead,),
                'auth': [
                    'basicAuth',
                    'csrfAuth',
                    'sessionAuth',
                ...
                'endpoint_path': '/api/invitations/{key}/accept',
                'operation_id': 'accept',
                'http_method': 'POST',
                'servers': None,
            },
        ...
        self.decline_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/invitations/{key}/decline',
                'operation_id': 'decline',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.resend_endpoint = _Endpoint(
            settings={
                'response_schema': None,
                'auth': [
                    'basicAuth',
                ...
                'endpoint_path': '/api/invitations/{key}/resend',
                'operation_id': 'resend',
                'http_method': 'POST',
                'servers': None,
            },
    ...
    def accept(
        ...
        **kwargs,
    ) -> typing.Tuple[typing.Optional[AcceptInvitationRead], urllib3.HTTPResponse]:
        """Accept an invitation  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass _async_call=True

        >>> thread = api.accept(key, _async_call=True)
        >>> result = thread.get()
        ...
        Returns:
            (AcceptInvitationRead, HTTPResponse)
    ...
    def decline(
        ...
        **kwargs,
        ...
        >>> thread = api.decline(key, _async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_request_auths'] = _request_auths
        kwargs['key'] = key
        return self.decline_endpoint.call_with_http_info(**kwargs)
    ...
    def resend(
        ...
        **kwargs,
        ...
        >>> thread = api.resend(key, _async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_request_auths'] = _request_auths
        kwargs['key'] = key
        return self.resend_endpoint.call_with_http_info(**kwargs)
    ...
    def retrieve(
        ...
        **kwargs,
        ...
        """Get invitation details  # noqa: E501
