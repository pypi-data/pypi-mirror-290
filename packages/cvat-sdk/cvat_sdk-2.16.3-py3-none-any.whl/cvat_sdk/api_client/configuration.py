...
class Configuration:
    ...
    conf = cvat_sdk.api_client.Configuration(
        ...
        api_key={
    ...
    def __init__(self,
        ...
        self.logger["package_logger"] = logging.getLogger("cvat_sdk.api_client")
    ...
    def auth_settings(self):
        ...
        if 'sessionAuth' in self.api_key:
            auth['sessionAuth'] = {
                'type': 'api_key',
                'in': 'cookie',
                'key': 'sessionid',
        ...
        if 'signatureAuth' in self.api_key:
            auth['signatureAuth'] = {
                'type': 'api_key',
                'in': 'query',
                'key': 'sign',
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: 2.16.3\n"\
               "SDK Package Version: 2.16.3".\
