...
def lazy_import():
    from cvat_sdk.api_client.model.frame_selection_method_enum import FrameSelectionMethodEnum
    ...
    globals()['FrameSelectionMethodEnum'] = FrameSelectionMethodEnum
...
class IJobWriteRequest(IModelData):
    """
    ...
    frame_selection_method: FrameSelectionMethodEnum # noqa: E501
    """
    [optional]
    """
    ...
    frames: typing.List[int] # noqa: E501
    """
    [optional]
    [int]
...
class JobWriteRequest(ModelNormal, IJobWriteRequest):
    """
    NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech
    ...
    Attributes:
      ...
      frame_selection_method (FrameSelectionMethodEnum): [optional]  # noqa: E501

      frame_count (int): The number of frames included in the job. Applicable only to the random frame selection . [optional]  # noqa: E501

      seed (int): The seed value for the random number generator. The same value will produce the same frame sets. Applicable only to the random frame selection. By default, a random value is used. . [optional]  # noqa: E501

      frames ([int]): The list of frame ids. Applicable only to the manual frame selection . [optional]  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, task_id, *args, **kwargs):  # noqa: E501
        """JobWriteRequest - a model defined in OpenAPI
...
"""
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, task_id, *args, **kwargs):  # noqa: E501
        """JobWriteRequest - a model defined in OpenAPI
