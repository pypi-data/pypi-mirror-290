...
class RequestsApi(object):
    ...
    def list(
        ...
        *,
        ...
        _async_call: bool = False,
        **kwargs,
    ) -> typing.Tuple[typing.Optional[PaginatedRequestList], urllib3.HTTPResponse]:
        ...
        Keyword Args:
            ...
            filter (str):  JSON Logic filter. This filter can be used to perform complex filtering by grouping rules.  Details about the syntax used can be found at the link: https://jsonlogic.com/   Available filter_fields: ['status', 'project_id', 'task_id', 'job_id', 'action', 'subresource', 'format'].. [optional]
    ...
    def retrieve(
        ...
        *,
        ...
        _async_call: bool = False,
        **kwargs,
    ) -> typing.Tuple[typing.Optional[Request], urllib3.HTTPResponse]:
