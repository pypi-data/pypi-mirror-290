...
class TasksApi(object):
    ...
    def create_annotations(
        ...
        **kwargs,
        ...
        """Import annotations into a task  # noqa: E501
         ...
         The request POST /api/tasks/id/annotations will initiate the import and will create the rq job on the server in which the import will be carried out. Please, use the PUT /api/tasks/id/annotations endpoint for checking status of the process.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass _async_call=True
    ...
    def create_data(
        ...
        *,
        ...
        _async_call: bool = False,
        **kwargs,
    ) -> typing.Tuple[typing.Optional[DataResponse], urllib3.HTTPResponse]:
    ...
    def retrieve_annotations(
        ...
        **kwargs,
        ...
        """Get task annotations or export them as a dataset in a specific format  # noqa: E501
    ...
    def retrieve_backup(
        ...
        **kwargs,
        ...
        """Back up a task  # noqa: E501

        Deprecation warning:     This endpoint will be deprecated in one of the next releases.     Consider using new API:     - POST /api/tasks/<task_id>/backup/export to initiate backup process     - GET /api/requests/<rq_id> to check process status,         where rq_id is request id returned on initializing request'   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass _async_call=True
    ...
    def update_annotations(
        ...
        **kwargs,
        ...
        """Replace task annotations / Get annotation import status  # noqa: E501

         To check the status of an import request:  After initiating the annotation import, you will receive an rq_id parameter. Make sure to include this parameter as a query parameter in your subsequent PUT /api/tasks/id/annotations requests to track the status of the import.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass _async_call=True
