    ...
    def generate_files(self, csv_logic_folder_path=None, localization_folder_path=None, directly_modify=False,
        ...
        if directly_modify and warning:
            ...
            if os.path.exists(os.path.join(current_folder, 'default_files/csv_logic')):
                print(
                    "A csv_logic folder already exists in this folder, using that instead")
                already_exist = True
            print(csv_logic_folder_path)
            if not already_exist: shutil.copytree(csv_logic_folder_path, os.path.join(current_folder, "default_files/csv_logic"))
            ...
            if not already_exist: shutil.copytree(localization_folder_path, os.path.join(current_folder, "default_files/localization"))
