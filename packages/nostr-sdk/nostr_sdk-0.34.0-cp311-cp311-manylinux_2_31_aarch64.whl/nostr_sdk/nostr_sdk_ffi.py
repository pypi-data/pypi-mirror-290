...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_add_relay() != 58887:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_add_relay_with_opts() != 36241:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_add_relays() != 46859:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_get_events_from() != 34355:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_get_events_of() != 28254:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_like() != 17749:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_mute_ids() != 26708:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_mute_public_keys() != 39159:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_relay() != 53414:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_relays() != 25563:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_repost() != 15487:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_event() != 56846:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_event_builder() != 57135:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_event_builder_to() != 63065:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_event_to() != 29322:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_msg() != 26109:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_signer() != 31951:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_subscribe() != 27244:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_subscribe_to() != 26336:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_subscribe_with_id() != 53663:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_subscriptions() != 20072:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_unmute_ids() != 55190:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_unmute_public_keys() != 32497:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_customnostrdatabase_save_event() != 44808:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_customnostrdatabase_has_event_already_been_saved() != 31021:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_customnostrdatabase_has_event_already_been_seen() != 60236:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_customnostrdatabase_has_event_id_been_deleted() != 63072:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_customnostrdatabase_has_coordinate_been_deleted() != 45636:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_customnostrdatabase_event_id_seen() != 22968:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_customnostrdatabase_event_seen_on_relays() != 3595:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_customnostrdatabase_count() != 49398:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_customnostrdatabase_query() != 32414:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_customnostrdatabase_delete() != 48524:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_customnostrdatabase_wipe() != 13488:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_nostrconnectsigneractions_approve() != 33577:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_nostrdatabase__none() != 38126:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_nostrdatabase_delete() != 19224:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_nostrdatabase_event_by_id() != 15873:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relay_url() != 1351:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relayblacklist_add_ids() != 56523:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relayblacklist_add_public_keys() != 28791:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relayblacklist_clear() != 40843:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relayblacklist_has_id() != 25951:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relayblacklist_has_public_key() != 23755:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relayblacklist_remove_id() != 32469:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relayblacklist_remove_ids() != 19470:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relayblacklist_remove_public_key() != 59175:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relayblacklist_remove_public_keys() != 53857:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_add_relay() != 60070:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_batch_event() != 37555:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_batch_event_to() != 15226:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_batch_msg() != 33910:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_relay() != 11676:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_relays() != 54295:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_remove_relay() != 40859:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_send_event() != 60050:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_send_event_to() != 59933:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_send_msg() != 65023:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_shutdown() != 24603:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_subscribe() != 60735:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_subscribe_to() != 20032:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_subscribe_with_id() != 28475:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_nostrdatabase_ndb() != 25092:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_nostrdatabase_sqlite() != 20589:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_nostrdatabase_sqlite_bounded() != 1908:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD2 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,ctypes.c_void_p,_UNIFFI_FOREIGN_FUTURE_COMPLETE_I8,ctypes.c_uint64,ctypes.POINTER(_UniffiForeignFuture),
)
_UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD3 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,ctypes.c_void_p,_UNIFFI_FOREIGN_FUTURE_COMPLETE_I8,ctypes.c_uint64,ctypes.POINTER(_UniffiForeignFuture),
)
_UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD4 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,ctypes.c_void_p,_UNIFFI_FOREIGN_FUTURE_COMPLETE_I8,ctypes.c_uint64,ctypes.POINTER(_UniffiForeignFuture),
)
_UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD5 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,ctypes.c_void_p,ctypes.c_void_p,_UNIFFI_FOREIGN_FUTURE_COMPLETE_I8,ctypes.c_uint64,ctypes.POINTER(_UniffiForeignFuture),
)
_UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD6 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,ctypes.c_void_p,_UniffiRustBuffer,_UNIFFI_FOREIGN_FUTURE_COMPLETE_VOID,ctypes.c_uint64,ctypes.POINTER(_UniffiForeignFuture),
)
_UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD7 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,ctypes.c_void_p,_UNIFFI_FOREIGN_FUTURE_COMPLETE_RUST_BUFFER,ctypes.c_uint64,ctypes.POINTER(_UniffiForeignFuture),
)
_UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD8 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,_UniffiRustBuffer,_UNIFFI_FOREIGN_FUTURE_COMPLETE_U64,ctypes.c_uint64,ctypes.POINTER(_UniffiForeignFuture),
)
_UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD9 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,_UniffiRustBuffer,_UNIFFI_FOREIGN_FUTURE_COMPLETE_RUST_BUFFER,ctypes.c_uint64,ctypes.POINTER(_UniffiForeignFuture),
)
_UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD10 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,ctypes.c_void_p,_UNIFFI_FOREIGN_FUTURE_COMPLETE_VOID,ctypes.c_uint64,ctypes.POINTER(_UniffiForeignFuture),
)
_UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD11 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,_UNIFFI_FOREIGN_FUTURE_COMPLETE_VOID,ctypes.c_uint64,ctypes.POINTER(_UniffiForeignFuture),
)
...
class _UniffiVTableCallbackInterfaceCustomNostrDatabase(ctypes.Structure):
    _fields_ = [
        ...
        ("has_event_already_been_saved", _UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD2),
        ("has_event_already_been_seen", _UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD3),
        ("has_event_id_been_deleted", _UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD4),
        ("has_coordinate_been_deleted", _UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD5),
        ("event_id_seen", _UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD6),
        ("event_seen_on_relays", _UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD7),
        ("count", _UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD8),
        ("query", _UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD9),
        ("delete", _UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD10),
        ("wipe", _UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD11),
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_add_relays.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_mute_ids.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_mute_public_keys.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_mute_public_keys.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_send_msg.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_unmute_ids.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_unmute_public_keys.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_unmute_public_keys.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_customnostrdatabase_has_event_already_been_saved.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_customnostrdatabase_has_event_already_been_saved.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_customnostrdatabase_has_event_already_been_seen.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_customnostrdatabase_has_event_already_been_seen.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_customnostrdatabase_has_event_id_been_deleted.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_customnostrdatabase_has_event_id_been_deleted.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_constructor_nostrdatabase_sqlite.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_sdk_ffi_fn_constructor_nostrdatabase_sqlite_bounded.argtypes = (
    _UniffiRustBuffer,
    ctypes.c_uint64,
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_constructor_nostrdatabase_sqlite_bounded.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_nostrdatabase__none.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_nostrdatabase__none.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_add_ids.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_add_public_keys.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_add_public_keys.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_clear.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_clear.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_has_id.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_has_id.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_has_public_key.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_has_public_key.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_remove_id.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_remove_id.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_remove_ids.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_remove_ids.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_remove_public_key.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_remove_public_key.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_remove_public_keys.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_remove_public_keys.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relaypool_batch_msg.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relaypool_send_msg.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_sdk_ffi_checksum_method_nostrdatabase__none.argtypes = (
)
_UniffiLib.uniffi_nostr_sdk_ffi_checksum_method_nostrdatabase__none.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_sdk_ffi_checksum_constructor_nostrdatabase_sqlite_bounded.argtypes = (
)
_UniffiLib.uniffi_nostr_sdk_ffi_checksum_constructor_nostrdatabase_sqlite_bounded.restype = ctypes.c_uint16
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def add_relay_with_opts(self, url: "str",opts: "RelayOptions") -> "bool":
        """
        Add new relay with custom `RelayOptions`
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def add_relays(self, relays: "typing.List[str]") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_add_relays(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeNostrSdkError,
    ...
    def blacklist(self, ) -> "RelayBlacklist":
        ...
        return _UniffiConverterTypeRelayBlacklist.lift(
            _uniffi_rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_blacklist,self._uniffi_clone_pointer(),)
        )
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def mute_ids(self, ids: "typing.List[EventId]") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_mute_ids(
                self._uniffi_clone_pointer(), 
    ...
    async def mute_public_keys(self, public_keys: "typing.List[PublicKey]") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_mute_public_keys(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def send_msg(self, msg: "ClientMessage") -> "Output":
        _UniffiConverterTypeClientMessage.check_lower(msg)
        
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_send_msg(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def unmute_ids(self, ids: "typing.List[EventId]") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_unmute_ids(
                self._uniffi_clone_pointer(), 
        _UniffiConverterSequenceTypeEventId.lower(ids)
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_void,
    ...
    async def unmute_public_keys(self, public_keys: "typing.List[PublicKey]") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_unmute_public_keys(
                self._uniffi_clone_pointer(), 
        _UniffiConverterSequenceTypePublicKey.lower(public_keys)
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_void,
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def has_event_already_been_saved(self, event_id: "EventId") -> "bool":
        """
        Check if [`Event`] has already been saved
        """
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_customnostrdatabase_has_event_already_been_saved(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def has_event_already_been_seen(self, event_id: "EventId") -> "bool":
        """
        Check if [`EventId`] has already been seen
        """
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_customnostrdatabase_has_event_already_been_seen(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypeEventId.lower(event_id)
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_i8,
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def has_event_id_been_deleted(self, event_id: "EventId") -> "bool":
        """
        Check if [`EventId`] has been deleted
        """
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_customnostrdatabase_has_event_id_been_deleted(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypeEventId.lower(event_id)
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_i8,
...
class _UniffiTraitImplCustomNostrDatabase:
    ...
    @_UNIFFI_CALLBACK_INTERFACE_CUSTOM_NOSTR_DATABASE_METHOD11
    def wipe(
            uniffi_handle,
            uniffi_future_callback,
            uniffi_callback_data,
...
class NostrDatabase:
    ...
    def ndb(cls, path: "str"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _uniffi_rust_call_with_error(_UniffiConverterTypeNostrSdkError,_UniffiLib.uniffi_nostr_sdk_ffi_fn_constructor_nostrdatabase_ndb,
        _UniffiConverterString.lower(path))
        return cls._make_instance_(pointer)


    @classmethod
    async def sqlite(cls, path: "str"):
        """
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_constructor_nostrdatabase_sqlite(
        _UniffiConverterString.lower(path)),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_pointer,
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_complete_pointer,
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_free_pointer,
            _UniffiConverterTypeNostrDatabase.lift,
...
_UniffiConverterTypeNostrSdkError,
    ...
    @classmethod
    async def sqlite_bounded(cls, path: "str",max_capacity: "int"):
        """
        ...
        _UniffiConverterUInt64.check_lower(max_capacity)
        

        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_constructor_nostrdatabase_sqlite_bounded(
        _UniffiConverterString.lower(path),
        _UniffiConverterUInt64.lower(max_capacity)),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_pointer,
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_complete_pointer,
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_free_pointer,
            _UniffiConverterTypeNostrDatabase.lift,
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def none(self, ) -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_nostrdatabase__none(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_void,
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_complete_void,
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def event_by_id(self, event_id: "EventId") -> "Event":
        """
        Get [`Event`] by [`EventId`]
        """
...
_UniffiConverterTypeNostrSdkError,
    ...
    def blacklist(self, ) -> "RelayBlacklist":
        ...
        return _UniffiConverterTypeRelayBlacklist.lift(
            _uniffi_rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relay_blacklist,self._uniffi_clone_pointer(),)
        )
...
class RelayBlacklist:
    ...
    def __init__(self, ids: "typing.Union[object, typing.List[EventId]]" = _DEFAULT,public_keys: "typing.Union[object, typing.List[PublicKey]]" = _DEFAULT):
        ...
        self._pointer = _uniffi_rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_constructor_relayblacklist_new,
        _UniffiConverterSequenceTypeEventId.lower(ids),
        _UniffiConverterSequenceTypePublicKey.lower(public_keys))
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _uniffi_rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_free_relayblacklist, pointer)

    def _uniffi_clone_pointer(self):
        return _uniffi_rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_clone_relayblacklist, self._pointer)
    ...
    def empty(cls, ):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _uniffi_rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_constructor_relayblacklist_empty,)
        return cls._make_instance_(pointer)
    ...
    async def add_ids(self, ids: "typing.List[EventId]") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_add_ids(
                self._uniffi_clone_pointer(), 
        _UniffiConverterSequenceTypeEventId.lower(ids)
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_void,
    ...
    async def add_public_keys(self, public_keys: "typing.List[PublicKey]") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_add_public_keys(
                self._uniffi_clone_pointer(), 
        _UniffiConverterSequenceTypePublicKey.lower(public_keys)
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_void,
    ...
    async def clear(self, ) -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_clear(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_void,
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_complete_void,
    ...
    async def has_id(self, id: "EventId") -> "bool":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_has_id(
                self._uniffi_clone_pointer(), 
    ...
    async def has_public_key(self, public_key: "PublicKey") -> "bool":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_has_public_key(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypePublicKey.lower(public_key)
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_i8,
    ...
    async def remove_id(self, id: "EventId") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_remove_id(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypeEventId.lower(id)
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_void,
    ...
    async def remove_ids(self, ids: "typing.List[EventId]") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_remove_ids(
                self._uniffi_clone_pointer(), 
        _UniffiConverterSequenceTypeEventId.lower(ids)
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_void,
    ...
    async def remove_public_key(self, public_key: "PublicKey") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_remove_public_key(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypePublicKey.lower(public_key)
            ),
            _UniffiLib.ffi_nostr_sdk_ffi_rust_future_poll_void,
    ...
    async def remove_public_keys(self, ids: "typing.List[PublicKey]") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayblacklist_remove_public_keys(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def batch_msg(self, msgs: "typing.List[ClientMessage]",opts: "RelaySendOptions") -> "Output":
        """
        Send multiple client messages at once to all connected relays
        """
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relaypool_batch_msg(
                self._uniffi_clone_pointer(), 
        _UniffiConverterSequenceTypeClientMessage.lower(msgs),
        _UniffiConverterTypeRelaySendOptions.lower(opts)
            ),
...
_UniffiConverterTypeNostrSdkError,
    ...
    def blacklist(self, ) -> "RelayBlacklist":
        ...
        return _UniffiConverterTypeRelayBlacklist.lift(
            _uniffi_rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relaypool_blacklist,self._uniffi_clone_pointer(),)
        )
...
_UniffiConverterTypeNostrSdkError,
    ...
    async def send_msg(self, msg: "ClientMessage",opts: "RelaySendOptions") -> "Output":
        """
        Send client message to all connected relays
        """
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relaypool_send_msg(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypeClientMessage.lower(msg),
        _UniffiConverterTypeRelaySendOptions.lower(opts)
            ),
...
class ConnectionMode:
    ...
    class TOR:
        ...
        def __str__(self):
            return "ConnectionMode.TOR()".format()
