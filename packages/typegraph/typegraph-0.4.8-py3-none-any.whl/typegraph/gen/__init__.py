...
class Root:
    ...
    def __init__(self, store: wasmtime.Store, import_object: RootImports) -> None:
        ...
        def lowering1_callee(caller: wasmtime.Caller, arg0: int, arg1: int, arg2: int, arg3: int, arg4: int) -> None:
            ptr = arg0
            len0 = arg1
            list = _decode_utf8(self._core_memory0, caller, ptr, len0)
            ptr6 = arg2
        ...
        lowering1_ty = wasmtime.FuncType([wasmtime.ValType.i32(), wasmtime.ValType.i32(), wasmtime.ValType.i32(), wasmtime.ValType.i32(), wasmtime.ValType.i32(), ], [])
        ...
        def lowering3_callee(caller: wasmtime.Caller, arg0: int, arg1: int, arg2: int) -> None:
            ptr = arg0
            len0 = arg1
            list = _decode_utf8(self._core_memory0, caller, ptr, len0)
            ...
            if isinstance(ret, Ok):
                ...
                raise TypeError("invalid variant specified for expected")
        lowering3_ty = wasmtime.FuncType([wasmtime.ValType.i32(), wasmtime.ValType.i32(), wasmtime.ValType.i32(), ], [])
        trampoline3 = wasmtime.Func(store, lowering3_ty, lowering3_callee, access_caller = True)
        def lowering4_callee(caller: wasmtime.Caller, arg0: int, arg1: int, arg2: int, arg3: int, arg4: int) -> None:
            ptr = arg0
            len0 = arg1
            list = _decode_utf8(self._core_memory0, caller, ptr, len0)
            ptr1 = arg2
            ...
            if isinstance(ret, Ok):
                ...
                raise TypeError("invalid variant specified for expected")
        lowering4_ty = wasmtime.FuncType([wasmtime.ValType.i32(), wasmtime.ValType.i32(), wasmtime.ValType.i32(), wasmtime.ValType.i32(), wasmtime.ValType.i32(), ], [])
        ...
        post_return5 = instance1["cabi_post_metatype:typegraph/utils#metagen-exec"]
        assert(isinstance(post_return5, wasmtime.Func))
        self._post_return5 = post_return5
        post_return6 = instance1["cabi_post_metatype:typegraph/utils#metagen-write-files"]
