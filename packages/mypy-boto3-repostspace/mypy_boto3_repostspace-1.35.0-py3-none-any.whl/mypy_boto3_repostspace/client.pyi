...
class RePostPrivateClient(BaseClient):
    ...
    def close(self) -> None:
        ...
        [Show boto3-stubs documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_repostspace/client/#close)
        """
    ...
    def delete_space(self, *, spaceId: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def deregister_admin(self, *, adminId: str, spaceId: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def register_admin(self, *, adminId: str, spaceId: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def send_invites(
        self, *, accessorIds: Sequence[str], body: str, spaceId: str, title: str
    ) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def update_space(
        self, *, spaceId: str, description: str = ..., roleArn: str = ..., tier: TierLevelType = ...
    ) -> EmptyResponseMetadataTypeDef:
        """
