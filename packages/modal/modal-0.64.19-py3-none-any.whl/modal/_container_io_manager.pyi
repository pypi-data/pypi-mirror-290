...
class FinalizedFunction:
    ...
    def __init__(
        self, callable: typing.Callable[..., typing.Any], is_async: bool, is_generator: bool, data_format: int
    ) -> None: ...
    def __repr__(self): ...
...
class IOContext:
    ...
    def _args_and_kwargs(self) -> typing.Tuple[typing.Tuple[typing.Any, ...], typing.Dict[str, typing.List]]: ...
...
class _ContainerIOManager:
    ...
    _heartbeat_condition: asyncio.locks.Condition
    ...
    def _generate_inputs(
        self, batch_max_size: int, batch_linger_ms: int
...
class ContainerIOManager:
    ...
    class __format_blob_data_spec(typing_extensions.Protocol):
        ...
        async def aio(self, *args, **kwargs) -> typing.Dict[str, typing.Any]: ...
    ...
    class __exit_context_spec(typing_extensions.Protocol):
        def __call__(self, started_at): ...
        async def aio(self, *args, **kwargs): ...

    exit_context: __exit_context_spec
