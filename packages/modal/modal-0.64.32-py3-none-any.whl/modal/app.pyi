...
class _App:
    ...
    def is_inside(self, image: typing.Optional[modal.image._Image] = None): ...
    def _set_local_app(
    ...
    def function(
        ...
        *,
        ...
        [typing.Union[typing.Callable[P, R], modal.partial_function._PartialFunction[P, R]]],
        modal.functions._Function[P, R],
    ]: ...
    def cls(
        self,
...
class App:
    ...
    def image(self, value): ...
    def _uncreate_all_objects(self): ...
    def is_inside(self, image: typing.Optional[modal.image.Image] = None): ...
    ...
    def function(
        ...
        *,
        ...
        [typing.Union[typing.Callable[P, R], modal.partial_function.PartialFunction[P, R]]],
        modal.functions.Function[P, R],
    ]: ...
    def cls(
        self,
        _warn_parentheses_missing: typing.Optional[bool] = None,
