...
def _validate_python_version(version: typing.Optional[str], allow_micro_granularity: bool = True) -> str: ...
def _dockerhub_python_version(
    builder_version: typing.Literal["2023.12", "2024.04"], python_version: typing.Optional[str] = None
) -> str: ...
...
class _Image(modal.object._Object):
    ...
    def _from_args(
        *,
        ...
        dockerfile_function: typing.Optional[
            typing.Callable[[typing.Literal["2023.12", "2024.04"]], DockerfileSpec]
        ] = None,
    ...
    @staticmethod
    def conda(python_version: typing.Optional[str] = None, force_build: bool = False) -> _Image: ...
    def conda_install(
        self,
        *packages: typing.Union[str, typing.List[str]],
    ...
    def run_function(
        ...
        timeout: typing.Optional[int] = 86400,
        force_build: bool = False,
        secret: typing.Optional[modal.secret._Secret] = None,
...
class Image(modal.object.Object):
    ...
    @staticmethod
    def conda(python_version: typing.Optional[str] = None, force_build: bool = False) -> Image: ...
    def conda_install(
        self,
        *packages: typing.Union[str, typing.List[str]],
        channels: typing.List[str] = [],
