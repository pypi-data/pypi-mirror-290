...
class _PartialFunction:
    ...
    batch_max_size: typing.Union[int, None]
    batch_wait_ms: typing.Union[int, None]
    ...
    def __init__(
        ...
        batch_max_size: typing.Union[int, None] = None,
        batch_wait_ms: typing.Union[int, None] = None,
    ): ...
