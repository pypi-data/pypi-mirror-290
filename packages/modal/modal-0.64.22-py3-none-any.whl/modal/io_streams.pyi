...
def _sandbox_logs_iterator(
    sandbox_id: str, file_descriptor: int, last_entry_id: typing.Union[str, None], client: modal.client._Client
) -> typing.AsyncIterator[typing.Tuple[typing.Union[modal_proto.api_pb2.TaskLogs, None], str]]: ...
def _container_process_logs_iterator(
    process_id: str, file_descriptor: int, last_entry_id: typing.Union[str, None], client: modal.client._Client
): ...
