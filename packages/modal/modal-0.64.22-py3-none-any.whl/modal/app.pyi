...
class _App:
    ...
    def run(
        ...
        show_progress: typing.Union[bool, None] = None,
        detach: bool = False,
    ...
    def _logs(self, client: typing.Union[modal.client._Client, None] = None) -> typing.AsyncGenerator[str, None]: ...
...
class App:
    ...
    class ___logs_spec(typing_extensions.Protocol):
        ...
        def aio(self, client: typing.Union[modal.client.Client, None] = None) -> typing.AsyncGenerator[str, None]: ...
