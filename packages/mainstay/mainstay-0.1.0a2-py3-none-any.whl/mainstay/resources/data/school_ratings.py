...
from ...types.data import school_rating_fetch_params
...
class SchoolRatingsResource(SyncAPIResource):
    ...
    def _fetch(
        self,
        *,
        addresses: Iterable[school_rating_fetch_params.Address],
        ...
        return self._post(
            ...
            body=maybe_transform({"addresses": addresses}, school_rating_fetch_params.SchoolRatingFetchParams),
        ...
        *,
        ...
        return await self._post(
            ...
            body=await async_maybe_transform(
                {"addresses": addresses}, school_rating_fetch_params.SchoolRatingFetchParams
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
