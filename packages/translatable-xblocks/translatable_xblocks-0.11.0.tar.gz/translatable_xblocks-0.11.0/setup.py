#!/usr/bin/env python
"""
Package metadata for translatable_xblocks.
"""
import os
import re
import sys
...
VERSION = get_version("translatable_xblocks", "__init__.py")
...
setup(
    ...
    version=VERSION,
    description="""Plugin for adding translation behavior to XBlocks""",
    long_description=README + "\n\n" + CHANGELOG,
    author="Nathan Sprenkle",
    author_email="nsprenkle@2u.org",
    url="https://github.com/edx/translatable-xblocks",
    packages=find_packages(
        include=["translatable_xblocks", "translatable_xblocks.*"],
        exclude=["*tests", "tests", "test_utils"],
    ),
    entry_points={
        "lms.djangoapp": [
            "translatable_xblocks = translatable_xblocks.apps:TranslatableXBlocksConfig",
        ],
        "cms.djangoapp": [
            "translatable_xblocks = translatable_xblocks.apps:TranslatableXBlocksConfig",
        ],
        "xblock.v1": [
            "html = translatable_xblocks.xblocks.html_block:HtmlBlock",
            "problem = translatable_xblocks.xblocks.capa_block:ProblemBlock",
            "video = translatable_xblocks.xblocks.video_block:VideoBlock",
        ],
    },
