...
[Open documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_dataexchange/literals/)
...
NotificationTypeType = Literal["DATA_DELAY", "DATA_UPDATE", "DEPRECATION", "SCHEMA_CHANGE"]
OriginType = Literal["ENTITLED", "OWNED"]
ProtocolTypeType = Literal["REST"]
SchemaChangeTypeType = Literal["ADD", "MODIFY", "REMOVE"]
...
DataExchangeServiceName = Literal["dataexchange"]
ServiceName = Literal[
    "accessanalyzer",
    "account",
    "acm",
