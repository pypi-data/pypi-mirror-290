...
class Tabella(RPCServer):
    def __init__(  # noqa: PLR0913
        ...
        *,
        ...
        routes: list[Route | WebSocketRoute] = [
            ...
            Route("/download-client", _routes.download_client),
        ]
    ...
    def _get_ws_function(self) -> Callable:
        ...
        async def ws_process_rpc(websocket: WebSocket) -> None:
            ...
            try:
                ...
                while True:
                    ...
                    await asyncio.create_task(_process_rpc(data))
    ...
    def _get_http_function(self) -> Callable:
