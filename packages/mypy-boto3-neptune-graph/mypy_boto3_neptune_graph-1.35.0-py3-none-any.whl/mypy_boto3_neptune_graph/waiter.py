...
class GraphAvailableWaiter(Waiter):
    ...
    def wait(self, *, graphIdentifier: str, WaiterConfig: WaiterConfigTypeDef = ...) -> None:
        """
...
class GraphSnapshotAvailableWaiter(Waiter):
    ...
    def wait(self, *, snapshotIdentifier: str, WaiterConfig: WaiterConfigTypeDef = ...) -> None:
        """
...
class ImportTaskCancelledWaiter(Waiter):
    ...
    def wait(self, *, taskIdentifier: str, WaiterConfig: WaiterConfigTypeDef = ...) -> None:
        """
