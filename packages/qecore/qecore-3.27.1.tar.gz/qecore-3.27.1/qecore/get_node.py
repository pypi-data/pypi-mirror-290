...
class GetNode:
    ...
    def __init__(self, context, **kwargs) -> None:
        ...
        self.position_high = string_to_int_tuple(
            kwargs.get("position_high", "1000000,1000000")
        )
        ...
        for _ in range(5):
            try:
                ...
                LOGGING.debug(f"Exception thrown when loading all applications: '{error}'")
            else:
        ...
        for _ in range(5):
            for application in application_objects:
                try:
                    ...
                    LOGGING.debug(f"Exception thrown while getting object name: '{error}'")
        ...
        try:
            found_node = self.root.findChild(
                ...
                and (
                    ...
                    or self.description == x.description
                )
                and (
