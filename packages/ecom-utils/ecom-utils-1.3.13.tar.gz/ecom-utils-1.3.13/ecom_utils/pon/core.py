...
ENDPOINT_STAGE = 'https://devapp8.chaco.gob.ar/ponapitest'
ENDPOINT_PROD = 'https://apps8.chaco.gob.ar/ponapi'

API_ENDPOINTS = {
	'get_token_application': '_endpointbase_/oauth/access_token',
	'obtener_jurisdicciones': '_endpointbase_/rest/ConsultaJurisdicciones',
	'obtener_oficinas': '_endpointbase_/rest/ConsultaOficinas',
	'consulta_cargos_agente': '_endpointbase_/rest/ConsultaCargosAgente'
}
