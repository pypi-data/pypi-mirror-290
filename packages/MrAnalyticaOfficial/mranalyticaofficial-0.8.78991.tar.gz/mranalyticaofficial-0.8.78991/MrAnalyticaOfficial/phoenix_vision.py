...
class PhoenixVision:
    def __init__(self, training_data_dir='training_data', model_path='face_recognition_model.keras'):
        ...
        self.model_path = os.path.join("C:\\Users\\mathe\\OneDrive\\Desktop\\m", model_path)
    ...
    def set_cam_ip(self, ip_address):
        ...
        try:
            ...
            self.cap = cv2.VideoCapture(self.camera_source)  # Inicializa self.cap aqui
            if not self.cap.isOpened():
                raise Exception(f"Erro ao abrir a câmera IP em {ip_address}")
        ...
        while True:
            ...
            if ret:
                ...
                for (x, y, w, h) in faces:
                    ...
                    if 0 <= label_id < len(self.labels) and prediction[0][label_id] > 0.5:
