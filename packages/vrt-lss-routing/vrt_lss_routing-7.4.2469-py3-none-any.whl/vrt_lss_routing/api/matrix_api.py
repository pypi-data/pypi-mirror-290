...
class MatrixApi:
    ...
    def run_matrix_calculation(
        self,
        matrix_task: Annotated[MatrixTask, Field(description="New request for matrix calculation.")],
        ...
        _param = self._run_matrix_calculation_serialize(
    ...
    @validate_call
    def run_matrix_calculation_with_http_info(
        self,
        matrix_task: Annotated[MatrixTask, Field(description="New request for matrix calculation.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def run_matrix_calculation_without_preload_content(
        self,
        matrix_task: Annotated[MatrixTask, Field(description="New request for matrix calculation.")],
        _request_timeout: Union[
            None,
    ...
    def _run_matrix_calculation_serialize(
        self,
        matrix_task,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/routing/matrix/calculation',
