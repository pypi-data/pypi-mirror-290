...
class MatrixTask(BaseModel):
    ...
    """ # noqa: E501
    waypoints: Annotated[List[RoutingMatrixWaypoint], Field(min_length=2, max_length=15001)] = Field(description="Array of geographical points to calculate the distances and times between them.")
