...
class RouteWaypoint(BaseModel):
    ...
    duration: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=16)]] = Field(default=None, description="Time duration according to [ISO 8601 duration](https://en.wikipedia.org/wiki/ISO_8601#Durations).")
    __properties: ClassVar[List[str]] = ["geopoint", "name", "duration"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RouteWaypoint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RouteWaypoint from a dict"""
        if obj is None:
            return None
