"""
Setup script for mypy-boto3-pinpoint-sms-voice.
"""
...
setup(
    ...
    description="Type annotations for boto3.PinpointSMSVoice 1.35.0 service generated with mypy-boto3-builder 7.26.0",
    classifiers=[
