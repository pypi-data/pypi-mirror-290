...
__all__ = (
    ...
    "ThingTypePropertiesExtraOutputTypeDef",
    ...
    "ViolationEventOccurrenceRangeExtraOutputTypeDef",
    ...
    "BehaviorCriteriaExtraOutputTypeDef",
    ...
    "MitigationActionParamsExtraOutputTypeDef",
...
AddThingsToThingGroupParamsExtraOutputTypeDef = TypedDict(
    "AddThingsToThingGroupParamsExtraOutputTypeDef",
    {
...
MetricValueExtraOutputTypeDef = TypedDict(
    "MetricValueExtraOutputTypeDef",
    {
        "count": NotRequired[int],
        "cidrs": NotRequired[List[str]],
...
DetectMitigationActionsTaskTargetExtraOutputTypeDef = TypedDict(
    "DetectMitigationActionsTaskTargetExtraOutputTypeDef",
    {
        "violationIds": NotRequired[List[str]],
        "securityProfileName": NotRequired[str],
...
ThingTypePropertiesExtraOutputTypeDef = TypedDict(
    "ThingTypePropertiesExtraOutputTypeDef",
    {
        "thingTypeDescription": NotRequired[str],
        "searchableAttributes": NotRequired[List[str]],
...
ViolationEventOccurrenceRangeExtraOutputTypeDef = TypedDict(
    "ViolationEventOccurrenceRangeExtraOutputTypeDef",
    {
        "startTime": datetime,
        "endTime": datetime,
...
BehaviorCriteriaExtraOutputTypeDef = TypedDict(
    "BehaviorCriteriaExtraOutputTypeDef",
    {
        "comparisonOperator": NotRequired[ComparisonOperatorType],
        "value": NotRequired[MetricValueExtraOutputTypeDef],
...
DetectMitigationActionsTaskTargetUnionTypeDef = Union[
    DetectMitigationActionsTaskTargetTypeDef, DetectMitigationActionsTaskTargetExtraOutputTypeDef
]
...
MitigationActionParamsExtraOutputTypeDef = TypedDict(
    "MitigationActionParamsExtraOutputTypeDef",
    {
        ...
        "addThingsToThingGroupParams": NotRequired[AddThingsToThingGroupParamsExtraOutputTypeDef],
...
ThingTypePropertiesUnionTypeDef = Union[
    ThingTypePropertiesTypeDef, ThingTypePropertiesExtraOutputTypeDef
]
...
BehaviorExtraOutputTypeDef = TypedDict(
    "BehaviorExtraOutputTypeDef",
    {
        "name": str,
        "metric": NotRequired[str],
        "metricDimension": NotRequired[MetricDimensionTypeDef],
        "criteria": NotRequired[BehaviorCriteriaExtraOutputTypeDef],
...
ViolationEventOccurrenceRangeUnionTypeDef = Union[
    ViolationEventOccurrenceRangeTypeDef, ViolationEventOccurrenceRangeExtraOutputTypeDef
]
...
MitigationActionParamsUnionTypeDef = Union[
    MitigationActionParamsTypeDef, MitigationActionParamsExtraOutputTypeDef
]
...
RepublishActionTypeDef = TypedDict(
    "RepublishActionTypeDef",
    {
        ...
        "topic": str,
        "qos": NotRequired[int],
        "headers": NotRequired[MqttHeadersTypeDef],
    },
)
...
BehaviorUnionTypeDef = Union[BehaviorTypeDef, BehaviorExtraOutputTypeDef]
