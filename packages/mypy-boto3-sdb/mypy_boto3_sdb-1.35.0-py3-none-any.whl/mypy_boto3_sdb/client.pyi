...
class SimpleDBClient(BaseClient):
    ...
    def close(self) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/sdb.html#SimpleDB.Client.close)
        [Show boto3-stubs documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_sdb/client/#close)
        """

    def create_domain(self, *, DomainName: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_domain(self, *, DomainName: str) -> EmptyResponseMetadataTypeDef:
        """
