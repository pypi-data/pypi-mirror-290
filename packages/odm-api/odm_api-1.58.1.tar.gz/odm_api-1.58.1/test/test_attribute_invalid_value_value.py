...
class TestAttributeInvalidValueValue(unittest.TestCase):
    """AttributeInvalidValueValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttributeInvalidValueValue:
        """Test AttributeInvalidValueValue
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttributeInvalidValueValue`
        """
        model = AttributeInvalidValueValue()
        if include_optional:
            return AttributeInvalidValueValue(
            )
        else:
            return AttributeInvalidValueValue(
        )
    ...
    def testAttributeInvalidValueValue(self):
        """Test AttributeInvalidValueValue"""
