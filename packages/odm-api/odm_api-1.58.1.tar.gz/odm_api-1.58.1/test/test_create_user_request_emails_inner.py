...
class TestCreateUserRequestEmailsInner(unittest.TestCase):
    """CreateUserRequestEmailsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateUserRequestEmailsInner:
        """Test CreateUserRequestEmailsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateUserRequestEmailsInner`
        """
        model = CreateUserRequestEmailsInner()
        if include_optional:
            return CreateUserRequestEmailsInner(
                type = 'work',
                value = '',
                primary = True
            )
    ...
    def testCreateUserRequestEmailsInner(self):
        """Test CreateUserRequestEmailsInner"""
