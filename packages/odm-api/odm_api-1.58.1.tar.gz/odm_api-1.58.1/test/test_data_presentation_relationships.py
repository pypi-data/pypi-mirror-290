...
class TestDataPresentationRelationships(unittest.TestCase):
    """DataPresentationRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataPresentationRelationships:
        """Test DataPresentationRelationships
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataPresentationRelationships`
        """
        model = DataPresentationRelationships()
        if include_optional:
            return DataPresentationRelationships(
                sample = '',
                cell = '',
                library = '',
                preparation = ''
    ...
    def testDataPresentationRelationships(self):
        """Test DataPresentationRelationships"""
