...
class TestJobRuntimeError(unittest.TestCase):
    """JobRuntimeError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobRuntimeError:
        """Test JobRuntimeError
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobRuntimeError`
        """
        model = JobRuntimeError()
        if include_optional:
            return JobRuntimeError(
                stage = '',
                stack = [
