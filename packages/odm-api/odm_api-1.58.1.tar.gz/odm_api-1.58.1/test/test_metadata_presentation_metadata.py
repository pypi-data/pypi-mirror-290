...
class TestMetadataPresentationMetadata(unittest.TestCase):
    """MetadataPresentationMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetadataPresentationMetadata:
        """Test MetadataPresentationMetadata
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetadataPresentationMetadata`
        """
        model = MetadataPresentationMetadata()
        if include_optional:
            return MetadataPresentationMetadata(
                source = '',
                name = '',
                public = True,
                id = '',
    ...
    def testMetadataPresentationMetadata(self):
        """Test MetadataPresentationMetadata"""
