    ...
    def make_instance(self, include_optional) -> FlowCytometryResponse:
        ...
        if include_optional:
            return FlowCytometryResponse(
                data = [
                    {itemId=itemId, itemOrigin={runSourceId=runSourceId,, runId=runId,, groupId=groupId}, metadata={}, feature={readoutType=readoutType, cellPopulation=cellPopulation, marker=marker}, value={value=0.8008281904610115}, runId=runId}
                    ],
                cursor = ''
            )
        else:
