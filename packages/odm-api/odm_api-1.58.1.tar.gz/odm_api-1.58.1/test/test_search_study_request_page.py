...
class TestSearchStudyRequestPage(unittest.TestCase):
    """SearchStudyRequestPage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchStudyRequestPage:
        """Test SearchStudyRequestPage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchStudyRequestPage`
        """
        model = SearchStudyRequestPage()
        if include_optional:
            return SearchStudyRequestPage(
                offset = 56,
                limit = 50
            )
        else:
    ...
    def testSearchStudyRequestPage(self):
        """Test SearchStudyRequestPage"""
