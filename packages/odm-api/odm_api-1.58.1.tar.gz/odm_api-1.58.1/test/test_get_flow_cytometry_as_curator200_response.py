        ...
        if include_optional:
            return GetFlowCytometryAsCurator200Response(
                ...
                item_origin = odm_api.models.get_expression_as_curator_200_response_item_origin.getExpressionAsCurator_200_response_itemOrigin(
                    ...
                    group_id = '', ),
                metadata = None,
                feature = odm_api.models.get_flow_cytometry_as_curator_200_response_feature.getFlowCytometryAsCurator_200_response_feature(
                    readout_type = '', 
                    cell_population = '', 
                    marker = '', ),
                value = odm_api.models.get_flow_cytometry_as_curator_200_response_value.getFlowCytometryAsCurator_200_response_value(
                    value = 1.337, )
            )
        else:
            return GetFlowCytometryAsCurator200Response(
