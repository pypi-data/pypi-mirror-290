...
class TestImportMetadataRequest(unittest.TestCase):
    """ImportMetadataRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImportMetadataRequest:
        """Test ImportMetadataRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImportMetadataRequest`
        """
        model = ImportMetadataRequest()
        if include_optional:
            return ImportMetadataRequest(
                source = 'HTTP',
                metadata_link = 'https://mybucket.s3.amazonaws.com/my-experiment/my-object-metadata.tsv',
    ...
    def testImportMetadataRequest(self):
        """Test ImportMetadataRequest"""
