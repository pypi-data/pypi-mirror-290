...
class TestGetFlowCytometryAsCurator200ResponseValue(unittest.TestCase):
    """GetFlowCytometryAsCurator200ResponseValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFlowCytometryAsCurator200ResponseValue:
        """Test GetFlowCytometryAsCurator200ResponseValue
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFlowCytometryAsCurator200ResponseValue`
        """
        model = GetFlowCytometryAsCurator200ResponseValue()
        if include_optional:
            return GetFlowCytometryAsCurator200ResponseValue(
                value = 1.337
            )
        else:
            return GetFlowCytometryAsCurator200ResponseValue(
    ...
    def testGetFlowCytometryAsCurator200ResponseValue(self):
        """Test GetFlowCytometryAsCurator200ResponseValue"""
