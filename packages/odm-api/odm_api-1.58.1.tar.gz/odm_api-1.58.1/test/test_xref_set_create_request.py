...
class TestXrefSetCreateRequest(unittest.TestCase):
    """XrefSetCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XrefSetCreateRequest:
        """Test XrefSetCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XrefSetCreateRequest`
        """
        model = XrefSetCreateRequest()
        if include_optional:
            return XrefSetCreateRequest(
                xref_set_type = 'gene-transcript',
                data_link = '"http://example-url.com/my-mapping.tsv"',
                data_source = 'arvados',
                metadata = None
            )
        else:
    ...
    def testXrefSetCreateRequest(self):
        """Test XrefSetCreateRequest"""
