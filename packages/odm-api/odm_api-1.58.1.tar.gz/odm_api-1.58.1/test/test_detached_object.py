...
class TestDetachedObject(unittest.TestCase):
    """DetachedObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DetachedObject:
        """Test DetachedObject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DetachedObject`
        """
        model = DetachedObject()
        if include_optional:
