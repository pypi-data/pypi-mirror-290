...
class TestGetExpressionAsCurator200ResponseItemOrigin(unittest.TestCase):
    """GetExpressionAsCurator200ResponseItemOrigin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetExpressionAsCurator200ResponseItemOrigin:
        """Test GetExpressionAsCurator200ResponseItemOrigin
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetExpressionAsCurator200ResponseItemOrigin`
        """
        model = GetExpressionAsCurator200ResponseItemOrigin()
        if include_optional:
            return GetExpressionAsCurator200ResponseItemOrigin(
                run_source_id = '',
                run_id = '',
                group_id = ''
            )
    ...
    def testGetExpressionAsCurator200ResponseItemOrigin(self):
        """Test GetExpressionAsCurator200ResponseItemOrigin"""
