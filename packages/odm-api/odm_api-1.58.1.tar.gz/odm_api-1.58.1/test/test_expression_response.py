    ...
    def make_instance(self, include_optional) -> ExpressionResponse:
        ...
        if include_optional:
            return ExpressionResponse(
                data = [
                    {itemId=itemId, itemOrigin={runSourceId=runSourceId,, runId=runId,, groupId=groupId}, metadata={}, expression=1.82, feature={genes=MYO9A,, groupingKey=VRSLGGISPSEDRR}, gene=gene, description=description, value={value=1.82}}
                    ],
                cursor = ''
            )
        else:
