...
class TestGetFlowCytometryAsCurator200ResponseFeature(unittest.TestCase):
    """GetFlowCytometryAsCurator200ResponseFeature unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFlowCytometryAsCurator200ResponseFeature:
        """Test GetFlowCytometryAsCurator200ResponseFeature
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFlowCytometryAsCurator200ResponseFeature`
        """
        model = GetFlowCytometryAsCurator200ResponseFeature()
        if include_optional:
            return GetFlowCytometryAsCurator200ResponseFeature(
                readout_type = '',
                cell_population = '',
                marker = ''
            )
    ...
    def testGetFlowCytometryAsCurator200ResponseFeature(self):
        """Test GetFlowCytometryAsCurator200ResponseFeature"""
