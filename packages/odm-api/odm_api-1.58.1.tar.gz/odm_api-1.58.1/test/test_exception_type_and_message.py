...
class TestExceptionTypeAndMessage(unittest.TestCase):
    """ExceptionTypeAndMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExceptionTypeAndMessage:
        """Test ExceptionTypeAndMessage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExceptionTypeAndMessage`
        """
        model = ExceptionTypeAndMessage()
        if include_optional:
            return ExceptionTypeAndMessage(
                type = '',
                message = ''
            )
        else:
    ...
    def testExceptionTypeAndMessage(self):
        """Test ExceptionTypeAndMessage"""
