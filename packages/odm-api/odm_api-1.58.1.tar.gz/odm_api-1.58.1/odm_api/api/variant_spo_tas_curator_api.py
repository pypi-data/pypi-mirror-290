...
class VariantSPoTAsCuratorApi:
    ...
    @validate_call
    def add_variants_as_curator(
        self,
        source: Optional[VariantSignalSource] = None,
        ...
        _param = self._add_variants_as_curator_serialize(
            source=source,
    ...
    @validate_call
    def add_variants_as_curator_with_http_info(
        self,
        source: Optional[VariantSignalSource] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def add_variants_as_curator_without_preload_content(
        self,
        source: Optional[VariantSignalSource] = None,
        _request_timeout: Union[
            None,
    ...
    def _add_variants_as_curator_serialize(
        self,
        source,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/as-curator/variants/vcf',
    ...
    @validate_call
    def delete_variant_group_as_curator(
        self,
        ...
        _param = self._delete_variant_group_as_curator_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_variant_group_as_curator_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_variant_group_as_curator_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_variant_group_as_curator_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def update_variant_as_curator(
        ...
        _param = self._update_variant_as_curator_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def update_variant_as_curator_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        body: Annotated[Optional[Dict[str, Any]], Field(description="Metadata in the form of `{key: value, key2: value2, ...}`")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_variant_as_curator_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        body: Annotated[Optional[Dict[str, Any]], Field(description="Metadata in the form of `{key: value, key2: value2, ...}`")] = None,
        _request_timeout: Union[
    ...
    def _update_variant_as_curator_serialize(
        self,
        id,
        body,
        _request_auth,
