...
class SampleSPoTAsCuratorApi:
    ...
    def add_samples_as_curator(
        ...
        ## Samples metadata import  This operation requires the URL of a samples metadata file which will be used to create sample objects.  Each record in the file should corresponds to a distinct sample.  ## Metadata content requirements:  1. The file should contain a column with name \"Sample Source\" - an id of external database,  where data came from (GEO, ArrayExpress and so on).  2. The file should contain a column with name \"Sample Source ID\" - the id of that object within that database.  3. All records should have distinct ID's (values for \"Sample Source ID\").  4. At least one record should be supplied.  ## Metadata file format  * Extension: any, `.zip` and `.gz` extensions are treated as archives and get decompressed  * Format: plain text, Tab-separated format (TSV), attribute names and record values are separated  with tabs (`U+0009`),  lines are separated with `CRLF` sequence (`U+000D U+000A`)  * Header: the first line is treated as table header that contains attribute names  * Records: the second line contains the values for each of the attributes described in the header line.  Values represent single string or list of strings. List values are separated  using the \"pipe\" `|` (`U+007C`)  separator. Values are trimmed of whitespace before parsing, and a literal `|`  (`U+007C`) character may be escaped by repeating it twice.  ## File sources  * Supported external sources (links): `http`/`https`/`ftp`
        ...
        _param = self._add_samples_as_curator_serialize(
            source=source,
    ...
    @validate_call
    def add_samples_as_curator_with_http_info(
        self,
        source: Optional[SampleSource] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def add_samples_as_curator_without_preload_content(
        self,
        source: Optional[SampleSource] = None,
        _request_timeout: Union[
            None,
    ...
    def _add_samples_as_curator_serialize(
        self,
        source,
        _request_auth,
        _content_type,
    ...
    def delete_sample_as_curator(
        ...
        _param = self._delete_sample_as_curator_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_sample_as_curator_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_sample_as_curator_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_sample_as_curator_serialize(
        self,
        id,
        _request_auth,
        _content_type,
