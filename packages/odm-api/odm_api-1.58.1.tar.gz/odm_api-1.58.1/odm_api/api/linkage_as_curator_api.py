...
class LinkageAsCuratorApi:
    ...
    @validate_call
    def delete_link_as_curator(
        self,
        first_id: Annotated[StrictStr, Field(description="Object ID (accession) (e.g. accession of study)")],
        second_id: Annotated[StrictStr, Field(description="Object ID (accession) (e.g. accession of study)")],
        ...
        :type first_id: str
        :param second_id: Object ID (accession) (e.g. accession of study) (required)
        :type second_id: str
        ...
        _param = self._delete_link_as_curator_serialize(
            first_id=first_id,
            second_id=second_id,
    ...
    @validate_call
    def delete_link_as_curator_with_http_info(
        self,
        first_id: Annotated[StrictStr, Field(description="Object ID (accession) (e.g. accession of study)")],
        second_id: Annotated[StrictStr, Field(description="Object ID (accession) (e.g. accession of study)")],
        first_type: Annotated[Optional[StrictStr], Field(description="Type of the object (e.g. study)")] = None,
    ...
    @validate_call
    def delete_link_as_curator_without_preload_content(
        self,
        first_id: Annotated[StrictStr, Field(description="Object ID (accession) (e.g. accession of study)")],
        second_id: Annotated[StrictStr, Field(description="Object ID (accession) (e.g. accession of study)")],
        first_type: Annotated[Optional[StrictStr], Field(description="Type of the object (e.g. study)")] = None,
    ...
    def _delete_link_as_curator_serialize(
        self,
        first_id,
        second_id,
        first_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/as-curator/links',
    ...
    def get_data_types_as_curator(
        ...
        _param = self._get_data_types_as_curator_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_data_types_as_curator_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_data_types_as_curator_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_data_types_as_curator_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/as-curator/data-types',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_data_types_links_as_curator(
        self,
        ...
        _param = self._get_data_types_links_as_curator_serialize(
            type=type,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_data_types_links_as_curator_with_http_info(
        self,
        type: Annotated[Optional[StrictStr], Field(description="Return only links with the specified data type.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_data_types_links_as_curator_without_preload_content(
        self,
        type: Annotated[Optional[StrictStr], Field(description="Return only links with the specified data type.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_data_types_links_as_curator_serialize(
        self,
        type,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/as-curator/data-types/links',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_links_by_ids_as_curator(
        self,
        ...
        _param = self._get_links_by_ids_as_curator_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_links_by_ids_as_curator_with_http_info(
        self,
        request: Optional[BatchOfIds] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_links_by_ids_as_curator_without_preload_content(
        self,
        request: Optional[BatchOfIds] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_links_by_ids_as_curator_serialize(
        self,
        request,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/as-curator/links/get-batch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_links_by_params_as_curator(
        self,
        first_id: Annotated[StrictStr, Field(description="Object ID (accession) (e.g. accession of study)")],
        first_type: Annotated[Optional[StrictStr], Field(description="Type of the object (e.g. study)")] = None,
        ...
        _param = self._get_links_by_params_as_curator_serialize(
            first_id=first_id,
            first_type=first_type,
            second_id=second_id,
            second_type=second_type,
    ...
    @validate_call
    def get_links_by_params_as_curator_with_http_info(
        self,
        first_id: Annotated[StrictStr, Field(description="Object ID (accession) (e.g. accession of study)")],
        first_type: Annotated[Optional[StrictStr], Field(description="Type of the object (e.g. study)")] = None,
        second_id: Annotated[Optional[StrictStr], Field(description="Object ID (accession) (e.g. accession of study)")] = None,
    ...
    @validate_call
    def get_links_by_params_as_curator_without_preload_content(
        self,
        first_id: Annotated[StrictStr, Field(description="Object ID (accession) (e.g. accession of study)")],
        first_type: Annotated[Optional[StrictStr], Field(description="Type of the object (e.g. study)")] = None,
        second_id: Annotated[Optional[StrictStr], Field(description="Object ID (accession) (e.g. accession of study)")] = None,
    ...
    def _get_links_by_params_as_curator_serialize(
        self,
        first_id,
        first_type,
        second_id,
    ...
    def save_links_as_curator(
        ...
        _param = self._save_links_as_curator_serialize(
            links=links,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def save_links_as_curator_with_http_info(
        self,
        links: Optional[List[Link]] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def save_links_as_curator_without_preload_content(
        self,
        links: Optional[List[Link]] = None,
        _request_timeout: Union[
            None,
    ...
    def _save_links_as_curator_serialize(
        self,
        links,
        _request_auth,
        _content_type,
