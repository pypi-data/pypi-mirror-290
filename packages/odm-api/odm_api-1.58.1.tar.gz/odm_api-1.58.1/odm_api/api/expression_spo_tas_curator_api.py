...
class ExpressionSPoTAsCuratorApi:
    ...
    @validate_call
    def add_expression_as_curator(
        self,
        source: Optional[ExpressionSignalSource] = None,
        ...
        _param = self._add_expression_as_curator_serialize(
            source=source,
    ...
    @validate_call
    def add_expression_as_curator_with_http_info(
        self,
        source: Optional[ExpressionSignalSource] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def add_expression_as_curator_without_preload_content(
        self,
        source: Optional[ExpressionSignalSource] = None,
        _request_timeout: Union[
            None,
    ...
    def _add_expression_as_curator_serialize(
        self,
        source,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/as-curator/expressions/gct',
    ...
    @validate_call
    def delete_expression_group_as_curator(
        self,
        ...
        _param = self._delete_expression_group_as_curator_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_expression_group_as_curator_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_expression_group_as_curator_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_expression_group_as_curator_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/as-curator/expressions/group/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_expression_as_curator(
        ...
        _param = self._get_expression_as_curator_serialize(
            id=id,
    ...
    @validate_call
    def get_expression_as_curator_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        response_format: Annotated[Optional[ResponseFormat], Field(description="Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.")] = None,
        returned_metadata_fields: Annotated[Optional[StrictStr], Field(description="The parameter defines amount of metadata attributes to return:  1. `minimal_data` - return metadata attributes according to the default template. 2. `extended_data_included` - return metadata attributes according to applied template, if object doesn’t have applied template, default template will be used. This is the default for User endpoints. 3. `original_data_included` - return all metadata attributes with values and null attributes, if they are present in the applied template. This is the default for Curator endpoints.")] = None,
    ...
    @validate_call
    def get_expression_as_curator_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        response_format: Annotated[Optional[ResponseFormat], Field(description="Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.")] = None,
        returned_metadata_fields: Annotated[Optional[StrictStr], Field(description="The parameter defines amount of metadata attributes to return:  1. `minimal_data` - return metadata attributes according to the default template. 2. `extended_data_included` - return metadata attributes according to applied template, if object doesn’t have applied template, default template will be used. This is the default for User endpoints. 3. `original_data_included` - return all metadata attributes with values and null attributes, if they are present in the applied template. This is the default for Curator endpoints.")] = None,
    ...
    def _get_expression_as_curator_serialize(
        self,
        id,
        response_format,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/as-curator/expressions/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_expression_by_version_as_curator(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        ...
        _param = self._get_expression_by_version_as_curator_serialize(
            id=id,
            version=version,
            response_format=response_format,
            returned_metadata_fields=returned_metadata_fields,
    ...
    @validate_call
    def get_expression_by_version_as_curator_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        version: Annotated[StrictStr, Field(description="Unique version of the object.")],
        response_format: Annotated[Optional[ResponseFormat], Field(description="Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.")] = None,
    ...
    @validate_call
    def get_expression_by_version_as_curator_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        version: Annotated[StrictStr, Field(description="Unique version of the object.")],
        response_format: Annotated[Optional[ResponseFormat], Field(description="Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.")] = None,
    ...
    def _get_expression_by_version_as_curator_serialize(
        self,
        id,
        version,
        response_format,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/as-curator/expressions/{id}/versions/{version}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_expression_data_as_curator(
        self,
        response_format: Annotated[Optional[ResponseFormat], Field(description="Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Filter by expression metadata (key-value metadata pair(s)). E.g. `\"Normalization Method\"=TPM`.")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Search for expression objects via a full text query over all expression metadata. E.g. `TPM`. Queries matching dictionary terms are automatically expanded to include synonyms.")] = None,
        ...
        run_filter: Annotated[Optional[List[StrictStr]], Field(description="Autogenerated numeric ID that corresponds to the column and is used to link data from the same run to a sample, library or preparation. Multiple values can be provided as a list.")] = None,
        run_source_filter: Annotated[Optional[List[StrictStr]], Field(description="Column name from the file to which all data for a sample, library or preparation is related. Multiple values can be provided as a list to retrieve data from multiple columns.")] = None,
        min_expression_level: Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Minimum threshold (inclusive) for returned expression values.")] = None,
        feature_list: Annotated[Optional[List[StrictStr]], Field(description="List of features to return. These features must match exactly the probe IDs in the GCT file. Example: `1552269_at`")] = None,
        ...
        _param = self._get_expression_data_as_curator_serialize(
            response_format=response_format,
            filter=filter,
            query=query,
            ...
            min_expression_level=min_expression_level,
    ...
    @validate_call
    def get_expression_data_as_curator_with_http_info(
        self,
        response_format: Annotated[Optional[ResponseFormat], Field(description="Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Filter by expression metadata (key-value metadata pair(s)). E.g. `\"Normalization Method\"=TPM`.")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Search for expression objects via a full text query over all expression metadata. E.g. `TPM`. Queries matching dictionary terms are automatically expanded to include synonyms.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExpressionResponse]:
        """Retrieve multiple expression data and metadata objects
    ...
    @validate_call
    def get_expression_data_as_curator_without_preload_content(
        self,
        response_format: Annotated[Optional[ResponseFormat], Field(description="Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Filter by expression metadata (key-value metadata pair(s)). E.g. `\"Normalization Method\"=TPM`.")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Search for expression objects via a full text query over all expression metadata. E.g. `TPM`. Queries matching dictionary terms are automatically expanded to include synonyms.")] = None,
    ...
    def _get_expression_data_as_curator_serialize(
        self,
        response_format,
        filter,
        query,
        ...
        if min_expression_level is not None:
            
            _query_params.append(('minExpressionLevel', min_expression_level))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/as-curator/expressions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_expression_group_as_curator(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        response_format: Annotated[Optional[ResponseFormat], Field(description="Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.")] = None,
        returned_metadata_fields: Annotated[Optional[StrictStr], Field(description="The parameter defines amount of metadata attributes to return:  1. `minimal_data` - return metadata attributes according to the default template. 2. `extended_data_included` - return metadata attributes according to applied template, if object doesn’t have applied template, default template will be used. This is the default for User endpoints. 3. `original_data_included` - return all metadata attributes with values and null attributes, if they are present in the applied template. This is the default for Curator endpoints.")] = None,
        ...
        _param = self._get_expression_group_as_curator_serialize(
            id=id,
            response_format=response_format,
            returned_metadata_fields=returned_metadata_fields,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_expression_group_as_curator_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        response_format: Annotated[Optional[ResponseFormat], Field(description="Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.")] = None,
        returned_metadata_fields: Annotated[Optional[StrictStr], Field(description="The parameter defines amount of metadata attributes to return:  1. `minimal_data` - return metadata attributes according to the default template. 2. `extended_data_included` - return metadata attributes according to applied template, if object doesn’t have applied template, default template will be used. This is the default for User endpoints. 3. `original_data_included` - return all metadata attributes with values and null attributes, if they are present in the applied template. This is the default for Curator endpoints.")] = None,
    ...
    @validate_call
    def get_expression_group_as_curator_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        response_format: Annotated[Optional[ResponseFormat], Field(description="Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.")] = None,
        returned_metadata_fields: Annotated[Optional[StrictStr], Field(description="The parameter defines amount of metadata attributes to return:  1. `minimal_data` - return metadata attributes according to the default template. 2. `extended_data_included` - return metadata attributes according to applied template, if object doesn’t have applied template, default template will be used. This is the default for User endpoints. 3. `original_data_included` - return all metadata attributes with values and null attributes, if they are present in the applied template. This is the default for Curator endpoints.")] = None,
    ...
    def _get_expression_group_as_curator_serialize(
        self,
        id,
        response_format,
        returned_metadata_fields,
    ...
    @validate_call
    def get_expression_group_by_run_as_curator(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        response_format: Annotated[Optional[ResponseFormat], Field(description="Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.")] = None,
        returned_metadata_fields: Annotated[Optional[StrictStr], Field(description="The parameter defines amount of metadata attributes to return:  1. `minimal_data` - return metadata attributes according to the default template. 2. `extended_data_included` - return metadata attributes according to applied template, if object doesn’t have applied template, default template will be used. This is the default for User endpoints. 3. `original_data_included` - return all metadata attributes with values and null attributes, if they are present in the applied template. This is the default for Curator endpoints.")] = None,
        ...
        _param = self._get_expression_group_by_run_as_curator_serialize(
            id=id,
            response_format=response_format,
            returned_metadata_fields=returned_metadata_fields,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_expression_group_by_run_as_curator_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        response_format: Annotated[Optional[ResponseFormat], Field(description="Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.")] = None,
        returned_metadata_fields: Annotated[Optional[StrictStr], Field(description="The parameter defines amount of metadata attributes to return:  1. `minimal_data` - return metadata attributes according to the default template. 2. `extended_data_included` - return metadata attributes according to applied template, if object doesn’t have applied template, default template will be used. This is the default for User endpoints. 3. `original_data_included` - return all metadata attributes with values and null attributes, if they are present in the applied template. This is the default for Curator endpoints.")] = None,
    ...
    @validate_call
    def get_expression_group_by_run_as_curator_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        response_format: Annotated[Optional[ResponseFormat], Field(description="Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.")] = None,
        returned_metadata_fields: Annotated[Optional[StrictStr], Field(description="The parameter defines amount of metadata attributes to return:  1. `minimal_data` - return metadata attributes according to the default template. 2. `extended_data_included` - return metadata attributes according to applied template, if object doesn’t have applied template, default template will be used. This is the default for User endpoints. 3. `original_data_included` - return all metadata attributes with values and null attributes, if they are present in the applied template. This is the default for Curator endpoints.")] = None,
    ...
    def _get_expression_group_by_run_as_curator_serialize(
        self,
        id,
        response_format,
        returned_metadata_fields,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/as-curator/expressions/group/by/run/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_expression_versions_as_curator(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_expression_versions_as_curator_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_expression_versions_as_curator_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_expression_versions_as_curator_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        _request_timeout: Union[
            None,
    ...
    def _get_expression_versions_as_curator_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/as-curator/expressions/{id}/versions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def search_expression_groups_as_curator(
        self,
        response_format: Annotated[Optional[ResponseFormat], Field(description="Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Filter by expression metadata (key-value metadata pair(s)). E.g. `\"Normalization Method\"=TPM`.")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Search for expression objects via a full text query over all expression metadata. E.g. `TPM`. Queries matching dictionary terms are automatically expanded to include synonyms.")] = None,
        ...
        _param = self._search_expression_groups_as_curator_serialize(
            response_format=response_format,
            filter=filter,
            query=query,
            search_specific_terms=search_specific_terms,
    ...
    @validate_call
    def search_expression_groups_as_curator_with_http_info(
        self,
        response_format: Annotated[Optional[ResponseFormat], Field(description="Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Filter by expression metadata (key-value metadata pair(s)). E.g. `\"Normalization Method\"=TPM`.")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Search for expression objects via a full text query over all expression metadata. E.g. `TPM`. Queries matching dictionary terms are automatically expanded to include synonyms.")] = None,
    ...
    @validate_call
    def search_expression_groups_as_curator_without_preload_content(
        self,
        response_format: Annotated[Optional[ResponseFormat], Field(description="Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Filter by expression metadata (key-value metadata pair(s)). E.g. `\"Normalization Method\"=TPM`.")] = None,
        query: Annotated[Optional[StrictStr], Field(description="Search for expression objects via a full text query over all expression metadata. E.g. `TPM`. Queries matching dictionary terms are automatically expanded to include synonyms.")] = None,
    ...
    def _search_expression_groups_as_curator_serialize(
        self,
        response_format,
        filter,
        query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/as-curator/expressions/group',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def search_expression_runs_as_curator(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        page_offset: Annotated[Optional[StrictInt], Field(description="Show the page {pageOffset+1} results from the start of the results. E.g. 100 will show a page of results  starting from the 101st result. The default value is 0.")] = None,
        page_limit: Annotated[Optional[StrictInt], Field(description="Maximum number of results to return per page (see Paging above). This value must be between 0 and 2000 (inclusive). The default is 2000.")] = None,
        ...
        _param = self._search_expression_runs_as_curator_serialize(
            id=id,
            page_offset=page_offset,
            page_limit=page_limit,
            _request_auth=_request_auth,
    ...
    @validate_call
    def search_expression_runs_as_curator_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        page_offset: Annotated[Optional[StrictInt], Field(description="Show the page {pageOffset+1} results from the start of the results. E.g. 100 will show a page of results  starting from the 101st result. The default value is 0.")] = None,
        page_limit: Annotated[Optional[StrictInt], Field(description="Maximum number of results to return per page (see Paging above). This value must be between 0 and 2000 (inclusive). The default is 2000.")] = None,
    ...
    @validate_call
    def search_expression_runs_as_curator_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        page_offset: Annotated[Optional[StrictInt], Field(description="Show the page {pageOffset+1} results from the start of the results. E.g. 100 will show a page of results  starting from the 101st result. The default value is 0.")] = None,
        page_limit: Annotated[Optional[StrictInt], Field(description="Maximum number of results to return per page (see Paging above). This value must be between 0 and 2000 (inclusive). The default is 2000.")] = None,
    ...
    def _search_expression_runs_as_curator_serialize(
        self,
        id,
        page_offset,
        page_limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/as-curator/expressions/runs/by/group/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def update_expression_run_as_curator(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        ...
        _param = self._update_expression_run_as_curator_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def update_expression_run_as_curator_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        body: Annotated[Optional[Dict[str, Any]], Field(description="Metadata in the form of `{key: value, key2: value2, ...}`")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_expression_run_as_curator_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        body: Annotated[Optional[Dict[str, Any]], Field(description="Metadata in the form of `{key: value, key2: value2, ...}`")] = None,
        _request_timeout: Union[
    ...
    def _update_expression_run_as_curator_serialize(
        self,
        id,
        body,
        _request_auth,
