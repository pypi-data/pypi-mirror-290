...
class UsersApi:
    ...
    def _create_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/scim/Users',
    ...
    def delete_user(
        self,
        id: Annotated[StrictStr, Field(description="String, unique identifier of the user in ODM.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: String, unique identifier of the user in ODM. (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _delete_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/scim/Users/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def find_users(
        ...
        :param filter: Filter by user attributes. The parameter name is case-sensitive, therefore parameters FILTER, fiLter, and other options are ignored.  Supported operators:  &nbsp;&nbsp;eq - equal, the attribute and operator values must be identical for a match;  &nbsp;&nbsp;and - logical \"and\", the filter is only a match if both expressions evaluate to true;  &nbsp;&nbsp;Using other operators returns an error.  Attribute names and attribute operators used in filters are case insensitive.  Examples of the request:  &nbsp;&nbsp;filter=emails[type eq \"work\" and value eq \"user@example.com\"] - returns a user with login = user@example.com  &nbsp;&nbsp;filter=userName eq \"bjensen\"  &nbsp;&nbsp;filter=emails[type eq \"work\" and value eq \"user@example.com\"] and userName eq \"bjensen\".
        :type filter: str
    ...
    def find_users_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FilterUsersResponse]:
        """Retrieve a list of all active users
