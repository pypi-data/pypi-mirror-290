...
conf = odm_api.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("odm_api")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'Access-token' in self.api_key:
            auth['Access-token'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Authorization',
        ...
        if 'Genestack-API-Token' in self.api_key:
            auth['Genestack-API-Token'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Genestack-API-Token',
                'value': self.get_api_key_with_prefix(
                    'Genestack-API-Token',
                ),
            }
