...
class ImportExpressionSignalRunRequest(BaseModel):
    ...
    data_class: Optional[StrictStr] = Field(default=None, description="A mandatory parameter with the following possible values: `Bulk transcriptomics`, `Single-cell transcriptomics`, `Differential abundance (FC, pval, etc.)`, `Pathway analysis`, `Proteomics`, `Single-cell proteomics`, `Metabolomics`, `Lipidomics`, `Epigenomics`, `DNA methylation`, `Chemoinformatics`, `Imaging features`, `Gene panel data`, `Biomarker data`, `Physical measures`, `Blood counts`, `Other body fluid counts`, `Nanopore`, `Other`.  In case the parameter is not set the dataClass is automatically defined as `Other`.", alias="dataClass")
