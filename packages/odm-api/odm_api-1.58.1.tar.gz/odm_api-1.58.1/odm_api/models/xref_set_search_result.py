...
class XrefSetSearchResult(BaseModel):
    """
    Result of a search query for xrefsets
    """ # noqa: E501
    cursor: Optional[StrictStr] = None
    result: Optional[List[XrefSetSearchResultResultInner]] = None
    __properties: ClassVar[List[str]] = ["cursor", "result"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": [XrefSetSearchResultResultInner.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None
        })
        return _obj
