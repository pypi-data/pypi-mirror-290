...
class GetFlowCytometryAsCurator200Response(BaseModel):
    ...
    feature: Optional[GetFlowCytometryAsCurator200ResponseFeature] = None
    value: Optional[GetFlowCytometryAsCurator200ResponseValue] = None
    __properties: ClassVar[List[str]] = ["itemId", "itemOrigin", "metadata", "feature", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "feature": GetFlowCytometryAsCurator200ResponseFeature.from_dict(obj["feature"]) if obj.get("feature") is not None else None,
            "value": GetFlowCytometryAsCurator200ResponseValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
