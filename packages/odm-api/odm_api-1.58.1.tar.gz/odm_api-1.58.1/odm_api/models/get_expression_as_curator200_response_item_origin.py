...
class GetExpressionAsCurator200ResponseItemOrigin(BaseModel):
    """
    GetExpressionAsCurator200ResponseItemOrigin
    """ # noqa: E501
    run_source_id: Optional[StrictStr] = Field(default=None, alias="runSourceId")
    run_id: Optional[StrictStr] = Field(default=None, alias="runId")
    group_id: Optional[StrictStr] = Field(default=None, alias="groupId")
    __properties: ClassVar[List[str]] = ["runSourceId", "runId", "groupId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetExpressionAsCurator200ResponseItemOrigin from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetExpressionAsCurator200ResponseItemOrigin from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "runSourceId": obj.get("runSourceId"),
            "runId": obj.get("runId"),
