...
class GroupResponse(BaseModel):
    ...
    members: Optional[List[GroupResponseAllOfMembers]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "members": [GroupResponseAllOfMembers.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None,
