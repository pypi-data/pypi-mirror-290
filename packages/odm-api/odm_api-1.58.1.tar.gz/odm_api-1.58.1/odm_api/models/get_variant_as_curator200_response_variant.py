...
class GetVariantAsCurator200ResponseVariant(BaseModel):
    """
    GetVariantAsCurator200ResponseVariant
    """ # noqa: E501
    chrom: Optional[StrictStr] = None
    pos: Optional[StrictInt] = None
    id: Optional[List[StrictStr]] = None
    ref: Optional[StrictStr] = None
    alt: Optional[List[StrictStr]] = None
    qual: Optional[Union[StrictFloat, StrictInt]] = None
    filter: Optional[List[StrictStr]] = None
    info: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["chrom", "pos", "id", "ref", "alt", "qual", "filter", "info"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetVariantAsCurator200ResponseVariant from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetVariantAsCurator200ResponseVariant from a dict"""
        if obj is None:
            return None
