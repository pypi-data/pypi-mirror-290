...
from ..types import ClientParams, ClientModeParams, ClientToolParams
    ...
    def run_instructor_completion(self):
        try:
            ...
            if self.params.mode == "json":
                ...
                mode = Mode.TOOLS
            client = from_litellm(completion, mode=mode)
        ...
        try:
            ...
            for tool_call in tool_calls:
                ...
                if function_name not in self.params.tools.mapping:
                    messages = self.params.messages.append(
                        {
                ...
                tool_result = self.params.tools.mapping[function_name](
                    **function_args
                )
                messages = self.params.messages.append(
                    {
