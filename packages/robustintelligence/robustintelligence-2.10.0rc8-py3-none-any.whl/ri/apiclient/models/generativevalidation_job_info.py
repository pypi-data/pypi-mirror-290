...
class GenerativevalidationJobInfo(BaseModel):
    """
    GenerativevalidationJobInfo
    """ # noqa: E501
    job_id: Optional[RimeUUID] = Field(default=None, alias="jobId")
    job_status: Optional[RimeJobStatus] = Field(default=None, alias="jobStatus")
    completion_time: Optional[datetime] = Field(default=None, description="When the job finished.", alias="completionTime")
    __properties: ClassVar[List[str]] = ["jobId", "jobStatus", "completionTime"]
