...
class ApigenerativevalidationListTestRunsResponse(BaseModel):
    """
    ApigenerativevalidationListTestRunsResponse
    """ # noqa: E501
    test_runs: Optional[List[GenerativevalidationGenerativeValidationTestRun]] = Field(default=None, description="The list of generative testing results.", alias="testRuns")
    ...
    __properties: ClassVar[List[str]] = ["testRuns", "nextPageToken", "hasMore"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "testRuns": [GenerativevalidationGenerativeValidationTestRun.from_dict(_item) for _item in obj["testRuns"]] if obj.get("testRuns") is not None else None,
