...
from ri.apiclient.models.generativevalidation_prompt_bank import GenerativevalidationPromptBank
from ri.apiclient.models.rime_language import RimeLanguage
from typing import Optional, Set
from typing_extensions import Self

class GenerativevalidationGenerativeTestingConfig(BaseModel):
    """
    GenerativeTestingConfig is the configuration to run a generative model test.
    """ # noqa: E501
    prompt_bank: Optional[GenerativevalidationPromptBank] = Field(default=None, alias="promptBank")
    ...
    connection: Optional[GenerativevalidationModelConnectionSpec] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connection": GenerativevalidationModelConnectionSpec.from_dict(obj["connection"]) if obj.get("connection") is not None else None,
