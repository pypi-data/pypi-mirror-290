...
class GenerativevalidationStartTestRequest(BaseModel):
    """
    ...
    filters: Optional[GenerativevalidationFilters] = None
    ...
    __properties: ClassVar[List[str]] = ["url", "httpHeaders", "endpointPayloadTemplate", "responseJsonPath", "httpAuthIntegrationId", "name", "mutualTlsIntegrationId", "systemPrompt", "awsIntegrationId", "modelId", "body", "filters", "workspaceId", "agentId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "mutualTlsIntegrationId": RimeUUID.from_dict(obj["mutualTlsIntegrationId"]) if obj.get("mutualTlsIntegrationId") is not None else None,
            ...
            "filters": GenerativevalidationFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None,
