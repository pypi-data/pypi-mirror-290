...
class RimeJobDataGenerativeModelTest(BaseModel):
    """
    RimeJobDataGenerativeModelTest
    """ # noqa: E501
    workspace_id: Optional[RimeUUID] = Field(default=None, alias="workspaceId")
    progress: Optional[RimeGenerativeModelTestProgress] = None
    name: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    model_output_is_sensitive: Optional[StrictBool] = Field(default=None, alias="modelOutputIsSensitive")
    __properties: ClassVar[List[str]] = ["workspaceId", "progress", "name", "url", "modelOutputIsSensitive"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "progress": RimeGenerativeModelTestProgress.from_dict(obj["progress"]) if obj.get("progress") is not None else None,
            "name": obj.get("name"),
            "url": obj.get("url"),
