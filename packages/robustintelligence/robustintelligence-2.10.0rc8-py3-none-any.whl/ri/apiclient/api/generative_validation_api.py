...
from typing_extensions import Annotated
from ri.apiclient.models.apigenerativevalidation_get_test_run_response import ApigenerativevalidationGetTestRunResponse
...
class GenerativeValidationApi:
    ...
    def quick_scan(
        ...
        aws_integration_id: Optional[RimeUUID] = None,
        ...
        body = GenerativevalidationStartTestRequest(
          url=url,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GenerativevalidationStartTestResponse",
        }
    ...
    def results(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GenerativevalidationGetResultsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def test_run(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApigenerativevalidationGetTestRunResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def test_runs(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApigenerativevalidationListTestRunsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
