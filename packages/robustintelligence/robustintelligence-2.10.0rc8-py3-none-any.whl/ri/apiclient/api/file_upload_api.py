...
class FileUploadApi:
    ...
    @validate_call
    def file_upload_get_dataset_file_upload_url(
        self,
        file_name: str,
        ...
        _param = self._file_upload_get_dataset_file_upload_url_serialize(
            file_name=file_name,
            upload_path=upload_path,
        )

        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeGetDatasetFileUploadURLResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def _file_upload_get_dataset_file_upload_url_serialize(
        self,
        file_name,
        upload_path,
    ) -> RequestSerialized:
    ...
    @validate_call
    def file_upload_get_dataset_file_upload_url2(
        self,
        file_name: str,
        upload_path: Optional[str] = None,
    ) -> RimeGetDatasetFileUploadURLResponse:
        ...
        body = RimeGetDatasetFileUploadURLRequest(
          file_name=file_name,
          upload_path=upload_path,
        )

        _param = self._file_upload_get_dataset_file_upload_url2_serialize(
            body=body,
        )
    ...
    def _file_upload_get_dataset_file_upload_url2_serialize(
        self,
        body,
    ) -> RequestSerialized:
    ...
    @validate_call
    def file_upload_get_model_directory_upload_urls(
        self,
        directory_name: str,
        ...
        _param = self._file_upload_get_model_directory_upload_urls_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeGetModelDirectoryUploadURLsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def _file_upload_get_model_directory_upload_urls_serialize(
        self,
        directory_name,
        relative_file_paths,
        upload_path,
    ...
    @validate_call
    def file_upload_get_model_directory_upload_urls2(
        self,
        directory_name: str,
        relative_file_paths: List[str],
        upload_path: Optional[str] = None,
        ...
        body = RimeGetModelDirectoryUploadURLsRequest(
          directory_name=directory_name,
          relative_file_paths=relative_file_paths,
          upload_path=upload_path,
        )

        _param = self._file_upload_get_model_directory_upload_urls2_serialize(
            body=body,
        )
    ...
    def _file_upload_get_model_directory_upload_urls2_serialize(
        self,
        body,
    ) -> RequestSerialized:
    ...
    def list_uploaded_file_urls(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeListUploadedFileURLsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
