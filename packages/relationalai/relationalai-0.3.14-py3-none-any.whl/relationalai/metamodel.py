...
class BuiltinsClass:
    def __init__(self) -> None:
        ...
        self.ReturnDistinct = Type("ReturnDistinct", parents=[self.Return, self.Distinct], properties=[Property(f"v{id}", self.Any) for i in range(20)])
        self.ExportReturn = Type("ExportReturn", parents=[self.Return], properties=[Property(f"v{id}", self.Any) for i in range(20)])
        self.ExportReturnDistinct = Type("ExportReturn", parents=[self.ExportReturn, self.Distinct], properties=[Property(f"v{id}", self.Any) for i in range(20)])
        ...
        self.BoolFilter = Type("pyrel_bool_filter", parents=[self.Relation])
