...
from .errors import FilterAsValue, Errors, InvalidPropertySetException, MultipleIdentities, NonCallablePropertyException, OutOfContextException, RAIException, ReservedPropertyException, VariableOutOfContextException
    ...
    def __init__(self, graph:'Graph', action_type:ActionType, positionals:List[Any], named:Dict[str,Any], var:Var|None=None, name=None, is_add=False, scope:str=""):
        ...
        for name, val in named.items():
            ...
            if isinstance(val, int) \
                and self._graph._config.get("platform") == "snowflake" \
                and action_type == ActionType.Get:
                orig = val
                val = Vars(1)
