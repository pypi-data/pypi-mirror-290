...
import typing
__all__ = ['ACTION_COSTS', 'ADL', 'ASSIGN', 'AStarAlgorithm', 'AStarAlgorithmEventHandlerBase', 'AStarAlgorithmStatistics', 'AbstractTransition', 'Abstraction', 'Action', 'ActionList', 'AssignOperatorEnum', 'Axiom', 'AxiomList', 'BinaryOperatorEnum', 'BlindHeuristic', 'BrFSAlgorithm', 'CLOSED', 'CONDITIONAL_EFFECTS', 'CONSTRAINTS', 'Certificate', 'ColorFunction', 'ColoredVertex', 'ConcreteState', 'ConcreteTransition', 'DEAD_END', 'DECREASE', 'DERIVED_PREDICATES', 'DISJUNCTIVE_PRECONDITIONS', 'DIV', 'DURATIVE_ACTIONS', 'DebugAStarAlgorithmEventHandler', 'DebugBrFSAlgorithmEventHandler', 'DebugGroundedApplicableActionGeneratorEventHandler', 'DebugLiftedApplicableActionGeneratorEventHandler', 'DefaultAStarAlgorithmEventHandler', 'DefaultBrFSAlgorithmEventHandler', 'DefaultGroundedApplicableActionGeneratorEventHandler', 'DefaultIWAlgorithmEventHandler', 'DefaultLiftedApplicableActionGeneratorEventHandler', 'DefaultSIWAlgorithmEventHandler', 'DenseNautyGraph', 'DerivedAtom', 'DerivedAtomList', 'DerivedGroundAtom', 'DerivedGroundAtomList', 'DerivedGroundLiteral', 'DerivedGroundLiteralList', 'DerivedLiteral', 'DerivedLiteralList', 'DerivedPredicate', 'DerivedPredicateList', 'Domain', 'DomainList', 'EQUALITY', 'EXHAUSTED', 'EXISTENTIAL_PRECONDITIONS', 'EffectConditional', 'EffectConditionalList', 'EffectSimple', 'EffectSimpleList', 'EffectUniversal', 'EffectUniversalList', 'EmptyEdge', 'EmptyVertex', 'FAILED', 'FLUENTS', 'FaithfulAbstractState', 'FaithfulAbstraction', 'FaithfulAbstractionOptions', 'FaithfulAbstractionsOptions', 'FluentAndDerivedMapper', 'FluentAtom', 'FluentAtomList', 'FluentGroundAtom', 'FluentGroundAtomList', 'FluentGroundLiteral', 'FluentGroundLiteralList', 'FluentLiteral', 'FluentLiteralList', 'FluentPredicate', 'FluentPredicateList', 'Function', 'FunctionExpression', 'FunctionExpressionBinaryOperator', 'FunctionExpressionFunction', 'FunctionExpressionMinus', 'FunctionExpressionMultiOperator', 'FunctionExpressionNumber', 'FunctionExpressionVariantList', 'FunctionList', 'FunctionSkeleton', 'FunctionSkeletonList', 'GlobalFaithfulAbstractState', 'GlobalFaithfulAbstraction', 'GroundAction', 'GroundActionList', 'GroundActionSpan', 'GroundFunction', 'GroundFunctionExpression', 'GroundFunctionExpressionBinaryOperator', 'GroundFunctionExpressionFunction', 'GroundFunctionExpressionMinus', 'GroundFunctionExpressionMultiOperator', 'GroundFunctionExpressionNumber', 'GroundFunctionExpressionVariantList', 'GroundFunctionList', 'GroundedApplicableActionGenerator', 'IAStarAlgorithmEventHandler', 'IAlgorithm', 'IApplicableActionGenerator', 'IBrFSAlgorithmEventHandler', 'IGroundedApplicableActionGeneratorEventHandler', 'IHeuristic', 'IIWAlgorithmEventHandler', 'ILiftedApplicableActionGeneratorEventHandler', 'INCREASE', 'IN_PROGRESS', 'ISIWAlgorithmEventHandler', 'IWAlgorithm', 'LiftedApplicableActionGenerator', 'MAXIMIZE', 'MINIMIZE', 'MINUS', 'MUL', 'MultiOperatorEnum', 'NEGATIVE_PRECONDITIONS', 'NEW', 'NUMERIC_FLUENTS', 'None', 'NumericFluent', 'NumericFluentList', 'OBJECT_FLUENTS', 'OPEN', 'OUT_OF_MEMORY', 'OUT_OF_TIME', 'Object', 'ObjectGraphPruningStrategy', 'ObjectGraphPruningStrategyEnum', 'ObjectList', 'OptimizationMetric', 'OptimizationMetricEnum', 'PDDLFactories', 'PDDLParser', 'PLUS', 'PREFERENCES', 'Problem', 'ProblemColorFunction', 'ProblemList', 'QUANTIFIED_PRECONDITIONS', 'RequirementEnum', 'Requirements', 'SCALE_DOWN', 'SCALE_UP', 'SIWAlgorithm', 'SOLVED', 'STRIPS', 'SearchNodeStatus', 'SearchStatus', 'SparseNautyGraph', 'State', 'StateIndexGroupedVector', 'StateList', 'StateRepository', 'StateSpace', 'StateSpaceOptions', 'StateSpacesOptions', 'StateSpan', 'StaticAtom', 'StaticAtomList', 'StaticDigraph', 'StaticGroundAtom', 'StaticGroundAtomList', 'StaticGroundLiteral', 'StaticGroundLiteralList', 'StaticLiteral', 'StaticLiteralList', 'StaticPredicate', 'StaticPredicateList', 'StaticScc', 'StaticVertexColoredDigraph', 'StringToDerivedPredicateMap', 'StringToFluentPredicateMap', 'StringToStaticPredicateMap', 'TIMED_INITIAL_LITERALS', 'TYPING', 'Term', 'TermObject', 'TermVariable', 'TermVariantList', 'TupleGraph', 'TupleGraphFactory', 'TupleGraphVertex', 'TupleGraphVertexIndexGroupedVector', 'TupleGraphVertexSpan', 'TupleIndexMapper', 'UNIVERSAL_PRECONDITIONS', 'UNSOLVABLE', 'Variable', 'VariableList', 'compute_sorted_vertex_colors', 'compute_vertex_colors', 'create_object_graph']
class AStarAlgorithm(IAlgorithm):
    @typing.overload
    def __init__(self, arg0: IApplicableActionGenerator, arg1: IHeuristic) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: IApplicableActionGenerator, arg1: StateRepository, arg2: IHeuristic, arg3: IAStarAlgorithmEventHandler) -> None:
        ...
...
class Abstraction:
    @typing.overload
    def __init__(self, arg0: FaithfulAbstraction) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: GlobalFaithfulAbstraction) -> None:
        ...
    def get_aag(self) -> IApplicableActionGenerator:
        ...
    ...
    def get_problem(self) -> Problem:
        ...
    def get_ssg(self) -> StateRepository:
        ...
    def get_transition_cost(self, transition_index: int) -> float:
        ...
    def is_alive_state(self, state_index: int) -> bool:
        ...
    def is_deadend_state(self, state_index: int) -> bool:
        ...
    def is_goal_state(self, state_index: int) -> bool:
        ...
class Action:
    ...
    def get_parameters(self) -> VariableList:
        ...
    def get_simple_effects(self) -> EffectSimpleList:
        ...
    def get_static_conditions(self) -> StaticLiteralList:
        ...
    def get_universal_effects(self) -> EffectUniversalList:
        ...
class ActionList:
...
class BrFSAlgorithm(IAlgorithm):
    @typing.overload
    def __init__(self, arg0: IApplicableActionGenerator) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: IApplicableActionGenerator, arg1: StateRepository, arg2: IBrFSAlgorithmEventHandler) -> None:
        ...
class Certificate:
    ...
    def __hash__(self) -> int:
        ...
    def __init__(self, arg0: int, arg1: int, arg2: str, arg3: list[int]) -> None:
        ...
...
class ColoredVertex:
    ...
    def get_index(self) -> int:
        ...
class ConcreteState:
    def __eq__(self, arg0: ConcreteState) -> bool:
        ...
    def __hash__(self) -> int:
        ...
    def get_index(self) -> int:
...
class ConcreteTransition:
    def __eq__(self, arg0: ConcreteTransition) -> bool:
        ...
    def __hash__(self) -> int:
        ...
    def get_cost(self) -> float:
...
class DenseNautyGraph:
    ...
    def __init__(self, arg0: int) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: StaticVertexColoredDigraph) -> None:
        ...
...
class EffectSimple:
    ...
    def get_index(self) -> int:
        ...
class EffectSimpleList:
    __hash__: typing.ClassVar[None] = None
    def __bool__(self) -> bool:
        """
        Check whether the list is nonempty
        """
    def __contains__(self, x: EffectSimple) -> bool:
        """
        Return true the container contains ``x``
        """
    @typing.overload
    ...
    def __delitem__(self, arg0: slice) -> None:
        ...
        Delete list elements using a slice object
        """
    def __eq__(self, arg0: EffectSimpleList) -> bool:
        ...
    @typing.overload
    def __getitem__(self, s: slice) -> EffectSimpleList:
        """
        Retrieve list elements using a slice object
        """
    @typing.overload
    def __getitem__(self, arg0: int) -> EffectSimple:
        ...
    @typing.overload
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: EffectSimpleList) -> None:
        """
        Copy constructor
        """
    @typing.overload
    ...
    def __len__(self) -> int:
        ...
    def __ne__(self, arg0: EffectSimpleList) -> bool:
        ...
    def __repr__(self) -> str:
        """
        Return the canonical string representation of this list.
        """
    @typing.overload
    def __setitem__(self, arg0: int, arg1: EffectSimple) -> None:
        ...
    @typing.overload
    def __setitem__(self, arg0: slice, arg1: EffectSimpleList) -> None:
        """
        Assign list elements using a slice object
        """
    def append(self, x: EffectSimple) -> None:
        """
        Add an item to the end of the list
        """
    def clear(self) -> None:
        ...
        Clear the contents
        """
    def count(self, x: EffectSimple) -> int:
        """
        Return the number of times ``x`` appears in the list
        """
    @typing.overload
    def extend(self, L: EffectSimpleList) -> None:
        """
        Extend the list by appending all the items in the given list
        """
    @typing.overload
    def extend(self, L: typing.Iterable) -> None:
        ...
        Extend the list by appending all the items in the given list
        """
    def insert(self, i: int, x: EffectSimple) -> None:
        """
        Insert an item at a given position.
        """
    @typing.overload
    def pop(self) -> EffectSimple:
        """
        Remove and return the last item
        """
    @typing.overload
    def pop(self, i: int) -> EffectSimple:
        """
        Remove and return the item at index ``i``
        """
    def remove(self, x: EffectSimple) -> None:
        """
        Remove the first item from the list whose value is x. It is an error if there is no such item.
        """
class EffectUniversal:
    def __repr__(self) -> str:
        ...
    def __str__(self) -> str:
        ...
    ...
    def get_static_conditions(self) -> StaticLiteralList:
        ...
class EffectUniversalList:
    __hash__: typing.ClassVar[None] = None
    def __bool__(self) -> bool:
        """
        Check whether the list is nonempty
        """
    def __contains__(self, x: EffectUniversal) -> bool:
        """
        Return true the container contains ``x``
        """
    @typing.overload
    ...
    def __delitem__(self, arg0: slice) -> None:
        ...
        Delete list elements using a slice object
        """
    def __eq__(self, arg0: EffectUniversalList) -> bool:
        ...
    @typing.overload
    def __getitem__(self, s: slice) -> EffectUniversalList:
        """
        Retrieve list elements using a slice object
        """
    @typing.overload
    def __getitem__(self, arg0: int) -> EffectUniversal:
        ...
    @typing.overload
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: EffectUniversalList) -> None:
        """
        Copy constructor
        """
    @typing.overload
    ...
    def __len__(self) -> int:
        ...
    def __ne__(self, arg0: EffectUniversalList) -> bool:
        ...
    def __repr__(self) -> str:
        """
        Return the canonical string representation of this list.
        """
    @typing.overload
    def __setitem__(self, arg0: int, arg1: EffectUniversal) -> None:
        ...
    @typing.overload
    def __setitem__(self, arg0: slice, arg1: EffectUniversalList) -> None:
        """
        Assign list elements using a slice object
        """
    def append(self, x: EffectUniversal) -> None:
        """
        Add an item to the end of the list
        """
    def clear(self) -> None:
        ...
        Clear the contents
        """
    def count(self, x: EffectUniversal) -> int:
        """
        Return the number of times ``x`` appears in the list
        """
    @typing.overload
    def extend(self, L: EffectUniversalList) -> None:
        """
        Extend the list by appending all the items in the given list
        """
    @typing.overload
    def extend(self, L: typing.Iterable) -> None:
        ...
        Extend the list by appending all the items in the given list
        """
    def insert(self, i: int, x: EffectUniversal) -> None:
        """
        Insert an item at a given position.
        """
    @typing.overload
    def pop(self) -> EffectUniversal:
        """
        Remove and return the last item
        """
    @typing.overload
    def pop(self, i: int) -> EffectUniversal:
        """
        Remove and return the item at index ``i``
        """
    def remove(self, x: EffectUniversal) -> None:
        """
        Remove the first item from the list whose value is x. It is an error if there is no such item.
        """
class EmptyEdge:
...
class FaithfulAbstraction:
    ...
    @staticmethod
    @typing.overload
    def create(problem: Problem, factories: PDDLFactories, aag: IApplicableActionGenerator, ssg: StateRepository, options: FaithfulAbstractionOptions = ...) -> FaithfulAbstraction | None:
        ...
    @staticmethod
    @typing.overload
    ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[Problem, PDDLFactories, IApplicableActionGenerator, StateRepository]], options: FaithfulAbstractionsOptions = ...) -> list[FaithfulAbstraction]:
        ...
    def __str__(self) -> str:
        ...
    ...
    def get_aag(self) -> IApplicableActionGenerator:
        ...
    def get_abstract_state_index(self, state: State) -> int:
        ...
    def get_backward_adjacent_state_indices(self, state_index: int) -> typing.Iterator:
        ...
    ...
    def get_backward_adjacent_transitions(self, state_index: int) -> typing.Iterator:
        ...
    def get_concrete_to_abstract_state(self) -> dict[State, int]:
        ...
    def get_deadend_states(self) -> set[int]:
        ...
    def get_forward_adjacent_state_indices(self, state_index: int) -> typing.Iterator:
...
class FaithfulAbstractionsOptions:
    ...
    def __init__(self, fa_options: FaithfulAbstractionOptions = ..., sort_ascending_by_num_states: bool = True, num_threads: int = 4) -> None:
        ...
class FluentAndDerivedMapper:
    @typing.overload
    def combine_and_sort(self, state: State) -> list[int]:
        ...
    @typing.overload
    def combine_and_sort(self, state: State, successor_state: State) -> tuple[list[int], list[int]]:
        ...
    ...
    def get_is_remapped_fluent(self) -> list[bool]:
        ...
    def inverse_remap_and_separate(self, fluent_and_derived_atom_indices: list[int]) -> tuple[list[int], list[int]]:
        ...
class FluentAtom:
    def __repr__(self) -> str:
        ...
...
class FunctionExpressionMultiOperator:
    ...
    def __str__(self) -> str:
        ...
    def get_function_expressions(self) -> FunctionExpressionVariantList:
        ...
    def get_index(self) -> int:
        ...
...
class FunctionExpressionNumber:
    ...
    def get_number(self) -> float:
        ...
class FunctionExpressionVariantList:
    def __bool__(self) -> bool:
        """
        Check whether the list is nonempty
        """
    ...
    def __delitem__(self, arg0: slice) -> None:
        ...
        """
    @typing.overload
    def __getitem__(self, s: slice) -> FunctionExpressionVariantList:
        """
        Retrieve list elements using a slice object
        """
    @typing.overload
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: FunctionExpressionVariantList) -> None:
        """
        Copy constructor
        """
    @typing.overload
    ...
    def __setitem__(self, arg0: int, arg1: FunctionExpression) -> None:
        ...
    @typing.overload
    def __setitem__(self, arg0: slice, arg1: FunctionExpressionVariantList) -> None:
        """
        Assign list elements using a slice object
        """
    ...
    def clear(self) -> None:
        ...
        """
    @typing.overload
    def extend(self, L: FunctionExpressionVariantList) -> None:
        """
        Extend the list by appending all the items in the given list
        """
    @typing.overload
...
class GlobalFaithfulAbstraction:
    ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[Problem, PDDLFactories, IApplicableActionGenerator, StateRepository]], options: FaithfulAbstractionsOptions = ...) -> list[GlobalFaithfulAbstraction]:
        ...
    def __str__(self) -> str:
        ...
    def compute_pairwise_shortest_backward_state_distances(self) -> list[list[float]]:
    ...
    def get_abstract_state_index(self, state: State) -> int:
        ...
    @typing.overload
    def get_abstract_state_index(self, state_index: int) -> int:
        ...
    ...
    def get_forward_adjacent_transitions(self, state_index: int) -> typing.Iterator:
        ...
    def get_global_state_index_to_state_index(self) -> dict[int, int]:
        ...
    def get_goal_distances(self) -> list[float]:
        ...
    def get_goal_states(self) -> set[int]:
...
class GroundFunctionExpressionMultiOperator:
    ...
    def __str__(self) -> str:
        ...
    def get_function_expressions(self) -> GroundFunctionExpressionVariantList:
        ...
    def get_index(self) -> int:
        ...
    def get_multi_operator(self) -> MultiOperatorEnum:
...
class GroundFunctionExpressionNumber:
    ...
    def get_number(self) -> float:
        ...
class GroundFunctionExpressionVariantList:
    def __bool__(self) -> bool:
        """
        Check whether the list is nonempty
        """
    ...
    def __delitem__(self, arg0: slice) -> None:
        ...
        """
    @typing.overload
    def __getitem__(self, s: slice) -> GroundFunctionExpressionVariantList:
        """
        Retrieve list elements using a slice object
        """
    @typing.overload
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: GroundFunctionExpressionVariantList) -> None:
        """
        Copy constructor
        """
    @typing.overload
    ...
    def __setitem__(self, arg0: int, arg1: GroundFunctionExpression) -> None:
        ...
    @typing.overload
    def __setitem__(self, arg0: slice, arg1: GroundFunctionExpressionVariantList) -> None:
        """
        Assign list elements using a slice object
        """
    ...
    def clear(self) -> None:
        ...
        """
    @typing.overload
    def extend(self, L: GroundFunctionExpressionVariantList) -> None:
        """
        Extend the list by appending all the items in the given list
        """
    @typing.overload
...
class GroundedApplicableActionGenerator(IApplicableActionGenerator):
    ...
    def __init__(self, arg0: Problem, arg1: PDDLFactories) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: Problem, arg1: PDDLFactories, arg2: IGroundedApplicableActionGeneratorEventHandler) -> None:
        ...
class IAStarAlgorithmEventHandler:
    pass
class IAlgorithm:
    def find_solution(self) -> tuple[SearchStatus, GroundActionList]:
        ...
class IApplicableActionGenerator:
    def compute_applicable_actions(self, state: State) -> GroundActionList:
        ...
...
class IWAlgorithm(IAlgorithm):
    @typing.overload
    def __init__(self, arg0: IApplicableActionGenerator, arg1: int) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: IApplicableActionGenerator, arg1: int, arg2: StateRepository, arg3: IBrFSAlgorithmEventHandler, arg4: IIWAlgorithmEventHandler) -> None:
        ...
class LiftedApplicableActionGenerator(IApplicableActionGenerator):
    ...
    def __init__(self, arg0: Problem, arg1: PDDLFactories) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: Problem, arg1: PDDLFactories, arg2: ILiftedApplicableActionGeneratorEventHandler) -> None:
        ...
...
class NumericFluent:
    ...
    def get_number(self) -> float:
        ...
class NumericFluentList:
    __hash__: typing.ClassVar[None] = None
    def __bool__(self) -> bool:
        """
        Check whether the list is nonempty
        """
    def __contains__(self, x: NumericFluent) -> bool:
        """
        Return true the container contains ``x``
        """
    @typing.overload
    ...
    def __delitem__(self, arg0: slice) -> None:
        ...
        Delete list elements using a slice object
        """
    def __eq__(self, arg0: NumericFluentList) -> bool:
        ...
    @typing.overload
    def __getitem__(self, s: slice) -> NumericFluentList:
        """
        Retrieve list elements using a slice object
        """
    @typing.overload
    def __getitem__(self, arg0: int) -> NumericFluent:
        ...
    @typing.overload
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: NumericFluentList) -> None:
        """
        Copy constructor
        """
    @typing.overload
    ...
    def __len__(self) -> int:
        ...
    def __ne__(self, arg0: NumericFluentList) -> bool:
        ...
    def __repr__(self) -> str:
        """
        Return the canonical string representation of this list.
        """
    @typing.overload
    def __setitem__(self, arg0: int, arg1: NumericFluent) -> None:
        ...
    @typing.overload
    def __setitem__(self, arg0: slice, arg1: NumericFluentList) -> None:
        """
        Assign list elements using a slice object
        """
    def append(self, x: NumericFluent) -> None:
        """
        Add an item to the end of the list
        """
    def clear(self) -> None:
        ...
        Clear the contents
        """
    def count(self, x: NumericFluent) -> int:
        """
        Return the number of times ``x`` appears in the list
        """
    @typing.overload
    def extend(self, L: NumericFluentList) -> None:
        """
        Extend the list by appending all the items in the given list
        """
    @typing.overload
    def extend(self, L: typing.Iterable) -> None:
        ...
        Extend the list by appending all the items in the given list
        """
    def insert(self, i: int, x: NumericFluent) -> None:
        """
        Insert an item at a given position.
        """
    @typing.overload
    def pop(self) -> NumericFluent:
        """
        Remove and return the last item
        """
    @typing.overload
    def pop(self, i: int) -> NumericFluent:
        """
        Remove and return the item at index ``i``
        """
    def remove(self, x: NumericFluent) -> None:
        """
        Remove the first item from the list whose value is x. It is an error if there is no such item.
        """
class Object:
...
class PDDLFactories:
    def get_derived_ground_atom(self, arg0: int) -> DerivedGroundAtom:
        ...
    def get_derived_ground_atoms_from_ids(self, arg0: list[int]) -> DerivedGroundAtomList:
        ...
    def get_fluent_ground_atom(self, arg0: int) -> FluentGroundAtom:
        ...
    def get_fluent_ground_atoms_from_ids(self, arg0: list[int]) -> FluentGroundAtomList:
        ...
    def get_object(self, arg0: int) -> Object:
        ...
    def get_static_ground_atom(self, arg0: int) -> StaticGroundAtom:
        ...
    def get_static_ground_atoms_from_ids(self, arg0: list[int]) -> StaticGroundAtomList:
        ...
class PDDLParser:
...
class Problem:
    ...
    def get_name(self) -> str:
        ...
    def get_numeric_fluents(self) -> NumericFluentList:
        ...
    def get_objects(self) -> ObjectList:
        ...
...
class SIWAlgorithm(IAlgorithm):
    ...
    def __init__(self, arg0: IApplicableActionGenerator, arg1: int) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: IApplicableActionGenerator, arg1: int, arg2: StateRepository, arg3: IBrFSAlgorithmEventHandler, arg4: IIWAlgorithmEventHandler, arg5: ISIWAlgorithmEventHandler) -> None:
        ...
...
class State:
    ...
    def __repr__(self) -> str:
        ...
    @typing.overload
    def contains(self, atom: FluentGroundAtom) -> bool:
        ...
    @typing.overload
    def contains(self, atom: DerivedGroundAtom) -> bool:
        ...
    ...
    def literals_hold(self, literals: DerivedGroundLiteralList) -> bool:
        ...
    @typing.overload
    def superset_of(self, atoms: FluentGroundAtomList) -> bool:
        ...
    @typing.overload
    def superset_of(self, atoms: DerivedGroundAtomList) -> bool:
        ...
    def to_string(self, problem: Problem, pddl_factories: PDDLFactories) -> str:
        ...
...
class StateSpace:
    ...
    @staticmethod
    @typing.overload
    def create(problem: Problem, factories: PDDLFactories, aag: IApplicableActionGenerator, ssg: StateRepository, options: StateSpaceOptions = ...) -> StateSpace | None:
        ...
    @staticmethod
    @typing.overload
    ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[Problem, PDDLFactories, IApplicableActionGenerator, StateRepository]], options: StateSpacesOptions = ...) -> list[StateSpace]:
        ...
    def __str__(self) -> str:
        ...
    def compute_pairwise_shortest_backward_state_distances(self) -> list[list[float]]:
    ...
    def get_ssg(self) -> StateRepository:
        ...
    def get_state(self, state_index: int) -> ConcreteState:
        ...
    def get_state_index(self, state: State) -> int:
        ...
    def get_states(self) -> list[ConcreteState]:
        ...
    def get_transition_cost(self, transition_index: int) -> float:
        ...
    def get_transitions(self) -> list[ConcreteTransition]:
        ...
    def is_alive_state(self, state_index: int) -> bool:
        ...
    def is_deadend_state(self, state_index: int) -> bool:
    ...
    def is_goal_state(self, state_index: int) -> bool:
        ...
    def sample_state_with_goal_distance(self, goal_distance: float) -> int:
        ...
...
class StateSpacesOptions:
    ...
    def __init__(self, state_space_options: StateSpaceOptions = ..., sort_ascending_by_num_states: bool = True, num_threads: int = 4) -> None:
        ...
class StateSpan:
    def __getitem__(self, arg0: int) -> State:
        ...
...
class TermVariable:
    ...
    def get_variable(self) -> Variable:
        ...
class TermVariantList:
    def __bool__(self: list[Term]) -> bool:
        """
        Check whether the list is nonempty
        """
    @typing.overload
    def __delitem__(self: list[Term], arg0: int) -> None:
        """
        Delete the list elements at index ``i``
        """
    @typing.overload
    def __delitem__(self: list[Term], arg0: slice) -> None:
        """
        Delete list elements using a slice object
        """
    @typing.overload
    def __getitem__(self: list[Term], s: slice) -> list[Term]:
        """
        Retrieve list elements using a slice object
        """
    @typing.overload
    def __getitem__(self: list[Term], arg0: int) -> Term:
        ...
    @typing.overload
    def __init__(self) -> None:
        ...
    ...
    def __init__(self, arg0: typing.Iterable) -> None:
        ...
    def __iter__(self: list[Term]) -> typing.Iterator:
        ...
    def __len__(self: list[Term]) -> int:
        ...
    @typing.overload
    def __setitem__(self: list[Term], arg0: int, arg1: Term) -> None:
        ...
    @typing.overload
    def __setitem__(self: list[Term], arg0: slice, arg1: list[Term]) -> None:
        """
        Assign list elements using a slice object
        """
    def append(self: list[Term], x: Term) -> None:
        """
        Add an item to the end of the list
        """
    def clear(self: list[Term]) -> None:
        """
        Clear the contents
        """
    @typing.overload
    def extend(self: list[Term], L: list[Term]) -> None:
        """
        Extend the list by appending all the items in the given list
        """
    @typing.overload
    def extend(self: list[Term], L: typing.Iterable) -> None:
        """
        Extend the list by appending all the items in the given list
        """
    def insert(self: list[Term], i: int, x: Term) -> None:
        """
        Insert an item at a given position.
        """
    @typing.overload
    def pop(self: list[Term]) -> Term:
        """
        Remove and return the last item
        """
    @typing.overload
    def pop(self: list[Term], i: int) -> Term:
        """
        Remove and return the item at index ``i``
        """
class TupleGraph:
    def __str__(self) -> str:
        ...
    @typing.overload
    def compute_admissible_chain(self, arg0: FluentGroundAtomList, arg1: DerivedGroundAtomList) -> list[int] | None:
        ...
    @typing.overload
...
class TupleIndexMapper:
    ...
    def get_empty_tuple_index(self) -> int:
        ...
    def get_factors(self) -> typing_extensions.Annotated[list[int], pybind11_stubgen.typing_ext.FixedSize(6)]:
        ...
...
class VariableList:
    ...
    def remove(self, x: Variable) -> None:
        ...
        Remove the first item from the list whose value is x. It is an error if there is no such item.
        """
def compute_sorted_vertex_colors(vertex_colored_graph: StaticVertexColoredDigraph) -> list[int]:
    ...
def compute_vertex_colors(vertex_colored_graph: StaticVertexColoredDigraph) -> list[int]:
    ...
def create_object_graph(color_function: ProblemColorFunction, pddl_factories: PDDLFactories, problem: Problem, state: State, state_index: int = 0, mark_true_goal_literals: bool = False, pruning_strategy: ObjectGraphPruningStrategy = ...) -> StaticVertexColoredDigraph:
    """
