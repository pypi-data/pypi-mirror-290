...
class Moobius:
    ...
    async def do_sync(self, channel_id, member_id):
        """Refresh as user for this channel_id and member_id."""
        pass
    ...
    async def do_channel_sync(self, channel_id):
        ...
        tasks = [self.do_sync(channel_id, user_id) for user_id in member_ids]
    ...
    async def on_refresh(self, refresh: RefreshBody):
        ...
        await self.do_sync(refresh.channel_id, self.client_id)
