...
class InputComponent:
    ...
    required: Optional[bool] # Is the user forced to use it?
...
class ButtonClick:
    ...
    arguments: Optional[list[ButtonClickArgument]]=None # What settings the user choose (for buttons that open a pop-up menu).
