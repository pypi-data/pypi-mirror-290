...
def get_controller(attr_val, *, attr_name='target', **kwargs):
    def _reader_(tables):
...
def get_bridge(attr_val, *, attr_name='name', **kwargs):
    def _reader_(tables):
...
def get_port(attr_val, *, attr_name='name', **kwargs):
    def _reader_(tables):
...
def get_iface(attr_val, *, attr_name='name', **kwargs):
    def _reader_(tables):
...
def get_manager(attr_val, *, attr_name='uuid', **kwargs):
    def _reader_(tables):
