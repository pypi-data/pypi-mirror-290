...
from yeeducli.utility.json_utils import check_boolean, check_non_empty_string, validate_array_of_intgers, check_cloud_providers
...
class BillingParser:
    ...
    def billing_parser(subparser):
        ...
        list_billed_clusters.add_argument(
            "--cloud_providers",
            type=check_cloud_providers,
            nargs='?',
            default=SUPPRESS,
            help="Specifies the cloud providers to be used as a filter."
        )
        list_billed_clusters.add_argument(
            "--json-output",
            type=check_non_empty_string,
        ...
        list_billed_usage.add_argument(
            ...
            nargs='?',
            default=SUPPRESS,
            help="Provide cloud_providers to list billed usage for given cloud providers."
        )
        list_billed_usage.add_argument(
            "--cluster_ids",
            type=validate_array_of_intgers,
        ...
        list_billed_invoice.add_argument(
            ...
            nargs='?',
            default=SUPPRESS,
            help="Provide cloud_providers to list billed invoice for given cloud providers."
        )
        list_billed_invoice.add_argument(
            "--cluster_ids",
            type=validate_array_of_intgers,
