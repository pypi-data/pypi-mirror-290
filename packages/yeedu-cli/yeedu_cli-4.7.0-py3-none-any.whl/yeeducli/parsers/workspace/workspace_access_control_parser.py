...
class WorkspaceAccessControlParser:
    def workspace_access_control_parser(subparser):
        ...
        list_workspace_users.add_argument(
            ...
            nargs=1,
            default=SUPPRESS,
            help="Provide group_id to list all the users."
        )
        list_workspace_users.add_argument(
            "--page_number",
            type=int,
        ...
        list_workspace_users_access = subparser.add_parser(
            'list-users-access',
            help='To list all the users having access to a workspace.',
            formatter_class=ArgumentDefaultsHelpFormatter)
        list_workspace_users_access.add_argument(
            ...
            default=SUPPRESS,
            required=True,
            help="Provide Workspace Id to list all the users."
        )
        list_workspace_users_access.add_argument(
            "--permission_id",
            type=int,
            ...
            default=SUPPRESS,
            required=True,
            help="Provide Permission Id to list all the users."
        )
        list_workspace_users_access.add_argument(
            "--page_number",
            type=int,
        ...
        search_workspace_users = subparser.add_parser(
            'search-users',
            help='To search all the users by a username having access to a workspace.',
            formatter_class=ArgumentDefaultsHelpFormatter)
        ...
        search_workspace_users.add_argument(
            ...
            nargs=1,
            default=SUPPRESS,
            help="Provide group id to search all the users."
        )
        search_workspace_users.add_argument(
            "--page_number",
            type=int,
        ...
        list_workspace_groups.add_argument(
            ...
            nargs=1,
            default=SUPPRESS,
            help="Provide a user_id to retrieve a list of all the groups associated with that user."
        )
        list_workspace_groups.add_argument(
            "--page_number",
            type=int,
        ...
        list_workspace_groups_access = subparser.add_parser(
            'list-groups-access',
            help='To list all the groups having access to a workspace.',
            formatter_class=ArgumentDefaultsHelpFormatter)
        list_workspace_groups_access.add_argument(
            ...
            default=SUPPRESS,
            required=True,
            help="Provide Workspace Id to list all the groups."
        )
        list_workspace_groups_access.add_argument(
            "--permission_id",
            type=int,
            ...
            default=SUPPRESS,
            required=True,
            help="Provide Permission Id to list all the groups."
        )
        list_workspace_groups_access.add_argument(
            "--page_number",
            type=int,
        ...
        search_workspace_groups = subparser.add_parser(
            'search-groups',
            help='To search all the groups by a groupname having access to a workspace.',
            formatter_class=ArgumentDefaultsHelpFormatter)
        ...
        search_workspace_groups.add_argument(
            ...
            nargs=1,
            default=SUPPRESS,
            help="Provide user id to search all the groups."
        )
        search_workspace_groups.add_argument(
            "--page_number",
            type=int,
