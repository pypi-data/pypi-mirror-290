...
class WorkspaceAccessControl:
    def list_workspace_users(workspace_id, pageNumber, limit, group_id=None):
        try:
    ...
    def list_workspace_users_access(workspace_id, permission_id, pageNumber, limit):
        try:
            url = f"{config.YEEDU_RESTAPI_URL}/ac/workspace/{workspace_id}/users/permission/{permission_id}"
    ...
    def search_workspace_users(workspace_id, username, pageNumber, limit, group_id=None):
        try:
    ...
    def list_workspace_groups(workspace_id, pageNumber, limit, user_id=None):
        try:
    ...
    def list_workspace_groups_access(workspace_id, permission_id, pageNumber, limit):
        try:
            url = f"{config.YEEDU_RESTAPI_URL}/ac/workspace/{workspace_id}/groups/permission/{permission_id}"
    ...
    def search_workspace_groups(workspace_id, groupname, pageNumber, limit, user_id=None):
        try:
