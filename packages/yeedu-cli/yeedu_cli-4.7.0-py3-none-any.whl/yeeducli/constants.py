...
COMPUTE_TYPES_LIST = ['compute_optimized', 'memory_optimized',
                      'general_purpose', 'gpu_accelerated', 'custom_compute']

# CLUSTER TYPEs
CLUSTER_TYPE_LIST = ['YEEDU', 'STANDALONE', 'CLUSTER']

NOTEBOOK_LANGUAGE_LIST = ['python3', 'scala']

# JOB TYPE lang
JOB_TYPE_LANG = ['RAW_SCALA', 'Jar', 'Python3', 'SQL']

SPARK_JOB_TYPE = ['SPARK_JOB', 'SPARK_SQL', 'NOTEBOOK']
...
RESOURCE_LIST = ['list-providers', 'list-disk-machine-types', 'list-credential-types', 'list-engine-cluster-instance-status', 'get-provider', 'list-provider-availability-zones', 'get-provider-availability-zone', 'list-provider-machine-types', 'get-provider-machine-type', 'list-spark-compute-types', 'list-spark-infra-versions', 'list-spark-job-status', 'list-workflow-execution-states', 'list-workflow-types', 'create-volume-conf', 'get-volume-conf', 'list-volume-confs', 'search-volume-confs', 'edit-volume-conf', 'delete-volume-conf', 'create-network-conf', 'list-network-confs', 'search-network-confs', 'get-network-conf', 'edit-network-conf', 'delete-network-conf', 'create-boot-disk-image-conf', 'list-boot-disk-image-confs', 'search-boot-disk-image-confs', 'get-boot-disk-image-conf', 'edit-boot-disk-image-conf', 'delete-boot-disk-image-conf',
                 'create-cloud-env', 'list-cloud-envs', 'search-cloud-envs', 'get-cloud-env', 'edit-cloud-env', 'delete-cloud-env', 'create-object-storage-manager', 'get-object-storage-manager', 'list-object-storage-managers', 'search-object-storage-managers', 'edit-object-storage-manager', 'delete-object-storage-manager', 'create-object-storage-manager-file', 'get-object-storage-manager-file', 'list-object-storage-manager-files', 'search-object-storage-manager-files', 'delete-object-storage-manager-file', 'create-hive-metastore-conf', 'list-hive-metastore-confs', 'search-hive-metastore-confs', 'get-hive-metastore-conf', 'edit-hive-metastore-conf', 'delete-hive-metastore-conf', 'create-credential-conf', 'list-credential-confs', 'search-credential-confs', 'get-credential-conf', 'edit-credential-conf', 'delete-credential-conf', 'list-linux-distros']

# CLUSTER SUBCOMMANDS LIST
CLUSTER_LIST = ['create-conf', 'list-confs', 'search-confs', 'get-conf', 'edit-conf', 'delete-conf', 'create', 'list', 'search', 'get', 'edit', 'destroy', 'start', 'stop', 'get-stats', 'list-status', 'logs',
...
WORKSPACE_LIST = ['create', 'list', 'search', 'get', 'get-stats', 'edit', 'enable', 'disable', 'create-user-access', 'create-group-access', 'delete-user-access', 'delete-group-access',
                  'list-users', 'list-users-access', 'search-users', 'match-user', 'list-groups', 'list-groups-access', 'search-groups', 'match-group', 'get-user-access', 'get-group-access']

# JOB SUBCOMMANDS LIST
JOB_LIST = ['create-conf', 'get-conf', 'list-confs', 'search-confs', 'edit-conf', 'enable-conf',
            'disable-conf', 'start', 'get', 'search', 'list', 'stop', 'get-status', 'logs', 'get-workflow-job-instance']

# NOTEBOOK SUBCOMMANDS LIST
NOTEBOOK_LIST = ['create-conf', 'get-conf', 'list-confs', 'search-confs', 'edit-conf', 'enable-conf', 'disable-conf',
                 'start', 'kernel-start', 'kernel-status', 'kernel-interrupt', 'kernel-restart', 'get', 'search', 'list', 'stop', 'logs']
...
IAM_LIST = ['list-tenants', 'associate-tenant', 'get-user-info', 'get-user-roles', 'sync-user', 'sync-group', 'list-user-groups', 'list-users', 'list-group-users', 'list-groups', 'list-resources', 'get-resource',            'list-permissions',
...
VARCHAR_ARRAY_COLUMN_FULL_LIST = ['labels', 'conf', 'conf_secret', 'env_var', 'env_var_secret', 'network_tags', 'files',
                                  'properties_file', 'packages', 'repositories', 'jars', 'archives', 'py_files', 'cluster_ids', 'machine_type_ids', 'cloud_providers']
