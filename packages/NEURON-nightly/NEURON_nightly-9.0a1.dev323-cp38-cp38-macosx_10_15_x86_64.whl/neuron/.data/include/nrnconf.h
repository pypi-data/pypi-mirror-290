...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/Users/runner/work/1/s/nrn_build_venv38_-4455649/bin/python)"};
   constexpr std::array<std::string_view, 1> supported_python_versions{"3.8"};
#endif
