...
class MeshViewerComponent:
    ...
    def show(self):
        ...
        if self.server_url == self.endpoints[ServerMessageInterface.Keys.Host]:
            return st.error("Error during setup of the trame server or the server_manager")
