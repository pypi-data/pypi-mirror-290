...
Usage::
    ...
    ```python
    from mypy_boto3_comprehend.type_defs import AugmentedManifestsListItemExtraOutputTypeDef

    data: AugmentedManifestsListItemExtraOutputTypeDef = ...
    ```
"""
...
__all__ = (
    "AugmentedManifestsListItemExtraOutputTypeDef",
    ...
    "DocumentReaderConfigExtraOutputTypeDef",
    ...
    "RedactionConfigExtraOutputTypeDef",
    ...
    "DocumentClassifierInputDataConfigExtraOutputTypeDef",
    "DocumentReaderConfigUnionTypeDef",
    "InputDataConfigExtraOutputTypeDef",
    ...
    "EntityRecognizerInputDataConfigExtraOutputTypeDef",
...
AugmentedManifestsListItemExtraOutputTypeDef = TypedDict(
    "AugmentedManifestsListItemExtraOutputTypeDef",
    {
        "S3Uri": str,
...
DocumentReaderConfigExtraOutputTypeDef = TypedDict(
    "DocumentReaderConfigExtraOutputTypeDef",
    {
        "DocumentReadAction": DocumentReadActionType,
        "DocumentReadMode": NotRequired[DocumentReadModeType],
...
RedactionConfigExtraOutputTypeDef = TypedDict(
    "RedactionConfigExtraOutputTypeDef",
    {
        "PiiEntityTypes": NotRequired[List[PiiEntityTypeType]],
        "MaskMode": NotRequired[PiiEntitiesDetectionMaskModeType],
...
DocumentClassifierInputDataConfigExtraOutputTypeDef = TypedDict(
    "DocumentClassifierInputDataConfigExtraOutputTypeDef",
    {
        "DataFormat": NotRequired[DocumentClassifierDataFormatType],
        "S3Uri": NotRequired[str],
        "TestS3Uri": NotRequired[str],
        "LabelDelimiter": NotRequired[str],
        "AugmentedManifests": NotRequired[List[AugmentedManifestsListItemExtraOutputTypeDef]],
        "DocumentType": NotRequired[DocumentClassifierDocumentTypeFormatType],
        "Documents": NotRequired[DocumentClassifierDocumentsTypeDef],
        "DocumentReaderConfig": NotRequired[DocumentReaderConfigExtraOutputTypeDef],
    },
)
DocumentReaderConfigUnionTypeDef = Union[
    DocumentReaderConfigTypeDef, DocumentReaderConfigExtraOutputTypeDef
]
InputDataConfigExtraOutputTypeDef = TypedDict(
    "InputDataConfigExtraOutputTypeDef",
    {
        "S3Uri": str,
        "InputFormat": NotRequired[InputFormatType],
...
EntityRecognizerInputDataConfigExtraOutputTypeDef = TypedDict(
    "EntityRecognizerInputDataConfigExtraOutputTypeDef",
    {
        "EntityTypes": List[EntityTypesListItemTypeDef],
...
RedactionConfigUnionTypeDef = Union[RedactionConfigTypeDef, RedactionConfigExtraOutputTypeDef]
...
DocumentClassifierInputDataConfigUnionTypeDef = Union[
    DocumentClassifierInputDataConfigTypeDef, DocumentClassifierInputDataConfigExtraOutputTypeDef
]
InputDataConfigUnionTypeDef = Union[InputDataConfigTypeDef, InputDataConfigExtraOutputTypeDef]
...
EntityRecognizerInputDataConfigUnionTypeDef = Union[
    EntityRecognizerInputDataConfigTypeDef, EntityRecognizerInputDataConfigExtraOutputTypeDef
]
