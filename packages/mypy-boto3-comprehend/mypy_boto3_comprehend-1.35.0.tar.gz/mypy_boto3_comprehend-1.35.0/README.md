...
[boto3.Comprehend 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/comprehend.html#Comprehend)
...
def get_value() -> AugmentedManifestsListItemExtraOutputTypeDef:
    return {...}
```
