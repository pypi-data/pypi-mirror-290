<a id="mypy-boto3-bedrock-agent-runtime"></a>
...
[boto3.AgentsforBedrockRuntime 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/bedrock-agent-runtime.html#AgentsforBedrockRuntime)
