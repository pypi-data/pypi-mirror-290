...
LIBDLL_API int generate_fm_minimals(int_64 num, int n, int ratio, int markov, double* weights, double* vv);
LIBDLL_API int generate_fm_minimals_le(int_64 num, int n, int ratio, int markov, double* weights, int_64* vv);
