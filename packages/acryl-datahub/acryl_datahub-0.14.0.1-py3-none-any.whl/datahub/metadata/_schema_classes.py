...
class DataHubActionKeyClass(_Aspect):
    ...
    ASPECT_INFO = {'keyForEntity': 'dataHubAction', 'entityCategory': 'internal', 'entityAspects': []}
...
class QueryKeyClass(_Aspect):
    ...
    ASPECT_INFO = {'keyForEntity': 'query', 'entityCategory': 'core', 'entityAspects': ['queryProperties', 'querySubjects', 'queryUsageStatistics', 'status', 'dataPlatformInstance', 'subTypes']}
...
class SchemaFieldKeyClass(_Aspect):
    ...
    ASPECT_INFO = {'keyForEntity': 'schemaField', 'entityCategory': 'core', 'entityAspects': ['schemafieldInfo', 'structuredProperties', 'forms', 'businessAttributes', 'documentation', 'testResults']}
...
class TagKeyClass(_Aspect):
    ...
    ASPECT_NAME = 'tagKey'
    ASPECT_INFO = {'keyForEntity': 'tag', 'entityCategory': 'core', 'entityAspects': ['tagProperties', 'ownership', 'deprecation', 'status', 'testResults']}
...
class GlobalSettingsInfoClass(_Aspect):
    ...
    def __init__(self,
        ...
        docPropagation: Optional["DocPropagationFeatureSettingsClass"]=None,
    ):
        super().__init__()
    ...
    @property
    def docPropagation(self) -> "DocPropagationFeatureSettingsClass":
    ...
    def docPropagation(self, value: "DocPropagationFeatureSettingsClass") -> None:
