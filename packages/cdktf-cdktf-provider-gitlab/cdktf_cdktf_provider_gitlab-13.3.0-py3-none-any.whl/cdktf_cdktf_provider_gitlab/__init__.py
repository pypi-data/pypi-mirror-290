r'''
# CDKTF prebuilt bindings for gitlabhq/gitlab provider version 17.3.0

This repo builds and publishes the [Terraform gitlab provider](https://registry.terraform.io/providers/gitlabhq/gitlab/17.3.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform gitlab provider](https://registry.terraform.io/providers/gitlabhq/gitlab/17.3.0)
