...
class AuthMethod:
    ...
    def get_secret(self, secret_arn: str) -> dict:
        ...
        try:
            ...
            response = json.loads(client.get_secret_value(SecretId=secret_arn)["SecretString"])
            return response
        except Exception as e:
            logging.error(f"Error getting secret from AWS Secrets Manager for ARN: {secret_arn}: {e}")
            return {}
