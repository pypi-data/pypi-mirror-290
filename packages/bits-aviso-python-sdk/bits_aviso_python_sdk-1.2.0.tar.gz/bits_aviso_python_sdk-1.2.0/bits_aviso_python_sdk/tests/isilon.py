...
from bits_aviso_python_sdk.helpers import export_to_json
...
class TestIsilon(unittest.TestCase):
    ...
    def test_get_quota_for_cluster(self, mock_get):
        """Test the get_quota_for_cluster method."""
        cluster_name = 'iron'
        ...
        quota_data, error_payload = self.isilon.get_quota_for_cluster(cluster_name, cluster_ip)
...
def test():
    ...
    quota_data, quota_error_data = isilon.get_all_quotas()
    export_to_json(quota_data, 'quota_data.json')
    network_pool_data, network_error_data = isilon.get_all_network_pools()
    export_to_json(network_pool_data, 'network_pool_data.json')
