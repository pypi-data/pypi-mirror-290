...
class AccountClient(BaseClient):
    ...
    def accept_primary_email_update(
        self, *, AccountId: str, Otp: str, PrimaryEmail: str
    ) -> AcceptPrimaryEmailUpdateResponseTypeDef:
        """
    ...
    def close(self) -> None:
        ...
        [Show boto3-stubs documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_account/client/#close)
        """
    ...
    def disable_region(
        self, *, RegionName: str, AccountId: str = ...
    ) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def get_primary_email(self, *, AccountId: str) -> GetPrimaryEmailResponseTypeDef:
        """
    ...
    def put_contact_information(
        self, *, ContactInformation: ContactInformationTypeDef, AccountId: str = ...
    ) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def start_primary_email_update(
        self, *, AccountId: str, PrimaryEmail: str
    ) -> StartPrimaryEmailUpdateResponseTypeDef:
        """
