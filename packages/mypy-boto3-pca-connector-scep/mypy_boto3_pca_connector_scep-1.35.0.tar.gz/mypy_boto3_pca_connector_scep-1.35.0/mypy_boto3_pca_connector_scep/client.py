...
class PrivateCAConnectorforSCEPClient(BaseClient):
    ...
    def close(self) -> None:
        ...
        [Show boto3-stubs documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_pca_connector_scep/client/#close)
        """

    def create_challenge(
        self, *, ConnectorArn: str, ClientToken: str = ..., Tags: Mapping[str, str] = ...
    ) -> CreateChallengeResponseTypeDef:
        """
    ...
    def delete_challenge(self, *, ChallengeArn: str) -> EmptyResponseMetadataTypeDef:
        """
    ...
    def delete_connector(self, *, ConnectorArn: str) -> EmptyResponseMetadataTypeDef:
        """
        Deletes the specified
