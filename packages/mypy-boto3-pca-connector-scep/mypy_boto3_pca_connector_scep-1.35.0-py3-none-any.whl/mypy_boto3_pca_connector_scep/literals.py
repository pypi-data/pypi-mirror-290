...
[Open documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_pca_connector_scep/literals/)
...
__all__ = (
    ...
    "PrivateCAConnectorforSCEPServiceName",
    "ServiceName",
    "ResourceServiceName",
    "PaginatorName",
)
...
PrivateCAConnectorforSCEPServiceName = Literal["pca-connector-scep"]
ServiceName = Literal[
    "accessanalyzer",
    "account",
    "acm",
...
PaginatorName = Literal["list_challenge_metadata", "list_connectors"]
