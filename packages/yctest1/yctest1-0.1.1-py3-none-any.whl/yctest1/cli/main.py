...
from yctest1.cli.init import init

from yctest1.cli.reset import reset
...
def main():
    ...
    parser.add_argument("--project_name",type=str,default="yctest1",help="project名称")
    ...
    start_parser.add_argument("--rag_dbname",type=str,help="保存的向量数据库，默认rag.faiss") 
