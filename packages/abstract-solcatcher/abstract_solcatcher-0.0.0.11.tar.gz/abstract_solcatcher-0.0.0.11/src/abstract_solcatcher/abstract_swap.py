...
from abstract_solcatcher.abstract_flask import view_table
from abstract_solcatcher.abstract_call import getCallRequest
class PoolManager:
    def __init__(self):
        self.poolInfo = view_table('pool_info', latest=True)[0]
        self.update_tokens()
    ...
    def get_token_info(self, typ='base'):
        ...
        MetaData = getCallRequest('getMetaData', **{f'{typ}Mint': Mint})
        AccountInfo = getCallRequest('getAccountInfo', account=Mint)
...
print("Amount out for 20 units:", pool_manager.calculate_amount_out(20))
print("Amount in for 20 units:", pool_manager.calculate_amount_in(20))
input(pool_manager.poolInfo)
