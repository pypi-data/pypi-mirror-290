...
from good_common.utilities._collections import (
    merge_dicts, deduplicate_dicts, clean_dict, recursive_remove_nones,
    set_defaults, merge_lists, flatten_list, recursive_to_dict, to_dict,
    map_object, expand_nested_json, recursive_default, recursive_get,
    recursive_convert_lists, index_object, deindex_object, DotDict,
    dict_to_flatdict, flatdict_to_dict, flatten_seq
)
...
def test_dotdict():
    ...
    assert regular_dict == {"a": 1, "b": {"c": 2}, "d": {"e": 3}, "f": [{"g": 4}, {"h": 5}]}
