...
[boto3.BedrockRuntime 1.35.0](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/bedrock-runtime.html#BedrockRuntime)
...
- [mypy-boto3-bedrock-runtime](#mypy-boto3-bedrock-runtime)
...
- Install `boto3-stubs[bedrock-runtime]` in your environment:
...
Install `boto3-stubs-lite[bedrock-runtime]` in your environment:
...
- Install `boto3-stubs[bedrock-runtime]` with services you use in your
  environment:
...
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_bedrock_runtime/type_defs/).
...
`mypy-boto3-bedrock-runtime` version is the same as related `boto3` version and
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_bedrock_runtime/)
