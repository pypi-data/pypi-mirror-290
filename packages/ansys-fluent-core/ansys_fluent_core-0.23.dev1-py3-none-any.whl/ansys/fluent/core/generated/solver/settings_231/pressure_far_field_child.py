...
from .phase_16 import phase as phase_cls
...
class pressure_far_field_child(Group):
    ...
    child_names = \
        ['phase', 'geom_disable', 'geom_dir_spec', 'geom_dir_x', 'geom_dir_y',
         ...
         't', 'non_equil_boundary', 'tve', 'coordinate_system', 'ni', 'nj',
         'nk', 'flow_direction', 'axis_direction', 'axis_origin', 'ke_spec',
         ...
         'in_emiss', 'fmean', 'fvar', 'fmean2', 'fvar2',
    ...
    return_type = "<object object at 0x7f7e08100b50>"
