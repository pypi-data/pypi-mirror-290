...
from .add_custom_vector import add_custom_vector as add_custom_vector_cls
...
class surface_integrals(Command):
    ...
    argument_names = \
        ['report_type', 'surface_id', 'add_custom_vector', 'cust_vec_name',
    ...
    _child_classes = dict(
        ...
        add_custom_vector=add_custom_vector_cls,
    ...
    return_type = "<object object at 0x7f54b7a388b0>"
