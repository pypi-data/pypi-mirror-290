...
from .cell_function_3 import cell_function as cell_function_cls
...
from .layering_1 import layering as layering_cls
...
class set(Group):
    ...
    child_names = \
        ['across_zone_boundaries', 'cell_function', 'load_distribution',
         'merge', 'partition_origin_vector', 'pre_test', 'smooth',
         'print_verbosity', 'origin', 'laplace_smoothing',
         'nfaces_as_weights', 'face_area_as_weights', 'layering',
         'solid_thread_weight', 'stretched_mesh_enhancement',
         'particle_weight', 'vof_free_surface_weight', 'isat_weight',
