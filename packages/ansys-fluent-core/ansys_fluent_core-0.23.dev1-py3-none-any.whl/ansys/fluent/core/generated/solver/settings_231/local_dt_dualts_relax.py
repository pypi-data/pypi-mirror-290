...
class local_dt_dualts_relax(NamedObject[relaxation_factor_child], _NonCreatableNamedObjectMixin[relaxation_factor_child]):
    """
    ...
    """
    return_type = "<object object at 0x7f7de61d0450>"
