...
class band_q_irrad_diffuse(NamedObject[reference_frame_velocity_child], _NonCreatableNamedObjectMixin[reference_frame_velocity_child]):
    """
    Diffuse Irradiation.
    """
    ...
    """
    return_type = "<object object at 0x7f3ecb619b30>"
