...
class tangential_coefficient(Group):
    """
    Set the tangential coefficient of restitution.
    """

    fluent_name = "tangential-coefficient"

    child_names = \
        ['option', 'function_of', 'value', 'udf', 'piecewise_polynomial',
