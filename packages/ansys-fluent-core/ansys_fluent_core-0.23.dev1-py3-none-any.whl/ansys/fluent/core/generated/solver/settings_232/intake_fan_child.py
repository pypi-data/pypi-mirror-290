...
from .fan_omega import fan_omega as fan_omega_cls
...
class intake_fan_child(Group):
    ...
    child_names = \
        ['phase', 'name', 'geom_disable', 'geom_dir_spec', 'geom_dir_x',
         ...
         'open_channel', 'inlet_number', 'phase_spec', 'frame_of_reference',
         'gauge_total_pressure', 'gauge_pressure', 't0', 'direction_spec',
         ...
         'pb_smm', 'pb_dqmom_bc', 'pb_dqmom', 'radiation_bc',
         ...
         'in_emiss', 'fmean', 'fvar', 'fmean2', 'fvar2', 'premixc',
