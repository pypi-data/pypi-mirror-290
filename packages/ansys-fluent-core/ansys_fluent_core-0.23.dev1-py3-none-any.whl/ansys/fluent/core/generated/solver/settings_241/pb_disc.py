...
class pb_disc(NamedObject[reference_frame_velocity_child], _NonCreatableNamedObjectMixin[reference_frame_velocity_child]):
    """
    'pb_disc' child.
    """
    ...
    """
    return_type = "<object object at 0x7f3f3ee3d850>"
