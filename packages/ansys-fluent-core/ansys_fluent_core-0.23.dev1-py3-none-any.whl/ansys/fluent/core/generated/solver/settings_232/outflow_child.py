...
class outflow_child(Group):
    ...
    child_names = \
        ['phase', 'name', 'geom_disable', 'geom_dir_spec', 'geom_dir_x',
         ...
         'flowrate_frac', 'elec_potential_type', 'potential_value',
         'dual_potential_type', 'dual_potential_value', 'x_displacement_type',
    ...
    return_type = "<object object at 0x7f54e88dbb70>"
