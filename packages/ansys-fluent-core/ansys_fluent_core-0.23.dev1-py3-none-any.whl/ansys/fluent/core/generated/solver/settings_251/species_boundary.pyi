...
from .species_boundary_child import species_boundary_child


class species_boundary(NamedObject[species_boundary_child], _NonCreatableNamedObjectMixin[species_boundary_child]):
    fluent_name = ...
    command_names = ...
