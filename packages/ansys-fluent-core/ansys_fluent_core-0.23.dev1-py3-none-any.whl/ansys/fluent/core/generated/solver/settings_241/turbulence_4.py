...
class turbulence(Group):
    ...
    child_names = \
        ['les_spec', 'fluctuating_velocity_algorithm',
         'number_of_fourier_modes', 'number_of_vortices',
         'include_streamwise_fluctuations', 'satisfy_mass_conservation',
         'scale_search_limiter', 'turbulent_intensity_perc',
         'turbulent_viscosity_ratio_stg', 'wall_distance',
         'volumetric_forcing', 'forcing_zone_thickness',
         'volumetric_thickness', 'turbulent_specification',
    ...
    return_type = "<object object at 0x7f3ecb846550>"
