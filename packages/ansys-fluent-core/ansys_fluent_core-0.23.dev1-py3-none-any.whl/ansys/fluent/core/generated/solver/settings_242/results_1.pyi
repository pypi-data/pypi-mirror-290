...
from .results_child import results_child


class results(NamedObject[results_child], _NonCreatableNamedObjectMixin[results_child]):
    fluent_name = ...
    command_names = ...
    ...
    child_object_type: results_child = ...
