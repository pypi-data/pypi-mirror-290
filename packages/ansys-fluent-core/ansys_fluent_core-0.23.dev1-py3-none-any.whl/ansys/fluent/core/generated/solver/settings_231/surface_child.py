...
class surface_child(Group):
    ...
    child_names = \
        ['report_type', 'custom_vector', 'field', 'surfaces', 'geometry',
         'physics', 'retain_instantaneous_values', 'phase', 'average_over',
         'per_surface', 'old_props', 'surface_names', 'surface_ids']
    ...
    return_type = "<object object at 0x7f7de619b3f0>"
