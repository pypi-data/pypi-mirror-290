...
class contact_angles(NamedObject[reference_frame_velocity_child], _NonCreatableNamedObjectMixin[reference_frame_velocity_child]):
    """
    Contact Angles.
    """
    ...
    """
    return_type = "<object object at 0x7f3ecbf0f810>"
