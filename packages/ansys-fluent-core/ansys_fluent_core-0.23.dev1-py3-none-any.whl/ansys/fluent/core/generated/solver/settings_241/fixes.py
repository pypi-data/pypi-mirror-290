...
class fixes(NamedObject[reference_frame_velocity_child], _NonCreatableNamedObjectMixin[reference_frame_velocity_child]):
    """
    Fixed Values.
    """
    ...
    """
    return_type = "<object object at 0x7f3f0452baa0>"
