...
class methods(Group):
    ...
    child_names = \
        ['accelerated_non_iterative_time_marching',
         ...
         'nita_expert_controls', 'nita', 'overset', 'p_v_coupling',
         'phase_based_vof_discretization', 'reduced_rank_extrapolation',
         'reduced_rank_extrapolation_options', 'residual_smoothing',
         'unsteady_1st_order', 'unsteady_2nd_order',
    ...
    return_type = "<object object at 0x7f7de619b270>"
