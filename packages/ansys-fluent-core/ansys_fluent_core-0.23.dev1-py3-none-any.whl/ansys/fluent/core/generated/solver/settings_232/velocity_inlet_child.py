...
class velocity_inlet_child(Group):
    ...
    child_names = \
        ['phase', 'name', 'geom_disable', 'geom_dir_spec', 'geom_dir_x',
         'geom_dir_y', 'geom_dir_z', 'geom_levels', 'geom_bgthread',
         'open_channel_wave_bc', 'ocw_vel_segregated', 'velocity_spec',
         'frame_of_reference', 'vmag', 'wave_velocity_spec',
         'avg_flow_velocity', 'ocw_ship_vel_spec', 'ocw_ship_vmag',
         'moving_object_direction', 'ocw_sp_vel_spec', 'ocw_sp_vmag',
         'secondary_phase_direction', 'ocw_pp_vel_spec', 'ocw_pp_ref_ht',
         'ocw_pp_power_coeff', 'ocw_pp_vmag', 'ocw_pp_vmag_ref',
         'primary_phase_direction', 'initial_gauge_pressure',
         'coordinate_system', 'velocity', 'flow_direction', 'axis_direction',
         'axis_origin', 'omega_swirl', 'phase_spec', 'wave_bc_type',
         'ht_local', 'ht_bottom', 'wave_dir_spec', 'reference_direction',
         'wave_modeling_type', 'wave_list', 'wave_list_shallow',
         'wave_spect_method_freq', 'wave_spect_factor',
         'wave_spect_sig_wave_ht', 'wave_spect_peak_freq',
         'wave_spect_min_freq', 'wave_spect_max_freq',
         ...
         'pb_qmom_bc', 'pb_qmom', 'pb_qbmm_bc', 'pb_qbmm', 'pb_smm_bc',
         'pb_smm', 'pb_dqmom_bc', 'pb_dqmom', 'gauge_pressure', 'premixc',
         'premixc_var', 'ecfm_sigma', 'inert', 'pollut_no', 'pollut_hcn',
         'pollut_nh3', 'pollut_n2o', 'pollut_urea', 'pollut_hnco',
         'pollut_nco', 'pollut_so2', 'pollut_h2s', 'pollut_so3', 'pollut_sh',
         'pollut_so', 'pollut_soot', 'pollut_nuclei', 'pollut_ctar',
         'pollut_hg', 'pollut_hgcl2', 'pollut_hcl', 'pollut_hgo', 'pollut_cl',
         'pollut_cl2', 'pollut_hgcl', 'pollut_hocl', 'radiation_bc',
    ...
    return_type = "<object object at 0x7f54b7f6e150>"
