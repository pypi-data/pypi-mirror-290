...
class wall_child(Group):
    ...
    child_names = \
        ['phase', 'name', 'geom_disable', 'geom_dir_spec', 'geom_dir_x',
         'geom_dir_y', 'geom_dir_z', 'geom_levels', 'geom_bgthread', 'd',
         'q_dot', 'material', 'thermal_bc', 't', 'q', 'h', 'tinf',
         'planar_conduction', 'shell_conduction', 'thin_wall', 'motion_bc',
         'shear_bc', 'rough_bc', 'moving', 'relative', 'rotating', 'vmag',
         'wall_translation', 'components', 'velocity', 'in_emiss', 'ex_emiss',
         'trad', 'int_rad', 'trad_internal', 'area_enhancement_factor',
         'rough_option', 'rough_nasa', 'rough_shin_et_al', 'rough_data',
         'roughness_height', 'roughness_const', 'roughness_height_cp',
         'roughness_const_cp', 'roughness_const_nasa', 'roughness_const_shin',
         ...
         'fensapice_dpm_wall_condition', 'fensapice_dpm_bc_norm_coeff',
    ...
    return_type = "<object object at 0x7f54b7d5b6a0>"
