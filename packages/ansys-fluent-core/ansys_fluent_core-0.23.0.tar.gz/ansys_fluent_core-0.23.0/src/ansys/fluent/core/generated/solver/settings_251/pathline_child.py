...
from .attributes import attributes as attributes_cls
...
class pathline_child(Group):
    ...
    child_names = \
        ['name', 'field', 'release_from_surfaces', 'style_attribute',
         'style_attributes', 'options', 'accuracy_control', 'attributes',
         'step', 'skip', 'coarsen', 'onzone', 'range', 'range_options',
         'plot', 'onphysics', 'velocity_domain', 'color_map', 'draw_mesh',
