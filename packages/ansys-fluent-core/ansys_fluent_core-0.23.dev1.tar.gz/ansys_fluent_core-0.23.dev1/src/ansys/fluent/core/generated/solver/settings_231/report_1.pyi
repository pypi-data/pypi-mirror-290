...
class report(Group):
    ...
    def forces(self, options: str, domain_val: str, all_wall_zones: bool, wall_thread_list: List[str], direction_vector: Tuple[Union[float, str], Union[float, str], Union[float, str], momentum_center: Tuple[Union[float, str], Union[float, str], Union[float, str], momentum_axis: Tuple[Union[float, str], Union[float, str], Union[float, str], pressure_coordinate: str, coord_val: Union[float, str], write_to_file: bool, file_name: str, append_data: bool, overwrite: bool):
        """
        'forces' command.
    ...
    def projected_surface_area(self, surface_id_val: List[int], min_feature_size: Union[float, str], proj_plane_norm_comp: Tuple[Union[float, str], Union[float, str], Union[float, str]):
        """
