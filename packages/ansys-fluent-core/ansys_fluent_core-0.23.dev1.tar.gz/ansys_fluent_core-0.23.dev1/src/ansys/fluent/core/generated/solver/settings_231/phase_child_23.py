...
class phase_child(Group):
    ...
    child_names = \
        ['geom_disable', 'geom_dir_spec', 'geom_dir_x', 'geom_dir_y',
         ...
         'pb_dqmom', 'gauge_pressure', 'premixc', 'premixc_var', 'ecfm_sigma',
         'inert', 'pollut_no', 'pollut_hcn', 'pollut_nh3', 'pollut_n2o',
         'pollut_urea', 'pollut_hnco', 'pollut_nco', 'pollut_so2',
         'pollut_h2s', 'pollut_so3', 'pollut_sh', 'pollut_so', 'pollut_soot',
         'pollut_nuclei', 'pollut_ctar', 'pollut_hg', 'pollut_hgcl2',
         'pollut_hcl', 'pollut_hgo', 'pollut_cl', 'pollut_cl2', 'pollut_hgcl',
         'pollut_hocl', 'radiation_bc', 'radial_direction', 'coll_dtheta',
    ...
    return_type = "<object object at 0x7f7de64e3da0>"
