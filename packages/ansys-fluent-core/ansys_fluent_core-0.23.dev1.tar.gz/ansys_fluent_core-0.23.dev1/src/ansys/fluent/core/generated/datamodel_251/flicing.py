    ...
    class Case(PyMenu):
        ...
        class App(PyMenu):
            ...
            def __init__(self, service, rules, path):
                ...
                self.Solution = self.__class__.Solution(service, rules, path + [("Solution", "")])
                self.AlphaFlag = self.__class__.AlphaFlag(service, rules, path + [("AlphaFlag", "")])
                ...
                self.UpdateSetupCFXres = self.__class__.UpdateSetupCFXres(service, rules, "UpdateSetupCFXres", path)
            ...
            class BC(PyNamedObjectContainer):
                ...
                class _BC(PyMenu):
                    ...
                    class IceWall(PyMenu):
                        ...
                        """
                        def __init__(self, service, rules, path):
                            self.Conductivity = self.__class__.Conductivity(service, rules, path + [("Conductivity", "")])
                            self.HeatFluxFile = self.__class__.HeatFluxFile(service, rules, path + [("HeatFluxFile", "")])
                            self.HeatFluxMode = self.__class__.HeatFluxMode(service, rules, path + [("HeatFluxMode", "")])
                            self.HeatFluxValue = self.__class__.HeatFluxValue(service, rules, path + [("HeatFluxValue", "")])
                            self.Icing = self.__class__.Icing(service, rules, path + [("Icing", "")])
                            self.InternalTemperature = self.__class__.InternalTemperature(service, rules, path + [("InternalTemperature", "")])
                            self.Thickness = self.__class__.Thickness(service, rules, path + [("Thickness", "")])
                            super().__init__(service, rules, path)

                        class Conductivity(PyNumerical):
                            """
                            Parameter Conductivity of value type float.
                            """
                            pass

                        class HeatFluxFile(PyTextual):
                            """
                            Parameter HeatFluxFile of value type str.
                            """
                            pass

                        class HeatFluxMode(PyTextual):
                            """
                            Parameter HeatFluxMode of value type str.
                            """
                            pass

                        class HeatFluxValue(PyNumerical):
                            """
                            Parameter HeatFluxValue of value type float.
                            """
                            pass
                        ...
                        class InternalTemperature(PyNumerical):
                            """
                            Parameter InternalTemperature of value type float.
                            """
                            pass

                        class Thickness(PyNumerical):
                            """
                            Parameter Thickness of value type float.
                            """
                            pass
                ...
                class Fluent(PyMenu):
                    ...
                    class Materials(PyMenu):
                        ...
                        def __init__(self, service, rules, path):
                            ...
                            self.AirCpFile = self.__class__.AirCpFile(service, rules, path + [("AirCpFile", "")])
                            ...
                            self.AirDensityFile = self.__class__.AirDensityFile(service, rules, path + [("AirDensityFile", "")])
                            ...
                            self.AirThermalConductivityFile = self.__class__.AirThermalConductivityFile(service, rules, path + [("AirThermalConductivityFile", "")])
                            ...
                            self.AirViscosityFile = self.__class__.AirViscosityFile(service, rules, path + [("AirViscosityFile", "")])
                            self.SettingsSync = self.__class__.SettingsSync(service, rules, path + [("SettingsSync", "")])
                            self.LoadPropertyFile = self.__class__.LoadPropertyFile(service, rules, "LoadPropertyFile", path)
                            super().__init__(service, rules, path)
                        ...
                        class AirCpFile(PyTextual):
                            """
                            Parameter AirCpFile of value type str.
                            """
                            pass
                        ...
                        class AirDensityFile(PyTextual):
                            """
                            Parameter AirDensityFile of value type str.
                            """
                            pass
                        ...
                        class AirThermalConductivityFile(PyTextual):
                            """
                            Parameter AirThermalConductivityFile of value type str.
                            """
                            pass
                        ...
                        class AirViscosityFile(PyTextual):
                            """
                            Parameter AirViscosityFile of value type str.
                            """
                            pass
                        ...
                        class LoadPropertyFile(PyCommand):
                            """
                            Command LoadPropertyFile.
                    ...
                    class Models(PyMenu):
                        ...
                        """
                        def __init__(self, service, rules, path):
                            self.CornerFlowCorrection = self.__class__.CornerFlowCorrection(service, rules, path + [("CornerFlowCorrection", "")])
                        ...
                        class CornerFlowCorrection(PyParameter):
                            """
                            Parameter CornerFlowCorrection of value type bool.
                            """
                            pass
            ...
            class Ice(PyMenu):
                ...
                def __init__(self, service, rules, path):
                    ...
                    self.ICIModel = self.__class__.ICIModel(service, rules, path + [("ICIModel", "")])
                ...
                class Conditions(PyMenu):
                    ...
                    def __init__(self, service, rules, path):
                        ...
                        self.ImpactIceDensityModelCoefficient = self.__class__.ImpactIceDensityModelCoefficient(service, rules, path + [("ImpactIceDensityModelCoefficient", "")])
                        self.ImpactIceDensityRimeLowerLimit = self.__class__.ImpactIceDensityRimeLowerLimit(service, rules, path + [("ImpactIceDensityRimeLowerLimit", "")])
                        self.ImpactIceDensityRimeUpperLimit = self.__class__.ImpactIceDensityRimeUpperLimit(service, rules, path + [("ImpactIceDensityRimeUpperLimit", "")])
                    ...
                    class ImpactIceDensityModelCoefficient(PyNumerical):
                        """
                        Parameter ImpactIceDensityModelCoefficient of value type float.
                        """
                        pass

                    class ImpactIceDensityRimeLowerLimit(PyNumerical):
                        """
                        Parameter ImpactIceDensityRimeLowerLimit of value type float.
                        """
                        pass

                    class ImpactIceDensityRimeUpperLimit(PyNumerical):
                        """
                ...
                class Crystals(PyMenu):
                    ...
                    def __init__(self, service, rules, path):
                        ...
                        self.ShallowAngleEnhancement = self.__class__.ShallowAngleEnhancement(service, rules, path + [("ShallowAngleEnhancement", "")])
                        super().__init__(service, rules, path)
                    ...
                    class ShallowAngleEnhancement(PyParameter):
                        """
                        Parameter ShallowAngleEnhancement of value type bool.
                        """
                        pass

                class ICIModel(PyMenu):
                    """
                    Singleton ICIModel.
                    """
                    def __init__(self, service, rules, path):
                        self.InitialPorosity = self.__class__.InitialPorosity(service, rules, path + [("InitialPorosity", "")])
                        self.WickingMode = self.__class__.WickingMode(service, rules, path + [("WickingMode", "")])
                        self.WickingRate = self.__class__.WickingRate(service, rules, path + [("WickingRate", "")])
                        super().__init__(service, rules, path)

                    class InitialPorosity(PyNumerical):
                        """
                        Parameter InitialPorosity of value type float.
                        """
                        pass

                    class WickingMode(PyTextual):
                        """
                        Parameter WickingMode of value type str.
                        """
                        pass

                    class WickingRate(PyNumerical):
                        """
                        Parameter WickingRate of value type float.
                        """
                        pass
                ...
                class IcingModel(PyMenu):
                    ...
                    def __init__(self, service, rules, path):
                        ...
                        self.ComputeIceShape = self.__class__.ComputeIceShape(service, rules, path + [("ComputeIceShape", "")])
                        self.ConcavityFixAngle = self.__class__.ConcavityFixAngle(service, rules, path + [("ConcavityFixAngle", "")])
                        self.HeatFlux = self.__class__.HeatFlux(service, rules, path + [("HeatFlux", "")])
                        self.IceSmoothingIter = self.__class__.IceSmoothingIter(service, rules, path + [("IceSmoothingIter", "")])
                        self.Model = self.__class__.Model(service, rules, path + [("Model", "")])
                    ...
                    class ComputeIceShape(PyParameter):
                        """
                        Parameter ComputeIceShape of value type bool.
                        """
                        pass

                    class ConcavityFixAngle(PyNumerical):
                        """
                    ...
                    class IceSmoothingIter(PyNumerical):
                        """
            ...
            class Particles(PyMenu):
                ...
                class Type(PyMenu):
                    ...
                    def __init__(self, service, rules, path):
                        ...
                        self.DpmVaporizationSourceFlag = self.__class__.DpmVaporizationSourceFlag(service, rules, path + [("DpmVaporizationSourceFlag", "")])
                    ...
                    class DpmVaporizationSourceFlag(PyParameter):
                        """
            ...
            class Solution(PyMenu):
                ...
                class AirflowRun(PyMenu):
                    ...
                    """
                    def __init__(self, service, rules, path):
                        self.AirflowCFXOutputSolution = self.__class__.AirflowCFXOutputSolution(service, rules, path + [("AirflowCFXOutputSolution", "")])
                    ...
                    class AirflowCFXOutputSolution(PyMenu):
                        """
                    ...
                    class FluentTimeIntegration(PyMenu):
                        ...
                        def __init__(self, service, rules, path):
                            ...
                            self.SolutionControlTransient = self.__class__.SolutionControlTransient(service, rules, path + [("SolutionControlTransient", "")])
                        ...
                        class SolutionControlTransient(PyTextual):
                            """
                            Parameter SolutionControlTransient of value type str.
                            """
                            pass
                ...
                class CHT(PyMenu):
                    ...
                    class CHTControl(PyMenu):
                        ...
                        """
                        def __init__(self, service, rules, path):
                            self.AntiSolverIter = self.__class__.AntiSolverIter(service, rules, path + [("AntiSolverIter", "")])
                            self.DeInnerIter = self.__class__.DeInnerIter(service, rules, path + [("DeInnerIter", "")])
                            self.DeSolverIter = self.__class__.DeSolverIter(service, rules, path + [("DeSolverIter", "")])
                            self.Equations = self.__class__.Equations(service, rules, path + [("Equations", "")])
                            self.NumberLoops = self.__class__.NumberLoops(service, rules, path + [("NumberLoops", "")])
                            super().__init__(service, rules, path)

                        class AntiSolverIter(PyNumerical):
                            """
                            Parameter AntiSolverIter of value type int.
                            """
                            pass

                        class DeInnerIter(PyNumerical):
                            """
                            Parameter DeInnerIter of value type int.
                            """
                            pass

                        class DeSolverIter(PyNumerical):
                            """
                            Parameter DeSolverIter of value type int.
                            """
                            pass
                    ...
                    class CHTOutput(PyMenu):
                        ...
                        """
                        def __init__(self, service, rules, path):
                            self.DeIceRestart = self.__class__.DeIceRestart(service, rules, path + [("DeIceRestart", "")])
                        ...
                        class DeIceRestart(PyParameter):
                            """
                            Parameter DeIceRestart of value type bool.
                            """
                            pass
                ...
                class IceRun(PyMenu):
                    ...
                    class IceAdvanced(PyMenu):
                        ...
                        def __init__(self, service, rules, path):
                            ...
                            self.IceUDFAtEnd = self.__class__.IceUDFAtEnd(service, rules, path + [("IceUDFAtEnd", "")])
                            self.RefreshNames = self.__class__.RefreshNames(service, rules, "RefreshNames", path)
                            super().__init__(service, rules, path)
                        ...
                        class IceUDFAtEnd(PyTextual):
                            """
                            Parameter IceUDFAtEnd of value type str.
                            """
                            pass
                ...
                class ParticlesRun(PyMenu):
                    ...
                    class Output(PyMenu):
                        ...
                        def __init__(self, service, rules, path):
                            ...
                            self.DpmSolveAll = self.__class__.DpmSolveAll(service, rules, path + [("DpmSolveAll", "")])
                            self.NumberedOutput = self.__class__.NumberedOutput(service, rules, path + [("NumberedOutput", "")])
                            self.SaveDelay = self.__class__.SaveDelay(service, rules, path + [("SaveDelay", "")])
                            super().__init__(service, rules, path)
                        ...
                        class DpmSolveAll(PyParameter):
                            """
                            Parameter DpmSolveAll of value type bool.
                            """
                            pass
            ...
            class UpdateSetupCFXres(PyCommand):
                """
        ...
        class Results(PyMenu):
            ...
            class SurfaceDefs(PyNamedObjectContainer):
                ...
                class _SurfaceDefs(PyMenu):
                    ...
                    class SaveImageOptions(PyMenu):
                        """
                        Singleton SaveImageOptions.
                        """
                        def __init__(self, service, rules, path):
                            self.Resolution = self.__class__.Resolution(service, rules, path + [("Resolution", "")])
                            self.Coloring = self.__class__.Coloring(service, rules, path + [("Coloring", "")])
                            self.FileType = self.__class__.FileType(service, rules, path + [("FileType", "")])
                            self.Format = self.__class__.Format(service, rules, path + [("Format", "")])
                            self.Orientation = self.__class__.Orientation(service, rules, path + [("Orientation", "")])
                            self.UseWhiteBackground = self.__class__.UseWhiteBackground(service, rules, path + [("UseWhiteBackground", "")])
                            super().__init__(service, rules, path)

                        class Resolution(PyMenu):
                            """
                            Singleton Resolution.
                            """
                            def __init__(self, service, rules, path):
                                self.DPI = self.__class__.DPI(service, rules, path + [("DPI", "")])
                                self.Height = self.__class__.Height(service, rules, path + [("Height", "")])
                                self.Option = self.__class__.Option(service, rules, path + [("Option", "")])
                                self.UseWindowResolution = self.__class__.UseWindowResolution(service, rules, path + [("UseWindowResolution", "")])
                                self.Width = self.__class__.Width(service, rules, path + [("Width", "")])
                                super().__init__(service, rules, path)

                            class DPI(PyNumerical):
                                """
                            ...
                            class UseWindowResolution(PyParameter):
                                """
                        ...
                        class FileType(PyTextual):
                            """
                            Parameter FileType of value type str.
                            """
                            pass

                        class Format(PyTextual):
                            """
                            Parameter Format of value type str.
                            """
                            pass

                        class Orientation(PyTextual):
                            """
                            Parameter Orientation of value type str.
                            """
                            pass

                        class UseWhiteBackground(PyParameter):
                            """
                ...
                class Contour(PyNamedObjectContainer):
                    ...
                    class _Contour(PyMenu):
                        ...
                        def __init__(self, service, rules, path):
                            ...
                            self.ManageViews = self.__class__.ManageViews(service, rules, "ManageViews", path)
                            ...
                            self.SaveImage = self.__class__.SaveImage(service, rules, "SaveImage", path)
                            self.SaveView = self.__class__.SaveView(service, rules, "SaveView", path)
                            self.UpdateMinMax = self.__class__.UpdateMinMax(service, rules, "UpdateMinMax", path)
                            super().__init__(service, rules, path)
                        ...
                        class ColorMap(PyMenu):
                            ...
                            """
                            def __init__(self, service, rules, path):
                                self.AutoFontSize = self.__class__.AutoFontSize(service, rules, path + [("AutoFontSize", "")])
                                self.ColorMap = self.__class__.ColorMap(service, rules, path + [("ColorMap", "")])
                                self.FixedFontSize = self.__class__.FixedFontSize(service, rules, path + [("FixedFontSize", "")])
                            ...
                            class AutoFontSize(PyNumerical):
                                """
                                Parameter AutoFontSize of value type float.
                                """
                                pass
                            ...
                            class FixedFontSize(PyNumerical):
                                """
                                Parameter FixedFontSize of value type int.
                                """
                                pass
