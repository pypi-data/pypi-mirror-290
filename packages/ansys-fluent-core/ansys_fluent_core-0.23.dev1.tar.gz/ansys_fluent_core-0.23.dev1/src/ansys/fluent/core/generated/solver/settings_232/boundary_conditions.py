...
class boundary_conditions(Group, _ChildNamedObjectAccessorMixin):
    ...
    command_names = \
        ['copy', 'change_type', 'slit_face_zone',
         'slit_interior_between_diff_solids', 'create_all_shell_threads',
         'recreate_all_shells', 'delete_all_shells', 'orient_face_zone']
    ...
    return_type = "<object object at 0x7f54b7d5b880>"
