...
class species_boundary_conditions(NamedObject[turb_visc_func_mf_child], _NonCreatableNamedObjectMixin[turb_visc_func_mf_child]):
    """
    ...
    """
    return_type = "<object object at 0x7f3ecb5df180>"
