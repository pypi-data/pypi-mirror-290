...
from .mirror_planes_child import mirror_planes_child


class mirror_planes(NamedObject[mirror_planes_child], _NonCreatableNamedObjectMixin[mirror_planes_child]):
    fluent_name = ...
    command_names = ...
