...
from .surface_tension_child import surface_tension_child


class surface_tension(NamedObject[surface_tension_child], _NonCreatableNamedObjectMixin[surface_tension_child]):
    fluent_name = ...
    command_names = ...
