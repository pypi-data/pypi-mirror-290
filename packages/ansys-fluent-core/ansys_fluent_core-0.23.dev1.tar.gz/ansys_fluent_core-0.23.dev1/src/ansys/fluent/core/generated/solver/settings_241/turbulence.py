...
from .turbulent_viscosity_ratio_real import turbulent_viscosity_ratio_real as turbulent_viscosity_ratio_real_cls
...
class turbulence(Group):
    ...
    return_type = "<object object at 0x7f3f242390d0>"
