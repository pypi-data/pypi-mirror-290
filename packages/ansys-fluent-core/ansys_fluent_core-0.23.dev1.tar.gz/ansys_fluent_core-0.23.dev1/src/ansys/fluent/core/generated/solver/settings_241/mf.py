...
class mf(NamedObject[reference_frame_velocity_child], _NonCreatableNamedObjectMixin[reference_frame_velocity_child]):
    """
    'mf' child.
    """
    ...
    """
    return_type = "<object object at 0x7f3f24239710>"
