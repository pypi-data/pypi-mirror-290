...
from .x_fan_origin import x_fan_origin as x_fan_origin_cls
from .y_fan_origin import y_fan_origin as y_fan_origin_cls
from .z_fan_origin import z_fan_origin as z_fan_origin_cls
from .fan_origin_components import fan_origin_components as fan_origin_components_cls
...
class mass_flow_inlet_child(Group):
    ...
    child_names = \
        ['phase', 'geom_disable', 'geom_dir_spec', 'geom_dir_x', 'geom_dir_y',
         ...
         'inlet_number', 'phase_spec', 'ht_local', 'ht_bottom', 'den_spec',
         'frame_of_reference', 'flow_spec', 'mass_flow', 'ec_mass_flow',
         'mass_flux', 'mass_flux_ave', 'tref', 'pref', 'upstream_torque',
         'upstream_t_enthalpy', 't0', 'supersonic_or_initial_gauge_pressure',
         ...
         'equ_required', 'swirl_model', 'swirl_factor', 'x_fan_origin',
         'y_fan_origin', 'z_fan_origin', 'fan_origin_components', 'premixc',
         ...
         'pollut_cl2', 'pollut_hgcl', 'pollut_hocl',
    ...
    _child_classes = dict(
        ...
        x_fan_origin=x_fan_origin_cls,
        y_fan_origin=y_fan_origin_cls,
        z_fan_origin=z_fan_origin_cls,
        fan_origin_components=fan_origin_components_cls,
        premixc=premixc_cls,
    ...
    return_type = "<object object at 0x7f9f67bdd280>"
