...
class mass_flow_inlet_child(Group):
    ...
    child_names = \
        ['phase', 'name', 'geom_disable', 'geom_dir_spec', 'geom_dir_x',
         ...
         'open_channel', 'inlet_number', 'phase_spec', 'ht_local',
         'ht_bottom', 'den_spec', 'frame_of_reference', 'flow_spec',
         'mass_flow', 'ec_mass_flow', 'mass_flux', 'mass_flux_ave', 'tref',
         'pref', 'upstream_torque', 'upstream_t_enthalpy', 't0',
         'gauge_pressure', 'direction_spec', 'coordinate_system',
         'flow_direction', 'direction_vector', 'axis_direction',
         'axis_origin', 'ke_spec', 'nut', 'kl', 'intermit', 'k', 'e', 'o',
         'v2', 'turb_intensity', 'turb_length_scale', 'turb_hydraulic_diam',
         'turb_viscosity_ratio', 'turb_viscosity_ratio_profile', 'rst_spec',
         'uu', 'vv', 'ww', 'uv', 'vw', 'uw', 'ksgs_spec', 'ksgs',
         'sgs_turb_intensity', 'species_in_mole_fractions', 'mf',
         ...
         'equ_required', 'swirl_model', 'swirl_factor', 'fan_origin',
    ...
    return_type = "<object object at 0x7f550c4a0980>"
