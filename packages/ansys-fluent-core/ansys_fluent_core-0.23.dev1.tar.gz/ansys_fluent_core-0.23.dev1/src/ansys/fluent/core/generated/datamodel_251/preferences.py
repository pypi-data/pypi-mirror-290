...
class Root(PyMenu):
    ...
    class Appearance(PyMenu):
        ...
        def __init__(self, service, rules, path):
            ...
            self.TransientPostProcessing = self.__class__.TransientPostProcessing(service, rules, path + [("TransientPostProcessing", "")])
            super().__init__(service, rules, path)
        ...
        class TransientPostProcessing(PyParameter):
            """
            Parameter TransientPostProcessing of value type bool.
            """
            pass
