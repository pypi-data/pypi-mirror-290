...
class pb_qmom(NamedObject[reference_frame_velocity_child], _NonCreatableNamedObjectMixin[reference_frame_velocity_child]):
    """
    'pb_qmom' child.
    """
    ...
    """
    return_type = "<object object at 0x7f3f3ee3d9e0>"
