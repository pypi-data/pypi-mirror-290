...
from .participates_in_view_factor_calculation import participates_in_view_factor_calculation as participates_in_view_factor_calculation_cls
...
class radiation(Group):
    ...
    return_type = "<object object at 0x7f3f3ebf6e20>"
