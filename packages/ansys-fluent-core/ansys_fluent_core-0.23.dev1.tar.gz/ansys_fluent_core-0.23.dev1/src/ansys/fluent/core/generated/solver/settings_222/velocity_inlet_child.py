...
from .moving_object_direction_components import moving_object_direction_components as moving_object_direction_components_cls
from .ocw_sp_vel_spec import ocw_sp_vel_spec as ocw_sp_vel_spec_cls
from .ocw_sp_vmag import ocw_sp_vmag as ocw_sp_vmag_cls
from .secondary_phase_direction_components import secondary_phase_direction_components as secondary_phase_direction_components_cls
...
from .primary_phase_direction_components import primary_phase_direction_components as primary_phase_direction_components_cls
from .p_sup import p_sup as p_sup_cls
from .coordinate_system import coordinate_system as coordinate_system_cls
from .velocity_component import velocity_component as velocity_component_cls
...
class velocity_inlet_child(Group):
    ...
    _child_classes = dict(
        ...
        moving_object_direction_components=moving_object_direction_components_cls,
        ocw_sp_vel_spec=ocw_sp_vel_spec_cls,
        ocw_sp_vmag=ocw_sp_vmag_cls,
        secondary_phase_direction_components=secondary_phase_direction_components_cls,
        ...
        primary_phase_direction_components=primary_phase_direction_components_cls,
        p_sup=p_sup_cls,
        coordinate_system=coordinate_system_cls,
        velocity_component=velocity_component_cls,
    ...
    return_type = "<object object at 0x7f9f672a7090>"
