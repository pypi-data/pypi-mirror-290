...
class diffuse_irradiation(NamedObject[reference_frame_velocity_child], _NonCreatableNamedObjectMixin[reference_frame_velocity_child]):
    """
    Diffuse Irradiation.
    """
    ...
    """
    return_type = "<object object at 0x7f3f24239390>"
