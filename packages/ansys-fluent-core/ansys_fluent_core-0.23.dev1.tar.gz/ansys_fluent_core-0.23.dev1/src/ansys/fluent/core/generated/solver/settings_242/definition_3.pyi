...
from .definition_child_1 import definition_child


class definition(NamedObject[definition_child], CreatableNamedObjectMixinOld[definition_child]):
    fluent_name = ...
    command_names = ...
    ...
    child_object_type: definition_child = ...
