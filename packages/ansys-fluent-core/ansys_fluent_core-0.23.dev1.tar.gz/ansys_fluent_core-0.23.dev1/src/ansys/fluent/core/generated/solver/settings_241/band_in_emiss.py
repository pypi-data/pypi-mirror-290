...
class band_in_emiss(NamedObject[reference_frame_velocity_child], _NonCreatableNamedObjectMixin[reference_frame_velocity_child]):
    """
    'band_in_emiss' child.
    """
    ...
    """
    return_type = "<object object at 0x7f3ecb6197d0>"
