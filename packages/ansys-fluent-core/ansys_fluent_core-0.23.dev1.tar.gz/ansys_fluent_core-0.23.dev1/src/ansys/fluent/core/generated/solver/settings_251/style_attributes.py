...
from .min_ribb import min_ribb as min_ribb_cls
from .max_ribb import max_ribb as max_ribb_cls
from .update_min_max_1 import update_min_max as update_min_max_cls
...
class style_attributes(Group):
    ...
    child_names = \
        ['style', 'line_width', 'space_factor', 'scale', 'width',
         ...
         'scale_factor', 'auto_range', 'minimum', 'maximum', 'min_ribb',
         'max_ribb']
    ...
    _child_classes = dict(
        ...
        minimum=minimum_cls,
        maximum=maximum_cls,
        min_ribb=min_ribb_cls,
        max_ribb=max_ribb_cls,
