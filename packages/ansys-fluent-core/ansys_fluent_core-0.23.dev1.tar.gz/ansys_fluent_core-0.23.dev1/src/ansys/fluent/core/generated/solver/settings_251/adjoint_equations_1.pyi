...
from .adjoint_equations_child_1 import adjoint_equations_child


class adjoint_equations(NamedObject[adjoint_equations_child], _NonCreatableNamedObjectMixin[adjoint_equations_child]):
    fluent_name = ...
    command_names = ...
