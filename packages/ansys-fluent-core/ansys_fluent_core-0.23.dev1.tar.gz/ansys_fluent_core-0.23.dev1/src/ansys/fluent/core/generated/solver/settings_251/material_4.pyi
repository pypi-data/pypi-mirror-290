...
from .material_child_1 import material_child


class material(NamedObject[material_child], _NonCreatableNamedObjectMixin[material_child]):
    fluent_name = ...
    command_names = ...
    ...
    child_object_type: material_child = ...
