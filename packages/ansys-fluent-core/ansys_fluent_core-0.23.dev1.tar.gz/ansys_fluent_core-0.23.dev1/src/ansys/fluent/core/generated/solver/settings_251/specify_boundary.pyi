...
from .specify_boundary_child import specify_boundary_child


class specify_boundary(NamedObject[specify_boundary_child], _NonCreatableNamedObjectMixin[specify_boundary_child]):
    fluent_name = ...
    command_names = ...
