...
from .body_force_formulation import body_force_formulation as body_force_formulation_cls
...
class multiphase(Group):
    ...
    child_names = \
        ['models', 'vaporization_pressure', 'non_condensable_gas',
         ...
         'vof_sub_models', 'body_force_formulation', 'vof_parameters',
         'phases', 'phase_interaction', 'wet_steam_settings']
    ...
    _child_classes = dict(
        ...
        body_force_formulation=body_force_formulation_cls,
