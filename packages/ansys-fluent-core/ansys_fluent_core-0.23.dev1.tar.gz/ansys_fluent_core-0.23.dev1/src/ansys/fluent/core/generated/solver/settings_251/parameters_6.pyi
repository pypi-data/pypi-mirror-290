...
from .parameters_child_2 import parameters_child


class parameters(NamedObject[parameters_child], _NonCreatableNamedObjectMixin[parameters_child]):
    fluent_name = ...
    command_names = ...
    ...
    child_object_type: parameters_child = ...
