...
class periodic_instancing(NamedObject[periodic_instancing_child], CreatableNamedObjectMixin[periodic_instancing_child]):
    fluent_name = ...
    command_names = ...
    ...
    def clear_repeats(self, ):
        """
        Clear all periodic repeats.
        """

    child_object_type: periodic_instancing_child = ...
