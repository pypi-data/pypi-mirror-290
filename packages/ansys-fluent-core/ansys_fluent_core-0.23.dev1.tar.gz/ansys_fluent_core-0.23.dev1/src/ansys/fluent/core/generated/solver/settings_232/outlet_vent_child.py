...
from .phase_13 import phase as phase_cls
...
class outlet_vent_child(Group):
    ...
    child_names = \
        ['phase', 'name', 'geom_disable', 'geom_dir_spec', 'geom_dir_x',
         ...
         'press_spec', 'frame_of_reference', 'phase_spec', 'ht_local',
         'gauge_pressure', 'p_profile_multiplier', 'ht_bottom', 'den_spec',
         't0', 'direction_spec', 'coordinate_system', 'flow_direction',
         ...
         'radiating_s2s_surface', 'b', 'strength']
    ...
    return_type = "<object object at 0x7f54e87212c0>"
