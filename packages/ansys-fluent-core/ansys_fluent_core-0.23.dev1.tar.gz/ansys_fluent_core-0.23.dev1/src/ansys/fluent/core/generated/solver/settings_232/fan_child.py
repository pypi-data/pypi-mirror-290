...
class fan_child(Group):
    ...
    child_names = \
        ['phase', 'name', 'geom_disable', 'geom_dir_spec', 'geom_dir_x',
         ...
         'dp_profile', 'swirl_model', 'fan_vr', 'fr', 'hub', 'axis_origin',
         'axis_direction', 'profile_vt', 'vt_profile', 'profile_vr',
         'vr_profile', 'swirl_factor', 'dpm_bc_type',
    ...
    return_type = "<object object at 0x7f550c6562c0>"
