...
class surfaces(Group):
    ...
    command_names = \
        ['create_multiple_zone_surfaces', 'create_multiple_iso_surfaces',
         'create_multiple_plane_surfaces', 'create_group_surfaces',
         'ungroup_surfaces', 'set_rendering_priority', 'reset_zone_surfaces']
    ...
    _child_classes = dict(
        ...
        create_multiple_plane_surfaces=create_multiple_plane_surfaces_cls,
