...
from .field_2 import field as field_cls
from .surfaces_list import surfaces_list as surfaces_list_cls
from .options_14 import options as options_cls
...
from .colorings import colorings as colorings_cls
...
class contour_child(Group):
    ...
    child_names = \
        ['name', 'field', 'surfaces_list', 'options', 'filled', 'node_values',
         'boundary_values', 'contour_lines', 'range_option', 'range_options',
         'coloring', 'colorings', 'color_map', 'draw_mesh', 'mesh_object',
         'display_state_name', 'physics', 'geometry', 'surfaces',
         'deformation', 'deformation_scale']
