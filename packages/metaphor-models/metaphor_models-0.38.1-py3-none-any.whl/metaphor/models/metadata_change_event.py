...
from typing import Optional, Any, List, Union, Dict, TypeVar, Type, Callable, cast
...
class Dataset:
    ...
    def from_dict(obj: Any) -> 'Dataset':
        ...
        return Dataset(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, dataset_created_at, custom_metadata, data_quality, deleted_at, description_assignment, display_name, documentation, entity_type, entity_upstream, field_associations, field_statistics, force_shown, dataset_id, is_complete, is_deleted, is_non_prod, is_production, last_ingested_at, last_modified_at, logical_id, overall_data_quality, ownership_assignment, parsed_upstream, pipeline_info, related_assets, schema, snowflake_stream_info, soda_data_quality, source_info, statistics, structure, system_contacts, system_description, system_tags, system_tag_values, tag_assignment, unity_catalog, usage, dataset_versioned_id)
...
class SearchHighlight:
    ...
    def from_dict(obj: Any) -> 'SearchHighlight':
        ...
        column = from_union([from_str, from_none], obj.get("column"))
        email = from_union([from_str, from_none], obj.get("email"))
        return SearchHighlight(author_display_name, contact_display_names, content, governed_tags, hashtags, name, description, column, email)
...
class QueryInfo:
    ...
    def from_dict(obj: Any) -> 'QueryInfo':
        ...
        return QueryInfo(bytes_read, bytes_written, cost, elapsed_time, entity_ids, id, issued_at, issued_by, issued_by_email, platform, query, rows_read, rows_written)
...
class MetadataChangeEvent:
    ...
    def from_dict(obj: Any) -> 'MetadataChangeEvent':
        ...
        return MetadataChangeEvent(dashboard, dataset, event_header, external_search_document, hierarchy, knowledge_card, metric, pipeline, query_attributions, query_logs, user_activity, virtual_view)
