...
class ThoughtSpotInfo:
    ...
    def from_dict(obj: Any) -> 'ThoughtSpotInfo':
        ...
        return ThoughtSpotInfo(embed_url, type)
...
class HierarchyInfo:
    ...
    def from_dict(obj: Any) -> 'HierarchyInfo':
        ...
        return HierarchyInfo(created_at, aspect_type, hierarchy_info_created_at, description, entity_id, id, metabase_collection, name, power_bi_workspace, type)
...
class DashboardLogicalID:
    ...
    def from_dict(obj: Any) -> 'DashboardLogicalID':
        ...
        return DashboardLogicalID(dashboard_id, platform, account, name, type, path, id, email)
...
class LookerViewQuery:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'LookerViewQuery':
        assert isinstance(obj, dict)
        default_database = from_union([from_str, from_none], obj.get("defaultDatabase"))
        default_schema = from_union([from_str, from_none], obj.get("defaultSchema"))
        query = from_union([from_str, from_none], obj.get("query"))
        ...
        return LookerViewQuery(default_database, default_schema, query, source_dataset_account, source_platform)
...
class LookerView:
    ...
    query: Optional[LookerViewQuery] = None
    source_datasets: Optional[List[str]] = None
    url: Optional[str] = None
    ...
    def from_dict(obj: Any) -> 'LookerView':
        ...
        query = from_union([LookerViewQuery.from_dict, from_none], obj.get("query"))
        source_datasets = from_union([lambda x: from_list(from_str, x), from_none], obj.get("sourceDatasets"))
        url = from_union([from_str, from_none], obj.get("url"))
    ...
    def to_dict(self) -> dict:
        ...
        if self.query is not None:
            result["query"] = from_union([lambda x: to_class(LookerViewQuery, x), from_none], self.query)
        if self.source_datasets is not None:
            result["sourceDatasets"] = from_union([lambda x: from_list(from_str, x), from_none], self.source_datasets)
        if self.url is not None:
            result["url"] = from_union([from_str, from_none], self.url)
...
class PowerBIDataset:
    ...
    def from_dict(obj: Any) -> 'PowerBIDataset':
        ...
        url = from_union([from_str, from_none], obj.get("url"))
        workspace_id = from_union([from_str, from_none], obj.get("workspaceId"))
        return PowerBIDataset(created_at, aspect_type, configured_by, power_bi_dataset_created_at, created_date, description, endorsement, entity_id, id, last_refreshed, name, parameters, refresh_schedule, sensitivity_label, source_datasets, tables, url, workspace_id)
...
class ThoughtSpotDataObject:
    ...
    def from_dict(obj: Any) -> 'ThoughtSpotDataObject':
        ...
        url = from_union([from_str, from_none], obj.get("url"))
        return ThoughtSpotDataObject(created_at, aspect_type, columns, thought_spot_data_object_created_at, description, entity_id, id, name, source_datasets, source_virtual_views, type, url)
...
class Entity:
    ...
    def from_dict(obj: Any) -> 'Entity':
        ...
        return Entity(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, entity_created_at, dashboard_info, deleted_at, display_name, entity_type, entity_upstream, force_shown, entity_id, is_complete, is_deleted, is_non_prod, is_production, last_ingested_at, last_modified_at, logical_id, overall_data_quality, parsed_upstream, related_assets, source_info, structure, system_contacts, system_description, system_tags, system_tag_values, entity_versioned_id, custom_metadata, data_quality, description_assignment, documentation, field_associations, field_statistics, ownership_assignment, pipeline_info, schema, snowflake_stream_info, soda_data_quality, statistics, tag_assignment, unity_catalog, usage, dbt_metric, azure_data_factory_pipeline, fivetran, informatica_mapping, power_bi_dataflow, spark, dbt_model, full_name, looker_explore, looker_view, power_bi_dataset, tableau_datasource, thought_spot, level, segments, browse_paths, display_name_without_fallback, hierarchy_info, asset_likes, organization)
...
class MapStringString:
    ...
    to_string_tag_5314: Optional[str] = None
    size: Optional[float] = None

    @staticmethod
    def from_dict(obj: Any) -> 'MapStringString':
        assert isinstance(obj, dict)
        to_string_tag_5314 = from_union([from_str, from_none], obj.get("__@toStringTag@5314"))
        size = from_union([from_float, from_none], obj.get("size"))
        return MapStringString(to_string_tag_5314, size)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.to_string_tag_5314 is not None:
            result["__@toStringTag@5314"] = from_union([from_str, from_none], self.to_string_tag_5314)
        if self.size is not None:
            result["size"] = from_union([to_float, from_none], self.size)
        return result
