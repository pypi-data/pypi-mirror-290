import os
import re
from .base_producer import BlockingProducer as AMQPBlockingProducer, ConnectionError
    ...
    def create_producer(cls, raise_on_connection_error=False, use_http_producer=True):
        try:
            ...
            if queue_server_url is not None:
                producer_class = None
                use_http_producer = use_http_producer and os.environ.get("UTF_QUEUE_USE_HTTP_PRODUCER") == "true"
