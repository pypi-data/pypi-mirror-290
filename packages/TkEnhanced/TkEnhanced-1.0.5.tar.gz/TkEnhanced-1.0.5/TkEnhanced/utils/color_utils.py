...
class ColorUtils:
    ...
    def is_hex_code_valid(hex_code: str) -> bool:
        if not hex_code.startswith("#") or not len(hex_code) in (4, 7):
            return False
    ...
    @staticmethod
    def generate_palette_colors(start_hex_code: str, end_hex_code: str, *, color_amount: Optional[int] = 2) -> Generator[str, None, None]:
