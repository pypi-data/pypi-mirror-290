# Local imports:
from .utils import PathDescription
...
class EnhImage(EnhLabel):
    ...
    def __init__(self, master: Optional[Misc] = None, *, imagepath: PathDescription = None, **standard_options: Any) -> None:
        super().__init__(master, **standard_options)
        self.configure(imagepath=imagepath)
