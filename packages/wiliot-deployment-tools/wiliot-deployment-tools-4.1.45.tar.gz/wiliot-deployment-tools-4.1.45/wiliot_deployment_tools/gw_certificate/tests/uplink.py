...
# TEST CLASS
UNCOUPLED_STAGES = [OneBrgUnifiedPacketStage, ThreeBrgUnifiedPacketStage, ApiValidationStage, SequentialSequenceIdStage, AliasBridgeIDStage, SensorPacketStage] 
