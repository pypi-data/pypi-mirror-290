...
class GWCertificate:
    def __init__(self, gw_id, owner_id, tests:list = [], topic_suffix='', update_fw=False):
        # Runtime
        ...
        # Version 
        self.gw_cert_version = "1.1.5"
        
        # GW-related
        self.gw_id = gw_id
        self.owner_id = owner_id
        self.topic_suffix = topic_suffix
        self.mqttc = MqttClient(gw_id, owner_id, self.mqtt_logger_filepath, topic_suffix=topic_suffix)
...
if __name__ == "__main__":
    ...
    gw_id = 'gw_id'
    owner_id = 'owner_id'
    gwc = GWCertificate(gw_id=gw_id,owner_id=owner_id, topic_suffix='-test', tests=[ConnectionTest,])
    gwc.run_tests()
