...
class MultiPortfolioData:
    ...
    """
    def get_navs(self,
                 add_benchmarks_to_nav_figure: bool = False,
                 benchmark: str = None,
        ...
        elif add_benchmarks_to_nav_figure:
    ...
    def plot_nav(self,
        ...
        prices = self.get_navs(time_period=time_period, add_benchmarks_to_nav_figure=add_benchmarks_to_nav_figure)
