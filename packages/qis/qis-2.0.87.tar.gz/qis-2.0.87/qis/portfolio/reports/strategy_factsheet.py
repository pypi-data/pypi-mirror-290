...
def generate_strategy_factsheet(portfolio_data: PortfolioData,
    ...
    if portfolio_data.group_data is not None and len(portfolio_data.prices.columns) > 7:  # otherwise tables look too bad
        is_grouped = True
    else:
        is_grouped = False
    ...
    turnover = portfolio_data.get_turnover(time_period=time_period, roll_period=turnover_rolling_period, is_grouped=is_grouped)
