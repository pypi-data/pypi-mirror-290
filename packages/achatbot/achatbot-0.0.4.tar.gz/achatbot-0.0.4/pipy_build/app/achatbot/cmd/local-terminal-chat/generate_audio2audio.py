r"""
TQDM_DISABLE=True python -m achatbot.cmd.local-terminal-chat.generate_audio2audio > ./log/std_out.log

TQDM_DISABLE=True RECORDER_TAG=wakeword_rms_recorder python -m achatbot.cmd.local-terminal-chat.generate_audio2audio > ./log/std_out.log
...
from achatbot.common.connector.multiprocessing_pipe import MultiprocessingPipeConnector
