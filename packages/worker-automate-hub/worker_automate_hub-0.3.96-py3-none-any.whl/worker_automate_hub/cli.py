...
def function_configure(flag: bool):
    ...
    if flag:
        ...
        if workers == None:
            ...
            if r4["assets_config"]:
                asyncio.run(download_assets_and_extract_from_drive())
            ...
            q6 = [inquirer.Confirm("tesseract_install", message="Iniciar a instalação do Tesseract?")]
