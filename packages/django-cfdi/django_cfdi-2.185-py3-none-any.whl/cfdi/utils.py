...
def get_xml_object(xml_text, incluir_texto_direccion=False, venta_global_es_combustible=False, usar_importe_concepto=False, prefix=None):
    """
        ...
        for pago in xml.complemento_pago.find_list("pago"):        
            ...
            if xml.es_v4:
                for p in pago.find_list("doctorelacionado", "pago20"):
                    ...
                    for t in p.find_list("trasladosdr", "pago20"):
                        traslados = {
