...
class TestBaseEntity(TestCase):
    ...
    def test_validate_transient(self):
        ...
        self.assertDictEqual(
            entity.__dict__,
            {'version': 'v1', 'created_on': DateTime(2023, 9, 9, 9, 9, 9, 9, tzinfo=zoneinfo.ZoneInfo(key='UTC')), 'updated_on': DateTime(2023, 9, 9, 9, 9, 9, 9, tzinfo=zoneinfo.ZoneInfo(key='UTC')), 'workspace': 'my_workspace', 'name': 'my_name'}
        )
    ...
    def test_load(self):
        expected_data = compress({'class_name': 'Query', 'method_name': 'load', 'self_obj': {'_klass': 'Portfolio', 'filters': [['workspace', '=', 'my_workspace']], 'order': [], 'projection': None, 'distinct_on': [], 'limit': None, 'offset': None, 'page_size': None, 'page_token': None, '_clean_order': [], '__class_path__': 'everysk.sdk.entities.query.Query'}, 'params': {'offset': 5}}, protocol='gzip', serialize='json')
        ...
        mock_post.assert_called_with(url=self.api_url, headers=self.headers, verify=settings.HTTP_DEFAULT_SSL_VERIFY, timeout=settings.EVERYSK_SDK_HTTP_DEFAULT_TIMEOUT, data=expected_data)
        self.assertIsInstance(result, Portfolio)

    def test_list(self):
        expected_data = compress({'class_name': 'Query', 'method_name': 'loads', 'self_obj': {'_klass': 'Portfolio', 'filters': [['workspace', '=', 'my_workspace']], 'order': [], 'projection': None, 'distinct_on': [], 'limit': None, 'offset': None, 'page_size': None, 'page_token': None, '_clean_order': [], '__class_path__': 'everysk.sdk.entities.query.Query'}, 'params': {'limit': 10, 'offset': 5}}, protocol='gzip', serialize='json')

        with mock.patch('requests.post') as mock_post:
            mock_post.return_value.content = '[{"key": "value"}]'
            mock_post.return_value.status_code = 200
            result = Portfolio.query.where('workspace', 'my_workspace').loads(limit=10, offset=5)
    ...
    def test_page(self):
        ...
        expected_data = compress({'class_name': 'Query', 'method_name': 'page', 'self_obj': {'_klass': 'Portfolio', 'filters': [['workspace', '=', 'my_workspace']], 'order': [], 'projection': None, 'distinct_on': [], 'limit': None, 'offset': None, 'page_size': None, 'page_token': None, '_clean_order': [], '__class_path__': 'everysk.sdk.entities.query.Query'}, 'params': {'page_size': 10, 'page_token': 'page_token'}}, protocol='gzip', serialize='json')
    ...
    def test_pages(self):
        ...
        expected_data = compress({'class_name': 'Query', 'method_name': 'page', 'self_obj': {'_klass': 'Portfolio', 'filters': [['workspace', '=', 'my_workspace']], 'order': [], 'projection': None, 'distinct_on': [], 'limit': None, 'offset': None, 'page_size': None, 'page_token': None, '_clean_order': [], '__class_path__': 'everysk.sdk.entities.query.Query'}, 'params': {'page_size': 10, 'page_token': {'__undefined__': None}}}, protocol='gzip', serialize='json')
    ...
    def test_script_query(self):
        expected_data = compress({'class_name': 'Script', 'method_name': 'fetch', 'self_obj': {'_klass': 'Portfolio', '__class_path__': 'everysk.sdk.entities.script.Script'}, 'params': {'user_input': 'port_12456', 'variant': 'select', 'workspace': None}}, protocol='gzip', serialize='json')
    ...
    def test_retrieve(self):
        expected_data = compress({'class_name': 'Portfolio', 'method_name': 'retrieve', 'self_obj': None, 'params': {'entity_id': 'port_1234567891011211234567890'}}, protocol='gzip', serialize='json')
    ...
    def test_modify(self):
        ...
        expected_data = compress({'class_name': 'Portfolio', 'method_name': 'modify', 'self_obj': None, 'params': {'entity_id': 'port_1234567891011211234567890', 'overwrites': {'base_currency': 'BRL'}}}, protocol='gzip', serialize='json')
    ...
    def test_remove(self):
        expected_data = compress({'class_name': 'Portfolio', 'method_name': 'remove', 'self_obj': None, 'params': {'entity_id': 'port_1234567891011211234567890'}}, protocol='gzip', serialize='json')
    ...
    def test_clone(self):
        sample_portfolio_data = self.sample_portfolio_data.copy()
        sample_portfolio_data['base_currency'] = 'BRL'
        expected_data = compress({'class_name': 'Portfolio', 'method_name': 'clone', 'self_obj': None, 'params': {'entity_id': 'port_1234567891011211234567890', 'overwrites': {'base_currency': 'BRL'}}}, protocol='gzip', serialize='json')
    ...
    def test_modify_many(self):
        ...
        expected_data = compress({'class_name': 'Portfolio', 'method_name': 'modify_many', 'self_obj': None, 'params': {'entity_id_list': ['port_1234567891011211234567890', 'port_1234567891011211234567891'], 'overwrites': [{'name': 'modified_1'}, {'name': 'modified_2'}]}}, protocol='gzip', serialize='json')
        expected_response = []
    ...
    def test_remove_many(self):
        ...
        expected_data = compress({'class_name': 'Portfolio', 'method_name': 'remove_many', 'self_obj': None, 'params': {'entity_id_list': ['port_1234567891011211234567890', 'port_1234567891011211234567891']}}, protocol='gzip', serialize='json')
    ...
    def test_clone_many(self):
        ...
        expected_data = compress({'class_name': 'Portfolio', 'method_name': 'clone_many', 'self_obj': None, 'params': {'entity_id_list': ['port_1234567891011211234567890', 'port_1234567891011211234567891'], 'overwrites': [{'name': 'modified_1'}, {'name': 'modified_1'}]}}, protocol='gzip', serialize='json')
        expected_response = []
    ...
    def test_save(self):
        ...
        expected_data = compress({'class_name': 'Portfolio', 'method_name': 'save', 'self_obj': {'id': 'port_1234567891011211234567890', 'workspace': 'SampleWorkspace', 'name': 'SamplePortfolio', 'tags': ['tag1', 'tag2'], 'link_uid': 'ABC', 'description': 'Description', 'nlv': 1000.0, 'base_currency': 'USD', 'date': '20230909', 'securities': [], 'version': '1.0', 'created_on': {'__datetime__': '2023-09-09T09:09:09.000009+00:00'}, 'updated_on': {'__datetime__': '2023-09-09T09:09:09.000009+00:00'}, 'level': 'HIGH', 'outstanding_shares': 1000, 'source_hash': 'XYZ', 'status': 'OK', 'portfolio_uid': 'UID123', 'check_securities': False, '__class_path__': 'everysk.sdk.entities.portfolio.base.Portfolio'}, 'params': {}}, protocol='gzip', serialize='json')
    ...
    def test_delete(self):
        self.sample_portfolio_data['securities'] = []
        expected_data = compress({'class_name': 'Portfolio', 'method_name': 'delete', 'self_obj': {'id': 'port_1234567891011211234567890', 'workspace': 'SampleWorkspace', 'name': 'SamplePortfolio', 'tags': ['tag1', 'tag2'], 'link_uid': 'ABC', 'description': 'Description', 'nlv': 1000.0, 'base_currency': 'USD', 'date': '20230909', 'securities': [], 'version': '1.0', 'created_on': {'__datetime__': '2023-09-09T09:09:09.000009+00:00'}, 'updated_on': {'__datetime__': '2023-09-09T09:09:09.000009+00:00'}, 'level': 'HIGH', 'outstanding_shares': 1000, 'source_hash': 'XYZ', 'status': 'OK', 'portfolio_uid': 'UID123', 'check_securities': False, '__class_path__': 'everysk.sdk.entities.portfolio.base.Portfolio'}, 'params': {}}, protocol='gzip', serialize='json')
        portfolio = Portfolio(**self.sample_portfolio_data)
