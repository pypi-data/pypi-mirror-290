...
class CustomIndexTestCase(TestCase):
    ...
    def test_validate(self):
        expected_data = compress({'class_name': 'CustomIndex', 'method_name': 'validate', 'self_obj': {'symbol': 'CUSTOM:INDEX', 'name': 'SampleCustomIndex', 'tags': ['tag1', 'tag2'], 'description': 'Description', 'currency': 'USD', 'data': [[1, 2, 3], [4, 5, 6]], 'periodicity': 'M', 'data_type': 'PRICE', 'base_price': 100.0, 'version': '1.0', 'created_on': {'__datetime__': '2023-09-09T09:09:09.000009+00:00'}, 'updated_on': {'__datetime__': '2023-09-09T09:09:09.000009+00:00'}, '__class_path__': 'everysk.sdk.entities.custom_index.base.CustomIndex'}, 'params': {}}, protocol='gzip', serialize='json')
