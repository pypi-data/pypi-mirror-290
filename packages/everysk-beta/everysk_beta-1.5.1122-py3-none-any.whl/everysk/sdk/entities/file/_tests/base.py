...
class FileTestCase(TestCase):
    ...
    def test_validate(self):
        expected_data = compress({'class_name': 'File', 'method_name': 'validate', 'self_obj': {'id': 'file_1234567891011211234567890', 'name': 'SampleFile', 'tags': ['tag1', 'tag2'], 'description': 'Description', 'link_uid': 'link_uid', 'workspace': 'main', 'date': '20230909', 'data': 'base64data', 'url': '/1234567891011211234567890', 'content_type': 'text/csv', 'version': '1.0', 'created_on': {'__datetime__': '2023-09-09T09:09:09.000009+00:00'}, 'updated_on': {'__datetime__': '2023-09-09T09:09:09.000009+00:00'}, 'hash': '4a0ed08522000734bb845f5d72673d9d113c8236', '__class_path__': 'everysk.sdk.entities.file.base.File'}, 'params': {}}, protocol='gzip', serialize='json')
    ...
    def test_validate_transient(self):
        expected_data = compress({'class_name': 'File', 'method_name': 'validate_transient', 'self_obj': None, 'params': {'entity_dict': {'id': 'file_1234567891011211234567890', 'name': 'SampleFile', 'tags': ['tag1', 'tag2'], 'description': 'Description', 'link_uid': 'link_uid', 'workspace': 'main', 'date': '20230909', 'data': 'base64data', 'url': '/1234567891011211234567890', 'content_type': 'text/csv', 'version': '1.0', 'created_on': {'__datetime__': '2023-09-09T09:09:09.000009+00:00'}, 'updated_on': {'__datetime__': '2023-09-09T09:09:09.000009+00:00'}, 'hash': '4a0ed08522000734bb845f5d72673d9d113c8236', '__class_path__': 'everysk.sdk.entities.file.base.File'}}}, protocol='gzip', serialize='json')
        file: File = self.file.copy()
