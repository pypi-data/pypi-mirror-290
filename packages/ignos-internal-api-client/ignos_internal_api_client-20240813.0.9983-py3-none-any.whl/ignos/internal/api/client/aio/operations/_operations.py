...
from ...operations._operations import (
    ...
    build_tenant_credentials_add_integration_credential_type_request,
    build_tenant_credentials_delete_integration_credential_type_request,
    build_tenant_credentials_list_tenant_credential_types_request,
...
class AppsOperations:
    ...
    @distributed_trace_async
    async def create_app(
        self, body: Optional[Union[_models.CreateApp, IO[bytes]]] = None, **kwargs: Any
    ) -> _models.AppDto:
        """Internal Ignos api for creating a new app.
...
class TenantCredentialsOperations:
    ...
    @overload
    async def add_integration_credential_type(
        self,
        tenant_id: str,
    ...
    @distributed_trace_async
    async def delete_integration_credential_type(  # pylint: disable=inconsistent-return-statements
