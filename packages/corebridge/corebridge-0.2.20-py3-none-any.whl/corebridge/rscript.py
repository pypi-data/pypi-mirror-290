...
def install_R_package(pkg:str|list, repo='https://cloud.r-project.org'):
    """
    ...
    for pkg_i in pkg:
        ...
        if run_script_result.returncode != 0:
            ...
            run_script_install = subprocess.run(['Rscript','-e', f"install.packages('{pkg_i}', repos='{repo}')"], capture_output=True)
