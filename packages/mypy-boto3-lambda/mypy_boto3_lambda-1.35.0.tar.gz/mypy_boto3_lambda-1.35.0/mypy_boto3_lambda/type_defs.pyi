...
__all__ = (
    ...
    "AliasRoutingConfigurationExtraOutputTypeDef",
    "AliasRoutingConfigurationTypeDef",
    "AllowedPublishersExtraOutputTypeDef",
    ...
    "SelfManagedEventSourceExtraOutputTypeDef",
...
AliasRoutingConfigurationExtraOutputTypeDef = TypedDict(
    "AliasRoutingConfigurationExtraOutputTypeDef",
    {
        "AdditionalVersionWeights": NotRequired[Dict[str, float]],
    },
...
AllowedPublishersExtraOutputTypeDef = TypedDict(
    "AllowedPublishersExtraOutputTypeDef",
    {
...
CorsExtraOutputTypeDef = TypedDict(
    "CorsExtraOutputTypeDef",
    {
...
ImageConfigExtraOutputTypeDef = TypedDict(
    "ImageConfigExtraOutputTypeDef",
    {
...
SelfManagedEventSourceExtraOutputTypeDef = TypedDict(
    "SelfManagedEventSourceExtraOutputTypeDef",
    {
        "Endpoints": NotRequired[Dict[Literal["KAFKA_BOOTSTRAP_SERVERS"], List[str]]],
    },
...
AliasRoutingConfigurationUnionTypeDef = Union[
    AliasRoutingConfigurationTypeDef, AliasRoutingConfigurationExtraOutputTypeDef
]
...
AllowedPublishersUnionTypeDef = Union[AllowedPublishersTypeDef, AllowedPublishersExtraOutputTypeDef]
...
CorsUnionTypeDef = Union[CorsTypeDef, CorsExtraOutputTypeDef]
...
ImageConfigUnionTypeDef = Union[ImageConfigTypeDef, ImageConfigExtraOutputTypeDef]
...
SelfManagedEventSourceUnionTypeDef = Union[
    SelfManagedEventSourceTypeDef, SelfManagedEventSourceExtraOutputTypeDef
]
