...
WorkspacePropertiesExtraOutputTypeDef = TypedDict(
    "WorkspacePropertiesExtraOutputTypeDef",
    {
        "RunningMode": NotRequired[RunningModeType],
        "RunningModeAutoStopTimeoutInMinutes": NotRequired[int],
...
StreamingPropertiesExtraOutputTypeDef = TypedDict(
    "StreamingPropertiesExtraOutputTypeDef",
    {
...
WorkspacePropertiesUnionTypeDef = Union[
    WorkspacePropertiesTypeDef, WorkspacePropertiesExtraOutputTypeDef
]
...
StreamingPropertiesUnionTypeDef = Union[
    StreamingPropertiesTypeDef, StreamingPropertiesExtraOutputTypeDef
]
