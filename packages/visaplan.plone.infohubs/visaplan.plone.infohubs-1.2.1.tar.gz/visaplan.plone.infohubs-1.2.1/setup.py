...
"""Installer for the visaplan.plone.infohubs package."""
...
package_name = 'visaplan.plone.infohubs'
...
# see as well --> src/visaplan.plone.infohubs/configure.zcml:
exclude_subpackages = (
        )
exclude_packages = []
...
setup_kwargs = dict(
    name=package_name,
    version=VERSION,
    description="A mini language for reuse of information",
    ...
    install_requires=[
        ...
        # -*- Extra requirements: -*-
        'visaplan.tools',
        # ... further (currently unused) dependencies removed. 
    ],
    entry_points="""
