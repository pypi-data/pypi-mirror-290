...
class SubscriptionEventsOrganizationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_subscription_event_endpoint = _Endpoint(
            settings={
                'response_type': (SubscriptionEvent,),
                'auth': [
                    'BearerAuth',
                    'oauth2'
                ],
                'endpoint_path': '/api/subscription_events/{subscription_event_guid}',
                'operation_id': 'get_subscription_event',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_subscription_events_endpoint = _Endpoint(
            settings={
                'response_type': (SubscriptionEventList,),
                'auth': [
                    'BearerAuth',
                    'oauth2'
                ],
                'endpoint_path': '/api/subscription_events',
    ...
    def get_subscription_event(
        self,
        subscription_event_guid,
        **kwargs
    ):
        """Get Subscription Event   # noqa: E501

        Retrieves a Subscription Event.  Required scope: **subscription_events:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_subscription_event(subscription_event_guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['subscription_event_guid'] = \
            subscription_event_guid
        return self.get_subscription_event_endpoint.call_with_http_info(**kwargs)

    def list_subscription_events(
        self,
        **kwargs
    ):
        """Get subscription events list  # noqa: E501

        Retrieves a listing of subscription events s.  Required scope: **subscription_events:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_subscription_events(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.list_subscription_events_endpoint.call_with_http_info(**kwargs)
