...
class SubscriptionEvent(ModelNormal):
    ...
    attribute_map = {
        ...
        'object_guid': 'object_guid',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, guid, event_type, object_guid, organization_guid, created_at, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            environment (str): The environment that the subscription event is configured for; one of sandbox or production.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, guid, event_type, object_guid, organization_guid, created_at, *args, **kwargs):  # noqa: E501
        """SubscriptionEvent - a model defined in OpenAPI
