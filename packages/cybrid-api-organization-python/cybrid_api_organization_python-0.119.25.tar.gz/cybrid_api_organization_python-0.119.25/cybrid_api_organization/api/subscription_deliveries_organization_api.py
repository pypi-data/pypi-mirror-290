"""
    ...
    The version of the OpenAPI document: v0.119.25
...
from cybrid_api_organization.api_client import ApiClient, Endpoint as _Endpoint
from cybrid_api_organization.model_utils import (  # noqa: F401
...
class SubscriptionDeliveriesOrganizationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_subscription_delivery_endpoint = _Endpoint(
            settings={
                'response_type': (SubscriptionDelivery,),
                'auth': [
                    'BearerAuth',
                    'oauth2'
                ],
                'endpoint_path': '/api/subscription_deliveries/',
                'operation_id': 'create_subscription_delivery',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'post_subscription_delivery',
                ],
                'required': [
                    'post_subscription_delivery',
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'post_subscription_delivery': 'body',
                },
        ...
        self.get_subscription_delivery_endpoint = _Endpoint(
            settings={
                'response_type': (SubscriptionDelivery,),
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/subscription_deliveries/{subscription_delivery_guid}',
            ...
            root_map={
                ...
                'attribute_map': {
                    'subscription_delivery_guid': 'subscription_delivery_guid',
                },
                'location_map': {
                    'subscription_delivery_guid': 'path',
                },
                'collection_format_map': {
                }
            },
        ...
        self.list_subscription_deliveries_endpoint = _Endpoint(
            settings={
                'response_type': (SubscriptionDeliveryList,),
                'auth': [
                    'BearerAuth',
                    'oauth2'
                ],
                'endpoint_path': '/api/subscription_deliveries',
                'operation_id': 'list_subscription_deliveries',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'per_page': 'query',
                    'guid': 'query',
                    'subscription_event_guid': 'query',
                    'subscription_guid': 'query',
                },
                'collection_format_map': {
                }
            },
    ...
    def create_subscription_delivery(
        ...
        **kwargs
        ...
        """Create SubscriptionDelivery  # noqa: E501

        Creates a SubscriptionDelivery.  post  Required scope: **subscription_events:execute  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_subscription_delivery(post_subscription_delivery, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['post_subscription_delivery'] = \
            post_subscription_delivery
        return self.create_subscription_delivery_endpoint.call_with_http_info(**kwargs)
    ...
    def get_subscription_delivery(
        ...
        **kwargs
        ...
        """Get Subscription Delivery   # noqa: E501

        Retrieves a subscription delivery.  Required scope: **subscription_events:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_subscription_delivery(subscription_delivery_guid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['subscription_delivery_guid'] = \
            subscription_delivery_guid
        return self.get_subscription_delivery_endpoint.call_with_http_info(**kwargs)

    def list_subscription_deliveries(
        self,
        **kwargs
    ):
        """Get subscription deliveries list  # noqa: E501

        Retrieves a listing of subscription deliveries s.  Required scope: **subscription_events:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_subscription_deliveries(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.list_subscription_deliveries_endpoint.call_with_http_info(**kwargs)
