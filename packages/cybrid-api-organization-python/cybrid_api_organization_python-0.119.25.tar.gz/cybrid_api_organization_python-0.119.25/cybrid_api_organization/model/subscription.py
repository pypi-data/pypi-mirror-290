...
class Subscription(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'state': (str,),  # noqa: E501
            'organization_guid': (str,),  # noqa: E501
            'signing_key': (str,),  # noqa: E501
            'deliveries_failing_since': (datetime, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'organization_guid': 'organization_guid',  # noqa: E501
        'signing_key': 'signing_key',  # noqa: E501
        'deliveries_failing_since': 'deliveries_failing_since',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, guid, name, url, environment, state, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            type (str): The type of subscription.. defaults to "webhook", must be one of ["webhook", ]  # noqa: E501
            ...
            organization_guid (str): The organization guid for the subscription.. [optional]  # noqa: E501
            signing_key (str): Subscription private signing key.. [optional]  # noqa: E501
            deliveries_failing_since (datetime, none_type): ISO8601 datetime the deliveries started failing.. [optional]  # noqa: E501
            failure_code (str, none_type): The failure code of a subscription (if any). [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, guid, name, url, environment, state, *args, **kwargs):  # noqa: E501
        """Subscription - a model defined in OpenAPI
