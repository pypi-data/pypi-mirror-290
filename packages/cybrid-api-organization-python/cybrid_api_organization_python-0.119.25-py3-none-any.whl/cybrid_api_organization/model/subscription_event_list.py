...
def lazy_import():
    ...
    globals()['SubscriptionEvent'] = SubscriptionEvent


class SubscriptionEventList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([SubscriptionEvent],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """SubscriptionEventList - a model defined in OpenAPI
