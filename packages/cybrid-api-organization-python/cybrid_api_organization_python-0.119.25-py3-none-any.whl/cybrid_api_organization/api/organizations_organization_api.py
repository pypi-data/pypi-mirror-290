...
class OrganizationsOrganizationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_organization_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/organizations/{organization_guid}',
    ...
    def get_organization(
        ...
        **kwargs
        ...
        Retrieve an organization.  Required scope: **organizations:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_organization(organization_guid, async_req=True)
        >>> result = thread.get()
    ...
    def update_organization(
        ...
        **kwargs
        ...
        Update an organization.  Required scope: **organizations:write**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_organization(organization_guid, patch_organization, async_req=True)
        >>> result = thread.get()
