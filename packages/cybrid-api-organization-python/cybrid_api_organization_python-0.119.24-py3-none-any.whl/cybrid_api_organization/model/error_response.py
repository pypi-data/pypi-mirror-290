...
class ErrorResponse(ModelNormal):
    ...
    attribute_map = {
        ...
        'message_code': 'message_code',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status, error_message, message_code, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, status, error_message, message_code, *args, **kwargs):  # noqa: E501
        """ErrorResponse - a model defined in OpenAPI
