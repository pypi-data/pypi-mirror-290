...
from cybrid_api_organization import rest
from cybrid_api_organization.configuration import Configuration
from cybrid_api_organization.exceptions import ApiTypeError, ApiValueError, ApiException
from cybrid_api_organization.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = OrganizationsOrganizationApi()
        api_instance.get_organization  # this is an instance of the class Endpoint
        api_instance.get_organization()  # this invokes api_instance.get_organization.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_organization.callable or self.callable in this class
