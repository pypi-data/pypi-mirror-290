...
def lazy_import():
    ...
    globals()['SubscriptionDelivery'] = SubscriptionDelivery


class SubscriptionDeliveryList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([SubscriptionDelivery],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """SubscriptionDeliveryList - a model defined in OpenAPI
