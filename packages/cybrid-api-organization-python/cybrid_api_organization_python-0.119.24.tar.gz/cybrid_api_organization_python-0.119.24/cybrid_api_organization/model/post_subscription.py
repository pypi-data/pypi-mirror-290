...
class PostSubscription(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, url, environment, *args, **kwargs):  # noqa: E501
        """PostSubscription - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, url, environment, *args, **kwargs):  # noqa: E501
        """PostSubscription - a model defined in OpenAPI
