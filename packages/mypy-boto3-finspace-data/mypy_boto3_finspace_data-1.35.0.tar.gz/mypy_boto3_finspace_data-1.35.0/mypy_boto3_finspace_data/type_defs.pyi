...
__all__ = (
    ...
    "CredentialsTypeDef",
    "DataViewDestinationTypeParamsExtraOutputTypeDef",
    ...
    "SchemaDefinitionExtraOutputTypeDef",
...
DataViewDestinationTypeParamsExtraOutputTypeDef = TypedDict(
    "DataViewDestinationTypeParamsExtraOutputTypeDef",
    {
        "destinationType": str,
        "s3DestinationExportFileFormat": NotRequired[ExportFileFormatType],
...
SchemaDefinitionExtraOutputTypeDef = TypedDict(
    "SchemaDefinitionExtraOutputTypeDef",
    {
...
DataViewDestinationTypeParamsUnionTypeDef = Union[
    DataViewDestinationTypeParamsTypeDef, DataViewDestinationTypeParamsExtraOutputTypeDef
]
...
SchemaUnionExtraOutputTypeDef = TypedDict(
    "SchemaUnionExtraOutputTypeDef",
    {
        "tabularSchemaConfig": NotRequired[SchemaDefinitionExtraOutputTypeDef],
    },
)
...
SchemaUnionUnionTypeDef = Union[SchemaUnionTypeDef, SchemaUnionExtraOutputTypeDef]
