...
class Namespace(ZBLBase):
    ...
    def __get(
        ...
        if resource_id is None:
            ...
            self.__basic_id_validation(namespace_id=resource_id.strip())
            response = requests.get(
    ...
    def validate_id(self, namespace_id: str, raise_exception: bool = False):
        ...
        return self.__get(
            ...
            error_message=NO_NAMESPACE_ID.format(namespace_id=namespace_id.strip())
        )
    ...
    def get_by_id(self, namespace_id: str, print_stdout: bool = True) -> Dict:
        ...
        err_msg = NO_NAMESPACE_ID.format(namespace_id=namespace_id.strip())
