...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in groot/sdk/client_service_pb2_grpc.py depends on'
...
def add_ClientServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('gs.rpc.groot.Client', rpc_method_handlers)
