...
class DirectoryServiceClient(BaseClient):
    ...
    def create_snapshot(self, *, DirectoryId: str, Name: str = ...) -> CreateSnapshotResultTypeDef:
        """
    ...
    def remove_ip_routes(self, *, DirectoryId: str, CidrIps: Sequence[str]) -> Dict[str, Any]:
        """
