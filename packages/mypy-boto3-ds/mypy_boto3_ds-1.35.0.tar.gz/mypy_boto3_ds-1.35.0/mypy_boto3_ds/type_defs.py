...
DirectoryVpcSettingsExtraOutputTypeDef = TypedDict(
    "DirectoryVpcSettingsExtraOutputTypeDef",
    {
        "VpcId": str,
        "SubnetIds": List[str],
...
RadiusSettingsExtraOutputTypeDef = TypedDict(
    "RadiusSettingsExtraOutputTypeDef",
    {
        "RadiusServers": NotRequired[List[str]],
        "RadiusPort": NotRequired[int],
...
DirectoryVpcSettingsUnionTypeDef = Union[
    DirectoryVpcSettingsTypeDef, DirectoryVpcSettingsExtraOutputTypeDef
]
