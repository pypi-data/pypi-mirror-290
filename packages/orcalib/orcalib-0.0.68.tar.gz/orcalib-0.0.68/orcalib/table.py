...
class TableHandle:
    ...
    # TODO: Update `column_names` param to be `*column_names`, so you can pass in as many columns as you want without using a list similar to how `add_columns` and other orcalib methods work
