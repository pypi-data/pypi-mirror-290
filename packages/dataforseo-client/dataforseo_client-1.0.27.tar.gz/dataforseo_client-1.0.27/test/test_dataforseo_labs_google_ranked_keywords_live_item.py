...
class TestDataforseoLabsGoogleRankedKeywordsLiveItem(unittest.TestCase):
    """DataforseoLabsGoogleRankedKeywordsLiveItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleRankedKeywordsLiveItem:
        """Test DataforseoLabsGoogleRankedKeywordsLiveItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleRankedKeywordsLiveItem`
        """
        model = DataforseoLabsGoogleRankedKeywordsLiveItem()
        if include_optional:
            return DataforseoLabsGoogleRankedKeywordsLiveItem(
                se_type = '',
    ...
    def testDataforseoLabsGoogleRankedKeywordsLiveItem(self):
        """Test DataforseoLabsGoogleRankedKeywordsLiveItem"""
