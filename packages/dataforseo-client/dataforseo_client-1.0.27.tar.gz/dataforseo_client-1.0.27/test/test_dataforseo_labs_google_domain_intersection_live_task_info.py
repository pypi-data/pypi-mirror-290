...
class TestDataforseoLabsGoogleDomainIntersectionLiveTaskInfo(unittest.TestCase):
    """DataforseoLabsGoogleDomainIntersectionLiveTaskInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleDomainIntersectionLiveTaskInfo:
        """Test DataforseoLabsGoogleDomainIntersectionLiveTaskInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleDomainIntersectionLiveTaskInfo`
        """
        model = DataforseoLabsGoogleDomainIntersectionLiveTaskInfo()
        if include_optional:
            return DataforseoLabsGoogleDomainIntersectionLiveTaskInfo(
                id = '',
                status_code = 56,
                status_message = '',
                time = '',
                ...
                result = [
                    dataforseo_client.models.dataforseo_labs_google_domain_intersection_live_result_info.DataforseoLabsGoogleDomainIntersectionLiveResultInfo(
                        se_type = '', 
                        target1 = '', 
                        target2 = '', 
                        location_code = 56, 
    ...
    def testDataforseoLabsGoogleDomainIntersectionLiveTaskInfo(self):
        """Test DataforseoLabsGoogleDomainIntersectionLiveTaskInfo"""
