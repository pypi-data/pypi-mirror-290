...
class TestAppendixDayLimitsRatesData(unittest.TestCase):
    """AppendixDayLimitsRatesData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixDayLimitsRatesData:
        """Test AppendixDayLimitsRatesData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixDayLimitsRatesData`
        """
        model = AppendixDayLimitsRatesData()
        if include_optional:
            return AppendixDayLimitsRatesData(
    ...
    def testAppendixDayLimitsRatesData(self):
        """Test AppendixDayLimitsRatesData"""
