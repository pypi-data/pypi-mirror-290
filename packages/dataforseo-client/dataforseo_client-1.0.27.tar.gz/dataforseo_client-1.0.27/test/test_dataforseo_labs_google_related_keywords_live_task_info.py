...
class TestDataforseoLabsGoogleRelatedKeywordsLiveTaskInfo(unittest.TestCase):
    """DataforseoLabsGoogleRelatedKeywordsLiveTaskInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleRelatedKeywordsLiveTaskInfo:
        """Test DataforseoLabsGoogleRelatedKeywordsLiveTaskInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleRelatedKeywordsLiveTaskInfo`
        """
        model = DataforseoLabsGoogleRelatedKeywordsLiveTaskInfo()
        if include_optional:
            return DataforseoLabsGoogleRelatedKeywordsLiveTaskInfo(
                id = '',
                status_code = 56,
                status_message = '',
                time = '',
                ...
                result = [
                    dataforseo_client.models.dataforseo_labs_google_related_keywords_live_result_info.DataforseoLabsGoogleRelatedKeywordsLiveResultInfo(
                        se_type = '', 
                        seed_keyword = '', 
                        seed_keyword_data = {
                            'key' : ''
                        ...
                        items_count = 56, 
                        items = [
                            dataforseo_client.models.dataforseo_labs_google_related_keywords_live_item.DataforseoLabsGoogleRelatedKeywordsLiveItem(
                                se_type = '', 
    ...
    def testDataforseoLabsGoogleRelatedKeywordsLiveTaskInfo(self):
        """Test DataforseoLabsGoogleRelatedKeywordsLiveTaskInfo"""
