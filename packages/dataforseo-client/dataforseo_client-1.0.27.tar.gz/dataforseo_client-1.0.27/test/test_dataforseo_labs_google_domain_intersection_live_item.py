...
class TestDataforseoLabsGoogleDomainIntersectionLiveItem(unittest.TestCase):
    """DataforseoLabsGoogleDomainIntersectionLiveItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleDomainIntersectionLiveItem:
        """Test DataforseoLabsGoogleDomainIntersectionLiveItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleDomainIntersectionLiveItem`
        """
        model = DataforseoLabsGoogleDomainIntersectionLiveItem()
        if include_optional:
            return DataforseoLabsGoogleDomainIntersectionLiveItem(
                se_type = '',
    ...
    def testDataforseoLabsGoogleDomainIntersectionLiveItem(self):
        """Test DataforseoLabsGoogleDomainIntersectionLiveItem"""
