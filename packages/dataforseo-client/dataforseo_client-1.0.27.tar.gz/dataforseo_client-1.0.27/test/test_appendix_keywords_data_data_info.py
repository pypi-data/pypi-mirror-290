...
class TestAppendixKeywordsDataDataInfo(unittest.TestCase):
    """AppendixKeywordsDataDataInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixKeywordsDataDataInfo:
        """Test AppendixKeywordsDataDataInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixKeywordsDataDataInfo`
        """
        model = AppendixKeywordsDataDataInfo()
        if include_optional:
            return AppendixKeywordsDataDataInfo(
                ...
                naver = dataforseo_client.models.appendix_naver_keywords_data_data_info.AppendixNaverKeywordsDataDataInfo(
                    keywords_for_category = dataforseo_client.models.appendix_info.AppendixInfo(
                        task_post = 1.337, 
                        task_get = 1.337, 
                        tasks_ready = 1.337, 
                        live = 1.337, ), 
    ...
    def testAppendixKeywordsDataDataInfo(self):
        """Test AppendixKeywordsDataDataInfo"""
