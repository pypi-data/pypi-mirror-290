...
class TestAppendixLimitsMoneyData(unittest.TestCase):
    """AppendixLimitsMoneyData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixLimitsMoneyData:
        """Test AppendixLimitsMoneyData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixLimitsMoneyData`
        """
        model = AppendixLimitsMoneyData()
        if include_optional:
            return AppendixLimitsMoneyData(
    ...
    def testAppendixLimitsMoneyData(self):
        """Test AppendixLimitsMoneyData"""
