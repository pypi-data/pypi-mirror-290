...
class TestDataforseoLabsGooglePageIntersectionLiveItem(unittest.TestCase):
    """DataforseoLabsGooglePageIntersectionLiveItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGooglePageIntersectionLiveItem:
        """Test DataforseoLabsGooglePageIntersectionLiveItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGooglePageIntersectionLiveItem`
        """
        model = DataforseoLabsGooglePageIntersectionLiveItem()
        if include_optional:
            return DataforseoLabsGooglePageIntersectionLiveItem(
                se_type = '',
    ...
    def testDataforseoLabsGooglePageIntersectionLiveItem(self):
        """Test DataforseoLabsGooglePageIntersectionLiveItem"""
