...
class TestDataforseoLabsGoogleRankedKeywordsLiveResultInfo(unittest.TestCase):
    """DataforseoLabsGoogleRankedKeywordsLiveResultInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleRankedKeywordsLiveResultInfo:
        """Test DataforseoLabsGoogleRankedKeywordsLiveResultInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleRankedKeywordsLiveResultInfo`
        """
        model = DataforseoLabsGoogleRankedKeywordsLiveResultInfo()
        if include_optional:
            return DataforseoLabsGoogleRankedKeywordsLiveResultInfo(
                se_type = '',
                target = '',
                location_code = 56,
                language_code = '',
    ...
    def testDataforseoLabsGoogleRankedKeywordsLiveResultInfo(self):
        """Test DataforseoLabsGoogleRankedKeywordsLiveResultInfo"""
