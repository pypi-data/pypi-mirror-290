...
class TestDataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo(unittest.TestCase):
    """DataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo:
        """Test DataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo`
        """
        model = DataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo()
        if include_optional:
            return DataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo(
                id = '',
                status_code = 56,
                status_message = '',
                time = '',
                ...
                result = [
                    dataforseo_client.models.dataforseo_labs_google_keyword_suggestions_live_result_info.DataforseoLabsGoogleKeywordSuggestionsLiveResultInfo(
                        se_type = '', 
                        seed_keyword = '', 
                        seed_keyword_data = {
                            'key' : ''
    ...
    def testDataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo(self):
        """Test DataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo"""
