...
class TestAppendixUserDataTaskInfo(unittest.TestCase):
    """AppendixUserDataTaskInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixUserDataTaskInfo:
        """Test AppendixUserDataTaskInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixUserDataTaskInfo`
        """
        model = AppendixUserDataTaskInfo()
        if include_optional:
            return AppendixUserDataTaskInfo(
                id = '',
                status_code = 56,
                status_message = '',
                time = '',
                ...
                result = [
                    dataforseo_client.models.appendix_user_data_result_info.AppendixUserDataResultInfo(
                        login = '', 
                        timezone = '', 
    ...
    def testAppendixUserDataTaskInfo(self):
        """Test AppendixUserDataTaskInfo"""
