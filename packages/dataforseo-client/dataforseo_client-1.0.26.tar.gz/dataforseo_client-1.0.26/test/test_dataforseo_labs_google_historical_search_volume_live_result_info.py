...
class TestDataforseoLabsGoogleHistoricalSearchVolumeLiveResultInfo(unittest.TestCase):
    """DataforseoLabsGoogleHistoricalSearchVolumeLiveResultInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleHistoricalSearchVolumeLiveResultInfo:
        """Test DataforseoLabsGoogleHistoricalSearchVolumeLiveResultInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleHistoricalSearchVolumeLiveResultInfo`
        """
        model = DataforseoLabsGoogleHistoricalSearchVolumeLiveResultInfo()
        if include_optional:
            return DataforseoLabsGoogleHistoricalSearchVolumeLiveResultInfo(
                se_type = '',
                location_code = 56,
                language_code = '',
                items_count = 56,
                items = [
                    dataforseo_client.models.dataforseo_labs_google_historical_search_volume_live_item.DataforseoLabsGoogleHistoricalSearchVolumeLiveItem(
                        ...
                        clickstream_keyword_info = dataforseo_client.models.clickstream_keyword_info.clickstream_keyword_info(), 
    ...
    def testDataforseoLabsGoogleHistoricalSearchVolumeLiveResultInfo(self):
        """Test DataforseoLabsGoogleHistoricalSearchVolumeLiveResultInfo"""
