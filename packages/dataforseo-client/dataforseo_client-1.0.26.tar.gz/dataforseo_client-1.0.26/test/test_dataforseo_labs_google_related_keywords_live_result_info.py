...
class TestDataforseoLabsGoogleRelatedKeywordsLiveResultInfo(unittest.TestCase):
    """DataforseoLabsGoogleRelatedKeywordsLiveResultInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleRelatedKeywordsLiveResultInfo:
        """Test DataforseoLabsGoogleRelatedKeywordsLiveResultInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleRelatedKeywordsLiveResultInfo`
        """
        model = DataforseoLabsGoogleRelatedKeywordsLiveResultInfo()
        if include_optional:
            return DataforseoLabsGoogleRelatedKeywordsLiveResultInfo(
                se_type = '',
                seed_keyword = '',
                seed_keyword_data = {
                    'key' : ''
    ...
    def testDataforseoLabsGoogleRelatedKeywordsLiveResultInfo(self):
        """Test DataforseoLabsGoogleRelatedKeywordsLiveResultInfo"""
