...
class TestDataforseoLabsGoogleKeywordsForAppLiveResultInfo(unittest.TestCase):
    """DataforseoLabsGoogleKeywordsForAppLiveResultInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleKeywordsForAppLiveResultInfo:
        """Test DataforseoLabsGoogleKeywordsForAppLiveResultInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleKeywordsForAppLiveResultInfo`
        """
        model = DataforseoLabsGoogleKeywordsForAppLiveResultInfo()
        if include_optional:
            return DataforseoLabsGoogleKeywordsForAppLiveResultInfo(
                se_type = '',
                app_id = '',
                location_code = 56,
                language_code = '',
                ...
                items_count = 56,
                items = [
                    dataforseo_client.models.dataforseo_labs_google_keywords_for_app_live_item.DataforseoLabsGoogleKeywordsForAppLiveItem(
                        se_type = '', 
    ...
    def testDataforseoLabsGoogleKeywordsForAppLiveResultInfo(self):
        """Test DataforseoLabsGoogleKeywordsForAppLiveResultInfo"""
