...
class TestDataforseoLabsGoogleKeywordIdeasLiveTaskInfo(unittest.TestCase):
    """DataforseoLabsGoogleKeywordIdeasLiveTaskInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleKeywordIdeasLiveTaskInfo:
        """Test DataforseoLabsGoogleKeywordIdeasLiveTaskInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleKeywordIdeasLiveTaskInfo`
        """
        model = DataforseoLabsGoogleKeywordIdeasLiveTaskInfo()
        if include_optional:
            return DataforseoLabsGoogleKeywordIdeasLiveTaskInfo(
                id = '',
                status_code = 56,
                status_message = '',
                time = '',
                ...
                result = [
                    dataforseo_client.models.dataforseo_labs_google_keyword_ideas_live_result_info.DataforseoLabsGoogleKeywordIdeasLiveResultInfo(
                        se_type = '', 
                        seed_keywords = [
                            ''
                            ], 
    ...
    def testDataforseoLabsGoogleKeywordIdeasLiveTaskInfo(self):
        """Test DataforseoLabsGoogleKeywordIdeasLiveTaskInfo"""
