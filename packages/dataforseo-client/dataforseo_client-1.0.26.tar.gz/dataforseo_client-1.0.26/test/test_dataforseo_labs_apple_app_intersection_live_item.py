...
class TestDataforseoLabsAppleAppIntersectionLiveItem(unittest.TestCase):
    """DataforseoLabsAppleAppIntersectionLiveItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsAppleAppIntersectionLiveItem:
        """Test DataforseoLabsAppleAppIntersectionLiveItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsAppleAppIntersectionLiveItem`
        """
        model = DataforseoLabsAppleAppIntersectionLiveItem()
        if include_optional:
            return DataforseoLabsAppleAppIntersectionLiveItem(
                se_type = '',
    ...
    def testDataforseoLabsAppleAppIntersectionLiveItem(self):
        """Test DataforseoLabsAppleAppIntersectionLiveItem"""
