...
class TestKeywordDataInfo(unittest.TestCase):
    """KeywordDataInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeywordDataInfo:
        """Test KeywordDataInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeywordDataInfo`
        """
        model = KeywordDataInfo()
        if include_optional:
            return KeywordDataInfo(
                se_type = '',
                keyword = '',
                location_code = 56,
                language_code = '',
