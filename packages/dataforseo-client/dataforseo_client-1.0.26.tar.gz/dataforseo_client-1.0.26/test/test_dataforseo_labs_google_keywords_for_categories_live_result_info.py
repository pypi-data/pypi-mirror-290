...
class TestDataforseoLabsGoogleKeywordsForCategoriesLiveResultInfo(unittest.TestCase):
    """DataforseoLabsGoogleKeywordsForCategoriesLiveResultInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleKeywordsForCategoriesLiveResultInfo:
        """Test DataforseoLabsGoogleKeywordsForCategoriesLiveResultInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleKeywordsForCategoriesLiveResultInfo`
        """
        model = DataforseoLabsGoogleKeywordsForCategoriesLiveResultInfo()
        if include_optional:
            return DataforseoLabsGoogleKeywordsForCategoriesLiveResultInfo(
                se_type = '',
                seed_categories = [
                    56
                    ],
    ...
    def testDataforseoLabsGoogleKeywordsForCategoriesLiveResultInfo(self):
        """Test DataforseoLabsGoogleKeywordsForCategoriesLiveResultInfo"""
