...
class TestDataforseoLabsGoogleKeywordSuggestionsLiveResultInfo(unittest.TestCase):
    """DataforseoLabsGoogleKeywordSuggestionsLiveResultInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleKeywordSuggestionsLiveResultInfo:
        """Test DataforseoLabsGoogleKeywordSuggestionsLiveResultInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleKeywordSuggestionsLiveResultInfo`
        """
        model = DataforseoLabsGoogleKeywordSuggestionsLiveResultInfo()
        if include_optional:
            return DataforseoLabsGoogleKeywordSuggestionsLiveResultInfo(
                se_type = '',
                seed_keyword = '',
                seed_keyword_data = {
                    'key' : ''
    ...
    def testDataforseoLabsGoogleKeywordSuggestionsLiveResultInfo(self):
        """Test DataforseoLabsGoogleKeywordSuggestionsLiveResultInfo"""
