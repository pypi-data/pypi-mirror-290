...
class TestDataforseoLabsGoogleKeywordsForSiteLiveResultInfo(unittest.TestCase):
    """DataforseoLabsGoogleKeywordsForSiteLiveResultInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleKeywordsForSiteLiveResultInfo:
        """Test DataforseoLabsGoogleKeywordsForSiteLiveResultInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleKeywordsForSiteLiveResultInfo`
        """
        model = DataforseoLabsGoogleKeywordsForSiteLiveResultInfo()
        if include_optional:
            return DataforseoLabsGoogleKeywordsForSiteLiveResultInfo(
                se_type = '',
                target = '',
                location_code = 56,
                language_code = '',
    ...
    def testDataforseoLabsGoogleKeywordsForSiteLiveResultInfo(self):
        """Test DataforseoLabsGoogleKeywordsForSiteLiveResultInfo"""
