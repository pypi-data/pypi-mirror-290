...
class TestDataforseoLabsGooglePageIntersectionLiveTaskInfo(unittest.TestCase):
    """DataforseoLabsGooglePageIntersectionLiveTaskInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGooglePageIntersectionLiveTaskInfo:
        """Test DataforseoLabsGooglePageIntersectionLiveTaskInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGooglePageIntersectionLiveTaskInfo`
        """
        model = DataforseoLabsGooglePageIntersectionLiveTaskInfo()
        if include_optional:
            return DataforseoLabsGooglePageIntersectionLiveTaskInfo(
                id = '',
                status_code = 56,
                status_message = '',
                time = '',
                ...
                result = [
                    dataforseo_client.models.dataforseo_labs_google_page_intersection_live_result_info.DataforseoLabsGooglePageIntersectionLiveResultInfo(
                        se_type = '', 
                        pages = {
                            'key' : ''
                            }, 
    ...
    def testDataforseoLabsGooglePageIntersectionLiveTaskInfo(self):
        """Test DataforseoLabsGooglePageIntersectionLiveTaskInfo"""
