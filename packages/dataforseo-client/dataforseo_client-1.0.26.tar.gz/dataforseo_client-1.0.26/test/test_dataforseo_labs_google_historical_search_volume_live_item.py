...
class TestDataforseoLabsGoogleHistoricalSearchVolumeLiveItem(unittest.TestCase):
    """DataforseoLabsGoogleHistoricalSearchVolumeLiveItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleHistoricalSearchVolumeLiveItem:
        """Test DataforseoLabsGoogleHistoricalSearchVolumeLiveItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleHistoricalSearchVolumeLiveItem`
        """
        model = DataforseoLabsGoogleHistoricalSearchVolumeLiveItem()
        if include_optional:
            return DataforseoLabsGoogleHistoricalSearchVolumeLiveItem(
                se_type = '',
                keyword = '',
                location_code = 56,
                language_code = '',
    ...
    def testDataforseoLabsGoogleHistoricalSearchVolumeLiveItem(self):
        """Test DataforseoLabsGoogleHistoricalSearchVolumeLiveItem"""
