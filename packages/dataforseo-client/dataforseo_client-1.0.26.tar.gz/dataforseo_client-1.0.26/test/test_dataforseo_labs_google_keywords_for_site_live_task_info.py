...
class TestDataforseoLabsGoogleKeywordsForSiteLiveTaskInfo(unittest.TestCase):
    """DataforseoLabsGoogleKeywordsForSiteLiveTaskInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleKeywordsForSiteLiveTaskInfo:
        """Test DataforseoLabsGoogleKeywordsForSiteLiveTaskInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleKeywordsForSiteLiveTaskInfo`
        """
        model = DataforseoLabsGoogleKeywordsForSiteLiveTaskInfo()
        if include_optional:
            return DataforseoLabsGoogleKeywordsForSiteLiveTaskInfo(
                id = '',
                status_code = 56,
                status_message = '',
                time = '',
                ...
                result = [
                    dataforseo_client.models.dataforseo_labs_google_keywords_for_site_live_result_info.DataforseoLabsGoogleKeywordsForSiteLiveResultInfo(
                        se_type = '', 
                        target = '', 
                        location_code = 56, 
                        language_code = '', 
    ...
    def testDataforseoLabsGoogleKeywordsForSiteLiveTaskInfo(self):
        """Test DataforseoLabsGoogleKeywordsForSiteLiveTaskInfo"""
