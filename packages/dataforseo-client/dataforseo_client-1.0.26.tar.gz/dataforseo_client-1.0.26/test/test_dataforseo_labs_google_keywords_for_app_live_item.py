...
class TestDataforseoLabsGoogleKeywordsForAppLiveItem(unittest.TestCase):
    """DataforseoLabsGoogleKeywordsForAppLiveItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleKeywordsForAppLiveItem:
        """Test DataforseoLabsGoogleKeywordsForAppLiveItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleKeywordsForAppLiveItem`
        """
        model = DataforseoLabsGoogleKeywordsForAppLiveItem()
        if include_optional:
            return DataforseoLabsGoogleKeywordsForAppLiveItem(
                se_type = '',
    ...
    def testDataforseoLabsGoogleKeywordsForAppLiveItem(self):
        """Test DataforseoLabsGoogleKeywordsForAppLiveItem"""
