...
class TestDataforseoLabsGoogleKeywordIdeasLiveResultInfo(unittest.TestCase):
    """DataforseoLabsGoogleKeywordIdeasLiveResultInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleKeywordIdeasLiveResultInfo:
        """Test DataforseoLabsGoogleKeywordIdeasLiveResultInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleKeywordIdeasLiveResultInfo`
        """
        model = DataforseoLabsGoogleKeywordIdeasLiveResultInfo()
        if include_optional:
            return DataforseoLabsGoogleKeywordIdeasLiveResultInfo(
                se_type = '',
                seed_keywords = [
                    ''
                    ],
    ...
    def testDataforseoLabsGoogleKeywordIdeasLiveResultInfo(self):
        """Test DataforseoLabsGoogleKeywordIdeasLiveResultInfo"""
