...
class TestDataforseoLabsGoogleAppIntersectionLiveItem(unittest.TestCase):
    """DataforseoLabsGoogleAppIntersectionLiveItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleAppIntersectionLiveItem:
        """Test DataforseoLabsGoogleAppIntersectionLiveItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleAppIntersectionLiveItem`
        """
        model = DataforseoLabsGoogleAppIntersectionLiveItem()
        if include_optional:
            return DataforseoLabsGoogleAppIntersectionLiveItem(
                se_type = '',
    ...
    def testDataforseoLabsGoogleAppIntersectionLiveItem(self):
        """Test DataforseoLabsGoogleAppIntersectionLiveItem"""
