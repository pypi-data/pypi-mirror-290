...
class TestDataforseoLabsGoogleTopSearchesLiveTaskInfo(unittest.TestCase):
    """DataforseoLabsGoogleTopSearchesLiveTaskInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleTopSearchesLiveTaskInfo:
        """Test DataforseoLabsGoogleTopSearchesLiveTaskInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleTopSearchesLiveTaskInfo`
        """
        model = DataforseoLabsGoogleTopSearchesLiveTaskInfo()
        if include_optional:
            return DataforseoLabsGoogleTopSearchesLiveTaskInfo(
                id = '',
                status_code = 56,
                status_message = '',
                time = '',
                ...
                result = [
                    dataforseo_client.models.dataforseo_labs_google_top_searches_live_result_info.DataforseoLabsGoogleTopSearchesLiveResultInfo(
                        se_type = '', 
                        location_code = 56, 
                        language_code = '', 
                        total_count = 56, 
    ...
    def testDataforseoLabsGoogleTopSearchesLiveTaskInfo(self):
        """Test DataforseoLabsGoogleTopSearchesLiveTaskInfo"""
