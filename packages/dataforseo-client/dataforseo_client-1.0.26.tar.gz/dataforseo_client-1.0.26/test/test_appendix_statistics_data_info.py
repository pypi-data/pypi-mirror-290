...
class TestAppendixStatisticsDataInfo(unittest.TestCase):
    """AppendixStatisticsDataInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixStatisticsDataInfo:
        """Test AppendixStatisticsDataInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixStatisticsDataInfo`
        """
        model = AppendixStatisticsDataInfo()
        if include_optional:
            return AppendixStatisticsDataInfo(
    ...
    def testAppendixStatisticsDataInfo(self):
        """Test AppendixStatisticsDataInfo"""
