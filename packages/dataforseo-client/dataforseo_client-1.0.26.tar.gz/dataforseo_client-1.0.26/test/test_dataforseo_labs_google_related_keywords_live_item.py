...
class TestDataforseoLabsGoogleRelatedKeywordsLiveItem(unittest.TestCase):
    """DataforseoLabsGoogleRelatedKeywordsLiveItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleRelatedKeywordsLiveItem:
        """Test DataforseoLabsGoogleRelatedKeywordsLiveItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleRelatedKeywordsLiveItem`
        """
        model = DataforseoLabsGoogleRelatedKeywordsLiveItem()
        if include_optional:
            return DataforseoLabsGoogleRelatedKeywordsLiveItem(
                se_type = '',
    ...
    def testDataforseoLabsGoogleRelatedKeywordsLiveItem(self):
        """Test DataforseoLabsGoogleRelatedKeywordsLiveItem"""
