...
class TestDataforseoLabsGoogleKeywordsForCategoriesLiveTaskInfo(unittest.TestCase):
    """DataforseoLabsGoogleKeywordsForCategoriesLiveTaskInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleKeywordsForCategoriesLiveTaskInfo:
        """Test DataforseoLabsGoogleKeywordsForCategoriesLiveTaskInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsGoogleKeywordsForCategoriesLiveTaskInfo`
        """
        model = DataforseoLabsGoogleKeywordsForCategoriesLiveTaskInfo()
        if include_optional:
            return DataforseoLabsGoogleKeywordsForCategoriesLiveTaskInfo(
                id = '',
                status_code = 56,
                status_message = '',
                time = '',
                ...
                result = [
                    dataforseo_client.models.dataforseo_labs_google_keywords_for_categories_live_result_info.DataforseoLabsGoogleKeywordsForCategoriesLiveResultInfo(
                        se_type = '', 
                        seed_categories = [
                            56
                            ], 
    ...
    def testDataforseoLabsGoogleKeywordsForCategoriesLiveTaskInfo(self):
        """Test DataforseoLabsGoogleKeywordsForCategoriesLiveTaskInfo"""
