...
class AppendixKeywordsDataDataInfo(BaseModel):
    ...
    clickstream_data: Optional[AppendixClickstreamDataKeywordsDataDataInfo] = None
    keyword_ideas_ads_api: Optional[AppendixSerpLimitsRatesDataInfo] = None
    __properties: ClassVar[List[str]] = ["keywords_for_keywords", "keywords_for_site", "search_volume", "ad_traffic_by_keywords", "languages", "locations", "tasks_ready", "explore", "categories", "errors", "bing", "keyword_performance", "locations_and_languages", "search_volume_history", "google_ads", "dataforseo_trends", "naver", "google", "clickstream_data", "keyword_ideas_ads_api"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "clickstream_data": AppendixClickstreamDataKeywordsDataDataInfo.from_dict(obj["clickstream_data"]) if obj.get("clickstream_data") is not None else None,
