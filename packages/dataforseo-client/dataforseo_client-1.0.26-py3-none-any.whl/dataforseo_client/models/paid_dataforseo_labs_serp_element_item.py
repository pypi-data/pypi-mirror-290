...
class PaidDataforseoLabsSerpElementItem(BaseDataforseoLabsSerpElementItem):
    ...
    __properties: ClassVar[List[str]] = ["type", "se_type", "rank_group", "rank_absolute", "position", "xpath", "title", "domain", "description", "breadcrumb", "url", "highlighted", "extra", "description_rows", "links", "main_domain", "relative_url", "etv", "impressions_etv", "estimated_paid_traffic_cost", "rank_changes", "backlinks_info", "rank_info", "clickstream_etv"]
