...
class advanced_list(__advanced_list__):
    ...
    def copy(self) -> 'advanced_list':
        ...
        self._copy_self = globals()['$PyListFunctions_temp_import_class$'](self._copy_self,
...
def var_in_list(lst: list, __class: type, return_lst: bool = False, only_return_lst: bool = False) -> Union[
    int, tuple, list]:
    """
...
_all = dir()
_all.remove("Any"), _all.remove("Union")
__all__ = _all
del _all
