...
__all__ = (
    ...
    "CloudWatchLogsConfigurationExtraOutputTypeDef",
...
RecipesExtraOutputTypeDef = TypedDict(
    "RecipesExtraOutputTypeDef",
    {
        "Setup": NotRequired[List[str]],
        "Configure": NotRequired[List[str]],
...
CloudWatchLogsConfigurationExtraOutputTypeDef = TypedDict(
    "CloudWatchLogsConfigurationExtraOutputTypeDef",
    {
...
RecipesUnionTypeDef = Union[RecipesTypeDef, RecipesExtraOutputTypeDef]
...
CloudWatchLogsConfigurationUnionTypeDef = Union[
    CloudWatchLogsConfigurationTypeDef, CloudWatchLogsConfigurationExtraOutputTypeDef
]
