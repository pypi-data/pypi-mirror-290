...
class Layer(ServiceResource):
    ...
    cloud_watch_logs_configuration: CloudWatchLogsConfigurationExtraOutputTypeDef
    ...
    default_recipes: RecipesExtraOutputTypeDef
    custom_recipes: RecipesExtraOutputTypeDef
    created_at: str
...
class StackSummary(ServiceResource):
    ...
    def load(self) -> None:
        ...
        attributes of the StackSummary
        resource.
