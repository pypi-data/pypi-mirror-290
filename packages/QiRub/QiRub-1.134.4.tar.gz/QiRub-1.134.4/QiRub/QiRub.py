...
class ClientMessenger(object):
    ...
    def polling(self):
        for handler in self.handlers:
            handler(QiUpdater(self.authtoken, self.privatekey, self.getChatsUpdates(), self.ufa, self.proxy))
    ...
    @property
    def on_message_reaction_actions(self):
        return (
            "Add",
            "Remove"
        )

    def actionOnMessageReaction(self, object_guid: str, message_id: str, reaction_id: int = None, action: str = "Add"):
